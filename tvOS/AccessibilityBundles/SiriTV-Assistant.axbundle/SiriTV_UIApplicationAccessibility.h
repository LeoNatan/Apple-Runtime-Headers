...
#import "__SiriTV_UIApplicationAccessibility_super.h"

@interface SiriTV_UIApplicationAccessibility : __SiriTV_UIApplicationAccessibility_super
{
}
...
- (id)_accessibilitySiriTVMainView;
