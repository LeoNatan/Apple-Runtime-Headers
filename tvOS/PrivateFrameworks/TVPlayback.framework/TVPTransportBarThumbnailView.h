...
#import <TVPlayback/TVPTransportBarThumbnailScrubbing-Protocol.h>

@class NSLayoutConstraint, NSString, TVPGradientView, TVPVideoView, UIFont, UIImage, UIImageView, UILabel;
...
@property(retain, nonatomic) TVPGradientView *gradientView; // @synthesize gradientView=_gradientView;
