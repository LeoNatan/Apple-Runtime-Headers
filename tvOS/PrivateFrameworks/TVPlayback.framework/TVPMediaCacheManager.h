...
@class AVAssetCache, AVAssetDownloadSession, AVQueuePlayer, NSArray, NSDate, NSMutableArray, NSNumber, NSObject<TVPMediaItem>, NSString, NSTimer, TVPMediaItemLoader, TVPPlayerItem, TVPTimeRange, TVSStateMachine;
