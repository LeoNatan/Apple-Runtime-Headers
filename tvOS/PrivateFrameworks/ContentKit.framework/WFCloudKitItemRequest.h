...
- (id)fetchRecordsWithPredicate:(id)arg1 itemType:(Class)arg2 sortDescriptors:(id)arg3 resultsLimit:(unsigned long long)arg4 resolvingReferences:(_Bool)arg5 completionHandler:(CDUnknownBlockType)arg6;
