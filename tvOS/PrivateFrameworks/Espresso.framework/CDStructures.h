...
struct multiple_buffer_manager<vImage_Buffer>;
...
struct shared_ptr<Espresso::multiple_buffer_manager<vImage_Buffer>> {
    struct multiple_buffer_manager<vImage_Buffer> *__ptr_;
    struct __shared_weak_count *__cntrl_;
};
