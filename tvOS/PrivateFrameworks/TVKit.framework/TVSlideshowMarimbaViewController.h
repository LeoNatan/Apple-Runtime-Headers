...
@class NSArray, NSDictionary, NSObject<OS_dispatch_source>, NSString, NSTimer, UIActivityIndicatorView, UITableView, UITapGestureRecognizer, UIView, UIVisualEffectView;
