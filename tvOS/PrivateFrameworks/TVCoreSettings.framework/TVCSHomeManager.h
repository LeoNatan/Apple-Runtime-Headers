...
#import "HMAccessoryBrowserPrivateDelegate.h"
#import "HMHomeManagerDelegatePrivate.h"

@class HMAccessory, HMAccessoryBrowser, HMHomeManager, NSArray, NSObject<OS_dispatch_queue>, NSString, TVCSAccessory, TVCSHome;
