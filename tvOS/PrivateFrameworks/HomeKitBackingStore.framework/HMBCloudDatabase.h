...
- (id)openExistingPrivateZoneWithID:(id)arg1 shouldRebuildOnManateeKeyLoss:(_Bool)arg2 delegate:(id)arg3 error:(id *)arg4;
- (id)openOrCreatePrivateZoneWithID:(id)arg1 shouldRebuildOnManateeKeyLoss:(_Bool)arg2 delegate:(id)arg3 error:(id *)arg4;
...
- (id)removeZoneWithID:(id)arg1 removeState:(_Bool)arg2;
