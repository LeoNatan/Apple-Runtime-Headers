...
+ (void)authenticateNonActivePlayerWithUsername:(id)arg1 password:(id)arg2 altDSID:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
+ (void)authenticatePlayerWithUsername:(id)arg1 password:(id)arg2 altDSID:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
