...
- (id)initWithContext:(struct OpaqueJSContext *)arg1 successBlock:(CDUnknownBlockType)arg2 successArgCount:(unsigned long long)arg3 failureBlock:(CDUnknownBlockType)arg4;
