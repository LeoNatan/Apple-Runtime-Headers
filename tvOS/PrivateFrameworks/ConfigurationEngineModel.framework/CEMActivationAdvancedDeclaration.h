...
- (_Bool)validStatusInstalledConfigurationsItem_Dictionary:(id)arg1 parentKeyPath:(id)arg2 error:(id *)arg3;
- (_Bool)validStatusDictionary:(id)arg1 error:(id *)arg2;
- (_Bool)validPayloadRequiredConfigurationsDictionary_Dictionary:(id)arg1 parentKeyPath:(id)arg2 error:(id *)arg3;
