...
@interface GEOVectorTile : NSObject
{
    ...
    CDStruct_38519e9a *_transitAccessPoints;
...
@property(readonly, nonatomic) CDStruct_38519e9a *transitAccessPoints; // @synthesize transitAccessPoints=_transitAccessPoints;
...
@property(readonly, nonatomic) CDStruct_d83bb90a *pois; // @synthesize pois=_pois;
...
- (CDStruct_38519e9a *)transitAccessPointForFeatureID:(unsigned long long)arg1;
...
- (_Bool)_decodeLabelTextPlacementsFromStream:(CDStruct_8bf61218 *)arg1 count:(unsigned long long)arg2 firstFeature:(CDStruct_d83bb90a *)arg3 featureStride:(unsigned long long)arg4 tilePrecision:(unsigned char)arg5;
