...
- (_Bool)_hasiCplStatusForServiceUIStatus:(id)arg1;
- (_Bool)_hasAnalysisProgressForServiceStatus:(id)arg1 outProgress:(float *)arg2 outDescription:(id *)arg3;
- (_Bool)_hasSyncProgressStatusForSyncAlbums:(id)arg1 outImportOperations:(int *)arg2;
- (void)_updateExposedProperties;
@property(readonly, nonatomic) _Bool hasPendingSyncProgressAlbums;
