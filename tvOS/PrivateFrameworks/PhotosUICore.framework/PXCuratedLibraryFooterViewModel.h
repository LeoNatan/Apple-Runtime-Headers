...
+ (_Bool)hasAnalysisProgressForStyle:(long long)arg1 analysisStatus:(id)arg2 serviceStatus:(id)arg3 cloudQuotaController:(id)arg4 outProgress:(float *)arg5 outTitle:(id *)arg6 outDescription:(id *)arg7;
...
- (_Bool)hasPendingSyncProgressAlbums;
