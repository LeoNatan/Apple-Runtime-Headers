...
@class MTKView, NSMutableArray, NSString, PXGCornerRadiusMask, PXGMetalRenderTextureStore;
...
@interface PXGMetalRenderer : NSObject <MTKViewDelegate, PXGRenderer>
{
    ...
    long long _frameId;
    double _lastTime;
    PXGCornerRadiusMask *_cornerRadiusMask;
...
- (double)_screenScale;
-     // Error parsing type: v24@0:8^{?={?=[4]}{?=[4]}{?=[4]}{?=[4]}ffS}16, name: _configureMatricesInUniforms:
@property(readonly, nonatomic) CDStruct_183601bc camera;
- (void)_ensureCornerRadiusMask;
@property(readonly, nonatomic) struct CGRect visibleRectInRenderCoordinates;
@property(readonly, nonatomic) PXGCornerRadiusMask *cornerRadiusMask;
