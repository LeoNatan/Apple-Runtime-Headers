...
@class NSMapTable, NSMutableDictionary, NSMutableIndexSet, NSObject, PXMediaProvider;
...
- (void)_requestImageTexturesForDisplayAsset:(id)arg1 atIndex:(unsigned int)arg2 observer:(id)arg3 presentationStyles:(unsigned long long)arg4 targetSize:(struct CGSize)arg5 screenScale:(double)arg6 textureRequestID:(int)arg7;
