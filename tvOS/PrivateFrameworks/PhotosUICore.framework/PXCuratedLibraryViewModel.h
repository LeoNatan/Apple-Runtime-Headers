...
@property(readonly, nonatomic) CDStruct_0d66156d pinchState; // @synthesize pinchState=_pinchState;
...
- (void)setPinchState:(CDStruct_0d66156d)arg1 withAnchorAssetReference:(id)arg2;
