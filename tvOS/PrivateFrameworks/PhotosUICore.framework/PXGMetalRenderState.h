...
@interface PXGMetalRenderState : NSObject
{
    ...
    // Error parsing type: {?="viewMatrix"{?="columns"[4]}"projectionMatrix"{?="columns"[4]}"viewProjectionMatrix"{?="columns"[4]}"billboardMatrix"{?="columns"[4]}"renderOrigin""screenScale"f"cornerRadiusMaskPixelSide"f"cornerRadiusLastSlice"S}, name: _uniforms
...
// Property attributes: T^{?={?=[4]}{?=[4]}{?=[4]}{?=[4]}ffS},R,N
