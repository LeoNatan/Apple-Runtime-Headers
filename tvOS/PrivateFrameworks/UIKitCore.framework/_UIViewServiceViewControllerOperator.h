...
- (void)__hostViewWillAppear:(_Bool)arg1 inInterfaceOrientation:(long long)arg2 traitCollection:(id)arg3 statusBarHeight:(double)arg4 underlapsStatusBar:(_Bool)arg5 sheetConfiguration:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;
