...
@class NSArray, NSLayoutConstraint, NSObject<SFPersonCollectionViewCellDelegate>, NSProgress, NSString, SFAirDropNode, SFCircleProgressView, SFPersonImageView, UIColor, UILabel, UIView, _TVMonogramView;
