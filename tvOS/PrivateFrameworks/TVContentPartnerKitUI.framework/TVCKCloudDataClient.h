...
@class HSCloudClient, ML3MusicLibrary, NSArray, NSDictionary, NSLock, NSMapTable, NSMutableDictionary, NSNumber, NSObject<OS_dispatch_queue>, NSString, NSTimer, TVSBackgroundTask, TVSDocumentLoader;
