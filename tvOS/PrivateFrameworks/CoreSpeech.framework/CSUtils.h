...
+ (long long)getVoiceProfileImplicitVersionfromVersionFile:(id)arg1;
+ (long long)getVoiceProfileBaseVersionfromVersionFile:(id)arg1;
+ (void)incrementVoiceProfileVersionForUpdateType:(unsigned long long)arg1 forVoiceProfile:(id)arg2;
