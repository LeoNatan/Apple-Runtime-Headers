...
- (long long)attemptLightweightMigrationFromVersion:(id)arg1 onStore:(id)arg2 withMetadata:(id)arg3 orStoreURL:(id)arg4 options:(id)arg5 coordinator:(id)arg6;
...
- (long long)migrateOrCreateDatabaseIfNecessaryWithPersistentContainer:(id)arg1;
