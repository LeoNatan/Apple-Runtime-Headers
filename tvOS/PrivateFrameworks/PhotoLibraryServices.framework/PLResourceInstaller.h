...
+ (_Bool)_installInternalResourcesForExistingAsset:(id)arg1 assumeNoExistingResources:(_Bool)arg2 includeLegacyCloudResources:(_Bool)arg3 outResourcesStoreCount:(unsigned long long *)arg4 error:(id *)arg5;
