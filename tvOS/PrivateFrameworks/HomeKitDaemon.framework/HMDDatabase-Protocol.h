...
- (HMDDatabaseFetchZonesResult *)ownedZonesWithName:(NSString *)arg1 shouldRebuildOnManateeKeyLoss:(_Bool)arg2 delegate:(id <HMBLocalZoneDelegate><HMBCloudZoneDelegate>)arg3 error:(id *)arg4;
