...
- (id)zonesWithID:(id)arg1 isOwned:(_Bool)arg2 shouldRebuildOnManateeKeyLoss:(_Bool)arg3 delegate:(id)arg4 error:(id *)arg5;
...
- (id)ownedZonesWithName:(id)arg1 shouldRebuildOnManateeKeyLoss:(_Bool)arg2 delegate:(id)arg3 error:(id *)arg4;
