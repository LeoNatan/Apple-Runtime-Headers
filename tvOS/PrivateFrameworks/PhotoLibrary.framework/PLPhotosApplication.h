...
@class NSDictionary, NSObject, NSSet, NSString, UIWindow;
...
+ (void)initialize;
@property(retain, nonatomic) NSObject *iPhotoMigrationActivityAlert; // @synthesize iPhotoMigrationActivityAlert=_iPhotoMigrationActivityAlert;
