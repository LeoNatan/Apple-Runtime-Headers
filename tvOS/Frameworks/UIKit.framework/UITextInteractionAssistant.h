...
#import "UITextGestureClusterViewDelegate.h"

@class NSString, UIFieldEditor, UIGestureRecognizer, UILongPressGestureRecognizer, UIResponder<UITextInput>, UIScrollView, UITapGestureRecognizer, UITextChecker, UITextGestureCluster, UITextSelectionView;
