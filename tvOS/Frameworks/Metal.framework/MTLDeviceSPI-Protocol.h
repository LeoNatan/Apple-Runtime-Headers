...
@class MTLCommandQueueDescriptor, MTLComputePipelineDescriptor, MTLIndirectCommandBufferDescriptor, MTLStructType, MTLTextureDescriptor, NSArray, NSData, NSObject, NSString, _MTLIndirectArgumentBufferLayout;
@protocol MTLArgumentEncoder, MTLBuffer, MTLCommandQueue, MTLComputePipelineState, MTLDevice, MTLDeviceSPI, MTLFunction, MTLIndirectArgumentEncoder, MTLIndirectRenderCommandEncoder, MTLLibrary, MTLPipelineLibrarySPI, MTLSharedEvent, MTLTexture, MTLTextureLayout, OS_dispatch_data;
