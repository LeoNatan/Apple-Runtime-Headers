...
@interface VSDeveloperSettings : NSObject <NSSecureCoding>
{
    ...
    _Bool _isCacheBusterEnabled;
    _Bool _requestTimeoutsEnabled;
...
@property(nonatomic) _Bool requestTimeoutsEnabled; // @synthesize requestTimeoutsEnabled=_requestTimeoutsEnabled;
