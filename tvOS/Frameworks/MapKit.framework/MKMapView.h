...
#import "MKMapInteractionControlsViewDelegate.h"
...
@interface MKMapView : UIView <MKOverlayContainerViewDelegate, VKMapViewDelegate, MKMapGestureControllerDelegate, MKAnnotationMarkerContainer, MKAnnotationManagerDelegate, GEOLogContextDelegate, MKRotationFilterDelegate, UIGestureRecognizerDelegate, MKVariableDelayTapRecognizerDelegate, GEOResourceManifestTileGroupObserver, MKMapInteractionControlsViewDelegate, _MKAnnotationSelectionEngineDelegate, NSCoding>
{
    ...
    _Bool _needsAnnotationSelectionUpdateAfterRedraw;
    _Bool _isProcessingSelectionEngine;
    _MKZoomSliderView *_zoomSliderView;
    _MKRightSideOfTrackpadTouchGestureRecognizer *_rightSideTouchpadGestureRecognizer;
    _Bool _isTouchingRightSideOfTouchpad;
