...
@class MKSmallCalloutViewController, NSString, UIInterpolatingMotionEffect, UIMotionEffect, UIPopoverController, UIView, _MKPopoverEmbeddingView;
...
@interface MKPopoverBasedAnnotationCalloutController : MKAnnotationCalloutController <_MKPopoverEmbeddingViewWindowDelegate, _UIPopoverControllerMapsTransitionDelegate, UIPopoverControllerDelegate, UIPopoverControllerDelegatePrivate, MKSmallCalloutViewControllerDelegate>
{
    ...
    UIMotionEffect *_calloutMotionEffect;
    UIInterpolatingMotionEffect *_horizontalRotationMotionEffect;
    UIInterpolatingMotionEffect *_verticalRotationMotionEffect;
    UIInterpolatingMotionEffect *_horizontalTranslationMotionEffect;
    UIInterpolatingMotionEffect *_verticalTranslationMotionEffect;
}
...
- (void)_addMotionEffectsIfNecessary;
- (void)_updateMotionEffectRotation;
