...
@class AVAsset, AVDisplayManager, AVMediaPlayerDelegate, AVPlayer, AVPlayerController, AVPlayerItem, AVPlayerViewController, AVTimeRangeCollection, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>;
