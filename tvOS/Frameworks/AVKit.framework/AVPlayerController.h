...
@class AVDelegateManager, AVNavigationMarkersGroup, AVPlayer, AVPlayerItem, AVQueuePlayer, AVTimeRange, AVTimeRangeCollection, AVValueTiming, NSArray, NSDate, NSDictionary, NSError, NSNumber, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>;
