...
struct WebPage {
    ...
    struct UniqueRef<WebKit::UserMediaPermissionRequestManager> _field69;
...
struct WebPageProxy {
    ...
    struct Optional<WebCore::InputMode> _field45;
    ...
    struct WeakPtr<WebKit::SuspendedPageProxy> _field211;
    struct HashMap<WebKit::WebViewDidMoveToWindowObserver *, WTF::WeakPtr<WebKit::WebViewDidMoveToWindowObserver>, WTF::PtrHash<WebKit::WebViewDidMoveToWindowObserver *>, WTF::HashTraits<WebKit::WebViewDidMoveToWindowObserver *>, WTF::HashTraits<WTF::WeakPtr<WebKit::WebViewDidMoveToWindowObserver>>> _field212;
    struct RefPtr<WTF::Logger, WTF::DumbPtrTraits<WTF::Logger>> _field213;
    struct Optional<WebKit::WebPageProxy::SpeechSynthesisData> _field214;
    _Bool _field215;
};
