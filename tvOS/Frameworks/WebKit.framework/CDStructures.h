...
struct Document {
    ...
    struct RefPtr<WebCore::ScriptedAnimationController, WTF::DumbPtrTraits<WebCore::ScriptedAnimationController>> _field161;
    struct unique_ptr<WebCore::IdleCallbackController, std::__1::default_delete<WebCore::IdleCallbackController>> _field162;
    struct unique_ptr<WebCore::DeviceMotionClient, std::__1::default_delete<WebCore::DeviceMotionClient>> _field163;
    struct unique_ptr<WebCore::DeviceMotionController, std::__1::default_delete<WebCore::DeviceMotionController>> _field164;
    struct unique_ptr<WebCore::DeviceOrientationClient, std::__1::default_delete<WebCore::DeviceOrientationClient>> _field165;
    struct unique_ptr<WebCore::DeviceOrientationController, std::__1::default_delete<WebCore::DeviceOrientationController>> _field166;
    struct unique_ptr<WebCore::DeviceOrientationAndMotionAccessController, std::__1::default_delete<WebCore::DeviceOrientationAndMotionAccessController>> _field167;
    struct GenericTaskQueue<WebCore::Timer> _field168;
    struct Timer _field169;
    struct Vector<WebCore::ScriptExecutionContext::Task, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> _field170;
    struct unique_ptr<WebCore::TextAutoSizing, std::__1::default_delete<WebCore::TextAutoSizing>> _field171;
    struct RefPtr<WebCore::HighlightMap, WTF::DumbPtrTraits<WebCore::HighlightMap>> _field172;
    ...
    _Bool _field250;
    _Bool _field251;
    struct unique_ptr<WebCore::Document::PendingScrollEventTargetList, std::__1::default_delete<WebCore::Document::PendingScrollEventTargetList>> _field252;
    ...
    struct RefPtr<WebCore::DocumentTimeline, WTF::DumbPtrTraits<WebCore::DocumentTimeline>> _field256;
    struct WeakHashSet<WebCore::DocumentTimeline> _field257;
    struct ObjectIdentifier<WebCore::DocumentIdentifierType> _field258;
    struct RefPtr<WebCore::WindowEventLoop, WTF::DumbPtrTraits<WebCore::WindowEventLoop>> _field259;
    struct unique_ptr<WebCore::EventLoopTaskGroup, std::__1::default_delete<WebCore::EventLoopTaskGroup>> _field260;
    ...
    struct unique_ptr<WebCore::DOMTimerHoldingTank, std::__1::default_delete<WebCore::DOMTimerHoldingTank>> _field276;
    struct unique_ptr<WebCore::TextManipulationController, std::__1::default_delete<WebCore::TextManipulationController>> _field277;
...
struct WebPage {
    ...
    struct UniqueRef<WebKit::FindController> _field55;
    struct RefPtr<WebKit::WebInspector, WTF::DumbPtrTraits<WebKit::WebInspector>> _field56;
    struct RefPtr<WebKit::WebInspectorUI, WTF::DumbPtrTraits<WebKit::WebInspectorUI>> _field57;
    struct RefPtr<WebKit::RemoteWebInspectorUI, WTF::DumbPtrTraits<WebKit::RemoteWebInspectorUI>> _field58;
    struct unique_ptr<WebKit::WebPageInspectorTargetController, std::__1::default_delete<WebKit::WebPageInspectorTargetController>> _field59;
    _Bool _field60;
    ...
    struct WebColorChooser *_field63;
    struct WeakPtr<WebKit::WebDataListSuggestionPicker> _field64;
    ...
    _Bool _field86;
    struct Optional<WebCore::IntSize> _field87;
    _Bool _field88;
    _Bool _field89;
    _Bool _field90;
    _Bool _field91;
    OptionSet_05ce0fa5 _field92;
    struct RefPtr<WebCore::Element, WTF::DumbPtrTraits<WebCore::Element>> _field93;
    struct RefPtr<WebCore::Element, WTF::DumbPtrTraits<WebCore::Element>> _field94;
    _Bool _field95;
    _Bool _field96;
    CompletionHandler_531ee0e2 _field97;
    ...
    struct FloatPoint _field104;
    struct RefPtr<WebCore::SecurityOrigin, WTF::DumbPtrTraits<WebCore::SecurityOrigin>> _field105;
    struct ViewportConfiguration _field106;
    _Bool _field107;
    _Bool _field108;
    _Bool _field109;
    _Bool _field110;
    ...
    _Bool _field125;
    _Bool _field126;
    struct HashMap<std::__1::pair<WebCore::IntSize, double>, WebCore::IntPoint, WTF::PairHash<WebCore::IntSize, double>, WTF::HashTraits<std::__1::pair<WebCore::IntSize, double>>, WTF::HashTraits<WebCore::IntPoint>> _field127;
    struct RefPtr<WebCore::Node, WTF::DumbPtrTraits<WebCore::Node>> _field128;
    struct FloatPoint _field129;
    struct FloatRect _field130;
    struct OptionSet<WebKit::WebEvent::Modifier> _field131;
    int _field132;
    unsigned long long _field133;
    struct Optional<unsigned long long> _field134;
    double _field135;
    struct MonotonicObjectIdentifier<WebKit::TransactionIDType> _field136;
    struct CompletionHandler<void (WebKit::InteractionInformationAtPosition &&)> _field137;
    struct Timer _field138;
    struct Vector<WTF::Function<void (bool)>, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> _field139;
    _Bool _field140;
    ...
    struct HashMap<unsigned long long, unsigned long long, WTF::IntHash<unsigned long long>, WTF::HashTraits<unsigned long long>, WTF::HashTraits<unsigned long long>> _field166;
    struct OptionSet<WebKit::WebPage::LayerTreeFreezeReason> _field167;
    _Bool _field168;
    _Bool _field169;
    _Bool _field170;
    struct WeakPtr<WebKit::WebRemoteObjectRegistry> _field171;
    ObjectIdentifier_b2f7915a _field172;
    struct IntSize _field173;
    struct DeferrableOneShotTimer _field174;
    struct unique_ptr<WebKit::LayerHostingContext, std::__1::default_delete<WebKit::LayerHostingContext>> _field175;
    struct Timer _field176;
    struct String _field177;
};
...
struct WebPageProxy {
    ...
    struct Optional<WebCore::InputMode> _field48;
    struct Optional<WebCore::ViewportArguments> _field49;
    struct VisibleContentRectUpdateInfo _field50;
    struct MonotonicObjectIdentifier<WebKit::TransactionIDType> _field51;
    int _field52;
    _Bool _field53;
    _Bool _field54;
    _Bool _field55;
    ...
    struct RefPtr<API::HitTestResult, WTF::DumbPtrTraits<API::HitTestResult>> _field62;
    ...
    _Bool _field68;
    _Bool _field69;
    struct unique_ptr<WebKit::ProcessThrottler::Activity<WebKit::ProcessThrottler::ActivityType::Foreground>, std::__1::default_delete<WebKit::ProcessThrottler::Activity<WebKit::ProcessThrottler::ActivityType::Foreground>>> _field70;
    ...
    struct Timer<WebKit::WebPageProxy> _field74;
    _Bool _field75;
    ...
    _Bool _field111;
    _Bool _field112;
    struct ResourceRequest _field113;
    _Bool _field114;
    ...
    struct Vector<WTF::Function<void ()>, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> _field119;
    ...
    OptionSet_05ce0fa5 _field186;
    _Bool _field187;
    struct Vector<WebKit::CallbackID, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> _field188;
    unsigned int _field189;
    _Bool _field190;
    _Bool _field191;
    _Bool _field192;
    struct Function<bool ()> _field193;
    struct unique_ptr<WebKit::ElementDidFocusArguments, std::__1::default_delete<WebKit::ElementDidFocusArguments>> _field194;
    _Bool _field195;
    _Bool _field196;
    struct FloatSize _field197;
    double _field198;
    double _field199;
    struct FloatSize _field200;
    _Bool _field201;
    struct Optional<WebCore::FontAttributes> _field202;
    _Bool _field203;
    _Bool _field204;
    _Bool _field205;
    _Bool _field206;
    ...
    struct HashMap<WebKit::WebViewDidMoveToWindowObserver *, WTF::WeakPtr<WebKit::WebViewDidMoveToWindowObserver>, WTF::PtrHash<WebKit::WebViewDidMoveToWindowObserver *>, WTF::HashTraits<WebKit::WebViewDidMoveToWindowObserver *>, WTF::HashTraits<WTF::WeakPtr<WebKit::WebViewDidMoveToWindowObserver>>> _field225;
    struct RefPtr<WTF::Logger, WTF::DumbPtrTraits<WTF::Logger>> _field226;
    struct Optional<WebKit::WebPageProxy::SpeechSynthesisData> _field227;
    _Bool _field228;
    _Bool _field229;
    struct String _field230;
    struct unique_ptr<WebKit::WebDeviceOrientationUpdateProviderProxy, std::__1::default_delete<WebKit::WebDeviceOrientationUpdateProviderProxy>> _field231;
    struct MonotonicTime _field232;
};
