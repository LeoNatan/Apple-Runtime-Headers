...
+ (void)setUp;
+ (id)defaultTestSuite;
+ (id)performFailableBlock:(CDUnknownBlockType)arg1 testCase:(id)arg2 testCaseRun:(id)arg3 shouldInterruptTest:(char *)arg4;
...
@property(nonatomic) BOOL hasAttemptedToCaptureScreenshotOnFailure; // @synthesize hasAttemptedToCaptureScreenshotOnFailure=_hasAttemptedToCaptureScreenshotOnFailure;
@property(nonatomic) BOOL shouldIgnoreSubsequentFailures; // @synthesize shouldIgnoreSubsequentFailures=_shouldIgnoreSubsequentFailures;
...
@property(nonatomic) BOOL shouldHaltWhenReceivesControl; // @synthesize shouldHaltWhenReceivesControl=_shouldHaltWhenReceivesControl;
...
@property BOOL _didStopMeasuring; // @synthesize _didStopMeasuring=__didStopMeasuring;
@property BOOL _didStartMeasuring; // @synthesize _didStartMeasuring=__didStartMeasuring;
@property BOOL _didMeasureMetrics; // @synthesize _didMeasureMetrics=__didMeasureMetrics;
@property BOOL _isMeasuringMetrics; // @synthesize _isMeasuringMetrics=__isMeasuringMetrics;
...
@property(nonatomic) BOOL _preciseTimeoutsEnabled; // @synthesize _preciseTimeoutsEnabled=__preciseTimeoutsEnabled;
...
- (void)_enqueueFailureWithDescription:(id)arg1 inFile:(id)arg2 atLine:(unsigned long long)arg3 expected:(BOOL)arg4 interruptTest:(BOOL)arg5 breakWhenDequeued:(BOOL)arg6;
