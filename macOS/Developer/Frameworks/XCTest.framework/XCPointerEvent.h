...
+ (id)textEventForModifierFlags:(unsigned long long)arg1 mergeWithCurrent:(BOOL)arg2 offset:(double)arg3;
...
@property BOOL mergeModifierFlagsWithCurrentFlags; // @synthesize mergeModifierFlagsWithCurrentFlags=_mergeModifierFlagsWithCurrentFlags;
