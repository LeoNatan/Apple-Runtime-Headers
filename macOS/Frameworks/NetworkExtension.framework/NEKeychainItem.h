...
- (void)setChangeACLList:(struct OpaqueSecAccessRef *)arg1;
- (void)updateACLApplicationList:(id)arg1 trustedApplications:(struct __CFArray *)arg2;
- (id)getConfigurationApplicationPath:(id)arg1 bundleID:(id)arg2 vpnpluginType:(id)arg3;
- (id)legacyApplicationPathForID:(id)arg1 vpnpluginType:(id)arg2;
- (id)pluginKitPathForAppBundleID:(id)arg1 providerBundleID:(id)arg2;
- (id)appPathForID:(id)arg1;
- (id)pluginKitPathForID:(id)arg1;
- (id)bundlePathForID:(id)arg1;
- (void)addPathtoTrustedApplications:(id)arg1 trustedApplications:(struct __CFArray *)arg2;
- (void)addToACLapplicationList:(id)arg1;
- (BOOL)copyKeychainItem:(struct OpaqueSecKeychainItemRef **)arg1 copyPrivateKey:(BOOL)arg2;
