...
+     // Error parsing type: c36@0:8I16^{__CFData=}20^{_VPNConfigurationPrivate={__CFRuntimeBase=QAQ}^{__CFString}C^{__CFRunLoopSource}^{__CFRunLoopSource}^{__CFRunLoopSource}^{__CFArray}^?{?=q^v^?^?^?}^?{?=q^v^?^?^?}@^v{ipc_queue=^{IPCMessage}^^{IPCMessage}}@{?=^{_VPNConfigurationPrivate}}}28, name: sendMessageWithType:data:forConfiguration:
