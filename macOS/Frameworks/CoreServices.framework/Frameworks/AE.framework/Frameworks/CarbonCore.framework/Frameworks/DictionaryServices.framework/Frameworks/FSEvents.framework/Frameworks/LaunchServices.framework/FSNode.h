...
+ (BOOL)shimFSRefs:(const struct FSRef *)arg1 count:(long long)arg2 reason:(unsigned long long)arg3 error:(id *)arg4 block:(CDUnknownBlockType)arg5;
+ (BOOL)shimFSRef:(const struct FSRef *)arg1 reason:(unsigned long long)arg2 error:(id *)arg3 block:(CDUnknownBlockType)arg4;
+ (BOOL)getFSRef:(struct FSRef *)arg1 fromURL:(id)arg2 reason:(unsigned long long)arg3 error:(id *)arg4;
...
- (BOOL)getFSRef:(struct FSRef *)arg1 reason:(unsigned long long)arg2 error:(id *)arg3;
- (id)initWithFSRef:(const struct FSRef *)arg1 reason:(unsigned long long)arg2 flags:(unsigned int)arg3 error:(id *)arg4;
...
- (BOOL)getHasCarbon:(char *)arg1 andCFMResources:(char *)arg2 propertyList:(id *)arg3 fromResourceFile:(struct OpaqueResourceFileRef *)arg4 reason:(unsigned long long)arg5 error:(id *)arg6;
