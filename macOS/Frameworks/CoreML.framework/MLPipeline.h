...
+ (id)compileWithModels:(const RepeatedPtrField_f3160e5f *)arg1 toArchive:(struct _MLModelOutputArchiver *)arg2 options:(id)arg3 updatable:(BOOL)arg4 error:(id *)arg5;
