...
@property(readonly, nonatomic) BOOL isConvolutionTranspose; // @synthesize isConvolutionTranspose=_isConvolutionTranspose;
@property(readonly, nonatomic) BOOL isFullyConnected; // @synthesize isFullyConnected=_isFullyConnected;
