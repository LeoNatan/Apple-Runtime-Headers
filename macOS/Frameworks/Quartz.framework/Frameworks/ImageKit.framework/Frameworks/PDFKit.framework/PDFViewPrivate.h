...
@class NSArray, NSColor, NSCursor, NSImmediateActionGestureRecognizer, NSMutableArray, NSTrackingArea, PDFAKOverlayAdaptor, PDFAnnotation, PDFCoachMarkManager, PDFDocument, PDFPage, PDFPageView, PDFPasswordViewController, PDFRenderingProperties, PDFScrollView, PDFSelection, PDFTimer, PDFViewController, PDFViewLayout, RVItem;
