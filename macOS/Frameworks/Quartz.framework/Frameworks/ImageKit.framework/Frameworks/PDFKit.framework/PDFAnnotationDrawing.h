...
+ (BOOL)renderString:(id)arg1 forRect:(struct CGRect)arg2 font:(id)arg3 color:(id)arg4 alignment:(unsigned long long)arg5 rotation:(int)arg6 breaks:(BOOL)arg7 context:(struct CGContext *)arg8 withAnnotation:(id)arg9;
