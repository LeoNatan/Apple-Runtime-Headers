...
@class NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSSQLCore, NSSQLEntity, NSSQLitePrefetchRequestCache, NSSQLiteStatement, NSString, NSURL;
