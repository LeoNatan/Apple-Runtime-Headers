...
@class CKContainer, CKDatabase, CKRecordZone, CKRecordZoneSubscription, NSCloudKitMirroringDelegateMetadata, NSCloudKitMirroringDelegateOptions, NSObject<OS_dispatch_semaphore>, NSPersistentStore, NSPersistentStoreCoordinator, NSURL;
