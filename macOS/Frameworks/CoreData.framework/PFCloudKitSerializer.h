...
@class CKRecordZone, NSArray, NSCloudKitMirroringDelegateOptions, NSDictionary, NSMutableArray, NSMutableDictionary, NSObject<PFCloudKitSerializerDelegate>, NSString, PFCloudKitMirroredRelationshipCache;
