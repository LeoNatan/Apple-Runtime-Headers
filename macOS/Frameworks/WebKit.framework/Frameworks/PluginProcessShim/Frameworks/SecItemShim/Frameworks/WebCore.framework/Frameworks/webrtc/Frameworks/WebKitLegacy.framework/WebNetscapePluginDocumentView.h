...
{
    struct RefPtr<WebNetscapePluginStream, WTF::DumbPtrTraits<WebNetscapePluginStream>> _manualStream;
    struct RetainPtr<CALayer> _pluginLayer;
    unsigned int _dataLengthReceived;
    struct RetainPtr<NSError> _error;
    struct NPObject *_elementNPObject;
    ...
    int drawingModel;
    int eventModel;
    struct unique_ptr<WebNetscapePluginEventHandler, std::__1::default_delete<WebNetscapePluginEventHandler>> _eventHandler;
    BOOL inSetWindow;
    BOOL shouldStopSoon;
    unsigned int currentTimerID;
    struct unique_ptr<WTF::HashMap<unsigned int, std::__1::unique_ptr<PluginTimer, std::__1::default_delete<PluginTimer>>, WTF::IntHash<unsigned int>, WTF::HashTraits<unsigned int>, WTF::HashTraits<std::__1::unique_ptr<PluginTimer, std::__1::default_delete<PluginTimer>>>>, std::__1::default_delete<WTF::HashMap<unsigned int, std::__1::unique_ptr<PluginTimer, std::__1::default_delete<PluginTimer>>, WTF::IntHash<unsigned int>, WTF::HashTraits<unsigned int>, WTF::HashTraits<std::__1::unique_ptr<PluginTimer, std::__1::default_delete<PluginTimer>>>>>> timers;
    unsigned int pluginFunctionCallDepth;
    int specifiedHeight;
    int specifiedWidth;
    struct HashSet<WTF::RefPtr<WebNetscapePluginStream, WTF::DumbPtrTraits<WebNetscapePluginStream>>, WTF::PtrHash<WTF::RefPtr<WebNetscapePluginStream, WTF::DumbPtrTraits<WebNetscapePluginStream>>>, WTF::HashTraits<WTF::RefPtr<WebNetscapePluginStream, WTF::DumbPtrTraits<WebNetscapePluginStream>>>> streams;
