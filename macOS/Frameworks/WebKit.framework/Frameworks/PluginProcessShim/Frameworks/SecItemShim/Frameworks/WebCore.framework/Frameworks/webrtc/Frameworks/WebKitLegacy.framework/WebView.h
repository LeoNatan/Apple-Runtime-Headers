...
@property(nonatomic, setter=_setUseInactiveAppearance:) BOOL _useInactiveAppearance;
...
- (Vector_1e8b6c82)_dictationAlternatives:(unsigned long long)arg1;
...
- (void)_getWebCoreDictationAlternatives:(Vector_b590eb53 *)arg1 fromTextAlternatives:(const Vector_59d1e414 *)arg2;
