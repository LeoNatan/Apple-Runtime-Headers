...
#import <WebKitLegacy/WebCoreFrameScrollView-Protocol.h>
...
- (void)setVerticalScrollingMode:(unsigned char)arg1 andLock:(BOOL)arg2;
- (void)setHorizontalScrollingMode:(unsigned char)arg1 andLock:(BOOL)arg2;
