...
#import <WebKitLegacy/NSDraggingSource-Protocol.h>
#import <WebKitLegacy/NSTextInput-Protocol.h>
...
- (unsigned char)_undoActionFromColorPanelWithSelector:(SEL)arg1;
...
- (id)_web_documentFragmentFromPasteboard:(id)arg1 pasteboardType:(id)arg2 imageMIMEType:(id)arg3;
- (void)close;
...
- (void)_setSoftSpaceRange:(struct _NSRange)arg1;
...
- (id)attributedString;
- (id)_legacyAttributedStringFrom:(id)arg1 offset:(int)arg2 to:(id)arg3 offset:(int)arg4;
