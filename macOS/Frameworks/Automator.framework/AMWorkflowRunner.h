...
@class AMAction, AMWorkflow, NSArray, NSError, NSMapTable, NSMutableArray, NSMutableDictionary, NSObject<AMWorkflowRunnerDelegate>, NSOperationQueue, NSProgress, NSString;
