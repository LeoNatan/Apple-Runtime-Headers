...
- (void)unsubscribeFromContextValueChangeNotificationsFromPeer:(_DKSyncPeer *)arg1 registrationIdentifier:(NSString *)arg2 predicateIdentifier:(NSString *)arg3 highPriority:(BOOL)arg4 completion:(void (^)(NSError *))arg5;
- (void)subscribeToContextValueChangeNotificationsFromPeer:(_DKSyncPeer *)arg1 registrationIdentifier:(NSString *)arg2 predicateIdentifier:(NSString *)arg3 highPriority:(BOOL)arg4 completion:(void (^)(NSError *))arg5;
@end
