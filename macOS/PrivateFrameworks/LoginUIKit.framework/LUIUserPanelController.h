...
@class CNAvatarViewController, LUIClickableImageView, LUIEffectsButton, LUISecureTextFieldView, NSTextField, NSView;
...
@interface LUIUserPanelController : LUIPanelController
{
    ...
    LUIClickableImageView *_userPictureImageView;
...
- (void)_userPicturePressed:(id)arg1;
