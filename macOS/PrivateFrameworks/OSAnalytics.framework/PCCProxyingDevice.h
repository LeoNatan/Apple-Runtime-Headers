...
#import <OSAnalytics/NSXPCListenerDelegate-Protocol.h>
#import <OSAnalytics/OSASyncProxyServices-Protocol.h>
...
- (void)addRequest:(id)arg1 onComplete:(CDUnknownBlockType)arg2;
