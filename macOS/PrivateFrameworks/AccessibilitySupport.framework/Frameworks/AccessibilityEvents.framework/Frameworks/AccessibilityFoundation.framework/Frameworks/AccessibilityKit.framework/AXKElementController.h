...
- (id)_copyAttachmentDescriptionForAttributedString:(id)arg1;
- (id)_copyDescriptionForAttributedString:(id)arg1;
- (id)_copyChildrenSpokenDescription;
- (id)_textForSpokenDescription;
...
- (BOOL)needToRebuildChilControllers;
