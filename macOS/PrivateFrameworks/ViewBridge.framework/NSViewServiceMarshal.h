...
@class NSAccessibilityRemoteUIElement, NSArray, NSCFRunLoopObserver, NSColor, NSDictionary, NSLayoutConstraint, NSMutableArray, NSProxy<NSXPCProxyCreating>, NSResponder, NSServiceViewController, NSString, NSVB_ViewServiceBehaviorProxy, NSViewBridge, NSXPCConnection, NSXPCInterface;
