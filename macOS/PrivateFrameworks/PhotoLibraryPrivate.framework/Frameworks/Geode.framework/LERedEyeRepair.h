...
@interface LERedEyeRepair : NSObject
{
    BOOL ownLF;
...
- (void)setDataStructUsingInternalRectOffset:(CDStruct_88c8157e *)arg1 fromDictionary:(id)arg2 scalingForHeight:(float)arg3 andWidth:(float)arg4;
- (void)setDataStruct:(CDStruct_88c8157e *)arg1 fromDictionary:(id)arg2 scalingForHeight:(float)arg3 andWidth:(float)arg4;
...
- (int)RERBase2:(struct CGPoint)arg1 alignPupilShades:(BOOL)arg2 matching:(CDStruct_a734b2e2)arg3 force:(int)arg4 IOD:(float)arg5;
