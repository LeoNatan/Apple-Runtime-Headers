...
@interface PAPlatform : NSObject
{
    ...
    unsigned long long _pixelPipelineSourceCacheSize;
    unsigned long long _pixelPipelinePipelineCacheSize;
}

+ (id)platform;
@property BOOL hasRetainedDiscreteGPU; // @synthesize hasRetainedDiscreteGPU=_hasRetainedDiscreteGPU;
@property(readonly) unsigned long long pixelPipelinePipelineCacheSize; // @synthesize pixelPipelinePipelineCacheSize=_pixelPipelinePipelineCacheSize;
@property(readonly) unsigned long long pixelPipelineSourceCacheSize; // @synthesize pixelPipelineSourceCacheSize=_pixelPipelineSourceCacheSize;
