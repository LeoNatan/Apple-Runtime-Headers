...
@class CAMediaTimingFunction, MOAssetsMediaView, MOMediaItem, NSColor, NSString, NSTrackingArea;
...
@interface MOAssetsView : NSView <MOMediaViewDataSource, MOMediaViewDelegate, MOAssetsMediaViewDelegate>
{
    ...
    BOOL _shouldDeselectAllOnBackgroundClick;
    struct {
...
@property(nonatomic) BOOL shouldDeselectAllOnBackgroundClick; // @synthesize shouldDeselectAllOnBackgroundClick=_shouldDeselectAllOnBackgroundClick;
...
- (double)mainFooterHeightForAssetsMediaView:(id)arg1;
...
- (long long)assetsMediaView:(id)arg1 allowedDropPositionsForItemsAtIndexPaths:(id)arg2 movedToIndexPath:(id)arg3;
...
- (void)_getHasFooter:(char *)arg1 includingWhenInbounds:(char *)arg2 footerHeight:(double *)arg3;
