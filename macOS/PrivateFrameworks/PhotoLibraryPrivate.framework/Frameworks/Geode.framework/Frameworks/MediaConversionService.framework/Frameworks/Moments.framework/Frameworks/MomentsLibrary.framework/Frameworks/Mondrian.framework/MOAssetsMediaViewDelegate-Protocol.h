...
@class MOAssetsMediaView, MOPhotosSupplementaryFooterInfo, NSArray, NSAttributedString, NSIndexPath;
...
- (double)mainFooterHeightForAssetsMediaView:(MOAssetsMediaView *)arg1;
...
- (long long)assetsMediaView:(MOAssetsMediaView *)arg1 allowedDropPositionsForItemsAtIndexPaths:(NSArray *)arg2 movedToIndexPath:(NSIndexPath *)arg3;
@end
