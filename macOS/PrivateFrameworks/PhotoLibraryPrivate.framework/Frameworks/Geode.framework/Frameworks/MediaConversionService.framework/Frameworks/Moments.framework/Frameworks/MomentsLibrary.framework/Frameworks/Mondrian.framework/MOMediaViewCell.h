...
@interface MOMediaViewCell : UXCollectionViewCell
{
    ...
    BOOL _bagdesVisibleWhileScrolling;
}

@property(nonatomic) BOOL bagdesVisibleWhileScrolling; // @synthesize bagdesVisibleWhileScrolling=_bagdesVisibleWhileScrolling;
