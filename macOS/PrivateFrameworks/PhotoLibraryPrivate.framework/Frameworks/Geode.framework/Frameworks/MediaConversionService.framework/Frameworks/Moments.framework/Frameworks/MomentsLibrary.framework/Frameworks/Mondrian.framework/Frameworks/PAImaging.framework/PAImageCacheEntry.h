...
@property(readonly) unsigned short imageStyle;
...
- (id)initWithImageRequest:(id)arg1 cacheKey:(id)arg2 invalidationKey:(id)arg3 buffer:(id)arg4 imageStyle:(unsigned short)arg5 scaled:(BOOL)arg6 cgImageProperties:(id)arg7 colorProfile:(id)arg8 masterToRasterOrientation:(long long)arg9 rasterToDisplayOrientation:(long long)arg10 requestedSubsampleFactor:(unsigned long long)arg11 error:(id)arg12;
