...
+ (id)inputKeyWithHue:(int)arg1 type:(int)arg2;
+ (id)inputKeysWithType:(int)arg1;
...
- (void).cxx_destruct;
- (BOOL)isMaskable;
- (id)prepareSHL:(id)arg1 withHueBase:(double)arg2 hueShift:(double)arg3 saturation:(double)arg4 luminance:(double)arg5 spread:(double)arg6 forRange:(unsigned long long)arg7;
