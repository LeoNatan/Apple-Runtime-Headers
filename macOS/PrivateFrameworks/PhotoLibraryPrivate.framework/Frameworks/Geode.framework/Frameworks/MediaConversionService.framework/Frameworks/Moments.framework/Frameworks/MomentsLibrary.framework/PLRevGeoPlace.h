...
+ (id)geoAsPlaceInfoFromMapItem:(id)arg1;
...
- (id)_filterSortedPlaceInfos:(id)arg1 usingPlaceAnnotation:(id)arg2;
...
- (id)initWithGEOMapItem:(id)arg1 placeAnnotation:(id)arg2;
- (void)dealloc;
- (id)init;
