...
@class CLLocation, NSDate, NSDateFormatter, NSDictionary, NSMutableArray, NSMutableOrderedSet, NSMutableSet, NSOrderedSet, NSString, PLMomentAnalyzerQueue, PLMomentAnalyzerWorkThread;
...
- (BOOL)updateInfoForYearMomentListsWithIDs:(id)arg1;
- (BOOL)updateInfoForMegaMomentListsWithIDs:(id)arg1;
- (BOOL)updateInfoForMomentWithMomentId:(id)arg1 fromOnDemandRequest:(BOOL)arg2;
- (BOOL)updateInfoForMomentsWithIDs:(id)arg1 invalidOnly:(BOOL)arg2;
...
- (id)_updateDominantInfoInCompoundNameInfo:(id)arg1 withRevGeoPlaces:(id)arg2 defaultGeoOrderingSet:(id)arg3 includeAllPlaces:(BOOL)arg4 includeHome:(BOOL)arg5 homeAtEnd:(BOOL)arg6 outOtherNonDominantPlaces:(id)arg7 outOrdersCheckedOrUsed:(id)arg8 outOrderUsed:(unsigned long long *)arg9 outUsedHome:(char *)arg10;
...
- (BOOL)_abortIfInvalidDataManager:(id)arg1;
...
- (id)init;
- (void)startAnalyzer;
- (BOOL)_checkForNewServerVersionInfoIfNeeded;
- (void)dealloc;
