...
@protocol RKPreset <NSObject, NSCopying>
- (BOOL)isNotFolder;
...
@optional
- (void)replaceObjectInChildPresetsAtIndex:(unsigned long long)arg1 withObject:(id <RKPreset>)arg2;
- (void)removeObjectFromChildPresetsAtIndex:(unsigned long long)arg1;
- (void)insertObject:(id <RKPreset>)arg1 inChildPresetsAtIndex:(unsigned long long)arg2;
