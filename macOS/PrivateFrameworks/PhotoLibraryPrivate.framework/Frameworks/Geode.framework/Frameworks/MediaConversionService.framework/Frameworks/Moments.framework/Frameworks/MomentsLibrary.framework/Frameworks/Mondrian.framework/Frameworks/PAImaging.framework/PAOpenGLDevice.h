...
@class NSDictionary, NSObject, NSString, PAHistogramCalculator, PAJobQueue, PAOpenCLDevice, PAOpenGLContextPool, PARenderer, _PALowPriorityOpenGLDevice;
...
- (BOOL)isDiscrete;
- (BOOL)isIntegrated;
- (void)monitorFence:(id)arg1 handler:(CDUnknownBlockType)arg2;
