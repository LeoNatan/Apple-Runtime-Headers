...
@class CropInteractionContext, NSString, PACanvasItemView, PACropModel, PACropModelEditor, PADescriptionEditController, PAImageItemView, PAImageItemViewController, PAImageItemViewMode, PAItemViewConfiguration, PFTraceBuffer;
