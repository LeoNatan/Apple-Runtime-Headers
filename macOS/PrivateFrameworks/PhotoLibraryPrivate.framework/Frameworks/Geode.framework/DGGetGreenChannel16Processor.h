...
@interface DGGetGreenChannel16Processor : NSObject <DGConstImageProcessor>
{
    struct PFIntRect_st _destArea;
    unsigned short *_destPtr;
    long long _rowBytes;
}

- (void)processConstArea:(struct PFIntRect_st)arg1 bufferPtr:(const void *)arg2 rowBytes:(long long)arg3 format:(int)arg4;
- (id)initWithArea:(struct PFIntRect_st)arg1 destPtr:(unsigned short *)arg2 rowBytes:(long long)arg3;
