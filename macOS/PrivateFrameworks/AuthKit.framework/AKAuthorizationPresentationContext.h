...
@property(readonly, nonatomic) BOOL isRapportLogin; // @synthesize isRapportLogin=_isRapportLogin;
@property(readonly, nonatomic) BOOL isFirstPartyLogin; // @synthesize isFirstPartyLogin=_isFirstPartyLogin;
