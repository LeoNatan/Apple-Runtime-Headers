...
+ (id)_navigation_stringWithCountdownValue:(id)arg1 inToken:(id)arg2 options:(CDStruct_03e639ae)arg3;
+ (id)_navigation_stringWithTimeStampValues:(id)arg1 options:(CDStruct_03e639ae)arg2;
+ (id)_navigation_replacementForFormatToken:(id)arg1 options:(CDStruct_03e639ae)arg2 overrideVariables:(id)arg3;
...
+ (id)_navigation_stringForServerFormattedString:(id)arg1 options:(CDStruct_03e639ae)arg2 overrideVariables:(id)arg3;
