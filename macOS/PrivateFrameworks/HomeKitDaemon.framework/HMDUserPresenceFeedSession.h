...
@class HMDCentralMessageDispatcher, HMDDevice, HMDHomeManager, HMDUser, HMDUserPresenceFeedRetryTimer, HMDUserPresenceRegion, HMDUserPresenceUpdateReason, HMUserPresenceAuthorization, HMUserPresenceCompute, NSDate, NSObject<OS_dispatch_queue>, NSString, NSUUID;
