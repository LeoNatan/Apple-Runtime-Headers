...
- (void)processIncomingPacket:(CDStruct_bc1e3e42 *)arg1;
...
- (struct IDSTCPConnection_ *)_getIDSTCPConnection:(CDStruct_bc1e3e42 *)arg1;
- (long long)getPacketLength:(CDStruct_bc1e3e42 *)arg1 isChannelData:(char *)arg2;
