...
@class CSKDatabaseHandle, CSKStreamArchiveStatistics, NSArray, NSDate, NSDictionary, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, NSURL, OSLogPersistence;
