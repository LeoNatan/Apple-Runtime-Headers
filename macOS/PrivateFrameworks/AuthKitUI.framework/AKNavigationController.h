...
@class NSArray, NSBox, NSButton, NSStackView, NSTextField, NSView;
...
@property(retain) NSStackView *rightBarStackView; // @synthesize rightBarStackView=_rightBarStackView;
