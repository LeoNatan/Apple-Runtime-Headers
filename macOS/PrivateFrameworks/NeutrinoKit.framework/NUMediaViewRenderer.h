...
@class AVComposition, NSArray, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSView, NUAVPlayerController, NUCoalescer, NUColorSpace, NUComposition, NULivePhotoRenderClient, NUMediaView, NUPixelFormat, NUResponse, NUSurfaceRenderClient, NUVideoRenderClient;
