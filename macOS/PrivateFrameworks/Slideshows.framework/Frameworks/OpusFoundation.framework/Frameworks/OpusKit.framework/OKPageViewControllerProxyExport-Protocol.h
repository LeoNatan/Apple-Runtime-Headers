...
- (OKWidgetView *)widgetWithTemplateName:(NSString *)arg1 andSettings:(NSDictionary *)arg2;
...
- (OKWidgetView *)widgetWithTemplateName:(NSString *)arg1 andSettings:(NSDictionary *)arg2 __JS_EXPORT_AS__widgetFromTemplate:(id)arg3;
@end
