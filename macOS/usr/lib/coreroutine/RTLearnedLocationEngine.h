...
- (id)createRelabeler;
- (id)getRelabeledInferredMapItemForCandidate:(struct RTPair *)arg1 relabeler:(id)arg2 loiIdentifierToCoalescedSourceMap:(id)arg3 submitMetrics:(BOOL)arg4 error:(id *)arg5;
