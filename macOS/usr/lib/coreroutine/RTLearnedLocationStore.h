...
- (void)removeUserCorrectionsForMapItem:(id)arg1 handler:(CDUnknownBlockType)arg2;
- (void)_removeUserCorrectionsForMapItem:(id)arg1 handler:(CDUnknownBlockType)arg2;
- (void)_removeAllUserCorrectionsWithHandler:(CDUnknownBlockType)arg1;
...
- (void)_fetchUserCorrectionsForMapItem:(id)arg1 predicate:(id)arg2 handler:(CDUnknownBlockType)arg3;
- (void)fetchUserCorrectionsForMapItem:(id)arg1 predicate:(id)arg2 handler:(CDUnknownBlockType)arg3;
- (void)fetchUserCorrectionsWithPredicate:(id)arg1 handler:(CDUnknownBlockType)arg2;
- (void)fetchUserCorrectionsWithHandler:(CDUnknownBlockType)arg1;
...
- (void)updateUserCorrections:(id)arg1 handler:(CDUnknownBlockType)arg2;
...
- (void)updateExpirationDateOfUserCorrectionsWithIdentifiers:(id)arg1 mapItemIdentifiers:(id)arg2 expirationDate:(id)arg3 handler:(CDUnknownBlockType)arg4;
- (void)_updateExpirationDateOfUserCorrectionsWithIdentifiers:(id)arg1 mapItemIdentifiers:(id)arg2 expirationDate:(id)arg3 handler:(CDUnknownBlockType)arg4;
...
- (void)storeUserCorrections:(id)arg1 handler:(CDUnknownBlockType)arg2;
