...
struct Document {
    ...
    struct GenericTaskQueue<WebCore::Timer> _field167;
    struct Timer _field168;
    struct Vector<WebCore::ScriptExecutionContext::Task, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> _field169;
    struct unique_ptr<WebCore::TextAutoSizing, std::__1::default_delete<WebCore::TextAutoSizing>> _field170;
    struct RefPtr<WebCore::HighlightMap, WTF::DumbPtrTraits<WebCore::HighlightMap>> _field171;
    ...
    struct HashMap<WTF::AtomString, std::__1::unique_ptr<WebCore::Locale, std::__1::default_delete<WebCore::Locale>>, WTF::AtomStringHash, WTF::HashTraits<WTF::AtomString>, WTF::HashTraits<std::__1::unique_ptr<WebCore::Locale, std::__1::default_delete<WebCore::Locale>>>> _field175;
    struct RefPtr<WebCore::Document, WTF::DumbPtrTraits<WebCore::Document>> _field176;
    struct WeakPtr<WebCore::Document> _field177;
    struct Ref<WebCore::CSSFontSelector, WTF::DumbPtrTraits<WebCore::CSSFontSelector>> _field178;
    struct WeakHashSet<WebCore::MediaProducer> _field179;
    ...
    _Bool _field249;
    _Bool _field250;
    struct unique_ptr<WebCore::Document::PendingScrollEventTargetList, std::__1::default_delete<WebCore::Document::PendingScrollEventTargetList>> _field251;
    struct OrientationNotifier _field252;
    struct RefPtr<WTF::Logger, WTF::DumbPtrTraits<WTF::Logger>> _field253;
    struct RefPtr<WebCore::StringCallback, WTF::DumbPtrTraits<WebCore::StringCallback>> _field254;
    struct RefPtr<WebCore::DocumentTimeline, WTF::DumbPtrTraits<WebCore::DocumentTimeline>> _field255;
    struct WeakHashSet<WebCore::DocumentTimeline> _field256;
    struct ObjectIdentifier<WebCore::DocumentIdentifierType> _field257;
    struct RefPtr<WebCore::WindowEventLoop, WTF::DumbPtrTraits<WebCore::WindowEventLoop>> _field258;
    struct unique_ptr<WebCore::EventLoopTaskGroup, std::__1::default_delete<WebCore::EventLoopTaskGroup>> _field259;
    ...
    _Bool _field271;
    _Bool _field272;
    struct Ref<WebCore::UndoManager, WTF::DumbPtrTraits<WebCore::UndoManager>> _field273;
    struct unique_ptr<WebCore::ContentChangeObserver, std::__1::default_delete<WebCore::ContentChangeObserver>> _field274;
    struct unique_ptr<WebCore::DOMTimerHoldingTank, std::__1::default_delete<WebCore::DOMTimerHoldingTank>> _field275;
    struct unique_ptr<WebCore::TextManipulationController, std::__1::default_delete<WebCore::TextManipulationController>> _field276;
