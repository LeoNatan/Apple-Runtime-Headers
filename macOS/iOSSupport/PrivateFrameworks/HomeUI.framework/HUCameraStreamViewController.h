...
@interface HUCameraStreamViewController : UIViewController <HFItemManagerDelegate, HUPresentationDelegate, HFExecutionEnvironmentObserver, HUItemPresentationContainer, HUPresentationDelegateHost>
{
