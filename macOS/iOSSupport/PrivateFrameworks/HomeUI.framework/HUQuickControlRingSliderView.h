...
- (void)_updateUIForThresholdModeForSecondaryHandleViewWithTouch:(id)arg1 didTouchBegin:(BOOL)arg2;
- (void)_updateUIForThresholdModeForPrimaryHandleViewWithTouchPoint:(struct CGPoint)arg1 didTouchBegin:(BOOL)arg2;
- (void)_updateUIForThresholdModeForPrimaryHandleViewWithTouch:(id)arg1 didTouchBegin:(BOOL)arg2;
- (void)_updateUIForTouchPoint:(struct CGPoint)arg1 didTouchBegin:(BOOL)arg2 forHandleView:(id)arg3 minAngle:(double)arg4 maxAngle:(double)arg5;
- (void)_updateUIForTouch:(id)arg1 didTouchBegin:(BOOL)arg2 forHandleView:(id)arg3 minAngle:(double)arg4 maxAngle:(double)arg5;
- (void)_updateUIWithTouch:(id)arg1 didTouchBegin:(BOOL)arg2;
