...
@property(nonatomic) BOOL scrollsUnder; // @synthesize scrollsUnder=_scrollsUnder;
...
- (long long)backdropStyleForScrollingUnder:(BOOL)arg1;
- (void)updateForContentScrollingUnder:(BOOL)arg1 animated:(BOOL)arg2;
