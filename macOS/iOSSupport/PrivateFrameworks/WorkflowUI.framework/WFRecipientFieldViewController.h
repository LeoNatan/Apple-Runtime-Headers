...
@class CNAutocompleteFetchContext, MFAutocompleteResultsTableViewController, MFComposeRecipientTextView, MFContactsSearchManager, NSArray, NSMutableArray, NSNumber, NSSet, NSString, UIScrollView, UITableView, WFContactPickerCoordinator;
...
- (id)_searchManager;
- (BOOL)_zeroKeywordSearchEnabled;
