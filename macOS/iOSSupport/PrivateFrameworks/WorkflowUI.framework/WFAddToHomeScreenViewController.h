...
@class NSString, WFAddToHomeIconPreviewCell, WFWorkflow, WFWorkflowIcon, WFWorkflowWizardNameCell;
...
@property(nonatomic) BOOL useWorkflowIcon; // @synthesize useWorkflowIcon=_useWorkflowIcon;
@property(retain, nonatomic) WFWorkflowIcon *selectedImage; // @synthesize selectedImage=_selectedImage;
