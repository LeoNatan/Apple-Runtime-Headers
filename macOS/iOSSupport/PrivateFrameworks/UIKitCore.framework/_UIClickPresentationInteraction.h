...
@class NSMutableArray, NSString, UIDragInteraction, UIGestureRecognizer, UIView, _UIClickInteraction, _UIClickPresentation, _UIClickPresentationAssistant, _UIGestureStudyInteraction, _UIRelationshipGestureRecognizer, _UIStateMachine;
...
- (BOOL)_beginDragIfPossibleWithTouch:(id)arg1;
- (BOOL)_staging_beginDragIfPossibleWithTouch:(id)arg1;
