...
- (BOOL)hasUserBackgroundImagePositionAdjustmentForState:(long long)arg1;
- (BOOL)hasUserBackgroundImageForState:(long long)arg1;
- (BOOL)hasUserTitlePositionAdjustmentForState:(long long)arg1;
- (BOOL)hasUserTitleTextAttributesForState:(long long)arg1;
