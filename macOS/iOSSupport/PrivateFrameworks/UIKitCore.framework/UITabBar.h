...
@property(nonatomic, setter=_setFocusedItemShouldAppearFocused:) BOOL shouldForceFocusedState; // @synthesize shouldForceFocusedState=_shouldForceFocusedState;
