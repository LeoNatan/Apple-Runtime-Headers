...
@interface CKUITheme : NSObject
{
    ...
    UIColor *_entryFieldEmojiButtonColor;
}

@property(readonly, nonatomic) UIColor *entryFieldEmojiButtonColor; // @synthesize entryFieldEmojiButtonColor=_entryFieldEmojiButtonColor;
