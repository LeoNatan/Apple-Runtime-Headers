...
@interface CKUIBehavior : NSObject
{
    ...
    UIImage *_genericDocumentIcon;
    UIImage *_errorDocumentIcon;
    UIImage *_textDocumentIcon;
    double _audioButtonTopMargin;
    double _entryViewVerticalInset;
    double _emojiButtonSize;
    double _emojiButtonRightMargin;
    NSString *_audiobuttonImageNameMarzipan;
    double _marzNavigationBarHeight;
    NSAttributedString *_iosMacDetailsButtonText;
    double _spaceBetweenSearchBarAndComposeButton;
    double _minConversationListWidth;
    double _maxConversationListWidth;
    struct UIEdgeInsets _entryViewContentInsets;
    struct UIEdgeInsets _searchNavbarCanvasInsets;
}

+ (id)fontWithStyle:(id)arg1 adjustedForMaxSizeCategory:(id)arg2;
+ (id)orderedContentSizeCategories;
+ (id)sharedBehaviors;
@property(readonly, nonatomic) double maxConversationListWidth; // @synthesize maxConversationListWidth=_maxConversationListWidth;
@property(readonly, nonatomic) double minConversationListWidth; // @synthesize minConversationListWidth=_minConversationListWidth;
@property(readonly, nonatomic) double spaceBetweenSearchBarAndComposeButton; // @synthesize spaceBetweenSearchBarAndComposeButton=_spaceBetweenSearchBarAndComposeButton;
@property(readonly, nonatomic) struct UIEdgeInsets searchNavbarCanvasInsets; // @synthesize searchNavbarCanvasInsets=_searchNavbarCanvasInsets;
@property(readonly, nonatomic) NSAttributedString *iosMacDetailsButtonText; // @synthesize iosMacDetailsButtonText=_iosMacDetailsButtonText;
@property(readonly, nonatomic) double marzNavigationBarHeight; // @synthesize marzNavigationBarHeight=_marzNavigationBarHeight;
@property(readonly, nonatomic) NSString *audiobuttonImageNameMarzipan; // @synthesize audiobuttonImageNameMarzipan=_audiobuttonImageNameMarzipan;
@property(readonly, nonatomic) double emojiButtonRightMargin; // @synthesize emojiButtonRightMargin=_emojiButtonRightMargin;
@property(readonly, nonatomic) double emojiButtonSize; // @synthesize emojiButtonSize=_emojiButtonSize;
@property(readonly, nonatomic) double entryViewVerticalInset; // @synthesize entryViewVerticalInset=_entryViewVerticalInset;
...
@property(readonly, nonatomic) double audioButtonTopMargin; // @synthesize audioButtonTopMargin=_audioButtonTopMargin;
@property(readonly, nonatomic) UIImage *textDocumentIcon; // @synthesize textDocumentIcon=_textDocumentIcon;
@property(readonly, nonatomic) UIImage *errorDocumentIcon; // @synthesize errorDocumentIcon=_errorDocumentIcon;
@property(readonly, nonatomic) UIImage *genericDocumentIcon; // @synthesize genericDocumentIcon=_genericDocumentIcon;
...
@property(readonly, nonatomic) BOOL canAccessPhotos; // @synthesize canAccessPhotos=_canAccessPhotos;
