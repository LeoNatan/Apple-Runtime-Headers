...
- (id)personViewControllerWithDelegate:(id)arg1 isUnknown:(char *)arg2 contactStoreProvider:(id)arg3;
- (id)personViewControllerWithDelegate:(id)arg1 isUnknown:(char *)arg2;
