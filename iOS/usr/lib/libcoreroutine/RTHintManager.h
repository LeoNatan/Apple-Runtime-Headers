...
@class NSObject<OS_dispatch_queue>, NSString, RTBatteryManager, RTBluetoothManager, RTCameraManager, RTLearnedLocationManager, RTLocationManager, RTMetricManager, RTNavigationManager, RTPersistenceManager, RTPlatform, RTReachabilityManager, RTWalletManager;
