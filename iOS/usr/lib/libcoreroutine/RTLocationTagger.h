...
@class NSObject<OS_dispatch_queue>, RTAuthorizationManager, RTInvocationDispatcher, RTLearnedLocationManager, RTLocationManager, RTLocationOfInterest, RTMicroLocation, RTVisitManager;
