...
@class MCNearbyServiceBrowser, MCPeerID, MCSession, NSBundle, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, UIBarButtonItem, UINavigationBar, UITableView;
