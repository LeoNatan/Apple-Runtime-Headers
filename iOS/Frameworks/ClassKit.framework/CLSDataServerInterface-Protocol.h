...
@class NSArray, NSDictionary, NSObject<CLSChangeNotifiable>, NSObject<CLSQuery>, NSObject<CLSSaveResponse>, NSPredicate, NSString;
...
- (oneway void)remote_authStatusesForContextsAtPaths:(NSDictionary *)arg1 completion:(void (^)(NSDictionary *, NSError *))arg2;
