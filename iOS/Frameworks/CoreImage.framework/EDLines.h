...
{
    _Bool _cartesianCoordinates;
    _Bool _checkInsetsOnInitialDetection;
    ...
    struct UIEdgeInsets _lineSegmentRejectionInsets;
...
@property(nonatomic) _Bool checkInsetsOnInitialDetection; // @synthesize checkInsetsOnInitialDetection=_checkInsetsOnInitialDetection;
@property(nonatomic) _Bool cartesianCoordinates; // @synthesize cartesianCoordinates=_cartesianCoordinates;
...
@property(nonatomic) struct UIEdgeInsets lineSegmentRejectionInsets; // @synthesize lineSegmentRejectionInsets=_lineSegmentRejectionInsets;
...
- (void).cxx_destruct;
- (double)leastSquaresLineFitWithXCoordinates:(unsigned short *)arg1 yCoordinates:(unsigned short *)arg2 length:(unsigned int)arg3 m:(double *)arg4 n:(double *)arg5 context:(CDStruct_bae50541 *)arg6 updateFromContext:(_Bool)arg7;
- (double)leastSquaresLineFitWithXCoordinates:(unsigned short *)arg1 yCoordinates:(unsigned short *)arg2 length:(unsigned int)arg3 equation:(CDStruct_2815125f *)arg4 context:(CDStruct_bae50541 *)arg5 udpateFromContext:(_Bool)arg6 from:(id)arg7;
- (unsigned char)validateLineSegment:(unsigned short *)arg1 yBuffer:(unsigned short *)arg2 length:(unsigned int)arg3 equation:(CDStruct_2815125f)arg4 relativeError:(double)arg5 resultingLineSegment:(struct DetectedLineSegment *)arg6 from:(id)arg7;
...
- (_Bool)validateEndPointsAgainstRejectionInsets:(struct CGPoint)arg1 endPoint:(struct CGPoint)arg2;
