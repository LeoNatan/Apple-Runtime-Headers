...
@class EKStructuredLocation, MKCircleRenderer, MKMapView, MKPointAnnotation, NSCache, NSMutableArray, NSObject<OS_dispatch_queue>, NSSet, NSString, UISearchBar, UITableView, UIView;
