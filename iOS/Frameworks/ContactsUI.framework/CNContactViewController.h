...
@class CNContact, CNContactContentViewController, CNContactFormatter, CNContactStore, CNContainer, CNGroup, CNPolicy, NSArray, NSString, UIView, UIViewController<CNContactContentViewController>, _UIAccessDeniedView;
