...
#import "CNQuickActionsViewDelegate.h"

@class CNContactFormatter, CNContactGridViewLayout, NSArray, NSDictionary, NSIndexPath, NSMutableDictionary, NSObject<CNContactDataSource>, NSString, UIColor;
