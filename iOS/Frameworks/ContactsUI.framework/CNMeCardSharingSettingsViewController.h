...
@interface CNMeCardSharingSettingsViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, CNMeCardSharingAvatarViewControllerDelegate, CNMeCardSharingEnabledDelegate, CNPhotoPickerViewControllerDelegate>
{
    ...
    _Bool _shouldSaveChangesToMeContact;
...
@property(nonatomic) _Bool shouldSaveChangesToMeContact; // @synthesize shouldSaveChangesToMeContact=_shouldSaveChangesToMeContact;
...
- (id)initWithContactStore:(id)arg1 contact:(id)arg2 sharingEnabled:(_Bool)arg3 selectedSharingAudience:(unsigned long long)arg4;
