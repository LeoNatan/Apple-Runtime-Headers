...
@class MTLCommandQueueDescriptor, MTLComputePipelineDescriptor, MTLStructType, MTLTextureDescriptor, MTLTileRenderPipelineDescriptor, NSArray, NSData, NSObject<OS_dispatch_data>, NSString, _MTLIndirectArgumentBufferLayout;
