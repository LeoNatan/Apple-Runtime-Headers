...
@class FPItemID, FPItemManager, FPPacer, NSArray, NSData, NSFileProviderEnumerationProperties, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSPredicate, NSString, _FPItemList;
