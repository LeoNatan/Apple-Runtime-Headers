...
@class NSArray, NSDictionary, NSHashTable, NSLayoutManager, NSSet, NSString, UIResponder<UITextInput>, UITextChecker, UITextInputTraits, UITextPasteController, UITextPosition, UITextRange, UIView, UIView<UITextInput>, UIView<UITextInputPrivate>, _UIDictationAttachment, _UITextInputControllerTokenizer, _UITextKitTextRange, _UITextServiceSession, _UITextUndoManager, _UITextUndoOperationTyping;
