...
@class NSArray, NSString, UIColor, UIFont, UIImageView, UIInterfaceActionGroupViewState, UIInterfaceActionViewState, UILabel, UIScreen, UIScrollView, UIView, UIView<UIInterfaceActionVisualBackgroundDisplaying>, UIView<UIInterfaceActionVisualGroupBackgroundDisplaying>, UIView<UIInterfaceActionVisualSectionSeparatorDisplaying>, UIView<UIInterfaceActionVisualSeparatorDisplaying>;
