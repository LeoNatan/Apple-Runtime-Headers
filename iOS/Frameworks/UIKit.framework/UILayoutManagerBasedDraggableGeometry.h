...
#import "UITextDraggableGeometry.h"
#import "UITextDraggableGeometryFastSameViewOperationsSupporting.h"

@class NSLayoutManager, NSString, UIView<UITextDragSupporting><UITextDropSupporting>;
