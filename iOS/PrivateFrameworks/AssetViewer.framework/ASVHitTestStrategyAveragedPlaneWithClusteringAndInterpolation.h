...
{
    float _currentYValue;
}

@property(nonatomic) float currentYValue; // @synthesize currentYValue=_currentYValue;
- (_Bool)hasFormedClusterForMovement:(float *)arg1;
- (_Bool)hasFormedClusterForInitialPlacement:(float *)arg1;
- (_Bool)resultsContainPoorQualityEstimatedResults:(id)arg1;
- (id)reprojectOntoCurrentYPlaneAtImagePoint:(id)arg1 inFrame:(struct CGSize)arg2 withViewportSize:(float)arg3 assetPosition:maxDistance: /* Error: Ran out of types for this method. */;
