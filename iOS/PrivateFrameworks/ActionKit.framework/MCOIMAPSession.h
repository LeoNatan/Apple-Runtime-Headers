...
- (id)fetchMessageAttachmentToFileOperationWithFolder:(id)arg1 uid:(unsigned int)arg2 partID:(id)arg3 encoding:(long long)arg4 filename:(id)arg5 urgent:(_Bool)arg6;
