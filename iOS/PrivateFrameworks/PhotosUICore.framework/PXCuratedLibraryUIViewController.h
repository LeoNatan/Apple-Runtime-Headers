...
@interface PXCuratedLibraryUIViewController : UIViewController <UIDragInteractionDelegate, UIDropInteractionDelegate, PXUserInterfaceFeatureViewController, PXScrollViewControllerObserver, PXOneUpPresentationDelegate, UIGestureRecognizerDelegate, PXSwipeSelectionManagerDelegate, PXCuratedLibrarySkimmingControllerDelegate, PXTouchingUIGestureRecognizerDelegate, PXCuratedLibraryZoomLevelControlDelegate, PXChangeObserver, PXPhotosGlobalFooterViewDelegate, PXCuratedLibraryFooterVisibilityManagerDelegate, PXCuratedLibraryActionPerformerDelegate, _UIContextMenuInteractionDelegate>
{
    ...
    PXCuratedLibrarySelectModeCaptionView *_selectModeCaptionView;
    ...
    _UITargetedPreview *__interactionTargetedPreview;
...
@property(retain, nonatomic, setter=_setInteractionTargetedPreview:) _UITargetedPreview *_interactionTargetedPreview; // @synthesize _interactionTargetedPreview=__interactionTargetedPreview;
...
@property(readonly, nonatomic) PXCuratedLibrarySelectModeCaptionView *selectModeCaptionView; // @synthesize selectModeCaptionView=_selectModeCaptionView;
