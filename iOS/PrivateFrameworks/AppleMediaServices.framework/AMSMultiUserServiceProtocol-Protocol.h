...
- (void)deleteRecordZoneShareForHomeID:(NSString *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
- (void)createRecordZoneShareForHomeID:(NSString *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
@end
