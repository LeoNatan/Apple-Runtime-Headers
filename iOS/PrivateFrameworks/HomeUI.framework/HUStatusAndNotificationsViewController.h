...
#import "HUTriggerConditionEditorItemModuleControllerDelegate.h"

@class HFItem<HFServiceLikeItem>, HUStatusAndNotificationsItemManager, HUTriggerConditionEditorItemModuleController, NSString;
