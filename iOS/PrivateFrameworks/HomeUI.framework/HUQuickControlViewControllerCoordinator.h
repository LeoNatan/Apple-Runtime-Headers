...
#import "HUQuickControlViewControllerDelegate.h"

@class HFItem, HFItem<NSCopying>, HFOverrideCharacteristicValueSource, HFSimpleItemManager, HMHome, HUQuickControlContentCharacteristicWritingUpdateAdapter, HUQuickControlViewController, NSArray, NSString;
