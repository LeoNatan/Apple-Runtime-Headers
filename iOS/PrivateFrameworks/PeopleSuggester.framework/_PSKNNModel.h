...
- (id)rankedGlobalSuggestionsWithPredictionContext:(id)arg1 maxSuggestions:(unsigned long long)arg2 contactsOnly:(_Bool)arg3 databaseDirectory:(id)arg4 interactions:(id)arg5;
...
- (id)rankedMessagesZkwSuggestionsWithPredictionContext:(id)arg1 bundleId:(id)arg2 maxSuggestions:(unsigned long long)arg3 databaseDirectory:(id)arg4 frequencyOnly:(_Bool)arg5 interactions:(id)arg6;
