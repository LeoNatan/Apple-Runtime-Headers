...
#import <WorkflowUI/GCDAsyncSocketDelegate-Protocol.h>
#import <WorkflowUI/NSNetServiceDelegate-Protocol.h>

@class GCDAsyncSocket, NSDictionary, NSLock, NSMutableArray, NSNetService, NSString;
@protocol OS_dispatch_queue;

@interface HTTPServer : NSObject <GCDAsyncSocketDelegate, NSNetServiceDelegate>
{
