...
+ (id)newWithSummaryFormatString:(id)arg1 parameters:(id)arg2 editableParameters:(id)arg3 states:(id)arg4 processing:(_Bool)arg5 stateWriter:(id)arg6 variableProvider:(id)arg7 variableUIDelegate:(id)arg8 navigationContext:(id)arg9 horizontalPadding:(double)arg10 textAlignment:(long long)arg11 extendSlotBackgroundOffEdges:(_Bool)arg12;
