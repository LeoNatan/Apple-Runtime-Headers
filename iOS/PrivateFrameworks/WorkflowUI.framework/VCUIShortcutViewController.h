...
{
    _Bool _shouldShowDontAddButton;
    _Bool _hasAppeared;
...
@property(nonatomic) _Bool shouldShowDontAddButton; // @synthesize shouldShowDontAddButton=_shouldShowDontAddButton;
...
- (_Bool)shouldAllowEditingAction;
- (void)didTapCancel;
