...
- (void)cancelPressed;
- (void)cleanup;
- (void)runWorkflow:(id)arg1 withAnimatedPresentation:(_Bool)arg2;
- (void)runWorkflowReference:(id)arg1 withAnimatedPresentation:(_Bool)arg2;
- (void)runWorkflowReference:(id)arg1;
- (_Bool)needsTopPadding;
