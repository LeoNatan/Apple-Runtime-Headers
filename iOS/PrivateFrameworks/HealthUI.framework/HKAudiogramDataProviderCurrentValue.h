...
- (void).cxx_destruct;
- (id)_localizedAverageSensitivity:(id)arg1 ear:(long long)arg2 displayType:(id)arg3 unitController:(id)arg4;
...
- (id)initWithDiagnosticCategory:(unsigned long long)arg1 leftAverageEarSensitivity:(id)arg2 rightAverageEarSensitivity:(id)arg3 date:(id)arg4;
