...
- (void)_drawDiastolicSymbolWidthColor:(id)arg1 atLocation:(struct CGPoint)arg2 width:(double)arg3 context:(struct CGContext *)arg4;
...
- (void)_drawRangeInContext:(struct CGContext *)arg1 coordinate:(id)arg2 width:(double)arg3 symbolType:(long long)arg4 symbolColor:(id)arg5 fillColor:(id)arg6;
