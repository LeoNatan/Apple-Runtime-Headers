...
- (_Bool)itemChanged:(id)arg1 baseVersion:(id)arg2 changedFields:(unsigned long long)arg3 newValues:(id)arg4 contents:(id)arg5 extension:(id)arg6 error:(id *)arg7;
- (id)findCollidingItemWithParentZone:(id)arg1 parentItemID:(id)arg2 filename:(id)arg3 excludingItemID:(id)arg4;
- (_Bool)_untrashItem:(id)arg1 toParentIdentifier:(id)arg2 error:(id *)arg3;
- (_Bool)_trashItem:(id)arg1 extension:(id)arg2 error:(id *)arg3;
...
- (_Bool)isDesktopOrDocumentsItem:(id)arg1;
- (_Bool)shouldRejectItem:(id)arg1 templateItem:(id)arg2 extension:(id)arg3 tryReconciling:(_Bool *)arg4;
