...
- (_Bool)saveXattrBlob:(id)arg1 forSignature:(id)arg2 error:(id *)arg3;
- (void)cleanupStagedDownloadWithID:(id)arg1 forItemID:(id)arg2;
- (_Bool)rememberStagedDownloadWithID:(id)arg1 gatherFileID:(unsigned long long *)arg2 generationID:(unsigned int *)arg3 error:(id *)arg4;
...
- (_Bool)pendingListRecordDirExistsInStageWithRecordID:(id)arg1;
...
- (_Bool)preparePackageForSecondStage:(id)arg1 recordName:(id)arg2 zone:(id)arg3 fileObjectID:(id)arg4 manifest:(id)arg5 package:(id)arg6 error:(id *)arg7;
- (_Bool)stagePackageWithStageID:(id)arg1 zone:(id)arg2 recordName:(id)arg3 package:(id)arg4 xattrsPackage:(id)arg5 error:(id *)arg6;
- (_Bool)moveFromURLToLiveStage:(id)arg1 fileObjectID:(id)arg2 error:(id *)arg3;
...
- (id)nonLocalRootURL;
- (_Bool)makeLiveSymlinkWithTarget:(id)arg1 fileObjectID:(id)arg2 error:(id *)arg3;
