...
- (void)markMigrationToFPFSCompleteInDataScope:(_Bool)arg1;
...
- (id)__getOrCreateAppLibrary:(id)arg1 rowID:(id)arg2 alreadyExists:(_Bool *)arg3 withClientZone:(id)arg4 createCZMMoved:(_Bool)arg5;
...
- (void)destroyLocalDataWaitingForFilesToBeUnlinked:(_Bool)arg1 pristineContainerIDs:(id)arg2 fileUnlinker:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
- (void)destroyLocalDataWaitingForFilesToBeUnlinked:(_Bool)arg1 fileUnlinker:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (_Bool)openWithError:(id *)arg1 pushQueue:(id)arg2;
- (void)resetThrottles;
