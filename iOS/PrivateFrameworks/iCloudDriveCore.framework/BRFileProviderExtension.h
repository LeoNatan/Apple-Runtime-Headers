...
@property(readonly, nonatomic) _Bool isDataScopeDomain; // @synthesize isDataScopeDomain=_isDataScopeDomain;
...
- (_Bool)_prepareAndCheckLoggedInOrError:(id *)arg1;
...
- (id)initWithDomain:(id)arg1 inSyncBubble:(_Bool)arg2;
