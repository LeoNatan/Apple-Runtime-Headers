...
- (_Bool)handleWaitForShareAcceptIfNecessaryForItem:(id)arg1 jobID:(id)arg2;
- (void)schedule;
...
- (void)scheduleContentDownloadForItem:(id)arg1 userInitiated:(_Bool)arg2;
...
- (_Bool)isDownloadScheduledForItem:(id)arg1;
