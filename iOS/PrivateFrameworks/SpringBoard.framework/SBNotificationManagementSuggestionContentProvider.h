...
#import <SpringBoard/SBNotificationManagementContentProvider.h>

#import <SpringBoard/SBFNotificationManagementSuggestionContentProviding-Protocol.h>

@class NSString;
@protocol SBFNotificationManagementSuggestionDelegate;

@interface SBNotificationManagementSuggestionContentProvider : SBNotificationManagementContentProvider <SBFNotificationManagementSuggestionContentProviding>
{
    _Bool _auxiliaryOptionsVisible;
    NSString *_optionsSummaryText;
    unsigned long long _numberOfOptionButtons;
    id <SBFNotificationManagementSuggestionDelegate> _suggestionDelegate;
}

@property(nonatomic) __weak id <SBFNotificationManagementSuggestionDelegate> suggestionDelegate; // @synthesize suggestionDelegate=_suggestionDelegate;
