...
@class NSString, SBAppLayout, SBApplicationSceneHandle, SBBestAppSuggestion, SBFluidSwitcherGesture, SBMainWorkspaceTransitionRequest, SBSwitcherModifierAction, SBTransientOverlayViewController, SBUIAnimationController, SBWorkspaceApplicationSceneTransitionContext;
