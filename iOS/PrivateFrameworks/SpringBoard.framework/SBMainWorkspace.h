...
- (id)transientOverlayPresentationManager:(id)arg1 acquireSiriWindowLevelAssertionWithReason:(id)arg2 windowLevel:(double)arg3 shouldAutomaticallyInvalidateWhenDismissed:(_Bool)arg4;
...
- (id)transientOverlayPresentationManager:(id)arg1 acquireControlCenterWindowLevelAssertionWithReason:(id)arg2 windowLevel:(double)arg3 shouldAutomaticallyInvalidateWhenDismissed:(_Bool)arg4;
- (void)transientOverlayPresentationManagerRequestsBannerLongLookDismissal:(id)arg1 animated:(_Bool)arg2;
- (id)transientOverlayPresentationManager:(id)arg1 acquireBannerLongLookWindowLevelAssertionWithReason:(id)arg2 windowLevel:(double)arg3 shouldAutomaticallyInvalidateWhenDismissed:(_Bool)arg4;
...
- (void)_executeSuspendedTransactionForRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;
