...
@class BSUIAnimationFactory, SBMainWorkspaceTransitionRequest, SBSceneViewStatusBarAssertion, SBUIAnimationController;
...
- (SBSceneViewStatusBarAssertion *)statusBarAssertionWithStatusBarHidden:(_Bool)arg1 nubViewHidden:(_Bool)arg2 atLevel:(unsigned long long)arg3;
