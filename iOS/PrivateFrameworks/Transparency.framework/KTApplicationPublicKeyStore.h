...
- (_Bool)processKeyData:(id)arg1 tltLeafs:(id)arg2 intermediates:(id)arg3 vrfKey:(id)arg4 vrfSignatureBytes:(id)arg5 vrfSPKIHash:(id)arg6 vrfSignatureAlgorithm:(struct __CFString *)arg7 error:(id *)arg8;
