...
@interface HKMCAnalysis : NSObject <NSSecureCoding, NSCopying>
{
    ...
    long long _lastLoggedDayIndex;
}

+ (_Bool)supportsSecureCoding;
@property(readonly, nonatomic) long long lastLoggedDayIndex; // @synthesize lastLoggedDayIndex=_lastLoggedDayIndex;
...
- (id)initWithStatistics:(id)arg1 menstruationProjections:(id)arg2 fertileWindowProjections:(id)arg3 cycles:(id)arg4 recentSymptoms:(unsigned long long)arg5 recentBasalBodyTemperature:(id)arg6 lastLoggedDayIndex:(long long)arg7;
