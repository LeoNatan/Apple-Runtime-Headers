...
- (void)_forwardDeleteBrailleCharSilently:(_Bool)arg1;
- (void)forwardDeleteBrailleCharSilently;
- (void)forwardDeleteBrailleChar;
- (void)_deleteBrailleCharSilently:(_Bool)arg1;
- (void)deleteBrailleCharSilently;
