...
#import "FCAssetHandleDelegate.h"
#import "FCCacheCoordinatorDelegate.h"
#import "FCCacheFlushing.h"

@class FCAssetStore, FCCacheCoordinator, FCKeyValueStore, FCNetworkBehaviorMonitor, NSMapTable, NSObject<OS_dispatch_queue>, NSString, NSURL;
