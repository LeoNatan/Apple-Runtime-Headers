...
- (void)setIconData:(id)arg1 forPageURLString:(id)arg2 iconURLString:(id)arg3 iconSize:(struct CGSize)arg4 isPrivate:(_Bool)arg5 completionHandler:(CDUnknownBlockType)arg6;
