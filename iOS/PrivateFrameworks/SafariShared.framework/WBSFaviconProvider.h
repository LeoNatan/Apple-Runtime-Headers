...
@class NSCache, NSCalendar, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, NSURL, WBSFaviconProviderPersistenceController;
...
- (void)_saveImageData:(id)arg1 iconURL:(id)arg2 pageURL:(id)arg3 originalPageURL:(id)arg4 isPrivate:(_Bool)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)_confirmImageDataShouldBeSaved:(id)arg1 pageURL:(id)arg2 includingPrivateData:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)_atomicallySaveImageData:(id)arg1 iconURL:(id)arg2 pageURL:(id)arg3 originalPageURL:(id)arg4 isPrivate:(_Bool)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)saveFaviconImageData:(id)arg1 iconURL:(id)arg2 pageURL:(id)arg3 originalPageURL:(id)arg4 isPrivate:(_Bool)arg5 completionHandler:(CDUnknownBlockType)arg6;
