...
@class AWAttentionAwarenessClientState, AWAttentionAwarenessConfiguration, NSString;
...
- (void)addClient:(id <AWFrameworkClient>)arg1 clientConfig:(AWAttentionAwarenessConfiguration *)arg2 clientState:(AWAttentionAwarenessClientState *)arg3 unitTestMode:(_Bool)arg4 reply:(void (^)(id <AWRemoteClient>, AWAttentionAwarenessClientState *, NSError *))arg5;
@end
