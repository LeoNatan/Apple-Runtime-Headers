...
@class NSArray, NSMutableArray, NSObject, NSObject<TSDInfo>, NSObject<TSKModel>, NSString, Protocol, TSDAutoscroll, TSDCanvasView, TSDEditorController, TSDInteractiveCanvasController, TSDLayout, TSDRep, TSKDocumentRoot, TSKScrollView, TSKSelection, UIGestureRecognizer, UITouch, UIView;
