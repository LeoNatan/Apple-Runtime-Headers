...
@class CVMLFaceDetector, CVMLFaceExpressionDetector, CVMLFaceLandmarkDetector, CVMLFaceprintGenerator, CVMLHumanDetector, CVMLImageprintGenerator, CVMLJunkIdentifier, CVMLSceneClassifier, NSObject<OS_dispatch_queue>;
