...
- (_Bool)_queue_deleteSamplesOfType:(id)arg1 onDayIndex:(long long)arg2 error:(id *)arg3;
- (_Bool)_queue_insertSamplesWithClientSource:(id)arg1 error:(id *)arg2;
- (id)_queue_mostRecentMenstrualFlowSampleWithError:(id *)arg1 requiringBeforeDay:(long long)arg2;
- (_Bool)_queue_savePeriodStartedOnDayIndex:(long long)arg1 endedOnDayIndex:(long long)arg2 error:(id *)arg3;
- (_Bool)_queue_saveMenstrualFlow:(long long)arg1 forEachDayInRange:(CDStruct_ef5fcbe6)arg2 error:(id *)arg3;
- (_Bool)_queue_saveLastMenstrualPeriodWithDayIndexRange:(CDStruct_ef5fcbe6)arg1 error:(id *)arg2;
