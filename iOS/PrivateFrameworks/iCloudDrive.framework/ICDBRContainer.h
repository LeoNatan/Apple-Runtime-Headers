...
+ (id)containerInPlistURL:(id)arg1 containerCache:(id)arg2 rootFileObjectID:(id)arg3 documentsFileObjectID:(id)arg4 createIfMissing:(_Bool)arg5 error:(id *)arg6;
...
+ (void)_generateiOSIconsForMangledID:(id)arg1 usingBundle:(struct __CFBundle *)arg2 containerStorageURL:(id)arg3 generatedIcons:(id)arg4;
