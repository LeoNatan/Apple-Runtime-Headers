...
- (id)initWithURL:(id)arg1 size:(id)arg2 etag:(id)arg3 hasThumbnail:(_Bool)arg4 displayName:(id)arg5 lastEditorDeviceName:(id)arg6 lastEditorNameComponents:(id)arg7 modificationDate:(id)arg8;
- (id)initAsFaultAtURL:(id)arg1 faultURL:(id)arg2 size:(id)arg3 logicalExtension:(id)arg4 faultExtension:(id)arg5 etag:(id)arg6 hasThumbnail:(_Bool)arg7 displayName:(id)arg8 lastEditorDeviceName:(id)arg9 lastEditorNameComponents:(id)arg10 modificationDate:(id)arg11;
