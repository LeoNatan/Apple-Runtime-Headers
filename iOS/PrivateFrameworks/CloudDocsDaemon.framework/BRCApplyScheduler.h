...
- (void)didSyncDownZone:(id)arg1 requestID:(unsigned long long)arg2 upToRank:(long long)arg3 caughtUpWithServer:(_Bool)arg4 fullSync:(_Bool)arg5;
...
- (_Bool)_rescheduleItemsParentedToItemGlobalID:(id)arg1 flags:(unsigned int)arg2;
