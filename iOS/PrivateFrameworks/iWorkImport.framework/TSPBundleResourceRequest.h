...
#import "TSPResourceLocalStrategyProvider.h"
#import "TSUResourceRequest.h"

@class NSBundle, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSProgress, NSSet, NSString, TSPDocumentResourceCache, TSPDocumentResourceRegistry, TSPDocumentResourceRequest;
