...
#import "TSTAdditionalHiddenRowColumnProviding.h"
#import "TSTCategoryProviding.h"
...
@class NSArray, NSDictionary, NSObject<TSDContainerInfo>, NSString, NSUUID, TSCECalculationEngine, TSCEOwnerUidMapper, TSDFill, TSDInfoGeometry, TSDStroke, TSPObject<TSDOwningAttachment>, TSTCategoryOrder, TSTCategoryOwner, TSTCellStyle, TSTCellWillChangeDistributor, TSTColumnRowUIDMap, TSTConcurrentMutableCellUIDSet, TSTConditionalStyleFormulaOwner, TSTGroupBy, TSTHiddenStates, TSTHiddenStatesOwner, TSTMasterLayout, TSTPencilAnnotationOwner, TSTSortRuleReferenceTracker, TSTStrokeSidecar, TSTStructuredTextImportRecord, TSTSummaryModel, TSTTableFilterSet, TSTTableModel, TSTTablePartitioner, TSTTableSortOrder, TSTTableStyle, TSTTableStylePreset, TSTTableTranslator, TSUMutableUUIDSet, TSWPParagraphStyle, TSWPShapeStyle;
