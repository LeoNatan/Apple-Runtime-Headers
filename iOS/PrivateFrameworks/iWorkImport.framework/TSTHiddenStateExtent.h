...
@class NSArray, NSMutableArray, NSMutableIndexSet, NSObject<OS_dispatch_queue>, NSString, TSCECalculationEngine, TSTHiddenStatesOwner, TSTInfo, TSTTableFilterSet, TSUMutableUUIDSet, TSUUUIDSet;
