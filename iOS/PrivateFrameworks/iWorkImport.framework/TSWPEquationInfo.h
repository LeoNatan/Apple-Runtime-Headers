...
-     // Error parsing type: v40@0:8@16^{CharacterStylePropertiesArchive=^^?{InternalMetadataWithArena=^v}{HasBits<2>=[2I]}{RepeatedPtrField<TSWP::FontFeatureArchive>=^{Arena}ii^{Rep}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}{ArenaStringPtr=^{basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >}}^{Color}^{Color}^{ShadowArchive}^{Color}^{Color}^{Color}fBBBBiiiiffiBBBBfffBBBBfBBBBBBi{CachedSize={atomic<int>=Ai}}}24@32, name: saveCharacterStylePropertiesFromPropertyMap:toArchive:archiver:
