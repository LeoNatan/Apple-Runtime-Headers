...
@interface TSDGPUParticleSystem : NSObject <TSDMTLParticleSystem, TSDGLParticleSystem>
{
    ...
    _Bool _shouldDraw;
    _Bool _shouldUseMetal;
    _Bool _shouldUseGLSL;
...
@property(readonly, nonatomic) _Bool shouldUseGLSL; // @synthesize shouldUseGLSL=_shouldUseGLSL;
@property(readonly, nonatomic) _Bool shouldUseMetal; // @synthesize shouldUseMetal=_shouldUseMetal;
