...
+ (id)composedShortcutsForApplicationWithBundleIdentifier:(id)arg1 iconDisplayName:(id)arg2 staticItems:(id)arg3 dynamicItems:(id)arg4 applicationItemID:(unsigned long long)arg5 supportsMultipleWindows:(_Bool)arg6 isSystemApplication:(_Bool)arg7 isInternalApplication:(_Bool)arg8 isApplicationInBeta:(_Bool)arg9;
