...
@interface VKDebugSettings : NSObject
{
    ...
    _Bool _enableMuninRoadLabelsDebugOverlay;
...
@property(nonatomic) _Bool enableMuninRoadLabelsDebugOverlay; // @synthesize enableMuninRoadLabelsDebugOverlay=_enableMuninRoadLabelsDebugOverlay;
...
@property(nonatomic) _Bool disableMuninRoadLabels; // @synthesize disableMuninRoadLabels=_disableMuninRoadLabels;
