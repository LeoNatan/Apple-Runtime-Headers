...
- (void)updateWebStorageWithInUseStartDate:(id)arg1 inFocusStartDate:(id)arg2 endDate:(id)arg3 url:(id)arg4 domain:(id)arg5 webApplication:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;
