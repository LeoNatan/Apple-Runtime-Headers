...
@interface _UIWindowSceneSafeAreaInsetsSettingsDiffAction : NSObject <_UISceneSettingsDiffAction>
{
    UIApplicationSceneSettingsDiffInspector *_sceneSettingsSafeAreaInsetsDiffInspector;
}

- (void).cxx_destruct;
- (void)_updateSafeAreaInsetsWithSettingsObserverContext:(CDUnion_e8341a59)arg1 windowScene:(id)arg2 transitionContext:(id)arg3;
