...
@class NSArray, NSLayoutConstraint, NSString, UIInterfaceAction, UIInterfaceActionVisualStyle, UISpringLoadedInteraction, UIView<UIInterfaceActionVisualBackgroundDisplaying>;
