...
@interface _UIPlatterContentWrapperView : UIView
{
    ...
    _Bool _didTakeOwnershipOfSourceView;
    UITargetedPreview *_sourcePreview;
    _UIPortalView *_portalView;
}

@property(nonatomic) _Bool didTakeOwnershipOfSourceView; // @synthesize didTakeOwnershipOfSourceView=_didTakeOwnershipOfSourceView;
