...
+ (id)configurationWithItems:(id)arg1 dataOwner:(long long)arg2 initialCentroid:(struct CGPoint)arg3 requiredContextIds:(id)arg4 sourceView:(id)arg5 accessibilityEndpoint:(id)arg6;
