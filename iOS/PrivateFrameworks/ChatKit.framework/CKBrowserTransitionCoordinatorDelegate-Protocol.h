...
@class CKAppGrabberView, CKBrowserSwitcherFooterView, CKBrowserTransitionCoordinator, IMBalloonPlugin, NSDate, UIViewController<CKBrowserViewControllerProtocol>;
