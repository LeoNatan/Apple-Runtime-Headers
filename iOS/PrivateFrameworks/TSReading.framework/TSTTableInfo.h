...
@class NSObject<TSDContainerInfo>, NSString, TSDInfoGeometry, TSKDocumentRoot, TSPObject<TSDOwningAttachment>, TSTEditingState, TSTMasterLayout, TSTTableModel, TSTTablePartitioner;
