...
@optional
- (_Bool)resumeBackgroundProcessingForIdentifier:(NSString *)arg1 completion:(void (^)(void))arg2;
- (void)didEndSession:(AASession *)arg1 endDate:(NSDate *)arg2;
- (void)didUpdateSession:(AASession *)arg1 submitEventQueues:(_Bool)arg2;
