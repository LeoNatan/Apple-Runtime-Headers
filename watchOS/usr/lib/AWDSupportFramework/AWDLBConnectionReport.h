...
{
    CDStruct_815f15fd _connectionReadyTimes;
    CDStruct_56d48c16 _resumptionFailureErrors;
    CDStruct_815f15fd _resumptionFailureTimes;
    CDStruct_815f15fd _resumptionSuccessTimes;
...
@property(readonly, nonatomic) unsigned int resumptionFailureTimesCount;
...
@property(readonly, nonatomic) unsigned int resumptionSuccessTimesCount;
...
@property(readonly, nonatomic) unsigned int resumptionFailureErrorsCount;
...
@property(readonly, nonatomic) unsigned int connectionReadyTimesCount;
