...
- (int)costAtIndex:(unsigned int)arg1;
...
- (_Bool)wordIsFromSystemDictionaryAtIndex:(unsigned int)arg1;
...
- (CDStruct_1ef3fb1f)wordRangeAtIndex:(long)arg1;
- (unsigned short)wordLengthAtIndex:(unsigned int)arg1;
@property(readonly, nonatomic) unsigned int wordCount;
