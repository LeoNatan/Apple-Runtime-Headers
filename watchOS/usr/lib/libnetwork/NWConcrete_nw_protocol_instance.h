...
#import "OS_nw_protocol_instance.h"

@class NSObject<OS_nw_array>, NSObject<OS_nw_endpoint>, NSObject<OS_nw_parameters>, NSString, NWConcrete_nw_protocol_definition;
