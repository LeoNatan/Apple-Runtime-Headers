...
@interface AXSpeechManager : NSObject <TTSSpeechSynthesizerDelegate>
{
    ...
    unsigned int _setActiveOptions;
...
@property(nonatomic) unsigned int audioSessionCategoryOptions; // @synthesize audioSessionCategoryOptions=_audioSessionCategoryOptions;
@property(retain, nonatomic) NSString *audioSessionCategory; // @synthesize audioSessionCategory=_audioSessionCategory;
@property(nonatomic) unsigned int setActiveOptions; // @synthesize setActiveOptions=_setActiveOptions;
- (void)_initialize;
