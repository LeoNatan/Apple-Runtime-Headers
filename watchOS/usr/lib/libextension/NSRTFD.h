...
- (unsigned int)saveToDocument:(id)arg1 removeBackup:(_Bool)arg2 errorHandler:(id)arg3;
- (unsigned int)internalSaveTo:(id)arg1 removeBackup:(_Bool)arg2 errorHandler:(id)arg3;
- (id)tmpNameFromPath:(id)arg1;
- (id)tmpNameFromPath:(id)arg1 extension:(id)arg2;
- (id)nameFromPath:(id)arg1 extra:(id)arg2;
- (unsigned int)internalSaveTo:(id)arg1 removeBackup:(_Bool)arg2 errorHandler:(id)arg3 temp:(id)arg4 backup:(id)arg5;
...
- (unsigned int)addDirNamed:(id)arg1 lazy:(_Bool)arg2;
