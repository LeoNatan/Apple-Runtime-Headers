...
- (_Bool)writeToURL:(id)arg1 options:(unsigned int)arg2 originalContentsURL:(id)arg3 error:(id *)arg4;
...
- (_Bool)readFromURL:(id)arg1 options:(unsigned int)arg2 error:(id *)arg3;
- (_Bool)_readContentsFromURL:(id)arg1 path:(id)arg2 itemKind:(id)arg3 options:(unsigned int)arg4 error:(id *)arg5;
