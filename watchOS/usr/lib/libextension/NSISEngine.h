...
{
    NSMapTable *_rows;
    CDStruct_f99a037b _engineVarTable;
    CDStruct_f99a037b _rowTables[2];
    CDStruct_f99a037b _colTables[2];
...
- (_Bool)tryToChangeConstraintSuchThatMarker:(id)arg1 isReplacedByMarkerPlusDelta:(float)arg2 undoHandler:(CDUnknownBlockType)arg3;
...
- (_Bool)tryToAddConstraintWithMarker:(id)arg1 expression:(id)arg2 integralizationAdjustment:(float)arg3 mutuallyExclusiveConstraints:(id *)arg4;
...
- (_Bool)hasValue:(float *)arg1 forExpression:(id)arg2;
- (float)valueForExpression:(id)arg1;
- (_Bool)hasValueForPossiblyDeallocatedVariable:(id)arg1;
- (_Bool)hasValue:(float *)arg1 forEngineVar:(CDStruct_a8d20eab)arg2;
- (_Bool)hasValue:(float *)arg1 forVariable:(id)arg2;
- (float)valueForEngineVar:(CDStruct_a8d20eab)arg1;
...
- (unsigned int)replayCommandsData:(id)arg1 verifyingIntegrity:(_Bool)arg2;
...
- (void)dealloc;
- (id)init;
- (_Bool)tryUsingArtificialVariableToAddConstraintWithMarker:(CDStruct_a8d20eab)arg1 row:(CDStruct_a8d20eab)arg2 usingInfeasibilityHandlingBehavior:(int)arg3 mutuallyExclusiveConstraints:(id *)arg4;
...
- (_Bool)handleUnsatisfiableRow:(CDStruct_a8d20eab)arg1 usingInfeasibilityHandlingBehavior:(int)arg2 prospectiveRowHead:(CDStruct_a8d20eab *)arg3 mutuallyExclusiveConstraints:(id *)arg4;
...
- (void)addRowBody:(CDStruct_a8d20eab)arg1 priority:(float)arg2 times:(double)arg3 toObjectiveRow:(CDStruct_a8d20eab)arg4;
- (void)_removeAllVariables;
- (void)addCol:(CDStruct_a8d20eab)arg1 coefficient:(double)arg2 toRow:(CDStruct_a8d20eab)arg3;
- (void)addCol:(CDStruct_a8d20eab)arg1 priority:(float)arg2 times:(double)arg3 toObjectiveRow:(CDStruct_a8d20eab)arg4;
