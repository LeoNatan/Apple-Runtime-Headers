...
- (void)assign:(unsigned int)arg1 key:(const void *)arg2 value:(const void *)arg3 isNew:(_Bool)arg4;
- (void)grow;
- (id)dump;
- (_Bool)containsKeys:(const void **)arg1 values:(const void **)arg2 count:(unsigned int)arg3;
