...
@interface NSItemProviderRepresentation : NSObject
{
    ...
    int _visibility;
    int _preferredRepresentation;
}

@property(nonatomic) int preferredRepresentation; // @synthesize preferredRepresentation=_preferredRepresentation;
...
- (void)dealloc;
- (id)initWithType:(id)arg1 preferredRepresentation:(int)arg2 loader:(CDUnknownBlockType)arg3;
- (id)initWithType_v2:(id)arg1 preferredRepresentation:(int)arg2 loader:(CDUnknownBlockType)arg3;
