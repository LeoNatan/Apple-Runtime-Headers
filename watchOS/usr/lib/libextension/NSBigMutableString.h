...
- (_Bool)_setData:(id)arg1 encoding:(unsigned int)arg2;
- (_Bool)_setStorage:(struct __CFStorage *)arg1 encoding:(unsigned int)arg2;
- (_Bool)_copyStorage:(struct __CFStorage **)arg1 encoding:(unsigned int *)arg2;
- (_Bool)_getData:(id *)arg1 encoding:(unsigned int *)arg2;
- (_Bool)_isMarkedAsImmutable;
- (void)_markAsImmutable;
- (void)_checkForInvalidMutationWithSelector:(SEL)arg1;
- (void)dealloc;
- (id)initWithStorage:(struct __CFStorage *)arg1 length:(unsigned int)arg2 isUnicode:(_Bool)arg3;
