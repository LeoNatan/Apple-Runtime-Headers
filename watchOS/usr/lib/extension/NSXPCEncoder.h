...
- (void)_encodeInvocationObjectArgumentsOnly:(id *)arg1 count:(unsigned int)arg2 typeString:(const char *)arg3 selector:(SEL)arg4 isReply:(_Bool)arg5 into:(id)arg6;
...
- (void)dealloc;
- (id)init;
- (id)initWithStackSpace:(char *)arg1 size:(unsigned long)arg2;
- (id)connection;
