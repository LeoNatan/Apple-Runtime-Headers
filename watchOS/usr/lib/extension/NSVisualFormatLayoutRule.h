...
+ (id)ruleWithVisualFormat:(id)arg1 options:(unsigned int)arg2 metrics:(id)arg3 views:(id)arg4;
+ (id)ruleWithVisualFormat:(id)arg1 options:(unsigned int)arg2 metrics:(id)arg3 rects:(id)arg4 containerRect:(id)arg5;
