...
- (_Bool)replaceItemAtURL:(id)arg1 withItemAtURL:(id)arg2 backupItemName:(id)arg3 options:(unsigned int)arg4 resultingItemURL:(id *)arg5 error:(id *)arg6;
...
- (_Bool)moveItemAtURL:(id)arg1 toURL:(id)arg2 options:(unsigned int)arg3 error:(id *)arg4;
...
- (_Bool)copyItemAtURL:(id)arg1 toURL:(id)arg2 options:(unsigned int)arg3 error:(id *)arg4;
- (_Bool)copyItemAtPath:(id)arg1 toPath:(id)arg2 error:(id *)arg3;
- (_Bool)copyItemAtPath:(id)arg1 toPath:(id)arg2 options:(unsigned int)arg3 error:(id *)arg4;
...
- (_Bool)getFileSystemRepresentation:(char *)arg1 maxLength:(unsigned int)arg2 withPath:(id)arg3;
...
- (id)directoryContentsAtPath:(id)arg1 matchingExtension:(id)arg2 options:(int)arg3 keepExtension:(_Bool)arg4;
- (id)directoryContentsAtPath:(id)arg1 matchingExtension:(id)arg2 options:(int)arg3 keepExtension:(_Bool)arg4 error:(id *)arg5;
