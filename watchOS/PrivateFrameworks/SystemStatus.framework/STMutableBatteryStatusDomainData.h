...
@property(nonatomic) unsigned int chargingDescriptionType; // @dynamic chargingDescriptionType;
...
@property(nonatomic) unsigned int percentCharge; // @dynamic percentCharge;
@property(nonatomic) unsigned int chargingState; // @dynamic chargingState;
