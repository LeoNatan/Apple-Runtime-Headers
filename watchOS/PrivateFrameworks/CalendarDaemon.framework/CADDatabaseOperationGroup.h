...
- (id)_importData:(id)arg1 intoCalendarWithID:(int)arg2 optionsMask:(unsigned int)arg3 outError:(int *)arg4;
- (void)CADDatabaseImportICSData:(id)arg1 intoCalendarsWithIDs:(id)arg2 optionsMask:(unsigned int)arg3 reply:(CDUnknownBlockType)arg4;
