...
- (id)_importEvents:(id)arg1 data:(id)arg2 intoCalendarWithID:(int)arg3 optionsMask:(unsigned int)arg4 batchSize:(int)arg5 outError:(int *)arg6;
- (void)CADDatabaseImportEvents:(id)arg1 fromICSData:(id)arg2 intoCalendarsWithIDs:(id)arg3 optionsMask:(unsigned int)arg4 batchSize:(int)arg5 reply:(CDUnknownBlockType)arg6;
