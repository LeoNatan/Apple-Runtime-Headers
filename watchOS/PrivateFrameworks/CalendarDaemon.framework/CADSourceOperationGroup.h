...
- (int)_tryPerformBlockWithSourceID:(id)arg1 forAction:(unsigned int)arg2 withBlock:(CDUnknownBlockType)arg3;
- (int)_tryPerformBlockWithSourceID:(id)arg1 forAction:(unsigned int)arg2 entityType:(int)arg3 withBlock:(CDUnknownBlockType)arg4;
