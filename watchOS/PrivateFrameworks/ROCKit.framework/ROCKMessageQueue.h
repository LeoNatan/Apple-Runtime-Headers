...
+ (id)messageQueueWithConnection:(id)arg1 invocationMode:(unsigned int)arg2;
...
@property(nonatomic) unsigned int invocationMode; // @synthesize invocationMode=_invocationMode;
@property(retain, nonatomic) ROCKConnection *connection; // @synthesize connection=_connection;
- (void).cxx_destruct;
- (void)dealloc;
- (id)initWithConnection:(id)arg1 invocationMode:(unsigned int)arg2;
