...
@interface ROCKConnectionManager : NSObject
{
    ...
    unsigned int _messageQueueInvocationMode;
    ...
    unsigned long _nextAvailableManagedConnectionIndex;
...
@property(nonatomic) unsigned long nextAvailableManagedConnectionIndex; // @synthesize nextAvailableManagedConnectionIndex=_nextAvailableManagedConnectionIndex;
...
@property(nonatomic) unsigned int messageQueueInvocationMode; // @synthesize messageQueueInvocationMode=_messageQueueInvocationMode;
