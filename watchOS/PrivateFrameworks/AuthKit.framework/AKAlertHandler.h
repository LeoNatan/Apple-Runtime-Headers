...
- (void).cxx_destruct;
- (void)_openUpgradeAccountSecurityLevel;
- (void)_openSpyglass;
...
- (void)_showAlertForUnderageAccountWithCompletion:(CDUnknownBlockType)arg1;
- (void)_showAlertForCannotFindServerWithCompletion:(CDUnknownBlockType)arg1;
- (void)_showAlertForInsufficientSecurityLevelWithCompletion:(CDUnknownBlockType)arg1;
