...
- (void).cxx_destruct;
@property(nonatomic) unsigned int circleStep; // @synthesize circleStep=_circleStep;
...
@property(nonatomic) int clientErrorCode; // @synthesize clientErrorCode=_clientErrorCode;
