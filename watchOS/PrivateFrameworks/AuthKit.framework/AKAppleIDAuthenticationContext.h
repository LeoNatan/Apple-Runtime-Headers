...
@property(nonatomic) int maximumLoginAttempts; // @synthesize maximumLoginAttempts=_maximumLoginAttempts;
...
@property(nonatomic) unsigned int _attemptIndex; // @synthesize _attemptIndex;
...
@property(readonly, nonatomic) unsigned int _capabilityForUIDisplay; // @synthesize _capabilityForUIDisplay;
