...
- (void)reportSignOutForAppleID:(NSString *)arg1 service:(int)arg2 completion:(void (^)(_Bool, NSError *))arg3;
...
- (void)validateLoginCode:(unsigned int)arg1 forAppleID:(NSString *)arg2 withCompletion:(void (^)(_Bool, NSError *))arg3;
