...
- (void)reportSignOutForAppleID:(id)arg1 service:(int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)validateLoginCode:(unsigned int)arg1 forAppleID:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)setAppleIDWithAltDSID:(id)arg1 inUse:(_Bool)arg2 forService:(int)arg3;
