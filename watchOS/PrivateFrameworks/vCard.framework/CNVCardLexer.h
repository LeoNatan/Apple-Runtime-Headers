...
- (int)tokenAtCursor;
- (id)nextStringInEncoding:(unsigned int)arg1 quotedPrintable:(_Bool)arg2 stopTokens:(int)arg3 trim:(_Bool)arg4;
- (void)_applyNextStringInEncoding:(unsigned int)arg1 quotedPrintable:(_Bool)arg2 stopTokens:(int)arg3 trim:(_Bool)arg4 intoString:(id)arg5;
...
- (id)nextSingleByteStringInEncoding:(unsigned int)arg1 quotedPrintable:(_Bool)arg2 stopTokens:(int)arg3 trim:(_Bool)arg4;
