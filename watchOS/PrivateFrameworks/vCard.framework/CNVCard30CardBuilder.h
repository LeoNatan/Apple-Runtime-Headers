...
+ (unsigned int)estimatedBytesAvailableForPhotoWithOptions:(id)arg1 serializer:(id)arg2;
...
@property(nonatomic) unsigned int countOfLinesBeforePhoto; // @synthesize countOfLinesBeforePhoto=_countOfLinesBeforePhoto;
