...
+ (_Bool)data:(id)arg1 containsParam:(id)arg2 value:(id)arg3 encoding:(unsigned int)arg4;
+ (_Bool)data:(id)arg1 containsString:(id)arg2 encoding:(unsigned int)arg3;
+ (_Bool)data:(id)arg1 isVersion30WithPrefix:(id)arg2 encoding:(unsigned int)arg3;
+ (_Bool)tryVCardEncoding:(unsigned int)arg1 data:(id)arg2 analysis:(struct CNVCardDataAnalysis *)arg3;
