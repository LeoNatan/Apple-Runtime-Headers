...
- (void).cxx_destruct;
@property(readonly, nonatomic) unsigned int maxBytes; // @synthesize maxBytes=_maxBytes;
...
- (id)bestEffortImage;
- (id)description;
- (id)initWithPerson:(id)arg1 options:(id)arg2 maximumDataLength:(unsigned int)arg3;
- (id)init;
