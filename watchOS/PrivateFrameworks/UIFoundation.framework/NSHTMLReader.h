...
- (void)_traverseNode:(id)arg1 depth:(int)arg2 embedded:(_Bool)arg3;
...
- (_Bool)_processElement:(id)arg1 tag:(id)arg2 display:(id)arg3 depth:(int)arg4;
- (void)_addTableCellForElement:(id)arg1;
- (void)_addTableForElement:(id)arg1;
- (_Bool)_enterElement:(id)arg1 tag:(id)arg2 display:(id)arg3 depth:(int)arg4 embedded:(_Bool)arg5;
- (void)_processHeadElement:(id)arg1;
- (void)_processMetaElementWithName:(id)arg1 content:(id)arg2;
- (void)_fillInBlock:(id)arg1 forElement:(id)arg2 backgroundColor:(id)arg3 extraMargin:(float)arg4 extraPadding:(float)arg5 isTable:(_Bool)arg6;
- (void)_addValue:(id)arg1 forElement:(id)arg2;
- (void)_addQuoteForElement:(id)arg1 opening:(_Bool)arg2 level:(int)arg3;
...
- (_Bool)_getFloat:(float *)arg1 forNode:(id)arg2 property:(id)arg3;
- (_Bool)_getComputedFloat:(float *)arg1 forNode:(id)arg2 property:(id)arg3;
