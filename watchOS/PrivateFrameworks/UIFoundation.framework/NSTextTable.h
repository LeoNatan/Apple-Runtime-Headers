...
- (_Bool)_missingColumnsForRowRange:(struct _NSRange)arg1 blockIndex:(unsigned int)arg2 text:(id)arg3;
...
- (id)_rowArrayForBlock:(id)arg1 atIndex:(unsigned int)arg2 text:(id)arg3 layoutManager:(id)arg4 containerWidth:(float)arg5 withRepetitions:(_Bool)arg6 collapseBorders:(_Bool)arg7 rowCharRange:(struct _NSRange *)arg8 indexInRow:(unsigned int *)arg9 startingRow:(int *)arg10 startingColumn:(int *)arg11 previousRowBlockHelper:(id *)arg12;
