...
- (_Bool)_closeListsForParagraphStyle:(id)arg1 atIndex:(unsigned int)arg2 inString:(id)arg3;
- (void)_openListsForParagraphStyle:(id)arg1 atIndex:(unsigned int)arg2 inString:(id)arg3 isStrict:(_Bool)arg4;
- (unsigned int)_listClassForList:(id)arg1;
- (_Bool)_closeBlocksForParagraphStyle:(id)arg1 atIndex:(unsigned int)arg2 inString:(id)arg3;
...
- (unsigned int)_paragraphClassforParagraphStyle:(id)arg1 range:(struct _NSRange)arg2 isEmpty:(_Bool)arg3 isCompletelyEmpty:(_Bool)arg4 headerString:(id *)arg5 alignmentString:(id *)arg6 directionString:(id *)arg7;
