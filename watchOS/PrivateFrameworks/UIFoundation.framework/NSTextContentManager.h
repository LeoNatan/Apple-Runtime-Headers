...
@interface NSTextContentManager : NSObject <NSTextElementProvider, NSSecureCoding>
{
    ...
    // Error parsing type: AL, name: _transactionStack
    ...
    unsigned int _maximumNumberOfUncachedElements;
}
...
@property unsigned int maximumNumberOfUncachedElements; // @synthesize maximumNumberOfUncachedElements=_maximumNumberOfUncachedElements;
