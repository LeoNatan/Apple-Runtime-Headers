...
@interface NSTextLayoutFragment : NSObject <NSSecureCoding, NSTextViewportElement>
{
    ...
    unsigned int _sourceVerticalDelta;
    unsigned int _sourceRangeDelta;
...
@property float destinationVerticalDelta; // @dynamic destinationVerticalDelta;
...
@property(readonly) unsigned int animationType; // @dynamic animationType;
