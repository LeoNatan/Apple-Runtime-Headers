...
- (void)enumerateTextViewportElementsInRect:(struct CGRect)arg1 options:(int)arg2 usingBlock:(CDUnknownBlockType)arg3;
...
- (void)adjustViewport:(float)arg1;
- (float)relocateViewport:(id)arg1;
- (void)layoutViewport;
- (void)dealloc;
