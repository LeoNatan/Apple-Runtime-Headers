...
+ (unsigned int)defaultLineBreakStrategy;
...
- (id)textContainers;
- (id)layoutManager;
- (_Bool)finalizeLineFragmentRect:(inout struct CGRect *)arg1 lineFragmentUsedRect:(inout struct CGRect *)arg2 baselineOffset:(inout float *)arg3 forGlyphRange:(struct _NSRange)arg4;
