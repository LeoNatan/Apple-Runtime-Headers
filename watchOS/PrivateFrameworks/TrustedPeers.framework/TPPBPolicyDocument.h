...
- (id)description;
- (id)keyViewMappingAtIndex:(unsigned int)arg1;
- (unsigned int)keyViewMappingsCount;
- (void)addKeyViewMapping:(id)arg1;
- (void)clearKeyViewMappings;
- (id)redactionsAtIndex:(unsigned int)arg1;
- (unsigned int)redactionsCount;
- (void)addRedactions:(id)arg1;
- (void)clearRedactions;
- (id)introducersByCategoryAtIndex:(unsigned int)arg1;
- (unsigned int)introducersByCategorysCount;
- (void)addIntroducersByCategory:(id)arg1;
- (void)clearIntroducersByCategorys;
- (id)categoriesByViewAtIndex:(unsigned int)arg1;
- (unsigned int)categoriesByViewsCount;
- (void)addCategoriesByView:(id)arg1;
- (void)clearCategoriesByViews;
- (id)modelToCategoryAtIndex:(unsigned int)arg1;
- (unsigned int)modelToCategorysCount;
