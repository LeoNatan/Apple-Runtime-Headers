...
+ (id)peerIDForData:(id)arg1 sig:(id)arg2 peerIDHashAlgo:(int)arg3;
+ (id)permanentInfoWithMachineID:(id)arg1 modelID:(id)arg2 epoch:(unsigned long long)arg3 signingKeyPair:(id)arg4 encryptionKeyPair:(id)arg5 peerIDHashAlgo:(int)arg6 error:(id *)arg7;
- (void).cxx_destruct;
