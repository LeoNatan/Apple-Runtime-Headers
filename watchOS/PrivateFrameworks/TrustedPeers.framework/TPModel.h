...
- (id)createVoucherForCandidate:(id)arg1 stableInfo:(id)arg2 withSponsorID:(id)arg3 reason:(unsigned int)arg4 signingKeyPair:(id)arg5 error:(id *)arg6;
...
- (unsigned int)statusOfMachineID:(id)arg1;
