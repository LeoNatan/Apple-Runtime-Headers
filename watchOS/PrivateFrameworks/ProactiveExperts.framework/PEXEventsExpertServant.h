...
- (id)_quickTypeItemsForEvents:(id)arg1 fields:(unsigned int)arg2 limit:(unsigned int)arg3 formatter:(id)arg4;
...
- (id)nameItemsWithLimit:(unsigned int)arg1;
- (id)quickTypeItemsForCriteria:(id)arg1 limit:(unsigned int)arg2;
- (void)askForEKAccess;
