...
@property(nonatomic) unsigned int efficacyMask; // @synthesize efficacyMask=_efficacyMask;
- (void)encodeWithXPCDictionary:(id)arg1;
- (id)initWithXPCDictionary:(id)arg1;
- (_Bool)isEqual:(id)arg1;
@property(readonly, nonatomic) unsigned int maxEfficacy;
- (id)description;
- (void)dealloc;
