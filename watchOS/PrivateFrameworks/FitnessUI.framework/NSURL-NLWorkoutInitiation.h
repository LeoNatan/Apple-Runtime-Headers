...
+ (id)fiui_startBackdatedWorkoutURLWithDate:(id)arg1 workoutIdentifier:(id)arg2 workoutType:(unsigned int)arg3 isIndoor:(_Bool)arg4 swimmingLocationType:(int)arg5 showPicker:(_Bool)arg6;
