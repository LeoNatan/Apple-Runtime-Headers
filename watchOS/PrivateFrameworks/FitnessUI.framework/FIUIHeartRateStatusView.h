...
- (id)initWithFrame:(struct CGRect)arg1 heartFilledImageName:(id)arg2 heartSpriteImageName:(id)arg3 spriteFrameCount:(int)arg4 spriteColumnCount:(int)arg5 resourceBundle:(id)arg6;
