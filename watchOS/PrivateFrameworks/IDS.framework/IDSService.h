...
+ (_Bool)checkMessageSize:(unsigned int)arg1 priority:(int)arg2;
- (void).cxx_destruct;
...
- (_Bool)sendAheadGroup:(id)arg1 priority:(int)arg2 options:(id)arg3 identifier:(id *)arg4 error:(id *)arg5;
...
- (_Bool)sendData:(id)arg1 toDestinations:(id)arg2 priority:(int)arg3 options:(id)arg4 identifier:(id *)arg5 error:(id *)arg6;
...
- (_Bool)sendMessage:(id)arg1 toDestinations:(id)arg2 priority:(int)arg3 options:(id)arg4 identifier:(id *)arg5 error:(id *)arg6;
