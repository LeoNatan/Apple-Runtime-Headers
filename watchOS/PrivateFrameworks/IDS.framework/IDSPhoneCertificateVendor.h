...
- (int)_subscriptionSourceForContext:(id)arg1;
- (int)_subscriptionSourceFromIntegerValue:(int)arg1;
...
- (id)_clientErrorForCode:(int)arg1 underlyingError:(id)arg2;
- (id)_debugDescriptionForErrorCode:(int)arg1;
- (_Bool)_isPhoneCertificateVendorSupported;
- (void)_updateSelfRetentionBasedOnInFlightRequestCount;
- (int)currentPhoneUserSubscriptionSourceWithError:(id *)arg1;
- (void)requestCurrentPhoneUserSubscriptionSourceWithCompletion:(CDUnknownBlockType)arg1;
- (void)setCurrentPhoneUserSubscriptionSource:(int)arg1 completion:(CDUnknownBlockType)arg2;
