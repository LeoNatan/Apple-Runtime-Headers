...
- (unsigned short)generateMetadata:(char *)arg1 maxSize:(unsigned long)arg2 withDatagramInfo:(CDStruct_54fea20c)arg3 options:(CDStruct_920a6c75 *)arg4 currentDatagramCount:(unsigned char)arg5 totalDatagramCount:(unsigned char)arg6;
...
- (void)processMetadataForDatagram:(char *)arg1 size:(unsigned long)arg2 datagramInfo:(CDStruct_54fea20c *)arg3 options:(CDStruct_920a6c75 *)arg4;
...
- (void)_logReceivingStats:(unsigned long)arg1;
- (void)_logSendingStats:(unsigned long)arg1;
- (id)description;
- (void)dealloc;
- (id)cachedMetadata;
