...
- (unsigned short)generateMetadata:(char *)arg1 maxSize:(unsigned long)arg2 withDatagramInfo:(CDStruct_54fea20c)arg3 options:(CDStruct_d008d4b8 *)arg4;
...
- (void)processMetadataForDatagram:(char *)arg1 size:(unsigned long)arg2 datagramInfo:(CDStruct_54fea20c *)arg3 options:(CDStruct_d008d4b8 *)arg4;
