...
- (CDStruct_f4e55b93 *)_setWiFiAssist:(_Bool)arg1;
- (void)setChannelPreferences:(id)arg1;
- (void)_buildPacketBufferMetaData:(CDStruct_f4e55b93 *)arg1;
- (void)sendMetadata;
- (void)readyToRead;
...
- (void)processMetadataForDatagram:(char *)arg1 size:(unsigned long)arg2 datagramInfo:(CDStruct_54fea20c *)arg3 options:(CDStruct_6bf83f29 *)arg4;
