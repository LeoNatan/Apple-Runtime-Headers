...
@property(readonly, nonatomic) int pairingProtocolVersion; // @synthesize pairingProtocolVersion=_pairingProtocolVersion;
@property(readonly, nonatomic) NSUUID *cbuuid; // @synthesize cbuuid=_cbuuid;
- (void)encodeWithCoder:(id)arg1;
- (id)initWithCoder:(id)arg1;
- (id)description;
- (id)initWithCBUUID:(id)arg1 pairingProtocolVersion:(int)arg2 BTOutOfBandKey:(id)arg3;
