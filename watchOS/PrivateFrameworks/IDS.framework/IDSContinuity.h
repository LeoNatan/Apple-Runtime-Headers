...
- (void)startScanningForType:(int)arg1 withData:(id)arg2 mask:(id)arg3 withOptions:(id)arg4 boostedScan:(_Bool)arg5 duplicates:(_Bool)arg6;
- (void)startScanningForType:(int)arg1 withData:(id)arg2 mask:(id)arg3 peers:(id)arg4 withOptions:(id)arg5 boostedScan:(_Bool)arg6 duplicates:(_Bool)arg7;
- (void)startScanningForType:(int)arg1 withData:(id)arg2 mask:(id)arg3 withOptions:(id)arg4 boostedScan:(_Bool)arg5;
- (void)startScanningForType:(int)arg1 withData:(id)arg2 mask:(id)arg3 peers:(id)arg4 withOptions:(id)arg5 boostedScan:(_Bool)arg6;
