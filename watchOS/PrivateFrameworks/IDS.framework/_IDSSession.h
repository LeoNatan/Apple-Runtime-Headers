...
- (void).cxx_destruct;
@property(readonly, nonatomic) unsigned int initialLinkType; // @synthesize initialLinkType=_initialLinkType;
...
- (id)_initWithAccount:(id)arg1 destinations:(id)arg2 transportType:(int)arg3 connectionCountHint:(unsigned int)arg4 needsToWaitForPreConnectionData:(_Bool)arg5 uniqueID:(id)arg6 delegateContext:(id)arg7;
- (id)daemonController;
- (id)daemonListener;
