...
@optional
- (void)iMessageReportSpamCheckUnknownResponseForRequestID:(NSString *)arg1 status:(int)arg2 abusive:(_Bool)arg3 delay:(double)arg4 withError:(NSError *)arg5;
...
- (void)continuityDidStopAdvertisingOfType:(int)arg1 withError:(NSError *)arg2;
...
- (void)messageIdentifier:(NSString *)arg1 alternateCallbackID:(NSString *)arg2 forAccount:(NSString *)arg3 updatedWithResponseCode:(int)arg4 error:(NSError *)arg5 lastCall:(_Bool)arg6 context:(NSDictionary *)arg7;
