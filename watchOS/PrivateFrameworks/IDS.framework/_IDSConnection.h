...
- (void).cxx_destruct;
- (void)checkTransportLogWithReason:(int)arg1;
...
- (void)messageIdentifier:(id)arg1 alternateCallbackID:(id)arg2 forAccount:(id)arg3 updatedWithResponseCode:(int)arg4 error:(id)arg5 lastCall:(_Bool)arg6 context:(id)arg7;
