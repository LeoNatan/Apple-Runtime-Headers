...
- (void)continuityStartScanningForType:(int)arg1 withData:(NSData *)arg2 mask:(NSData *)arg3 peers:(NSArray *)arg4 boostedScan:(_Bool)arg5 duplicates:(_Bool)arg6;
- (void)continuityStartScanningForType:(int)arg1 withData:(NSData *)arg2 mask:(NSData *)arg3 boostedScan:(_Bool)arg4 duplicates:(_Bool)arg5;
...
- (void)failedDecryptingMessage:(NSDictionary *)arg1 reason:(int)arg2 forGroupID:(ENGroupID *)arg3 onService:(NSString *)arg4;
