...
+ (void)_addWebDomains:(id)arg1 toItemNames:(id)arg2 remainingItems:(unsigned int)arg3 totalCount:(unsigned int)arg4 completionHandler:(CDUnknownBlockType)arg5;
