...
- (void)setDaysSinceCreationDates:(unsigned long long *)arg1 count:(unsigned int)arg2;
- (unsigned long long)daysSinceCreationDateAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int daysSinceCreationDatesCount;
- (id)limitedCategoriesAtIndex:(unsigned int)arg1;
- (unsigned int)limitedCategoriesCount;
