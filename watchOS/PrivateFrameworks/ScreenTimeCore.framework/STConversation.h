...
@interface STConversation : NSObject
{
    ...
    int _currentThirdPartyApplicationState;
...
@property int currentThirdPartyApplicationState; // @synthesize currentThirdPartyApplicationState=_currentThirdPartyApplicationState;
