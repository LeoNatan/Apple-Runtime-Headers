...
@interface MIInstallOptions : NSObject <NSSecureCoding, NSCopying>
{
    ...
    _Bool _overrideLaunchDisabled;
    unsigned int _installTargetType;
    unsigned int _lsInstallType;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool overrideLaunchDisabled; // @synthesize overrideLaunchDisabled=_overrideLaunchDisabled;
...
@property(nonatomic) unsigned int lsInstallType; // @synthesize lsInstallType=_lsInstallType;
...
@property(nonatomic) unsigned int installTargetType; // @synthesize installTargetType=_installTargetType;
- (id)description;
