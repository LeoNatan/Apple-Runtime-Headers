...
- (_Bool)swapSpecifierAtIndex:(unsigned int)arg1 withSpecifierAtIndex:(unsigned int)arg2;
- (_Bool)moveSpecifier:(id)arg1 toIndex:(unsigned int)arg2;
- (_Bool)moveSpecifierAtIndexPath:(id)arg1 toIndexPath:(id)arg2;
- (_Bool)moveSpecifierAtIndex:(unsigned int)arg1 toIndex:(unsigned int)arg2;
- (_Bool)reloadSpecifiersInRange:(struct _NSRange)arg1;
- (_Bool)reloadSpecifierAtIndexPath:(id)arg1;
- (_Bool)reloadSpecifierAtIndex:(unsigned int)arg1;
...
- (_Bool)reloadSpecifiersInGroupAtGroupIndex:(unsigned int)arg1;
...
- (_Bool)removeSpecifiersInGroupAtGroupIndex:(unsigned int)arg1;
- (_Bool)removeSpecifierAtIndexPath:(id)arg1;
- (_Bool)removeSpecifiersInRange:(struct _NSRange)arg1;
- (_Bool)_removeOneSpecifierOnlyAtIndex:(unsigned int)arg1;
- (_Bool)removeSpecifierAtIndex:(unsigned int)arg1;
...
- (_Bool)appendSpecifiers:(id)arg1 toGroupAtGroupIndex:(unsigned int)arg2;
- (_Bool)appendSpecifier:(id)arg1 toGroupAtGroupIndex:(unsigned int)arg2;
...
- (_Bool)insertContiguousSpecifiers:(id)arg1 atIndex:(unsigned int)arg2;
...
- (_Bool)insertSpecifier:(id)arg1 atIndex:(unsigned int)arg2;
