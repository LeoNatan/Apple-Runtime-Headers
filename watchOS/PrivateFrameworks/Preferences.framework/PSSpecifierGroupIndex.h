...
- (_Bool)getGroup:(out unsigned int *)arg1 row:(out unsigned int *)arg2 ofSpecifierWithID:(id)arg3;
- (_Bool)getGroup:(out unsigned int *)arg1 row:(out unsigned int *)arg2 ofSpecifier:(id)arg3;
- (_Bool)getGroup:(out unsigned int *)arg1 row:(out unsigned int *)arg2 ofSpecifierAtIndex:(unsigned int)arg3;
- (id)indexPathForSpecifierWithID:(id)arg1;
- (id)indexPathForSpecifier:(id)arg1;
- (id)specifierAtIndexPath:(id)arg1;
- (id)indexPathForSpecifierAtIndex:(unsigned int)arg1 forInsertion:(_Bool)arg2;
- (id)indexPathForSpecifierAtIndex:(unsigned int)arg1;
- (unsigned int)indexOfSpecifierAtIndexPath:(id)arg1 forInsertion:(_Bool)arg2;
- (unsigned int)indexOfSpecifierAtIndexPath:(id)arg1;
- (unsigned int)_indexOfSpecifierInSection:(unsigned int)arg1 row:(unsigned int)arg2 forInsertion:(_Bool)arg3;
- (void)_getSection:(out unsigned int *)arg1 row:(out unsigned int *)arg2 forSpecifierAtIndex:(unsigned int)arg3 forInsertion:(_Bool)arg4 allowGroupSpecifiers:(_Bool)arg5;
- (void)_getSection:(out unsigned int *)arg1 row:(out unsigned int *)arg2 forSpecifierAtIndex:(unsigned int)arg3 forInsertion:(_Bool)arg4;
