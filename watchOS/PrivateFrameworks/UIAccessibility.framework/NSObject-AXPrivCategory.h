...
- (id)_accessibilitySearchSubtreesAfterChildElement:(id)arg1 direction:(long)arg2 searchType:(long)arg3 allowOutOfBoundsChild:(_Bool)arg4 range:(struct _NSRange)arg5;
...
- (unsigned int)_accessibilityVisionDetectionOptions;
...
- (_Bool)_animateScrollViewWithMachPort:(unsigned int)arg1 amount:(float)arg2;
