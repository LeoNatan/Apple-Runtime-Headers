...
- (long)_accessibilityMapFeatureType;
...
- (void)_accessibilityMapsExplorationContinueWithVertexIndex:(unsigned int)arg1;
...
- (id)_accessibilityAlternativesForTextAtPosition:(unsigned int)arg1;
...
- (unsigned int)_accessibilityHandwritingAttributeAllowedCharacterSets;
- (unsigned int)_accessibilityHandwritingAttributeAllowedCharacterSetsForKeyboardType:(int)arg1;
- (unsigned int)_accessibilityHandwritingAttributePreferredCharacterSet;
- (unsigned int)_accessibilityHandwritingAttributePreferredCharacterSetForKeyboardType:(int)arg1;
...
- (struct _NSRange)_accessibilityRangeForLineNumber:(int)arg1;
...
- (unsigned int)_accessibilityPositionInDirection:(int)arg1 offset:(unsigned int)arg2 forPosition:(unsigned int)arg3;
...
- (_Bool)_accessibilityBasePerformOrbGesture:(int)arg1;
...
- (_Bool)accessibilityPerformCustomAction:(int)arg1;
...
- (struct CGRect)_accessibilityCompareFrameForScrollParent:(id)arg1 frame:(struct CGRect)arg2 fromOrientation:(int)arg3 toOrientation:(int)arg4;
...
- (int)_accessibilityOrientationForCompareGeometryForApplication:(id)arg1;
...
- (struct CGRect)_handleRotatingFrame:(struct CGRect)arg1 fromOrientation:(int)arg2 toOrientation:(int)arg3;
- (int)_accessibilityCompareElement:(id)arg1 toElement:(id)arg2;
- (int)_accessibilitySortPriorityWithReturningElement:(id *)arg1;
...
- (id)_accessibilitySearchSubtreesAfterChildElement:(id)arg1 direction:(long)arg2 searchType:(long)arg3 allowOutOfBoundsChild:(_Bool)arg4 range:(struct _NSRange)arg5 shouldScrollToVisible:(_Bool)arg6;
...
- (void)_accessibilityOpaqueElementScrollToDirection:(long)arg1;
- (id)_accessibilityFindElementInDirection:(long)arg1 searchType:(long)arg2 allowOutOfBoundsChild:(_Bool)arg3 startingTouchContainer:(id)arg4;
- (id)_accessibilityFindElementInDirection:(long)arg1 searchType:(long)arg2 allowOutOfBoundsChild:(_Bool)arg3;
...
- (struct CGPoint)_accessibilityOffsetForOpaqueElementDirection:(long)arg1;
- (void)_accessibilityScrollOpaqueElementIntoView:(long)arg1 previousScroller:(id)arg2;
...
- (id)_accessibilityMoveFocusToNextOpaqueElementForTechnology:(id)arg1 direction:(long)arg2 searchType:(long)arg3 range:(struct _NSRange)arg4 shouldScrollToVisible:(_Bool)arg5;
- (id)_accessibilityMoveFocusToNextOpaqueElementForTechnology:(id)arg1 direction:(long)arg2 searchType:(long)arg3 range:(struct _NSRange)arg4;
- (id)_accessibilityOpaqueHeaderElementInDirection:(long)arg1 childElement:(id)arg2;
...
- (void)_accessibilitySetAllowedPagingOverlap:(float)arg1;
...
- (id)_accessibilityDataSeriesValueDescriptionForPosition:(float)arg1 axis:(long)arg2;
- (id)_accessibilityDataSeriesCategoryLabelsForAxis:(long)arg1;
- (id)_accessibilityDataSeriesGridlinePositionsForAxis:(long)arg1;
- (id)_accessibilityDataSeriesMaximumValueForAxis:(long)arg1;
- (id)_accessibilityDataSeriesMinimumValueForAxis:(long)arg1;
- (id)_accessibilityDataSeriesUnitLabelForAxis:(long)arg1;
- (id)_accessibilityDataSeriesTitleForAxis:(long)arg1;
...
- (unsigned int)_accessibilityRowCount;
...
- (id)accessibilityDataTableCellElementForRow:(unsigned int)arg1 column:(unsigned int)arg2;
...
- (void)_iosAccessibilitySetValue:(id)arg1 forAttribute:(long)arg2;
- (id)_iosAccessibilityAttributeValue:(long)arg1;
- (int)_accessibilityReinterpretVoiceOverCommand:(int)arg1;
...
- (float)_accessibilityMagnifierZoomLevel;
- (id)_accessibilityTextualContext;
- (id)_iosAccessibilityAttributeValue:(long)arg1 forParameter:(id)arg2;
- (id)_accessibilityProcessElementsInDirection:(long)arg1 forParameter:(id)arg2;
...
- (id)_accessibilityHeaderElementsForRow:(unsigned int)arg1;
- (id)accessibilityHeaderElementsForRow:(unsigned int)arg1;
- (id)_accessibilityHeaderElementsForColumn:(unsigned int)arg1;
- (id)accessibilityHeaderElementsForColumn:(unsigned int)arg1;
- (id)_accessibilityPublicCustomRotorIdForSystemType:(id)arg1;
- (int)_accessibilityCustomRotorTypeForString:(id)arg1;
- (id)_accessibilityRotorTypeStringForCustomRotor:(int)arg1;
...
- (unsigned int)accessibilityBlockquoteLevel;
...
- (_Bool)_accessibilityIsLastSiblingForType:(unsigned long)arg1;
- (_Bool)_accessibilityIsFirstSiblingForType:(unsigned long)arg1;
...
- (id)_accessibilityAncestorForSiblingsWithType:(unsigned long)arg1;
- (id)_axAncestorTypes;
...
- (long)_accessibilityOrientation;
...
- (_Bool)_accessibilityScrollPageInDirection:(int)arg1 shouldSendScrollFailed:(_Bool)arg2;
...
- (_Bool)_accessibilityHandlePublicScroll:(int)arg1;
- (struct CGPoint)_accessibilityScrollRectToVisible:(struct CGRect)arg1;
- (void)_accessibilityScrollToPoint:(struct CGPoint)arg1;
- (_Bool)_animateScrollViewWithMachPort:(unsigned int)arg1 amount:(float)arg2 point:(struct CGPoint)arg3;
...
- (float)_accessibilityVisibleItemDenominator;
...
- (long)_accessibilityExpandedStatus;
...
- (void)accessibilitySetValue:(id)arg1 forAttribute:(long)arg2;
- (_Bool)accessibilityPerformAction:(int)arg1 withValue:(id)arg2 fencePort:(unsigned int)arg3;
- (id)accessibilityAttributeValue:(long)arg1 forParameter:(id)arg2;
- (id)accessibilityAttributeValue:(long)arg1;
...
- (void)_accessibilityAutoscrollInDirection:(unsigned long)arg1;
- (_Bool)_accessibilityIsAutoscrolling;
- (unsigned long)_accessibilityAvailableAutoscrollDirections;
...
- (float)_axScaleTransformForFocusLayerLineWidth;
...
- (void *)_accessibilityGetBlockForAttribute:(int)arg1;
- (void)_accessibilitySetBlock:(void *)arg1 forAttribute:(int)arg2;
...
- (_Bool)_accessibilityHasActionBlockForKey:(unsigned long)arg1;
...
- (void)_accessibilitySetScannerActivateBehavior:(long)arg1;
- (long)_accessibilityScannerActivateBehavior;
- (void)_accessibilitySetScannerGroupTraits:(unsigned long)arg1;
- (void)_accessibilitySetIsScannerGroup:(_Bool)arg1;
- (unsigned long)_accessibilityScannerGroupTraits;
- (_Bool)_accessibilityIsScannerGroup;
- (id)_accessibilityGroupIdentifier;
- (unsigned long)_accessibilityScanningBehaviorTraits;
...
- (id)_accessibilityUserTestingSnapshotAncestorsWithAttributes:(id)arg1 maxDepth:(unsigned int)arg2 maxChildren:(unsigned int)arg3 maxArrayCount:(unsigned int)arg4 honorsModalViews:(_Bool)arg5;
- (id)_accessibilityUserTestingSnapshotDescendantsWithAttributes:(id)arg1 maxDepth:(unsigned int)arg2 maxChildren:(unsigned int)arg3 maxArrayCount:(unsigned int)arg4 honorsModalViews:(_Bool)arg5;
