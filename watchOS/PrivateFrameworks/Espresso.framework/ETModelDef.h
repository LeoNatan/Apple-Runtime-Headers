...
- (id)layerNames;
- (id)variableForLayer:(id)arg1 kind:(unsigned int)arg2;
- (id)variables;
- (int)configureLayersToTrain:(id)arg1 reinitializeVariables:(_Bool)arg2;
- (id)variableNameForLayer:(id)arg1 kind:(unsigned int)arg2;
- (void)setupVariablesDef;
- (void)randomizeWeightsForLayer:(id)arg1 withSeed:(float)arg2;
- (void)updateLayer:(id)arg1 withBiases:(shared_ptr_6c49034a)arg2 length:(unsigned int)arg3;
- (void)updateLayer:(id)arg1 withWeights:(shared_ptr_6c49034a)arg2 length:(unsigned int)arg3;
- (shared_ptr_9e9623e1)biasesForLayer:(id)arg1;
