...
@property(readonly) unsigned int mode; // @synthesize mode=_mode;
...
- (id)initWithMode:(unsigned int)arg1 inputName:(id)arg2 targetName:(id)arg3 lossOutputName:(id)arg4;
