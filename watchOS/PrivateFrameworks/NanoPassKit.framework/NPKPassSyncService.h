...
- (void)handleIncomingPassSettings:(unsigned int)arg1 forPassWithUniqueID:(id)arg2;
- (unsigned int)settingsForPassWithUniqueID:(id)arg1;
- (id)currentLibraryPassSyncStateWithReconciledState:(id)arg1;
- (void)suggestSync;
- (void)handleCatalogChanged:(id)arg1;
- (void)handleSettingsChanged:(unsigned int)arg1 forPassWithUniqueID:(id)arg2;
- (void)handlePassLibraryChanged;
- (void)start;
- (id)initWithPassSyncEngineRole:(unsigned int)arg1;
