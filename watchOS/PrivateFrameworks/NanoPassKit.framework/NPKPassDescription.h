...
@interface NPKPassDescription : NSObject <NSSecureCoding, NSCopying>
{
    ...
    unsigned int _expressPassTypesMask;
...
@property(nonatomic) int effectivePaymentApplicationState; // @synthesize effectivePaymentApplicationState=_effectivePaymentApplicationState;
...
@property(nonatomic) unsigned int settings; // @synthesize settings=_settings;
...
@property(nonatomic) unsigned int expressPassTypesMask; // @synthesize expressPassTypesMask=_expressPassTypesMask;
- (void).cxx_destruct;
- (_Bool)hasValidNFCPayload;
- (_Bool)supportsExpressPassType:(int)arg1;
- (_Bool)isEnroute;
- (_Bool)isAddValuePending;
- (id)fieldForKey:(id)arg1;
- (id)transitProperties;
@property(readonly, nonatomic) int effectiveContactlessPaymentApplicationState;
- (_Bool)supportsInAppPaymentOnNetworks:(id)arg1 capabilities:(unsigned int)arg2 issuerCountryCodes:(id)arg3 paymentApplicationStates:(id)arg4;
