...
- (void)_removePairedPeer:(id)arg1 options:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)removePairedPeer:(id)arg1 options:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_savePairedPeer:(id)arg1 options:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)savePairedPeer:(id)arg1 options:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)_getPairedPeersWithOptions:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
- (void)getPairedPeersWithOptions:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
- (void)_deletePairingIdentityWithOptions:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
- (void)deletePairingIdentityWithOptions:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
- (void)_getPairingIdentityWithOptions:(unsigned int)arg1 tryCount:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
