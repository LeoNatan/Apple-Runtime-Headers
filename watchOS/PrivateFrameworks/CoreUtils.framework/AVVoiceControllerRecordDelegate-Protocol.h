...
@optional
- (void)voiceControllerStreamInvalidated:(AVVoiceController *)arg1 forStream:(unsigned int)arg2;
- (void)voiceControllerAudioCallback:(AVVoiceController *)arg1 forStream:(unsigned int)arg2 buffer:(AVVCAudioBuffer *)arg3;
- (void)voiceControllerDidStopRecording:(AVVoiceController *)arg1 forStream:(unsigned int)arg2 forReason:(int)arg3;
- (void)voiceControllerDidStartRecording:(AVVoiceController *)arg1 forStream:(unsigned int)arg2 successfully:(_Bool)arg3 error:(NSError *)arg4;
