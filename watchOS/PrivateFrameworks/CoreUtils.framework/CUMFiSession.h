...
@class CUMFiReadRequest, CUMFiWriteRequest, EAAccessory, EASession, NSInputStream, NSObject<OS_dispatch_queue>, NSOutputStream, NSString;
...
- (void)readMinLength:(unsigned long)arg1 maxLength:(unsigned long)arg2 completion:(CDUnknownBlockType)arg3;
