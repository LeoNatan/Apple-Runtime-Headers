...
- (void)mapQueueShutDownStateMachineInMap:(id)arg1 personIDs:(id)arg2 index:(unsigned int)arg3 forDestruction:(_Bool)arg4 completionBlock:(CDUnknownBlockType)arg5;
- (void)shutDown;
- (void)start;
- (id)init;
