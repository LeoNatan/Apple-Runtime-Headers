...
- (_Bool)dbQueueCommentWithGUID:(id)arg1 outObject:(id *)arg2 outID:(unsigned int *)arg3 outTimestamp:(id *)arg4 outAssetCollectionGUID:(id *)arg5 outIsCaption:(_Bool *)arg6 outUserInfoData:(id *)arg7;
