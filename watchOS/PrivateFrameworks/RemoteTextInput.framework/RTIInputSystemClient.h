...
{
    unsigned int _environmentOptions;
    _Bool _isInDealloc;
    unsigned int _currentEnvironmentOptions;
...
@property(readonly, nonatomic) unsigned int currentEnvironmentOptions; // @synthesize currentEnvironmentOptions=_currentEnvironmentOptions;
...
- (void)setEnvironmentOptions:(unsigned int)arg1 withReason:(id)arg2;
