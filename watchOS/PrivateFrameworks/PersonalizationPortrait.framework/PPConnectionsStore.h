...
- (_Bool)iterRecentLocationsForConsumer:(unsigned int)arg1 criteria:(id)arg2 limit:(unsigned int)arg3 client:(id)arg4 error:(id *)arg5 block:(CDUnknownBlockType)arg6;
