...
@property int loginCancelledCount; // @synthesize loginCancelledCount=_loginCancelledCount;
...
- (void)removeAllCredentialsForEnvironment:(int)arg1 completionHandler:(CDUnknownBlockType)arg2;
