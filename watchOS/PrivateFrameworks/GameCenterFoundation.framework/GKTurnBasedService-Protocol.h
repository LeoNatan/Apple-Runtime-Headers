...
- (oneway void)reserveShareParticipantSlots:(int)arg1 minPlayerCount:(int)arg2 maxPlayerCount:(int)arg3 andInvitePlayers:(NSArray *)arg4 withMessage:(NSString *)arg5 forMatch:(GKTurnBasedMatchInternal *)arg6 handler:(void (^)(NSError *))arg7;
...
- (oneway void)getNextTurnBasedEventWithHandler:(void (^)(NSString *, NSString *, int, _Bool, NSError *))arg1;
...
- (oneway void)resignFromTurnBasedGame:(GKTurnBasedMatchInternal *)arg1 outcome:(unsigned int)arg2 handler:(void (^)(GKTurnBasedMatchInternal *, NSError *))arg3;
