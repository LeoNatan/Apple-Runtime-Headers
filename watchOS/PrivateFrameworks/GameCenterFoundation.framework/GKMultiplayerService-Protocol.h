...
- (oneway void)declineGameInvite:(GKInviteInternal *)arg1 reason:(int)arg2 handler:(void (^)(void))arg3;
...
- (oneway void)getOverallFlowRateWithHandler:(void (^)(unsigned int, NSError *))arg1;
- (oneway void)getFlowRateForPlayerGroup:(int)arg1 handler:(void (^)(unsigned int, NSError *))arg2;
- (oneway void)cancelOutstandingMatchRequestWithHandler:(void (^)(void))arg1;
- (oneway void)getPlayersForMatchRequest:(GKMatchRequestInternal *)arg1 connectionData:(NSData *)arg2 connectedPeers:(int)arg3 rematchID:(NSString *)arg4 handler:(void (^)(GKMatchResponse *, NSError *))arg5;
@end
