...
+ (void)createSessionInContainer:(id)arg1 withTitle:(id)arg2 maxConnectedPlayers:(int)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
@property(nonatomic) int maxNumberOfConnectedPlayers; // @synthesize maxNumberOfConnectedPlayers=_maxNumberOfConnectedPlayers;
...
- (void)sendData:(id)arg1 withTransportType:(int)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (id)playersWithConnectionState:(int)arg1;
- (void)setConnectionState:(int)arg1 completionHandler:(CDUnknownBlockType)arg2;
