...
- (oneway void)getSuggestionsForNickname:(NSString *)arg1 suggestionsCount:(int)arg2 handler:(void (^)(NSArray *, NSError *))arg3;
- (oneway void)setPlayerNickname:(NSString *)arg1 suggestionsCount:(int)arg2 handler:(void (^)(NSArray *, unsigned int, NSError *))arg3;
