...
- (oneway void)setConnectionState:(int)arg1 forSessionWithIdentifier:(NSString *)arg2 handler:(void (^)(GKGameSession *, NSError *))arg3;
...
- (oneway void)createSessionInContainer:(NSString *)arg1 withTitle:(NSString *)arg2 maxConnectedPlayers:(int)arg3 handler:(void (^)(GKGameSession *, NSError *))arg4;
