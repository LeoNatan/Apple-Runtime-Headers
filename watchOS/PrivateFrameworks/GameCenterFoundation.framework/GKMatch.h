...
- (id)stringForGKPlayerConnectionState:(int)arg1;
...
- (_Bool)sendDataToAllPlayers:(id)arg1 withDataMode:(int)arg2 error:(id *)arg3;
- (_Bool)sendData:(id)arg1 toPlayers:(id)arg2 withDataMode:(int)arg3 error:(id *)arg4;
- (_Bool)sendData:(id)arg1 toPlayers:(id)arg2 dataMode:(int)arg3 error:(id *)arg4;
