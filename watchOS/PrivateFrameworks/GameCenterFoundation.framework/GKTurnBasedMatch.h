...
- (void)reserveShareParticipantSlots:(int)arg1 minPlayerCount:(int)arg2 maxPlayerCount:(int)arg3 andInvitePlayers:(id)arg4 withMessage:(id)arg5 handler:(CDUnknownBlockType)arg6;
