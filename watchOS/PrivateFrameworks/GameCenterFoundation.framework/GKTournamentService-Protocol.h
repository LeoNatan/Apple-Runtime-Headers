...
- (oneway void)getTournamentStateForTournament:(NSString *)arg1 completionHandler:(void (^)(int, NSError *))arg2;
...
- (oneway void)getFriendCountInTournament:(NSString *)arg1 forGroup:(int)arg2 completionHandler:(void (^)(int, NSError *))arg3;
- (oneway void)getTotalPlayerCountInTournament:(NSString *)arg1 forGroup:(int)arg2 completionHandler:(void (^)(int, NSError *))arg3;
...
- (oneway void)registerPlayerInTournament:(NSString *)arg1 playerGroup:(int)arg2 completionHandler:(void (^)(NSError *))arg3;
- (oneway void)reportProgressScore:(int)arg1 withTryToken:(NSString *)arg2 forTournament:(NSString *)arg3 completionHandler:(void (^)(NSError *))arg4;
- (oneway void)reportScore:(int)arg1 withTryToken:(NSString *)arg2 forTournament:(NSString *)arg3 completionHandler:(void (^)(NSError *))arg4;
@end
