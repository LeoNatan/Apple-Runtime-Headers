...
- (void)matchWithRequest:(id)arg1 currentMatch:(id)arg2 hostedCurrentPlayerCount:(int)arg3 serverHosted:(_Bool)arg4 rematchID:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)_request:(id)arg1 match:(id)arg2 rematchID:(id)arg3 serverHosted:(_Bool)arg4 playerCount:(int)arg5 connectionData:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;
...
- (id)declineReasonString:(int)arg1;
...
- (id)hashForBundleID:(id)arg1 version:(id)arg2 platform:(int)arg3;
