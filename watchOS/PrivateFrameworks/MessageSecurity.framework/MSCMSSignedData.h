...
- (struct __SecCertificate *)getSignerCertificate:(unsigned int)arg1 error:(id *)arg2;
...
- (_Bool)addSigner:(id)arg1 withChainMode:(unsigned int)arg2 error:(id *)arg3;
...
- (id)initWithEmbeddedContent:(id)arg1 signer:(id)arg2 signerChainMode:(unsigned int)arg3 error:(id *)arg4;
...
- (id)initWithDataContent:(id)arg1 isDetached:(_Bool)arg2 signer:(id)arg3 signerChainMode:(unsigned int)arg4 error:(id *)arg5;
...
- (_Bool)addCertificatesForSigner:(id)arg1 mode:(unsigned int)arg2 error:(id *)arg3;
