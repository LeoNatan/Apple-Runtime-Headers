...
@interface MSCMSSignerInfo : NSObject
{
    ...
    NSData *_LAContext;
    // Error parsing type: ^{__SecKey={__CFRuntimeBase=IAI}^{__SecKeyDescriptor}^v}, name: _signerPrivKey
...
// Property attributes: T^{__SecKey={__CFRuntimeBase=IAI}^{__SecKeyDescriptor}^v},V_signerPrivKey
