...
- (void)_writeCollection:(id)arg1 toStream:(id)arg2 startBlock:(CDUnknownBlockType)arg3 writerBlock:(CDUnknownBlockType)arg4 endBlock:(CDUnknownBlockType)arg5 wantsHeader:(_Bool)arg6 depth:(unsigned int)arg7;
- (void)_writeValue:(id)arg1 toStream:(id)arg2 depth:(unsigned int)arg3 needsIndent:(_Bool)arg4;
