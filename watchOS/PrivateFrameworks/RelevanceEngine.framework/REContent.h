...
@property(nonatomic) unsigned int description2FontStyle;
@property(nonatomic) unsigned int description1FontStyle;
@property(nonatomic) unsigned int headerFontStyle;
@property(nonatomic) _Bool useMonospaceFont;
@property(nonatomic) unsigned int style;
@property(copy, nonatomic) UIColor *tintColor;
@property(nonatomic) unsigned int punchThrough;
