...
- (id)userActivityByFilteringUserActivity:(id)arg1 withLevel:(unsigned int)arg2;
- (id)intentByFilteringIntent:(id)arg1 withLevel:(unsigned int)arg2;
- (id)init;
