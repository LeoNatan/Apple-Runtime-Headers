...
- (void)_enumerateObjectsOfType:(unsigned int)arg1 usingBlock:(CDUnknownBlockType)arg2;
- (id)nodeValueForDefinition:(id)arg1;
- (id)objectValueForDefinition:(id)arg1;
- (_Bool)typeForDefinition:(id)arg1 type:(unsigned int *)arg2;
...
- (_Bool)define:(id)arg1 type:(unsigned int)arg2 options:(id)arg3 error:(id *)arg4;
