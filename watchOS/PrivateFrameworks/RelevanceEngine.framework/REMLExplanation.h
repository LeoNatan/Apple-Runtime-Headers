...
- (id)_formattedFeatureListFromFeatures:(id)arg1 style:(unsigned int)arg2;
- (id)_formattedNameForFeature:(id)arg1 style:(unsigned int)arg2;
...
- (int)rankExplanationToExplanation:(id)arg1;
