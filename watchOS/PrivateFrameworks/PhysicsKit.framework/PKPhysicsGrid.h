...
- (shared_ptr_2aaf3a07)pathFromOutlineWithSmoothingThreshold:(float)arg1 bounds:(CDStruct_c7fe8b62)arg2;
- (id)physicsBodyFromSmoothedOutline:(float)arg1 size:(struct CGSize)arg2;
