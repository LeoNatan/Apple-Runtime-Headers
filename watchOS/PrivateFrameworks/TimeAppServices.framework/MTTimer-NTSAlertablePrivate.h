...
#import <TimeAppServices/NTSAlertablePrivate-Protocol.h>

@class NSDate, NSString;

@interface MTTimer (NTSAlertablePrivate) <NTSAlertablePrivate, NTSAlertable>
+ (id)alertForBulletin:(id)arg1 withAlertProvider:(id)arg2;
