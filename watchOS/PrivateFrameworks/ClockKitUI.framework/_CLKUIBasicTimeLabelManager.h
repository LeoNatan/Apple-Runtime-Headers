...
- (id)_initPrimary:(_Bool)arg1 withTimeFormatter:(id)arg2 options:(unsigned int)arg3 labelFactory:(CDUnknownBlockType)arg4;
- (id)initWithTimeFormatter:(id)arg1 options:(unsigned int)arg2 labelFactory:(CDUnknownBlockType)arg3;
