...
- (id)terminatePlugInsInApplication:(id)arg1 options:(int)arg2 withError:(id *)arg3;
- (id)forceHoldPlugIn:(id)arg1 withError:(id *)arg2;
- (id)holdPlugInsInApplication:(id)arg1 withError:(id *)arg2;
- (void)terminatePlugInsInApplication:(id)arg1 options:(int)arg2 result:(CDUnknownBlockType)arg3;
