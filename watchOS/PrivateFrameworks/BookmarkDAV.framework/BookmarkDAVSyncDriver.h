...
@property(nonatomic) unsigned int accountPropertyFetchAttempt; // @synthesize accountPropertyFetchAttempt=_accountPropertyFetchAttempt;
...
- (_Bool)_addChange:(void *)arg1 toData:(id)arg2 numActionsP:(int *)arg3 runningSizeP:(int *)arg4 maxResources:(int)arg5 maxSize:(int)arg6 foldersToAddByServerId:(struct __CFDictionary *)arg7 parentToArrayOfChildrenFolderChanges:(struct __CFDictionary *)arg8 pushedParentToArrayOfChildrenFolders:(struct __CFDictionary *)arg9;
