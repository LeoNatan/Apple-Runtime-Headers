...
@property(readonly, nonatomic) int downgradesToVersion; // @synthesize downgradesToVersion=_downgradesToVersion;
...
- (_Bool)writeDatabaseVersion:(int)arg1 resultBlock:(CDUnknownBlockType)arg2;
