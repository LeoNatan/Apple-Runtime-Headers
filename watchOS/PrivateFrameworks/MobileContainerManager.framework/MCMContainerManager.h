...
- (id)temporaryContainerWithContentClass:(int)arg1 identifier:(id)arg2 existed:(_Bool *)arg3 error:(id *)arg4;
- (id)containerWithContentClass:(int)arg1 identifier:(id)arg2 createIfNecessary:(_Bool)arg3 existed:(_Bool *)arg4 error:(id *)arg5;
- (id)containerWithContentClass:(int)arg1 identifier:(id)arg2 error:(id *)arg3;
- (id)init;
- (id)_containersWithClass:(int)arg1 temporary:(_Bool)arg2 error:(id *)arg3;
