...
@interface ASAsset : NSObject
{
    ...
    // Error parsing type: ^{__MobileAsset={__CFRuntimeBase=IAI}^{__CFString}^{__CFDictionary}^{__MobileAssetQuery}^{__MobileAssetQuery}C}, name: _cfAsset
...
-     // Error parsing type: ^{__MobileAsset={__CFRuntimeBase=IAI}^{__CFString}^{__CFDictionary}^{__MobileAssetQuery}^{__MobileAssetQuery}C}8@0:4, name: mobileAsset
