...
- (id)_descriptionForArgument:(id)arg1 index:(unsigned int)arg2 format:(_Bool)arg3 metadata:(id)arg4;
...
- (void)registerCustomLogSettings:(id)arg1 forSelector:(SEL)arg2 argumentIndex:(unsigned int)arg3;
