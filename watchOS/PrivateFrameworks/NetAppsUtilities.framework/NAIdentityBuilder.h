...
- (unsigned int)hashOfObject:(id)arg1;
- (id)appendCharacteristic:(CDUnknownBlockType)arg1 withRole:(int)arg2 comparatorBlock:(CDUnknownBlockType)arg3 hashBlock:(CDUnknownBlockType)arg4;
- (id)appendRangeCharacteristic:(CDUnknownBlockType)arg1 withRole:(int)arg2;
- (id)appendDoubleCharacteristic:(CDUnknownBlockType)arg1 withRole:(int)arg2;
- (id)appendFloatCharacteristic:(CDUnknownBlockType)arg1 withRole:(int)arg2;
- (id)appendUnsignedIntegerCharacteristic:(CDUnknownBlockType)arg1 withRole:(int)arg2;
- (id)appendIntegerCharacteristic:(CDUnknownBlockType)arg1 withRole:(int)arg2;
- (id)appendCharacteristic:(CDUnknownBlockType)arg1 withRole:(int)arg2;
