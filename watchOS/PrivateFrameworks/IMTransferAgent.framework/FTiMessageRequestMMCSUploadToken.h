...
@property int responseContentVersion; // @synthesize responseContentVersion=_responseContentVersion;
...
@property int contentVersion; // @synthesize contentVersion=_contentVersion;
