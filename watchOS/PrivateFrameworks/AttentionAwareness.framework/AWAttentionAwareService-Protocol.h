...
- (void)addClient:(id <AWFrameworkClient>)arg1 clientConfig:(AWAttentionAwarenessConfiguration *)arg2 unitTestMode:(_Bool)arg3 reply:(void (^)(id <AWRemoteClient>, NSError *))arg4;
@end
