...
@property(readonly, nonatomic) unsigned int activationMode; // @synthesize activationMode=_activationMode;
...
- (void).cxx_destruct;
- (id)initWithActionBlock:(CDUnknownBlockType)arg1 remoteViewControllerClassName:(id)arg2 remoteServiceBundleIdentifier:(id)arg3 actionIdentifier:(id)arg4 activationMode:(unsigned int)arg5 behavior:(unsigned int)arg6 parameters:(id)arg7;
