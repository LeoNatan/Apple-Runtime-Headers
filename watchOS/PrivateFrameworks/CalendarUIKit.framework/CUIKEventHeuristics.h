...
+ (_Bool)_shouldFilterEvent:(id)arg1 filterOptions:(unsigned int)arg2;
...
+ (id)upcomingEventsInCalendars:(id)arg1 onlyReturnFirstEvents:(_Bool)arg2 filterOptions:(unsigned int)arg3 sortMethod:(unsigned int)arg4 eventStore:(id)arg5;
