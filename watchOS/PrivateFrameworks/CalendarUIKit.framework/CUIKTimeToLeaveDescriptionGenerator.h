...
+ (id)_travelAdvisoryDescriptionOfType:(unsigned int)arg1 hypothesis:(id)arg2 eta:(id)arg3 location:(id)arg4;
+ (id)travelAdvisoryDescriptionOfType:(unsigned int)arg1 hypothesis:(id)arg2 location:(id)arg3;
+ (id)explanatoryText;
