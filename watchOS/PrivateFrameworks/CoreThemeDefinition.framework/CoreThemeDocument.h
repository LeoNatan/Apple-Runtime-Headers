...
- (_Bool)allowMultipleInstancesOfElementID:(int)arg1;
...
- (id)glyphSizeWithIdentifier:(int)arg1;
- (id)glyphWeightWithIdentifier:(int)arg1;
- (id)localizationWithIdentifier:(int)arg1 name:(id)arg2 createIfNeeded:(_Bool)arg3;
- (id)localizationWithIdentifier:(int)arg1;
- (id)appearanceWithIdentifier:(int)arg1 name:(id)arg2 createIfNeeded:(_Bool)arg3;
- (id)appearanceWithIdentifier:(int)arg1;
