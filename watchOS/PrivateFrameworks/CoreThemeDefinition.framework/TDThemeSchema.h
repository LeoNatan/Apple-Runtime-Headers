...
- (void)_addSchemaPartDefinitionsForStandardElement:(const CDStruct_80a119ee *)arg1 withElement:(id)arg2;
- (void)_sanityCheckSchemaPartDefinitionsForStandardElement:(const CDStruct_80a119ee *)arg1 withElement:(id)arg2;
