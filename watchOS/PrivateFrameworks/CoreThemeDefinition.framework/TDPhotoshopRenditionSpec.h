...
- (id)createCSIRepresentationFromPSDImage:(id)arg1 withCompression:(_Bool)arg2 colorSpaceID:(unsigned int)arg3;
- (id)createCSIRepresentationWithCompression:(_Bool)arg1 colorSpaceID:(unsigned int)arg2 document:(id)arg3;
- (id)createCSIRepresentationFromGradientPSDImage:(id)arg1 withCompression:(_Bool)arg2 colorSpaceID:(unsigned int)arg3;
- (id)createCSIRepresentationFromPSDImage:(id)arg1 withCompression:(_Bool)arg2 edgeMetricsMask:(id)arg3 textMetricsMask:(id)arg4 baselineMetricsMask:(id)arg5 auxiliary1MetricsMask:(id)arg6 auxiliary2MetricsMask:(id)arg7 colorSpaceID:(unsigned int)arg8;
- (CDStruct_29e12816)_subtractThrowawaySliceFromMetricsIfNeeded:(struct CGRect)arg1 metrics:(CDStruct_29e12816)arg2 renditionRect:(struct CGRect)arg3;
