...
- (id)createCSIRepresentationFromPSDImage:(id)arg1 withCompression:(_Bool)arg2 edgeMetricsMask:(id)arg3 textMetricsMask:(id)arg4 baselineMetricsMask:(id)arg5 auxiliary1MetricsMask:(id)arg6 auxiliary2MetricsMask:(id)arg7 colorSpaceID:(unsigned int)arg8 allowsPaletteImageCompression:(_Bool)arg9 allowsHevcCompression:(_Bool)arg10 allowsDeepmapImageCompression:(_Bool)arg11;
