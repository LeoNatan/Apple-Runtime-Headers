...
- (id)description;
- (id)trialMessagesAtIndex:(unsigned int)arg1;
- (unsigned int)trialMessagesCount;
- (void)addTrialMessages:(id)arg1;
- (void)clearTrialMessages;
- (id)unaggregatedMessagesAtIndex:(unsigned int)arg1;
- (unsigned int)unaggregatedMessagesCount;
- (void)addUnaggregatedMessages:(id)arg1;
- (void)clearUnaggregatedMessages;
- (id)aggregatedMessagesAtIndex:(unsigned int)arg1;
- (unsigned int)aggregatedMessagesCount;
