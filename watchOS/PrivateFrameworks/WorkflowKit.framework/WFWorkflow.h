...
+ (_Bool)checkClientVersion:(unsigned int)arg1 currentVersion:(unsigned int)arg2 error:(id *)arg3;
+ (id)localizedSubtitleWithActionCount:(unsigned int)arg1;
...
- (id)actionIconsForAutomationSummaryMaxCount:(int)arg1;
...
- (void)dealloc;
- (id)initWithRecord:(id)arg1 storageProvider:(id)arg2 migrateIfNecessary:(_Bool)arg3 environment:(int)arg4 error:(id *)arg5;
