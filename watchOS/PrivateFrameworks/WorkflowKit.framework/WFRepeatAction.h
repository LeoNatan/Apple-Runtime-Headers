...
- (id)itemVariableNameWithScopeLevel:(unsigned int)arg1;
- (id)indexVariableNameWithScopeLevel:(unsigned int)arg1;
- (id)indexVariableName;
- (id)defaultOutputName;
- (_Bool)ignoresOutputFromAction:(id)arg1 inWorkflow:(id)arg2;
- (void)runWithInput:(id)arg1 error:(id *)arg2;
@property(readonly, nonatomic) unsigned int numberOfLoops;
