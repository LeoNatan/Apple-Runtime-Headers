...
// Property attributes: T^{Group=^^?{SlabAlloc=^^?I^{Replication}iI{atomic<unsigned long long>=AQ}{shared_ptr<realm::SlabAlloc::MappedFile>=^{MappedFile}^{__shared_weak_count}}{unique_ptr<std::__1::shared_ptr<const realm::util::File::Map<char> > [], std::__1::default_delete<std::__1::shared_ptr<const realm::util::File::Map<char> > []> >={__compressed_pair<std::__1::shared_ptr<const realm::util::File::Map<char> > *, std::__1::default_delete<std::__1::shared_ptr<const realm::util::File::Map<char> > []> >=^{shared_ptr<const realm::util::File::Map<char> >}}}I*IIi{unique_ptr<unsigned long [], std::__1::default_delete<unsigned long []> >={__compressed_pair<unsigned long *, std::__1::default_delete<unsigned long []> >=^L}}IiBi{vector<realm::SlabAlloc::Slab, std::__1::allocator<realm::SlabAlloc::Slab> >=^{Slab}^{Slab}{__compressed_pair<realm::SlabAlloc::Slab *, std::__1::allocator<realm::SlabAlloc::Slab> >=^{Slab}}}{vector<realm::SlabAlloc::Chunk, std::__1::allocator<realm::SlabAlloc::Chunk> >=^{Chunk}^{Chunk}{__compressed_pair<realm::SlabAlloc::Chunk *, std::__1::allocator<realm::SlabAlloc::Chunk> >=^{Chunk}}}{vector<realm::SlabAlloc::Chunk, std::__1::allocator<realm::SlabAlloc::Chunk> >=^{Chunk}^{Chunk}{__compressed_pair<realm::SlabAlloc::Chunk *, std::__1::allocator<realm::SlabAlloc::Chunk> >=^{Chunk}}}B[256{hash_entry=I*I}]I}{Array=^^?^{VTable}*qqII^{Allocator}I^{ArrayParent}ICBBB}{ArrayInteger=^^?^{VTable}*qqII^{Allocator}I^{ArrayParent}ICBBB}{ArrayString=^^?^{VTable}*qqII^{Allocator}I^{ArrayParent}ICBBBB}{vector<realm::Table *, std::__1::allocator<realm::Table *> >=^^{Table}^^{Table}{__compressed_pair<realm::Table **, std::__1::allocator<realm::Table *> >=^^{Table}}}BB{function<void (const realm::Group::CascadeNotification &)>={__value_func<void (const realm::Group::CascadeNotification &)>={type=[16C]}^{__base<void (const realm::Group::CascadeNotification &)>}}}{function<void ()>={__value_func<void ()>={type=[16C]}^{__base<void ()>}}}},R,N
