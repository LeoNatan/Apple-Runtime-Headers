...
- (void)runWithWatchKitUserInterface:(id)arg1 input:(id)arg2;
...
@property(readonly, nonatomic) unsigned int parameterCollapsingBehavior;
...
@property(readonly, nonatomic) int rateLimitDelay;
@property(readonly, nonatomic) int rateLimitTimeout;
