...
+ (void)determineLocationWithWorkflowEnvironment:(int)arg1 desiredAccuracy:(double)arg2 timeout:(double)arg3 completion:(CDUnknownBlockType)arg4;
+ (void)determineLocationWithWorkflowEnvironment:(int)arg1 desiredAccuracy:(double)arg2 completion:(CDUnknownBlockType)arg3;
+ (void)determineLocationWithWorkflowEnvironment:(int)arg1 completion:(CDUnknownBlockType)arg2;
- (void).cxx_destruct;
...
- (void)dealloc;
- (id)initWithWorkflowEnvironment:(int)arg1;
