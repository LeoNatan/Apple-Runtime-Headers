...
- (void)resolveOptionsForUserInput:(NSString *)arg1 forDynamicResolveParameter:(WFDynamicResolveParameter *)arg2 completion:(void (^)(NSArray *, int, INIntent *, NSError *))arg3;
@end
