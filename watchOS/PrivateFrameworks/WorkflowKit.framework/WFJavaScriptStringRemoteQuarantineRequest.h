...
@property(nonatomic) unsigned int runtimeType; // @synthesize runtimeType=_runtimeType;
...
- (id)initWithWorkflow:(id)arg1 runtimeType:(unsigned int)arg2 targetURL:(id)arg3 preRuntimeVariableString:(id)arg4 runtimeString:(id)arg5;
