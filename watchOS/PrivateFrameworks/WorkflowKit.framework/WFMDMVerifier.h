...
+ (id)dataInfosFromContentSources:(id)arg1 withManagedLevel:(unsigned int)arg2;
- (void).cxx_destruct;
...
- (id)errorFromFailedVerificationContentSources:(id)arg1 targetDataInfo:(id)arg2 destinationManagedLevel:(unsigned int)arg3;
