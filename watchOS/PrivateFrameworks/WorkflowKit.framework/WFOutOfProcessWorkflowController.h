...
- (void)dealloc;
- (id)initWithWorkflowData:(id)arg1 debugIdentifier:(id)arg2 environment:(int)arg3 workflowReference:(id)arg4;
- (id)initWithWorkflowData:(id)arg1 debugIdentifier:(id)arg2 environment:(int)arg3;
- (id)initWithWorkflow:(id)arg1 database:(id)arg2 environment:(int)arg3;
