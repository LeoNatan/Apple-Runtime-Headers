...
- (void).cxx_destruct;
@property(readonly, nonatomic) unsigned int currentActionIndex; // @synthesize currentActionIndex=_currentActionIndex;
...
- (id)initWithWorkflow:(id)arg1 variables:(id)arg2 currentActionIndex:(unsigned int)arg3 currentInput:(id)arg4 currentProcessedParameters:(id)arg5;
