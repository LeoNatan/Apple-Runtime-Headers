...
- (id)stateBySettingComparisonOperator:(int)arg1;
...
- (id)initWithPropertyName:(id)arg1 contentItemClass:(Class)arg2 comparisonOperator:(int)arg3 removable:(_Bool)arg4 bounded:(_Bool)arg5 hidden:(_Bool)arg6;
