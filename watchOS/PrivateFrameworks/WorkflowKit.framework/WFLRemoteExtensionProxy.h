...
@interface WFLRemoteExtensionProxy : NSObject <INCExtensionProxy>
{
    INCExtensionConnection *_connection;
    SARemoteDevice *_remoteDevice;
}

@property(retain, nonatomic) SARemoteDevice *remoteDevice; // @synthesize remoteDevice=_remoteDevice;
