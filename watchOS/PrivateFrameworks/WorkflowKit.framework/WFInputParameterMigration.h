...
- (id)findGetVariableActionProvidingInputToActionAtIndex:(int)arg1 inWorkflow:(id)arg2;
- (id)findActionProvidingInputToActionAtIndex:(unsigned int)arg1 inWorkflow:(id)arg2 reachedBeginning:(_Bool *)arg3 inputActionIndex:(unsigned int *)arg4;
