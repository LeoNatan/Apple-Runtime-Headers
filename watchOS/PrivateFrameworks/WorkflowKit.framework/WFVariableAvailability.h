...
- (unsigned int)variableScopeLevelForGroupingIdentifier:(id)arg1;
- (id)possibleContentClassesForVariableNamed:(id)arg1 atIndex:(unsigned int)arg2 context:(id)arg3 excludingAction:(id)arg4;
- (id)_possibleContentClassesForVariableNamed:(id)arg1 atIndex:(unsigned int)arg2 context:(id)arg3 excludingAction:(id)arg4;
- (id)actionsProvidingVariableName:(id)arg1 atIndex:(unsigned int)arg2;
...
- (_Bool)isVariableAvailableAtIndex:(unsigned int)arg1 withActionTest:(CDUnknownBlockType)arg2;
- (_Bool)isVariableWithName:(id)arg1 availableAtIndex:(unsigned int)arg2;
- (_Bool)areVariablesAvailableAtIndex:(unsigned int)arg1;
- (id)availableVariableNamesAtIndex:(unsigned int)arg1;
