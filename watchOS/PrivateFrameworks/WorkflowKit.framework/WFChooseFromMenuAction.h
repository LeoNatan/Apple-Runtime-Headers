...
- (void)arrayParameter:(id)arg1 itemWasMovedFromIndex:(unsigned int)arg2 toIndex:(unsigned int)arg3;
- (void)arrayParameter:(id)arg1 itemWasAppended:(id)arg2;
- (unsigned int)numberOfActionsIncludedWithAction:(id)arg1;
