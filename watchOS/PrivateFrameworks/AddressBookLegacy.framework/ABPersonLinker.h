...
- (_Bool)linkRecentlyAddedPeopleWithLimit:(int)arg1;
...
- (void)removeAllLinks;
- (void)makeLinksForAddedPeople:(id)arg1 inInitialLinking:(_Bool)arg2 countingOuterIterations:(unsigned int *)arg3 detectedLinkCount:(unsigned int *)arg4;
