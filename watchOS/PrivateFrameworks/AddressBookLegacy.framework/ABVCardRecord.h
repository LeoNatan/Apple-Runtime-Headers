...
- (id)dataForSocialProfileProperty:(void *)arg1 groupCount:(int *)arg2 includePrivateData:(_Bool)arg3;
- (id)propertyLineForGenericABProperty21:(unsigned int)arg1 vCardProperty:(id)arg2;
- (id)propertyLineForIMPPProperty:(_Bool)arg1 groupCount:(int *)arg2 includePrivateData:(_Bool)arg3;
- (id)propertyLineForInstantMessageHandles:(_Bool)arg1 groupCount:(int *)arg2 includePrivateData:(_Bool)arg3;
- (id)propertyLineForGenericABProperty:(unsigned int)arg1 vCardProperty:(id)arg2 is21:(_Bool)arg3 groupCount:(int *)arg4;
