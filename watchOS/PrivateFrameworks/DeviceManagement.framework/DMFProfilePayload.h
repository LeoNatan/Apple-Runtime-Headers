...
@property(readonly, nonatomic) int payloadVersion; // @synthesize payloadVersion=_payloadVersion;
...
- (id)initWithType:(id)arg1 identifier:(id)arg2 payloadVersion:(int)arg3 displayName:(id)arg4 organization:(id)arg5 payloadDescription:(id)arg6;
