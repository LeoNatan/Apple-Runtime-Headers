...
@property(readonly, nonatomic) unsigned int installSize; // @synthesize installSize=_installSize;
...
- (id)initWithProductKey:(id)arg1 humanReadableName:(id)arg2 productName:(id)arg3 version:(id)arg4 build:(id)arg5 downloadSize:(unsigned int)arg6 installSize:(unsigned int)arg7 isCritical:(_Bool)arg8 restartRequired:(_Bool)arg9 allowsInstallLater:(_Bool)arg10;
