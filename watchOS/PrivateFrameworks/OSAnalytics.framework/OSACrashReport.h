...
@interface OSACrashReport : OSAReport <OSAConcreteReport>
{
    ...
    unsigned long _spewage_diag_total_length;
...
- (char *)_copyStringFromTask:(unsigned int)arg1 atAddress:(unsigned long long)arg2 immutableOnly:(_Bool)arg3 maxLength:(unsigned long)arg4;
- (id)_readStringAtTaskAddress:(unsigned long long)arg1 immutableOnly:(_Bool)arg2 maxLength:(unsigned long)arg3;
