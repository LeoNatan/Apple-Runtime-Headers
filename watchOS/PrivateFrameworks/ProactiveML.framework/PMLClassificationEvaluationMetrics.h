...
+ (unsigned long)falseNegatives:(id)arg1 predictions:(id)arg2 predicate:(CDUnknownBlockType)arg3;
+ (unsigned long)trueNegatives:(id)arg1 predictions:(id)arg2 predicate:(CDUnknownBlockType)arg3;
+ (unsigned long)falsePositives:(id)arg1 predictions:(id)arg2 predicate:(CDUnknownBlockType)arg3;
+ (unsigned long)truePositives:(id)arg1 predictions:(id)arg2 predicate:(CDUnknownBlockType)arg3;
