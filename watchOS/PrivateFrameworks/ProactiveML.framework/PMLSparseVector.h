...
@interface PMLSparseVector : NSObject
{
    ...
    unsigned int _numberOfNonZeroValues;
    long long *_sparseIndices;
    float *_sparseValues;
}

+ (id)sparseVectorFromNumbers:(id)arg1 indices:(id)arg2 length:(unsigned int)arg3;
+ (id)sparseVectorFromNumbers:(id)arg1;
+ (id)sparseVectorEmptyWithLength:(unsigned int)arg1;
+ (id)sparseVectorFromDense:(id)arg1;
+ (id)sparseVectorFromDense:(const float *)arg1 length:(unsigned int)arg2;
...
@property(nonatomic) unsigned int numberOfNonZeroValues; // @synthesize numberOfNonZeroValues=_numberOfNonZeroValues;
...
- (id)indicesData;
- (void)dealloc;
- (id)initWithLength:(unsigned int)arg1 numberOfNonZeroValues:(unsigned int)arg2 indices:(long long *)arg3 values:(float *)arg4;
- (id)initWithLength:(unsigned int)arg1 numberOfNonZeroValues:(unsigned int)arg2 indicesData:(id)arg3 valuesData:(id)arg4;
- (id)init;
