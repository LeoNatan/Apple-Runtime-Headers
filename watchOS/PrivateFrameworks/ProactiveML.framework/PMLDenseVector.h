...
- (void).cxx_destruct;
- (float)valueAt:(unsigned int)arg1;
...
- (id)initWithFloatsNoCopy:(float *)arg1 count:(unsigned int)arg2 deallocator:(CDUnknownBlockType)arg3;
- (id)initWithFloatsNoCopy:(float *)arg1 count:(unsigned int)arg2 freeWhenDone:(_Bool)arg3;
- (id)initWithFloats:(const float *)arg1 count:(unsigned int)arg2;
