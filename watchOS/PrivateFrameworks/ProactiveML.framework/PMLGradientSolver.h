...
- (void)solveWithAvgGradient:(float *)arg1 maxNumberOfIterations:(unsigned int)arg2;
- (id)computeAvgGradientWithIterations:(unsigned int)arg1;
- (void)solve;
- (id)init;
- (id)initWithLearningRate:(float)arg1 minIterations:(unsigned int)arg2 stoppingThreshold:(float)arg3 weights:(id)arg4 intercept:(_Bool)arg5 gradientCalculator:(CDUnknownBlockType)arg6 predictionCalculator:(CDUnknownBlockType)arg7 batchPredictionCalculator:(CDUnknownBlockType)arg8;
