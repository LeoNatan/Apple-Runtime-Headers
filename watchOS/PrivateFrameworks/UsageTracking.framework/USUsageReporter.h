...
- (void).cxx_destruct;
- (void)fetchReportsForUsageType:(unsigned int)arg1 interval:(id)arg2 partitionInterval:(double)arg3 focalOnly:(_Bool)arg4 completionHandler:(CDUnknownBlockType)arg5;
