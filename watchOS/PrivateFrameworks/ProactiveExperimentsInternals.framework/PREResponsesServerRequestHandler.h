...
- (void)preResponseItemsForMessage:(id)arg1 maximumResponses:(unsigned int)arg2 conversationHistory:(id)arg3 language:(id)arg4 modelFilePath:(id)arg5 modelConfigPath:(id)arg6 registerDisplayed:(_Bool)arg7 completion:(CDUnknownBlockType)arg8;
