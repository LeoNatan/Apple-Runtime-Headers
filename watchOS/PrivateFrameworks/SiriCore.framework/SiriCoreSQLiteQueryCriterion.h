...
@property(readonly, nonatomic) int logicalOperator; // @synthesize logicalOperator=_logicalOperator;
@property(readonly, nonatomic) int comparisonOperator; // @synthesize comparisonOperator=_comparisonOperator;
@property(readonly, copy, nonatomic) NSString *columnName; // @synthesize columnName=_columnName;
- (id)copyWithZone:(struct _NSZone *)arg1;
- (id)initWithColumnName:(id)arg1 comparisonOperator:(int)arg2 logicalOperator:(int)arg3 value:(id)arg4 values:(id)arg5 subcriteriaProvider:(CDUnknownBlockType)arg6;
