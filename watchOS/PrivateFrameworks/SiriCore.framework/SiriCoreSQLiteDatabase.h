...
- (unsigned int)countValuesInTableWithName:(id)arg1 columnName:(id)arg2 behavior:(int)arg3 indexedBy:(id)arg4 criterion:(id)arg5 range:(id)arg6 error:(id *)arg7;
- (id)selectValuesFromTableWithName:(id)arg1 columnName:(id)arg2 behavior:(int)arg3 indexedBy:(id)arg4 criterion:(id)arg5 order:(id)arg6 range:(id)arg7 error:(id *)arg8;
- (id)selectRecordsFromTableWithName:(id)arg1 columnNames:(id)arg2 behavior:(int)arg3 indexedBy:(id)arg4 criterion:(id)arg5 order:(id)arg6 range:(id)arg7 recordBuilder:(id)arg8 error:(id *)arg9;
- (id)selectValueMapsFromTableWithName:(id)arg1 columnNames:(id)arg2 behavior:(int)arg3 indexedBy:(id)arg4 criterion:(id)arg5 order:(id)arg6 range:(id)arg7 error:(id *)arg8;
- (id)selectValueTuplesFromTableWithName:(id)arg1 columnNames:(id)arg2 behavior:(int)arg3 indexedBy:(id)arg4 criterion:(id)arg5 order:(id)arg6 range:(id)arg7 error:(id *)arg8;
