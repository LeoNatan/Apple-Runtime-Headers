...
- (id)selectRecordsFromTableWithName:(id)arg1 columnNames:(id)arg2 behavior:(int)arg3 criterion:(id)arg4 order:(id)arg5 range:(id)arg6 recordBuilder:(id)arg7 error:(id *)arg8;
