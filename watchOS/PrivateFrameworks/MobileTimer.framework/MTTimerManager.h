...
- (_Bool)_updateCurrentTimerWithStateSync:(unsigned int)arg1;
...
- (id)stopCurrentTimer;
- (id)_updateCurrentTimerWithState:(unsigned int)arg1;
- (id)currentTimer;
...
- (id)addTimer:(id)arg1;
- (id)nextTimersForDate:(id)arg1 maxCount:(unsigned int)arg2;
- (id)timersSync;
- (id)nextTimer;
- (id)timers;
