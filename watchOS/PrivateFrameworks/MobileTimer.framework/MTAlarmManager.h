...
- (id)nextAlarmSync;
- (id)sleepAlarmSync;
- (id)nextAlarmsInRangeSync:(id)arg1 maxCount:(unsigned int)arg2 includeSleepAlarm:(_Bool)arg3 includeBedtimeNotification:(_Bool)arg4;
- (id)nextAlarmsInRangeSync:(id)arg1 maxCount:(unsigned int)arg2 includeSleepAlarm:(_Bool)arg3;
- (id)nextAlarmsForDateSync:(id)arg1 maxCount:(unsigned int)arg2 includeSleepAlarm:(_Bool)arg3 includeBedtimeNotification:(_Bool)arg4;
- (id)nextAlarmsForDateSync:(id)arg1 maxCount:(unsigned int)arg2 includeBedtimeNotification:(_Bool)arg3;
- (id)nextAlarmsForDateSync:(id)arg1 maxCount:(unsigned int)arg2 includeSleepAlarm:(_Bool)arg3;
- (id)nextAlarmsForDateSync:(id)arg1 maxCount:(unsigned int)arg2;
...
- (id)_nextAlarmsInRange:(id)arg1 maxCount:(unsigned int)arg2 includeSleepAlarm:(_Bool)arg3 includeBedtimeNotification:(_Bool)arg4 doSynchronous:(_Bool)arg5;
- (id)nextAlarmsInRange:(id)arg1 maxCount:(unsigned int)arg2 includeSleepAlarm:(_Bool)arg3 includeBedtimeNotification:(_Bool)arg4;
- (id)nextAlarmsInRange:(id)arg1 maxCount:(unsigned int)arg2 includeSleepAlarm:(_Bool)arg3;
- (id)_nextAlarmsForDate:(id)arg1 maxCount:(unsigned int)arg2 includeSleepAlarm:(_Bool)arg3 includeBedtimeNotification:(_Bool)arg4 doSynchronous:(_Bool)arg5;
- (id)nextAlarmsForDate:(id)arg1 maxCount:(unsigned int)arg2 includeSleepAlarm:(_Bool)arg3 includeBedtimeNotification:(_Bool)arg4;
- (id)nextAlarmsForDate:(id)arg1 maxCount:(unsigned int)arg2 includeBedtimeNotification:(_Bool)arg3;
- (id)nextAlarmsForDate:(id)arg1 maxCount:(unsigned int)arg2 includeSleepAlarm:(_Bool)arg3;
- (id)nextAlarmsForDate:(id)arg1 maxCount:(unsigned int)arg2;
- (id)alarms;
- (id)alarmsSyncIncludingSleepAlarm:(_Bool)arg1;
- (id)alarmsSync;
- (unsigned int)firingAlarmCount;
- (unsigned int)alarmCountIncludingSleepAlarm:(_Bool)arg1;
- (id)nextAlarm;
- (id)sleepAlarm;
