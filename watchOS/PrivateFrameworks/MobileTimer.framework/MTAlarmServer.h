...
- (void)dismissAlarmWithIdentifier:(id)arg1 dismissAction:(unsigned int)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void)snoozeAlarmWithIdentifier:(id)arg1 snoozeAction:(unsigned int)arg2 withCompletion:(CDUnknownBlockType)arg3;
