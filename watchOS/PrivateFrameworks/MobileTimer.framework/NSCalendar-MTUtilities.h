...
+ (unsigned int)_optionsForBackwards:(_Bool)arg1;
...
- (id)_mtNextDateAfterDate:(id)arg1 matchingUnit:(unsigned int)arg2 value:(int)arg3 backwards:(_Bool)arg4;
- (id)mtPreviousDateBeforeDate:(id)arg1 matchingUnit:(unsigned int)arg2 value:(int)arg3;
- (id)mtNextDateAfterDate:(id)arg1 matchingUnit:(unsigned int)arg2 value:(int)arg3;
