...
@property(nonatomic) int alarmSoundType; // @synthesize alarmSoundType=_alarmSoundType;
...
@property(nonatomic) int repeatSchedule; // @synthesize repeatSchedule=_repeatSchedule;
