...
@property(nonatomic) unsigned int numAuthAttempts; // @synthesize numAuthAttempts=_numAuthAttempts;
...
- (void)dismissNotificationsForAlarm:(id)arg1 dismissAction:(unsigned int)arg2;
