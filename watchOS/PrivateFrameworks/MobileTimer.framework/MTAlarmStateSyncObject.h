...
+ (id)alarmStateWithAlarms:(id)arg1 sleepAlarm:(id)arg2 lastModifiedDate:(id)arg3 changeType:(int)arg4;
...
- (id)allAlarms;
- (id)lastModifiedDate;
- (id)initWithAlarms:(id)arg1 sleepAlarm:(id)arg2 lastModifiedDate:(id)arg3 changeType:(int)arg4;
