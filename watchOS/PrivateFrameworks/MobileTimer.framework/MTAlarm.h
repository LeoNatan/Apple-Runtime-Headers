...
- (id)_nextDateHelperWithDate:(id)arg1 hour:(int)arg2 minute:(int)arg3 calendar:(id)arg4;
...
- (int)compare:(id)arg1;
@property(readonly, nonatomic) int sleepDuration;
