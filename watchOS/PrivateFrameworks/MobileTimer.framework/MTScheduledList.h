...
- (void)reset;
- (id)_scheduledListForTriggerType:(unsigned int)arg1;
- (id)nextScheduledObjectWithTriggerType:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int numberOfScheduledAlertsAndNotifications;
@property(readonly, nonatomic) unsigned int numberOfScheduledAlerts;
