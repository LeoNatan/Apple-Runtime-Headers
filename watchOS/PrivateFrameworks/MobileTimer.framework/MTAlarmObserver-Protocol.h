...
- (void)source:(id <MTSource>)arg1 didDismissAlarm:(MTAlarm *)arg2 dismissAction:(unsigned int)arg3;
- (void)source:(id <MTSource>)arg1 didFireAlarm:(MTAlarm *)arg2 triggerType:(unsigned int)arg3;
- (void)source:(id <MTSource>)arg1 didSnoozeAlarm:(MTAlarm *)arg2 snoozeAction:(unsigned int)arg3;
