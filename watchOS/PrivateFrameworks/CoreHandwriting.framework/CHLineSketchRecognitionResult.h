...
- (id)initWithString:(id)arg1 score:(double)arg2 rotation:(float)arg3 startLocation:(struct CGPoint)arg4 startEndpointType:(int)arg5 endLocation:(struct CGPoint)arg6 endEndpointType:(int)arg7 midPointLocation:(struct CGPoint)arg8 controlPointLocation:(struct CGPoint)arg9 pathPoints:(id)arg10;
