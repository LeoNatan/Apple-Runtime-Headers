...
@interface CHRecognitionInsight : NSObject
{
    ...
    unsigned int _recognizerMaxRecognitionResultCount;
...
@property(nonatomic) unsigned int recognizerMaxRecognitionResultCount; // @synthesize recognizerMaxRecognitionResultCount=_recognizerMaxRecognitionResultCount;
...
- (void)recordDelayedStrokeProbabilities:(const vector_f9ed6fc8 *)arg1;
- (void)recordCharBoundaryProbabilities:(const vector_f9ed6fc8 *)arg1;
- (void)recordSpaceProbabilities:(const vector_f9ed6fc8 *)arg1;
