...
@property(nonatomic) map_ba07c80e cachedResults; // @synthesize cachedResults=_cachedResults;
...
- (id)_extractSubStrokeSegmentsFromSegments:(id)arg1 withDelayedStrokeSegments:(id *)arg2 fromDelayedSegmentIDs:(vector_55d7bafa)arg3;
- (id)recognitionResultsForMultipleCharacterDrawing:(id)arg1 sortedStrokeIndices:(vector_55d7bafa *)arg2 subStrokeSegments:(id)arg3 delayedSubStrokeSegments:(id)arg4 network:(struct Network *)arg5 boundsAtNode:(vector_ea45b3ba *)arg6 options:(id)arg7 shouldCancel:(CDUnknownBlockType)arg8;
...
- (id)postProcessMultiWordsLatticePaths:(const vector_7a3f6ffc *)arg1 withMaximumResults:(unsigned int)arg2;
...
- (id)bestNetworkPaths:(struct Network *)arg1 from:(unsigned long)arg2 to:(unsigned long)arg3 count:(unsigned int)arg4 staticLexiconCursor:(void *)arg5 customLexiconCursor:(struct _LXCursor *)arg6 patternCursor:(struct PatternGraph *)arg7 history:(id)arg8 activeHistoryRange:(struct _NSRange)arg9 mecabraIDs:(vector_12bd641b *)arg10 numExpectedDelayedStrokes:(unsigned int)arg11;
- (float)_calculateJointWordProbabilityForString:(id)arg1 withPatterns:(id)arg2;
...
- (id)defaultPunctuationResultsForRecognitionType:(int)arg1 withStrokeCount:(unsigned int)arg2;
