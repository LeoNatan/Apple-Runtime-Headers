...
- (void)_adjustCandidatesForChinesePunctuation:(vector_06f11b7b *)arg1 segmentedDrawing:(id)arg2 drawing:(id)arg3 inStrokeIndex:(int)arg4 outStrokeIndex:(int)arg5;
