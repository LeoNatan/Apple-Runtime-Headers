...
@property(readonly, nonatomic) unsigned int maxCandidateCount; // @synthesize maxCandidateCount=_maxCandidateCount;
...
- (void)dealloc;
- (id)initWithDrawing:(id)arg1 characterSet:(id)arg2 expandCodePoints:(_Bool)arg3 normalizationContext:(struct CGRect)arg4 firstPointIsSubstrokeCut:(_Bool)arg5 lastPointIsSubstrokeCut:(_Bool)arg6 maxCandidateCount:(unsigned int)arg7;
