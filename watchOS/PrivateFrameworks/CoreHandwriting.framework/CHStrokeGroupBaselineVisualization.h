...
- (struct CGAffineTransform)_orientationTransformForStrokeBounds:(struct CGRect)arg1 atWritingDirectionIndex:(int)arg2 inGroup:(id)arg3;
- (void)_getOrientedBounds:(struct CGRect *)arg1 length:(float *)arg2 forStroke:(id)arg3 atWritingDirectionIndex:(int)arg4 inGroup:(id)arg5;
