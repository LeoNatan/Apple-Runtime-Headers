...
@property(nonatomic, setter=_setReadyToPlayPlaybackID:) int _readyToPlayPlaybackID; // @synthesize _readyToPlayPlaybackID=__readyToPlayPlaybackID;
@property(nonatomic, setter=_setCurrentPlaybackID:) int _currentPlaybackID; // @synthesize _currentPlaybackID=__currentPlaybackID;
