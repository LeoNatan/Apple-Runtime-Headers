...
@property(nonatomic) float maximumDistanceLag; // @synthesize maximumDistanceLag=_maximumDistanceLag;
@property(nonatomic) float maximumDistance; // @synthesize maximumDistance=_maximumDistance;
