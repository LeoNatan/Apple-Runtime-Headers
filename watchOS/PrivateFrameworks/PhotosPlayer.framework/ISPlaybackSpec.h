...
@property(nonatomic) float playbackTransitionScale; // @synthesize playbackTransitionScale=_playbackTransitionScale;
@property(nonatomic) float playbackTransitionBlurRadius; // @synthesize playbackTransitionBlurRadius=_playbackTransitionBlurRadius;
