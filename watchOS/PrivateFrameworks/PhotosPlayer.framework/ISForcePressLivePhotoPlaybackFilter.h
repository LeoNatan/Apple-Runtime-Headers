...
@property(nonatomic, setter=_setCurrentTimeoutRequestId:) int _currentTimeoutRequestId; // @synthesize _currentTimeoutRequestId=__currentTimeoutRequestId;
...
@property(nonatomic) float forceProgress; // @synthesize forceProgress=_forceProgress;
