...
@property(nonatomic, setter=_setLastAppliedScale:) float lastAppliedScale; // @synthesize lastAppliedScale=_lastAppliedScale;
...
- (void)applyScale:(float)arg1 withTransitionOptions:(id)arg2 completion:(CDUnknownBlockType)arg3;
