...
- (void).cxx_destruct;
@property int curve; // @synthesize curve=_curve;
...
- (id)initWithCurve:(int)arg1 diffieHellmanOperation:(id)arg2 encryptionOperation:(id)arg3 digestOperation:(id)arg4;
