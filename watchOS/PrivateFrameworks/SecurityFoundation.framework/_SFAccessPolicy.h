...
{
    CDStruct_fa52dea6 _accessibility;
    int _sharingPolicy;
...
@property(nonatomic) int sharingPolicy; // @synthesize sharingPolicy=_sharingPolicy;
@property(nonatomic) CDStruct_fa52dea6 accessibility; // @synthesize accessibility=_accessibility;
