...
{
    _Bool _isRunning;
    unsigned int _calledStartImplementation;
    unsigned int _calledStopImplementation;
}

@property(readonly, nonatomic) _Bool isRunning; // @synthesize isRunning=_isRunning;
@property(readonly, nonatomic) unsigned int calledStopImplementation; // @synthesize calledStopImplementation=_calledStopImplementation;
@property(readonly, nonatomic) unsigned int calledStartImplementation; // @synthesize calledStartImplementation=_calledStartImplementation;
