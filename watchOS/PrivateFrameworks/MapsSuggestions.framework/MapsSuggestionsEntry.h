...
+ (id)entryWithType:(unsigned int)arg1 title:(id)arg2 subtitle:(id)arg3 weight:(double)arg4 expires:(id)arg5 sourceSpecificInfo:(id)arg6;
...
- (_Bool)_wasEverOfType:(unsigned int)arg1;
- (void)_overrideType:(unsigned int)arg1;
...
- (id)initWithType:(unsigned int)arg1 title:(id)arg2 subtitle:(id)arg3 weight:(double)arg4 expires:(id)arg5 geoMapItem:(id)arg6 sourceSpecificInfo:(id)arg7;
- (id)initWithType:(unsigned int)arg1 title:(id)arg2 subtitle:(id)arg3 weight:(double)arg4 expires:(id)arg5 sourceSpecificInfo:(id)arg6;
- (id)initWithType:(unsigned int)arg1 title:(id)arg2;
...
- (_Bool)wasEverOfType:(unsigned int)arg1;
