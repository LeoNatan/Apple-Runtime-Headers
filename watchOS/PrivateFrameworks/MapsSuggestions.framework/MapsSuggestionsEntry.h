...
+ (id)entryWithType:(int)arg1 title:(id)arg2 subtitle:(id)arg3 weight:(double)arg4 expires:(id)arg5 sourceSpecificInfo:(id)arg6;
...
- (_Bool)_wasEverOfType:(int)arg1;
- (void)_overrideType:(int)arg1;
- (id)serializedBase64String;
- (id)serializedHexString;
- (void)resetAvailableRemovalBehavior:(int)arg1;
- (void)setAvailableRemovalBehavior:(int)arg1;
- (int)availableRemovalBehaviors;
- (_Bool)hasExpired;
- (id)fullDescription;
- (id)shortDescription;
...
- (id)initWithType:(int)arg1 title:(id)arg2 subtitle:(id)arg3 weight:(double)arg4 expires:(id)arg5 geoMapItem:(struct GEOMapItemStorage *)arg6 sourceSpecificInfo:(id)arg7;
- (id)initWithType:(int)arg1 title:(id)arg2 subtitle:(id)arg3 weight:(double)arg4 expires:(id)arg5 sourceSpecificInfo:(id)arg6;
...
- (void)mergeSpecificsFromSuggestionEntry:(id)arg1 behavior:(unsigned int)arg2;
- (void)mergeFromSuggestionEntry:(id)arg1 behavior:(unsigned int)arg2 protectTitles:(_Bool)arg3 protectTitleDecorations:(_Bool)arg4 protectMapItem:(_Bool)arg5 protectWeight:(_Bool)arg6 protectExpiration:(_Bool)arg7 protectIcon:(_Bool)arg8;
- (void)mergeFromSuggestionEntry:(id)arg1 behavior:(unsigned int)arg2;
- (_Bool)expiresBeforeEntry:(id)arg1;
- (_Bool)startsBeforeEntry:(id)arg1;
- (_Bool)wasEverOneOfTypes:(id)arg1;
- (_Bool)wasEverOfType:(int)arg1;
