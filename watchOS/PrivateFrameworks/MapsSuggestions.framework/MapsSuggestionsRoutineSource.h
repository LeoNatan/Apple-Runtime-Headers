...
- (id)_extractTitleAndSubtitleFromMapItem:(id)arg1 forType:(unsigned int)arg2;
- (int)_convertTransportType:(int)arg1;
- (unsigned int)_convertType:(int)arg1 source:(id)arg2 typeSource:(int)arg3;
- (void)dealloc;
