...
@property(nonatomic) float pixelHeight; // @synthesize pixelHeight=_pixelHeight;
@property(nonatomic) float pixelWidth; // @synthesize pixelWidth=_pixelWidth;
...
- (id)_sf_urlForSettings:(id)arg1 shouldResize:(_Bool)arg2 width:(float)arg3 height:(float)arg4;
