...
- (_Bool)hasType;
- (_Bool)hasScore;
- (id)initWithSuggestion:(id)arg1 query:(id)arg2 score:(float)arg3 type:(int)arg4;
- (id)initWithIdentifier:(id)arg1 suggestion:(id)arg2 query:(id)arg3 score:(float)arg4 type:(int)arg5;
