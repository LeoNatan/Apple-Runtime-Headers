...
- (_SFPBNamedProtobufMessage *)entityProtobufMessagesAtIndex:(unsigned int)arg1;
...
- (_SFPBAbstractCommand *)dismissalCommandsAtIndex:(unsigned int)arg1;
- (unsigned int)dismissalCommandsCount;
- (void)addDismissalCommands:(_SFPBAbstractCommand *)arg1;
- (void)clearDismissalCommands;
- (_SFPBCardSection *)cardSectionsAtIndex:(unsigned int)arg1;
