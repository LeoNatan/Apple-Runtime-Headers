...
- (_SFPBMediaOffer *)buyOptionsAtIndex:(unsigned int)arg1;
- (unsigned int)buyOptionsCount;
- (void)addBuyOptions:(_SFPBMediaOffer *)arg1;
- (void)clearBuyOptions;
- (NSString *)subtitleCustomLineBreakingAtIndex:(unsigned int)arg1;
- (unsigned int)subtitleCustomLineBreakingCount;
