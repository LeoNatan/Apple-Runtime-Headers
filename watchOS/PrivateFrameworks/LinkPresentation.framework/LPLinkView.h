...
@class LPAnimationMaskView, LPCaptionBarPresentationProperties, LPImage, LPLinkMetadata, LPLinkViewComponents, LPTheme, LPVideo, LPiTunesPlaybackInformation, NSMutableArray, NSString, NSURL, UIColor;
