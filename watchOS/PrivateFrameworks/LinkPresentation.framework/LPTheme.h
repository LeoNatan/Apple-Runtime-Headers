...
+ (id)iconPlatterPaddingForReason:(int)arg1;
+ (void)addClient:(id)arg1;
+ (id)themeWithStyle:(int)arg1 icon:(id)arg2 platform:(int)arg3 sizeClass:(unsigned int)arg4;
+ (id)secondaryLabelColor;
+ (id)primaryLabelColor;
+ (float)largestIconSizeInPoints;
+ (id)regularTheme;
+ (void)invalidateThemeCache;
- (void).cxx_destruct;
@property(nonatomic) float widthFractionForTallMedia; // @synthesize widthFractionForTallMedia=_widthFractionForTallMedia;
...
- (void)adjustForStyle;
- (id)initWithStyle:(int)arg1 icon:(id)arg2 platform:(int)arg3 sizeClass:(unsigned int)arg4;
