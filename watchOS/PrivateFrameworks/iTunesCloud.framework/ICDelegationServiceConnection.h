...
@property(readonly, nonatomic) int connectionRole; // @synthesize connectionRole=_connectionRole;
- (void).cxx_destruct;
...
- (void)dealloc;
- (id)initWithConnectionRole:(int)arg1 inputStream:(id)arg2 outputStream:(id)arg3 securitySettings:(id)arg4;
