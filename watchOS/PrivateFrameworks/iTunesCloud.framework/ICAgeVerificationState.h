...
+ (id)ageVerificationStateNotRequiredForUserIdentity:(id)arg1 withTreatment:(int)arg2 verificationURL:(id)arg3;
+ (id)ageVerificationStateNotRequiredForUserIdentity:(id)arg1 withTreatment:(int)arg2;
...
- (id)initWithUserIdentity:(id)arg1 ageVerifier:(id)arg2 treatment:(int)arg3 verificationURL:(id)arg4;
- (id)_initWithUserIdentity:(id)arg1 status:(int)arg2 treatment:(int)arg3 verificationURL:(id)arg4 error:(id)arg5;
