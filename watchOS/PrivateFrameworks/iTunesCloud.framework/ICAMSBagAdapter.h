...
+ (_Bool)_value:(id)arg1 matchesExpectedType:(unsigned int)arg2;
+ (id)_valueFromBagDictionary:(id)arg1 forKeyPath:(id)arg2 valueType:(unsigned int)arg3;
+ (id)_valueForBagKey:(id)arg1 valueType:(unsigned int)arg2 fromURLBag:(id)arg3 urlBagLoadingError:(id)arg4 valueRetrievingError:(id *)arg5;
- (void).cxx_destruct;
