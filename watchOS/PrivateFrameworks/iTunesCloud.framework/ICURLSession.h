...
- (void)dealloc;
- (id)initWithConfiguration:(id)arg1 maxConcurrentRequests:(unsigned int)arg2 qualityOfService:(int)arg3;
- (id)initWithConfiguration:(id)arg1 maxConcurrentRequests:(unsigned int)arg2;
