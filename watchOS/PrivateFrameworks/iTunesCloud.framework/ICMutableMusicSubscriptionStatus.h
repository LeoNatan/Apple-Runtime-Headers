...
@property(nonatomic) int carrierBundlingErrorCode; // @dynamic carrierBundlingErrorCode;
...
@property(nonatomic) int carrierBundlingStatusType; // @dynamic carrierBundlingStatusType;
