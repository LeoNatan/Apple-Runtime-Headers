...
- (id)contentParametersAtIndex:(unsigned int)arg1;
- (unsigned int)contentParametersCount;
- (void)addContentParameters:(id)arg1;
- (void)clearContentParameters;
- (id)messageActionsAtIndex:(unsigned int)arg1;
- (unsigned int)messageActionsCount;
- (void)addMessageActions:(id)arg1;
- (void)clearMessageActions;
- (id)imagesAtIndex:(unsigned int)arg1;
