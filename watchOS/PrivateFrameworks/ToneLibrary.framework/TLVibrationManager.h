...
- (int)_currentVibrationWatchAlertPolicyForAlertType:(int)arg1 topic:(id)arg2 didFindPersistedWatchAlertPolicy:(_Bool *)arg3;
...
- (id)_defaultPreferablyNonSilentVibrationIdentifierForAlertType:(int)arg1 topic:(id)arg2 correspondingToneIdentifier:(id)arg3;
...
- (id)defaultVibrationIdentifierForAlertType:(int)arg1 topic:(id)arg2;
...
- (id)_currentVibrationIdentifierForAlertType:(int)arg1 topic:(id)arg2 correspondingToneIdentifier:(id)arg3 allowsNoneDefaultToAnyActualVibrationSubstitution:(_Bool)arg4;
