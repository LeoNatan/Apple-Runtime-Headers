...
@property unsigned int maxTotalFileCount; // @synthesize maxTotalFileCount=_maxTotalFileCount;
@property unsigned int maxTotalFileSize; // @synthesize maxTotalFileSize=_maxTotalFileSize;
