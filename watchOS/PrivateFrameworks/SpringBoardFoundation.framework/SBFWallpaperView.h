...
@property(nonatomic) int logicalContentOrientation; // @synthesize logicalContentOrientation=_logicalContentOrientation;
@property(nonatomic) unsigned int transformOptions; // @synthesize transformOptions=_transformOptions;
...
- (id)_cacheKeyForParameters:(CDStruct_cb92536b)arg1 includingTint:(_Bool)arg2 downsampleFactor:(float)arg3;
- (id)_imageForBackdropParameters:(CDStruct_cb92536b)arg1 includeTint:(_Bool)arg2;
- (id)_blurredImage;
...
- (id)imageForBackdropParameters:(CDStruct_cb92536b)arg1 includeTint:(_Bool)arg2;
- (id)blurredImage;
- (id)snapshotImage;
...
- (void)setVariant:(int)arg1 withAnimationFactory:(id)arg2 forced:(_Bool)arg3;
...
@property(readonly, nonatomic) float cropZoomScale;
...
@property(readonly, nonatomic) int wallpaperType;
- (void)dealloc;
