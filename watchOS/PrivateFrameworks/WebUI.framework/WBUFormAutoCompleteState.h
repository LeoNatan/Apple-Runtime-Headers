...
@class NSArray, NSDictionary, NSMutableDictionary, NSString, UIView<WBUFormAutoFillWebView>, WBSFormControlMetadata, WBSFormMetadata, WBSMultiRoundAutoFillManager, WBUFormDataController;
