...
- (void)_showPasswordPromptForWebView:(id)arg1 formType:(unsigned int)arg2 username:(id)arg3 host:(id)arg4 hasCredentialForCurrentHost:(_Bool)arg5 existingCredentialMatchesForCurrentHost:(id)arg6 otherSubdomainCredentialMatches:(id)arg7 haveExistingCredentialWithSameUsernameAndDifferentPassword:(_Bool)arg8 completionHandler:(CDUnknownBlockType)arg9;
...
- (_Bool)_saveUser:(id)arg1 password:(id)arg2 forURL:(id)arg3 formType:(unsigned int)arg4 promptingPolicy:(int)arg5 webView:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;
