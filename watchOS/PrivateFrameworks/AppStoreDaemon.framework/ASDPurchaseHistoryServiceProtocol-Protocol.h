...
- (void)updateWithContext:(unsigned int)arg1 withReplyHandler:(void (^)(NSError *))arg2;
- (void)updateForAccountID:(long long)arg1 withContext:(unsigned int)arg2 withReplyHandler:(void (^)(NSError *))arg3;
