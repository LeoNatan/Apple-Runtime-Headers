...
- (id)parseForecastDataFromDict:(id)arg1 types:(unsigned int)arg2 location:(id)arg3 locale:(id)arg4 date:(id)arg5 error:(id *)arg6 rules:(id)arg7;
...
- (id)init;
- (id)dailyAlmanacDictFromData:(id)arg1 types:(unsigned int)arg2;
- (id)parseAlmanacFromData:(id)arg1;
- (id)pollenDictFromData:(id)arg1 types:(unsigned int)arg2;
- (id)parsePollenFromData:(id)arg1;
- (id)hourlyForecastDictFromData:(id)arg1 types:(unsigned int)arg2;
- (id)parseHourlyForecastFromData:(id)arg1;
- (id)hourlyHistoryDictFromData:(id)arg1 types:(unsigned int)arg2;
- (id)parseHourlyHistoryFromData:(id)arg1;
- (id)currentObservationsDictFromData:(id)arg1 types:(unsigned int)arg2;
...
- (id)airQualityDictFromData:(id)arg1 types:(unsigned int)arg2;
- (id)parsePollutants:(id)arg1;
- (id)parseAirQualityFromData:(id)arg1 locale:(id)arg2;
- (id)dailyHistoryDictFromData:(id)arg1 types:(unsigned int)arg2;
- (id)parseDailyHistoryFromData:(id)arg1;
- (id)dailyForecastDictFromData:(id)arg1 types:(unsigned int)arg2;
- (id)parseDailyForecastFromData:(id)arg1;
- (id)nowLinksDictFromData:(id)arg1 types:(unsigned int)arg2;
