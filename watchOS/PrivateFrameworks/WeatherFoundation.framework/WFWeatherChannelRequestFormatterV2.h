...
+ (id)forecastRequest:(unsigned int)arg1 forLocation:(id)arg2 locale:(id)arg3 date:(id)arg4 rules:(id)arg5;
+ (id)forecastRequest:(unsigned int)arg1 forLocation:(id)arg2 locale:(id)arg3 date:(id)arg4;
