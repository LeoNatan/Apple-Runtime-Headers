...
- (void)_submitRequest:(id)arg1 withIdentifier:(id)arg2 forLocation:(id)arg3 forecastTypes:(unsigned int)arg4 configuration:(id)arg5 locale:(id)arg6 date:(id)arg7 apiVersion:(id)arg8 completionHandler:(CDUnknownBlockType)arg9;
- (void)_enumerateForecastTypesIn:(unsigned int)arg1 usingBlock:(CDUnknownBlockType)arg2;
- (_Bool)_cacheParsedForecastData:(id)arg1 types:(unsigned int)arg2 location:(id)arg3 date:(id)arg4 requestIdentifier:(id)arg5;
- (void)_cacheObject:(id)arg1 type:(unsigned int)arg2 date:(id)arg3 forLocation:(id)arg4;
- (void)_forecastConditionsForTypes:(unsigned int)arg1 location:(id)arg2 locale:(id)arg3 date:(id)arg4 requestIdentifier:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (_Bool)_isConnectivityAvailableForWeatherHost:(id *)arg1;
- (id)_cachedData:(unsigned int)arg1 forLocation:(id)arg2 date:(id)arg3;
...
- (void)forecast:(unsigned int)arg1 forLocation:(id)arg2 locale:(id)arg3 requestIdentifier:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
