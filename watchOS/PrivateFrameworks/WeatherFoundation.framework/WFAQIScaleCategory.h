...
@property(readonly, nonatomic) unsigned int categoryIndex; // @synthesize categoryIndex=_categoryIndex;
- (void)encodeWithCoder:(id)arg1;
- (id)initWithCoder:(id)arg1;
- (id)copyWithZone:(struct _NSZone *)arg1;
- (_Bool)isEqualToScaleCategory:(id)arg1;
- (_Bool)isEqual:(id)arg1;
- (id)initWithCategoryIndex:(unsigned int)arg1 localizedCategoryDescription:(id)arg2;
