...
@property int jobAccountIDSupport; // @synthesize jobAccountIDSupport=_jobAccountIDSupport;
@property int proximity; // @synthesize proximity;
@property int btleMeasuredPower; // @synthesize btleMeasuredPower;
