...
- (id)_actionSheetWithButtons:(id)arg1 title:(id)arg2 destructive:(_Bool)arg3 cancelButtonIndex:(int)arg4 context:(id)arg5;
...
- (id)showAlertViewWithButtons:(id)arg1 title:(id)arg2 message:(id)arg3 destructive:(_Bool)arg4 cancelButtonIndex:(int)arg5 context:(id)arg6 completion:(CDUnknownBlockType)arg7;
...
- (id)showConfirmationViewWithButtons:(id)arg1 title:(id)arg2 message:(id)arg3 destructive:(_Bool)arg4 cancelButtonIndex:(int)arg5 context:(id)arg6 completion:(CDUnknownBlockType)arg7;
- (id)showConfirmationViewWithButtons:(id)arg1 title:(id)arg2 message:(id)arg3 destructive:(_Bool)arg4 cancelButtonIndex:(int)arg5 context:(id)arg6 forceAlert:(_Bool)arg7 completion:(CDUnknownBlockType)arg8;
