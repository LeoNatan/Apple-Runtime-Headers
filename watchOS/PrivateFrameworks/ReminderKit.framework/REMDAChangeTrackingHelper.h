...
- (void)_setCachedModeObjectResults:(id)arg1 forModelClass:(Class)arg2 changeType:(int)arg3;
- (id)_cachedModeObjectResultsForModelClass:(Class)arg1 changeType:(int)arg2;
- (int)_changeTypeMaskFromChangeType:(int)arg1;
...
- (id)_changedModelObjectsOfClass:(Class)arg1 ofChangeTypes:(int)arg2;
- (id)changedIdentifiersOfModelClass:(Class)arg1 ofChangeType:(int)arg2;
- (id)changedModelObjectsOfModelClass:(Class)arg1 ofChangeType:(int)arg2;
