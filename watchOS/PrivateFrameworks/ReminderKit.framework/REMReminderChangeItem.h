...
- (id)addRecurrenceRuleWithFrequency:(int)arg1 interval:(int)arg2 firstDayOfTheWeek:(int)arg3 daysOfTheWeek:(id)arg4 daysOfTheMonth:(id)arg5 monthsOfTheYear:(id)arg6 weeksOfTheYear:(id)arg7 daysOfTheYear:(id)arg8 setPositions:(id)arg9 end:(id)arg10;
- (id)addRecurrenceRuleWithFrequency:(int)arg1 interval:(int)arg2 daysOfTheWeek:(id)arg3 daysOfTheMonth:(id)arg4 monthsOfTheYear:(id)arg5 weeksOfTheYear:(id)arg6 daysOfTheYear:(id)arg7 setPositions:(id)arg8 end:(id)arg9;
- (id)addRecurrenceRuleWithFrequency:(int)arg1 interval:(int)arg2 end:(id)arg3;
@property(nonatomic) unsigned int icsDisplayOrder; // @dynamic icsDisplayOrder;
...
@property(nonatomic) int flagged; // @dynamic flagged;
...
@property(nonatomic) int siriFoundInAppsUserConfirmation; // @dynamic siriFoundInAppsUserConfirmation;
