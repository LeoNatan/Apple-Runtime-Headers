...
- (id)_orderedSet;
- (void)removeObjectFromReminderIDsAtIndex:(unsigned int)arg1;
- (void)insertObject:(id)arg1 inReminderIDsAtIndex:(unsigned int)arg2;
- (unsigned int)indexInReminderIDsOfObject:(id)arg1;
- (id)objectInReminderIDsAtIndex:(unsigned int)arg1;
- (unsigned int)countOfReminderIDs;
