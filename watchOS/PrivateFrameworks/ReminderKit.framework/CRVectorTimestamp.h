...
- (void)encodeIntoProtobufTimestamp:(VectorTimestamp_1132d4f7 *)arg1 coder:(id)arg2;
- (id)initWithProtobufTimestamp:(const VectorTimestamp_1132d4f7 *)arg1 decoder:(id)arg2;
