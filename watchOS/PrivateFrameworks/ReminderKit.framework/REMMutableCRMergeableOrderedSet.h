...
- (void)undo:(id)arg1;
- (void)undo;
- (id)moveObjectFromIndex:(unsigned int)arg1 toIndex:(unsigned int)arg2;
- (id)removeObjectAtIndex:(unsigned int)arg1;
- (id)addObject:(id)arg1;
- (id)insertObject:(id)arg1 atIndex:(unsigned int)arg2;
- (id)documentToEdit;
