...
- (unsigned int)firstIndexOf:(id)arg1 fromIndex:(unsigned int)arg2;
...
- (void)removeObjectAtIndex:(unsigned int)arg1 forUndo:(_Bool)arg2;
- (void)removeObjectAtIndex:(unsigned int)arg1;
- (void)removeLastObject;
- (id)_insertObject:(id)arg1 withIdentifier:(id)arg2 atIndex:(unsigned int)arg3 forUndo:(_Bool)arg4;
- (id)_insertObject:(id)arg1 atIndex:(unsigned int)arg2;
