...
- (id)description;
- (id)cityNamesAtIndex:(unsigned int)arg1;
- (unsigned int)cityNamesCount;
- (void)addCityNames:(id)arg1;
- (void)clearCityNames;
- (id)streetNamesAtIndex:(unsigned int)arg1;
- (unsigned int)streetNamesCount;
- (void)addStreetNames:(id)arg1;
- (void)clearStreetNames;
- (id)relatedNamesAtIndex:(unsigned int)arg1;
- (unsigned int)relatedNamesCount;
