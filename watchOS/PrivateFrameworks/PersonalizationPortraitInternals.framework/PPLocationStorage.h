...
- (_Bool)deleteAllLocationsFromSourcesWithBundleId:(id)arg1 groupId:(id)arg2 olderThanDate:(id)arg3 atLeastOneLocationRemoved:(_Bool *)arg4 deletedCount:(unsigned int *)arg5 error:(id *)arg6;
- (_Bool)deleteAllLocationsFromSourcesWithBundleId:(id)arg1 atLeastOneLocationRemoved:(_Bool *)arg2 deletedCount:(unsigned int *)arg3 error:(id *)arg4;
- (_Bool)deleteAllLocationsFromSourcesWithBundleId:(id)arg1 groupIds:(id)arg2 atLeastOneLocationRemoved:(_Bool *)arg3 deletedCount:(unsigned int *)arg4 error:(id *)arg5;
- (_Bool)deleteAllLocationsFromSourcesWithBundleId:(id)arg1 documentIds:(id)arg2 atLeastOneLocationRemoved:(_Bool *)arg3 deletedCount:(unsigned int *)arg4 error:(id *)arg5;
- (_Bool)deleteAllLocationsOlderThanDate:(id)arg1 atLeastOneLocationRemoved:(_Bool *)arg2 deletedCount:(unsigned int *)arg3 error:(id *)arg4;
- (void)_deleteLocationsWithRowIdTableWithName:(id)arg1 txnWitness:(id)arg2 atLeastOneLocationRemoved:(_Bool *)arg3 deletedCount:(unsigned int *)arg4;
