...
+ (id)recordsForTopics:(id)arg1 source:(id)arg2 algorithm:(unsigned int)arg3;
...
- (void)logDonationErrorForReason:(int)arg1;
...
- (_Bool)deleteAllTopicsWithTopicId:(id)arg1 algorithm:(unsigned int)arg2 deletedCount:(unsigned int *)arg3 error:(id *)arg4;
...
- (void)_petLoggingForMappedTopicQuery:(id)arg1 mappingId:(id)arg2 count:(unsigned int)arg3 clientProcessName:(id)arg4 hasError:(_Bool)arg5;
...
- (void)_petLoggingForQuery:(id)arg1 count:(unsigned int)arg2 clientProcessName:(id)arg3 hasError:(_Bool)arg4;
