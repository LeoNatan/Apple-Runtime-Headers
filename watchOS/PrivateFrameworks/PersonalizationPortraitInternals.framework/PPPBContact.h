...
- (id)socialProfilesAtIndex:(unsigned int)arg1;
- (unsigned int)socialProfilesCount;
...
- (id)postalAddressesAtIndex:(unsigned int)arg1;
- (unsigned int)postalAddressesCount;
- (void)addPostalAddresses:(id)arg1;
- (void)clearPostalAddresses;
- (id)emailAddressesAtIndex:(unsigned int)arg1;
- (unsigned int)emailAddressesCount;
- (void)addEmailAddresses:(id)arg1;
- (void)clearEmailAddresses;
- (id)phoneNumbersAtIndex:(unsigned int)arg1;
- (unsigned int)phoneNumbersCount;
