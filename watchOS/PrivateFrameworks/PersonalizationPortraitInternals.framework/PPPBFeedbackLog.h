...
- (id)extractedDonationsAtIndex:(unsigned int)arg1;
- (unsigned int)extractedDonationsCount;
- (void)addExtractedDonations:(id)arg1;
- (void)clearExtractedDonations;
- (id)scoredItemsAtIndex:(unsigned int)arg1;
- (unsigned int)scoredItemsCount;
