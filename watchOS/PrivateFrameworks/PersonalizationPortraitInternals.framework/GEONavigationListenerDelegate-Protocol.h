...
- (void)navigationListener:(GEONavigationListener *)arg1 didUpdateStepIndex:(unsigned int)arg2;
...
- (void)navigationListener:(GEONavigationListener *)arg1 didChangeNavigationState:(unsigned int)arg2 transportType:(int)arg3;
@end
