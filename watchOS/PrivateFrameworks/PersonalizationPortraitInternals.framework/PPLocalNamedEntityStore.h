...
- (_Bool)_deleteAllNamedEntitiesWithPredicate:(id)arg1 loggingBundleId:(id)arg2 deletedCount:(unsigned int *)arg3 error:(id *)arg4;
...
- (void)dealloc;
- (id)initWithRecordFetchLimit:(unsigned int)arg1 useQueryCache:(_Bool)arg2;
