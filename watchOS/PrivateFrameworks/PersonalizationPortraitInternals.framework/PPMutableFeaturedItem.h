...
@interface PPMutableFeaturedItem : NSObject
{
    ...
    unsigned int _uniqueAlgorithmCount;
    float _maxScore;
    float _minScore;
    float _meanScore;
    ...
    float _recordCount;
    unsigned int _uniqueOsBuildCount;
    unsigned int _uniqueAssetVersionCount;
    unsigned int _uniqueBundleIdCount;
    ...
    unsigned int _uniqueGroupIdCount;
    unsigned int _uniqueSourceHourCount;
    NSMutableArray *_countInHour;
    unsigned int _uniqueSourceDayOfWeekCount;
...
@property(readonly, nonatomic) unsigned int uniqueSourceDayOfWeekCount; // @synthesize uniqueSourceDayOfWeekCount=_uniqueSourceDayOfWeekCount;
@property(readonly, nonatomic) NSMutableArray *countInHour; // @synthesize countInHour=_countInHour;
@property(readonly, nonatomic) unsigned int uniqueSourceHourCount; // @synthesize uniqueSourceHourCount=_uniqueSourceHourCount;
@property(readonly, nonatomic) unsigned int uniqueGroupIdCount; // @synthesize uniqueGroupIdCount=_uniqueGroupIdCount;
...
@property(readonly, nonatomic) unsigned int uniqueBundleIdCount; // @synthesize uniqueBundleIdCount=_uniqueBundleIdCount;
@property(readonly, nonatomic) unsigned int uniqueAssetVersionCount; // @synthesize uniqueAssetVersionCount=_uniqueAssetVersionCount;
@property(readonly, nonatomic) unsigned int uniqueOsBuildCount; // @synthesize uniqueOsBuildCount=_uniqueOsBuildCount;
