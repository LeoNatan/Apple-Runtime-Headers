...
- (void)recentLocationsForConsumer:(unsigned int)arg1 criteria:(id)arg2 limit:(unsigned int)arg3 explanationSet:(id)arg4 client:(id)arg5 queryId:(unsigned long long)arg6;
