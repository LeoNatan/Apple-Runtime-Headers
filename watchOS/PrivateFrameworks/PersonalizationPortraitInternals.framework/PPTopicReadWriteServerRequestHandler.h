...
- (void)donateTopics:(id)arg1 source:(id)arg2 algorithm:(unsigned int)arg3 cloudSync:(_Bool)arg4 sentimentScore:(double)arg5 completion:(CDUnknownBlockType)arg6;
