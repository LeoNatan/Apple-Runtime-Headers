...
@property(readonly, nonatomic) unsigned int effectiveMinCPUPercentage;
@property(readonly, nonatomic) unsigned int effectiveMinCPUDuration;
@property(readonly, nonatomic) unsigned int effectiveMaxCPUPercentage;
@property(readonly, nonatomic) unsigned int effectiveMaxCPUDuration;
@property(readonly, nonatomic) unsigned int effectiveMaxCPUUsageViolationPolicy;
