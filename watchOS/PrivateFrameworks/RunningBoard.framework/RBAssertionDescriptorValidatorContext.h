...
@interface RBAssertionDescriptorValidatorContext : NSObject <NSCopying>
{
    ...
    unsigned int _ignoreEntitlementViolationsCount;
    unsigned int _ignoreTargetPropertyViolationsCount;
...
+ (id)context;
@property(readonly, nonatomic) _Bool unitTesting; // @synthesize unitTesting=_unitTesting;
