...
@interface RBAssertionManager : NSObject <RBAssertionManagerQueueDelegate, RBAssertionManaging, RBStateCapturing>
{
    ...
    unsigned int _maxOperationsInFlight;
    unsigned int _maxAssertionsPerOriginator;
...
- (unsigned int)_lock_numberofStartTimeDefiningAssertionsForTargetProcessIdentity:(id)arg1;
...
- (id)initWithDelegate:(id)arg1 domainAttributeManager:(id)arg2 bundlePropertiesManager:(id)arg3 originatorPidStore:(id)arg4 assertionDescriptorValidator:(id)arg5 entitlementManager:(id)arg6 jetsamBandProvider:(id)arg7 stateCaptureManager:(id)arg8 maxOperationsInFlight:(unsigned int)arg9 maxAssertionsPerOriginator:(unsigned int)arg10;
- (id)init;
