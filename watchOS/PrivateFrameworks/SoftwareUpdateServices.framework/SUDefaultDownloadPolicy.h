...
- (_Bool)_isDownloadableForNetworkType:(int)arg1 error:(int *)arg2 cellularFeesApply:(_Bool *)arg3 powerRequired:(_Bool *)arg4;
- (_Bool)isDownloadAllowableForCellular2G;
- (_Bool)isDownloadAllowableForCellular;
- (_Bool)isDownloadableForCurrentNetworkConditions:(int *)arg1 cellularFeesApply:(_Bool *)arg2 powerRequired:(_Bool *)arg3;
- (_Bool)isDownloadableForCurrentNetworkConditions:(int *)arg1 cellularFeesApply:(_Bool *)arg2;
