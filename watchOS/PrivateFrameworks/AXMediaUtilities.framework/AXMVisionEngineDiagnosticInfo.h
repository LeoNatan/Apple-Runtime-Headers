...
- (float)_queue_averageFramesDroppedPerSecond;
@property(readonly, nonatomic) float averageFramesDroppedPerSecond;
- (float)_queue_averageFramesProcessedPerSecond;
@property(readonly, nonatomic) float averageFramesProcessedPerSecond;
