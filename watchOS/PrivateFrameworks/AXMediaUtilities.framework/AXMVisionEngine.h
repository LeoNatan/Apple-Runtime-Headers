...
@class AXMFeatureTrackingManager, AXMService, AXMTaskDispatcher, AXMVisionEngineCache, AXMVisionEngineDiagnosticInfo, NSArray, NSMapTable, NSMutableArray, NSObject<OS_dispatch_queue>, NSString, _AXMVisionEngineAnalysisTask;
