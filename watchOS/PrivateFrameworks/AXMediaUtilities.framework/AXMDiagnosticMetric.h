...
@interface AXMDiagnosticMetric : NSObject <NSSecureCoding>
{
    ...
    NSString *_name;
    int _representedMetrics;
}

+ (_Bool)supportsSecureCoding;
- (void).cxx_destruct;
@property(nonatomic) int representedMetrics; // @synthesize representedMetrics=_representedMetrics;
...
- (void)_commonInit;
- (id)initWithName:(id)arg1 metrics:(int)arg2;
