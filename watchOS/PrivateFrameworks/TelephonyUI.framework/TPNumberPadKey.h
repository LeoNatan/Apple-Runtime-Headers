...
- (void)setFontStylesForHighlightState:(_Bool)arg1 language:(unsigned int)arg2 showLocalizedLetters:(_Bool)arg3 shouldCenterDigit:(_Bool)arg4 fontColor:(_Bool)arg5 circleDiameter:(float)arg6 largeFont:(_Bool)arg7 isCarPlay:(_Bool)arg8;
