...
- (void)_enumerateEngineElementsWithOptions:(unsigned int)arg1 usingBlock:(CDUnknownBlockType)arg2;
- (void)_enumerateEngineElementsInSection:(unsigned int)arg1 withOptions:(unsigned int)arg2 usingBlock:(CDUnknownBlockType)arg3;
...
- (id)predictedContentForSectionAtIndex:(unsigned int)arg1 atDate:(id)arg2 limit:(int)arg3;
- (void)resignCurrent;
- (void)makeCurrent;
...
- (unsigned int)_numberOfItemsInSectionAtIndex:(unsigned int)arg1;
- (unsigned int)numberOfItemsInSectionAtIndex:(unsigned int)arg1;
...
@property(nonatomic) unsigned int onScreenElementCount;
