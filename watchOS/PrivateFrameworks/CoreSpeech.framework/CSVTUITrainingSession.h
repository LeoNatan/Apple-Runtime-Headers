...
- (void)startTraining;
- (id)initWithUtteranceId:(int)arg1 sessionNumber:(int)arg2 Locale:(id)arg3 audioSession:(id)arg4 keywordDetector:(id)arg5 speechRecognizer:(id)arg6 speechRecognitionRequest:(id)arg7 sessionDelegate:(id)arg8 sessionDispatchQueue:(id)arg9 completion:(CDUnknownBlockType)arg10;
