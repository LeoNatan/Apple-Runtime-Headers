...
@interface CSSmartSiriVolume : NSObject <CSMediaPlayingMonitorDelegate, CSAlarmMonitorDelegate, CSTimerMonitorDelegate, CSSpeechManagerDelegate, CSVoiceTriggerDelegate>
{
    ...
    float _alarmVolume;
    unsigned int _noiseLevelChannelBitset;
    unsigned int _LKFSChannelBitset;
...
- (void)speechManagerDidStopForwarding:(id)arg1 forReason:(int)arg2;
...
- (float)estimateSoundLevelbySoundType:(int)arg1;
- (void)_processAudioChunk:(id)arg1 soundType:(int)arg2;
- (void)prepareSoundLevelBufferFromSamples:(id)arg1 soundType:(int)arg2 firedVoiceTriggerEvent:(_Bool)arg3 triggerStartTimeSampleOffset:(unsigned long long)arg4 triggerEndTimeSampleOffset:(unsigned long long)arg5;
- (void)_prepareSoundLevelBufferFromSamples:(unsigned int)arg1 soundType:(int)arg2;
- (void)_reset;
