...
- (void).cxx_destruct;
- (void)CSAudioRouteChangeMonitor:(id)arg1 didReceiveAudioRouteChangeEvent:(int)arg2;
...
- (void)speechManagerDidFinishAlertPlayback:(id)arg1 ofType:(int)arg2 error:(id)arg3;
- (void)speechManagerDetectedSystemVolumeChange:(id)arg1 withVolume:(float)arg2 forReason:(unsigned int)arg3;
- (void)speechManagerRecordHardwareConfigurationDidChange:(id)arg1 toConfiguration:(int)arg2;
