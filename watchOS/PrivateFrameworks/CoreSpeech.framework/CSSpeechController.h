...
@interface CSSpeechController : NSObject <CSAudioConverterDelegate, CSSpIdSpeakerRecognizerDelegate, CSSmartSiriVolumeControllerDelegate, CSAudioSessionProvidingDelegate, CSAudioStreamProvidingDelegate, CSAudioAlertProvidingDelegate, CSAudioSessionControllerDelegate, CSXPCClientDelegate, CSSpeechManagerDelegate, CSContinuousVoiceTriggerDelegate>
{
    ...
    unsigned int _numTrailingSamplesAfterSchedulingStop;
    unsigned int _maxAllowedTrailingSamplesAfterSchedulingStop;
...
+ (id)sharedController;
- (void).cxx_destruct;
@property(nonatomic) unsigned int maxAllowedTrailingSamplesAfterSchedulingStop; // @synthesize maxAllowedTrailingSamplesAfterSchedulingStop=_maxAllowedTrailingSamplesAfterSchedulingStop;
@property(nonatomic) unsigned int numTrailingSamplesAfterSchedulingStop; // @synthesize numTrailingSamplesAfterSchedulingStop=_numTrailingSamplesAfterSchedulingStop;
...
- (unsigned int)_phaticPlaybackReason;
...
- (int)_currentAudioRecorderSampleRate;
...
- (void)smartSiriVolumeControllerDetectedSystemVolumeChange:(id)arg1 withVolume:(float)arg2 forReason:(unsigned int)arg3;
...
- (void)audioAlertProvidingDidFinishAlertPlayback:(id)arg1 ofType:(int)arg2 error:(id)arg3;
...
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(int)arg2;
- (void)_didStopForReason:(int)arg1;
