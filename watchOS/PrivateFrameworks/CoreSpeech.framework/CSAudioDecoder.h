...
- (void)addPackets:(id)arg1 audioStreamHandleId:(unsigned int)arg2 remoteVAD:(id)arg3 timestamp:(unsigned long long)arg4 receivedNumChannels:(unsigned int)arg5;
