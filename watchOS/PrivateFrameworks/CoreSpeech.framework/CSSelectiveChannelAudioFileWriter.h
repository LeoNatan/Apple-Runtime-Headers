...
- (void).cxx_destruct;
@property(readonly, nonatomic) unsigned long numberOfChannels; // @synthesize numberOfChannels=_numberOfChannels;
@property(readonly, nonatomic) NSURL *fileURL; // @synthesize fileURL=_fileURL;
- (_Bool)addSamples:(const void *)arg1 numSamples:(long)arg2;
- (_Bool)endAudio;
- (void)dealloc;
