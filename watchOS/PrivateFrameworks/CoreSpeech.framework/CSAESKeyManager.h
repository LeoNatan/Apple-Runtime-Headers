...
+ (id)generateAESKeyWithKeySizeInBits:(unsigned int)arg1;
+ (id)generateIfNecessaryAESKeyWithKeySizeInBits:(unsigned int)arg1 applicationTag:(id)arg2 keyLabel:(id)arg3 shouldGenerateIfNecessary:(_Bool)arg4;
