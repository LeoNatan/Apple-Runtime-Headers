...
@property(nonatomic) unsigned int startRecordingSampleCount; // @synthesize startRecordingSampleCount=_startRecordingSampleCount;
...
- (long long)_alertBehaviorTypeFromAVVCOberrideType:(int)arg1;
- (int)_avvcAlertOverrideType:(long long)arg1;
- (id)avvcAlertBehavior;
- (void)setAVVCAlertBehavior:(id)arg1;
- (id)avvcSettings;
- (id)avvcStartRecordSettingsWithAudioStreamHandleId:(unsigned int)arg1;
