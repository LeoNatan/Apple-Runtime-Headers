...
+ (id)spIdSATModelDirForLocale:(id)arg1 userName:(id)arg2 spidType:(unsigned int)arg3;
+ (id)spIdSATAudioDirForLocale:(id)arg1 userName:(id)arg2 spidType:(unsigned int)arg3;
+ (id)spIdSATDirForLocale:(id)arg1 userName:(id)arg2 spidType:(unsigned int)arg3;
