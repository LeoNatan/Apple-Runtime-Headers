...
+ (int)getVoiceProfileImplicitVersionfromVersionFile:(id)arg1;
+ (int)getVoiceProfileBaseVersionfromVersionFile:(id)arg1;
+ (void)incrementVoiceProfileVersionForUpdateType:(unsigned int)arg1 forVoiceProfile:(id)arg2;
