...
- (id)_getUserVoiceProfileDownloadCacheDirectoryForProfileId:(id)arg1 forDeviceCategory:(unsigned int)arg2 forVoiceProfileVersion:(unsigned int)arg3;
...
- (void)_downloadVoiceProfileForProfileId:(id)arg1 forDeviceCategory:(unsigned int)arg2 withDownloadTriggerBlock:(CDUnknownBlockType)arg3 withCompletion:(CDUnknownBlockType)arg4;
