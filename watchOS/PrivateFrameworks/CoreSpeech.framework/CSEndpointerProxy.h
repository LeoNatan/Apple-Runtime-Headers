...
@interface CSEndpointerProxy : NSObject <CSEndpointAnalyzerDelegate, CSEndpointAnalyzer>
{
    ...
    int _vad2EndpointStyle;
    int _vad2EndpointtMode;
...
@property(nonatomic) int vad2EndpointtMode; // @synthesize vad2EndpointtMode=_vad2EndpointtMode;
@property(nonatomic) int vad2EndpointStyle; // @synthesize vad2EndpointStyle=_vad2EndpointStyle;
