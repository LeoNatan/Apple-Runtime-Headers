...
- (void)saveRecordingBufferToEndFrom:(unsigned int)arg1 toURL:(NSURL *)arg2;
- (void)saveRecordingBufferFrom:(unsigned int)arg1 to:(unsigned int)arg2 toURL:(NSURL *)arg3;
- (CSAudioChunk *)audioChunkToEndFrom:(unsigned int)arg1;
- (CSAudioChunk *)audioChunkFrom:(unsigned int)arg1 to:(unsigned int)arg2;
