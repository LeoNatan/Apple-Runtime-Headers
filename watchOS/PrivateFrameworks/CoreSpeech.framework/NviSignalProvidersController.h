...
- (void)unregisterSignalProviderDelegate:(id)arg1 forSignalType:(unsigned int)arg2;
- (void)registerSignalProviderDelegate:(id)arg1 forSignalTypes:(unsigned int)arg2;
- (void)_iterateSignalMask:(unsigned int)arg1 withHandler:(CDUnknownBlockType)arg2;
- (void)stop;
