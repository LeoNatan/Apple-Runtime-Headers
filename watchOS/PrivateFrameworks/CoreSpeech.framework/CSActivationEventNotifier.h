...
- (_Bool)_hasPendingActivationForType:(unsigned int)arg1;
- (void)_stopMonitoring;
- (void)_startMonitoring;
- (void)setDelegate:(id)arg1 for:(unsigned int)arg2;
- (void)notifyActivationEvent:(unsigned int)arg1 deviceId:(id)arg2 activationInfo:(id)arg3 completion:(CDUnknownBlockType)arg4;
