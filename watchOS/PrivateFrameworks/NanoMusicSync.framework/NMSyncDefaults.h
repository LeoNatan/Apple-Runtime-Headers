...
- (void)_setObject:(id)arg1 forKey:(id)arg2 shouldSynchronizeToPhone:(_Bool)arg3;
...
- (void)setAudiobooksSyncInfo:(id)arg1 shouldSynchronizeToPhone:(_Bool)arg2;
- (void)setPodcastsSyncInfo:(id)arg1 shouldSynchronizeToPhone:(_Bool)arg2;
- (void)setMusicSyncInfo:(id)arg1 shouldSynchronizeToPhone:(_Bool)arg2;
