...
@property(nonatomic) int contentPreviewSetting; // @dynamic contentPreviewSetting;
@property(retain, nonatomic) NSDictionary *context; // @dynamic context;
@property(nonatomic) unsigned int counter; // @dynamic counter;
...
@property(nonatomic) unsigned int realertCount_deprecated; // @dynamic realertCount_deprecated;
