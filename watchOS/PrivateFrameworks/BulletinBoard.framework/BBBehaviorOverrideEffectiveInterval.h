...
+ (id)dateWithComponents:(id)arg1 closestToDate:(id)arg2 earlierThanDate:(_Bool)arg3 calendar:(id)arg4 repeatInterval:(unsigned int)arg5;
+ (int)_dateComponentWithProvidedComponent:(int)arg1 andBaseComponent:(int)arg2;
+ (id)adjustComponentsForRepeatInterval:(unsigned int)arg1 earlier:(_Bool)arg2;
