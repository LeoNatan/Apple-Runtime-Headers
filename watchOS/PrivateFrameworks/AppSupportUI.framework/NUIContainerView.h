...
- (void)setAlignment:(int)arg1 forView:(id)arg2 inAxis:(int)arg3;
- (int)alignmentForView:(id)arg1 inAxis:(int)arg2;
...
- (void)replaceArrangedSubview:(id)arg1 atIndex:(unsigned int)arg2;
