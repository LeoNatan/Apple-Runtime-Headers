...
- (_Bool)intervalOverlapTop:(float)arg1 bottom:(float)arg2 paragraphs:(id)arg3;
- (_Bool)intervalOverlapLeft:(float)arg1 right:(float)arg2 paragraphs:(id)arg3;
- (_Bool)intervalOverlapLeft:(float)arg1 right:(float)arg2 rects:(id)arg3;
