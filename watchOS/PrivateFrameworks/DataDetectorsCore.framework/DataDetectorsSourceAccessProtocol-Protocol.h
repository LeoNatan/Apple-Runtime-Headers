...
- (void)filesForSourceRead:(NSArray *)arg1 resourceType:(unsigned int)arg2 withReply:(void (^)(NSArray *))arg3;
- (void)fileForSourceRead:(NSNumber *)arg1 resourceType:(unsigned int)arg2 withReply:(void (^)(NSFileHandle *))arg3;
@end
