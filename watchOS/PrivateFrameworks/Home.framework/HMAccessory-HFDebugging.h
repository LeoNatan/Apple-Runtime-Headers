...
- (_Bool)hf_shouldDisplayManualFixOptionForSymptom:(int)arg1;
...
@property(readonly, nonatomic) unsigned int hf_numberOfProgrammableSwitches;
@property(readonly, nonatomic) int hf_appPunchOutReason;
