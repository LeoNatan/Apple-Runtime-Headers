...
+ (id)aggregatedReadResponseFromResponses:(id)arg1 withAggregationPolicy:(unsigned int)arg2;
+ (id)na_identity;
- (void).cxx_destruct;
...
- (unsigned int)defaultAggregationPolicyForCharacteristicType:(id)arg1;
...
- (id)_responseForCharacteristicType:(id)arg1 aggregationPolicy:(unsigned int)arg2 filter:(CDUnknownBlockType)arg3;
- (id)responseForCharacteristicType:(id)arg1 inService:(id)arg2 aggregationPolicy:(unsigned int)arg3;
- (id)responseForCharacteristicType:(id)arg1 aggregationPolicy:(unsigned int)arg2;
