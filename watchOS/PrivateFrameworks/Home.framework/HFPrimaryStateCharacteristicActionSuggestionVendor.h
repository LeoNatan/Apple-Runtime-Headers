...
@interface HFPrimaryStateCharacteristicActionSuggestionVendor : NSObject <HFCharacteristicActionSuggestionVending>
{
    ...
    unsigned int _bucketingPolicy;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) unsigned int bucketingPolicy; // @synthesize bucketingPolicy=_bucketingPolicy;
...
- (id)initWithCharacteristicType:(id)arg1 normalStateValue:(id)arg2 bucketingPolicy:(unsigned int)arg3;
