...
@property(readonly, nonatomic) int outputGender; // @synthesize outputGender=_outputGender;
...
- (id)initWithRecognitionLanguage:(id)arg1 outputLanguage:(id)arg2 outputGender:(int)arg3 defaultVoiceForRecognitionLanguage:(_Bool)arg4;
