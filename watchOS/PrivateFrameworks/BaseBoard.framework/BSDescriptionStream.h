...
@interface BSDescriptionStream : NSObject <BSDescriptionStringAppendTarget, BSDescriptionFormatting>
{
    ...
    int _emitPhase;
    int _groupItemCount;
    int _groupVerbosityOptions;
}

+ (id)descriptionForRootObject:(id)arg1;
- (void).cxx_destruct;
@property(nonatomic) int groupVerbosityOptions; // @synthesize groupVerbosityOptions=_groupVerbosityOptions;
@property(nonatomic) int groupItemCount; // @synthesize groupItemCount=_groupItemCount;
@property(nonatomic) int emitPhase; // @synthesize emitPhase=_emitPhase;
@property(retain, nonatomic) NSString *pendingFieldTerminator; // @synthesize pendingFieldTerminator=_pendingFieldTerminator;
@property(nonatomic) int indentLevel; // @synthesize indentLevel=_indentLevel;
...
- (id)appendUInt64:(unsigned long long)arg1 withName:(id)arg2 format:(int)arg3;
...
- (id)appendUnsignedInteger:(unsigned int)arg1 withName:(id)arg2 format:(int)arg3;
- (id)appendUnsignedInteger:(unsigned int)arg1 withName:(id)arg2;
- (id)appendInteger:(int)arg1 withName:(id)arg2;
- (id)appendFlag:(int)arg1 withName:(id)arg2 skipIfNotSet:(_Bool)arg3;
...
- (void)appendSectionWithItemCount:(int)arg1 openDelimiter:(id)arg2 closeDelimiter:(id)arg3 block:(CDUnknownBlockType)arg4;
