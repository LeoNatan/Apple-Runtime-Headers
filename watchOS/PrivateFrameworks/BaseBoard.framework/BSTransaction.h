...
- (_Bool)_evaluateParentTransactionsWithSchedulingPolicy:(unsigned int)arg1 evaluator:(CDUnknownBlockType)arg2;
...
- (id)_childTransactionsWithSchedulingPolicy:(unsigned int)arg1;
...
- (id)_parentTransactionsWithSchedulingPolicy:(unsigned int)arg1;
...
- (id)_descriptionForDebugging:(_Bool)arg1 indentLevel:(unsigned int)arg2 visited:(id)arg3;
- (id)_descriptionForDebugging:(_Bool)arg1 indentLevel:(unsigned int)arg2;
