...
@property int maxOutputLength; // @synthesize maxOutputLength=_maxOutputLength;
@property int maxInputLength; // @synthesize maxInputLength=_maxInputLength;
- (void).cxx_destruct;
- (void)dealloc;
- (void)terminate;
...
- (void)sendControl:(id)arg1 data:(id)arg2 expectedLength:(unsigned long)arg3 reply:(CDUnknownBlockType)arg4;
...
- (void)setProtocol:(unsigned int)arg1 reply:(CDUnknownBlockType)arg2;
