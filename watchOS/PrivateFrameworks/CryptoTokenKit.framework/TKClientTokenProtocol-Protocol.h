...
- (void)session:(NSNumber *)arg1 objectID:(NSData *)arg2 operation:(int)arg3 data:(NSData *)arg4 algorithms:(NSArray *)arg5 parameters:(NSDictionary *)arg6 reply:(void (^)(id, NSError *))arg7;
