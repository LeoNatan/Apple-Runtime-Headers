...
- (_Bool)tokenSession:(TKTokenSession *)arg1 supportsOperation:(int)arg2 usingKey:(id)arg3 algorithm:(TKTokenKeyAlgorithm *)arg4;
- (TKTokenAuthOperation *)tokenSession:(TKTokenSession *)arg1 beginAuthForOperation:(int)arg2 constraint:(id)arg3 error:(id *)arg4;
@end
