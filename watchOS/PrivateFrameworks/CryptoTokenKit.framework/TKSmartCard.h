...
@property unsigned int currentProtocol; // @synthesize currentProtocol=_currentProtocol;
@property unsigned int allowedProtocols; // @synthesize allowedProtocols=_allowedProtocols;
...
- (void)transmitChunkedIns:(unsigned char)arg1 p1:(unsigned char)arg2 p2:(unsigned char)arg3 data:(id)arg4 fromOffset:(unsigned int)arg5 realLe:(unsigned int)arg6 chained:(_Bool)arg7 isCase4:(_Bool)arg8 reply:(CDUnknownBlockType)arg9;
- (id)buildIns:(unsigned char)arg1 p1:(unsigned char)arg2 p2:(unsigned char)arg3 data:(id)arg4 range:(struct _NSRange)arg5 le:(id)arg6 protocol:(unsigned int)arg7 chained:(_Bool)arg8 extended:(_Bool *)arg9 realLe:(unsigned int *)arg10;
- (void)encodeLength:(unsigned int)arg1 into:(id)arg2 sized:(int)arg3;
- (void)handleApduResponse:(id)arg1 body:(id)arg2 le:(unsigned int)arg3 isCase4:(_Bool)arg4 error:(id)arg5 reply:(CDUnknownBlockType)arg6;
