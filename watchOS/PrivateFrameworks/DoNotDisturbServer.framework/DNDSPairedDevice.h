...
- (unsigned int)hash;
- (id)initWithDeviceIdentifier:(id)arg1 deviceClass:(unsigned int)arg2 syncProtocolVersion:(unsigned int)arg3 pairingIdentifier:(id)arg4 pairingDataStore:(id)arg5;
