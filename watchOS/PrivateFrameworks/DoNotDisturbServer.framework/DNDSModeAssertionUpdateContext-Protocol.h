...
- (DNDSModeAssertionUpdateResult *)invalidateAssertionsMatchingPredicate:(DNDSModeAssertionInvalidationPredicate *)arg1 forReason:(unsigned int)arg2 source:(DNDModeAssertionSource *)arg3;
