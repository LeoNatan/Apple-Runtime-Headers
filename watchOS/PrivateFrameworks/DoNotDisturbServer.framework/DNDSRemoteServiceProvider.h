...
- (id)_queue_invalidateAllActiveModeAssertionsWithReason:(unsigned int)arg1 error:(id *)arg2;
- (id)_invalidateAllActiveModeAssertionsWithReason:(unsigned int)arg1 error:(id *)arg2;
- (id)_queue_invalidateActiveModeAssertionForClientConnection:(id)arg1 clientIdentifier:(id)arg2 reason:(unsigned int)arg3 error:(id *)arg4;
