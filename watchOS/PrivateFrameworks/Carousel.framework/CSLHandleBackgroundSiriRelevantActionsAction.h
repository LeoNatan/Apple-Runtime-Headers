...
#import <PepperUICore/PUICHandleBackgroundSiriRelevantActionsAction.h>

#import <Carousel/CSLAssertionAction-Protocol.h>

@class CSLAssertionActionImplementation, FBSProcessExecutionPolicy, NSString;

@interface CSLHandleBackgroundSiriRelevantActionsAction : PUICHandleBackgroundSiriRelevantActionsAction <CSLAssertionAction>
{
