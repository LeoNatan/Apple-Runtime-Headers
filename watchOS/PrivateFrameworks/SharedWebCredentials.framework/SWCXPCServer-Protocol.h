...
- (void)getDetailsWithServiceSpecifier:(_SWCServiceSpecifier *)arg1 URL:(NSURL *)arg2 limit:(unsigned int)arg3 completionHandler:(void (^)(NSArray *, NSError *))arg4;
- (void)getInfoWithServiceSpecifier:(_SWCServiceSpecifier *)arg1 URL:(NSURL *)arg2 limit:(unsigned int)arg3 completionHandler:(void (^)(NSArray *, NSError *))arg4;
