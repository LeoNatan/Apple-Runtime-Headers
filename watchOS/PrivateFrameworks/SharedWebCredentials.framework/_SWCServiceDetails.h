...
+ (id)new;
+ (id)serviceDetailsWithServiceSpecifier:(id)arg1 URLComponents:(id)arg2 limit:(unsigned int)arg3 error:(id *)arg4;
+ (id)serviceDetailsWithServiceSpecifier:(id)arg1 limit:(unsigned int)arg2 error:(id *)arg3;
+ (id)serviceDetailsWithServiceSpecifier:(id)arg1 error:(id *)arg2;
+ (id)_serviceDetailsWithServiceSpecifier:(id)arg1 URLComponents:(id)arg2 limit:(unsigned int)arg3 error:(id *)arg4;
- (void).cxx_destruct;
