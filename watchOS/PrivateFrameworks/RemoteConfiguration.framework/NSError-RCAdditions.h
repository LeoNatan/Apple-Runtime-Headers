...
+ (id)rc_offlineErrorWithReason:(int)arg1;
+ (id)rc_notAvailableError;
+ (id)rc_notCachedError;
+ (id)rc_errorWithCode:(int)arg1 description:(id)arg2;
+ (id)rc_errorWithCode:(int)arg1 description:(id)arg2 additionalUserInfo:(id)arg3;
- (_Bool)rc_isOfflineErrorOfflineReason:(int *)arg1;
