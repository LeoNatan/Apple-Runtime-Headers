...
- (unsigned int)_executeDeleteStatement:(id)arg1 onConnection:(id)arg2 errorMessage:(id)arg3;
...
- (unsigned int)_mergeTable:(id)arg1 connection:(id)arg2;
- (unsigned int)_mergeSchema:(id)arg1 connection:(id)arg2;
- (unsigned int)_reconcileJournalsWithSchema:(id)arg1 connection:(id)arg2;
- (unsigned int)_reconcileJournalsWithSchema:(id)arg1 connection:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
