...
- (void)transferAllMessagesFromMailboxes:(id)arg1 exceptMessages:(id)arg2 transferType:(int)arg3 destinationMailboxURL:(id)arg4 userInitiated:(_Bool)arg5;
...
- (void)transferMessages:(id)arg1 transferType:(int)arg2 destinationMailboxURL:(id)arg3 userInitiated:(_Bool)arg4 oldMessagesByNewMessage:(id)arg5;
- (id)transferMessages:(id)arg1 transferType:(int)arg2 destinationMailboxURL:(id)arg3 userInitiated:(_Bool)arg4;
