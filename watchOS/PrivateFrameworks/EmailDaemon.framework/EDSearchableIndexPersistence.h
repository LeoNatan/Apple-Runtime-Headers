...
- (id)_attachmentItemsFromAttachmentData:(id)arg1 limit:(unsigned int)arg2 excludedAttachmentPersistentIDs:(id)arg3;
- (id)_attachmentDataForItemsRequiringIndexingExcludingIdentifiers:(id)arg1 limit:(unsigned int)arg2 connection:(id)arg3;
...
- (id)updatesForSearchableIndex:(id)arg1 excludingIdentifiers:(id)arg2 count:(unsigned int)arg3;
