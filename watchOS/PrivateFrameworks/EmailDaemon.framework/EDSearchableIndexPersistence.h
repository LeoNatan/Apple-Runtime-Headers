...
- (id)_attachmentItemsFromAttachmentData:(id)arg1 limit:(unsigned int)arg2 cancelationToken:(id)arg3;
- (id)_attachmentDataForItemsRequiringIndexingExcludingIdentifiers:(id)arg1 limit:(unsigned int)arg2 cancelationToken:(id)arg3 connection:(id)arg4;
- (id)_messageIDTransactionIDDictionaryToVerifyUsingConnection:(id)arg1 count:(unsigned int)arg2;
...
- (id)_identifiersForTombstonesOfType:(int)arg1 connection:(id)arg2;
- (void)_purgeSpotlightTombstonesBeforeTransaction:(long long)arg1 connection:(id)arg2;
- (void)_assignTombstonesForIdentifiers:(id)arg1 type:(int)arg2 transaction:(long long)arg3 connection:(id)arg4;
- (void)_addTombstonesForIdentifiers:(id)arg1 type:(int)arg2 connection:(id)arg3;
...
- (id)verificationDataSamplesForSearchableIndex:(id)arg1 count:(unsigned int)arg2;
...
- (void)searchableIndex:(id)arg1 willRemoveIdentifiers:(id)arg2 type:(int)arg3;
- (void)searchableIndex:(id)arg1 assignIndexingType:(int)arg2 forIdentifiers:(id)arg3;
- (_Bool)_canPerformIncrementalIndexForIdentifier:(id)arg1 indexingType:(int)arg2;
- (int)indexingTypeForSearchableIndex:(id)arg1 item:(id)arg2;
- (id)_messagesRequiringIndexingForType:(int)arg1 excludingIdentifiers:(id)arg2 limit:(int)arg3;
- (id)updatesForSearchableIndex:(id)arg1 excludingIdentifiers:(id)arg2 count:(unsigned int)arg3 cancelationToken:(id)arg4;
...
- (id)searchableIndexItemsFromMessages:(id)arg1 type:(int)arg2;
- (id)messagesWhere:(id)arg1 sortedBy:(id)arg2 limit:(int)arg3;
