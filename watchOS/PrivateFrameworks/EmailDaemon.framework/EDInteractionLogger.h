...
- (void)movedMessages:(id)arg1 toMailboxType:(int)arg2;
...
- (void)messageListDisplayStartedForMessage:(id)arg1 messageListType:(id)arg2 row:(int)arg3 cellStyle:(id)arg4;
...
- (void)_logMessageListDisplayStartedMessage:(id)arg1 now:(id)arg2 type:(id)arg3 row:(int)arg4 cellStyle:(id)arg5;
