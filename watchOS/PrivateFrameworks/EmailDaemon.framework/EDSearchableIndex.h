...
+ (id)userHandle;
+ (_Bool)isIncrementalIndexingType:(int)arg1;
...
- (void)indexMessages:(id)arg1 includeBody:(_Bool)arg2 indexingType:(int)arg3;
...
- (void)reindexAllItemsWithOptions:(unsigned int)arg1 acknowledgementHandler:(CDUnknownBlockType)arg2;
...
- (id)_identifiersStringForItems:(id)arg1 maxLength:(unsigned int)arg2;
...
- (void)_logSignpostForIndexingBatchAssignedUpdatesWithItemsIndexedCount:(unsigned int)arg1;
- (void)_logSignpostForIndexingBatchAssignedDomainRemovalCount:(unsigned int)arg1;
...
- (unsigned int)_countOfItemsInPendingQueues;
- (void)_queueRefresh;
...
- (id)dataSamplesForSearchableIndexVerifier:(id)arg1 searchableIndex:(id)arg2 count:(unsigned int)arg3;
...
- (double)_throttleRequestedSize:(unsigned int *)arg1 targetTime:(double)arg2 action:(CDUnknownBlockType)arg3;
- (void)_handleFailingTransactionIDs:(id)arg1 sampleCount:(unsigned int)arg2;
