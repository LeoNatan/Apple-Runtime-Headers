...
- (NSArray *)messageIDsForConversationID:(long long)arg1 limit:(unsigned int)arg2;
...
- (void)setPersistenceConversationFlags:(unsigned long long)arg1 syncKey:(NSString *)arg2 forConversationID:(long long)arg3 reason:(int)arg4;
