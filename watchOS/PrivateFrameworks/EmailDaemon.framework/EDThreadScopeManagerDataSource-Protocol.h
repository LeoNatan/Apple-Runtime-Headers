...
- (void)threadScopeManager:(EDThreadScopeManager *)arg1 gatherStatisticsForThreadScopesWithDatabaseIDs:(NSDictionary *)arg2 block:(void (^)(long long, NSDate *, unsigned int))arg3;
