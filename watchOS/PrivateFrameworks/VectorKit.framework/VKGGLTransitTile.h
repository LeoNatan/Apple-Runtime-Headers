...
@interface VKGGLTransitTile : VKVectorTile
{
    ...
    list_5fb6f0cf _displayConnections;
...
@property(readonly, nonatomic) list_5fb6f0cf *displayConnections; // @synthesize displayConnections=_displayConnections;
...
- (void)addTransitLinesInRect:(const Box_3d7e3c2c *)arg1 toSet:(unordered_set_400cf796 *)arg2;
- (void)willDisappear;
- (void)willAppear;
...
- (void)setSelectedNodes:(const unordered_set_a2a16c4c *)arg1;
- (void)setSelectedLines:(const unordered_set_a2a16c4c *)arg1;
- (void)appendNodesAttachedToLines:(const unordered_set_a2a16c4c *)arg1 toNodes:(unordered_set_a2a16c4c *)arg2;
...
- (float)minLineZoomForIDs:(const unordered_set_a2a16c4c *)arg1;
- (_Bool)containsLinesInSet:(const unordered_set_a2a16c4c *)arg1;
- (void)setNodeFeaturePool:(struct TransitNodeFeaturePool *)arg1;
- (void)setInterTileMediator:(const shared_ptr_10302801 *)arg1;
- (void)dealloc;
- (id)initWithKey:(const struct VKTileKey *)arg1 modelTile:(id)arg2 userInfo:(id)arg3 styleManager:(shared_ptr_a3c46825)arg4 dataOverrideManager:(shared_ptr_887a193f)arg5 sharedResources:(id)arg6 contentScale:(float)arg7 device:(Device_9226c869 *)arg8 labelExternalObjectsModerator:(struct LabelExternalObjectsModerator *)arg9;
