...
- (void)dealloc;
- (id)initShouldRasterize:(_Bool)arg1 inBackground:(_Bool)arg2 manifestConfiguration:(id)arg3 contentScale:(float)arg4;
...
- (void)_setStyleTransitionProgress:(float)arg1 targetStyle:(CDStruct_80aa614a)arg2 step:(int)arg3;
...
- (id)currentCanvas;
- (id)iconForStyleAttributes:(id)arg1 contentScale:(float)arg2 size:(int)arg3 customIconID:(unsigned long long)arg4 transparent:(_Bool)arg5;
