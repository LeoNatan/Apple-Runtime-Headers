...
- (_Bool)roadsDisabled;
@property(readonly, nonatomic, getter=getSceneState) unsigned int sceneState;
...
- (_Bool)canEnter3DModeFlyoverForTileSize:(int)arg1;
...
- (void)transitionToTracking:(_Bool)arg1 mapMode:(int)arg2 startLocation:(CDStruct_c3b9c2ee)arg3 startCourse:(double)arg4 pounceCompletionHandler:(CDUnknownBlockType)arg5;
...
- (double)distanceFromPoint:(struct CGPoint)arg1 toPoint:(struct CGPoint)arg2 fromLayer:(id)arg3 withPrecision:(int)arg4;
...
- (void)dealloc;
- (id)initShouldRasterize:(_Bool)arg1 inBackground:(_Bool)arg2 contentScale:(float)arg3 auditToken:(id)arg4;
...
- (unordered_map_3bd9e45d)clientStyleAttributes;
...
- (void)arController:(id)arg1 arSessionWasInterrupted:(unsigned int)arg2;
