...
- (_Bool)addPointyRoofForBuilding:(CDStruct_fb51a5a1 *)arg1 buildingModel:(unsigned char)arg2 scaleThreshold:(float)arg3 styleIndex:(float)arg4;
- (_Bool)canConstructPointyRoofForPolygon:(CDStruct_05d1342c *)arg1 building:(CDStruct_fb51a5a1 *)arg2 buildingModel:(unsigned char)arg3 scaleThreshold:(float)arg4;
- (void)addExtrusionForBuilding:(CDStruct_fb51a5a1 *)arg1 index:(unsigned int)arg2 ofTotal:(unsigned int)arg3;
- (void)addBuilding:(CDStruct_fb51a5a1 *)arg1 index:(unsigned int)arg2 ofTotal:(unsigned int)arg3 accessor:(struct ResourceAccessor *)arg4 triangulator:(Triangulator_dd8f0ddb *)arg5 prepareExtrusion:(_Bool)arg6 forRoofStyle:(unsigned char)arg7 scaleThreshold:(float)arg8;
- (void)didFinishAddingData;
- (void)willAddDataWithAccessor:(struct ResourceAccessor *)arg1;
- (void)prepareForBuilding:(CDStruct_fb51a5a1 *)arg1 forRoofStyle:(unsigned char)arg2 scaleThreshold:(float)arg3;
- (const MultiRange_4bdc93a8 *)commitRangesToPointyRoofStrokeRenderItemBatcher:(struct Batcher *)arg1 forMeshAtIndex:(unsigned long)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_bfb36918)arg4;
- (const MultiRange_4bdc93a8 *)commitRangesToPointyRoofFillRenderItemBatcher:(struct Batcher *)arg1 forMeshAtIndex:(unsigned long)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_bfb36918)arg4;
- (const MultiRange_4bdc93a8 *)commitRangesToPointyRoofTopRenderItemBatcher:(struct Batcher *)arg1 forMeshAtIndex:(unsigned long)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_bfb36918)arg4;
- (const MultiRange_4bdc93a8 *)commitRangesToExtrusionStrokeRenderItemBatcher:(struct Batcher *)arg1 forMeshAtIndex:(unsigned long)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_bfb36918)arg4;
- (const MultiRange_4bdc93a8 *)commitRangesToExtrusionFillRenderItemBatcher:(struct Batcher *)arg1 forMeshAtIndex:(unsigned long)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_bfb36918)arg4;
