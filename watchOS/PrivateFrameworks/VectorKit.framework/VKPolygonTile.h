...
@interface VKPolygonTile : VKSkewingVectorTile <VKPolygonTile>
{
    ...
    unordered_map_c352ad26 _transitNodesRouteAttributesMap;
}
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)setTransitNodesRouteAttributes:(const unordered_map_c352ad26 *)arg1;
...
- (void)dealloc;
- (id)initWithKey:(const struct VKTileKey *)arg1 modelTile:(id)arg2 userInfo:(id)arg3 prepareExtrusion:(_Bool)arg4 styleManager:(shared_ptr_a3c46825)arg5 sharedResources:(id)arg6 contentScale:(float)arg7 device:(Device_9226c869 *)arg8;
