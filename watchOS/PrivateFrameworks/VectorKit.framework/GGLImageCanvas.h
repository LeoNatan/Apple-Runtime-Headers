...
- (void)dealloc;
- (id)initWithSize:(struct CGSize)arg1 scale:(float)arg2 useMultisampling:(_Bool)arg3 taskContext:(const shared_ptr_e963992e *)arg4 device:(struct Device *)arg5 signpostId:(unsigned long long)arg6;
