...
- (void)addPatternedRibbonTo:(unordered_map_933849e0 *)arg1 styleQuery:(shared_ptr_c5d816ee)arg2 painterZ:(unsigned int)arg3 numPoints:(unsigned long)arg4 points:(Matrix_8746f91e *)arg5;
- (void)addRoadRibbonTo:(unordered_map_2061f73d *)arg1 styleQuery:(shared_ptr_c5d816ee)arg2 painterZ:(unsigned int)arg3 numPoints:(unsigned long)arg4 points:(Matrix_8746f91e *)arg5 startCap:(_Bool)arg6 endCap:(_Bool)arg7 trafficTexelRun:(const struct TexelRun *)arg8 trafficSkeleton:(_Bool)arg9;
- (void)updateViewDependentStateIfNecessaryWithContext:(struct LayoutContext *)arg1;
- (id)description;
- (void)dealloc;
- (id)initWithKey:(const struct VKTileKey *)arg1 modelTile:(id)arg2 userInfo:(id)arg3 styleManager:(shared_ptr_a3c46825)arg4 sharedResources:(id)arg5 contentScale:(float)arg6 device:(Device_9226c869 *)arg7;
