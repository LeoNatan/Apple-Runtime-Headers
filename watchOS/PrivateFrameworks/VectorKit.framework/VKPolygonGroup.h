...
- (_Bool)addFillForSection:(const struct PolygonSection *)arg1 precision:(unsigned char)arg2 styleIndex:(unsigned int)arg3 cullingMask:(unsigned int)arg4 accessor:(struct ResourceAccessor *)arg5 triangulator:(Triangulator_dd8f0ddb *)arg6;
- (void)addPolygon:(CDStruct_769cd29a *)arg1 hasNonWaterStyle:(_Bool)arg2 accessor:(struct ResourceAccessor *)arg3 triangulator:(Triangulator_dd8f0ddb *)arg4;
...
- (void)prepareForPolygon:(CDStruct_769cd29a *)arg1 hasNonWaterStyle:(_Bool)arg2;
- (unsigned int)createStrokePointStyleList:(CDStruct_769cd29a *)arg1 section:(unsigned int)arg2 outPointStyles:(vector_0496561e *)arg3;
...
- (shared_ptr_479d1306)_textureForName:(const basic_string_8c74bb18 *)arg1 textureManager:(shared_ptr_f2399894 *)arg2;
- (void)dealloc;
