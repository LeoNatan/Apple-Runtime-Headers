...
- (void)addPolygon:(CDStruct_3f45b185 *)arg1 hasNonWaterStyle:(_Bool)arg2 accessor:(struct ResourceAccessor *)arg3 triangulator:(id)arg4;
...
- (void)prepareForPolygon:(CDStruct_3f45b185 *)arg1 hasNonWaterStyle:(_Bool)arg2;
- (unsigned int)createStrokePointStyleList:(CDStruct_3f45b185 *)arg1 section:(unsigned int)arg2 outPointStyles:(vector_0496561e *)arg3;
...
- (shared_ptr_479d1306)_textureForName:(const basic_string_91ca5453 *)arg1;
- (void)dealloc;
