...
@property(readonly, nonatomic) unsigned int purpose; // @synthesize purpose=_purpose;
...
- (void)dealloc;
- (id)initWithTarget:(id)arg1 renderer:(struct CartographicRenderer *)arg2 purpose:(unsigned int)arg3 taskContext:(shared_ptr_e963992e)arg4 logicManager:(struct LogicManager *)arg5 mapEngineSettings:(const struct MapEngineSettings *)arg6 animationRunner:(struct AnimationRunner *)arg7;
