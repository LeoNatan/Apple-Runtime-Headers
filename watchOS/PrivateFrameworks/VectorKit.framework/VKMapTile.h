...
- (void)setTile:(id)arg1 state:(unsigned int)arg2 error:(id)arg3 forLayer:(unsigned char)arg4;
- (void)_setTile:(id)arg1 state:(unsigned int)arg2 error:(id)arg3 forLayer:(unsigned char)arg4 timestamp:(double)arg5;
