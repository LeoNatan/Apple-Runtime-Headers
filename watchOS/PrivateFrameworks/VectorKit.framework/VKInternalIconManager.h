...
- (id)imageForName:(id)arg1 contentScale:(float)arg2 sizeGroup:(int)arg3 modifiers:(id)arg4;
- (id)imageForKey:(unsigned int)arg1 value:(unsigned int)arg2 contentScale:(float)arg3 sizeGroup:(int)arg4 modifiers:(id)arg5;
- (id)imageForDataID:(unsigned int)arg1 text:(id)arg2 contentScale:(float)arg3 sizeGroup:(int)arg4 modifiers:(id)arg5;
- (id)imageForStyleAttributes:(id)arg1 withStylesheetName:(id)arg2 contentScale:(float)arg3 sizeGroup:(int)arg4 modifiers:(id)arg5;
- (id)imageForStyleAttributes:(id)arg1 styleManager:(shared_ptr_a3c46825)arg2 contentScale:(float)arg3 sizeGroup:(int)arg4 modifiers:(id)arg5;
