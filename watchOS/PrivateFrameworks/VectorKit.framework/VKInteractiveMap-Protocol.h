...
+ (_Bool)supportsMapType:(int)arg1 scale:(int)arg2 manifestConfiguration:(GEOResourceManifestConfiguration *)arg3;
...
- (void)transitionToTracking:(_Bool)arg1 mapMode:(int)arg2 startLocation:(CDStruct_c3b9c2ee)arg3 startCourse:(double)arg4 cameraController:(VKCameraController<VKNavigationCameraController> *)arg5 pounceCompletionHandler:(void (^)(_Bool))arg6;
