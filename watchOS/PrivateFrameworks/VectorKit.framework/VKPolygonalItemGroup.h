...
@interface VKPolygonalItemGroup : NSObject
{
    ...
    unordered_set_a2a16c4c _featureIds;
...
- (const MultiRange_4bdc93a8 *)commitRangesToVerticalVenueWallStrokeRenderItemBatcher:(struct Batcher *)arg1 forMeshAtIndex:(unsigned long)arg2 cullingMask:(unsigned int)arg3;
