...
+ (int)convertGrlSizeGroup:(unsigned char)arg1;
+ (unsigned char)convertSizeGroup:(int)arg1;
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)purge;
- (void)dealloc;
...
- (id)imageForName:(id)arg1 contentScale:(float)arg2 sizeGroup:(int)arg3 coordinate:(CDStruct_c3b9c2ee)arg4 modifiers:(id)arg5;
- (id)imageForKey:(unsigned int)arg1 value:(unsigned int)arg2 contentScale:(float)arg3 sizeGroup:(int)arg4 coordinate:(CDStruct_c3b9c2ee)arg5 modifiers:(id)arg6;
- (id)imageForDataID:(unsigned int)arg1 text:(id)arg2 contentScale:(float)arg3 sizeGroup:(int)arg4 coordinate:(CDStruct_c3b9c2ee)arg5 modifiers:(id)arg6;
- (id)imageForStyleAttributes:(id)arg1 withStylesheetName:(id)arg2 contentScale:(float)arg3 sizeGroup:(int)arg4 coordinate:(CDStruct_c3b9c2ee)arg5 modifiers:(id)arg6;
- (id)imageForStyleAttributes:(id)arg1 styleManager:(shared_ptr_a3c46825)arg2 contentScale:(float)arg3 sizeGroup:(int)arg4 coordinate:(CDStruct_c3b9c2ee)arg5 modifiers:(id)arg6;
