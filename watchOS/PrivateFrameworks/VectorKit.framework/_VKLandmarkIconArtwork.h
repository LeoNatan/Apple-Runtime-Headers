...
- (id)_newImage;
- (void)dealloc;
- (id)initWithMask:(struct CGImage *)arg1 outlineMask:(struct CGImage *)arg2 style:(const struct Style *)arg3 extraStyle:(const struct ExtraStyle *)arg4 contentScale:(float)arg5;
