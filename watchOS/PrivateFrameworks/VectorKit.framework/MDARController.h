...
{
    unsigned int _trackingState;
    unsigned int _trackingStateReason;
    unsigned int _sessionInterruptedReason;
...
@property(readonly, nonatomic) unsigned int sessionInterruptedReason; // @synthesize sessionInterruptedReason=_sessionInterruptedReason;
- (void)pause;
- (void)run:(_Bool)arg1;
- (void)dealloc;
- (id)init;
