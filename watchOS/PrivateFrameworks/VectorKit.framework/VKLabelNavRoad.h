...
- (_Bool)matchesRoadEdge:(const CDStruct_fc3c0eb0 *)arg1;
...
- (void)dealloc;
- (id)initWithRoadEdge:(const CDStruct_fc3c0eb0 *)arg1 navJunctionA:(id)arg2 routeOffset:(struct PolylineCoordinate)arg3 tile:(const shared_ptr_702c344d *)arg4;
