...
- (_Bool)_findRouteOverlappingJunctionFrom:(int)arg1 routeJunctions:(vector_682a2c99 *)arg2 lookBackward:(_Bool)arg3 firstOverlap:(int *)arg4 secondOverlap:(int *)arg5;
