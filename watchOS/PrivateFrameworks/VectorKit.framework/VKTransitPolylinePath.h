...
- (void)dealloc;
- (id)description;
- (id)initWithOverlay:(id)arg1 section:(id)arg2 points:(Matrix_8746f91e *)arg3 pointCount:(unsigned int)arg4 reversePoints:(_Bool)arg5 transform:(CDStruct_5ae1f918 *)arg6 routeStartIndex:(unsigned int)arg7 routeEndIndex:(unsigned int)arg8 lineID:(unsigned long long)arg9 tile:(id)arg10;
