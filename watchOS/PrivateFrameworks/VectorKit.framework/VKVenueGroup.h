...
- (unsigned long)verticalStrokeCountForSection:(const struct PolygonSection *)arg1 styles:(const vector_0496561e *)arg2 edges:(const vector_304c695f *)arg3;
- (const vector_304c695f *)generateEdgeListForPolygonSection:(const struct PolygonSection *)arg1 key:(const pair_3c94251f *)arg2;
