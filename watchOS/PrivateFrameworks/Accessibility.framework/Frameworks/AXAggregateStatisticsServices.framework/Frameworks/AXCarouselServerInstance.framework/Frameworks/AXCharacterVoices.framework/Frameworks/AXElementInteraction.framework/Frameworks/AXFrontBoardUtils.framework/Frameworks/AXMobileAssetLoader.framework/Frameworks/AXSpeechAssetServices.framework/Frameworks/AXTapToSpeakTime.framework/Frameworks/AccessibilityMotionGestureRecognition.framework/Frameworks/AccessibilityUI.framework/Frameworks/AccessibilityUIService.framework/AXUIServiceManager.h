...
@interface AXUIServiceManager : NSObject <AXUIMessageSenderDelegate>
{
    ...
    unsigned int _lastUsedServiceIdentifier;
...
@property(nonatomic) unsigned int lastUsedServiceIdentifier; // @synthesize lastUsedServiceIdentifier=_lastUsedServiceIdentifier;
...
- (_Bool)_registerClientWithIdentifier:(id)arg1 connection:(id)arg2 serviceBundleName:(id)arg3 initiatingMessageIdentifier:(unsigned int)arg4 error:(id *)arg5;
- (void)_applicationDidReceiveMemoryWarning:(id)arg1;
- (void)_applicationDidFinishLaunching;
- (void)_registerForSpringBoardDeath;
- (_Bool)_serviceWithClass:(Class)arg1 canProcessMessageWithIdentifier:(unsigned int)arg2 fromClientWithConnection:(id)arg3 possibleRequiredEntitlements:(id *)arg4;
...
- (id)_sendSynchronousMessage:(id)arg1 withIdentifier:(unsigned int)arg2 toClientWithMessenger:(id)arg3 error:(id *)arg4;
- (void)_sendAsynchronousMessage:(id)arg1 withIdentifier:(unsigned int)arg2 toClientWithMessenger:(id)arg3 targetAccessQueue:(id)arg4 completionRequiresWritingBlock:(_Bool)arg5 completion:(CDUnknownBlockType)arg6;
