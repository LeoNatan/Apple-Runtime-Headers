...
- (void)finishInstantReplayAtIndex:(unsigned int)arg1;
- (void)updateInstantReplayAtIndex:(unsigned int)arg1 withPartialPath:(id)arg2;
- (void)reloadDynamicFingerPathAtIndex:(unsigned int)arg1;
- (void)insertDynamicFingerPathAtIndex:(unsigned int)arg1;
- (id)_dynamicFingerPathAtIndex:(unsigned int)arg1;
- (void)fingerPathDidChange:(unsigned int)arg1;
