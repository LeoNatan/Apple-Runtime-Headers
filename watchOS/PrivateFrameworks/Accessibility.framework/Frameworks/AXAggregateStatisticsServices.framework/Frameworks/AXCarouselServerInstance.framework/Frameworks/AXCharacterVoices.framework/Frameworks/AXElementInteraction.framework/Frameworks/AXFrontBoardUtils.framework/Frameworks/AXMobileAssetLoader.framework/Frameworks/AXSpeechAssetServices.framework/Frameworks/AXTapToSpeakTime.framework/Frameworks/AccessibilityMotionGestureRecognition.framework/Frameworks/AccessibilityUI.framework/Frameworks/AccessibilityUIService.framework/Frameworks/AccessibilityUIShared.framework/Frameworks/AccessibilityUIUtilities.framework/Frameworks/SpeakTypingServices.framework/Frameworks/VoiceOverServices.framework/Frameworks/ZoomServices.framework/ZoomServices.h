...
- (id)activeZoomMode;
- (void)autoPanZoomUsingLocation:(struct CGPoint)arg1 withPanningStyle:(unsigned int)arg2;
- (void)panDown;
- (void)panUp;
- (void)panRight;
- (void)panLeft;
...
- (_Bool)notifyZoomIdleSlugOpacityChangedTo:(float)arg1;
...
- (_Bool)notifyZoomFocusDidChangeWithType:(int)arg1 rect:(struct CGRect)arg2 contextId:(unsigned int)arg3 keyboardFrame:(struct CGRect)arg4;
- (_Bool)notifyZoomFocusDidChangeWithType:(int)arg1 rect:(struct CGRect)arg2 contextId:(unsigned int)arg3;
...
- (id)userInterfaceClient:(id)arg1 accessQueueForProcessingMessageWithIdentifier:(unsigned int)arg2;
- (id)userInterfaceClient:(id)arg1 processMessageFromServer:(id)arg2 withIdentifier:(unsigned int)arg3 error:(id *)arg4;
- (void)startMagnifier;
