...
@property(nonatomic) float leftMixedVolume;
@property(nonatomic) float rightMixedVolume;
@property(nonatomic) float leftSensitivity;
@property(nonatomic) float rightSensitivity;
