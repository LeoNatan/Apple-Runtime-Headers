...
- (void)provideFeedbackForAction:(RTAction *)arg1 engagementResult:(int)arg2 reply:(void (^)(NSError *))arg3;
...
- (void)fetchCloudSyncAuthorizationState:(void (^)(int, NSError *))arg1;
