...
@interface RTTokenBucket : NSObject
{
    ...
    unsigned int _totalOperations;
    unsigned int _operationsAllowed;
...
- (void)dumpStatistics;
- (void)reset;
- (unsigned int)countOfOperationsAllowedWithCost:(double)arg1;
- (unsigned int)countOfOperationsAllowed;
...
- (_Bool)_consumeTokens:(unsigned int)arg1;
