...
- (void)userInteractionWithPredictedLocationOfInterest:(id)arg1 interaction:(unsigned int)arg2 feedback:(id)arg3 geoMapItem:(id)arg4 handler:(CDUnknownBlockType)arg5;
...
- (void)updateLocationOfInterestWithIdentifier:(id)arg1 type:(int)arg2 customLabel:(id)arg3 handler:(CDUnknownBlockType)arg4;
- (void)updateLocationOfInterestWithIdentifier:(id)arg1 customLabel:(id)arg2 handler:(CDUnknownBlockType)arg3;
- (void)updateLocationOfInterestWithIdentifier:(id)arg1 type:(int)arg2 handler:(CDUnknownBlockType)arg3;
- (void)updateLocationOfInterestWithIdentifier:(id)arg1 mapItem:(id)arg2 handler:(CDUnknownBlockType)arg3;
- (void)updateLocationOfInterestWithIdentifier:(id)arg1 type:(int)arg2 mapItem:(id)arg3 customLabel:(id)arg4 handler:(CDUnknownBlockType)arg5;
- (void)addLocationOfInterestOfType:(int)arg1 mapItem:(id)arg2 customLabel:(id)arg3 handler:(CDUnknownBlockType)arg4;
- (void)addLocationOfInterestOfType:(int)arg1 mapItem:(id)arg2 handler:(CDUnknownBlockType)arg3;
- (void)addLocationOfInterestOfType:(int)arg1 mapItem:(id)arg2 withHandler:(CDUnknownBlockType)arg3;
...
- (void)startMonitoringScenarioTriggerOfType:(unsigned int)arg1 withHandler:(CDUnknownBlockType)arg2;
...
- (void)provideFeedbackForAction:(id)arg1 engagementResult:(int)arg2 handler:(CDUnknownBlockType)arg3;
...
- (void)simulateApplicationPredictionWithBundleIdentifier:(id)arg1 reason:(int)arg2 handler:(CDUnknownBlockType)arg3;
