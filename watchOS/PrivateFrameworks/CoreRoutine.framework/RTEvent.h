...
- (id)initWithStartDate:(id)arg1 endDate:(id)arg2 source:(int)arg3 identifier:(id)arg4;
- (id)initWithStartDate:(id)arg1 endDate:(id)arg2 source:(int)arg3;
