...
@class MPCPlayerPath, MPLibraryAddStatusObserver, MPRequestResponseController, NMRNowPlayingState, NMROrigin, NMRPlaybackQueue, NMRPlayerResponseNowPlayingState, NSObject<OS_dispatch_queue>, NSString;
