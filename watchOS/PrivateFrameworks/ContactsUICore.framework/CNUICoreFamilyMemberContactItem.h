...
@interface CNUICoreFamilyMemberContactItem : NSObject <NSCopying, NSSecureCoding>
{
    ...
    NSData *_imageData;
    int _contactType;
    int _whitelistStatus;
}

+ (_Bool)supportsSecureCoding;
- (void).cxx_destruct;
@property(readonly, nonatomic) _Bool hasBeenPersisted; // @synthesize hasBeenPersisted=_hasBeenPersisted;
@property(readonly, nonatomic) int whitelistStatus; // @synthesize whitelistStatus=_whitelistStatus;
@property(readonly, nonatomic) int contactType; // @synthesize contactType=_contactType;
...
- (id)initWithContactIdentifier:(id)arg1 formattedName:(id)arg2 imageData:(id)arg3 isUnreachable:(_Bool)arg4 contactType:(int)arg5 whitelistStatus:(int)arg6 hasBeenPersisted:(_Bool)arg7;
