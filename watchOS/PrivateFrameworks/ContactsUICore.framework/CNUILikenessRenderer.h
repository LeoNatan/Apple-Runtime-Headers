...
+ (id)concurrentCachingRendererWithLikenessResolver:(id)arg1 capacity:(unsigned int)arg2 schedulerProvider:(id)arg3;
+ (id)cachingRendererWithLikenessResolver:(id)arg1 capacity:(unsigned int)arg2 schedulerProvider:(id)arg3;
