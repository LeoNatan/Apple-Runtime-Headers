...
- (void)dealloc;
- (id)initWithLikenessResolver:(id)arg1 capacity:(unsigned int)arg2 schedulerProvider:(id)arg3;
- (id)initWithLikenessResolver:(id)arg1 capacity:(unsigned int)arg2;
