...
+ (void)insertPreviousRoute:(unsigned short *)arg1 ofLength:(unsigned int)arg2 toBuffer:(unsigned short **)arg3 ofLength:(unsigned int)arg4 atPosition:(unsigned short *)arg5 addSpace:(_Bool)arg6;
