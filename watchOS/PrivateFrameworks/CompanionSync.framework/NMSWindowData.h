...
@property(readonly, nonatomic) unsigned int countOfPendingMessages;
...
@property(readonly, nonatomic) unsigned int countOfAllMessagesInFlight;
@property(readonly, nonatomic) unsigned int lengthOfAllMessagesInFlight;
