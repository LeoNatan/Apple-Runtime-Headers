...
@property(nonatomic) int maxConcurrentMessages; // @synthesize maxConcurrentMessages=_maxConcurrentMessages;
...
- (id)stateResponders;
- (void)_onSessionStateChangedTo:(int)arg1 do:(CDUnknownBlockType)arg2;
...
@property(readonly, nonatomic) unsigned int sentChangeCount;
@property(readonly, nonatomic) unsigned int sentChangeByteCount;
