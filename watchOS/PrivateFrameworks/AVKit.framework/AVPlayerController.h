...
@class AVAsset, AVAssetTrack, AVMediaSelectionOption, AVObservationController, AVPlayer, AVValueTiming, NSArray, NSDate, NSDictionary, NSError, NSNumber, NSObject;
...
@interface AVPlayerController : UIResponder
{
    ...
    long _savedCaptionAppearanceDisplayType;
    ...
    int _canUseNetworkResourcesForLiveStreamingWhilePausedCount;
...
- (void)seekOrStepByFrameCount:(int)arg1;
