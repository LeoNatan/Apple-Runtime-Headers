...
- (void)stopObserving;
- (void)startObserving;
- (id)initWithObservedObject:(id)arg1 observer:(id)arg2 keyPaths:(id)arg3 retainingObservedObject:(_Bool)arg4 options:(unsigned int)arg5 changesBlock:(CDUnknownBlockType)arg6;
