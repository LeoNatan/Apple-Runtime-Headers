...
- (void)logTrustedString:(id)arg1 type:(unsigned char)arg2 logLevel:(int)arg3;
- (void)actuallyLogString:(id)arg1 type:(unsigned char)arg2 logLevel:(int)arg3;
- (void)logString:(id)arg1 type:(unsigned char)arg2 logLevel:(int)arg3;
- (id)init;
