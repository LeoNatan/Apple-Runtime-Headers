...
+ (id)deduplicatedReplyTextsForReplyPositions:(id)arg1 semanticClass:(unsigned int)arg2 responseCount:(unsigned int)arg3 config:(id)arg4;
- (void).cxx_destruct;
...
- (id)sortedReplyPositionsForSemanticClass:(unsigned int)arg1 config:(id)arg2;
- (id)replyTextsForSemanticClass:(unsigned int)arg1 responseCount:(unsigned int)arg2 config:(id)arg3;
