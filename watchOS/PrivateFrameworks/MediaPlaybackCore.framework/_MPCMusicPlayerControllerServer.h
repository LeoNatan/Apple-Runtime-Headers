...
- (void)endSeek;
- (void)beginSeekWithDirection:(int)arg1;
- (void)reshuffle;
- (void)skipWithBehavior:(int)arg1;
- (void)stop;
- (void)pauseWithFadeDuration:(int)arg1;
- (void)play;
...
- (void)getNowPlayingAtIndex:(int)arg1 reply:(CDUnknownBlockType)arg2;
