...
- (_Bool)_shouldVendContentItemForOffset:(int)arg1;
...
@property(readonly, nonatomic) unsigned int hardQueueItemCount;
...
- (void)addPlaybackIntent:(id)arg1 withOptions:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (int)state;
- (id)currentContainer;
- (id)currentItem;
- (void)dealloc;
