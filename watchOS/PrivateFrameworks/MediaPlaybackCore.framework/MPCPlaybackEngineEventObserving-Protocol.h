...
- (void)engine:(MPCPlaybackEngine *)arg1 didChangeRepeatType:(int)arg2;
- (void)engine:(MPCPlaybackEngine *)arg1 didChangeShuffleType:(int)arg2;
...
- (void)engine:(MPCPlaybackEngine *)arg1 didChangeToState:(unsigned int)arg2;
@end
