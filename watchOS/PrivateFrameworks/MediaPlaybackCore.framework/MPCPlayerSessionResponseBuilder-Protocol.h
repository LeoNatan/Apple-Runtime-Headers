...
- (MPCPlayerPath *)sessionPlayerPath:(MPCPlayerPath *)arg1 atIndex:(int)arg2 chain:(MPMiddlewareChain *)arg3;
- (int)sessionNumberOfSessions:(int)arg1 forPlayerPathAtIndex:(int)arg2 chain:(MPMiddlewareChain *)arg3;
- (int)sessionNumberOfPlayerPaths:(int)arg1 chain:(MPMiddlewareChain *)arg2;
@end
