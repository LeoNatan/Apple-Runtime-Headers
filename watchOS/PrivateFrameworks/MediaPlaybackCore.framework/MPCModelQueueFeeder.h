...
@interface MPCModelQueueFeeder : MPQueueFeeder <MPRTCReportingItemSessionContaining, MPShuffleControllerDataSource, MPCQueueBehaviorManaging>
{
    ...
    int _preferredStartIndexFromPlaybackContext;
    ...
    struct map<unsigned int, MPIdentifierSet *, std::__1::less<unsigned int>, std::__1::allocator<std::__1::pair<const unsigned int, MPIdentifierSet *>>> _retrievedIndexToIdentifiers;
...
- (unsigned int)_indexOfItemWithIdentifier:(id)arg1 shouldIgnoreShuffle:(_Bool)arg2;
...
- (_Bool)_handleFinalResponseWithPreferredStartIndex:(unsigned int)arg1;
- (_Bool)_hasPlaceholderItemAtIndex:(unsigned int)arg1;
- (id)_genericObjectForModelObject:(id)arg1;
- (id)_equivalencySourceAdamIDForIdentifierSet:(id)arg1;
- (void)_endBackgroundTaskAssertion;
- (int)_currentPreferredStartIndexWithFinalResponse:(_Bool)arg1;
