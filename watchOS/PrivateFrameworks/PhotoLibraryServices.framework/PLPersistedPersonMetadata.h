...
+ (void)performPostImportMigrationFromVersion:(unsigned int)arg1 fromDataInManagedObjectContext:(id)arg2;
...
+ (id)_fetchFacesWithPredicate:(id)arg1 resultType:(unsigned int)arg2 managedObjectContext:(id)arg3 error:(id *)arg4;
...
@property(nonatomic) int fromVersion; // @synthesize fromVersion=_fromVersion;
