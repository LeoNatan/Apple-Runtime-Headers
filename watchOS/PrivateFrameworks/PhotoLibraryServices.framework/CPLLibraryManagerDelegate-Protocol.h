...
@optional
- (void)libraryManager:(CPLLibraryManager *)arg1 provideLocalResource:(CPLResource *)arg2 recordClass:(Class)arg3 completionHandler:(void (^)(CPLResource *, unsigned int))arg4;
