...
- (id)requestSuggestedRecipientsForMomentIdentifiers:(id)arg1 sharingStream:(unsigned int)arg2 error:(id *)arg3;
...
- (id)requestCurationDebugInformationForAssetCollectionWithLocalIdentifier:(id)arg1 precision:(unsigned int)arg2 error:(id *)arg3;
