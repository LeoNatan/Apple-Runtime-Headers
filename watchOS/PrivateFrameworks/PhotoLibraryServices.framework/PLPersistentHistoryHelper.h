...
+ (id)fetchTransactionsSinceToken:(id)arg1 withBatchSize:(unsigned int)arg2 context:(id)arg3 error:(id *)arg4;
+ (id)fetchTransactionsSinceToken:(id)arg1 withFetchLimit:(unsigned int)arg2 context:(id)arg3 error:(id *)arg4;
