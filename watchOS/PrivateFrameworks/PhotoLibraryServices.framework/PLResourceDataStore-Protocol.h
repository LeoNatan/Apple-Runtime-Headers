...
- (void)requestStreamingURLForResource:(id <PLResource>)arg1 asset:(PLManagedAsset *)arg2 intent:(unsigned int)arg3 inContext:(NSManagedObjectContext *)arg4 completion:(void (^)(NSError *, NSURL *, NSDate *))arg5;
