...
- (void)_dispatchExternalWaitersForState:(int)arg1;
- (void)_transitionToState:(int)arg1;
- (_Bool)_canTransitionToState:(int)arg1 error:(id *)arg2;
- (void)deactivateWithInvalidationError:(id)arg1;
- (_Bool)finalize:(id *)arg1;
- (void)_invalidate;
- (_Bool)transitionToState:(int)arg1 error:(id *)arg2;
- (void)_enqueueExternalWaiterCompletionBlockForState:(int)arg1 completionBlock:(CDUnknownBlockType)arg2;
- (void)awaitLibraryState:(int)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (_Bool)awaitLibraryState:(int)arg1 error:(id *)arg2;
- (void)_waitForAwaitOperation:(id)arg1;
- (id)_enqueueAwaitOperation;
- (void)_awaitLibraryState:(int)arg1 sync:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (id)_libraryServicesStateNodeWithState:(int)arg1;
