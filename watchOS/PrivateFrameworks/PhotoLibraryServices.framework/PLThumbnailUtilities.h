...
+ (_Bool)_performSWDownscaleTo5551OnSourceImage:(struct CGImage *)arg1 withSourceDimensions:(CDStruct_dff5684f)arg2 withSpecification:(id)arg3 destinationData:(id)arg4 imageRect:(struct CGRect *)arg5 bytesPerRow:(int *)arg6;
