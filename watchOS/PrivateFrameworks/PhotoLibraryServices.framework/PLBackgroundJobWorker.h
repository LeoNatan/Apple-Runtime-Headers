...
@interface PLBackgroundJobWorker : NSObject <PLBackgroundJobWorkerProtocol>
{
    ...
    unsigned int _totalJobsCount;
    NSObject<OS_dispatch_queue> *_processingQueue;
    struct os_unfair_lock_s _lock;
    _Bool _shouldStop;
    unsigned int _workerPriority;
...
@property(readonly, nonatomic) unsigned int workerPriority; // @synthesize workerPriority=_workerPriority;
...
- (id)initWithPriority:(unsigned int)arg1 photoLibrary:(id)arg2;
- (id)init;
