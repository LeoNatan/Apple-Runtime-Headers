...
+ (int)qualitySortValueBasedOnFullSizeWidth:(unsigned int)arg1 height:(unsigned int)arg2 isNativeColorSpace:(_Bool)arg3 forResource:(id)arg4;
...
@property(nonatomic) unsigned int cplType; // @dynamic cplType;
...
@property(readonly, nonatomic) unsigned int sourceCplType; // @dynamic sourceCplType;
