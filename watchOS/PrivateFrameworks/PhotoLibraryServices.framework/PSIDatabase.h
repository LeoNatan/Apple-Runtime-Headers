...
@interface PSIDatabase : NSObject
{
    ...
    CDStruct_dff5684f _tokenizerOutputRanges[8];
    NSString *_path;
}
...
- (id)_inqNewGroupsWithMatchingGroupIds:(const void **)arg1 count:(long)arg2 matchingPredicateBlock:(CDUnknownBlockType)arg3;
