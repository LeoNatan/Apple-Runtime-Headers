...
- (void)requestMemoryDebugInformationForMemoryWithLocalIdentifier:(NSString *)arg1 precision:(unsigned int)arg2 context:(NSDictionary *)arg3 reply:(void (^)(NSDictionary *, NSError *))arg4;
