...
+ (id)_memoriesMatchingPredicate:(id)arg1 sortDescriptors:(id)arg2 limit:(int)arg3 inManagedObjectContext:(id)arg4;
...
+ (_Bool)indexTitleForMemoryCategory:(unsigned int)arg1;
