...
- (void)_downloadCPLResourceForAsset:(id)arg1 resourceType:(unsigned int)arg2 options:(id)arg3 taskDidBeginHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
