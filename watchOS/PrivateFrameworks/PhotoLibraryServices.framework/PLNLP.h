...
+ (id)ngramsFromTokens:(id)arg1 ofSize:(unsigned int)arg2 usingSeparator:(id)arg3;
+ (id)stringWithoutDiacriticsFromString:(id)arg1;
+ (id)tokensFromString:(id)arg1 options:(int)arg2;
+ (id)lemmasForToken:(id)arg1 locale:(id)arg2 options:(int)arg3;
