...
- (int)attemptLightweightMigrationFromVersion:(id)arg1 onStore:(id)arg2 withMetadata:(id)arg3 orStoreURL:(id)arg4 options:(id)arg5 coordinator:(id)arg6;
...
- (int)createNewDatabaseWithMigrationType:(int)arg1 forced:(_Bool)arg2;
...
- (int)migrateOrCreateDatabaseIfNecessaryWithPersistentContainer:(id)arg1;
