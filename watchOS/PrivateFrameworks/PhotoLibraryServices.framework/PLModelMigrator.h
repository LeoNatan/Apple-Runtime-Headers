...
+ (short)_resourceVersionFromCPLType:(unsigned int)arg1 fromAdjustedSet:(_Bool)arg2;
+ (short)_resourceTypeFromCPLType:(unsigned int)arg1 assetType:(short)arg2;
...
+ (unsigned int)_recipeIDFromCPLResourceType:(unsigned int)arg1 assetType:(short)arg2 fromAdjustedSet:(_Bool)arg3;
