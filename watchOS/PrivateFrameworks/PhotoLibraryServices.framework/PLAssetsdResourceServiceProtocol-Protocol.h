...
- (void)asynchronousVideoURLForAsset:(NSURL *)arg1 format:(unsigned short)arg2 intent:(unsigned int)arg3 networkAccessAllowed:(_Bool)arg4 streamingAllowed:(_Bool)arg5 trackCPLDownload:(_Bool)arg6 restrictToPlayable:(_Bool)arg7 reply:(void (^)(NSURL *, unsigned short, NSString *, _Bool, NSString *, NSString *, NSError *))arg8;
