...
@property(nonatomic) int previousValidatedModelVersion;
...
- (void)runPeriodicMaintenanceTasks:(unsigned int)arg1 withTransaction:(PLXPCTransaction *)arg2;
...
- (id <PLMomentListData>)monthMomentListForMonth:(int)arg1 year:(int)arg2;
- (id <PLMomentListData>)yearMomentListForYear:(int)arg1;
...
- (void)enumerateAssetsWithIDs:(NSArray *)arg1 usingBlock:(void (^)(id <PLMomentAssetData>, unsigned int, _Bool *))arg2;
...
- (void)performDataTransaction:(void (^)(void))arg1 synchronously:(_Bool)arg2 priority:(int)arg3 completionHandler:(void (^)(void))arg4;
- (void)performBlock:(void (^)(void))arg1 synchronously:(_Bool)arg2 priority:(int)arg3 completionHandler:(void (^)(void))arg4;
