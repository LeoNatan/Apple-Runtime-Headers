...
@class NSArray, NSCalendar, NSMutableArray, NSObject<PLAlbumProtocol>, NSSet, NSString, PLAssetsdClient, PLFetchingAlbum, PLGenericAlbum, PLManagedAlbum, PLManagedAlbumList, PLManagedFolder, PLManagedObjectContext, PLPhotoAnalysisServiceClient, PLPhotoLibraryPathManager, PLSimpleDCIMDirectory;
...
+ (void)performOnTransientLibraryWithPriority:(int)arg1 name:(const char *)arg2 block:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;
+ (void)performOnTransientLibraryWithPriority:(int)arg1 name:(const char *)arg2 block:(CDUnknownBlockType)arg3;
...
- (void)_withDispatchGroup:(id)arg1 synchronously:(_Bool)arg2 priority:(int)arg3 name:(id)arg4 shouldSave:(_Bool)arg5 performTransaction:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;
