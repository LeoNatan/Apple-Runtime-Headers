...
@property(readonly, nonatomic) unsigned int logicalScreenPixelSize;
@property(readonly, nonatomic) _Bool shouldUseNanoThumbnailFormats; // @dynamic shouldUseNanoThumbnailFormats;
- (id)description;
- (id)initWithLogicalScreenSize:(struct CGSize)arg1 screenScale:(float)arg2 deviceClass:(void *)arg3 isRidingCrudSnow:(_Bool)arg4 isRidingPowderSnow:(_Bool)arg5;
