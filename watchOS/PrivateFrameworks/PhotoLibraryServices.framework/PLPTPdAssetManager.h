...
- (void)markSignpostForAsset:(id)arg1 endMarker:(_Bool)arg2 adjusted:(_Bool)arg3 arg4:(unsigned long)arg4;
...
- (id)dataByJPEGCompressingCGImage:(struct CGImage *)arg1 toLengthLimit:(int)arg2 initialCompressionQuality:(float)arg3 size:(struct CGSize)arg4 orientation:(int)arg5;
