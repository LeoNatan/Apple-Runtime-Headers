...
+ (short)_localTypeFromCloudType:(int)arg1;
+ (int)_cloudTypeToPushFromLocalType:(short)arg1 cachedCloudType:(unsigned short)arg2;
...
+ (id)_faceCropsMatchingPredicate:(id)arg1 limit:(unsigned int)arg2 inManagedObjectContext:(id)arg3;
