...
@interface PLLocationOfInterestCache : NSObject
{
    ...
    unsigned int _numberOfLocationsOfInterestVisits;
    NSDate *_earliestVisitStartDate;
    PLLocationOfInterestVisit *_lastLocationOfInterestVisit;
    unsigned int _numberOfLocationsOfInterestTransitions;
}

- (void).cxx_destruct;
@property(readonly) unsigned int numberOfLocationsOfInterestTransitions; // @synthesize numberOfLocationsOfInterestTransitions=_numberOfLocationsOfInterestTransitions;
...
@property(readonly) unsigned int numberOfLocationsOfInterestVisits; // @synthesize numberOfLocationsOfInterestVisits=_numberOfLocationsOfInterestVisits;
...
@property(readonly) unsigned int numberOfLocationsOfInterest;
...
- (id)locationsOfInterestOfType:(int)arg1;
