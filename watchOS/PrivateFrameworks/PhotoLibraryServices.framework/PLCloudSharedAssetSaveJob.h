...
+ (void)saveCloudSharedAssetAtPath:(id)arg1 forAssetCollection:(id)arg2 mediaAssetType:(unsigned int)arg3 albumGUID:(id)arg4 personID:(id)arg5 info:(id)arg6 shouldPrioritize:(_Bool)arg7;
...
- (void)_incrementDerivativesCount:(int)arg1 thumbnailsCount:(int)arg2;
- (void)_prefetchLimitForDerivatives:(int *)arg1 thumbnails:(int *)arg2;
- (_Bool)_processInflightAsset:(id)arg1 mediaAssetType:(unsigned int)arg2;
