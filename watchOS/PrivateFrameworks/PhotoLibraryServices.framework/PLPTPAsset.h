...
@interface PLPTPAsset : NSObject <NSMutableCopying, NSCopying>
{
    ...
    int _conversionGroup;
}

- (void).cxx_destruct;
@property(readonly, copy, nonatomic) NSData *event; // @synthesize event=_event;
@property(readonly, nonatomic) int conversionGroup; // @synthesize conversionGroup=_conversionGroup;
...
@property(readonly, nonatomic) int desiredOrientation; // @synthesize desiredOrientation=_desiredOrientation;
