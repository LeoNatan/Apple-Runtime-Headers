...
+ (id)entityName;
+ (unsigned int)fullSizeJPEGSourceForUTI:(id)arg1 andImageDimensions:(struct CGSize)arg2;
...
- (id)originalFilenameForResourceType:(unsigned int)arg1 filePath:(id)arg2;
...
- (id)rm_cloudResourceForResourceType:(unsigned int)arg1 forAssetUuid:(id)arg2;
- (id)rm_cloudResourcesForResourceType:(unsigned int)arg1;
