...
@class CLLocation, NSArray, NSData, NSDate, NSDictionary, NSError, NSManagedObject, NSManagedObjectID, NSNumber, NSObject<NSCopying>, NSOrderedSet, NSSet, NSString, NSURL, PLAdditionalAssetAttributes, PLCloudFeedAssetsEntry, PLCloudMaster, PLFaceCrop, PLMoment, UIImage;
...
+ (unsigned int)countOfAssetsQuarantinedInLibrary:(id)arg1;
+ (unsigned int)countOfAssetsFailedToUploadInLibrary:(id)arg1;
+ (unsigned int)_countOfAssetsForUploadInLibrary:(id)arg1 withCloudLocalState:(short)arg2;
+ (unsigned int)countOfAssetsMissingOriginalsInLibrary:(id)arg1;
...
- (void)markCloudResourceOfType:(unsigned int)arg1 asLocallyAvailable:(_Bool)arg2;
...
- (id)cplAssetChangeWithMasterID:(id)arg1 withChangeType:(unsigned int)arg2 shouldGenerateDerivatives:(_Bool)arg3 inLibrary:(id)arg4;
- (id)cplFullRecord;
...
- (void)_applyResourceChangeToCPLAsset:(id)arg1 withIdentifier:(id)arg2 forChangeType:(unsigned int)arg3 shouldGenerateDerivatives:(_Bool)arg4 inLibrary:(id)arg5;
...
- (id)_createVideoResourceFromVideoURL:(id)arg1 withResourceType:(unsigned int)arg2 itemIdentifier:(id)arg3 applyVideoAdjustments:(_Bool)arg4 forMaster:(_Bool)arg5 forPhotoIris:(_Bool)arg6;
...
- (id)_createImageResourceForResourceType:(unsigned int)arg1 withPreviewImagePath:(id)arg2 itemIdentifier:(id)arg3 forMaster:(_Bool)arg4;
- (id)itemIdentifier;
- (id)_generatePosterFrameForVideoAtURL:(id)arg1 withResourceType:(unsigned int)arg2 itemIdentifier:(id)arg3 forMaster:(_Bool)arg4;
