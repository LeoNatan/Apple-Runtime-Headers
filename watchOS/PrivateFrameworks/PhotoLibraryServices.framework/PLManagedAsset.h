...
+ (unsigned long long)localResourceOptionFromResourceType:(unsigned int)arg1 useMaster:(_Bool)arg2;
...
+ (unsigned int)countUsedAssetsWithKind:(short)arg1 excludeTrashed:(_Bool)arg2 excludeInvisible:(_Bool)arg3 excludeCloudShared:(_Bool)arg4 excludePhotoStream:(_Bool)arg5 inManagedObjectContext:(id)arg6;
+ (long long)totalPurgeableSizeOnDiskInLibrary:(id)arg1 urgency:(int)arg2;
...
+ (unsigned int)countForAssetsWithUUIDs:(id)arg1 includePendingChanges:(_Bool)arg2 inManagedObjectContext:(id)arg3 error:(id *)arg4;
...
+ (id)_notPushedAssetsToUploadInitiallyInManagedObjectContext:(id)arg1 withSavedAssetTypePredicate:(id)arg2 shouldSort:(_Bool)arg3 limit:(unsigned int)arg4;
+ (id)assetsToUploadInitiallyInManagedObjectContext:(id)arg1 limit:(unsigned int)arg2;
+ (id)_syncablePredicate;
+ (unsigned int)countOfNotUploadedAssetsInPhotoLibrary:(id)arg1 forAssetType:(short)arg2 error:(id *)arg3;
...
+ (id)_assetsWithCloudAssetUUIDs:(id)arg1 inMomentShare:(id)arg2 inLibrary:(id)arg3 fetchLimit:(unsigned int)arg4;
...
+ (id)cloudAdjustmentFingerprintWithAdjustmentDataBlob:(id)arg1 formatIdentifier:(id)arg2 formatVersion:(id)arg3 editorBundleID:(id)arg4 baseVersion:(int)arg5 baseFingerprint:(id)arg6;
+ (id)cloudAdjustmentFingerprintWithAdjustmentDataBlob:(id)arg1 formatIdentifier:(id)arg2 formatVersion:(id)arg3 editorBundleID:(id)arg4 baseVersion:(int)arg5 baseImageData:(id)arg6;
+ (id)_cloudAdjustmentFingerprintWithAdjustmentDataBlob:(id)arg1 largeAdjustmentBlobFingerpint:(id)arg2 formatIdentifier:(id)arg3 formatVersion:(id)arg4 editorBundleID:(id)arg5 baseVersion:(int)arg6 baseImageData:(id)arg7 baseImageFingerprint:(id)arg8;
+ (id)predicateForCompleteResources;
+ (void)countOfAssetsWithRequiredResourcesNotLocallyAvailableInLibrary:(id)arg1 outCount:(unsigned int *)arg2 photoCount:(unsigned int *)arg3 videoCount:(unsigned int *)arg4;
...
- (void)_ingestAndApplyMetadataChangesFromAdjustmentRenderedContentURL:(id)arg1 fullSizeRenderURL:(id)arg2 renderedVideoComplementContentURL:(id)arg3 videoPosterContentURL:(id)arg4 videoPosterRenderURL:(id)arg5 ingestionType:(int)arg6 updateAdjustmentDictionary:(id)arg7 shouldUpdateAttributes:(_Bool)arg8 isSubstandardRender:(_Bool)arg9 isRevertToOriginal:(_Bool)arg10;
...
- (_Bool)isResourceAvailableForResourceType:(unsigned int)arg1;
- (_Bool)_isResourceAvailableForResourceType:(unsigned int)arg1 outResource:(id *)arg2;
- (_Bool)_isAdjustedResourceAvailableForResourceType:(unsigned int)arg1;
- (_Bool)_isAdjustedResourceAvailableForResourceType:(unsigned int)arg1 outResource:(id *)arg2;
- (_Bool)_isMasterResourceAvailableForResourceType:(unsigned int)arg1;
- (_Bool)_isMasterResourceAvailableForResourceType:(unsigned int)arg1 outResource:(id *)arg2;
- (unsigned int)CPLResourceTypeFromVideoFormat:(unsigned short)arg1;
...
- (_Bool)becomePhotoIrisWithMediaGroupUUID:(id)arg1 videoURL:(id)arg2 spatialOverCaptureURL:(id)arg3 videoDuration:(CDStruct_198678f7)arg4 stillDisplayTime:(CDStruct_198678f7)arg5 options:(unsigned int)arg6;
- (_Bool)becomePhotoIrisWithMediaGroupUUID:(id)arg1 videoURL:(id)arg2 videoDuration:(CDStruct_198678f7)arg3 stillDisplayTime:(CDStruct_198678f7)arg4 options:(unsigned int)arg5;
...
- (void)_appendPublicEventStrings:(id)arg1 toAsset:(id)arg2 forSearchIndexCategory:(unsigned int)arg3;
...
- (id)legacyCloudResourceForResourceType:(unsigned int)arg1;
...
- (id)pathForCPLResourceType:(unsigned int)arg1 adjusted:(_Bool)arg2;
...
- (id)localResourcePathForMasterResourceWithCPLType:(unsigned int)arg1 andUTI:(id)arg2;
...
- (struct CGSize)targetSizeForInputSize:(struct CGSize)arg1 maxPixelSize:(unsigned int)arg2;
...
- (void)_applyResourceChangeToCPLAsset:(id)arg1 forChangeType:(unsigned int)arg2 shouldGenerateDerivatives:(_Bool)arg3 inLibrary:(id)arg4;
...
- (id)_createVideoResourceFromVideoURL:(id)arg1 withResourceType:(unsigned int)arg2 scopedIdentifier:(id)arg3 applyVideoAdjustments:(_Bool)arg4 forMaster:(_Bool)arg5 forPhotoIris:(_Bool)arg6;
- (id)_createCPLResourceFromResourcePath:(id)arg1 withResourceType:(unsigned int)arg2 uniformTypeIdentifier:(id)arg3 scopedIdentifier:(id)arg4;
- (id)_createImageResourceForResourceType:(unsigned int)arg1 withPreviewImagePath:(id)arg2 scopedIdentifier:(id)arg3 forMaster:(_Bool)arg4;
...
- (_Bool)addSidecarFileAtIndex:(unsigned int)arg1 sidecarURL:(id)arg2 withFilename:(id)arg3 compressedSize:(id)arg4 captureDate:(id)arg5 modificationDate:(id)arg6 uniformTypeIdentifier:(id)arg7 pathManager:(id)arg8;
- (_Bool)addSidecarFileInfo:(id)arg1 pathManager:(id)arg2 atIndex:(unsigned int)arg3;
...
- (id)assetResourceForCPLType:(unsigned int)arg1;
- (id)masterResourceForCPLType:(unsigned int)arg1;
- (id)resourceForCPLType:(unsigned int)arg1 version:(unsigned int)arg2;
