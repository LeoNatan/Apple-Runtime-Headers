...
+ (unsigned int)_countAssetsInLibrary:(id)arg1 withPredicate:(id)arg2 withKeyPathsForPrefetching:(id)arg3;
...
- (void)setAdjustments:(id)arg1 renderedContentURL:(id)arg2 penultimateRenderedJPEGData:(id)arg3 isSubstandardRender:(_Bool)arg4 fullSizeRenderSize:(struct CGSize)arg5 renderedVideoComplementContentURL:(id)arg6 penultimateRenderedVideoComplementContentURL:(id)arg7 shouldUpdateAttributes:(_Bool)arg8 fileIngestionType:(int)arg9 shouldGenerateThumbnails:(_Bool)arg10;
- (void)setAdjustments:(id)arg1 renderedContentURL:(id)arg2 penultimateRenderedJPEGData:(id)arg3 isSubstandardRender:(_Bool)arg4 fullSizeRenderSize:(struct CGSize)arg5 renderedVideoComplementContentURL:(id)arg6 penultimateRenderedVideoComplementContentURL:(id)arg7 shouldUpdateAttributes:(_Bool)arg8 fileIngestionType:(int)arg9;
- (void)writeOutAdjustmentsToFile:(id)arg1;
- (int)_prepareFileSystemResourcesForPhotoAdjustmentsWithCurrentAdjustmentBaseVersion:(int)arg1 pathForFullsizeRenderImageFile:(id)arg2 penultimateRenderedJPEGData:(id)arg3 renderedVideoComplementContentURL:(id)arg4 penultimateRenderedVideoComplementContentURL:(id)arg5 fileIngestionType:(int)arg6;
...
- (_Bool)addSidecarFileAtIndex:(unsigned int)arg1 sidecarURL:(id)arg2 withFilename:(id)arg3 originalFilename:(id)arg4 compressedSize:(id)arg5 captureDate:(id)arg6 modificationDate:(id)arg7 uniformTypeIdentifier:(id)arg8;
- (_Bool)addSidecarFileInfo:(id)arg1 atIndex:(unsigned int)arg2;
- (_Bool)addSideCarForVideoComplementFileIfNecessary:(id)arg1;
- (_Bool)becomePhotoIrisWithMediaGroupUUID:(id)arg1 videoURL:(id)arg2 videoDuration:(CDStruct_1b6d18a9)arg3 stillDisplayTime:(CDStruct_1b6d18a9)arg4 createSidecar:(_Bool)arg5 options:(unsigned int)arg6;
...
- (unsigned int)_masterResourceTypeForAdjustedAssetResourceType:(unsigned int)arg1 sourceAsset:(id)arg2 flattenLivePhoto:(_Bool)arg3;
...
- (id)nrm_cplMasterResourceForResourceType:(unsigned int)arg1;
- (id)nrm_cplResourceForResourceType:(unsigned int)arg1;
...
- (id)resourceForCPLType:(unsigned int)arg1 itemIdentifier:(id)arg2;
