...
+ (id)payloadPropertyWithKey:(id)arg1 andType:(unsigned int)arg2 requiresConversion:(_Bool)arg3;
+ (id)payloadPropertyWithKey:(id)arg1 andType:(unsigned int)arg2;
...
- (id)initWithKey:(id)arg1 andType:(unsigned int)arg2 subRelationshipProperties:(id)arg3 requiresConversion:(_Bool)arg4 relationPropertyNames:(id)arg5 isUUIDKey:(_Bool)arg6 isToManySubRelationship:(_Bool)arg7;
