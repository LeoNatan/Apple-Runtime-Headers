...
- (void)privateDownloadCloudPhotoLibraryAsset:(NSURL *)arg1 resourceType:(unsigned int)arg2 highPriority:(_Bool)arg3 reply:(void (^)(void))arg4;
...
- (void)prefetchResourcesWithMode:(int)arg1 reply:(void (^)(NSError *))arg2;
