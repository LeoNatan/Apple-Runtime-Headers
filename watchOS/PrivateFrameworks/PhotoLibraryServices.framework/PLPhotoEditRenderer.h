...
- (void)generateJPEGImageDataWithCompressionQuality:(float)arg1 livePhotoPairingIdentifier:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)renderVideoWithTargetSize:(struct CGSize)arg1 contentMode:(int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)renderImageWithTargetSize:(struct CGSize)arg1 contentMode:(int)arg2 renderMode:(int)arg3 renderTime:(CDStruct_198678f7)arg4 completion:(CDUnknownBlockType)arg5;
- (void)renderImageWithTargetSize:(struct CGSize)arg1 contentMode:(int)arg2 renderMode:(int)arg3 completion:(CDUnknownBlockType)arg4;
- (void)renderImageWithTargetSize:(struct CGSize)arg1 contentMode:(int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (id)initWithEditSource:(id)arg1 overcaptureEditSource:(id)arg2 renderPriority:(int)arg3;
