...
@interface PLImageFormat : NSObject
{
    ...
    int _formatMode;
    int _version;
    const CDStruct_39c0191a *_bakedFormatInfo;
    int _thumbnailKind;
    struct CGSize _size;
}
...
@property(readonly, nonatomic) const CDStruct_39c0191a *bakedFormatInfo; // @synthesize bakedFormatInfo=_bakedFormatInfo;
...
@property(readonly, nonatomic) int formatMode; // @synthesize formatMode=_formatMode;
...
- (id)initWithName:(id)arg1 size:(struct CGSize)arg2 isCropped:(_Bool)arg3 version:(int)arg4 isAlwaysFullScreen:(_Bool)arg5 formatMode:(int)arg6 thumbnailKind:(int)arg7;
- (id)initWithName:(id)arg1 size:(struct CGSize)arg2 isCropped:(_Bool)arg3 version:(int)arg4 isAlwaysFullScreen:(_Bool)arg5;
...
- (_Bool)_isAcceptableForViewSize:(struct CGSize)arg1 contentMode:(int)arg2 sourceAspectRatio:(float)arg3 desiredImageSize:(struct CGSize)arg4 demoteFactor:(double)arg5;
