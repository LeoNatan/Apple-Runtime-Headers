...
- (_Bool)GCM:(const struct ccmode_gcm *)arg1 context:(CDStruct_60067b7e *)arg2 iv:(id)arg3 size:(unsigned long)arg4 data:(const char *)arg5 processed:(char *)arg6 tag:(char *)arg7 error:(id *)arg8;
