...
- (_Bool)validateAlias:(id)arg1 type:(int)arg2;
...
- (_Bool)addIMHandle:(id)arg1 toGroups:(id)arg2 atLocation:(int)arg3;
- (_Bool)removePeople:(id)arg1 fromGroups:(id)arg2;
- (_Bool)addPeople:(id)arg1 toGroups:(id)arg2 atLocation:(int)arg3;
