...
- (id)fileSizeForMessageGUID:(id)arg1 withFilePathIndex:(int)arg2;
- (id)uploadAttachmentToCloudkitWithMessageGUID:(id)arg1 andFilePathIndex:(int)arg2;
- (id)clearAttachmentsUploadedToCloudkit;
- (id)deleteAttachmentWithMessageGUID:(id)arg1 andFilePathIndex:(int)arg2;
- (id)loadHighResolutionFileForMessageGUID:(id)arg1 withFilePathIndex:(int)arg2;
