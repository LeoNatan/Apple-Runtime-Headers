...
+ (void)_initializeFMF;
+ (void)moveVIPChatAtIndex:(int)arg1 toIndex:(int)arg2;
...
- (void)_setJoinState:(int)arg1 quietly:(_Bool)arg2;
...
- (_Bool)hasSurfRequestForPaymentType:(unsigned int)arg1;
- (unsigned int)paymentTypeForMessage:(id)arg1;
- (void)_resetChatIdToLastMessageItemMap;
- (void)_handleMessageGUIDDeletions:(id)arg1;
- (void)_setParticipantState:(unsigned int)arg1 forHandles:(id)arg2 quietly:(_Bool)arg3;
- (void)_setParticipantState:(unsigned int)arg1 forHandle:(id)arg2 quietly:(_Bool)arg3;
...
- (id)_archivedItemsToReplace:(id)arg1 numberOfMessagesBeforeGUID:(unsigned int)arg2 numberOfMessagesAfterGUID:(unsigned int)arg3;
- (void)_insertHistoricalMessages:(id)arg1 queryID:(id)arg2 isRefresh:(_Bool)arg3 isHistoryQuery:(_Bool)arg4 limit:(unsigned int)arg5 numberOfMessagesBeforeGUID:(unsigned int)arg6 numberOfMessagesAfterGUID:(unsigned int)arg7;
- (void)_insertHistoricalMessages:(id)arg1 queryID:(id)arg2 isRefresh:(_Bool)arg3 isHistoryQuery:(_Bool)arg4 limit:(unsigned int)arg5;
...
- (int)_compareChat:(id)arg1 withDate:(id)arg2 withDate:(id)arg3;
- (id)_tuDateForChat:(id)arg1;
- (int)compareChatByTUDateAndLastFinishedMessageDate:(id)arg1;
- (int)compareChatByDate:(id)arg1;
...
- (unsigned int)scrutinyModeAttemptCount;
...
- (id)loadFrequentRepliesLimit:(unsigned int)arg1 loadImmediately:(_Bool)arg2;
- (id)loadMessagesBeforeAndAfterGUID:(id)arg1 numberOfMessagesToLoadBeforeGUID:(unsigned int)arg2 numberOfMessagesToLoadAfterGUID:(unsigned int)arg3 loadImmediately:(_Bool)arg4;
- (id)loadMessagesUpToGUID:(id)arg1 date:(id)arg2 limit:(unsigned int)arg3 loadImmediately:(_Bool)arg4;
