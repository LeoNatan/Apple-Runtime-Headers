...
- (void)enumerateAllChatsAndAttachmentSizesWithOptions:(unsigned int)arg1 usingBlock:(CDUnknownBlockType)arg2;
...
- (void)_chat_loadPagedHistory:(id)arg1 numberOfMessagesBefore:(unsigned int)arg2 numberOfMessagesAfter:(unsigned int)arg3 messageGUID:(id)arg4 queryID:(id)arg5;
...
- (void)updateChatDictionaryArray:(id)arg1 createdChat:(id)arg2 joinstate:(int)arg3 setHasCommunicatedOveriMessage:(_Bool *)arg4;
...
- (void)pagedHistoryQuery:(id)arg1 chatID:(id)arg2 services:(id)arg3 numberOfMessagesBefore:(unsigned int)arg4 numberOfMessagesAfter:(unsigned int)arg5 finishedWithResult:(id)arg6;
...
- (void)_checkLimitAndSetMessagesToKeepLoadedIfNeeded:(unsigned long)arg1 chat:(id)arg2;
