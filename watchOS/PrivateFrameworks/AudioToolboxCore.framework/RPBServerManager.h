...
- (long)parameterChangedOnRPB:(unsigned int)arg1 itemID:(unsigned int)arg2 inParameterID:(unsigned int)arg3 inParameterValue:(float)arg4;
- (long)propertyChangedOnRPB:(unsigned int)arg1 itemID:(unsigned int)arg2 inPropertyID:(unsigned int)arg3;
- (long)propertyChangedOnRPB:(unsigned int)arg1 inPropertyID:(unsigned int)arg2;
- (long)propertiesChangedOnRPB:(unsigned int)arg1 inPropertyIDs:(id)arg2;
- (long)unregisterRPBItem:(unsigned int)arg1 inRPBlockID:(unsigned int)arg2;
- (long)registerRPBItem:(unsigned int *)arg1 inRPBlockID:(unsigned int)arg2;
