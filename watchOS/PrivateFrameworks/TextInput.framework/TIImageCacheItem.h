...
+ (id)cacheItemWithSize:(struct CGSize)arg1 format:(unsigned char)arg2 formatColor:(struct CGColor *)arg3 scale:(float)arg4 data:(id)arg5 dataReleaseHandler:(CDUnknownBlockType)arg6;
+ (id)cacheItemWithSize:(struct CGSize)arg1 format:(unsigned char)arg2 formatColor:(struct CGColor *)arg3 scale:(float)arg4 data:(id)arg5;
- (void).cxx_destruct;
