...
- (void)smartSelectionForTextInDocument:(NSString *)arg1 inRange:(struct _NSRange)arg2 language:(NSString *)arg3 tokenizedRanges:(NSArray *)arg4 options:(unsigned int)arg5 completion:(void (^)(struct _NSRange))arg6;
...
- (void)performHitTestForTouchEvents:(NSArray *)arg1 keyboardState:(TIKeyboardState *)arg2 continuation:(void (^)(int))arg3;
