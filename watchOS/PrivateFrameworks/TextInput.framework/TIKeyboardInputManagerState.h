...
@property(nonatomic) unsigned int initialCandidateBatchCount; // @synthesize initialCandidateBatchCount=_initialCandidateBatchCount;
...
@property(nonatomic) unsigned int autoquoteType;
