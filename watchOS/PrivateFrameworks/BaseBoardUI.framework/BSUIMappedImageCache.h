...
- (void)setImage:(id)arg1 forKey:(id)arg2 withPersistenceOptions:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)_setImage:(id)arg1 forKey:(id)arg2 withPersistenceOptions:(unsigned int)arg3 andCPBitmapReadFlags:(int)arg4 completion:(CDUnknownBlockType)arg5;
