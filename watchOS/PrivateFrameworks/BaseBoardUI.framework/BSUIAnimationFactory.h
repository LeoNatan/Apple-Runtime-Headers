...
+ (void)animateWithSettings:(id)arg1 options:(unsigned int)arg2 actions:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;
+ (void)animateWithSettings:(id)arg1 options:(unsigned int)arg2 actions:(CDUnknownBlockType)arg3;
