...
#import "CSLPISystemSleepGlobalObserverObserver.h"

@class CSLPIBalancedPowerAssertion, CSLPIDispatchTimer, CSLPIScheduledSystemWake, NSObject<OS_dispatch_queue>, NSString;
