...
- (unsigned int)_numberOfTranscriptItems;
- (id)_makeDrawableForTranscriptItem:(id)arg1;
- (id)_cachedDrawableAtIndexOrNil:(unsigned int)arg1;
- (id)_cachedDrawableForTranscriptItem:(id)arg1 atIndex:(unsigned int)arg2;
- (void)removeItemsAtIndexPaths:(id)arg1 insertItemsAtIndexPaths:(id)arg2;
- (id)drawableAtIndex:(unsigned int)arg1;
- (void)invalidateLayout;
- (float)_spaceForVerticalSpaceDescriptor:(int)arg1;
- (void)_updateFrames;
