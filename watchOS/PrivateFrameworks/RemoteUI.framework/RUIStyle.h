...
@property(nonatomic) int footerLinkAlignment; // @synthesize footerLinkAlignment=_footerLinkAlignment;
@property(nonatomic) int footerLabelAlignment; // @synthesize footerLabelAlignment=_footerLabelAlignment;
@property(nonatomic) int subHeaderLabelAlignment; // @synthesize subHeaderLabelAlignment=_subHeaderLabelAlignment;
@property(nonatomic) int headerLabelAlignment; // @synthesize headerLabelAlignment=_headerLabelAlignment;
@property(nonatomic) int labelRowTextAlignment; // @synthesize labelRowTextAlignment=_labelRowTextAlignment;
...
@property(readonly, nonatomic) int navBarActivityIndicatorStyle;
