...
- (void)conference:(id)arg1 remoteVideoPaused:(_Bool)arg2 callID:(int)arg3;
- (void)conference:(id)arg1 remoteAudioPaused:(_Bool)arg2 callID:(int)arg3;
- (void)conference:(id)arg1 withCallID:(int)arg2 didPauseAudio:(_Bool)arg3 error:(id)arg4;
- (void)conference:(id)arg1 reinitializeCallForCallID:(unsigned long)arg2;
- (void)conference:(id)arg1 withCallID:(int)arg2 remoteMediaStalled:(_Bool)arg3;
- (void)conference:(id)arg1 videoQualityNotificationForCallID:(int)arg2 isDegraded:(_Bool)arg3 isRemote:(_Bool)arg4;
- (void)conference:(id)arg1 withCallID:(int)arg2 networkHint:(_Bool)arg3;
