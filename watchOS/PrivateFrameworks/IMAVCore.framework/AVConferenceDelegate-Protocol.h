...
- (void)conference:(AVConference *)arg1 withCallID:(int)arg2 networkHint:(_Bool)arg3;
- (void)conference:(AVConference *)arg1 videoQualityNotificationForCallID:(int)arg2 isDegraded:(_Bool)arg3 isRemote:(_Bool)arg4;
...
- (void)conference:(AVConference *)arg1 remoteVideoPaused:(_Bool)arg2 callID:(int)arg3;
- (void)conference:(AVConference *)arg1 remoteAudioPaused:(_Bool)arg2 callID:(int)arg3;
...
- (void)conference:(AVConference *)arg1 withCallID:(int)arg2 remoteMediaStalled:(_Bool)arg3;
...
- (void)conference:(AVConference *)arg1 localAudioEnabled:(_Bool)arg2 forCallID:(unsigned long)arg3 error:(NSError *)arg4;
- (void)conference:(AVConference *)arg1 remoteAudioEnabled:(_Bool)arg2 forCallID:(unsigned long)arg3;
...
- (void)conference:(AVConference *)arg1 withCallID:(int)arg2 didPauseVideo:(_Bool)arg3 error:(NSError *)arg4;
- (void)conference:(AVConference *)arg1 withCallID:(int)arg2 didPauseAudio:(_Bool)arg3 error:(NSError *)arg4;
- (void)conference:(AVConference *)arg1 withCallID:(int)arg2 isSendingAudio:(_Bool)arg3 error:(NSError *)arg4;
- (void)conference:(AVConference *)arg1 didStopWithCallID:(int)arg2 error:(NSError *)arg3 callMetadata:(NSDictionary *)arg4;
- (void)conference:(AVConference *)arg1 didStartSession:(_Bool)arg2 withCallID:(int)arg3 error:(NSError *)arg4;
