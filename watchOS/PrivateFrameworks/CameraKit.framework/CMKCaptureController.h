...
+ (_Bool)isVideoMode:(int)arg1;
+ (_Bool)isStillImageMode:(int)arg1;
+ (id)sharedInstance;
...
- (void)postOrientationChangedNotification:(int)arg1 force:(_Bool)arg2;
@property(readonly, nonatomic) _Bool isStillImageStabilizationActive;
- (_Bool)supportsLiveEffects;
- (_Bool)supportsAvalancheAnalysisForDevice:(int)arg1;
...
- (_Bool)supportsHDRSuggestionForDevice:(int)arg1;
@property(readonly, nonatomic) _Bool supportsHDRSuggestion;
- (_Bool)supportsHDRForDevice:(int)arg1 mode:(int)arg2;
...
- (_Bool)hasFrontFlash;
- (_Bool)hasRearFlash;
- (void)_setFlashMode:(int)arg1 force:(_Bool)arg2;
...
- (void)_setFocusMode:(int)arg1 forceSmoothFocus:(_Bool)arg2;
...
- (void)_setCameraMode:(int)arg1 cameraDevice:(int)arg2 forceConfigure:(_Bool)arg3;
...
- (_Bool)_configureSessionWithCameraMode:(int)arg1 cameraDevice:(int)arg2 options:(id)arg3;
- (_Bool)_safeSetCameraMode:(int)arg1 cameraDevice:(int)arg2;
