...
@property(readonly, nonatomic) int _framesWrittenCount; // @synthesize _framesWrittenCount=__framesWrittenCount;
@property(readonly, nonatomic) int _sourceFramesReadCount; // @synthesize _sourceFramesReadCount=__sourceFramesReadCount;
...
- (void).cxx_destruct;
- (id)copySourceStabilizationMetadataForFrameNumber:(int)arg1 outputSampleTime:(CDStruct_198678f7 *)arg2 stabilizer:(id)arg3;
- (struct __CVBuffer *)copySourcePixelBufferForFrameNumber:(int)arg1 outputSampleTime:(CDStruct_198678f7 *)arg2 stabilizer:(id)arg3;
...
- (_Bool)_startWritingWithOutputPath:(id)arg1 width:(int)arg2 height:(int)arg3 videoFormatDescription:(struct opaqueCMFormatDescription *)arg4 transform:(struct CGAffineTransform)arg5 framesPerSecond:(int)arg6 frameCount:(int)arg7 visMetadataCount:(int)arg8 videoMetadata:(id)arg9;
...
- (void)writeMovieFromImageFiles:(id)arg1 visMetadataFiles:(id)arg2 startDate:(id)arg3 location:(id)arg4 outputPath:(id)arg5 transform:(struct CGAffineTransform)arg6 framesPerSecond:(int)arg7 completionHandler:(CDUnknownBlockType)arg8;
- (void)_reset;
- (id)init;
