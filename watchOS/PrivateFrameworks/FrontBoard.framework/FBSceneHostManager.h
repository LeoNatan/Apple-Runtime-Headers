...
@interface FBSceneHostManager : NSObject <BSDescriptionProviding>
{
    ...
    unsigned int _defaultRenderingMode;
...
@property(readonly, nonatomic) int contentState; // @synthesize contentState=_contentState;
...
@property(nonatomic) unsigned int defaultHostedLayerTypes; // @synthesize defaultHostedLayerTypes=_defaultHostedLayerTypes;
...
- (void)setLayer:(id)arg1 alpha:(float)arg2 forRequester:(id)arg3;
...
- (id)hostViewForRequester:(id)arg1 enableAndOrderFront:(_Bool)arg2 appearanceStyle:(unsigned int)arg3;
