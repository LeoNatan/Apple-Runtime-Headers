...
- (void)_notifyDelegateOfAcquisitionForBundleID:(id)arg1 efficacy:(unsigned int)arg2;
- (void)noteTerminationAssertionEfficacyChangedTo:(unsigned int)arg1 forBundleIdentifier:(id)arg2;
