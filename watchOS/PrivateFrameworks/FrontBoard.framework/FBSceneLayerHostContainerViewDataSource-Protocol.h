...
- (unsigned int)contextHostRenderingModeForHostContainerView:(FBSceneLayerHostContainerView *)arg1;
- (float)hostContainerView:(FBSceneLayerHostContainerView *)arg1 alphaForLayer:(FBSceneLayer *)arg2;
