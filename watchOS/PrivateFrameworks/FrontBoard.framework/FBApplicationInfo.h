...
+ (void)_buildDefaults:(id)arg1 fromInfo:(id)arg2 entitlements:(id)arg3 appType:(unsigned int)arg4 isOnOrAfterOkemo:(_Bool)arg5;
...
- (_Bool)supportsDeviceFamily:(unsigned int)arg1;
- (_Bool)supportsAllInterfaceOrientations;
- (_Bool)supportsInterfaceOrientation:(int)arg1;
