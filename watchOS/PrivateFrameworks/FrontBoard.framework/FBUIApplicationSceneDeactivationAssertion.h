...
@property(readonly, nonatomic) float sceneLevel; // @synthesize sceneLevel=_sceneLevel;
- (void).cxx_destruct;
...
- (void)acquire;
- (void)dealloc;
- (id)_initWithReason:(int)arg1 sceneLevel:(float)arg2 forDisplayWithIdentity:(id)arg3;
