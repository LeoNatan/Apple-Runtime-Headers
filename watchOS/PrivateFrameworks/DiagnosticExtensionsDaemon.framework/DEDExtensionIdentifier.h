...
+ (id)log;
- (void).cxx_destruct;
@property int invocationNumber; // @synthesize invocationNumber=_invocationNumber;
...
- (id)initWithExtensionIdentifier:(id)arg1 invocationNumber:(int)arg2;
