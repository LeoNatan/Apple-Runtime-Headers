...
+ (id)deviceForSFDevice:(id)arg1 systemInfo:(id)arg2 andStatus:(int)arg3;
+ (id)deviceForSFDevice:(id)arg1 andStatus:(int)arg2;
...
- (id)imageURLForDeviceClass:(id)arg1 deviceModel:(id)arg2 deviceColor:(id)arg3 size:(int)arg4 variant:(int)arg5 scale:(float)arg6;
