...
- (id)contentTypeForParameterEncoding:(unsigned int)arg1;
- (id)bodyDataForParameters:(id)arg1 encoding:(unsigned int)arg2 error:(id *)arg3;
...
- (void)updatePromise:(id)arg1 withFilename:(id)arg2 size:(long long)arg3 status:(int)arg4 success:(CDUnknownBlockType)arg5 error:(CDUnknownBlockType)arg6;
- (void)updatePromise:(id)arg1 withAttachmentGroup:(id)arg2 status:(int)arg3 success:(CDUnknownBlockType)arg4 error:(CDUnknownBlockType)arg5;
...
- (void)performHTTPMethod:(id)arg1 toURL:(id)arg2 parameters:(id)arg3 encoding:(unsigned int)arg4 success:(CDUnknownBlockType)arg5 error:(CDUnknownBlockType)arg6;
- (void)deleteResourceAtURL:(id)arg1 success:(CDUnknownBlockType)arg2 error:(CDUnknownBlockType)arg3;
- (void)putToURL:(id)arg1 parameters:(id)arg2 encoding:(unsigned int)arg3 success:(CDUnknownBlockType)arg4 error:(CDUnknownBlockType)arg5;
- (void)postToURL:(id)arg1 parameters:(id)arg2 encoding:(unsigned int)arg3 success:(CDUnknownBlockType)arg4 error:(CDUnknownBlockType)arg5;
