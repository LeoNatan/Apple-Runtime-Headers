...
@interface DEDBugSession : NSObject <NSSecureCoding, DEDSecureArchiving>
{
    ...
    int _priorClientTransportType;
    int _priorWorkerTransportType;
...
@property int priorWorkerTransportType; // @synthesize priorWorkerTransportType=_priorWorkerTransportType;
...
- (void)willPerformOperationWithID:(id)arg1 type:(int)arg2 options:(id)arg3;
- (void)save;
...
- (void)cancelDiagnosticExtensionWithIdentifier:(id)arg1 invocationNumber:(int)arg2;
