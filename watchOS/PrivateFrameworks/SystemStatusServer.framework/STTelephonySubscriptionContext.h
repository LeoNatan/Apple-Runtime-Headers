...
@interface STTelephonySubscriptionContext : NSObject <BSDebugDescriptionProviding>
{
    ...
    unsigned int _modemDataConnectionType;
...
@property(nonatomic) unsigned int modemDataConnectionType; // @synthesize modemDataConnectionType=_modemDataConnectionType;
