...
@interface ISDataProvider : NSObject <NSCopying>
{
    ...
    unsigned int _authenticatedAccountCredentialSource;
...
@property unsigned int authenticatedAccountCredentialSource; // @synthesize authenticatedAccountCredentialSource=_authenticatedAccountCredentialSource;
