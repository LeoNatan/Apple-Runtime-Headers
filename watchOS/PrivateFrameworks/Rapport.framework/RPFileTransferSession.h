...
- (_Bool)_writeFD:(int)arg1 buffer:(const char *)arg2 size:(unsigned long)arg3 error:(id *)arg4;
- (_Bool)_readFD:(int)arg1 buffer:(char *)arg2 size:(unsigned long)arg3 error:(id *)arg4;
- (id)_readFD:(int)arg1 size:(unsigned long)arg2 error:(id *)arg3;
- (id)_readPath:(const char *)arg1 size:(unsigned long)arg2 error:(id *)arg3;
...
- (id)_ioQueueDequeue;
- (id)_decompressAndDecodeData:(id)arg1 originalSize:(unsigned long)arg2 error:(id *)arg3;
- (id)_encodeAndCompressObject:(id)arg1 originalSize:(unsigned int *)arg2 error:(id *)arg3;
- (id)_decompressData:(id)arg1 originalSize:(unsigned long)arg2 error:(id *)arg3;
