...
@interface PKSecureElementSignatureInfo : NSObject <NSCopying, NSSecureCoding>
{
    ...
    unsigned int _certificateVersion;
}

+ (_Bool)supportsSecureCoding;
- (void).cxx_destruct;
@property(readonly, nonatomic) unsigned int certificateVersion; // @synthesize certificateVersion=_certificateVersion;
...
- (id)initWithSecureElementCertificateSet:(id)arg1 sequenceCounter:(id)arg2 platformIdentifier:(id)arg3 certificateVersion:(unsigned int)arg4;
