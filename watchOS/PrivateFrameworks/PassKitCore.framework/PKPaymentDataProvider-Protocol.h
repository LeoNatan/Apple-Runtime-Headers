...
- (void)removeExpressPassesWithCardType:(int)arg1 visibleViewController:(id)arg2 completion:(void (^)(_Bool, NSSet *))arg3;
...
- (NSSet *)expressPassesInformationWithCardType:(int)arg1;
