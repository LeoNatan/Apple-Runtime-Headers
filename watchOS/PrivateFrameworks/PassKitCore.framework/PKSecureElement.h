...
@property(readonly, nonatomic) unsigned int hardwareVersion;
@property(readonly, nonatomic) unsigned int supportedTechnologies;
...
- (unsigned int)ownershipStateForUserUUID:(id)arg1;
...
- (void)signChallenge:(id)arg1 signatureEntanglementMode:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
