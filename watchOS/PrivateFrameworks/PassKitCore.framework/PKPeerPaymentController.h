...
+ (unsigned int)proposedResolutionForError:(id)arg1;
...
- (id)_defaultAlternateFundingSourceForMode:(unsigned int)arg1;
...
- (void)selectMode:(unsigned int)arg1;
...
- (void)_resetToState:(unsigned int)arg1;
- (void)reset;
- (_Bool)_ensureState:(unsigned int)arg1;
- (void)_setState:(unsigned int)arg1 notify:(_Bool)arg2;
- (void)dealloc;
