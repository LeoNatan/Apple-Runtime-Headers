...
- (void)updateDiscoveryEngagementMessageWithIdentifier:(NSString *)arg1 forAction:(int)arg2 completion:(void (^)(NSError *))arg3;
- (void)discoveryEngagementMessagesForPassUniqueIdentifier:(NSString *)arg1 active:(unsigned int)arg2 completion:(void (^)(NSArray *, NSError *))arg3;
...
- (void)updateDiscoveryItemWithIdentifier:(NSString *)arg1 forAction:(int)arg2 completion:(void (^)(NSError *))arg3;
