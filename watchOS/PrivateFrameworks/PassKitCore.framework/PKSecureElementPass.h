...
+ (id)displayableErrorForTransitAction:(id)arg1 andReason:(unsigned int)arg2;
...
- (unsigned int)transitCommutePlanType;
...
@property(readonly, nonatomic) int passActivationState;
...
- (_Bool)canPerformAction:(id)arg1 unableReason:(unsigned int *)arg2 displayableError:(id *)arg3;
