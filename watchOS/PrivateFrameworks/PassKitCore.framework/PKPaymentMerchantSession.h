...
@property(readonly, nonatomic) unsigned int expiresAt; // @synthesize expiresAt=_expiresAt;
@property(readonly, nonatomic) unsigned int epochTimestamp; // @synthesize epochTimestamp=_epochTimestamp;
- (id)signedData;
- (_Bool)_isModern;
...
- (id)initWithMerchantIdentifier:(id)arg1 merchantSessionIdentifier:(id)arg2 nonce:(id)arg3 epochTimestamp:(unsigned int)arg4 expiresAt:(unsigned int)arg5 displayName:(id)arg6 initiativeContext:(id)arg7 initiative:(id)arg8 ampEnrollmentPinning:(id)arg9 signedFields:(id)arg10 signature:(id)arg11;
- (id)initWithMerchantIdentifier:(id)arg1 merchantSessionIdentifier:(id)arg2 nonce:(id)arg3 epochTimestamp:(unsigned int)arg4 expiresAt:(unsigned int)arg5 displayName:(id)arg6 initiativeContext:(id)arg7 initiative:(id)arg8 signedFields:(id)arg9 signature:(id)arg10;
- (id)initWithMerchantIdentifier:(id)arg1 merchantSessionIdentifier:(id)arg2 nonce:(id)arg3 epochTimestamp:(unsigned int)arg4 expiresAt:(unsigned int)arg5 domain:(id)arg6 displayName:(id)arg7 signature:(id)arg8;
- (id)initWithMerchantIdentifier:(id)arg1 merchantSessionIdentifier:(id)arg2 nonce:(id)arg3 epochTimestamp:(unsigned int)arg4 domain:(id)arg5 displayName:(id)arg6 signature:(id)arg7;
- (id)init;
- (id)protobuf;
