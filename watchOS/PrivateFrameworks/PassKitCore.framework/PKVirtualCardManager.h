...
- (void)credentialsForVirtualCard:(id)arg1 authorization:(id)arg2 options:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
- (void)activeVirtualCardsWithOptions:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
- (id)init;
