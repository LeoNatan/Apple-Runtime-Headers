...
- (void)_queue_fetchAllRecordsUsingStoredChangeToken:(_Bool)arg1 changeToken:(id)arg2 shouldSaveToken:(_Bool)arg3 operationGroupName:(id)arg4 operationGroupNameSuffix:(id)arg5 qualityOfService:(int)arg6 batchHandler:(CDUnknownBlockType)arg7 completion:(CDUnknownBlockType)arg8;
...
- (id)zoneForCloudStoreItemType:(unsigned int)arg1;
- (id)cloudRecordObjectFromItemType:(unsigned int)arg1 records:(id)arg2;
