...
- (void)_retryContainerStateWithError:(id)arg1 retryCount:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)processResultWithError:(id)arg1 nextExpectedState:(unsigned int)arg2 retryCount:(unsigned int)arg3 shouldRetry:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)setContainerState:(unsigned int)arg1 retryCount:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)setContainerState:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
