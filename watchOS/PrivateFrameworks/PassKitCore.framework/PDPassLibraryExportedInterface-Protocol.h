...
- (void)canAddPassesOfType:(unsigned int)arg1 handler:(void (^)(_Bool))arg2;
...
- (void)getManifestHashAndSettingsForPassTypeID:(NSString *)arg1 serialNumber:(NSString *)arg2 handler:(void (^)(NSData *, unsigned int))arg3;
- (void)getPassesOfType:(unsigned int)arg1 handler:(void (^)(NSSet *))arg2;
- (void)getPassesWithHandler:(void (^)(NSSet *))arg1;
- (void)getPassesAndCatalogOfPassTypes:(unsigned int)arg1 limitResults:(_Bool)arg2 withHandler:(void (^)(NSSet *, PKCatalog *))arg3;
