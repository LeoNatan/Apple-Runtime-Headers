...
- (void)presentRegistrationFlowWithAccount:(PKPeerPaymentAccount *)arg1 amount:(PKCurrencyAmount *)arg2 state:(unsigned int)arg3 orientation:(NSNumber *)arg4 completion:(void (^)(_Bool))arg5;
