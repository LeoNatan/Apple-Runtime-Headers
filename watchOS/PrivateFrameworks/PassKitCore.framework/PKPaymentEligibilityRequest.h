...
@property(nonatomic) int expirationInputMethod; // @synthesize expirationInputMethod=_expirationInputMethod;
@property(nonatomic) int primaryAccountNumberInputMethod; // @synthesize primaryAccountNumberInputMethod=_primaryAccountNumberInputMethod;
@property(nonatomic) int cardholderNameInputMethod; // @synthesize cardholderNameInputMethod=_cardholderNameInputMethod;
