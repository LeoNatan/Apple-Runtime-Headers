...
+ (int)cleanupActionsForDeviceCredential:(id)arg1 withAssociatedPassCredential:(id)arg2;
+ (int)cleanupActionsForApplet:(id)arg1 withAssociatedPaymentApplication:(id)arg2;
- (void).cxx_destruct;
