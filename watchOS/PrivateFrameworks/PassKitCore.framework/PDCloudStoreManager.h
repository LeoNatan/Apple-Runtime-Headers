...
- (id)_parseRecords:(id)arg1 shouldUpdateLocalDatabase:(_Bool)arg2 updateReasons:(unsigned int)arg3;
...
- (void)_fetchCounterpartRecordsWithFetchedRecords:(id)arg1 zone:(id)arg2 shouldUpdateLocalDatabase:(_Bool)arg3 updateReasons:(unsigned int)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)_processResultWithError:(id)arg1 nextExpectedState:(unsigned int)arg2 retryCount:(unsigned int)arg3 shouldRetry:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
- (_Bool)_canSyncTransactionToCloudKit:(id)arg1;
- (void)_setContainerState:(unsigned int)arg1 retryCount:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_setContainerState:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
- (void)_setContainerState:(unsigned int)arg1;
- (_Bool)_ensureState:(unsigned int)arg1;
- (void)_detachFromContainerWithState:(unsigned int)arg1;
...
- (void)_fetchAndStoreChangesWithForceFetch:(_Bool)arg1 updateReasons:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)fetchAndStoreChangesWithForceFetch:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
- (id)insertOrUpdatePaymentTransaction:(id)arg1 withOriginDeviceID:(id)arg2 forPassUniqueIdentifier:(id)arg3 paymentApplication:(id)arg4 withInsertionMode:(unsigned int)arg5 performTruncation:(_Bool)arg6;
- (void)_fetchAndStoreChangesWithUpdateReasons:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
