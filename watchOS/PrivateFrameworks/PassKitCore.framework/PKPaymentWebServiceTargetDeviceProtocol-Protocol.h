...
- (PKWebServiceRegionFeature *)paymentWebService:(PKPaymentWebService *)arg1 supportedRegionFeatureOfType:(int)arg2;
- (void)paymentWebService:(PKPaymentWebService *)arg1 matchingInvitationOnDevice:(PKAppletSubcredentialSharingInvitation *)arg2 withTimeout:(unsigned int)arg3 completion:(void (^)(PKAppletSubcredentialSharingInvitation *, NSError *))arg4;
