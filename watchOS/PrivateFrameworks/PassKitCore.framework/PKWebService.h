...
- (unsigned int)webServiceTaskIdentifierForTaskIdentifier:(int)arg1;
- (void)performRequest:(id)arg1 taskIdentifier:(unsigned int)arg2 retries:(unsigned int)arg3 authHandling:(_Bool)arg4 completionHandler:(CDUnknownBlockType)arg5;
