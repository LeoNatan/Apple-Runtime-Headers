...
@property(nonatomic) unsigned int warrantyYears; // @synthesize warrantyYears=_warrantyYears;
...
- (id)_imageURLFromImageURLs:(id)arg1 forScale:(float)arg2 suffix:(id)arg3;
- (id)splashImageURLForScale:(float)arg1 suffix:(id)arg2;
- (id)iconURLForScale:(float)arg1 suffix:(id)arg2;
