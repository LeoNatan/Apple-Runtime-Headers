...
- (void)performVirtualCardAction:(int)arg1 forVirtualCardIdentifier:(NSString *)arg2 forAccountIdentifier:(NSString *)arg3 completion:(void (^)(PKVirtualCard *, PKAccount *, NSError *))arg4;
- (void)createVirtualCard:(int)arg1 forAccountIdentifier:(NSString *)arg2 completion:(void (^)(PKVirtualCard *, PKAccount *, NSError *))arg3;
...
- (void)activatePhysicalCardWithIdentifier:(NSString *)arg1 activationCode:(NSString *)arg2 completion:(void (^)(int))arg3;
- (void)inactivatePhysicalCardForFeatureIdentifier:(unsigned int)arg1 completion:(void (^)(PKPhysicalCard *))arg2;
...
- (void)defaultAccountForFeature:(unsigned int)arg1 completion:(void (^)(PKAccount *, NSError *))arg2;
