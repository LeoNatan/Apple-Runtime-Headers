...
- (PKCloudStoreZone *)cloudStoreZonesForCloudStoreItemType:(unsigned int)arg1 recordName:(NSString *)arg2;
- (NSSet *)cloudStoreZonesForCloudStoreItemType:(unsigned int)arg1;
