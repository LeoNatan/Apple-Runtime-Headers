...
@property(nonatomic) int inAppPriority; // @synthesize inAppPriority=_inAppPriority;
@property(nonatomic) int contactlessPriority; // @synthesize contactlessPriority=_contactlessPriority;
...
- (_Bool)supportsExpressForAutomaticPresentationTechnologyType:(int)arg1;
- (_Bool)supportsExpress;
- (_Bool)supportsWebPaymentMode:(int)arg1 withExclusionList:(id)arg2 clientOSVersion:(id)arg3;
- (_Bool)supportsWebPaymentMode:(int)arg1 withExclusionList:(id)arg2;
...
- (_Bool)acceptedForNonWebPaymentWithSupportedNetworkIdentifiers:(id)arg1 merchantCapabilities:(unsigned int)arg2 paymentMode:(int)arg3;
- (_Bool)acceptedForNonWebPaymentWithSupportedNetworkIdentifiers:(id)arg1 merchantCapabilities:(unsigned int)arg2 paymentMode:(int)arg3 paymentApplicationStates:(id)arg4;
- (_Bool)acceptedForWebPaymentWithSupportedNetworkIdentifiers:(id)arg1 merchantCapabilities:(unsigned int)arg2 paymentMode:(int)arg3 webService:(id)arg4;
- (_Bool)acceptedForWebPaymentWithSupportedNetworkIdentifiers:(id)arg1 merchantCapabilities:(unsigned int)arg2 paymentMode:(int)arg3 webService:(id)arg4 paymentApplicationStates:(id)arg5;
- (id)protobuf;
