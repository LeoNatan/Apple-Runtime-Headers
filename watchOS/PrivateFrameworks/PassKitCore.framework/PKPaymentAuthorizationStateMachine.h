...
@property(nonatomic) unsigned int prepareTransactionDetailsCounter; // @synthesize prepareTransactionDetailsCounter=_prepareTransactionDetailsCounter;
...
@property(nonatomic) unsigned int hostApplicationState; // @synthesize hostApplicationState=_hostApplicationState;
...
- (void)_processBluetoothState:(int)arg1;
...
- (void)_processErrorsForDataType:(int)arg1;
