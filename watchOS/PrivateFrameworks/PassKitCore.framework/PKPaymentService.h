...
- (void)transactionCountByYearForPassWithUniqueIdentifier:(id)arg1 withTransactionSource:(unsigned int)arg2 withBackingData:(unsigned int)arg3 calendar:(id)arg4 completion:(CDUnknownBlockType)arg5;
