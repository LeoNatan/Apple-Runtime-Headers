...
- (void)hasPassesWithSupportedNetworks:(NSSet *)arg1 merchantCapabilities:(unsigned int)arg2 webDomain:(NSString *)arg3 completion:(void (^)(_Bool))arg4;
- (void)canPresentPaymentRequest:(PKPaymentRequest *)arg1 completion:(void (^)(int, NSString *, NSError *))arg2;
...
- (void)inAppPaymentPassesForNetworks:(NSSet *)arg1 capabilities:(unsigned int)arg2 issuerCountryCodes:(NSSet *)arg3 withHandler:(void (^)(NSSet *))arg4;
- (void)hasInAppPaymentPassesForNetworks:(NSSet *)arg1 capabilities:(unsigned int)arg2 issuerCountryCodes:(NSSet *)arg3 withHandler:(void (^)(_Bool))arg4;
@end
