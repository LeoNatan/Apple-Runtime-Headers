...
- (void)_downloadRemoteAssetsWithScreenScale:(float)arg1 suffix:(id)arg2 cloudStoreCoordinatorDelegate:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (id)pendingRemoteAssetsItemsForScreenScale:(float)arg1 suffix:(id)arg2;
