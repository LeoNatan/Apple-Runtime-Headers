...
- (_Bool)_shouldNotifyForParter:(id)arg1;
...
- (void)_fetchImageSetForUniqueID:(id)arg1 ofType:(int)arg2 displayProfile:(id)arg3 usingSynchronousProxy:(_Bool)arg4 withCompletion:(CDUnknownBlockType)arg5;
- (void)_fetchImageSetContainerForUniqueID:(id)arg1 ofType:(int)arg2 displayProfile:(id)arg3 usingSynchronousProxy:(_Bool)arg4 withCompletion:(CDUnknownBlockType)arg5;
