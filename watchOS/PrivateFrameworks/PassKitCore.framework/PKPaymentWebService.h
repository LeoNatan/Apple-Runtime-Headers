...
- (unsigned int)serviceProviderPurchasesWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (unsigned int)performNotifificationActionRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;
