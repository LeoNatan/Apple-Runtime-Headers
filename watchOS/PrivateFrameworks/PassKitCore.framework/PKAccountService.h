...
- (void)scheduledPaymentsWithAccountIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)activatePhysicalCard:(id)arg1 withActivationCode:(id)arg2 forFeatureIdentifier:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
- (void)inactivePhysicalCardForFeatureIdentifier:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)performVirtualCardAction:(int)arg1 forVirtualCardIdentifier:(id)arg2 forAccountIdentifier:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)createVirtualCard:(int)arg1 forAccountIdentifier:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)eventsForAccountIdentifier:(id)arg1 types:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 orderedByDate:(int)arg5 limit:(unsigned int)arg6 completion:(CDUnknownBlockType)arg7;
...
- (void)defaultAccountForFeature:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
