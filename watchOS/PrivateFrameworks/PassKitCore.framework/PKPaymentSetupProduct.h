...
+ (void)_updateProduct:(id)arg1 withDebugConfigurationForState:(unsigned int)arg2;
...
@property(nonatomic) int hsa2Requirement; // @synthesize hsa2Requirement=_hsa2Requirement;
