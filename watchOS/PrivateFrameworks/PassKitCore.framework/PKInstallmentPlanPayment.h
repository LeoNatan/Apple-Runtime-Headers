...
@interface PKInstallmentPlanPayment : NSObject <NSSecureCoding, NSCopying>
{
    ...
    NSDate *_dueDate;
    NSArray *_lineItems;
    unsigned int _paymentNumber;
    unsigned int _paymentCount;
...
@property(nonatomic) unsigned int paymentCount; // @synthesize paymentCount=_paymentCount;
@property(nonatomic) unsigned int paymentNumber; // @synthesize paymentNumber=_paymentNumber;
