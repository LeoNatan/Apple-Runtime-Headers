...
- (id)_concreteTransactionForRecordAtIndex:(unsigned int)arg1 withBalance:(unsigned int *)arg2 historyRecords:(id)arg3 terminalState:(id)arg4 numberProcessed:(unsigned int *)arg5 exitedShinkansen:(_Bool *)arg6;
