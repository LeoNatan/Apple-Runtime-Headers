...
@interface PKBillPaymentSelectedSuggestedAmountData : NSObject <NSSecureCoding, PKRecordObject>
{
    ...
    unsigned int _suggestedAmountCategory;
...
@property(nonatomic) unsigned int suggestedAmountCategory; // @synthesize suggestedAmountCategory=_suggestedAmountCategory;
...
- (id)initWithStatementIdentifier:(id)arg1 transactionDate:(id)arg2 transactionAmount:(id)arg3 suggestedAmountCategory:(unsigned int)arg4;
