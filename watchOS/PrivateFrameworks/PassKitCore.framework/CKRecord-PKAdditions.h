...
- (unsigned int)pk_unsignedIntegerForKey:(id)arg1;
- (unsigned long long)pk_uint64ForKey:(id)arg1;
- (int)pk_intForKey:(id)arg1;
- (int)pk_integerForKey:(id)arg1;
...
- (unsigned int)pk_encryptedUnsignedIntegerForKey:(id)arg1;
- (unsigned long long)pk_encryptedUint64ForKey:(id)arg1;
- (int)pk_encryptedIntForKey:(id)arg1;
- (int)pk_encryptedIntegerForKey:(id)arg1;
