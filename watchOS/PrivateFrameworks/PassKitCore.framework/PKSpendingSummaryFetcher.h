...
+ (id)summaryWithTransactions:(id)arg1 currency:(id)arg2 type:(unsigned int)arg3 startDate:(id)arg4 endDate:(id)arg5 lastSummary:(id)arg6;
- (void).cxx_destruct;
...
- (void)_spendingSummaryStartingWithDate:(id)arg1 endDate:(id)arg2 type:(unsigned int)arg3 withLastPeriodChange:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
- (void)_processNextRequest;
- (void)spendingSummaryStartingWithDate:(id)arg1 type:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (id)_cachedSpendingSummaryStartingWithDate:(id)arg1 type:(unsigned int)arg2 withLastPeriodChange:(_Bool)arg3;
- (id)cachedSpendingSummaryStartingWithDate:(id)arg1 type:(unsigned int)arg2;
