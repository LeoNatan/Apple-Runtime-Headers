...
@property(nonatomic) unsigned int balanceStatus; // @synthesize balanceStatus=_balanceStatus;
@property(nonatomic) int cyclesPastDue; // @synthesize cyclesPastDue=_cyclesPastDue;
