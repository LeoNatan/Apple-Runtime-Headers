...
+ (id)operationForState:(int)arg1 configuration:(id)arg2 context:(id)arg3 delegate:(id)arg4;
- (void).cxx_destruct;
...
- (void)failWithErrorCode:(int)arg1 description:(id)arg2 underlyingError:(id)arg3;
- (void)failWithErrorCode:(int)arg1 description:(id)arg2;
- (void)failWithError:(id)arg1;
- (void)advanceToState:(int)arg1;
