...
@interface HKClinicalSourceAuthorizationController : NSObject
{
    ...
    NSError *_fetchError;
    int _authorizationModeForSource;
...
@property(nonatomic) int authorizationModeForSource; // @synthesize authorizationModeForSource=_authorizationModeForSource;
...
- (_Bool)_shouldUpdateDisplayReadAuthorizationAnchorDateWhenCommittingWithMode:(int)arg1;
- (void)commitAllTypesAndUpdateAuthorizationAnchorWithMode:(int)arg1;
