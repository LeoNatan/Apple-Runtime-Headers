...
+ (float)_graphBottomToCardBottom;
+ (float)_graphHeight;
+ (float)_averageHeartRateBaselineToGraphTop;
+ (float)_averageHeartRateBaselineToSymptomBaseline;
+ (float)_headerBottomToAverageHeartRateBaseline;
