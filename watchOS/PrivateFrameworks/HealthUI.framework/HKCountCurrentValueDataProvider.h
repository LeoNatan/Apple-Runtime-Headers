...
@property(readonly, nonatomic) int countStyle; // @synthesize countStyle=_countStyle;
...
- (id)currentValue;
- (id)initWithHealthStore:(id)arg1 updateController:(id)arg2 dateCache:(id)arg3 displayType:(id)arg4 countStyle:(int)arg5;
