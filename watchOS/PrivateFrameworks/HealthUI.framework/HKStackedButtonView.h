...
+ (float)_footerTextSpacingForValue:(float)arg1;
+ (id)_footerTextBoldFont;
+ (id)_footerTextFont;
+ (id)_footerFontTextStyle;
+ (id)buddyStackedButtonViewWithTitles:(id)arg1 footerText:(id)arg2 boldFooterText:(id)arg3 footerTextAlignment:(int)arg4 delegate:(id)arg5;
...
@property(nonatomic) int footerTextAlignment; // @synthesize footerTextAlignment=_footerTextAlignment;
...
- (id)initWithButtonTitles:(id)arg1 styles:(id)arg2 footerText:(id)arg3 boldFooterText:(id)arg4 footerTextAlignment:(int)arg5 delegate:(id)arg6;
