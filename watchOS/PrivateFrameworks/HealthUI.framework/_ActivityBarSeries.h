...
@interface _ActivityBarSeries : HKBarSeries
{
    ...
    int _activityDisplayTypeIdentifier;
...
@property(nonatomic) int activityDisplayTypeIdentifier; // @synthesize activityDisplayTypeIdentifier=_activityDisplayTypeIdentifier;
