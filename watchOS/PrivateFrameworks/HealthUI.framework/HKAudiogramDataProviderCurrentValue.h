...
- (id)_localizedAverageSensitivity:(id)arg1 ear:(int)arg2 displayType:(id)arg3 unitController:(id)arg4 shortened:(_Bool)arg5;
...
- (id)initWithDiagnosticCategory:(unsigned int)arg1 leftAverageEarSensitivity:(id)arg2 rightAverageEarSensitivity:(id)arg3 minimumSensitivity:(id)arg4 maximumSensitivity:(id)arg5 date:(id)arg6;
