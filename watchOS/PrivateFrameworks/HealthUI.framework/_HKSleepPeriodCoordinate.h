...
- (id)initWithXValue:(float)arg1 asleepYValues:(id)arg2 inBedYValues:(id)arg3 yValues:(id)arg4 upperGoalYValue:(id)arg5 lowerGoalYValue:(id)arg6 highlighted:(_Bool)arg7 userInfo:(id)arg8;
