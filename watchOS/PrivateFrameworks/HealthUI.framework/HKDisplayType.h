...
@property(readonly, nonatomic) unsigned int statisticsMergeStrategy; // @synthesize statisticsMergeStrategy=_statisticsMergeStrategy;
...
- (unsigned int)hash;
@property(readonly, nonatomic) unsigned int roundingMode;
...
- (id)hk_numberFormatterForUnit:(id)arg1 formattingContext:(int)arg2;
...
- (id)_dataSourceForWorkoutsWithTimeScope:(int)arg1 healthStore:(id)arg2;
- (id)_singleCenteredLineDataSourceForCategoryType:(id)arg1 timeScope:(int)arg2 healthStore:(id)arg3 displayTypeIdentifier:(int)arg4;
- (id)_levelCategoryValuesDataSourceForCategoryType:(id)arg1 timeScope:(int)arg2 healthStore:(id)arg3 displayIdentifier:(int)arg4;
- (id)_stackedDataSourceForCategoryType:(id)arg1 timeScope:(int)arg2 healthStore:(id)arg3;
- (id)_timePeriodDisplayPrefix;
- (id)_dailySleepSeriesDataSourceForSampleType:(id)arg1 timeScope:(int)arg2 healthStore:(id)arg3;
- (id)_timePeriodDataSourceForSampleType:(id)arg1 timeScope:(int)arg2 healthStore:(id)arg3;
- (CDUnknownBlockType)_singleValueUserInfoBlockWithUnitController:(id)arg1 displayType:(id)arg2 statisticsOption:(unsigned int)arg3;
...
- (id)hk_standardSeriesForTimeScope:(int)arg1 displayCategory:(id)arg2 unitController:(id)arg3 dataCacheController:(id)arg4 displayCategoryController:(id)arg5;
- (id)_generateGraphSeriesForTimeScope:(int)arg1 displayCategory:(id)arg2;
- (id)_generateDistributionSeriesWithColor:(id)arg1;
- (id)_generateLevelCategorySeriesWithColor:(id)arg1;
- (id)_generateSingleLineSeriesWithColor:(id)arg1 timeScope:(int)arg2;
- (id)_generateStackedSeriesWithColor:(id)arg1;
- (id)_generateScatterPlotSeriesWithColor:(id)arg1;
- (id)_generateLineSeriesWithColor:(id)arg1 timeScope:(int)arg2;
...
- (id)_dataSourceForTimeScope:(int)arg1 dataCacheController:(id)arg2;
...
- (unsigned int)hk_chartCalendarUnitForTimeScope:(int)arg1;
