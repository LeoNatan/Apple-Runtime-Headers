...
@property(nonatomic) float lineSpacingPercentage; // @synthesize lineSpacingPercentage=_lineSpacingPercentage;
...
- (float)yCoordinateForLevel:(id)arg1 axisRect:(struct CGRect)arg2;
