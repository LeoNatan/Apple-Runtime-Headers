...
- (void)_renderPointLabelInContext:(struct CGContext *)arg1 renderingData:(CDStruct_2660488d)arg2 numberFormatter:(id)arg3 labelAttributes:(id)arg4;
...
- (void)_addAxisAnnotationForValue:(float)arg1;
...
- (void)_enumerateCoordinateList:(id)arg1 withTransform:(struct CGAffineTransform)arg2 weightedAverageWidth:(float)arg3 block:(CDUnknownBlockType)arg4;
