...
- (void)setNeedsRender;
- (struct CGSize)drawText:(NSString *)arg1 atPoint:(struct CGPoint)arg2 spaceAvailable:(NSNumber *)arg3 horizontalAlignment:(int)arg4 verticalAlignment:(int)arg5 textColor:(UIColor *)arg6 font:(UIFont *)arg7 clipToAxis:(_Bool)arg8 exclusion:(id <HKGraphRendererExclusion>)arg9;
