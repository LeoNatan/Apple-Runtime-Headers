...
+ (_Bool)_isNumericStringValid:(id)arg1 withLength:(int)arg2;
...
- (_Bool)isFieldValid:(int)arg1;
- (unsigned int)_placeHolderTypeForField:(int)arg1;
- (id)dataEntryItemForRegistrantField:(int)arg1;
- (void)_addDataEntryItemIntoArray:(id)arg1 validOnly:(_Bool)arg2 forField:(int)arg3;
