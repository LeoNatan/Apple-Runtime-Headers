...
@property(readonly, nonatomic) int dayOfMonth; // @synthesize dayOfMonth=_dayOfMonth;
@property(readonly, copy, nonatomic) NSDate *date; // @synthesize date=_date;
@property(nonatomic) float dayDiameter; // @synthesize dayDiameter=_dayDiameter;
...
- (float)_roundedRectCornerRadius;
- (void)layoutOnce;
