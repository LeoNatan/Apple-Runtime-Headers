...
@property(nonatomic) float minimumGraphViewHeight; // @synthesize minimumGraphViewHeight=_minimumGraphViewHeight;
...
- (void)viewDidLoad;
- (id)initWithHealthStore:(id)arg1 dataSource:(id)arg2 dataFormatter:(id)arg3 minimumGraphViewHeight:(float)arg4;
