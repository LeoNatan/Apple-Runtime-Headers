...
- (id)initWithDataSourceValue:(id)arg1 options:(unsigned int)arg2 unit:(id)arg3 displayType:(id)arg4;
- (id)initWithStatistics:(id)arg1 options:(unsigned int)arg2 unit:(id)arg3 displayType:(id)arg4;
