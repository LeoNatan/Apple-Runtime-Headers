...
- (id)filesystemPathForAssetDataRelativePath:(id)arg1 assetVersion:(unsigned int *)arg2;
- (id)filesystemPathsForAssetDataRelativePaths:(id)arg1;
- (id)filesystemPathsForAssetDataRelativePaths:(id)arg1 assetVersion:(unsigned int *)arg2;
- (id)_defaultBundleFilesystemPathsForAssetDataRelativePaths:(id)arg1 guardedData:(id)arg2 assetVersion:(unsigned int *)arg3;
- (id)_maFilesystemPathsForAssetDataRelativePaths:(id)arg1 guardedData:(id)arg2 isMissingData:(_Bool *)arg3 assetVersion:(unsigned int *)arg4;
...
- (void)dealloc;
- (id)init;
- (id)_initWithAssetTypeIdentifier:(id)arg1 defaultBundlePath:(id)arg2 compatibilityVersion:(unsigned int)arg3 matchingKeysAndValues:(id)arg4 notificationQueue:(id)arg5 logHandle:(id)arg6 enableAssetUpdates:(_Bool)arg7 purgeObsoleteInstalledAssets:(_Bool)arg8;
