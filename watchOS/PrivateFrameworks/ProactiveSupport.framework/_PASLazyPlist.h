...
{
    NSData *_backingData;
    CDStruct_fd2ef869 _mappedRegion;
...
+ (_Bool)isLazyPlistLikelyContainedInFileAtPath:(id)arg1 version:(unsigned int *)arg2;
+ (_Bool)isLazyPlistLikelyContainedInData:(id)arg1 version:(unsigned int *)arg2;
...
- (_Bool)_validateObjectGraphWithFilename:(id)arg1 rootValue:(CDStruct_c0454aff)arg2 recursionDepth:(unsigned int)arg3 stats:(struct _PASLPObjectGraphStats *)arg4 error:(id *)arg5;
...
@property(readonly, nonatomic) const CDStruct_fd2ef869 *mappedRegion;
- (id)init;
