...
+ (id)newMutableDataInZone:(struct _NSZone *)arg1 length:(unsigned int)arg2;
+ (id)newMutableDataInZone:(struct _NSZone *)arg1 capacity:(unsigned int)arg2;
...
+ (id)newMutableStringInZone:(struct _NSZone *)arg1 capacity:(unsigned int)arg2;
...
+ (id)newMutableSetInZone:(struct _NSZone *)arg1 capacity:(unsigned int)arg2;
...
+ (id)newMutableDictionaryInZone:(struct _NSZone *)arg1 capacity:(unsigned int)arg2;
...
+ (id)newMutableArrayInZone:(struct _NSZone *)arg1 capacity:(unsigned int)arg2;
