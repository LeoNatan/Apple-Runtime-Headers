...
+ (void)_writePlist:(id)arg1 allDictionaryKeys:(id)arg2 toBuffer:(void *)arg3 size:(unsigned long)arg4 actSize:(unsigned int *)arg5;
+ (unsigned int)_valueWordForObjectGraph:(id)arg1 allocContext:(CDStruct_4a2af2ac *)arg2 recursionDepth:(unsigned int)arg3;
+ (_Bool)_scanPlist:(id)arg1 recursionDepth:(unsigned int)arg2 sizeUpperBound:(unsigned int *)arg3 allDictionaryKeys:(id)arg4 error:(id *)arg5;
