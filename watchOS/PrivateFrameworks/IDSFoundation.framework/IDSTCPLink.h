...
- (void)processIncomingPacket:(CDStruct_05c4e9ef *)arg1;
...
- (struct IDSTCPConnection_ *)_getIDSTCPConnection:(CDStruct_05c4e9ef *)arg1;
- (long)getPacketLength:(CDStruct_05c4e9ef *)arg1 isChannelData:(_Bool *)arg2;
