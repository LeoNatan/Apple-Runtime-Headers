...
@interface IDSGroupSessionParticipantUpdate : NSObject
{
    ...
    unsigned int _participantUpdateType;
    unsigned int _participantUpdateSubtype;
    _Bool _fromServer;
    NSDate *_serverDate;
...
@property(readonly, nonatomic) unsigned int participantUpdateSubtype; // @synthesize participantUpdateSubtype=_participantUpdateSubtype;
...
@property(readonly, nonatomic) unsigned int participantUpdateType; // @synthesize participantUpdateType=_participantUpdateType;
...
- (id)initWithGroupUUID:(id)arg1 isInitiator:(_Bool)arg2 participantIdentifier:(unsigned int)arg3 participantDestinationID:(id)arg4 participantUpdateType:(unsigned int)arg5 participantUpdateSubtype:(unsigned int)arg6 fromServer:(_Bool)arg7 serverDate:(id)arg8 participantData:(id)arg9 clientContextData:(id)arg10 members:(id)arg11 participantIDs:(id)arg12 relaySessionID:(id)arg13;
