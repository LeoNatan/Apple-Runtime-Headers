...
+ (int)_endpointStateForServerDeliveryStatus:(id)arg1;
- (void).cxx_destruct;
...
@property(nonatomic) int idsResponseCode; // @synthesize idsResponseCode=_idsResponseCode;
...
- (id)initWithResponseCode:(int)arg1 deviceID:(id)arg2 currentAverageRTT:(id)arg3 isDeviceBlackedOut:(id)arg4 localMessageState:(id)arg5;
- (id)initWithResponseCode:(int)arg1 deviceID:(id)arg2;
- (id)initWithResponseCode:(int)arg1 error:(id)arg2 lastCall:(_Bool)arg3;
