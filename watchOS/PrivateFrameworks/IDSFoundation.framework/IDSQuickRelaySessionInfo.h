...
@property(readonly) int linkProtocol; // @synthesize linkProtocol=_linkProtocol;
...
@property(readonly) int relayServerProviderType; // @synthesize relayServerProviderType=_relayServerProviderType;
...
@property(readonly) int allocateType; // @synthesize allocateType=_allocateType;
- (int)parseSessionInfo:(id)arg1;
