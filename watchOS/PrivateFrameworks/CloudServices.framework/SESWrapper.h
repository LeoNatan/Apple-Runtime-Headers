...
-     // Error parsing type: @20@0:4@8^{__SecKey={__CFRuntimeBase=IAI}^{__SecKeyDescriptor}^v}12^{ccrsa_full_ctx=II^{cczp_funcs}[0I]}16, name: srpResponseForEscrowBlob:withKey:withFullCCKey:
- (id)decodedEscrowRecordFromData:(id)arg1;
-     // Error parsing type: @16@0:4^{__SecKey={__CFRuntimeBase=IAI}^{__SecKeyDescriptor}^v}8^@12, name: encodedEscrowRecordWithPublicKey:error:
- (id)srpRecoveryBlobFromData:(id)arg1 error:(id *)arg2;
- (void)srpRecoveryUpdateDSID:(id)arg1 recoveryPassphrase:(id)arg2;
- (unsigned long)srpPublicKeySize;
- (unsigned long)srpKeySize;
- (id)srpInitBlob;
