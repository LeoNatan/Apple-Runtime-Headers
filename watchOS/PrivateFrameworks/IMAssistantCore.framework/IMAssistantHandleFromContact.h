...
- (void).cxx_destruct;
@property(readonly, nonatomic) int handleType; // @synthesize handleType=_handleType;
...
@property(readonly, nonatomic) int personHandleType;
...
- (id)_initWithPhoneNumber:(id)arg1 emailAddress:(id)arg2 businessID:(id)arg3 handleType:(int)arg4 contact:(id)arg5;
