...
- (id)sendMessageWithText:(id)arg1 currentLocation:(_Bool)arg2 expressiveSendStyleID:(id)arg3 idsIdentifier:(id)arg4 executionContext:(int)arg5 toChat:(id)arg6;
