...
#import "SCKDatabaseStoreCoordinatorObserver.h"

@class NSArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, SCKAsyncSerialQueue, SCKDatabaseSchema, SCKStartupQueue;
...
- (void)_enqueueStartupSequenceWithFeatures:(int)arg1;
...
- (id)initWithSchema:(id)arg1 store:(id)arg2 migrationPlan:(id)arg3 features:(int)arg4 containerProxy:(id)arg5;
- (id)initWithSchema:(id)arg1 store:(id)arg2 migrationPlan:(id)arg3 containerProxy:(id)arg4;
- (id)initWithSchema:(id)arg1 store:(id)arg2 features:(int)arg3 mergeHandlers:(id)arg4 containerProxy:(id)arg5;
- (id)initWithSchema:(id)arg1 store:(id)arg2 features:(int)arg3 containerProxy:(id)arg4;
