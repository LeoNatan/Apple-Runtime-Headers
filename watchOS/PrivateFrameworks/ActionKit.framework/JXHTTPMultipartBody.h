...
{
    unsigned int _streamBufferLength;
...
@property(nonatomic) unsigned int streamBufferLength; // @synthesize streamBufferLength=_streamBufferLength;
...
- (unsigned int)loadMutableData:(id)arg1 withDataInRange:(struct _NSRange)arg2;
