...
- (void)_logWithSender:(void *)arg1 connectionType:(int)arg2 data:(id)arg3;
- (id)quotaOperation;
...
- (id)searchOperationWithFolder:(id)arg1 kind:(int)arg2 searchString:(id)arg3;
- (id)storeLabelsOperationWithFolder:(id)arg1 numbers:(id)arg2 kind:(int)arg3 labels:(id)arg4;
- (id)storeLabelsOperationWithFolder:(id)arg1 uids:(id)arg2 kind:(int)arg3 labels:(id)arg4;
- (id)storeFlagsOperationWithFolder:(id)arg1 numbers:(id)arg2 kind:(int)arg3 flags:(int)arg4 customFlags:(id)arg5;
- (id)storeFlagsOperationWithFolder:(id)arg1 numbers:(id)arg2 kind:(int)arg3 flags:(int)arg4;
...
- (id)fetchMessageAttachmentToFileOperationWithFolder:(id)arg1 uid:(unsigned int)arg2 partID:(id)arg3 encoding:(int)arg4 filename:(id)arg5 urgent:(_Bool)arg6;
- (id)fetchMessageAttachmentOperationWithFolder:(id)arg1 number:(unsigned int)arg2 partID:(id)arg3 encoding:(int)arg4;
- (id)fetchMessageAttachmentOperationWithFolder:(id)arg1 number:(unsigned int)arg2 partID:(id)arg3 encoding:(int)arg4 urgent:(_Bool)arg5;
- (id)fetchMessageAttachmentOperationWithFolder:(id)arg1 uid:(unsigned int)arg2 partID:(id)arg3 encoding:(int)arg4;
- (id)customCommandOperation:(id)arg1;
- (id)fetchMessageAttachmentOperationWithFolder:(id)arg1 uid:(unsigned int)arg2 partID:(id)arg3 encoding:(int)arg4 urgent:(_Bool)arg5;
- (id)fetchMessageAttachmentByUIDOperationWithFolder:(id)arg1 uid:(unsigned int)arg2 partID:(id)arg3 encoding:(int)arg4;
- (id)fetchMessageAttachmentByUIDOperationWithFolder:(id)arg1 uid:(unsigned int)arg2 partID:(id)arg3 encoding:(int)arg4 urgent:(_Bool)arg5;
...
- (id)syncMessagesWithFolder:(id)arg1 requestKind:(int)arg2 uids:(id)arg3 modSeq:(unsigned long long)arg4;
- (id)syncMessagesByUIDWithFolder:(id)arg1 requestKind:(int)arg2 uids:(id)arg3 modSeq:(unsigned long long)arg4;
- (id)fetchMessagesByNumberOperationWithFolder:(id)arg1 requestKind:(int)arg2 numbers:(id)arg3;
- (id)fetchMessagesOperationWithFolder:(id)arg1 requestKind:(int)arg2 uids:(id)arg3;
- (id)fetchMessagesByUIDOperationWithFolder:(id)arg1 requestKind:(int)arg2 uids:(id)arg3;
...
- (id)appendMessageOperationWithFolder:(id)arg1 contentsAtPath:(id)arg2 flags:(int)arg3 customFlags:(id)arg4;
- (id)appendMessageOperationWithFolder:(id)arg1 messageData:(id)arg2 flags:(int)arg3 customFlags:(id)arg4;
- (id)appendMessageOperationWithFolder:(id)arg1 messageData:(id)arg2 flags:(int)arg3;
...
@property(readonly, nonatomic, getter=isIdleEnabled) _Bool idleEnabled;
