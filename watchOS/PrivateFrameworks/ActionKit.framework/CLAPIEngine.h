...
- (int)requestTypeForConnectionIdentifier:(id)arg1;
...
- (id)getItemListStartingAtPage:(int)arg1 ofType:(int)arg2 itemsPerPage:(int)arg3 showOnlyItemsInTrash:(_Bool)arg4 userInfo:(id)arg5;
- (id)getItemListStartingAtPage:(int)arg1 ofType:(int)arg2 itemsPerPage:(int)arg3 userInfo:(id)arg4;
- (id)getItemListStartingAtPage:(int)arg1 itemsPerPage:(int)arg2 userInfo:(id)arg3;
