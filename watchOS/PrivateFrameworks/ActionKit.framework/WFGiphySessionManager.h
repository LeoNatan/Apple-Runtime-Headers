...
- (void)search:(id)arg1 limit:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)trendingWithLimit:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
