...
- (void)findNotesMetadataInternalWithFilter:(id)arg1 offset:(int)arg2 resultSpec:(id)arg3 maxResults:(unsigned int)arg4 results:(id)arg5 success:(CDUnknownBlockType)arg6 failure:(CDUnknownBlockType)arg7;
- (void)findNotesMetadataWithFilter:(id)arg1 maxResults:(unsigned int)arg2 resultSpec:(id)arg3 success:(CDUnknownBlockType)arg4 failure:(CDUnknownBlockType)arg5;
...
- (void)fetchResourceByHashWithGuid:(id)arg1 contentHash:(id)arg2 options:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)fetchResourceWithGuid:(id)arg1 options:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)fetchNoteVersionWithGuid:(id)arg1 updateSequenceNum:(int)arg2 resourceOptions:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)fetchNoteWithGuid:(id)arg1 includingContent:(_Bool)arg2 resourceOptions:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
