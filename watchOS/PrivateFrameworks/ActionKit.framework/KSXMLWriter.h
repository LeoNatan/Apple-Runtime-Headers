...
@property(nonatomic) int indentationLevel; // @synthesize indentationLevel=_indentation;
...
- (void)startDocumentWithDocType:(id)arg1 encoding:(unsigned int)arg2;
- (void)flush;
- (void)close;
- (id)initWithOutputWriter:(id)arg1 encoding:(unsigned int)arg2;
