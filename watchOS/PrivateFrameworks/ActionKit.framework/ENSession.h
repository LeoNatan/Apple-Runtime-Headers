...
- (void)downloadThumbnailForNote:(id)arg1 maxDimension:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)findNotesWithSearch:(id)arg1 inNotebook:(id)arg2 orScope:(unsigned int)arg3 sortOrder:(unsigned int)arg4 maxResults:(unsigned int)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)uploadNote:(id)arg1 policy:(int)arg2 toNotebook:(id)arg3 orReplaceNote:(id)arg4 progress:(CDUnknownBlockType)arg5 completion:(CDUnknownBlockType)arg6;
