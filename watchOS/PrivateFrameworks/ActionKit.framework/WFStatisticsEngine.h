...
- (void)applyOperation:(int)arg1 onStatisticsSampleProviders:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)applyOperation:(int)arg1 onNumbers:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (id)init;
