...
- (void)engine:(IKEngine *)arg1 connection:(IKURLConnection *)arg2 didDeleteFolderWithFolderID:(int)arg3;
...
- (void)engine:(IKEngine *)arg1 connection:(IKURLConnection *)arg2 didReceiveText:(NSString *)arg3 ofBookmarkWithBookmarkID:(int)arg4;
- (void)engine:(IKEngine *)arg1 connection:(IKURLConnection *)arg2 didMoveBookmark:(IKBookmark *)arg3 toFolderWithFolderID:(int)arg4;
...
- (void)engine:(IKEngine *)arg1 connection:(IKURLConnection *)arg2 didDeleteBookmarkWithBookmarkID:(int)arg3;
