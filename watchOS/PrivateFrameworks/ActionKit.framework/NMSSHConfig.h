...
- (struct _NSRange)rangeInString:(id)arg1 fromLocationUntilBlankOrEnd:(unsigned int)arg2;
- (struct _NSRange)rangeOfQuotedSubstringInString:(id)arg1 startingAtIndex:(unsigned int)arg2;
