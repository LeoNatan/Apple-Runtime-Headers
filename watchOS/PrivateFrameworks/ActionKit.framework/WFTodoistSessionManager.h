...
- (void)createItemInProject:(id)arg1 content:(id)arg2 dueDateString:(id)arg3 reminderDateString:(id)arg4 reminderService:(int)arg5 priority:(int)arg6 note:(id)arg7 completionHandler:(CDUnknownBlockType)arg8;
- (void)createFileOnItemWithId:(int)arg1 withFile:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
