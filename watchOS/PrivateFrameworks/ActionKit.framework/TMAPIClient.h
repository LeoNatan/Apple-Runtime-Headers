...
- (void)avatar:(id)arg1 size:(unsigned int)arg2 queue:(id)arg3 callback:(CDUnknownBlockType)arg4;
- (void)avatar:(id)arg1 size:(unsigned int)arg2 callback:(CDUnknownBlockType)arg3;
