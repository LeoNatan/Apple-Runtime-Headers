...
- (void)enumerateElementsWithCSS:(NSString *)arg1 usingBlock:(void (^)(ONOXMLElement *, unsigned int, _Bool *))arg2;
...
- (void)enumerateElementsWithXPath:(NSString *)arg1 usingBlock:(void (^)(ONOXMLElement *, unsigned int, _Bool *))arg2;
