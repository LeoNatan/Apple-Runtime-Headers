...
+ (id)connectToHost:(id)arg1 port:(int)arg2 withUsername:(id)arg3;
- (void).cxx_destruct;
...
@property(nonatomic) int fingerprintHash; // @synthesize fingerprintHash=_fingerprintHash;
...
- (_Bool)addKnownHostName:(id)arg1 port:(int)arg2 toFile:(id)arg3 withSalt:(id)arg4;
- (int)knownHostStatusWithFile:(id)arg1;
- (int)knownHostStatusInFiles:(id)arg1;
- (id)userKnownHostsFileName;
- (id)applicationSupportDirectory;
- (id)fingerprint:(int)arg1;
...
- (id)initWithHost:(id)arg1 configs:(id)arg2 withDefaultPort:(int)arg3 defaultUsername:(id)arg4;
- (id)initWithHost:(id)arg1 port:(int)arg2 andUsername:(id)arg3;
