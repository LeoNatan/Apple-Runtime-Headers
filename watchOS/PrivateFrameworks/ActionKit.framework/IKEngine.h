...
- (id)updateReadProgressOfBookmark:(id)arg1 toProgress:(float)arg2 userInfo:(id)arg3;
- (id)bookmarksInFolder:(id)arg1 limit:(unsigned int)arg2 existingBookmarks:(id)arg3 userInfo:(id)arg4;
