...
- (_Bool)_beginPrintModeWithMinimumPageWidth:(float)arg1 height:(float)arg2 maximumPageWidth:(float)arg3;
...
- (_Bool)_findString:(id)arg1 options:(unsigned int)arg2;
- (id)rectsForTextMatches;
- (void)unmarkAllTextMatches;
- (_Bool)markedTextMatchesAreHighlighted;
- (void)setMarkedTextMatchesAreHighlighted:(_Bool)arg1;
- (unsigned int)countMatchesForText:(id)arg1 inDOMRange:(id)arg2 options:(unsigned int)arg3 limit:(unsigned int)arg4 markMatches:(_Bool)arg5;
