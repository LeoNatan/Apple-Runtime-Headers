...
- (unsigned int)countMatchesForText:(id)arg1 caseSensitive:(_Bool)arg2 highlight:(_Bool)arg3 limit:(unsigned int)arg4 markMatches:(_Bool)arg5;
- (unsigned int)markAllMatchesForText:(id)arg1 caseSensitive:(_Bool)arg2 highlight:(_Bool)arg3 limit:(unsigned int)arg4;
...
- (void)_setDeviceOrientation:(unsigned int)arg1;
- (_Bool)_isClosing;
- (_Bool)_isStopping;
...
- (unsigned int)countMatchesForText:(id)arg1 inDOMRange:(id)arg2 options:(unsigned int)arg3 highlight:(_Bool)arg4 limit:(unsigned int)arg5 markMatches:(_Bool)arg6;
- (unsigned int)countMatchesForText:(id)arg1 options:(unsigned int)arg2 highlight:(_Bool)arg3 limit:(unsigned int)arg4 markMatches:(_Bool)arg5;
...
- (_Bool)findString:(id)arg1 options:(unsigned int)arg2;
...
@property(readonly, nonatomic) unsigned int selectionAffinity;
...
- (_Bool)_shouldChangeSelectedDOMRange:(id)arg1 toDOMRange:(id)arg2 affinity:(unsigned int)arg3 stillSelecting:(_Bool)arg4;
