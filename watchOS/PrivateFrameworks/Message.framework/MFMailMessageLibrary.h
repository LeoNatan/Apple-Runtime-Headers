...
- (void).cxx_destruct;
- (_Bool)messageDataExistsInDatabaseForMessageLibraryID:(long long)arg1 part:(id)arg2 length:(unsigned int *)arg3;
...
- (id)indexableMessagesWhere:(id)arg1 sortedBy:(id)arg2 limit:(int)arg3 options:(unsigned int)arg4;
- (struct sqlite3_stmt *)_prepareBatchStatement:(id)arg1 pattern:(id)arg2 libraryIDs:(long long *)arg3 batchSize:(unsigned int)arg4;
- (struct sqlite3_stmt *)_prepareBatchStatement:(id)arg1 pattern:(id)arg2 objects:(id *)arg3 count:(unsigned int)arg4;
...
@property(readonly, nonatomic) unsigned int protectedDataAvailability;
...
- (int)loadMoreMessagesForThreadContainingMessage:(id)arg1 hasNoMoreMessages:(_Bool *)arg2;
...
- (int)countDistinctMessagesMatchingCriterion:(id)arg1;
...
- (id)sendersByLibraryIDForConversation:(long long)arg1 mailbox:(id)arg2 limit:(int)arg3;
...
- (id)_messagesForMailbox:(id)arg1 olderThanNumberOfDays:(int)arg2 limit:(unsigned int)arg3;
