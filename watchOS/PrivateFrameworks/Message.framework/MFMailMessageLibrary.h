...
- (id)_searchableItemIndexesForDb:(struct sqlite3 *)arg1 indexingType:(int)arg2 nonLocalAccountsClause:(id)arg3 protectedDataAvailable:(_Bool)arg4 whereClause:(id)arg5 limit:(unsigned int)arg6;
...
- (void)_assignTransaction:(long long)arg1 messageIndexingState:(int)arg2 forLibraryIDs:(id)arg3 missingLibraryIDIndexSet:(id *)arg4 database:(struct sqlite3 *)arg5;
- (void)_assignTransaction:(long long)arg1 messageIndexingState:(int)arg2 forLibraryIDIndexSet:(id)arg3 missingLibraryIDIndexSet:(id *)arg4 database:(struct sqlite3 *)arg5;
...
- (int)beginTransaction:(struct sqlite3 *)arg1 withType:(int)arg2 forMailbox:(id)arg3;
...
- (int)_reconcileJournal;
- (void)_schedulePeriodicStatisticsLogging;
- (void)_logStatistics;
- (unsigned int)_deleteJournaledEntries;
...
- (void)_setOrAdjust:(_Bool)arg1 lastSyncAndMostRecentStatusCountWithValue:(int)arg2 forMailbox:(id)arg3;
