...
#import "MFSearchableIndexSchedulableDelegate.h"

@class MFSearchableIndexBudgetConfiguration, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSString;
