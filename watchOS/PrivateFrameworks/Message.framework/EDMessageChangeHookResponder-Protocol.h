...
- (void)persistenceDidChangeConversationNotificationLevel:(int)arg1 conversationID:(long long)arg2 generationWindow:(EDPersistenceDatabaseGenerationWindow *)arg3;
