...
- (id)_reallyLoad:(int)arg1 shouldDownload:(_Bool)arg2;
- (void)_load:(int)arg1 shouldDownload:(_Bool)arg2;
- (void)load:(int)arg1 scheduler:(id)arg2 shouldDownload:(_Bool)arg3;
