...
- (int)budgetedItemCountRemainingForSearchableIndexSchedulable:(id <MFSearchableIndexSchedulable>)arg1;
...
- (void)searchableIndexSchedulable:(id <MFSearchableIndexSchedulable>)arg1 didIndexItemCount:(int)arg2;
