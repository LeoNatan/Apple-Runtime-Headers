...
- (id)initWithTime:(double)arg1 periodDuration:(double)arg2 numberOfItemsToIndexOnResume:(int)arg3 enableActivityBasedScheduling:(_Bool)arg4 autoStartMaintenanceIndexing:(_Bool)arg5;
