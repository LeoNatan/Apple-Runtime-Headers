...
- (void)adjustUnreadStatusCountsBy:(int)arg1 forMailboxWithURL:(NSURL *)arg2;
- (void)setUnreadStatusCountsTo:(unsigned int)arg1 subtractFromTotalCount:(_Bool)arg2 forMailboxWithURL:(NSURL *)arg3;
