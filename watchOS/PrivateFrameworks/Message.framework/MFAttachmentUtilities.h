...
+ (id)makeAttachmentPlaceholder:(id)arg1 fileSize:(int)arg2 mimeType:(id)arg3 contentID:(id)arg4;
+ (_Bool)shouldCreatePlaceholderAttachmentForAttachmentWithSize:(int)arg1;
