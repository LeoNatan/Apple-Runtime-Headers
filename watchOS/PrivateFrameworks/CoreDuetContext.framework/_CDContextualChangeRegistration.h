...
- (id)initWithIdentifier:(id)arg1 contextualPredicate:(id)arg2 dismissalPolicy:(id)arg3 deviceSet:(unsigned int)arg4 mustWake:(_Bool)arg5 callback:(CDUnknownBlockType)arg6;
- (id)init;
