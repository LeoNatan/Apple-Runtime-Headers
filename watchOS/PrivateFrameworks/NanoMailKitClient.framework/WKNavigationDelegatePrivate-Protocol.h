...
@optional
- (void)_webView:(WKWebView *)arg1 decidePolicyForSOAuthorizationLoadWithCurrentPolicy:(int)arg2 forExtension:(NSString *)arg3 completionHandler:(void (^)(int))arg4;
...
- (void)_webView:(WKWebView *)arg1 webContentProcessDidTerminateWithReason:(int)arg2;
...
- (void)_webView:(WKWebView *)arg1 decidePolicyForNavigationAction:(WKNavigationAction *)arg2 preferences:(WKWebpagePreferences *)arg3 userInfo:(id <NSSecureCoding>)arg4 decisionHandler:(void (^)(int, WKWebpagePreferences *))arg5;
- (void)_webView:(WKWebView *)arg1 decidePolicyForNavigationAction:(WKNavigationAction *)arg2 userInfo:(id <NSSecureCoding>)arg3 decisionHandler:(void (^)(int, _WKWebsitePolicies *))arg4;
- (void)_webView:(WKWebView *)arg1 decidePolicyForNavigationAction:(WKNavigationAction *)arg2 decisionHandler:(void (^)(int, _WKWebsitePolicies *))arg3;
