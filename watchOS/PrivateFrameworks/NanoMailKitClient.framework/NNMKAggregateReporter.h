...
+ (void)reportNotificationAction:(unsigned int)arg1;
...
+ (void)reportComposedMessageSizeInBytes:(unsigned int)arg1;
...
+ (void)reportMoreMessagesReceivedConversationSpecific:(_Bool)arg1 fullSyncVersion:(unsigned int)arg2 dateSynced:(id)arg3;
...
+ (void)reportMessageUpdateCountFetchedOverCloudMessaging:(unsigned int)arg1;
+ (void)reportMessageDeletionCountFetchedOverCloudMessaging:(unsigned int)arg1;
+ (void)reportNewMessageCountFetchedOverCloudMessaging:(unsigned int)arg1;
...
+ (void)reportOriginalMessageContentSizeInBytes:(unsigned int)arg1;
...
+ (void)reportMessageReceivedWithId:(id)arg1 willGenerateNotification:(_Bool)arg2 fullSyncVersion:(unsigned int)arg3 dateSynced:(id)arg4;
...
+ (void)reportSyncAccountsStandaloneNotSupportCount:(unsigned int)arg1;
+ (void)reportSyncAccountsStandalonePendingCount:(unsigned int)arg1;
+ (void)reportSyncAccountsStandaloneActiveCount:(unsigned int)arg1;
