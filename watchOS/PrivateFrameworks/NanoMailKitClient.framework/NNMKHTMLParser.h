...
@interface NNMKHTMLParser : NSObject
{
    ...
    unsigned int _bodyTagStartIndex;
    NSString *_bodyTagStyle;
    unsigned int _currentHeadTagStartIndex;
    unsigned int _currentImgTagStartIndex;
...
@property(nonatomic) unsigned int currentImgTagStartIndex; // @synthesize currentImgTagStartIndex=_currentImgTagStartIndex;
@property(nonatomic) unsigned int currentHeadTagStartIndex; // @synthesize currentHeadTagStartIndex=_currentHeadTagStartIndex;
@property(retain, nonatomic) NSString *bodyTagStyle; // @synthesize bodyTagStyle=_bodyTagStyle;
@property(nonatomic) unsigned int bodyTagStartIndex; // @synthesize bodyTagStartIndex=_bodyTagStartIndex;
...
- (void)parseHTMLBody:(id)arg1 encoding:(unsigned int)arg2;
- (id)init;
