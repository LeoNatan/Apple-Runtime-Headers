...
- (id)ef_stringByReplacingPercentEscapesUsingEncoding:(unsigned int)arg1;
- (id)ef_stringByAddingPercentEscapesUsingEncoding:(unsigned int)arg1;
...
- (id)ef_wordComponentsForLocale:(id)arg1 minimumWordLength:(int)arg2;
