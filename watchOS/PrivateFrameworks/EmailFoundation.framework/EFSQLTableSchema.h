...
@interface EFSQLTableSchema : NSObject
{
    ...
    unsigned int _primaryKeyConflictResolution;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) unsigned int primaryKeyConflictResolution; // @synthesize primaryKeyConflictResolution=_primaryKeyConflictResolution;
...
- (void)addUniquenessConstraintForColumns:(id)arg1 conflictResolution:(unsigned int)arg2;
...
- (id)initWithName:(id)arg1 rowIDType:(unsigned int)arg2 rowIDAlias:(id)arg3 columns:(id)arg4;
- (id)initWithName:(id)arg1 rowIDType:(unsigned int)arg2 columns:(id)arg3;
