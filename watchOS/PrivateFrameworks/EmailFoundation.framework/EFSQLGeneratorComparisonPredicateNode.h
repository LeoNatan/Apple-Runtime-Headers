...
@interface EFSQLGeneratorComparisonPredicateNode : NSObject <EFSQLGeneratorPredicateNode>
{
    ...
    unsigned int _predicateOperator;
...
@property(readonly, nonatomic) unsigned int predicateOperator; // @synthesize predicateOperator=_predicateOperator;
...
- (id)initWithKeypathGenerators:(id)arg1 predicateOperator:(unsigned int)arg2 constValue:(id)arg3;
