...
- (void).cxx_destruct;
@property(readonly, nonatomic) unsigned int bitwiseOperator; // @synthesize bitwiseOperator=_bitwiseOperator;
...
- (id)initWithLeft:(id)arg1 bitwiseOperator:(unsigned int)arg2 right:(id)arg3;
