...
- (id)ef_subarraysOfSize:(unsigned int)arg1;
...
- (unsigned int)ef_countObjectsPassingTest:(CDUnknownBlockType)arg1;
...
- (unsigned int)ef_indexWhereObjectWouldBeInserted:(id)arg1 usingComparator:(CDUnknownBlockType)arg2;
...
- (id)ef_prefix:(unsigned int)arg1;
