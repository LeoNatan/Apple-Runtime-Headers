...
- (void)_observableAtIndex:(unsigned int)arg1 didFailWithError:(id)arg2 observer:(id)arg3;
- (void)_observableAtIndex:(unsigned int)arg1 didCompleteForObserver:(id)arg2;
- (void)_observableAtIndex:(unsigned int)arg1 receivedResult:(id)arg2 observer:(id)arg3;
