...
- (unsigned int)getIndexes:(long long *)arg1 maxCount:(unsigned int)arg2 inIndexRange:(struct _EFUInt64Range *)arg3;
- (long long)lastIndex;
...
- (long)_insertionPositionOfIndex:(long long)arg1;
- (long)_positionOfIndex:(long long)arg1;
