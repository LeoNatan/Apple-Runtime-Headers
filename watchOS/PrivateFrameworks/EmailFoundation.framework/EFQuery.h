...
@property(readonly, nonatomic) unsigned int queryOptions; // @synthesize queryOptions=_queryOptions;
...
- (id)initWithTargetClass:(Class)arg1 predicate:(id)arg2 sortDescriptors:(id)arg3 queryOptions:(unsigned int)arg4 label:(id)arg5;
