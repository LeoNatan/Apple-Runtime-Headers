...
- (id)notGlob:(id)arg1;
- (id)glob:(id)arg1;
- (id)notLike:(id)arg1 patternType:(unsigned int)arg2;
- (id)notLike:(id)arg1;
- (id)like:(id)arg1 patternType:(unsigned int)arg2;
- (id)like:(id)arg1;
...
- (id)cachedSelf;
- (id)expressionForPredicateOperatorType:(unsigned int)arg1 constValue:(id)arg2;
