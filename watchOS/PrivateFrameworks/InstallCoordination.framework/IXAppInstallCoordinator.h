...
@interface IXAppInstallCoordinator : NSObject <IXCoordinatorWithPlaceholderPromise>
{
    ...
    unsigned int _observersCalled;
}

+ (void)setRemovability:(unsigned int)arg1 forAppWithBundleID:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
+ (void)cancelCoordinatorsForAppsWithBundleIDs:(id)arg1 withReason:(id)arg2 client:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
+ (_Bool)cancelCoordinatorsForAppsWithBundleIDs:(id)arg1 withReason:(id)arg2 client:(unsigned int)arg3 error:(id *)arg4;
+ (void)cancelCoordinatorForAppWithBundleID:(id)arg1 withReason:(id)arg2 client:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
+ (_Bool)cancelCoordinatorForAppWithBundleID:(id)arg1 withReason:(id)arg2 client:(unsigned int)arg3 error:(id *)arg4;
+ (_Bool)_synchronouslyEnumerateCoordinatorsForIntent:(unsigned int)arg1 error:(id *)arg2 usingBlock:(CDUnknownBlockType)arg3;
+ (void)_asynchronouslyEnumerateCoordinatorsForIntent:(unsigned int)arg1 usingBlock:(CDUnknownBlockType)arg2;
+ (Class)classForIntent:(unsigned int)arg1;
...
+ (id)_coordinatorForAppWithBundleID:(id)arg1 withClientID:(unsigned int)arg2 intent:(unsigned int)arg3 createIfNotExisting:(_Bool)arg4 requireMatchingIntent:(_Bool)arg5 created:(_Bool *)arg6 error:(id *)arg7;
...
+ (void)demoteAppToPlaceholderWithBundleID:(id)arg1 forReason:(unsigned int)arg2 waitForDeletion:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
...
- (oneway void)_clientDelegate_promiseDidBeginFulfillmentWithIdentifier:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int coordinationState;
...
- (unsigned int)importanceWithError:(id *)arg1;
- (_Bool)setImportance:(unsigned int)arg1 error:(id *)arg2;
...
- (id)initWithBundleID:(id)arg1 creator:(unsigned int)arg2 intent:(unsigned int)arg3;
