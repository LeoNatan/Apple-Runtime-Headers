...
+ (id)_placeholderForBundle:(id)arg1 client:(unsigned int)arg2 withParent:(id)arg3 installType:(unsigned int)arg4 metadata:(id)arg5 error:(id *)arg6;
+ (id)placeholderForInstallable:(id)arg1 client:(unsigned int)arg2 installType:(unsigned int)arg3 metadata:(id)arg4 error:(id *)arg5;
...
+ (id)placeholderForRemovableSystemAppWithBundleID:(id)arg1 client:(unsigned int)arg2 installType:(unsigned int)arg3 error:(id *)arg4;
...
@property(readonly, nonatomic) unsigned int installType; // @dynamic installType;
@property(readonly, nonatomic) unsigned int placeholderType; // @dynamic placeholderType;
...
- (_Bool)_doInitWithBundleName:(id)arg1 bundleID:(id)arg2 installType:(unsigned int)arg3 isPlugin:(_Bool)arg4;
- (id)initPlugInPlaceholderWithBundleName:(id)arg1 bundleID:(id)arg2 parentPlaceholder:(id)arg3 client:(unsigned int)arg4;
- (id)initAppPlaceholderWithBundleName:(id)arg1 bundleID:(id)arg2 installType:(unsigned int)arg3 client:(unsigned int)arg4;
