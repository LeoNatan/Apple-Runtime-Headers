...
- (oneway void)_remote_IXSDataPromise:(NSUUID *)arg1 getErrorInfo:(void (^)(unsigned int, NSError *))arg2;
- (oneway void)_remote_IXSDataPromise:(NSUUID *)arg1 resetWithCompletion:(void (^)(NSError *))arg2;
- (oneway void)_remote_IXSDataPromise:(NSUUID *)arg1 cancelForReason:(NSError *)arg2 client:(unsigned int)arg3 completion:(void (^)(NSError *))arg4;
...
- (oneway void)_remote_IXSCoordinatedAppInstall:(NSUUID *)arg1 getCoordinationState:(void (^)(unsigned int, NSError *))arg2;
...
- (oneway void)_remote_IXSCoordinatedAppInstall:(NSUUID *)arg1 getErrorInfo:(void (^)(unsigned int, NSError *))arg2;
...
- (oneway void)_remote_IXSCoordinatedAppInstall:(NSUUID *)arg1 importanceWithCompletion:(void (^)(unsigned int, NSError *))arg2;
- (oneway void)_remote_IXSCoordinatedAppInstall:(NSUUID *)arg1 setImportance:(unsigned int)arg2 completion:(void (^)(NSError *))arg3;
...
- (oneway void)_remote_IXSCoordinatedAppInstall:(NSUUID *)arg1 setAppAssetPromiseDRI:(unsigned int)arg2 completion:(void (^)(NSError *))arg3;
- (oneway void)_remote_IXSCoordinatedAppInstall:(NSUUID *)arg1 getAppAssetPromiseDRI:(void (^)(unsigned int, NSError *))arg2;
...
- (oneway void)_remote_IXSCoordinatedAppInstall:(NSUUID *)arg1 cancelForReason:(NSError *)arg2 client:(unsigned int)arg3 completion:(void (^)(NSError *))arg4;
- (void)_remote_displayUserPresentableErrorForAppWithLocalizedName:(NSString *)arg1 code:(int)arg2;
- (void)_remote_displayUserPresentableErrorForApps:(NSArray *)arg1 code:(int)arg2;
- (void)_remote_displayUserPresentableErrorForApp:(NSString *)arg1 code:(int)arg2;
- (void)_remote_registerTransientObserver:(NSXPCListenerEndpoint *)arg1 forClientIdentifiers:(NSSet *)arg2 respondingToSelectors:(unsigned int)arg3;
- (void)_remote_registerObserverMachServiceName:(NSString *)arg1 forClientIdentifiers:(NSSet *)arg2 respondingToSelectors:(unsigned int)arg3;
...
- (void)_remote_cancelCoordinatorsForAppsWithBundleIDs:(NSArray *)arg1 reason:(NSError *)arg2 client:(unsigned int)arg3 completion:(void (^)(NSError *))arg4;
- (void)_remote_cancelCoordinatorForAppWithBundleID:(NSString *)arg1 reason:(NSError *)arg2 client:(unsigned int)arg3 completion:(void (^)(NSError *))arg4;
- (void)_remote_setRemovability:(unsigned int)arg1 forAppWithBundleID:(NSString *)arg2 completion:(void (^)(NSError *))arg3;
- (void)_remote_removabilityForAppWithBundleID:(NSString *)arg1 completion:(void (^)(unsigned int, NSError *))arg2;
- (void)_remote_setTestModeForIdentifierPrefix:(NSString *)arg1 testMode:(unsigned int)arg2 completion:(void (^)(NSError *))arg3;
...
- (void)_remote_purgeRegisteredCoordinatorsAndPromisesForCreator:(unsigned int)arg1 completion:(void (^)(NSError *))arg2;
- (void)_remote_fetchRegisteredDataPromiseInfoForCreator:(unsigned int)arg1 completion:(void (^)(NSArray *, NSError *))arg2;
- (void)_remote_fetchSeedsForCoordinatorsWithIntent:(unsigned int)arg1 completion:(void (^)(NSArray *, NSError *))arg2;
