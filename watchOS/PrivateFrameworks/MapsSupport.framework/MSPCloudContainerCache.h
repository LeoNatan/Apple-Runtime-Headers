...
@property(nonatomic) int accountEnvironment; // @synthesize accountEnvironment=_accountEnvironment;
...
- (void)merge;
- (void)reset;
- (id)initWithName:(id)arg1 accountIdentifier:(id)arg2 accountEnvironment:(int)arg3;
