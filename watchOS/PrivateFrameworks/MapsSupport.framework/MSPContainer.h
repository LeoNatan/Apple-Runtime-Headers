...
+ (_Bool)_deletes:(unsigned int)arg1 mayRepresentDataLossIfAppliedTo:(unsigned int)arg2;
...
- (void)eraseFromStorageTypes:(unsigned int)arg1 withCompletionQueue:(id)arg2 completion:(CDUnknownBlockType)arg3;
