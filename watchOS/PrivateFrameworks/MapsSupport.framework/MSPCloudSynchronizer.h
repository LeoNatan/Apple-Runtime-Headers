...
@interface MSPCloudSynchronizer : NSObject <MSPJournaling>
{
    ...
    _Bool _needsMerge;
    unsigned int _countOfInFlightMerges;
    NSMutableArray *_mergeCompletionHandlers;
    MSPJournal *_journal;
    NSTimer *_identityRecheckTimer;
    unsigned int _failedResolutionAttempts;
...
+ (int)_maximumResolutionAttemptsCount;
+ (int)_boostedQualityOfServiceForOpportunisticTask;
+ (int)_boostedQualityOfServiceForUserObservableTask;
+ (int)_qualityOfServiceForOpportunisticTask;
+ (int)_qualityOfServiceForUserObservableTask;
+ (int)_qualityOfServiceForInitialDownload;
...
- (void)_completeOperation:(id)arg1 isMerge:(_Bool)arg2 withError:(id)arg3 canReattempt:(_Bool)arg4 maxAttempts:(unsigned int)arg5 minimumReattemptDate:(id)arg6 completion:(CDUnknownBlockType)arg7;
- (id)_scheduleTaskIfAny:(id)arg1 isMerge:(_Bool)arg2 qualityOfService:(int)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)setNeedsMergeWithOptions:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
...
@property(getter=_loginStatus, setter=_setLoginStatus:) int loginStatus; // @synthesize loginStatus=_loginStatus;
- (void)_availabilityDidChange;
- (void)start;
- (int)_boostIfNeededQualityOfServiceForTask:(id)arg1 thatIsUserObservable:(_Bool)arg2;
