...
+ (id)containerForEnvironment:(int)arg1 usesZoneWidePCS:(_Bool)arg2;
...
- (id)newRequestGroupWithName:(id)arg1 size:(int)arg2;
...
- (id)initWithEnvironment:(int)arg1 zoneID:(id)arg2 usesZoneWidePCS:(_Bool)arg3;
