...
- (void)cancel;
- (void)_endWithError:(id)arg1 canReattempt:(_Bool)arg2 maxAttempts:(unsigned int)arg3 minimumReattemptDate:(id)arg4;
- (_Bool)isFinished;
- (_Bool)isExecuting;
...
- (id)description;
- (id)initWithTask:(id)arg1 access:(id)arg2 attemptCount:(unsigned int)arg3 minimumAttemptDate:(id)arg4 completion:(CDUnknownBlockType)arg5;
