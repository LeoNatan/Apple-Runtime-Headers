...
- (void)failWithError:(id)arg1 canReattempt:(_Bool)arg2 maxAttempts:(unsigned int)arg3 minimumReattemptDate:(id)arg4;
- (void)setFailureHandler:(CDUnknownBlockType)arg1;
- (void)performRequest:(id)arg1 continuation:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic, getter=_desiredQualityOfService) int desiredQualityOfService;
- (void)performCancel;
