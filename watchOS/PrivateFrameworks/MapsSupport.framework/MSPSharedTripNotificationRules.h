...
@property(nonatomic) unsigned int postedNotifcations; // @synthesize postedNotifcations=_postedNotifcations;
@property(nonatomic) unsigned int maxPostedNotifications; // @synthesize maxPostedNotifications=_maxPostedNotifications;
- (void).cxx_destruct;
