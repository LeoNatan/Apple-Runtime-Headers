...
- (id)_taskPerformingCachedFetchWithExpectedMergeSize:(int)arg1 processingBlock:(CDUnknownBlockType)arg2;
- (void)synchronizer:(id)arg1 userIdentityDidLogOutWithFollowUp:(int)arg2;
...
- (void)start;
- (id)initWithContainer:(id)arg1 options:(unsigned int)arg2;
- (id)initWithContainer:(id)arg1 environment:(int)arg2 options:(unsigned int)arg3;
