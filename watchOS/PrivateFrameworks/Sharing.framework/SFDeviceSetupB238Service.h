...
@class CUAudioPlayer, NSDate, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, RPCompanionLinkClient, SFClient, SFDeviceOperationHandlerWiFiSetup, SFService, SFSession, SFSiriClient, SFSiriDeviceSetupGreetingDetails;
...
- (long)_handleBasicConfigRequest:(id)arg1;
