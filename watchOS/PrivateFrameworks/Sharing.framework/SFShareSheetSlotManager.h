...
- (void)activityViewControllerWithSessionID:(id)arg1 movedActivityAtIndex:(int)arg2 toIndex:(int)arg3 activityCategory:(int)arg4;
- (void)activityViewControllerWithSessionID:(id)arg1 selectedDefaultActivityAtIndex:(int)arg2 activityCategory:(int)arg3;
- (void)activityViewControllerWithSessionID:(id)arg1 favoritedActivity:(_Bool)arg2 atIndex:(int)arg3;
- (void)activityViewControllerWithSessionID:(id)arg1 toggledActivityAtIndex:(int)arg2 activityCategory:(int)arg3;
- (void)activityViewControllerWithSessionID:(id)arg1 selectedPersonAtIndex:(unsigned int)arg2;
- (void)activityViewControllerWithSessionID:(id)arg1 selectedActionAtIndex:(unsigned int)arg2;
- (void)activityViewControllerWithSessionID:(id)arg1 selectedActivityAtIndex:(unsigned int)arg2;
