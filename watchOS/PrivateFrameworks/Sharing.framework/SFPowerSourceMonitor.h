...
- (void)_updatePowerSourcesWithInfo:(void *)arg1 sources:(struct __CFArray *)arg2 sourcesCount:(long)arg3;
- (void)_updatePowerSources;
- (void)_triggerUpdatePowerSources;
- (_Bool)powerSourcesListWithOutInfo:(const void **)arg1 outSources:(const struct __CFArray **)arg2 outSourcesCount:(int *)arg3;
- (void)_update;
- (void)invalidate;
