...
- (int)tlsState;
- (void)_tlsReceivedObjectFromPeer:(id)arg1 length:(unsigned long)arg2;
...
- (void)_pairTLSComplete:(long)arg1 peer:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (long)_tlsSetCertificatesForSession:(struct SSLContext *)arg1;
- (long)_tlsEnsureConfiguredWithPeer:(id)arg1;
