...
@interface SFAirDropTransfer : NSObject <NSSecureCoding, NSCopying>
{
    ...
    unsigned int _userResponse;
    unsigned int _transferState;
...
@property(nonatomic) unsigned int transferState; // @synthesize transferState=_transferState;
@property(nonatomic) unsigned int userResponse; // @synthesize userResponse=_userResponse;
