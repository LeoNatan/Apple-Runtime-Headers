...
+ (id)_glyphForBatteryDeviceWithTransport:(int)arg1 accessoryCategory:(unsigned int)arg2 vendor:(int)arg3 productIdentifier:(int)arg4 parts:(unsigned int)arg5 modelNumber:(id)arg6;
...
- (int)_transportTypeFromPowerSourceTransportTypeString:(id)arg1;
- (id)_identifierFromPowerSourceDescription:(id)arg1;
- (int)_powerSourceStateFromPowerSourceStateString:(id)arg1;
- (int)_vendorFromPowerSourceDescriptionVendorIdentifier:(id)arg1 transportType:(int)arg2;
- (int)_displayChargePercentForCurrentCapacity:(id)arg1 andMaxCapacity:(id)arg2 updateZeroValue:(_Bool)arg3;
- (int)_lowBatteryLevelForVendor:(int)arg1 accessoryCategory:(unsigned int)arg2 transportType:(int)arg3;
- (id)_nameForVendor:(int)arg1 accessoryCategory:(unsigned int)arg2 name:(id)arg3 partName:(id)arg4;
- (struct CGSize)_largestBatteryDeviceGlyphSize;
- (unsigned int)_partFromPowerSourcePartIdentifier:(id)arg1;
- (unsigned int)_accessoryCategoryFromPowerSourceAccessoryCategory:(id)arg1 partType:(unsigned int)arg2 transportType:(int)arg3 vendor:(int)arg4 productIdentifier:(int)arg5;
...
- (_Bool)_shouldCoalesceDevices:(id)arg1 minimumPercentCharge:(int *)arg2;
