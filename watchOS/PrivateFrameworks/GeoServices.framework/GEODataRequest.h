...
@property(readonly, nonatomic) unsigned int multipathAlternatePort; // @synthesize multipathAlternatePort=_multipathAlternatePort;
@property(readonly, nonatomic) unsigned int multipathServiceType; // @synthesize multipathServiceType=_multipathServiceType;
...
@property(readonly, nonatomic) unsigned int constraints; // @synthesize constraints=_constraints;
...
- (id)description;
- (id)initWithKind:(CDStruct_d1a7ebee)arg1 URL:(id)arg2 xpcRequest:(id)arg3 auditToken:(id)arg4 timeoutInterval:(double)arg5 additionalHTTPHeaders:(id)arg6 needsProxy:(_Bool)arg7 HTTPMethod:(BOOL)arg8 bodyData:(id)arg9 HTTPShouldHandleCookies:(_Bool)arg10 constraints:(unsigned int)arg11 allowTLSSessionTicketUse:(_Bool)arg12 allowTFOUse:(_Bool)arg13 userAgent:(id)arg14 entityTag:(id)arg15 cachedData:(id)arg16 requestCounterTicket:(id)arg17 multipathServiceType:(unsigned int)arg18 multipathAlternatePort:(unsigned int)arg19 throttleToken:(id)arg20;
...
- (id)initHttpOnlyRequestWithKind:(CDStruct_d1a7ebee)arg1 protobufRequest:(id)arg2 URL:(id)arg3 additionalHTTPHeaders:(id)arg4 needsProxy:(_Bool)arg5 allowCellularUse:(_Bool)arg6 compressRequest:(_Bool)arg7 requestCounterTicket:(id)arg8 multipathServiceType:(unsigned int)arg9 multipathAlternatePort:(unsigned int)arg10 throttleToken:(id)arg11;
- (id)initWithKind:(CDStruct_d1a7ebee)arg1 protobufRequest:(id)arg2 URL:(id)arg3 additionalHTTPHeaders:(id)arg4 needsProxy:(_Bool)arg5 auditToken:(id)arg6 timeoutInterval:(double)arg7 traits:(id)arg8 requestCounterTicket:(id)arg9 multipathServiceType:(unsigned int)arg10 multipathAlternatePort:(unsigned int)arg11 throttleToken:(id)arg12;
