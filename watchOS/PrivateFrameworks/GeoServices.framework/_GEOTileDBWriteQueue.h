...
{
    unsigned int _maxOperations;
    unsigned int _maxOperationsSizeInBytes;
    NSMutableArray *_pendingOperations;
    GEOTileDB *_db;
    NSObject<OS_dispatch_queue> *_queue;
    unsigned int _pendingSizeInBytes;
}
...
- (id)initWithDB:(id)arg1 maxOperations:(unsigned int)arg2 maxOperationsSizeInBytes:(unsigned int)arg3;
