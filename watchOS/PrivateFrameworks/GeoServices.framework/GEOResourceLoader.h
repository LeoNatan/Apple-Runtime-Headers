...
@interface GEOResourceLoader : NSObject <NSProgressReporting>
{
    ...
    unsigned int _numberOfDownloadsInProgress;
...
- (id)initWithTargetDirectory:(id)arg1 baseURL:(id)arg2 proxyURL:(id)arg3 resources:(id)arg4 maximumConcurrentLoads:(unsigned int)arg5 additionalDirectoryToConsider:(id)arg6 log:(id)arg7 signpostID:(unsigned long long)arg8;
- (id)init;
