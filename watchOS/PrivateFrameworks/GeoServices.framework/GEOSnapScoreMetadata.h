...
- (id)description;
- (id)destinationAccessPointAtIndex:(unsigned int)arg1;
- (unsigned int)destinationAccessPointsCount;
...
- (id)destinationPointAtIndex:(unsigned int)arg1;
- (unsigned int)destinationPointsCount;
...
- (id)originAccessPointAtIndex:(unsigned int)arg1;
- (unsigned int)originAccessPointsCount;
