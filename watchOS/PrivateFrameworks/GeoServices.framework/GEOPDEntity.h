...
@interface GEOPDEntity : PBCodable <NSCopying>
{
    ...
    CDStruct_56d48c16 _placeLookupCategorys;
...
- (int)placeLookupCategoryAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int placeLookupCategorysCount;
