...
+ (id)createRequestedComponentsForReason:(unsigned int)arg1 traits:(id)arg2 count:(unsigned int)arg3;
...
- (void)addRequestedComponentsForReason:(unsigned int)arg1 traits:(id)arg2 count:(unsigned int)arg3;
