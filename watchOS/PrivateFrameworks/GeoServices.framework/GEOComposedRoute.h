...
@interface GEOComposedRoute : NSObject <NSSecureCoding, GEOMapAccessRestrictions>
{
    ...
    unsigned int _indexOfSuggestedRoute;
...
@property(readonly, nonatomic) unsigned int indexOfSuggestedRoute; // @synthesize indexOfSuggestedRoute=_indexOfSuggestedRoute;
...
- (id)getSnappedPathsForVisibleRect:(CDStruct_90e2a262)arg1 rectsToSnap:(CDStruct_90e2a262 *)arg2 rectsToSnapCount:(unsigned long)arg3 observer:(id)arg4;
...
- (void)_addSnappedPolylinePathsForSection:(id)arg1 toPaths:(id)arg2 rects:(CDStruct_90e2a262 *)arg3 rectsCount:(unsigned long)arg4;
...
- (CDStruct_91c84281 *)roadFeatureAtPointIndex:(unsigned int)arg1;
...
- (CDStruct_39925896)pointAt:(unsigned int)arg1;
