...
- (void)setVariantBrandMuids:(unsigned long long *)arg1 count:(unsigned int)arg2;
- (unsigned long long)variantBrandMuidAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int variantBrandMuidsCount;
- (void)_readVariantBrandMuids;
- (void)setChildBrandMuids:(unsigned long long *)arg1 count:(unsigned int)arg2;
- (unsigned long long)childBrandMuidAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int childBrandMuidsCount;
- (void)_readChildBrandMuids;
- (id)geoHashAtIndex:(unsigned int)arg1;
- (unsigned int)geoHashsCount;
