...
- (void)submitWithRefinedHandler:(CDUnknownBlockType)arg1 auditToken:(id)arg2 timeout:(int)arg3 networkActivity:(CDUnknownBlockType)arg4 queue:(id)arg5;
- (void)submitWithRefinedHandler:(CDUnknownBlockType)arg1 timeout:(int)arg2 networkActivity:(CDUnknownBlockType)arg3 queue:(id)arg4;
- (void)submitWithRefinedHandler:(CDUnknownBlockType)arg1 networkActivity:(CDUnknownBlockType)arg2 queue:(id)arg3;
- (void)submitWithRefinedHandler:(CDUnknownBlockType)arg1 auditToken:(id)arg2 timeout:(int)arg3 networkActivity:(CDUnknownBlockType)arg4;
...
- (void)submitWithHandler:(CDUnknownBlockType)arg1 auditToken:(id)arg2 timeout:(int)arg3 networkActivity:(CDUnknownBlockType)arg4 queue:(id)arg5;
- (void)submitWithHandler:(CDUnknownBlockType)arg1 timeout:(int)arg2 networkActivity:(CDUnknownBlockType)arg3 queue:(id)arg4;
