...
- (void)_CDSDownloadAction:(unsigned int)arg1 regionId:(id)arg2 tileSetName:(id)arg3 zoom:(unsigned char)arg4 totalTileCount:(unsigned int)arg5 attempts:(unsigned int)arg6 successes:(unsigned int)arg7 failures:(unsigned int)arg8 date:(id)arg9;
