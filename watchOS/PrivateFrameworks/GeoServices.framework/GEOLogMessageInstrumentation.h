...
@class NSLock, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString;
...
- (void)captureLogMsgCountForEventName:(id)arg1 logMsgCount:(int)arg2 fromLogFrameworkAdaptor:(_Bool)arg3;
