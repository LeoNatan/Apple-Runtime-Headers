...
@interface GEOTileDB : NSObject
{
    ...
    unsigned int _expirationRecordsCount;
    _Bool _preloading;
...
- (void)getStaleTileKeysUsedSince:(double)arg1 fromTileSets:(id)arg2 maxCount:(unsigned int)arg3 maxTotalSize:(unsigned int)arg4 queue:(id)arg5 callback:(CDUnknownBlockType)arg6;
