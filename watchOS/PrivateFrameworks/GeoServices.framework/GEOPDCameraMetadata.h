...
- (id)description;
- (void)setTextureIds:(unsigned int *)arg1 count:(unsigned int)arg2;
- (unsigned int)textureIdAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int textureIdsCount;
