...
- (void)_performTileRequestsPreemptedStepIndex:(int)arg1 currentRoutePositionStepIndex:(int)arg2 firstErrorStepIndex:(int)arg3 firstLoadStepIndex:(int)arg4 loadStepsAhead:(int)arg5 loadStepsAheadIfNoWiFi:(int)arg6;
