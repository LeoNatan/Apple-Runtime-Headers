...
- (id)description;
- (id)shadowTypeCountsAtIndex:(unsigned int)arg1;
- (unsigned int)shadowTypeCountsCount;
...
- (id)inflightTypeCountsAtIndex:(unsigned int)arg1;
- (unsigned int)inflightTypeCountsCount;
...
- (id)storedTypeCountsAtIndex:(unsigned int)arg1;
- (unsigned int)storedTypeCountsCount;
