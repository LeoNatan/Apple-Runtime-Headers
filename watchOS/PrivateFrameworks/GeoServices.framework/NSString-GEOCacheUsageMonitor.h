...
+ (id)_geo_keyStringForCacheMissErrorDomain:(id)arg1 code:(int)arg2;
...
+ (id)stringWithStdString:(const basic_string_9db06383 *)arg1 copy:(_Bool)arg2;
...
- (basic_string_9db06383)stdString;
- (id)initWithStdString:(const basic_string_9db06383 *)arg1 copy:(_Bool)arg2;
@end
