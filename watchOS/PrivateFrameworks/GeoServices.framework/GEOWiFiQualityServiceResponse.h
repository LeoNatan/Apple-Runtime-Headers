...
- (id)description;
- (id)networkResultsAtIndex:(unsigned int)arg1;
- (unsigned int)networkResultsCount;
...
- (id)locationResultsAtIndex:(unsigned int)arg1;
- (unsigned int)locationResultsCount;
