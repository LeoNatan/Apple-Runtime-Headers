...
- (void)_resolveMapItemFromHandle:(id)arg1 withTraits:(id)arg2 cachePolicy:(unsigned int)arg3 coordinateOnlyRefinement:(_Bool)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)_resolveMapItemFromHandle:(id)arg1 withTraits:(id)arg2 cachePolicy:(unsigned int)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (unsigned int)maxParametersCountForSpatialEventLookup;
- (id)ticketForSpatialPlaceLookupParameters:(id)arg1 traits:(id)arg2;
- (unsigned int)maxParametersCountForSpatialPlaceLookup;
...
- (int)wiFiQualitySearchZoomLevel;
