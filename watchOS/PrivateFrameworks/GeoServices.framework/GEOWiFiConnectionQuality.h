...
@interface GEOWiFiConnectionQuality : PBCodable <NSCopying>
{
    ...
    CDStruct_56d48c16 _authTraits;
    CDStruct_56d48c16 _traits;
...
- (id)speedTestAtIndex:(unsigned int)arg1;
- (unsigned int)speedTestsCount;
...
- (id)roamStatesAtIndex:(unsigned int)arg1;
- (unsigned int)roamStatesCount;
...
- (id)feedbackAtIndex:(unsigned int)arg1;
- (unsigned int)feedbacksCount;
- (void)_addNoFlagsFeedback:(id)arg1;
- (void)addFeedback:(id)arg1;
- (void)clearFeedbacks;
@property(retain, nonatomic) NSMutableArray *feedbacks;
- (void)_readFeedbacks;
- (id)nearbyBSSAtIndex:(unsigned int)arg1;
- (unsigned int)nearbyBSSsCount;
...
- (id)essMembersAtIndex:(unsigned int)arg1;
- (unsigned int)essMembersCount;
...
- (void)setAuthTraits:(int *)arg1 count:(unsigned int)arg2;
- (int)authTraitsAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int authTraitsCount;
...
- (void)setTraits:(int *)arg1 count:(unsigned int)arg2;
- (int)traitsAtIndex:(unsigned int)arg1;
- (void)_addNoFlagsTraits:(int)arg1;
- (void)addTraits:(int)arg1;
- (void)clearTraits;
@property(readonly, nonatomic) int *traits;
@property(readonly, nonatomic) unsigned int traitsCount;
- (void)_readTraits;
