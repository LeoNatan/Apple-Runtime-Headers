...
- (id)otherUniqueIDsAtIndex:(unsigned int)arg1;
- (unsigned int)otherUniqueIDsCount;
- (void)addOtherUniqueIDs:(id)arg1;
- (void)clearOtherUniqueIDs;
- (id)additionalUniqueIDsAtIndex:(unsigned int)arg1;
- (unsigned int)additionalUniqueIDsCount;
