...
- (void)reportRealtimeTrafficProbes:(NSData *)arg1 probeCount:(unsigned int)arg2 recvTime:(NSDate *)arg3 forTripId:(NSString *)arg4 auditToken:(GEOApplicationAuditToken *)arg5;
@end
