...
- (id)laneMessagesAtIndex:(unsigned int)arg1;
- (unsigned int)laneMessagesCount;
...
- (void)setAlertCCodes:(unsigned int *)arg1 count:(unsigned int)arg2;
- (unsigned int)alertCCodeAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int alertCCodesCount;
...
- (id)incidentDescriptionAtIndex:(unsigned int)arg1;
- (unsigned int)incidentDescriptionsCount;
