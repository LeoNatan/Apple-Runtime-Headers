...
- (id)secondarySignAtIndex:(unsigned int)arg1;
- (unsigned int)secondarySignsCount;
...
- (id)signDetailAtIndex:(unsigned int)arg1;
- (unsigned int)signDetailsCount;
...
- (id)signTitleAtIndex:(unsigned int)arg1;
- (unsigned int)signTitlesCount;
