...
+ (id)subdataFromPointData:(id)arg1 fromPointIndex:(unsigned int)arg2 usesZilch:(_Bool)arg3;
...
+ (CDStruct_c3b9c2ee)pointAt:(unsigned int)arg1 pointData:(id)arg2 usesZilch:(_Bool)arg3;
+ (unsigned int)pointCount:(id)arg1 usesZilch:(_Bool)arg2;
