...
- (void)_cacheKeysForHash:(unsigned int)arg1 withHandler:(CDUnknownBlockType)arg2;
- (void)_cacheEntriesForHash:(unsigned int)arg1 withHandler:(CDUnknownBlockType)arg2;
