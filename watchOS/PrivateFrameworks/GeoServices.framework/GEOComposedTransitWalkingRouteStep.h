...
- (id)initWithComposedRoute:(id)arg1 transitStep:(id)arg2 stepIndex:(unsigned int)arg3 startCoordinate:(CDStruct_c3b9c2ee)arg4 endCoordinate:(CDStruct_c3b9c2ee)arg5 pointRange:(struct _NSRange)arg6;
- (id)initWithComposedRoute:(id)arg1 transitStep:(id)arg2 stepIndex:(unsigned int)arg3 geoStep:(id)arg4 pointRange:(struct _NSRange)arg5 maneuverPointRange:(struct _NSRange)arg6;
