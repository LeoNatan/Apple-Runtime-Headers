...
- (id)initWithComposedRoute:(id)arg1 decoderData:(id)arg2 transitStep:(id)arg3 stepIndex:(unsigned int)arg4 startCoordinate:(CDStruct_c3b9c2ee)arg5 endCoordinate:(CDStruct_c3b9c2ee)arg6 pointRange:(struct _NSRange)arg7;
- (id)initWithComposedRoute:(id)arg1 decoderData:(id)arg2 transitStep:(id)arg3 stepIndex:(unsigned int)arg4 geoStep:(id)arg5 pointRange:(struct _NSRange)arg6 maneuverPointRange:(struct _NSRange)arg7;
