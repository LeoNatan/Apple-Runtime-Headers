...
- (void)cancel;
- (void)submitWithRefinedHandler:(void (^)(NSArray *, NSArray *, NSError *))arg1 auditToken:(GEOApplicationAuditToken *)arg2 timeout:(int)arg3 networkActivity:(void (^)(_Bool))arg4 queue:(NSObject<OS_dispatch_queue> *)arg5;
- (void)submitWithRefinedHandler:(void (^)(NSArray *, NSArray *, NSError *))arg1 timeout:(int)arg2 networkActivity:(void (^)(_Bool))arg3 queue:(NSObject<OS_dispatch_queue> *)arg4;
...
- (void)submitWithHandler:(void (^)(NSArray *, NSError *))arg1 auditToken:(GEOApplicationAuditToken *)arg2 timeout:(int)arg3 networkActivity:(void (^)(_Bool))arg4 queue:(NSObject<OS_dispatch_queue> *)arg5;
- (void)submitWithHandler:(void (^)(NSArray *, NSError *))arg1 timeout:(int)arg2 networkActivity:(void (^)(_Bool))arg3 queue:(NSObject<OS_dispatch_queue> *)arg4;
- (void)submitWithHandler:(void (^)(NSArray *, NSError *))arg1 networkActivity:(void (^)(_Bool))arg2 queue:(NSObject<OS_dispatch_queue> *)arg3;
- (void)submitWithRefinedHandler:(void (^)(NSArray *, NSArray *, NSError *))arg1 auditToken:(GEOApplicationAuditToken *)arg2 timeout:(int)arg3 networkActivity:(void (^)(_Bool))arg4;
- (void)submitWithHandler:(void (^)(NSArray *, NSError *))arg1 auditToken:(GEOApplicationAuditToken *)arg2 timeout:(int)arg3 networkActivity:(void (^)(_Bool))arg4;
- (void)submitWithRefinedHandler:(void (^)(NSArray *, NSArray *, NSError *))arg1 timeout:(int)arg2 networkActivity:(void (^)(_Bool))arg3;
- (void)submitWithHandler:(void (^)(NSArray *, NSError *))arg1 timeout:(int)arg2 networkActivity:(void (^)(_Bool))arg3;
