...
@interface GEOPDClientMetadata : PBCodable <NSCopying>
{
    ...
    CDStruct_56d48c16 _knownClientResolvedTypeDeprecateds;
...
- (id)businessChatPreflightIdentifierAtIndex:(unsigned int)arg1;
- (unsigned int)businessChatPreflightIdentifiersCount;
...
- (void)setKnownClientResolvedTypeDeprecateds:(int *)arg1 count:(unsigned int)arg2;
- (int)knownClientResolvedTypeDeprecatedAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int knownClientResolvedTypeDeprecatedsCount;
