...
- (void)setActiveTileGroupIdentifier:(NSNumber *)arg1 updateType:(int)arg2 completionHandler:(void (^)(NSError *))arg3;
...
- (void)forceUpdate:(int)arg1 completionHandler:(void (^)(NSError *))arg2;
