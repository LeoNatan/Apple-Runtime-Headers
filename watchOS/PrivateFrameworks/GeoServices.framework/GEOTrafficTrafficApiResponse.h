...
- (id)description;
- (id)trafficSnapshotsAtIndex:(unsigned int)arg1;
- (unsigned int)trafficSnapshotsCount;
...
- (id)incidentSnapshotsAtIndex:(unsigned int)arg1;
- (unsigned int)incidentSnapshotsCount;
...
- (id)speedSnapshotsAtIndex:(unsigned int)arg1;
- (unsigned int)speedSnapshotsCount;
