...
@property(readonly, nonatomic) unsigned int buildingsZoomLevel;
@property(readonly, nonatomic) unsigned int transitZoomLevel;
@property(readonly, nonatomic) unsigned int roadsZoomLevel;
- (id)_transitPointForTransitMapNode:(shared_ptr_52e51bdf)arg1;
- (id)_findTransitPointWithID:(unsigned long long)arg1 near:(CDStruct_c3b9c2ee)arg2 type:(unsigned int)arg3 pointHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (id)_findTransitPointsWithin:(double)arg1 of:(CDStruct_c3b9c2ee)arg2 type:(unsigned int)arg3 pointHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (_Bool)_hasLoadedTilesNearCoordinate:(CDStruct_c3b9c2ee)arg1 radius:(double)arg2 zoomLevel:(unsigned int)arg3 tileStyle:(int)arg4 tileSize:(int)arg5 tileScale:(int)arg6;
...
- (id)findTransitPointWithParentID:(unsigned long long)arg1 near:(CDStruct_c3b9c2ee)arg2 type:(unsigned int)arg3 pointHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
