...
- (void)setCategoryFilters:(int *)arg1 count:(unsigned int)arg2;
- (int)categoryFilterAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int categoryFiltersCount;
