...
+ (id)sharedInstance;
- (void).cxx_destruct;
- (id)logMsgStateForRealtimeTrafficProbeCollectionWithTripId:(id)arg1 probeCount:(unsigned int)arg2 recvTime:(id)arg3;
...
- (id)logMsgStateForUserSessionWithSessionType:(unsigned int)arg1 isNavSessionAllowed:(_Bool)arg2 userSessionSnapshot:(id)arg3;
...
- (id)logMsgStateForMapsUIShownWithStateOrigin:(id)arg1 isWeatherShown:(_Bool)arg2;
- (id)logMsgStateForMapsUIShownWithIsWeatherShown:(_Bool)arg1;
