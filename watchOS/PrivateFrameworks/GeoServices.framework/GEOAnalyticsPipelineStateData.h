...
@interface GEOAnalyticsPipelineStateData : PBCodable <NSCopying>
{
    ...
    CDStruct_56d48c16 _placeCardPossibleactions;
    CDStruct_56d48c16 _placeCardUnactionableuielements;
...
- (id)suggestionsDisplayedresultsAtIndex:(unsigned int)arg1;
- (unsigned int)suggestionsDisplayedresultsCount;
...
- (id)mapsServerMetadataSuggestionEntryDisplayedAtIndex:(unsigned int)arg1;
- (unsigned int)mapsServerMetadataSuggestionEntryDisplayedsCount;
...
- (void)setPlaceCardUnactionableuielements:(int *)arg1 count:(unsigned int)arg2;
- (int)placeCardUnactionableuielementsAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int placeCardUnactionableuielementsCount;
- (void)_readPlaceCardUnactionableuielements;
- (void)setPlaceCardPossibleactions:(int *)arg1 count:(unsigned int)arg2;
- (int)placeCardPossibleactionsAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int placeCardPossibleactionsCount;
