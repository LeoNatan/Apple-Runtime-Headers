...
- (id)initWithRoute:(id)arg1 startPoint:(unsigned int)arg2 pointCount:(unsigned int)arg3 bounds:(CDStruct_90e2a262)arg4 transportType:(int)arg5 finalStepIndex:(unsigned int)arg6 startDistance:(double)arg7 lengthScaleFactor:(double)arg8;
