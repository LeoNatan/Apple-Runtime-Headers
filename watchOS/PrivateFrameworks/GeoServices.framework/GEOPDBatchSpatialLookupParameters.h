...
- (id)description;
- (id)spatialEventLookupAtIndex:(unsigned int)arg1;
- (unsigned int)spatialEventLookupsCount;
...
- (id)spatialPlaceLookupAtIndex:(unsigned int)arg1;
- (unsigned int)spatialPlaceLookupsCount;
