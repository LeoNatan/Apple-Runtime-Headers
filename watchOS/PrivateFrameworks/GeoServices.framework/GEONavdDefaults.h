...
+ (id)sharedInstance;
@property(readonly, nonatomic) unsigned int maxRandomJitterForHypothesisWakeup;
@property(readonly, nonatomic) unsigned int minRandomJitterForHypothesisWakeup;
...
@property(readonly, nonatomic) unsigned int maximumTraceFileCount;
...
@property(readonly, nonatomic) unsigned int maximumNumberOfLeechedLocations;
...
@property(readonly, nonatomic) unsigned int refreshEquationHighestFrequency;
@property(readonly, nonatomic) unsigned int refreshEquationLowestFrequencyTransit;
@property(readonly, nonatomic) unsigned int refreshEquationLowestFrequency;
@property(readonly, nonatomic) double refreshTimeIntervalToUseIfError;
@property(readonly, nonatomic) unsigned int maximumNumberOfProcessingLoopRepeats;
@property(readonly, nonatomic) unsigned int accessValueThresholdToUpdateCacheEntries;
...
@property(readonly, nonatomic) int maximumNumberOfDestinationsToMonitor;
@property(readonly, nonatomic) unsigned int maximumNumberOfEntriesInTheCacheUnderMemoryPressure;
...
@property(readonly, nonatomic) unsigned int initialClientInitiatedHypothesisCacheAccessValue;
@property(readonly, nonatomic) unsigned int initialSelfInitiatedHypothesisCacheAccessValue;
