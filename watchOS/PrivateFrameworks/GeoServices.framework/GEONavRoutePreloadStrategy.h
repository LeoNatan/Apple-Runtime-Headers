...
- (void)_performTileRequestsWithCurrentRoutePositionStepIndex:(int)arg1 firstErrorStepIndex:(int)arg2 firstLoadStepIndex:(int)arg3 loadStepsAhead:(int)arg4 loadStepsAheadIfNoWiFi:(int)arg5;
