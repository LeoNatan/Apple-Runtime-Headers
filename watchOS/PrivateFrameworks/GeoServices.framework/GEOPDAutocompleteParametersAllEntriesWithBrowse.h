...
- (void)setSupportedListTypes:(int *)arg1 count:(unsigned int)arg2;
- (int)supportedListTypeAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int supportedListTypesCount;
