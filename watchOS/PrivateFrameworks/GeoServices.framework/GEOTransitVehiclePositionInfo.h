...
- (id)departureEntryAtIndex:(unsigned int)arg1;
- (unsigned int)departureEntrysCount;
...
@property(readonly, nonatomic) unsigned int tripIDForNextUpcomingDeparture;
@property(readonly, nonatomic) unsigned int firstTripID;
