...
- (id)description;
- (id)searchResultSectionAtIndex:(unsigned int)arg1;
- (unsigned int)searchResultSectionsCount;
...
- (id)retainSearchAtIndex:(unsigned int)arg1;
- (unsigned int)retainSearchsCount;
...
- (id)displayHeaderSubstituteAtIndex:(unsigned int)arg1;
- (unsigned int)displayHeaderSubstitutesCount;
