...
@property(readonly, nonatomic) unsigned int workLoad; // @synthesize workLoad=_workLoad;
- (void)encodeWithCoder:(id)arg1;
- (id)initWithCoder:(id)arg1;
- (id)initWithWorkload:(unsigned int)arg1 timeWindowDuration:(double)arg2;
- (id)initWithWorkload:(unsigned int)arg1 timeWindowStartTime:(double)arg2 timeWindowDuration:(double)arg3;
