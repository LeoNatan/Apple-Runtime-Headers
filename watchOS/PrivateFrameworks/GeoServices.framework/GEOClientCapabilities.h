...
@interface GEOClientCapabilities : PBCodable <NSCopying>
{
    ...
    CDStruct_56d48c16 _supportedTransitFeatures;
...
- (void)setSupportedTransitFeatures:(int *)arg1 count:(unsigned int)arg2;
- (int)supportedTransitFeatureAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int supportedTransitFeaturesCount;
