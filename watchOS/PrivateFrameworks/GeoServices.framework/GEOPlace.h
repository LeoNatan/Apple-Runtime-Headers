...
+ (Class)businessType;
+ (id)_placesFromURL:(id)arg1 hasCurrentLocation:(_Bool *)arg2 currentLocationIndex:(unsigned int *)arg3 options:(id *)arg4;
+ (id)_placesFromDirectionsAction:(id)arg1 hasCurrentLocation:(_Bool *)arg2 currentLocationIndex:(unsigned int *)arg3 options:(id *)arg4;
+ (id)_placesFromShowAction:(id)arg1 hasCurrentLocation:(_Bool *)arg2 currentLocationIndex:(unsigned int *)arg3 options:(id *)arg4;
+ (id)_placesFromPresentAction:(id)arg1 hasCurrentLocation:(_Bool *)arg2 currentLocationIndex:(unsigned int *)arg3 options:(id *)arg4;
