...
@interface GEOPDAutocompletePlaceContextMetadata : PBCodable <NSCopying>
{
    ...
    CDStruct_56d48c16 _clientizationFeatures;
...
- (void)setClientizationFeatures:(int *)arg1 count:(unsigned int)arg2;
- (int)clientizationFeatureAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int clientizationFeaturesCount;
