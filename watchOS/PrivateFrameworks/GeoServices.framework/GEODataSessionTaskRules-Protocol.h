...
- (_Bool)dataTask:(id <GEODataSessionTask>)arg1 shouldStartSubtask:(id <GEODataSessionTask>)arg2 ofType:(unsigned int)arg3;
- (_Bool)dataTask:(id <GEODataSessionTask>)arg1 shouldCreateSubtaskOfType:(unsigned int)arg2 forRequest:(GEODataRequest *)arg3;
@end
