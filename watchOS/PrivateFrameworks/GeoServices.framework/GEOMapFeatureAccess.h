...
+ (unsigned int)zoomLevelForStyle:(int)arg1 scale:(int)arg2;
- (void).cxx_destruct;
...
- (id)_findTransitPointsOfType:(unsigned int)arg1 nearCoordinate:(CDStruct_c3b9c2ee)arg2 radius:(double)arg3 handler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (id)initWithQueue:(id)arg1 memoryCacheCountLimit:(unsigned int)arg2 memoryCacheCostLimit:(unsigned int)arg3;
