...
- (id)initWithComposedRoute:(id)arg1 decoderData:(id)arg2 routeLegType:(int)arg3 step:(id)arg4 stepIndex:(unsigned int)arg5 duration:(unsigned int)arg6 pointRange:(struct _NSRange)arg7;
