...
- (id)initWithComposedRoute:(id)arg1 routeLegType:(int)arg2 step:(id)arg3 stepIndex:(unsigned int)arg4 duration:(unsigned int)arg5 pointRange:(struct _NSRange)arg6;
