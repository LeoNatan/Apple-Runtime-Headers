...
@class NWCUltravioletIndexTemplateFormatter;

@interface NWCUltravioletIndexDataSource : NWCBaseDataSource
{
}

+ (id)bundleIdentifier;
+ (_Bool)acceptsComplicationFamily:(int)arg1 forDevice:(id)arg2;
@property(readonly, nonatomic) NWCUltravioletIndexTemplateFormatter *formatter;
