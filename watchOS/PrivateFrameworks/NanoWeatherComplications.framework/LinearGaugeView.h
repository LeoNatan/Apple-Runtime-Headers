...
@interface LinearGaugeView : UIView
{
    ...
    float _lastLayoutSubviewsHeight;
    CAShapeLayer *_valueIndicatorLayer;
    UIColor *_indicatorFillColor;
    CDStruct_ca3f765c _layoutConstants;
}
...
@property(nonatomic) float lastLayoutSubviewsHeight; // @synthesize lastLayoutSubviewsHeight=_lastLayoutSubviewsHeight;
@property(retain, nonatomic) CAGradientLayer *gaugeLayer; // @synthesize gaugeLayer=_gaugeLayer;
@property(nonatomic) CDStruct_ca3f765c layoutConstants; // @synthesize layoutConstants=_layoutConstants;
...
- (id)initWithLayouConstants:(CDStruct_ca3f765c)arg1;
