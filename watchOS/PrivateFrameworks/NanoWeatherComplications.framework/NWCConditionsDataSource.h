...
@class NWCConditionsTemplateFormatter;

@interface NWCConditionsDataSource : NWCBaseDataSource
{
}

+ (id)bundleIdentifier;
+ (_Bool)acceptsComplicationFamily:(int)arg1 forDevice:(id)arg2;
@property(readonly, nonatomic) NWCConditionsTemplateFormatter *formatter;
