...
@interface SUICAutoDismissalStrategy : NSObject
{
    ...
    int _latestFaceAwarenessEvent;
    int _latestDeviceMotionEvent;
    int _autoDismissalReason;
...
@property(nonatomic) int autoDismissalReason; // @synthesize autoDismissalReason=_autoDismissalReason;
...
@property(nonatomic) int latestDeviceMotionEvent; // @synthesize latestDeviceMotionEvent=_latestDeviceMotionEvent;
@property(nonatomic) int latestFaceAwarenessEvent; // @synthesize latestFaceAwarenessEvent=_latestFaceAwarenessEvent;
