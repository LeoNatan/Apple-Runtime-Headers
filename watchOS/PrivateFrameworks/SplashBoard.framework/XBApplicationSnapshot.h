...
@property(nonatomic) int fileLocation; // @synthesize fileLocation=_fileLocation;
...
@property(readonly, nonatomic) int fileFormat; // @synthesize fileFormat=_fileFormat;
...
- (void)_setFileLocation:(int)arg1;
- (int)_fileLocation;
...
@property(readonly, nonatomic) unsigned int _contentTypeMask;
@property(readonly, nonatomic) unsigned int _interfaceOrientationMask;
