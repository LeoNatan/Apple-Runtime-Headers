...
- (unsigned int)validateEnrollment:(id)arg1 queryResponse:(id)arg2 transparentData:(id *)arg3 error:(id *)arg4;
- (id)analyticsForRequestValidation:(id)arg1 initialResult:(unsigned int)arg2 result:(unsigned int)arg3;
- (unsigned int)handleVerifyInsertResponse:(id)arg1 request:(id)arg2 transparentData:(id *)arg3 error:(id *)arg4;
- (unsigned int)writeFailureForRequest:(id)arg1 proof:(id)arg2 error:(id *)arg3;
- (unsigned int)validateSelfWithAnalytics:(id)arg1 transparentData:(id *)arg2 error:(id *)arg3;
- (unsigned int)validateSelf:(id)arg1 transparentData:(id *)arg2 error:(id *)arg3;
- (unsigned int)validateSelf:(id)arg1 queryResponse:(id)arg2 transparentData:(id *)arg3 error:(id *)arg4;
- (unsigned int)handleVerifySelfResponse:(id)arg1 request:(id)arg2 transparentData:(id *)arg3 error:(id *)arg4;
