...
- (id)createRequestWithUri:(id)arg1 application:(id)arg2 accountID:(id)arg3 serverData:(id)arg4 syncedData:(id)arg5 queryResponse:(id)arg6 type:(unsigned int)arg7 error:(id *)arg8;
- (id)createRequest;
