...
- (void)resourceTrackingRecordAccessesToArguments:(id)arg1 bufferFuncArgsPtr:(CDStruct_24aab684 *)arg2 textureFuncArgsPtr:(CDStruct_24aab684 *)arg3;
- (void)trackUseResources:(const id *)arg1 count:(unsigned int)arg2 usage:(unsigned int)arg3;
- (void)trackUseResource:(id)arg1 usage:(unsigned int)arg2;
