...
struct pair<id<MTLBuffer>, unsigned int> {
    id _field1;
    unsigned int _field2;
};
...
typedef struct {
    ...
    unsigned int threadgroupMemoryOffset;
    _Bool hasLodClamp;
    float lodMinClamp;
    float lodMaxClamp;
} CDStruct_24aab684;
...
typedef struct pair<id<MTLBuffer>, unsigned int> {
    id _field1;
    unsigned int _field2;
} pair_2bca82c0;
