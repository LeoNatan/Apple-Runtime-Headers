...
- (id <MTLIndirectComputeCommand>)indirectComputeCommandAtIndex:(unsigned int)arg1;
- (id <MTLIndirectRenderCommand>)indirectRenderCommandAtIndex:(unsigned int)arg1;
