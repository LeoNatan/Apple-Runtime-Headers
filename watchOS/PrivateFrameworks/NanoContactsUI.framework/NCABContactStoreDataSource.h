...
@class CNContact, CNContactFilter, CNContactFormatter, CNContactStore, CNiOSAddressBook, NCABCoalescingTimer, NCABContactStoreSnapshot, NSArray, NSDictionary, NSObject<OS_dispatch_queue>, NSString;
