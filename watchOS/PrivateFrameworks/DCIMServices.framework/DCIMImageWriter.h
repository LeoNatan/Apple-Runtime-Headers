...
+ (void)writeableDataForImage:(id)arg1 previewImage:(id)arg2 imageData:(id)arg3 imageUTIType:(struct __CFString *)arg4 exifProperties:(id)arg5 imageOrientation:(int)arg6 thumbnailDataOut:(id *)arg7 imageUTITypeOut:(id *)arg8 exifPropertiesOut:(id *)arg9 isJPEGOut:(_Bool *)arg10 imageDataOut:(id *)arg11;
...
+ (id)sharedDCIMWriter;
- (long)copyPrimaryFormatImageData:(id)arg1 toURL:(id)arg2 properties:(id)arg3;
