...
+ (int)calculateInstallConsentTextTypeFor:(id)arg1;
+ (id)sharedManager;
- (void)dealloc;
...
- (void)addNewRemotePlanWithAddress:(id)arg1 matchingId:(id)arg2 oid:(id)arg3 confirmationCode:(id)arg4 isPairing:(_Bool)arg5 withCSN:(id)arg6 withContext:(id)arg7 userConsent:(int)arg8 completion:(CDUnknownBlockType)arg9;
- (void)addNewRemotePlanWithCardData:(id)arg1 confirmationCode:(id)arg2 isPairing:(_Bool)arg3 withCSN:(id)arg4 withContext:(id)arg5 userConsent:(int)arg6 completion:(CDUnknownBlockType)arg7;
- (void)addNewRemotePlanWithCardData:(id)arg1 isPairing:(_Bool)arg2 withCSN:(id)arg3 withContext:(id)arg4 userConsent:(int)arg5 completion:(CDUnknownBlockType)arg6;
- (void)addNewRemotePlan:(_Bool)arg1 withCSN:(id)arg2 withContext:(id)arg3 userConsent:(int)arg4 completion:(CDUnknownBlockType)arg5;
- (void)addNewRemotePlanWithAddress:(id)arg1 matchingId:(id)arg2 oid:(id)arg3 confirmationCode:(id)arg4 isPairing:(_Bool)arg5 userConsent:(int)arg6 completion:(CDUnknownBlockType)arg7;
- (void)addNewRemotePlanWithCardData:(id)arg1 confirmationCode:(id)arg2 isPairing:(_Bool)arg3 userConsent:(int)arg4 completion:(CDUnknownBlockType)arg5;
- (void)addNewRemotePlanWithCardData:(id)arg1 isPairing:(_Bool)arg2 userConsent:(int)arg3 completion:(CDUnknownBlockType)arg4;
- (void)addNewRemotePlan:(_Bool)arg1 userConsent:(int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)addNewPlanWithAddress:(id)arg1 matchingId:(id)arg2 oid:(id)arg3 confirmationCode:(id)arg4 duringBuddy:(_Bool)arg5 userConsent:(int)arg6 completion:(CDUnknownBlockType)arg7;
- (void)addNewPlanWithCardData:(id)arg1 duringBuddy:(_Bool)arg2 userConsent:(int)arg3 completion:(CDUnknownBlockType)arg4;
- (void)addNewPlanWithCardData:(id)arg1 triggerType:(int)arg2 userConsent:(int)arg3 completion:(CDUnknownBlockType)arg4;
- (void)addNewPlanWithCarrierItem:(id)arg1 duringBuddy:(_Bool)arg2 userConsent:(int)arg3 completion:(CDUnknownBlockType)arg4;
- (void)addNewPlanWithUserInWebsheetWithCompletion:(CDUnknownBlockType)arg1;
- (void)addNewPlanWithAddress:(id)arg1 matchingId:(id)arg2 oid:(id)arg3 confirmationCode:(id)arg4 triggerType:(int)arg5 userConsent:(int)arg6 completion:(CDUnknownBlockType)arg7;
- (void)addNewPlanWithFlowType:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
- (void)addNewPlanWithCardData:(id)arg1 confirmationCode:(id)arg2 triggerType:(int)arg3 userConsent:(int)arg4 completion:(CDUnknownBlockType)arg5;
- (void)addNewPlanWithCarrierItem:(id)arg1 triggerType:(int)arg2 userConsent:(int)arg3 completion:(CDUnknownBlockType)arg4;
...
- (unsigned int)getSupportedFlowTypes;
