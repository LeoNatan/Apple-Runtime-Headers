...
- (void)addNewRemotePlanWithAddress:(NSString *)arg1 matchingId:(NSString *)arg2 oid:(NSString *)arg3 confirmationCode:(NSString *)arg4 isPairing:(_Bool)arg5 userConsent:(int)arg6 completion:(void (^)(NSError *))arg7;
- (void)addNewRemotePlanWithCardData:(NSString *)arg1 confirmationCode:(NSString *)arg2 isPairing:(_Bool)arg3 userConsent:(int)arg4 completion:(void (^)(NSError *))arg5;
- (void)addNewRemotePlan:(_Bool)arg1 userConsent:(int)arg2 completion:(void (^)(NSError *))arg3;
- (void)finishRemoteProvisioningWithCompletion:(void (^)(_Bool))arg1;
- (void)startRemoteProvisioningWithCompletion:(void (^)(_Bool))arg1;
- (void)shouldShowAddNewRemotePlanWithFlowTypeAndTrialPlanType:(void (^)(_Bool, unsigned int, NSString *, NSError *))arg1;
