...
- (id)description;
- (id)multiwayVideoStreamAtIndex:(unsigned int)arg1;
- (unsigned int)multiwayVideoStreamsCount;
...
- (id)multiwayAudioStreamsAtIndex:(unsigned int)arg1;
- (unsigned int)multiwayAudioStreamsCount;
- (void)addMultiwayAudioStreams:(id)arg1;
- (void)clearMultiwayAudioStreams;
@property(readonly, nonatomic) _Bool hasCaptionsSettings;
- (id)bandwidthSettingsAtIndex:(unsigned int)arg1;
- (unsigned int)bandwidthSettingsCount;
