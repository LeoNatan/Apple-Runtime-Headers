...
@property unsigned long lastActiveCall; // @synthesize lastActiveCall;
...
- (void)setPeerProtocolVersion:(unsigned int)arg1 forCallID:(unsigned long)arg2;
- (void)handleCellTechChange:(int)arg1 cellularMaxPktLen:(unsigned short)arg2;
- (void)processRelayUpdate:(unsigned long)arg1 updateDict:(id)arg2 didOriginateRequest:(_Bool)arg3;
- (void)processRelayRequestResponse:(unsigned long)arg1 responseDict:(id)arg2 didOriginateRequest:(_Bool)arg3;
...
- (struct CGSize)remoteFrameSizeForCallID:(unsigned long)arg1;
...
- (_Bool)startConnectionWithParticipantID:(id)arg1 callID:(unsigned long)arg2 usingInviteData:(id)arg3 isCaller:(_Bool)arg4 capabilities:(id)arg5 idsSocket:(int)arg6 destination:(id)arg7 error:(id *)arg8;
- (void)setUpAudioIO:(int)arg1;
- (_Bool)startConnectionWithParticipantID:(id)arg1 callID:(unsigned long)arg2 usingInviteData:(id)arg3 isCaller:(_Bool)arg4 relayResponseDict:(id)arg5 didOriginateRelayRequest:(_Bool)arg6 capabilities:(id)arg7 idsSocket:(int)arg8 destination:(id)arg9 error:(id *)arg10;
- (_Bool)startConnectionWithParticipantID:(id)arg1 callID:(unsigned long)arg2 oldCallID:(unsigned long)arg3 usingInviteData:(id)arg4 isCaller:(_Bool)arg5 relayResponseDict:(id)arg6 didOriginateRelayRequest:(_Bool)arg7 capabilities:(id)arg8 idsSocket:(int)arg9 destination:(id)arg10 error:(id *)arg11;
- (int)conferenceOperatingMode;
- (void)setConferenceOperatingMode:(int)arg1;
- (_Bool)shouldReinitializeCallWithDuration:(double)arg1 forCallID:(unsigned long)arg2;
- (void)updateCapabilities:(id)arg1 forCallID:(unsigned long)arg2;
- (void)updateCapabilities:(id)arg1 forSession:(id)arg2;
- (void)setPeerReportingID:(id)arg1 sessionID:(id)arg2 callID:(unsigned long)arg3;
- (void)setSessionID:(id)arg1 callID:(unsigned long)arg2;
- (void)setPeerCN:(id)arg1 callID:(unsigned long)arg2;
- (_Bool)setPauseVideo:(_Bool)arg1 callID:(unsigned long)arg2 error:(id *)arg3;
- (_Bool)setPauseAudio:(_Bool)arg1 callID:(unsigned long)arg2 error:(id *)arg3;
- (void)setSendAudio:(_Bool)arg1 forCallID:(unsigned long)arg2;
- (_Bool)shouldSendAudioForCallID:(unsigned long)arg1;
- (_Bool)getIsAudioPaused:(_Bool *)arg1 callID:(unsigned long)arg2 error:(id *)arg3;
- (_Bool)getIsVideoPaused:(_Bool *)arg1 callID:(unsigned long)arg2 error:(id *)arg3;
...
- (void)connectionBlobForParticipantID:(id)arg1 callID:(unsigned long)arg2 block:(CDUnknownBlockType)arg3 queue:(id)arg4 caller:(id)arg5;
- (void)inviteDataForParticipantID:(id)arg1 callID:(unsigned long)arg2 remoteInviteData:(id)arg3 nonCellularCandidateTimeout:(unsigned int)arg4 block:(CDUnknownBlockType)arg5 queue:(id)arg6 caller:(id)arg7;
- (void)cleanupQueues;
...
- (_Bool)updateSpeaking:(unsigned long)arg1 timeStamp:(unsigned int)arg2;
...
- (_Bool)matchesCallID:(unsigned long)arg1;
...
- (void)stopCallID:(unsigned long)arg1 didRemoteCancel:(_Bool)arg2 error:(id)arg3;
- (void)unlock;
- (void)rdlock;
- (int)tryrdlock;
- (void)wrlock;
...
- (void)session:(id)arg1 localAudioEnabled:(_Bool)arg2 withCallID:(unsigned long)arg3 error:(id)arg4;
- (void)session:(id)arg1 remoteAudioEnabled:(_Bool)arg2 withCallID:(unsigned long)arg3;
...
- (void)remoteVideoDidPause:(_Bool)arg1 callID:(unsigned long)arg2;
- (void)remoteAudioDidPause:(_Bool)arg1 callID:(unsigned long)arg2;
...
- (void)session:(id)arg1 withCallID:(unsigned long)arg2 videoIsDegraded:(_Bool)arg3 isRemote:(_Bool)arg4;
- (void)session:(id)arg1 withCallID:(unsigned long)arg2 networkHint:(_Bool)arg3;
- (void)sourceFrameRateDidChange:(unsigned int)arg1;
- (void)thermalLevelDidChange:(int)arg1;
- (void)setConferenceVisualRectangle:(struct CGRect)arg1 forCallID:(unsigned long)arg2;
- (void)setConferenceState:(unsigned int)arg1 forCallID:(unsigned long)arg2;
