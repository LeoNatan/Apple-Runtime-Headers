...
+ (_Bool)supportsCodecRateModesForCodecType:(int)arg1;
+ (unsigned int)bitrateForCodecType:(int)arg1 mode:(int)arg2;
+ (int)payloadForCodecType:(int)arg1;
+ (int)codecTypeForPayload:(int)arg1;
+ (float)qualityForPayload:(int)arg1 forBitrate:(unsigned long)arg2;
+ (_Bool)shouldEnablePacketSizeLimitForPayload:(int)arg1;
+ (unsigned long)internalBundleFactorForPayload:(int)arg1;
...
+ (unsigned long)sampleRateForPayload:(int)arg1;
