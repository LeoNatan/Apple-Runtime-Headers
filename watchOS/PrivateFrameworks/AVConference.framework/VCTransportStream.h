...
- (long)unregisterPacketCallback;
- (long)registerPacketCallbackContext:(void *)arg1 callback:(CDUnknownBlockType)arg2;
- (void)VCTransportStreamUnblock;
- (long)receivePacket:(CDStruct_88f6cd69 *)arg1;
- (long)VCTransportStreamSendPacket:(CDStruct_88f6cd69 *)arg1;
- (void)dealloc;
