...
- (void)session:(VCCallSession *)arg1 localAudioEnabled:(_Bool)arg2 withCallID:(unsigned long)arg3 error:(NSError *)arg4;
- (void)session:(VCCallSession *)arg1 remoteAudioEnabled:(_Bool)arg2 withCallID:(unsigned long)arg3;
...
- (void)session:(VCCallSession *)arg1 withCallID:(unsigned long)arg2 networkHint:(_Bool)arg3;
- (void)session:(VCCallSession *)arg1 withCallID:(unsigned long)arg2 videoIsDegraded:(_Bool)arg3 isRemote:(_Bool)arg4;
