...
@class AVCStatisticsCollector, DTMFEventHandler, NSMutableArray, NSObject<OS_dispatch_source>, NSObject<VCMediaStreamSyncSourceDelegate>, NSString, VCAudioIO, VCAudioPayload, VCAudioTransmitter, WRMClient;
...
+ (unsigned char)audioIODirectionWithMediaStreamDirection:(int)arg1;
...
- (_Bool)createAudioTransmitter:(int)arg1;
...
- (int)operatingModeForAudioStreamMode:(int)arg1;
...
- (unsigned long)preferredAudioBitrateForPayload:(int)arg1;
...
- (unsigned int)internalSampleRateForCodecType:(int)arg1;
