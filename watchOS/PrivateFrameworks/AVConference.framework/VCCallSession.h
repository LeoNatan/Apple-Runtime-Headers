...
+ (long)setRxPayloadList:(struct tagHANDLE *)arg1 withPayloadTypes:(id)arg2 isRedEnabled:(_Bool)arg3;
+ (long)setRxPayloadList:(struct tagHANDLE *)arg1 withPayloadTypes:(id)arg2;
...
@property int sipState; // @synthesize sipState=_sipState;
...
@property int videoPayload; // @synthesize videoPayload;
...
@property int connectionChangeState; // @synthesize connectionChangeState;
...
- (void)setSessionConferenceVisualRectangle:(struct CGRect)arg1 callID:(unsigned long)arg2;
- (void)setSessionConferenceState:(unsigned int)arg1 callID:(unsigned long)arg2;
...
- (id)getVideoRuleForVideoMode:(unsigned int)arg1 interface:(int)arg2 sessionBitrate:(int *)arg3;
...
- (_Bool)findFeatureString:(const char *)arg1 value:(char *)arg2 valueLength:(unsigned int)arg3 withPrefix:(const char *)arg4;
...
- (long)Conference_SetBWEstMode:(_Bool)arg1 bFakeLargeFrameMode:(_Bool)arg2;
...
- (long)processMediaControlInfo:(void *)arg1 isAudio:(_Bool)arg2;
- (long)fillMediaControlInfo:(void *)arg1;
...
- (int)calculateSIPEndAction:(_Bool)arg1 currentState:(int)arg2 error:(id)arg3;
- (void)notifyDelegateAndEndCall:(int)arg1 didRemoteCancel:(_Bool)arg2 error:(id)arg3;
...
- (long)setupEncryptionWithKey:(const struct __CFData **)arg1 confIndex:(int *)arg2;
...
- (_Bool)setupIDSConnectionForCallID:(unsigned long)arg1 destination:(id)arg2 socket:(int)arg3 error:(id *)arg4;
