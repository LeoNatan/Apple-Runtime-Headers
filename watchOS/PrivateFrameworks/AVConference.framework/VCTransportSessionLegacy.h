...
@property unsigned long remoteCallID; // @synthesize remoteCallID=_remoteCallID;
...
- (id)createInitiateRelayDictionaryForCall:(unsigned long)arg1 primaryConnection:(struct tagCONNRESULT *)arg2;
...
- (void)setupInitialSecondaryRelayWithCallbackRelayFlag:(_Bool)arg1 callID:(unsigned long)arg2 connectionId:(int)arg3;
- (void)setupSecondaryRelayForCall:(unsigned long)arg1 callerRequired:(_Bool)arg2;
...
- (void)createSecondaryRelayDispatchTimer:(float)arg1 callID:(unsigned long)arg2 callerRequired:(_Bool)arg3;
...
- (void)dealloc;
- (id)initWithCallID:(unsigned long)arg1 reportingAgent:(id)arg2;
