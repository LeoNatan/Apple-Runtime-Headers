...
- (void)dealloc;
- (id)initWithOperatingMode:(int)arg1 payloadConfigs:(id)arg2 packetsPerBundle:(id)arg3 supportedRedNumPayloads:(id)arg4 headerSize:(unsigned int)arg5 usingCellular:(_Bool)arg6 useCaseWatchContinuity:(_Bool)arg7 defaultMaxCap:(unsigned int)arg8 alwaysOnAudioRedundancyEnabled:(_Bool)arg9 cellularAllowRedLowBitratesEnabled:(_Bool)arg10 wifiAllowRedLowBitratesEnabled:(_Bool)arg11;
