...
@class NSObject<OS_dispatch_queue>, NSString, VCDatagramChannelIDS, VCMediaStreamConfig, VCWeakObjectHolder;
...
- (long)getKeyDerivationCryptoSet:(CDStruct_839290c6 *)arg1 withKeyMaterial:(id)arg2;
...
- (long)getCryptoSet:(struct tagSRTPExchangeInfo *)arg1 withMasterKey:(id)arg2;
- (int)getSRTPMasterKeyLength:(int)arg1;
- (int)SRTPCipherSuiteForVCMediaStreamCipherSuite:(int)arg1;
