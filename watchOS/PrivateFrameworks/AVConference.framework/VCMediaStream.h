...
- (long)handleMediaCallbackNotification:(int)arg1 inData:(void *)arg2 outData:(void *)arg3;
...
- (id)initWithTransportSessionID:(unsigned long)arg1 localSSRC:(unsigned int)arg2;
- (id)initWithTransportSessionID:(unsigned long)arg1;
- (id)init;
