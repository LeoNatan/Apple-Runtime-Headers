...
- (_Bool)translateMediaControlInfo:(void *)arg1 feedbackMessage:(CDStruct_094a8fc2 *)arg2;
...
- (_Bool)processRateControlFeedbackMessage:(CDStruct_094a8fc2)arg1 type:(unsigned int)arg2 error:(id *)arg3;
- (_Bool)getVCStatisticsFeedbackMessage:(CDStruct_b3eb8f4a *)arg1 time:(double)arg2;
