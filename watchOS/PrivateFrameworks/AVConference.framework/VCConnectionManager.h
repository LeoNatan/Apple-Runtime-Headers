...
@class NSObject<OS_dispatch_queue>, NSString, VCConnectionHealthMonitor, VCStatsRecorder;
...
@property unsigned long callID; // @synthesize callID=_callID;
...
- (long)processConnectionHealthFromControlInfo:(void *)arg1;
- (long)setConnectionHealthOnControlInfo:(void *)arg1;
...
- (long)processRemoteWRMSuggestion:(int)arg1 isRemoteDuplicating:(_Bool)arg2;
- (long)processWRMNotification:(CDStruct_d2860d30 *)arg1;
- (long)setWRMUpdateCallback:(CDUnknownFunctionPointerType)arg1 requestNotificationCallback:(CDUnknownFunctionPointerType)arg2 withContext:(void *)arg3;
