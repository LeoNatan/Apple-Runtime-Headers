...
+ (long)integerValueForKey:(struct __CFString *)arg1 defaultValue:(long)arg2;
+ (long)integerValueForKey:(struct __CFString *)arg1;
...
@property(readonly) _Bool rateControlAllowRedLowBitrates;
