...
@interface VCSessionMediaStreamConfigurationProvider : NSObject
{
    ...
    int _highestEncodingResolution;
...
@property(readonly, nonatomic) int highestEncodingResolution; // @synthesize highestEncodingResolution=_highestEncodingResolution;
