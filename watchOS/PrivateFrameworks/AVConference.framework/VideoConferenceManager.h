...
- (void)videoConference:(id)arg1 withCallID:(unsigned long)arg2 didPauseVideo:(_Bool)arg3 error:(id)arg4;
- (void)videoConference:(id)arg1 withCallID:(unsigned long)arg2 isSendingAudio:(_Bool)arg3 error:(id)arg4;
- (void)videoConference:(id)arg1 withCallID:(unsigned long)arg2 didPauseAudio:(_Bool)arg3 error:(id)arg4;
