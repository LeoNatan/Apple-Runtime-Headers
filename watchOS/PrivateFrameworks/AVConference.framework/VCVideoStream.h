...
@class NSArray, NSNumber, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSString, VCVideoCaptureConverter, VCVideoReceiverBase, VCVideoRule, VCVideoTransmitterBase;
...
- (id)initWithTransportSessionID:(unsigned long)arg1 ssrc:(unsigned int)arg2 streamToken:(int)arg3;
- (id)init;
