...
@property(nonatomic) unsigned long visibleRectCropping; // @synthesize visibleRectCropping;
...
@property(nonatomic) unsigned long cellBandwidth; // @synthesize cellBandwidth;
@property(nonatomic) unsigned long maxBandwidth; // @synthesize maxBandwidth;
@property(nonatomic) unsigned long auNumber; // @synthesize auNumber;
