...
@class NSString, UIBezierPath, UIColor, UIFont, UIImage, UIImageView, UILabel, UIPanGestureRecognizer, UITapGestureRecognizer, UIView, UIView<PUICActionSliderLabel>, _UIBackdropView, _UIVibrantSettings;
