...
- (void)_scene:(UIScene *)arg1 didTransitionFromActivationState:(int)arg2 withReasonsMask:(unsigned int)arg3;
- (void)_scene:(UIScene *)arg1 willTransitionToActivationState:(int)arg2 withReasonsMask:(unsigned int)arg3;
