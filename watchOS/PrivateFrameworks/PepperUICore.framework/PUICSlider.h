...
@class NSArray, NSObject<OS_dispatch_source>, NSString, PUICCrownInputSequencer, UIColor, UIImage, UIImageView, UIView, _PUICQueuedSetEnabledRequest, _PUICQueuedSetValueRequest, _PUICSliderAccessoryState;

@interface PUICSlider : UISlider <PUICCrownInputSequencerDelegate, CAAnimationDelegate>
{
    int _touchTarget;
