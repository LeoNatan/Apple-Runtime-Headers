...
- (void)lockDatabaseForReason:(int)arg1 withCompletion:(void (^)(_Bool, NSError *))arg2;
- (void)cancelImportOperation:(unsigned int)arg1 completionHandler:(void (^)(_Bool, NSError *))arg2;
- (void)performImport:(ML3DatabaseImport *)arg1 fromSource:(unsigned int)arg2 withUUID:(NSUUID *)arg3 completionHandler:(void (^)(_Bool, NSError *, NSData *))arg4;
- (void)setOptions:(NSDictionary *)arg1 withCompletionHandler:(void (^)(_Bool, NSError *))arg2;
- (void)performDatabaseOperation:(unsigned int)arg1 withAttributes:(NSDictionary *)arg2 options:(NSDictionary *)arg3 completionHandler:(void (^)(_Bool, NSError *))arg4;
...
- (void)beginTransactionForDatabaseAtPath:(NSString *)arg1 withPriorityLevel:(unsigned int)arg2 options:(unsigned int)arg3 completionHandler:(void (^)(NSUUID *, NSError *))arg4;
