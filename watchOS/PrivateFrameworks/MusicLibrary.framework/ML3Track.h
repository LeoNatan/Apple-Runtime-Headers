...
+ (id)orderingTermsForITTGTrackOrder:(unsigned long)arg1 descending:(_Bool)arg2;
...
- (_Bool)_populateLocationPropertiesWithPath:(id)arg1 protectionType:(int)arg2 fromLibrary:(id)arg3 usingConnection:(id)arg4;
- (void)populateLocationPropertiesWithPath:(id)arg1 protectionType:(int)arg2 completionBlock:(CDUnknownBlockType)arg3;
