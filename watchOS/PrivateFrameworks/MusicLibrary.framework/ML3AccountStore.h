...
+ (id)defaultStore;
- (id)_accountsWithAccountTypeIdentifier:(id)arg1 options:(unsigned int)arg2 error:(id *)arg3;
- (id)_init;
@property(readonly, copy, nonatomic) NSString *accountDSID;
- (id)altDSIDForAccountWithDSID:(long long)arg1 options:(unsigned int)arg2 error:(id *)arg3;
