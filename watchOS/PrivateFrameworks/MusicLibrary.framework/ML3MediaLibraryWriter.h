...
+ (id)writerErrorWithCode:(int)arg1 description:(id)arg2 userInfo:(id)arg3;
- (void).cxx_destruct;
...
- (void)performDatabaseOperation:(unsigned int)arg1 onLibrary:(id)arg2 withAttributes:(id)arg3 options:(id)arg4 fromClient:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
- (id)beginTransactionForLibrary:(id)arg1 withClient:(id)arg2 options:(unsigned int)arg3 error:(id *)arg4;
- (id)description;
- (void)dealloc;
- (id)init;
