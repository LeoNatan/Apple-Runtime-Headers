...
@class FPItemID, FPSandboxingURLWrapper, NSArray, NSDate, NSFileHandle, NSString, NSURL;
...
- (void)startProvidingItemAtURL:(NSURL *)arg1 readingOptions:(unsigned int)arg2 completionHandler:(void (^)(NSError *))arg3;
