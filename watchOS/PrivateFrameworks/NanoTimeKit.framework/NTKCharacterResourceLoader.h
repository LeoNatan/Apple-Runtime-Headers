...
@interface NTKCharacterResourceLoader : NSObject
{
    ...
    unsigned int _bufferOffsetBackground;
    unsigned int _bufferOffsetBody;
    unsigned int _bufferOffsetFoot;
    unsigned int _bufferOffsetArm;
    unsigned int _bufferOffsetHand;
    unsigned int _bufferOffsetHead;
    unsigned int _bufferOffsetSkirt;
    unsigned int _bufferOffsetFlower;
}
...
@property(readonly, nonatomic) unsigned int bufferOffsetHand; // @synthesize bufferOffsetHand=_bufferOffsetHand;
@property(readonly, nonatomic) unsigned int bufferOffsetArm; // @synthesize bufferOffsetArm=_bufferOffsetArm;
@property(readonly, nonatomic) unsigned int bufferOffsetFoot; // @synthesize bufferOffsetFoot=_bufferOffsetFoot;
...
- (void)_loadTextures;
- (void)localeChanged;
- (id)_loadBank:(id)arg1 toArrays:(unsigned int)arg2 allowNewKeys:(_Bool)arg3;
- (id)getPipelineForProgramType:(unsigned int)arg1;
- (void)_loadPrograms;
- (void)_setupPipelineForType:(unsigned int)arg1 vertex:(id)arg2 fragment:(id)arg3 blending:(_Bool)arg4 inLibrary:(id)arg5 librarySPI:(id)arg6;
...
- (void)dealloc;
- (id)initForDevice:(id)arg1 withPixelFormat:(unsigned int)arg2;
