...
@class NSDate, NSDateInterval, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString;

@interface NTKUpNextTimer : NSObject <CSLPISystemSleepGlobalObserverObserver>
{
