...
#import <NanoTimeKit/CLKVideoPlayerViewDelegate-Protocol.h>
...
@interface NTKVideoPlayerView : UIView <CLKVideoPlayerViewDelegate>
{
    ...
    int _currentDataMode;
    unsigned int _prerollState;
...
- (void)_advanceListingForEvent:(unsigned int)arg1;
- (void)_loadCurrentListing;
- (void)_playNextVideoForEvent:(unsigned int)arg1 animated:(_Bool)arg2;
