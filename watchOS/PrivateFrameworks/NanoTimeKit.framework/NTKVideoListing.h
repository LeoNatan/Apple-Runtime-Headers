...
- (void)_setHasAssets;
- (id)initWithName:(id)arg1 videoName:(id)arg2 transitionImageName:(id)arg3 overlayColor:(id)arg4 theme:(unsigned int)arg5 variant:(int)arg6 clip:(int)arg7 tags:(unsigned int)arg8;
