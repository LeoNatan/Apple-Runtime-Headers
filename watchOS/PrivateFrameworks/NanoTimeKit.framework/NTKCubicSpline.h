...
-     // Error parsing type: v16@0:4^^8^^12, name: getControlPoints:processedPoints:
- (void)interpolateWithSteps:(int)arg1 interpolation:(CDUnknownBlockType)arg2;
-     // Error parsing type: 16@0:4f8^12, name: interpolateAt:derivative:
-     // Error parsing type: 12@0:4f8, name: interpolateAt:
- (void)process;
