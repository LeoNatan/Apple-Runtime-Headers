...
#import <NanoTimeKit/RERelevanceEngineObserver-Protocol.h>
...
- (_Bool)_shouldPrewarmForFaceCollection:(id)arg1;
- (_Bool)_faceCollectionNeedsLiveElementCoordinator:(id)arg1;
- (_Bool)_shouldPrewarmOnDeck;
- (_Bool)_shouldPrewarmInLibrary;
- (_Bool)_shouldPrewarmInAddable;
