...
@class CLKComplicationTimelineEntry, NMRNowPlayingController, NSNumber, NSObject<OS_dispatch_queue>, NSString;

@interface NTKNowPlayingComplicationDataSource : NTKComplicationDataSource <NMROriginObserverDelegate, NMRNowPlayingControllerDelegate>
{
