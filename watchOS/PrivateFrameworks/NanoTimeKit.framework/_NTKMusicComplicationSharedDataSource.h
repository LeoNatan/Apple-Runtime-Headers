...
@class NMUNowPlayingTimeline, NSHashTable, NSMutableArray, NSObject<OS_dispatch_queue>, NSString, NTKMusicNewUserManager, NTKMusicTimelineEntry, _NTKMusicTimelineEntryList, _NTKOneShotTimer;
