...
- (id)timeTravelEntry;
- (id)nowEntry;
- (void)extendLeftFromDate:(id)arg1 withEntries:(id)arg2 tritiumUpdatePriority:(int)arg3;
- (void)extendRightFromDate:(id)arg1 withEntries:(id)arg2 tritiumUpdatePriority:(int)arg3;
