...
- (void)_nextPhotoAnimated:(_Bool)arg1 skipUpdatingDateAttributes:(_Bool)arg2 method:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)_displayCachedPhoto:(id)arg1 skipUpdatingDateAttributes:(_Bool)arg2 animated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
