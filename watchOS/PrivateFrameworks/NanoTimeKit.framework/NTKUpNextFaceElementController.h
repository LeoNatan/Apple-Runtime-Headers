...
@interface NTKUpNextFaceElementController : NSObject <NTKUpNextElementCoordinatorObserver, CSLSBacklightObserver>
{
...
- (void)_enumerateCoordinatorElementWithOptions:(unsigned int)arg1 usingBlock:(CDUnknownBlockType)arg2;
...
- (unsigned int)numberOfElementsInSection:(unsigned int)arg1;
