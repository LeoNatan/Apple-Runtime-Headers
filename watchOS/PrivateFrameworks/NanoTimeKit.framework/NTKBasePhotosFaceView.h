...
#import <NanoTimeKit/NTKPhotoImageViewDelegate-Protocol.h>
#import <NanoTimeKit/UIGestureRecognizerDelegate-Protocol.h>

@class NSString, NSTimer, NTKAlbumEmptyView, NTKPhotoImageView, NTKTaskScheduler, NTKUtilityComplicationFactory, UIColor, UILongPressGestureRecognizer, UIView;
