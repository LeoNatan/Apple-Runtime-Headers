...
@property(readonly, nonatomic) int imageViewContentMode; // @synthesize imageViewContentMode=_imageViewContentMode;
...
- (void)layoutSubviews;
- (void)setImageProvider:(id)arg1 reason:(int)arg2;
