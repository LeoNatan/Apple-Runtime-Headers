...
@interface _Arms : _Geometry
{
    ...
    NSNumber *_texArm;
    unsigned int _mtlBufHandOffset;
    unsigned int _mtlBufArmOffset;
...
@property(nonatomic) unsigned int mtlBufArmOffset; // @synthesize mtlBufArmOffset=_mtlBufArmOffset;
@property(nonatomic) unsigned int mtlBufHandOffset; // @synthesize mtlBufHandOffset=_mtlBufHandOffset;
