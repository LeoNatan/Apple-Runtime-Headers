...
+ (int)formattingContextFromIUDisplayNameContext:(unsigned int)arg1;
...
- (id)displayNameForRegion:(id)arg1 displayLanguage:(id)arg2 capitalization:(unsigned int)arg3 short:(_Bool)arg4;
...
- (id)displayNameForLocale:(id)arg1 displayLanguage:(id)arg2 capitalization:(unsigned int)arg3 short:(_Bool)arg4;
