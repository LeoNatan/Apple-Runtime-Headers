...
- (id)_predicateForFetchingAccountsWithManagedAccountTypeID:(id)arg1 options:(unsigned int)arg2;
- (id)_accountsWithAccountType:(id)arg1 options:(unsigned int)arg2 error:(id *)arg3;
- (id)_accountsWithAcountType:(id)arg1 error:(id *)arg2;
- (void)accountsWithAccountType:(id)arg1 options:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
