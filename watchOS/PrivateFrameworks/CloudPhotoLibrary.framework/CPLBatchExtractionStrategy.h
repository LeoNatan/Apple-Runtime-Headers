...
@interface CPLBatchExtractionStrategy : NSObject
{
    ...
    unsigned int _maximumRecordCountPerBatch;
    NSString *_name;
}
...
+ (void)setMaximumRecordCountPerBatch:(unsigned int)arg1;
- (void).cxx_destruct;
@property(readonly, copy, nonatomic) NSString *name; // @synthesize name=_name;
@property(nonatomic) unsigned int maximumRecordCountPerBatch; // @synthesize maximumRecordCountPerBatch=_maximumRecordCountPerBatch;
