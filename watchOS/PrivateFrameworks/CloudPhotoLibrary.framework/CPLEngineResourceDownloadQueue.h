...
@interface CPLEngineResourceDownloadQueue : CPLEngineStorage <CPLAbstractObject>
{
    ...
    unsigned int _inflightTransferTasksCount;
    unsigned int _transferTasksBurstCount;
    unsigned int _lastTransferTasksBurstCount;
...
- (id)dequeueNextBackgroundDownloadTasksForResourceType:(unsigned int)arg1 maximumSize:(unsigned long long)arg2 maximumCount:(unsigned int)arg3 error:(id *)arg4;
