...
+ (id)descriptionForProvideContentResult:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int libraryOptions; // @synthesize libraryOptions=_libraryOptions;
...
- (void)resetCacheWithOption:(unsigned int)arg1 reason:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (_Bool)_setStatus:(unsigned int)arg1 andError:(id)arg2;
...
- (void)getStreamingURLForResource:(id)arg1 intent:(unsigned int)arg2 hints:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (id)initWithClientLibraryBaseURL:(id)arg1 cloudLibraryStateStorageURL:(id)arg2 cloudLibraryResourceStorageURL:(id)arg3 libraryIdentifier:(id)arg4 options:(unsigned int)arg5;
