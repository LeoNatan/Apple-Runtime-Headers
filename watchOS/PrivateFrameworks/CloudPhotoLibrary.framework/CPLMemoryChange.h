...
@property(nonatomic) int notificationState; // @synthesize notificationState=_notificationState;
...
@property(nonatomic) int subcategory; // @synthesize subcategory=_subcategory;
