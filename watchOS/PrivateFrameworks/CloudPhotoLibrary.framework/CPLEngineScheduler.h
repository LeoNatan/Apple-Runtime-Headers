...
- (void)noteSyncSession:(id)arg1 failedDuringPhase:(unsigned int)arg2 withError:(id)arg3;
...
- (void)noteSyncSession:(id)arg1 stateWillBeAttempted:(unsigned int)arg2;
...
- (void)forceStartSyncSession:(id)arg1 withMinimalPhase:(unsigned int)arg2;
...
- (void)_startSyncSession:(id)arg1 withMinimalPhase:(unsigned int)arg2 rewind:(_Bool)arg3;
