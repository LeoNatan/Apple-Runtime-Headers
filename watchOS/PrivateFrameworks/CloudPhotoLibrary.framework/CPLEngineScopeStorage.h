...
- (_Bool)upgradeScopesWithNewLibraryOption:(unsigned int)arg1 error:(id *)arg2;
- (unsigned int)estimatedAssetCountForScope:(id)arg1;
- (unsigned long long)estimatedSizeForScope:(id)arg1;
- (_Bool)storeEstimatedSize:(unsigned long long)arg1 estimatedAssetCount:(unsigned int)arg2 forScope:(id)arg3 error:(id *)arg4;
- (_Bool)supportedFeatureVersionIsMostRecentForScope:(id)arg1;
- (_Bool)storeSupportedFeatureVersionInLastSync:(unsigned int)arg1 forScope:(id)arg2 error:(id *)arg3;
- (unsigned int)supportedFeatureVersionInLastSyncForScope:(id)arg1;
...
- (_Bool)updateInitialSyncTransportGroupEstimatedSize:(unsigned long long)arg1 assetCount:(unsigned int)arg2 forScope:(id)arg3 error:(id *)arg4;
...
- (_Bool)valueForFlag:(int)arg1 forScope:(id)arg2;
- (_Bool)setValue:(_Bool)arg1 forFlag:(int)arg2 forScope:(id)arg3 error:(id *)arg4;
...
- (int)stableScopeIndexForScopeIdentifier:(id)arg1;
...
- (id)scopeIdentifierForCloudScopeIndex:(int)arg1;
- (id)scopeIdentifierForLocalScopeIndex:(int)arg1;
- (int)indexForCloudScopeIdentifier:(id)arg1;
- (int)indexForLocalScopeIdentifier:(id)arg1;
- (id)scopedIdentifierForCloudScopedIdentifier:(id)arg1;
- (id)scopedIdentifierForLocalScopedIdentifier:(id)arg1;
- (_Bool)setScopeType:(int)arg1 forScope:(id)arg2 error:(id *)arg3;
- (_Bool)deleteScopeWithIdentifier:(id)arg1 error:(id *)arg2;
- (id)createScopeWithIdentifier:(id)arg1 scopeType:(int)arg2 flags:(int)arg3 transportScope:(id)arg4 error:(id *)arg5;
- (_Bool)_handledDisabledFeaturesForScopeIfNecessary:(id)arg1 type:(int)arg2 error:(id *)arg3;
...
- (_Bool)setScope:(id)arg1 hasCompletedTransportUpdate:(int)arg2 error:(id *)arg3;
- (int)transportUpdateTaskForScope:(id)arg1;
...
- (id)scopeChangesNeedingToBePulledByClientWithMaximumCount:(unsigned int)arg1;
...
- (_Bool)setScope:(id)arg1 hasCompletedPullFromTransportTask:(int)arg2 error:(id *)arg3;
- (int)pullFromTransportTaskForScope:(id)arg1;
...
- (_Bool)setScope:(id)arg1 hasCompletedPushToTransportTask:(int)arg2 error:(id *)arg3;
- (int)pushToTransportTaskForScope:(id)arg1;
...
- (id)_scopeWithStableIndex:(int)arg1;
- (id)_scopeWithCloudIndex:(int)arg1;
- (id)_scopeWithLocalIndex:(int)arg1;
