...
@property(readonly, nonatomic) unsigned int estimatedLocalLibraryAssetCount;
@property(readonly, nonatomic) unsigned long long estimatedLocalLibrarySize;
- (_Bool)storeEstimatedLocalLibrarySize:(unsigned long long)arg1 estimatedAssetCount:(unsigned int)arg2 error:(id *)arg3;
- (id)statusDictionary;
- (id)status;
...
- (unsigned int)countOfRecordsWithRelatedIdentifier:(id)arg1 class:(Class)arg2;
