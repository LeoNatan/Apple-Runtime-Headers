...
- (_Bool)addAddEventForRecordWithLocalIdentifier:(id)arg1 direction:(unsigned int)arg2 error:(id *)arg3;
- (_Bool)addDeleteEventForRecordWithLocalIdentifier:(id)arg1 direction:(unsigned int)arg2 error:(id *)arg3;
...
- (id)setupCloudIdentifier:(id)arg1 forLocalIdentifier:(id)arg2 isFinal:(_Bool)arg3 direction:(unsigned int)arg4 error:(id *)arg5;
- (_Bool)addCloudIdentifier:(id)arg1 forLocalIdentifier:(id)arg2 isFinal:(_Bool)arg3 direction:(unsigned int)arg4 error:(id *)arg5;
