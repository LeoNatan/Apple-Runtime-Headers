...
+ (id)columnHeadersWithOptions:(unsigned int)arg1 maximumLength:(unsigned int)arg2 memorySizeDivisor:(unsigned int)arg3 hasFractionalPageSizes:(_Bool)arg4;
...
- (struct _VMURange)range;
- (id)description;
- (id)descriptionWithOptions:(unsigned int)arg1 maximumLength:(unsigned int)arg2 memorySizeDivisor:(unsigned int)arg3 hasFractionalPageSizes:(_Bool)arg4;
...
- (id)initWithVMRegionData:(struct _VMUVMRegionData *)arg1 encodedVersion:(int)arg2 simpleSerializer:(id)arg3;
- (id)init;
