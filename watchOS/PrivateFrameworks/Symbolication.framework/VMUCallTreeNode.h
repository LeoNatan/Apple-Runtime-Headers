...
- (void)printCallTreeToFile:(struct __sFILE *)arg1 options:(unsigned int)arg2;
...
- (id)stringFromCallTreeWithOptions:(unsigned int)arg1;
...
- (void)_printCallTreeToFile:(struct __sFILE *)arg1 cumulativeOutput:(id)arg2 indentString:(id)arg3 branchPointCount:(unsigned int)arg4 topFunctions:(id)arg5 options:(unsigned int)arg6;
...
- (int)comparePuttingRetainCycleNodesAtTop:(id)arg1;
- (int)compare:(id)arg1;
