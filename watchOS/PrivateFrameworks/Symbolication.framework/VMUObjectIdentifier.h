...
- (id)_scanner;
- (struct _CSTypeRef)_symbolicator;
- (id)labelForMemory:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3 expectedClassName:(id)arg4;
...
- (id)labelForMemory:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3 usingHandlerBlock:(CDUnknownBlockType)arg4;
