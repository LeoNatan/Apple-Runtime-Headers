...
- (id)labelForMemory:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3 classInfo:(id)arg4 usingHandlerBlock:(CDUnknownBlockType)arg5;
...
- (id)labelForOSLog:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForOSDispatchQueue:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForOSDispatchMach:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSInlineData:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSConcreteMutableData:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSConcreteData:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSData:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSCFSet:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSSet:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSConcreteHashTable:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSCFDictionary:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSDictionary:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSArray:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForItemCount:(long)arg1;
- (id)labelForNSDate:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSNumber:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSBundle:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForCFBundle:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSPathStore2:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSURL:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSConcreteAttributedString:(void *)arg1 length:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3;
- (id)labelForNSCFStringAtRemoteAddress:(unsigned int)arg1 printDetail:(_Bool)arg2;
- (id)labelForNSString:(void *)arg1 mappedSize:(unsigned int)arg2 remoteAddress:(unsigned long long)arg3 printDetail:(_Bool)arg4;
