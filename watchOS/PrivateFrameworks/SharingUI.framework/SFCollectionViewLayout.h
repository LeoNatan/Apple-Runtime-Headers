...
- (float)_evaluateHorizontalItemOffsetForItemSize:(struct CGSize)arg1 inset:(struct UIEdgeInsets)arg2 containerWidth:(float)arg3 offscreenPeekInFactor:(float)arg4;
...
- (struct CGPoint)firstItemCenterForContainerWidth:(float)arg1;
- (id)init;
