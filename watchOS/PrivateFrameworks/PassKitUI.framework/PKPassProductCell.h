...
- (void).cxx_destruct;
@property(nonatomic) float middlePadding; // @synthesize middlePadding=_middlePadding;
...
@property(nonatomic) int accessibleLayout; // @synthesize accessibleLayout=_accessibleLayout;
