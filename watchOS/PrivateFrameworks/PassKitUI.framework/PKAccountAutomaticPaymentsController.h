...
@property(nonatomic) int paymentPreset; // @synthesize paymentPreset=_paymentPreset;
...
- (_Bool)canPerformScheduleAutomaticPaymentsWithPreset:(int)arg1 frequency:(int)arg2 amount:(id)arg3 paymentDate:(id)arg4;
- (int)minimumPaymentDayForPreset:(int)arg1;
...
- (id)initWithAccountService:(id)arg1 paymentWebService:(id)arg2 account:(id)arg3 context:(int)arg4;
