...
@interface PKSpendingSummaryViewController : UIViewController <PKSpendingSummaryFetcherObserver, UIScrollViewDelegate, PKSpendingSingleSummaryViewControllerDelegate>
{
    ...
    unsigned int _currentSummaryType;
    ...
    float _collectionViewVerticalOffset;
...
- (void)spendingSingleSummaryViewController:(id)arg1 changedSelection:(unsigned int)arg2;
- (void)spendingSingleSummaryViewController:(id)arg1 scrollViewDidScroll:(id)arg2;
- (_Bool)_canReloadVCs;
- (void)_reloadDataForVCAtIndex:(unsigned int)arg1 swap:(_Bool)arg2;
- (void)_switchPrimaryIndexToIndex:(unsigned int)arg1;
- (float)_yPositionForNonPrimaryVCs;
...
- (void)_retireVCForIndex:(unsigned int)arg1;
- (id)_recoverUnusedVC;
- (id)_dequeueNonVisibleVCForIndex:(unsigned int)arg1;
- (id)_dequeueVCForIndex:(unsigned int)arg1;
...
- (void)viewDidLoad;
- (void)dealloc;
- (id)initWithPaymentPass:(id)arg1 account:(id)arg2 fetcher:(id)arg3 weeks:(id)arg4 months:(id)arg5 type:(unsigned int)arg6 unit:(unsigned int)arg7 currentMonthTransactions:(id)arg8 upcomingScheduledPayments:(id)arg9;
