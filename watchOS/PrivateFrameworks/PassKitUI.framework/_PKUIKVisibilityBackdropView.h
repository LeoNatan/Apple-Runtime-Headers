...
{
    float _visibility;
    float _visibilityAnimationTarget;
...
- (int)pkui_preferredBackdropStyle;
- (void)_pkui_setVisibility:(float)arg1 animated:(_Bool)arg2;
- (void)pkui_setVisibility:(float)arg1 animated:(_Bool)arg2;
- (float)pkui_visibility;
