...
@property(nonatomic) float draggingVelocity; // @synthesize draggingVelocity=_draggingVelocity;
...
- (float)_contentOffsetAnimationDurationForCollectionView:(id)arg1;
- (void)_dismiss;
