...
@property(nonatomic) float stickyValue; // @synthesize stickyValue=_stickyValue;
...
- (void).cxx_destruct;
- (id)description;
- (id)lastCompletedArcForValue:(float)arg1;
- (id)arcForValue:(float)arg1;
- (_Bool)valueIsInRingRotation:(float)arg1;
- (float)arcLength;
- (float)arcMaxValue;
- (float)arcMinValue;
