...
- (void)_transitionToState:(int)arg1 withError:(id)arg2;
- (_Bool)_canPerformActionWithState:(int)arg1;
...
- (void)replacePhysicalCard:(id)arg1 withReason:(unsigned int)arg2;
