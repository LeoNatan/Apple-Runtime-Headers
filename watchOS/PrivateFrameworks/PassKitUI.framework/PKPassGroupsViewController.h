...
@interface PKPassGroupsViewController : UIViewController <PKGroupsControllerDelegate, PKPassGroupStackViewDatasource, PKPassGroupStackViewDelegate, UIScrollViewDelegate, PKForegroundActiveArbiterObserver, PKPaymentServiceDelegate, PKPaymentSetupDelegate, PKPerformActionViewControllerDelegate, PKPeerPaymentAccountResolutionControllerDelegate, PKAccountServiceAccountResolutionControllerDelegate, PKDiscoveryDataSourceDelegate, PKSubcredentialProvisioningFlowControllerDelegate, _PKUIKVisibilityBackdropViewDelegate, PKPGSVFooterViewDelegate, PKPGSVSectionSubheaderDelegate, PKPGSVSectionHeaderViewDelegate, PKPassPersonalizationViewControllerDelegate, PKDiscoveryArticleViewControllerPresenter>
{
    ...
    float _headerBackgroundVisibility;
    float _footerBackgroundVisibility;
...
- (void)dismissPresentedVCsWithRequirements:(unsigned int)arg1 animated:(_Bool)arg2 performAction:(CDUnknownBlockType)arg3;
...
- (void)startPaymentPreflight:(id)arg1 withPaymentSetupMode:(int)arg2 referrerIdentifier:(id)arg3 paymentNetwork:(id)arg4 transitNetworkIdentifier:(id)arg5 allowedFeatureIdentifiers:(id)arg6;
...
- (void)presentSpendingSummaryForPassUniqueIdentifier:(id)arg1 type:(unsigned int)arg2 unit:(unsigned int)arg3 animated:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)presentInstallmentPlansForFeature:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)presentPaymentSetupInMode:(int)arg1 referrerIdentifier:(id)arg2 paymentNetwork:(id)arg3 transitNetworkIdentifier:(id)arg4 allowedFeatureIdentifiers:(id)arg5;
