...
@interface PKPaymentPassDetailViewController : PKSectionTableViewController <PKPeerPaymentContactResolverDelegate, PKPeerPaymentActionViewControllerDelegate, PKPeerPaymentAccountResolutionControllerDelegate, PKPhysicalCardActionControllerDelegate, PKCreditAccountPaymentDetailsViewControllerDelegate, PKAccountAutomaticPaymentsControllerDelegate, PKAccountServiceAccountResolutionControllerDelegate, PKAccountBillPaymentObserver, PKAccountServiceObserver, PKPaymentDataProviderDelegate, PKPaymentVerificationControllerDelegate, PKPassHeaderViewDelegate, PKBalanceDetailsViewControllerDelegate, PKPaymentPassActionWidgetViewDelegate, PKPerformActionViewControllerDelegate, PKSelectActionViewControllerDelegate, PKAMPEnrollmentManagerObserver, UITableViewDataSource, UITableViewDelegate, PSStateRestoration, PKPaymentSetupDelegate>
{
    ...
    unsigned int _cashbackResolution;
    unsigned int _redemptionStatus;
...
- (void)_presentContactBankViewController:(unsigned int)arg1;
...
- (unsigned int)_peerPaymentBalanceAndMoneyActionForRowIndex:(unsigned int)arg1;
- (_Bool)_peerPaymentBalanceAndMoneyActionEnabled:(unsigned int)arg1;
- (unsigned int)_numberOfPeerPaymentBalanceAndMoneyActionsEnabled;
...
- (void)presentInstallmentPlansForFeature:(unsigned int)arg1;
...
- (void)_didSelectSharedCredentialGroupAtIndex:(int)arg1;
...
- (void)_didSelectPeerPaymentBalanceAndMoneyActionAtRow:(int)arg1;
...
- (unsigned int)_accountServiceScheduledPaymentsRowTypeForRowIndex:(int)arg1;
- (id)_accountServiceScheduledPaymentsCellForRowIndex:(int)arg1 tableView:(id)arg2;
- (id)_accountServiceCardNumbersCellForRowIndex:(int)arg1 tableView:(id)arg2;
- (id)_accountServicePhysicalCardCellForRowIndex:(int)arg1 tableView:(id)arg2;
- (unsigned int)_accountServicePhysicalCardRowForRowIndex:(int)arg1;
- (int)_numberOfAccountServicePhysicalCardRowsEnabled;
- (_Bool)_accountServicePhysicalCardRowIsEnabled:(unsigned int)arg1;
- (unsigned int)_accountServiceRewardsRowForRowIndex:(int)arg1;
- (int)_numberOfAccountServiceRewardsRowsEnabled;
- (_Bool)_accountServiceRewardsRowIsEnabled:(unsigned int)arg1;
- (id)_accountServiceRewardsDetailsCellForRowIndex:(int)arg1 tableView:(id)arg2;
- (id)_accountServiceMakeDefaultCellForRowIndex:(int)arg1 tableView:(id)arg2;
- (id)_accountServiceBankAccountsCellForRowIndex:(int)arg1 tableView:(id)arg2;
- (unsigned int)_accountServiceCreditDetailsRowForRowIndex:(int)arg1;
- (_Bool)_accountServiceCreditDetailsRowIsEnabled:(unsigned int)arg1;
- (int)_numberOfAccountServiceCreditDetailsRowsEnabled;
- (id)_accountServiceCreditDetailsCellForRowIndex:(int)arg1 tableView:(id)arg2;
...
- (id)_peerPaymentBalanceAndMoneyActionCellForRowIndex:(int)arg1 tableView:(id)arg2;
...
- (id)_sharedCredentialCellForRowIndex:(int)arg1 tableView:(id)arg2;
...
- (id)_balanceForRow:(unsigned int)arg1;
- (id)_topUpActionForRow:(unsigned int)arg1;
- (id)_renewActionForRow:(unsigned int)arg1 commutePlanIdentifier:(id)arg2;
...
- (id)_stackedInfoCellWithPrimaryText:(id)arg1 detailText:(id)arg2 cellStyle:(int)arg3 forTableView:(id)arg4;
...
- (void)dealloc;
- (id)initWithPass:(id)arg1 webService:(id)arg2 peerPaymentWebService:(id)arg3 accountService:(id)arg4 style:(int)arg5 passLibraryDataProvider:(id)arg6 paymentServiceDataProvider:(id)arg7 rendererState:(id)arg8 context:(id)arg9;
- (id)initWithPass:(id)arg1 webService:(id)arg2 peerPaymentWebService:(id)arg3 style:(int)arg4 passLibraryDataProvider:(id)arg5 paymentServiceDataProvider:(id)arg6 rendererState:(id)arg7 context:(id)arg8;
- (id)initWithPass:(id)arg1 webService:(id)arg2 peerPaymentWebService:(id)arg3 accountService:(id)arg4 style:(int)arg5 passLibraryDataProvider:(id)arg6 paymentServiceDataProvider:(id)arg7;
