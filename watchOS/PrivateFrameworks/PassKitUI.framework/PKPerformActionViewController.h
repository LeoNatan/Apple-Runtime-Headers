...
+ (id)alertControllerForUnableReason:(unsigned int)arg1 action:(id)arg2 displayableError:(id)arg3 addCardActionHandler:(CDUnknownBlockType)arg4;
...
- (_Bool)_shouldPresentPaymentRequest:(int)arg1;
