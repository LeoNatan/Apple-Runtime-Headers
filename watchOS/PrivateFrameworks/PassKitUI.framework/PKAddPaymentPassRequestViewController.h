...
@class CLInUseAssertion, NSArray, NSObject<OS_dispatch_source>, NSString, PKAddPaymentPassRequest, PKAddPaymentPassRequestConfiguration, PKPaymentProvisioningController, PKPaymentWebService, PKTableHeaderView, RemoteUIController;
