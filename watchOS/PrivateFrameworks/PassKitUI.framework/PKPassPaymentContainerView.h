...
@class NSMutableArray, NSNumber, NSObject, NSString, PKAuthenticator, PKContactlessInterfaceSession, PKPassLibrary, PKPassPaymentApplicationView, PKPassPaymentPayStateView, PKPassValueAddedServiceInfoView, PKPaymentService, PKPeerPaymentAccountResolutionController, PKPeerPaymentContactResolver, PKPeerPaymentService, PKTransitBalanceModel, UIButton, UIView, UIViewController;
...
@interface PKPassPaymentContainerView : PKPassFooterContentView <PKPaymentServiceDelegate, PKAuthenticatorDelegate, PKPassPaymentPayStateViewDelegate, PKPassPaymentApplicationViewDelegate, PKContactlessInterfaceSessionDelegate, PKForegroundActiveArbiterObserver, PKUIForegroundActiveArbiterDeactivationObserver>
{
    ...
    unsigned int _transactionUpdateCounter;
    ...
    int _pendingPayStateGlyphState;
...
- (void)_setGlyphState:(int)arg1 animated:(_Bool)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;
- (void)_setGlyphState:(int)arg1 animated:(_Bool)arg2;
...
- (void)_emphasizeStateIfPossible:(int)arg1 withTextOverride:(id)arg2 playSystemSound:(_Bool)arg3;
- (void)_emphasizeStateIfPossible:(int)arg1 withTextOverride:(id)arg2;
- (void)_applyPayState:(int)arg1 withTextOverride:(id)arg2 animated:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (_Bool)_isBackgroundedForReasons:(unsigned int)arg1;
- (_Bool)_isDeactivatedForReasons:(unsigned int)arg1;
...
- (void)_authorizeForTransactionWithCredential:(id)arg1 authenticationIdentifier:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_activatePaymentApplication:(id)arg1 forPaymentPass:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void)_didAuthorizePaymentApplicationWithAuthenticationIdentifier:(unsigned int)arg1;
...
- (void)_cancelBiometricRecognitionAndPromptUserAction:(int)arg1;
