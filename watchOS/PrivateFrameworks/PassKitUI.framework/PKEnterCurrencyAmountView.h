...
- (id)_formatAmount:(id)arg1 minimumFractionDigits:(unsigned int)arg2;
...
- (id)_formatAmountForDisplay:(id)arg1 alwaysShowDecimalSeparator:(_Bool)arg2 minimumFractionDigits:(unsigned int)arg3 useGroupingSeparator:(_Bool)arg4;
- (void)_createAmountFormatter;
- (unsigned int)_numberOfDecimalPlacesInString:(id)arg1 decimalSeperator:(id)arg2;
