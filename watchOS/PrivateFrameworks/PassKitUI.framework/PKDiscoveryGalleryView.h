...
- (void)_updateScrollViewToCardIndex:(unsigned int)arg1 animated:(_Bool)arg2;
- (_Bool)_requestDismissalIfNecessaryAfterLayoutStateUpdate;
- (void)_removeCardView:(id)arg1 animated:(_Bool)arg2;
- (unsigned int)_indexForCardViewWithIdentifier:(id)arg1;
