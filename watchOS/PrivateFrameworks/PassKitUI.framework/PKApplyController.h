...
@interface PKApplyController : NSObject <PKSetupFlowControllerProtocol, PKPaymentServiceDelegate>
{
    ...
    unsigned int _viewControllerIndex;
    ...
    unsigned int _runningApplicationUpdates;
...
- (void)_deviceMetadataFields:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)dealloc;
- (id)initWithFeatureApplication:(id)arg1 setupDelegate:(id)arg2 context:(int)arg3 provisioningController:(id)arg4;
- (id)initWithFeature:(unsigned int)arg1 setupDelegate:(id)arg2 context:(int)arg3 provisioningController:(id)arg4;
