...
- (void)setStyle:(int)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_calculateViewMetricsForWidth:(float)arg1 labelSize:(struct CGSize *)arg2 statusSize:(struct CGSize *)arg3 baselineAdjustment:(float *)arg4;
