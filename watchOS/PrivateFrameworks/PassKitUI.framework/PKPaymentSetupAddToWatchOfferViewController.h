...
+ (void)shouldShowAddToWatchOfferForPass:(id)arg1 inContext:(int)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void).cxx_destruct;
...
- (id)initWithPaymentPass:(id)arg1 context:(int)arg2 dismissalHandler:(CDUnknownBlockType)arg3;
