...
- (SPCoreSpotlightTask *)taskForQueryWithQueryString:(NSString *)arg1 queryContext:(CSSearchQueryContext *)arg2 eventHandler:(void * (^)(int, struct, unsigned long, void *))arg3 resultsHandler:(void (^)(int, unsigned long, struct __MDStoreOIDArray *, struct __MDPlistBytes *, NSString *))arg4 completionHandler:(void (^)(NSError *))arg5;
- (SPCoreSpotlightTask *)startQueryWithQueryString:(NSString *)arg1 queryContext:(CSSearchQueryContext *)arg2 eventHandler:(void * (^)(int, struct, unsigned long, void *))arg3 resultsHandler:(void (^)(int, unsigned long, struct __MDStoreOIDArray *, struct __MDPlistBytes *, NSString *))arg4 completionHandler:(void (^)(NSError *))arg5;
- (SPCoreSpotlightTask *)startQuery:(NSString *)arg1 withContext:(CSSearchQueryContext *)arg2 eventHandler:(void * (^)(int, struct, unsigned long, void *))arg3 handler:(void (^)(int, unsigned long, struct __MDStoreOIDArray *, struct __MDPlistBytes *, NSString *))arg4;
- (SPCoreSpotlightTask *)startQuery:(NSString *)arg1 withContext:(CSSearchQueryContext *)arg2 handler:(void (^)(int, unsigned long, struct __MDStoreOIDArray *, struct __MDPlistBytes *, NSString *))arg3;
@end
