...
- (id)emojiTokensForText:(id)arg1 phoneticReading:(id)arg2 options:(unsigned int)arg3 searchType:(int)arg4 includePrefixMatches:(_Bool)arg5;
- (void)enumerateSearchResultsInText:(id)arg1 range:(struct _NSRange)arg2 options:(unsigned int)arg3 searchType:(int)arg4 usingBlock:(CDUnknownBlockType)arg5;
