...
- (id)_queue_evaluateTriggers:(unsigned int)arg1 activitySummary:(id)arg2 templates:(id)arg3 shouldLog:(_Bool)arg4;
- (unsigned int)_queue_triggersWithChangedSummaryFields:(unsigned int)arg1 dataProvider:(id)arg2;
- (void)_runIncrementallyForChangedSummaryFields:(unsigned int)arg1;
