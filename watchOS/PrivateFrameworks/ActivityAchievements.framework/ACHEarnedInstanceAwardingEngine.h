...
@interface ACHEarnedInstanceAwardingEngine : NSObject <HDDatabaseProtectedDataObserver>
{
    ...
    CDStruct_f9ab334b _historicalEvaluationPolicy;
...
- (id)initWithProfile:(id)arg1 dataStore:(id)arg2 earnedInstanceStore:(id)arg3 historicalEvaluationPolicy:(CDStruct_f9ab334b)arg4;
