...
- (id)customPlaceholderValuesAtIndex:(unsigned int)arg1;
- (unsigned int)customPlaceholderValuesCount;
...
- (id)earnedInstancesAtIndex:(unsigned int)arg1;
- (unsigned int)earnedInstancesCount;
