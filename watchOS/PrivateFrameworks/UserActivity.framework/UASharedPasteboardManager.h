...
- (void)pickupLocalChanges:(id)arg1 iterNumber:(int)arg2 cloneDir:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (_Bool)addData:(id)arg1 toItemAtIndex:(unsigned int)arg2 generation:(unsigned int)arg3;
