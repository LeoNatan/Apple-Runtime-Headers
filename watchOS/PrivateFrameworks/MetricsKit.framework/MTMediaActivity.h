...
- (_Bool)isStopped;
- (void)stoppedAtOverallPosition:(unsigned int)arg1 type:(id)arg2 reason:(id)arg3 eventData:(id)arg4;
- (void)startedAtOverallPosition:(unsigned int)arg1 type:(id)arg2 reason:(id)arg3 eventData:(id)arg4;
- (unsigned int)positionFromOverallPosition:(unsigned int)arg1;
- (id)initWithType:(int)arg1 playlistItem:(id)arg2 vpafKit:(id)arg3;
