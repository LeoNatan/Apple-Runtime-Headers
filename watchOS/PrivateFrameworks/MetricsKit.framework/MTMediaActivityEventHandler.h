...
- (id)knownFields;
- (id)metricsDataForStopActionWithPosition:(unsigned int)arg1 overallPosition:(unsigned int)arg2 type:(id)arg3 reason:(id)arg4 startMetricsData:(id)arg5 eventData:(id)arg6;
- (id)metricsDataForStartActionWithPosition:(unsigned int)arg1 overallPosition:(unsigned int)arg2 type:(id)arg3 reason:(id)arg4 eventData:(id)arg5;
