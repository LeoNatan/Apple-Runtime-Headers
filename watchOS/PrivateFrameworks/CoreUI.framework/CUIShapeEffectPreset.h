...
{
    CDStruct_97694245 _parameterList[125];
...
- (void)addColorFillWithRed:(unsigned int)arg1 green:(unsigned int)arg2 blue:(unsigned int)arg3 opacity:(float)arg4 blendMode:(unsigned int)arg5 tintable:(_Bool)arg6;
...
- (id)initWithConstantPreset:(const CDStruct_b5108d36 *)arg1;
