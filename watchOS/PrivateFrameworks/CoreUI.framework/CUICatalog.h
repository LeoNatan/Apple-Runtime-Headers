...
- (_Bool)_effectStyle:(unsigned int *)arg1 state:(int *)arg2 presentationState:(int *)arg3 value:(int *)arg4 resolution:(unsigned int *)arg5 fromStyleConfiguration:(id)arg6;
...
- (id)_resolvedRenditionKeyFromThemeRef:(unsigned int)arg1 withBaseKey:(id)arg2 scaleFactor:(float)arg3 deviceIdiom:(int)arg4 deviceSubtype:(unsigned int)arg5 displayGamut:(int)arg6 layoutDirection:(int)arg7 sizeClassHorizontal:(int)arg8 sizeClassVertical:(int)arg9 memoryClass:(unsigned int)arg10 graphicsClass:(unsigned int)arg11 graphicsFallBackOrder:(id)arg12 iconSizeIndex:(unsigned int)arg13;
...
- (id)_colorWithName:(id)arg1 displayGamut:(int)arg2 deviceIdiom:(int)arg3;
...
- (id)_namedTextureWithName:(id)arg1 scaleFactor:(float)arg2 displayGamut:(int)arg3;
- (id)namedTextureWithName:(id)arg1 scaleFactor:(float)arg2;
- (id)_namedTextureWithName:(id)arg1 scaleFactor:(float)arg2;
...
- (id)_namedVectorImageWithName:(id)arg1 scaleFactor:(float)arg2 deviceIdiom:(int)arg3 deviceSubtype:(unsigned int)arg4 displayGamut:(int)arg5 layoutDirection:(int)arg6 sizeClassHorizontal:(int)arg7 sizeClassVertical:(int)arg8;
...
- (id)_namedImageAtlasWithName:(id)arg1 scaleFactor:(float)arg2 deviceIdiom:(int)arg3 displayGamut:(int)arg4 deviceSubtype:(unsigned int)arg5 memoryClass:(unsigned int)arg6 graphicsClass:(unsigned int)arg7 graphicsFallBackOrder:(id)arg8;
...
- (id)_dataWithName:(id)arg1 deviceIdiom:(int)arg2 deviceSubtype:(unsigned int)arg3 memoryClass:(unsigned int)arg4 graphicsClass:(unsigned int)arg5 graphicsFallBackOrder:(id)arg6;
...
- (id)_imageWithName:(id)arg1 scaleFactor:(float)arg2 deviceIdiom:(int)arg3 deviceSubtype:(unsigned int)arg4 displayGamut:(int)arg5 layoutDirection:(int)arg6 sizeClassHorizontal:(int)arg7 sizeClassVertical:(int)arg8 memoryClass:(unsigned int)arg9 graphicsClass:(unsigned int)arg10 graphicsFallBackOrder:(id)arg11;
