...
@interface CUIShapeEffectStack : NSObject
{
    ...
    unsigned int _hueSaturationCount;
    CDStruct_2844c7c7 *_hueSaturation;
    unsigned int _colorOverlayCount;
    CDStruct_073a3662 *_colorOverlay;
    unsigned int _innerGradientCount;
    CDStruct_bdea167c *_innerGradient;
    unsigned int _innerGlowCount;
    CDStruct_3d979a67 *_innerGlow;
    unsigned int _innerShadowCount;
    CDStruct_238132ea *_innerShadow;
    unsigned int _outerGlowCount;
    CDStruct_265c7ca9 *_outerGlow;
    unsigned int _engraveShadowCount;
    CDStruct_2425aea7 *_engraveShadow;
    unsigned int _extraShadowCount;
    CDStruct_2425aea7 *_extraShadow;
    unsigned int _bevelEmbossCount;
...
@property(readonly, nonatomic) unsigned int bevelEmbossCount; // @synthesize bevelEmbossCount=_bevelEmbossCount;
@property(readonly, nonatomic) CDStruct_2425aea7 *extraShadow; // @synthesize extraShadow=_extraShadow;
@property(readonly, nonatomic) unsigned int extraShadowCount; // @synthesize extraShadowCount=_extraShadowCount;
@property(readonly, nonatomic) CDStruct_2425aea7 *engraveShadow; // @synthesize engraveShadow=_engraveShadow;
@property(nonatomic) unsigned int engraveShadowCount; // @synthesize engraveShadowCount=_engraveShadowCount;
@property(readonly, nonatomic) CDStruct_265c7ca9 *outerGlow; // @synthesize outerGlow=_outerGlow;
@property(readonly, nonatomic) unsigned int outerGlowCount; // @synthesize outerGlowCount=_outerGlowCount;
@property(readonly, nonatomic) CDStruct_238132ea *innerShadow; // @synthesize innerShadow=_innerShadow;
@property(nonatomic) unsigned int innerShadowCount; // @synthesize innerShadowCount=_innerShadowCount;
@property(readonly, nonatomic) CDStruct_3d979a67 *innerGlow; // @synthesize innerGlow=_innerGlow;
@property(nonatomic) unsigned int innerGlowCount; // @synthesize innerGlowCount=_innerGlowCount;
@property(readonly, nonatomic) CDStruct_bdea167c *innerGradient; // @synthesize innerGradient=_innerGradient;
@property(nonatomic) unsigned int innerGradientCount; // @synthesize innerGradientCount=_innerGradientCount;
@property(readonly, nonatomic) CDStruct_073a3662 *colorOverlay; // @synthesize colorOverlay=_colorOverlay;
@property(nonatomic) unsigned int colorOverlayCount; // @synthesize colorOverlayCount=_colorOverlayCount;
@property(readonly, nonatomic) CDStruct_2844c7c7 *hueSaturation; // @synthesize hueSaturation=_hueSaturation;
@property(readonly, nonatomic) unsigned int hueSaturationCount; // @synthesize hueSaturationCount=_hueSaturationCount;
...
- (struct CGImage *)newFlattenedImageFromCGImage:(struct CGImage *)arg1 withScale:(float)arg2 ciContext:(id)arg3;
- (struct CGImage *)newFlattenedImageFromShapeCGImage:(struct CGImage *)arg1 withScale:(float)arg2 ciContext:(id)arg3;
- (struct CGImage *)_newFlattenedImageFromShapeCGImage:(struct CGImage *)arg1 withScale:(float)arg2 ciContext:(id)arg3 blendOverImage:(_Bool)arg4;
- (struct CGImage *)newFlattenedImageFromShapeCGImage:(struct CGImage *)arg1 withScale:(float)arg2 cache:(_Bool)arg3;
- (struct CGImage *)newFlattenedImageFromShapeCGImage:(struct CGImage *)arg1 withScale:(float)arg2;
- (id)processedImageFromShapeImage:(id)arg1 withScale:(float)arg2 invertShadows:(_Bool)arg3;
- (id)processedImageFromShapeImage:(id)arg1 withScale:(float)arg2;
- (id)processedImageFromShapeImage:(id)arg1;
- (id)processedImageFromImage:(id)arg1 withScale:(float)arg2;
- (id)processedImageFromImage:(id)arg1;
- (CDStruct_fd71c141)effectInsetsWithScale:(float)arg1;
- (struct CGRect)effectPaddingWithScale:(float)arg1;
- (id)compositeEffectStackWithShapeImage:(id)arg1 withScale:(float)arg2 blendOntoImage:(_Bool)arg3;
...
- (void)scaleBrightnessOfEffectColorsByAmount:(float)arg1 onlyTintableColors:(_Bool)arg2;
...
- (id)imageWithExtraShadowOfImage:(id)arg1 effect:(CDStruct_2425aea7)arg2;
- (id)imageWithEngraveShadowOfImage:(id)arg1 effect:(CDStruct_2425aea7)arg2;
