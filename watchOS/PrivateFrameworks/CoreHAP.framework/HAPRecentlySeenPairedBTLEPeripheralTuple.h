...
- (void).cxx_destruct;
@property(nonatomic) unsigned int connectionPriority; // @synthesize connectionPriority=_connectionPriority;
...
@property(nonatomic) unsigned int advertisementFormat; // @synthesize advertisementFormat=_advertisementFormat;
...
- (id)description;
- (void)updatePairedPeripheralConfiguration:(_Bool)arg1 connectionPriority:(unsigned int)arg2;
- (id)initRecentlySeenPairedBTLEPeripheral:(id)arg1 statusFlags:(id)arg2 stateNumber:(id)arg3 category:(id)arg4 configNumber:(id)arg5 identifier:(id)arg6 advertisementFormat:(unsigned int)arg7 setupHash:(id)arg8;
