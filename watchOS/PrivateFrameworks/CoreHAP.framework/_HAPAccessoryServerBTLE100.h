...
+ (id)deserializeCharacteristicReadData:(id)arg1 characteristicFormat:(unsigned int)arg2 supportsAdditonalAuthentication:(_Bool)arg3 error:(id *)arg4;
+ (id)serializeCharacteristicWriteValue:(id)arg1 characteristicFormat:(unsigned int)arg2 supportsAdditonalAuthentication:(_Bool)arg3 authenticationData:(id)arg4 error:(id *)arg5;
- (void).cxx_destruct;
...
@property(nonatomic) unsigned int metadataValueReadCount; // @synthesize metadataValueReadCount=_metadataValueReadCount;
@property(nonatomic) unsigned int metadataDiscoveryRequestCount; // @synthesize metadataDiscoveryRequestCount=_metadataDiscoveryRequestCount;
@property(nonatomic) unsigned int characteristicValueReadCount; // @synthesize characteristicValueReadCount=_characteristicValueReadCount;
...
@property(nonatomic) unsigned int connectionRetryCount; // @synthesize connectionRetryCount=_connectionRetryCount;
@property(nonatomic) unsigned int state; // @synthesize state=_state;
- (void)_dequeueAndContinueOperation;
- (void)_enqueueOperation:(int)arg1 identifier:(id)arg2 publicKey:(id)arg3 admin:(_Bool)arg4 queue:(id)arg5 completion:(CDUnknownBlockType)arg6;
