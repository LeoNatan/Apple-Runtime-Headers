...
- (id)decrypt:(const void *)arg1 length:(unsigned long)arg2 additionalAuthData:(const void *)arg3 additionalAuthDataLength:(unsigned long)arg4 authTagData:(const void *)arg5 authTagDataLength:(unsigned long)arg6 error:(id *)arg7;
