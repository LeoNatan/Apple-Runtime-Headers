...
- (_Bool)updatePeripheralIdentifier:(NSUUID *)arg1 forAccessoryIdentifier:(NSString *)arg2 protocolVersion:(unsigned int)arg3 previousVersion:(unsigned int *)arg4 resumeSessionID:(unsigned long long)arg5 error:(id *)arg6;
