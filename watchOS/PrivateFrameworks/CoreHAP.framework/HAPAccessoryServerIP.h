...
@property(nonatomic) long cancelPairingErr; // @synthesize cancelPairingErr=_cancelPairingErr;
...
- (void)_handleListPairingsResponseObject:(id)arg1 type:(unsigned int)arg2 httpStatus:(int)arg3 httpError:(id)arg4 completionQueue:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
- (void)handleHTTPClientUnavailableErrorWithCompletion:(CDUnknownBlockType)arg1 serializationType:(unsigned int)arg2;
- (void)sendGETRequestToURL:(id)arg1 timeout:(double)arg2 logEventSession:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)sendPOSTRequestToURL:(id)arg1 request:(id)arg2 serializationType:(unsigned int)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)sendPUTRequestToURL:(id)arg1 request:(id)arg2 serializationType:(unsigned int)arg3 timeout:(double)arg4 logEventSession:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)_handleWriteResponseObject:(id)arg1 type:(unsigned int)arg2 httpStatus:(int)arg3 error:(id)arg4 requestTuples:(id)arg5 queue:(id)arg6 logEventSession:(id)arg7 completion:(CDUnknownBlockType)arg8;
- (void)_handlePrepareWriteResponseObject:(id)arg1 type:(unsigned int)arg2 prepareIdentifier:(id)arg3 httpStatus:(int)arg4 error:(id)arg5 requestTuples:(id)arg6 timeout:(double)arg7 queue:(id)arg8 logEventSession:(id)arg9 completion:(CDUnknownBlockType)arg10;
...
- (void)_handleReadResponseObject:(id)arg1 type:(unsigned int)arg2 httpStatus:(int)arg3 error:(id)arg4 characteristics:(id)arg5 queue:(id)arg6 logEventSession:(id)arg7 completion:(CDUnknownBlockType)arg8;
