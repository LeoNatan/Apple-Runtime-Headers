...
+ (id)configurationRequestForCharacteristic:(id)arg1 isBroadcasted:(_Bool)arg2 interval:(unsigned int)arg3 error:(id *)arg4;
...
- (unsigned int)_getPairSetupType;
...
- (_Bool)_parsePairingFeaturesCharacteristic:(id)arg1 authMethod:(unsigned int *)arg2 error:(id *)arg3;
...
- (void)_enableBroadcastEvent:(_Bool)arg1 interval:(unsigned int)arg2 forCharacteristic:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)_performTimedWriteExecuteForCharacteristic:(id)arg1 value:(id)arg2 options:(int)arg3 logEventSession:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)_performTimedWritePrepareWithValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 options:(int)arg4 logEventSession:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)_performTimedWriteValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 options:(int)arg4 logEventSession:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)_performWriteValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 options:(int)arg4 logEventSession:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)_writeValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 options:(int)arg4 logEventSession:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
- (void)_readValueForCharacteristic:(id)arg1 options:(int)arg2 logEventSession:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (id)_serviceCacheFromHAPService:(id)arg1 serviceOrder:(unsigned int)arg2;
- (id)_hapServicesFromCache;
- (id)_getCachedService:(id)arg1;
- (id)_getCBService:(id)arg1 instanceOrder:(unsigned int)arg2;
...
- (void)_discoverWithType:(int)arg1 completionHandler:(CDUnknownBlockType)arg2;
