...
- (void)_performTimedWriteExecuteForCharacteristic:(id)arg1 value:(id)arg2 options:(int)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)_performTimedWritePrepareWithValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 options:(int)arg4 completionHandler:(CDUnknownBlockType)arg5;
