...
- (id)initWithType:(id)arg1 instanceID:(id)arg2 value:(id)arg3 stateNumber:(id)arg4 properties:(unsigned int)arg5 eventNotificationsEnabled:(_Bool)arg6 metadata:(id)arg7;
