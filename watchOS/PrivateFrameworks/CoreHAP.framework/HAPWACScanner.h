...
@class HAPWACScanRequest, NSMutableArray, NSObject<OS_dispatch_queue>;
...
- (void)scanForWACAndExtractSetupDictWithNumberOfScans:(unsigned int)arg1 andCompletion:(CDUnknownBlockType)arg2;
- (_Bool)activeScan;
- (void)dealloc;
- (id)init;
- (id)initPrivate;
