...
@property(readonly, nonatomic) unsigned int characteristicProperties; // @synthesize characteristicProperties=_characteristicProperties;
...
- (id)initWithCharacteristicType:(id)arg1 serviceInstanceID:(id)arg2 serviceType:(id)arg3 characteristicProperties:(unsigned int)arg4 characteristicMetadata:(id)arg5 authenticated:(_Bool)arg6;
