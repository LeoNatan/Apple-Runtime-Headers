...
- (void)enumerateCorrectionEntriesForWord:(id)arg1 maxCorrections:(unsigned int)arg2 withBlock:(CDUnknownBlockType)arg3;
- (void)enumerateCompletionEntriesForPrefix:(id)arg1 maxCompletions:(unsigned int)arg2 withBlock:(CDUnknownBlockType)arg3;
