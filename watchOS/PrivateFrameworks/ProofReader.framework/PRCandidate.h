...
+ (id)transpositionCandidateWithBuffer:(char *)arg1 encoding:(unsigned long)arg2 transform:(unsigned int)arg3 replacementRange:(struct _NSRange)arg4 intendedFirstCharacter:(unsigned short)arg5 intendedSecondCharacter:(unsigned short)arg6;
+ (id)replacementCandidateWithBuffer:(char *)arg1 encoding:(unsigned long)arg2 transform:(unsigned int)arg3 replacementRange:(struct _NSRange)arg4 intendedCharacter:(unsigned short)arg5 actualCharacter:(unsigned short)arg6;
+ (id)candidateWithBuffer:(char *)arg1 encoding:(unsigned long)arg2 transform:(unsigned int)arg3 replacementRange:(struct _NSRange)arg4 errorType:(unsigned int)arg5;
+ (id)candidateWithBuffer:(char *)arg1 encoding:(unsigned long)arg2 transform:(unsigned int)arg3 replacementRange:(struct _NSRange)arg4 errorScore:(double)arg5;
...
+ (id)candidateWithString:(id)arg1 replacementRange:(struct _NSRange)arg2 errorType:(unsigned int)arg3;
+ (id)candidateWithString:(id)arg1 replacementRange:(struct _NSRange)arg2 errorScore:(double)arg3;
+ (id)candidateWithWords:(id)arg1 replacementRange:(struct _NSRange)arg2 errorType:(unsigned int)arg3;
