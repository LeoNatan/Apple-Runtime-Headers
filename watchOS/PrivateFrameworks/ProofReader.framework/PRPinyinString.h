...
- (void)dealloc;
- (id)initWithString:(id)arg1 syllableCount:(unsigned int)arg2 lastSyllableIsPartial:(_Bool)arg3 score:(unsigned int)arg4 originalLength:(unsigned int)arg5 originalCheckedLength:(unsigned int)arg6 numberOfModifications:(unsigned int)arg7 modificationTypes:(unsigned int *)arg8 originalModificationRanges:(struct _NSRange *)arg9 finalModificationRanges:(struct _NSRange *)arg10 originalSyllableRanges:(struct _NSRange *)arg11 originalAdditionalSyllableRanges:(struct _NSRange *)arg12;
- (id)initWithUncheckedString:(id)arg1 score:(unsigned int)arg2 originalLength:(unsigned int)arg3;
- (id)initWithString:(id)arg1 syllableCount:(unsigned int)arg2 lastSyllableIsPartial:(_Bool)arg3 score:(unsigned int)arg4 originalLength:(unsigned int)arg5 modificationType:(unsigned int)arg6 originalModificationRange:(struct _NSRange)arg7 finalModificationRange:(struct _NSRange)arg8 originalSyllableRange:(struct _NSRange)arg9 originalAdditionalSyllableRange:(struct _NSRange)arg10;
- (id)initWithString:(id)arg1 syllableCount:(unsigned int)arg2 lastSyllableIsPartial:(_Bool)arg3 score:(unsigned int)arg4 originalLength:(unsigned int)arg5 modificationType:(unsigned int)arg6 originalModificationRange:(struct _NSRange)arg7 finalModificationRange:(struct _NSRange)arg8 originalSyllableRange:(struct _NSRange)arg9;
- (id)initWithString:(id)arg1 syllableCount:(unsigned int)arg2 lastSyllableIsPartial:(_Bool)arg3 score:(unsigned int)arg4 originalLength:(unsigned int)arg5 modificationType:(unsigned int)arg6 originalModificationRange:(struct _NSRange)arg7 finalModificationRange:(struct _NSRange)arg8;
