...
- (_Bool)_shouldBlockWord:(id)arg1 language:(id)arg2 encoding:(unsigned long)arg3;
...
- (unsigned int)acceptibilityOfWordBuffer:(char *)arg1 length:(unsigned int)arg2 language:(id)arg3 encoding:(unsigned long)arg4 forPrediction:(_Bool)arg5;
- (unsigned int)acceptibilityOfWordBuffer:(char *)arg1 length:(unsigned int)arg2 language:(id)arg3 encoding:(unsigned long)arg4 forPrediction:(_Bool)arg5 depth:(unsigned int)arg6;
