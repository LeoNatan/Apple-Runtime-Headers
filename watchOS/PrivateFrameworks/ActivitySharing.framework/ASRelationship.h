...
+ (id)relationshipWithCodableRelationship:(id)arg1 version:(int)arg2;
...
@property(readonly, nonatomic) unsigned int currentRelationshipEventAnchor;
- (void)traverseRelationshipHistoryStartingAtEventWithAnchor:(unsigned int)arg1 block:(CDUnknownBlockType)arg2;
