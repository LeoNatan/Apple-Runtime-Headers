...
- (void)_queue_restartQueryAfterErrorCount:(int)arg1 withBlock:(CDUnknownBlockType)arg2;
- (_Bool)_isWheelchairUserDisplayModeValidForFriends:(id)arg1 filter:(int)arg2;
...
- (void)fetchActivitySharingDataIfTimeSinceLastFetchIsGreaterThan:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
- (unsigned int)totalNumberOfPendingRequests;
- (unsigned int)numberOfFriendsWithCompetitionRequestsAwaitingResponseFromMe;
...
- (void)enumerateValidDisplayModesForFilter:(int)arg1 usingBlock:(CDUnknownBlockType)arg2;
