...
- (id)_navigation_transitRelativeDateStringForDate:(id)arg1 context:(int)arg2 inTimeZone:(id)arg3 outUsedFormat:(out unsigned int *)arg4;
- (id)_navigation_relativeDateStringForDate:(id)arg1 context:(int)arg2 inTimeZone:(id)arg3;
- (id)_navigation_dateStringForDate:(id)arg1 withStyle:(unsigned int)arg2 useRelativeFormatting:(_Bool)arg3 inTimeZone:(id)arg4;
