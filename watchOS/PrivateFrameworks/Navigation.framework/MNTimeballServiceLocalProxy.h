...
- (void)subscribeToDestination:(id)arg1 options:(int)arg2 refreshPolicy:(unsigned int)arg3;
- (void)requestRoutingOptions:(int)arg1 forDestinations:(id)arg2 freshness:(id)arg3 handlerID:(id)arg4;
...
- (void)_requestOptions:(int)arg1 forDestinations:(id)arg2 fromLocation:(id)arg3 freshness:(id)arg4 handlerID:(id)arg5;
