...
- (void)navigationService:(MNNavigationService *)arg1 didUpdateFeedback:(GEOAlightNotificationFeedback *)arg2 forAlightingStepAtIndex:(unsigned int)arg3;
- (void)navigationService:(MNNavigationService *)arg1 didSignalAlightForStepAtIndex:(unsigned int)arg2;
