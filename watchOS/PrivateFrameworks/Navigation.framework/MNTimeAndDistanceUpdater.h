...
- (void)updateDisplayETAForRoute:(id)arg1 notificationType:(unsigned int)arg2;
- (void)setRoutes:(id)arg1 mainRoute:(id)arg2 location:(id)arg3 notificationType:(unsigned int)arg4;
- (void)setLocation:(id)arg1 notificationType:(unsigned int)arg2;
- (void)stopUpdating;
- (void)startUpdating;
- (void)dealloc;
