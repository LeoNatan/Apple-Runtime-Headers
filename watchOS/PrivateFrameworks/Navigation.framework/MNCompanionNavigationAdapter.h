...
- (void)navigationService:(id)arg1 displayManeuverAlertForAnnouncementStage:(unsigned int)arg2;
- (void)navigationService:(id)arg1 triggerHaptics:(int)arg2;
- (void)navigationService:(id)arg1 displayPrimaryStep:(id)arg2 instructions:(id)arg3 shieldType:(int)arg4 shieldText:(id)arg5 drivingSide:(int)arg6 maneuverStepIndex:(unsigned int)arg7 isSynthetic:(_Bool)arg8;
- (void)navigationService:(id)arg1 willAnnounce:(unsigned int)arg2 inSeconds:(double)arg3;
- (void)navigationService:(id)arg1 didUpdateDistanceUntilManeuver:(double)arg2 timeUntilManeuver:(double)arg3 forStepIndex:(unsigned int)arg4;
...
- (void)_setNextAnnouncementStage:(unsigned int)arg1 timeUntilNextAnnouncement:(double)arg2;
- (void)_setAnnouncementStage:(unsigned int)arg1;
- (void)_setPositionFromDestination:(CDStruct_c3b9c2ee)arg1;
- (void)_setPositionFromManeuver:(CDStruct_c3b9c2ee)arg1;
- (void)_setDisplayedStepIndex:(unsigned int)arg1;
