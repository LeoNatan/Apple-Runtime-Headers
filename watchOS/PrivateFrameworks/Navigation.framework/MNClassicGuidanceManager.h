...
@interface MNClassicGuidanceManager : NSObject <MNGuidanceManager>
{
    ...
    CDStruct_82c04388 _currentInstructionOptions;
    _Bool _didAnnounceStartOfRoute;
    unsigned int _countLocationUpdates;
}

- (void).cxx_destruct;
@property(nonatomic) CDStruct_82c04388 currentInstructionOptions; // @synthesize currentInstructionOptions=_currentInstructionOptions;
...
- (void)_notifyAnnounceManeuverForStep:(id)arg1 withDistance:(double)arg2 withCombinedGuidance:(int)arg3 playShortPrompt:(_Bool)arg4 isRepeat:(_Bool)arg5 stage:(unsigned int)arg6 timeLimit:(double)arg7;
...
@property(readonly, nonatomic) unsigned int maneuverStepIndex;
- (unsigned int)_maneuverStepIndex;
@property(readonly, nonatomic) _Bool proceedingToRoute;
- (id)_getStepAtIndex:(unsigned int)arg1 clampIndexToRange:(_Bool)arg2;
