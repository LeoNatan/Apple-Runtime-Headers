...
+ (id)contentsWithStep:(id)arg1 transportType:(int)arg2 destination:(id)arg3 options:(CDStruct_82c04388 *)arg4 isSecondary:(_Bool)arg5;
- (void).cxx_destruct;
