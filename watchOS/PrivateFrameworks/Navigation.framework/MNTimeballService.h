...
- (void)addSubscriber:(id)arg1 forDestination:(id)arg2 options:(int)arg3 refreshPolicy:(unsigned int)arg4;
- (void)requestRoutingOptions:(int)arg1 forDestinations:(id)arg2 freshness:(id)arg3 callbackBlock:(CDUnknownBlockType)arg4;
- (void)requestRoutingOptions:(int)arg1 forDestination:(id)arg2 freshness:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
