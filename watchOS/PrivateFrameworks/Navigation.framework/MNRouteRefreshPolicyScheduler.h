...
- (void)_handleSchedulingUpdatesForDestination:(id)arg1 options:(int)arg2 policy:(unsigned int)arg3 auditToken:(id)arg4;
- (void)scheduleUpdatesForDestination:(id)arg1 options:(int)arg2 policy:(unsigned int)arg3 auditToken:(id)arg4;
- (void)dealloc;
