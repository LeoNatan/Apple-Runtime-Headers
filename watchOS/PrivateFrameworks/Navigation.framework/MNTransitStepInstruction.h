...
+ (id)instructionForStep:(id)arg1 overrides:(struct NSDictionary *)arg2 context:(int)arg3;
...
- (void).cxx_destruct;
- (id)instructionSet;
- (id)initWithStep:(id)arg1 overrides:(struct NSDictionary *)arg2 context:(int)arg3;
