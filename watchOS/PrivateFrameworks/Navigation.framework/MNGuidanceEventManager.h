...
- (double)_calculateDurationToSpeakEvent:(id)arg1 announcementIndex:(unsigned int)arg2 distance:(double)arg3;
...
- (void)_handleDuration:(double)arg1 forEventID:(id)arg2 index:(unsigned int)arg3;
