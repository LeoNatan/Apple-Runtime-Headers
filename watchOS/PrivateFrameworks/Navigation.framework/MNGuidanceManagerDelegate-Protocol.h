...
- (void)guidanceManager:(id <MNGuidanceManager>)arg1 displayManeuverAlertForAnnouncementStage:(unsigned int)arg2;
...
- (void)guidanceManager:(id <MNGuidanceManager>)arg1 displayPrimaryStep:(GEOStep *)arg2 instructions:(NSArray *)arg3 shieldType:(int)arg4 shieldText:(NSString *)arg5 drivingSide:(int)arg6 maneuverStepIndex:(unsigned int)arg7 isSynthetic:(_Bool)arg8;
- (void)guidanceManagerDidUpdateProgress:(id <MNGuidanceManager>)arg1 currentStepIndex:(unsigned int)arg2 distanceUntilSign:(double)arg3 timeUntilSign:(double)arg4;
- (void)guidanceManagerProceedingToRoute:(id <MNGuidanceManager>)arg1 proceedToRouteDistance:(double)arg2 displayString:(NSString *)arg3 closestStepIndex:(unsigned int)arg4;
...
- (void)guidanceManager:(id <MNGuidanceManager>)arg1 announce:(NSString *)arg2 shortPromptType:(unsigned int)arg3 ignorePromptStyle:(_Bool)arg4 stage:(unsigned int)arg5 hasSecondaryManeuver:(_Bool)arg6 completionBlock:(void (^)(int))arg7;
- (void)guidanceManager:(id <MNGuidanceManager>)arg1 willAnnounce:(unsigned int)arg2 inSeconds:(double)arg3;
