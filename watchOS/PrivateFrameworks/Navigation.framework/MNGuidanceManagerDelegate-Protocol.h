...
- (void)guidanceManager:(id <MNGuidanceManager>)arg1 announce:(NSString *)arg2 shortPromptType:(unsigned int)arg3 stage:(unsigned int)arg4 hasSecondaryManeuver:(_Bool)arg5 completionBlock:(void (^)(int))arg6;
