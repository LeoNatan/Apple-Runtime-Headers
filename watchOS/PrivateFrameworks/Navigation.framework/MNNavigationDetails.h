...
@interface MNNavigationDetails : NSObject <NSSecureCoding>
{
    ...
    unsigned int _selectedPreviewRouteIndex;
...
@property(readonly, nonatomic) unsigned int selectedPreviewRouteIndex; // @synthesize selectedPreviewRouteIndex=_selectedPreviewRouteIndex;
