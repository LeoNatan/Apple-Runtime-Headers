...
- (void)subscribeToDestination:(MNPlannedDestination *)arg1 options:(int)arg2 refreshPolicy:(unsigned int)arg3;
- (void)requestRoutingOptions:(int)arg1 forDestinations:(NSArray *)arg2 freshness:(MNRouteUpdateFreshness *)arg3 handlerID:(NSUUID *)arg4;
@end
