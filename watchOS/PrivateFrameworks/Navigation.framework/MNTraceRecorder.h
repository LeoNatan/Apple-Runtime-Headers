...
@interface MNTraceRecorder : NSObject <MNLocationRecorder>
{
    ...
    unsigned int _lastLaneEventHash;
...
- (void)recordCommuteDirectionsRequest:(id)arg1 forDestinationID:(unsigned int)arg2;
- (void)recordCommuteDestinationWithID:(unsigned int)arg1 name:(id)arg2 waypoint:(id)arg3;
- (void)updateActualArrivalTime:(double)arg1 arrivalTimeDelta:(double)arg2 forStepIndex:(unsigned int)arg3;
- (void)recordProjectedArrivalTime:(double)arg1 actualArrivalTime:(double)arg2 arrivalTimeDelta:(double)arg3 matchType:(int)arg4 vehicleType:(int)arg5 lastKnownLocation:(id)arg6 forStepIndex:(unsigned int)arg7 withDuration:(double)arg8 andManeuverType:(int)arg9;
...
- (void)recordNavigationEvent:(int)arg1 forLocation:(id)arg2 description:(id)arg3;
- (void)recordTraceEventAtTime:(double)arg1 eventType:(int)arg2 stage:(int)arg3 description:(id)arg4;
- (void)recordTraceEventForEventType:(int)arg1 stage:(int)arg2 description:(id)arg3;
...
- (void)recordAudioSetting:(_Bool)arg1 volume:(int)arg2;
