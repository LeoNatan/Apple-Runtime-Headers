...
- (void)guidanceManager:(id)arg1 announce:(id)arg2 shortPromptType:(unsigned int)arg3 stage:(unsigned int)arg4 hasSecondaryManeuver:(_Bool)arg5 completionBlock:(CDUnknownBlockType)arg6;
