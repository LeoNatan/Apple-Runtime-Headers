...
- (void)timeAndDistanceUpdater:(id)arg1 didUpdateDisplayETA:(id)arg2 displayRemainingMinutes:(unsigned int)arg3 forRoute:(id)arg4;
...
- (void)guidanceManager:(id)arg1 announce:(id)arg2 shortPromptType:(unsigned int)arg3 ignorePromptStyle:(_Bool)arg4 stage:(unsigned int)arg5 hasSecondaryManeuver:(_Bool)arg6 completionBlock:(CDUnknownBlockType)arg7;
...
- (void)guidanceManager:(id)arg1 displayPrimaryStep:(id)arg2 instructions:(id)arg3 shieldType:(int)arg4 shieldText:(id)arg5 drivingSide:(int)arg6 maneuverStepIndex:(unsigned int)arg7 isSynthetic:(_Bool)arg8;
