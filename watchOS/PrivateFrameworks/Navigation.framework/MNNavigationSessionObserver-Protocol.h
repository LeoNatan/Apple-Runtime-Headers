...
- (void)navigationSession:(MNNavigationSession *)arg1 displayPrimaryStep:(GEOStep *)arg2 instructions:(NSArray *)arg3 shieldType:(int)arg4 shieldText:(NSString *)arg5 drivingSide:(int)arg6 maneuverStepIndex:(unsigned int)arg7 isSynthetic:(_Bool)arg8;
- (void)navigationSession:(MNNavigationSession *)arg1 triggerHaptics:(int)arg2;
- (void)navigationSession:(MNNavigationSession *)arg1 didAnnounce:(NSString *)arg2 stage:(unsigned int)arg3;
...
- (void)navigationSession:(MNNavigationSession *)arg1 didUpdateMotionType:(unsigned int)arg2 confidence:(unsigned int)arg3;
...
- (void)navigationSession:(MNNavigationSession *)arg1 didUpdateDisplayETA:(NSDate *)arg2 displayRemainingMinutes:(unsigned int)arg3 forRoute:(MNActiveRouteInfo *)arg4;
