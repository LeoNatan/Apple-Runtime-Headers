...
- (void)_retrieveProxyObjectAndRunServiceType:(int)arg1 completionBlock:(CDUnknownBlockType)arg2;
- (void)_callServiceByType:(int)arg1 onProxy:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
