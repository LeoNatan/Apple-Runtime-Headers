...
- (void)removeUninstalledProfileWithIdentifier:(id)arg1 installationType:(int)arg2 targetDeviceType:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
- (void)removeProfileWithIdentifier:(id)arg1 installationType:(int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)removeProtectedProfileAsyncWithIdentifier:(id)arg1 installationType:(int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)removeProfileAsyncWithIdentifier:(id)arg1 installationType:(int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)removeProtectedProfileAsyncWithIdentifier:(id)arg1 installationType:(int)arg2;
...
- (id)_handleQueueProfileError:(id)arg1 forTargetDevice:(unsigned int)arg2;
- (id)popProvisioningProfileDataFromHeadOfInstallationQueue;
- (id)peekProfileDataFromPurgatoryForDeviceType:(unsigned int)arg1;
- (id)popProfileDataFromPurgatoryForDeviceType:(unsigned int)arg1;
- (id)popProfileDataFromHeadOfInstallationQueue;
- (void)allProfilesOutMDMProfileInfo:(id *)arg1 outConfigurationProfilesInfo:(id *)arg2 outUninstalledProfilesInfo:(id *)arg3 forDeviceType:(unsigned int)arg4;
...
- (_Bool)_areProfilesRestrictingSettings:(id)arg1 outMDMName:(id *)arg2 outExchangeName:(id *)arg3 outExchangeCount:(int *)arg4 outProfileName:(id *)arg5 outProfileCount:(int *)arg6;
...
- (int)dragDropTargetManagementStateForBundleID:(id)arg1;
- (int)dragDropSourceManagementStateForBundleID:(id)arg1;
- (int)dragDropBidirectionalManagementStateForBaseBundleID:(id)arg1;
