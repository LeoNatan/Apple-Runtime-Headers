...
- (void)removeProtectedProfileWithIdentifier:(NSString *)arg1 installationType:(int)arg2 completion:(void (^)(NSError *))arg3;
- (void)removeUninstalledProfileWithIdentifier:(NSString *)arg1 installationType:(int)arg2 targetDeviceType:(unsigned int)arg3 completion:(void (^)(NSError *))arg4;
