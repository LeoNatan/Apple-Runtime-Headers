...
- (void)getShareOptionsOfItemIdentifier:(NSString *)arg1 reply:(void (^)(_Bool, _Bool, _Bool, NSError *))arg2;
...
- (void)startOperation:(NSObject<BROperationClient> *)arg1 toProcessSubitemsAtURL:(NSURL *)arg2 maxSubsharesFailures:(unsigned long long)arg3 processType:(unsigned int)arg4 reply:(void (^)(NSError *))arg5;
...
- (void)enumerateWorkingSetChangesFromChangeToken:(NSData *)arg1 limit:(unsigned int)arg2 completion:(void (^)(NSArray *, NSArray *, NSData *, NSError *))arg3;
...
- (void)getPublishedURLForItemAtURL:(NSURL *)arg1 forStreaming:(_Bool)arg2 requestedTTL:(unsigned int)arg3 reply:(void (^)(NSURL *, NSDate *, NSError *))arg4;
...
- (void)evictItemAtURL:(NSURL *)arg1 options:(unsigned int)arg2 reply:(void (^)(NSError *))arg3;
- (void)startOperation:(NSObject<BROperationClient> *)arg1 toDownloadItemAtURL:(NSURL *)arg2 readingOptions:(unsigned int)arg3 wantsCurrentVersion:(_Bool)arg4 reply:(void (^)(NSError *))arg5;
...
- (void)forceSyncZoneHealthWithBarrierWithTimeout:(unsigned int)arg1 reply:(void (^)(NSError *))arg2;
- (void)forceSyncWithBarrierContainerID:(NSString *)arg1 timeout:(unsigned int)arg2 reply:(void (^)(NSError *))arg3;
