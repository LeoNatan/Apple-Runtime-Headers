...
+ (id)br_errorWithDomain:(id)arg1 code:(int)arg2 userInfo:(id)arg3 description:(id)arg4;
+ (id)br_errorWithDomain:(id)arg1 code:(int)arg2 description:(id)arg3;
- (id)br_underlyingPOSIXError;
- (_Bool)br_isCloudDocsErrorCode:(int)arg1;
- (_Bool)br_isCocoaErrorCode:(int)arg1;
- (_Bool)br_isPOSIXErrorCode:(int)arg1;
@end
