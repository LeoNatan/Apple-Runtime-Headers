...
- (void)fetchMetadataWithTime:(double)arg1 offset:(unsigned long)arg2 metadataFrame:(void **)arg3 next:(void **)arg4;
- (id)findClosestMetadataFrameTo:(double)arg1 offset:(unsigned long)arg2;
- (void)writeMetadataBytes:(const void *)arg1 length:(unsigned long)arg2 timestamp:(double)arg3;
- (_Bool)writeSampleBytes:(const void *)arg1 length:(unsigned long)arg2 timestamp:(double)arg3;
- (void)dealloc;
- (id)initWithSampleFile:(id)arg1 metadataFile:(id)arg2 permission:(unsigned int)arg3 defaults:(id)arg4;
