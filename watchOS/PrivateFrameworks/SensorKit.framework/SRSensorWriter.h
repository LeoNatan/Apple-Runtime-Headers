...
- (void)provideSampleBytes:(const void *)arg1 length:(unsigned long)arg2 timestamp:(double)arg3;
- (void)provideSampleBytes:(const void *)arg1 length:(unsigned long)arg2 continuousTimestamp:(unsigned long long)arg3;
- (void)provideSampleBytes:(const void *)arg1 length:(unsigned long)arg2;
