...
@property int totalUnlocks; // @synthesize totalUnlocks=_totalUnlocks;
@property int totalScreenWakes; // @synthesize totalScreenWakes=_totalScreenWakes;
