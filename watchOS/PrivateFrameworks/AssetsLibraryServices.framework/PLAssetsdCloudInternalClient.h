...
- (unsigned int)getResetSyncStatusWithError:(id *)arg1;
...
- (unsigned long long)cloudSharingSpaceManagementRequestWithType:(unsigned int)arg1 optionalBytesToPurge:(unsigned long long)arg2 error:(id *)arg3;
