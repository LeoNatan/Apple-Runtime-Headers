...
- (void)getResetSyncStatusWithReply:(void (^)(unsigned int))arg1;
...
- (void)cloudSharingSpaceManagementRequestWithType:(unsigned int)arg1 optionalBytesToPurge:(unsigned long long)arg2 reply:(void (^)(unsigned long long, NSError *))arg3;
