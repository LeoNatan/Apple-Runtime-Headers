...
- (void)overrideSystemBudgetsForSyncSession:(_Bool)arg1 forSystemBudgets:(unsigned int)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)rampingRequestForResourceType:(unsigned int)arg1 numRequested:(unsigned int)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;
...
- (void)privateDownloadCloudPhotoLibraryAsset:(id)arg1 resourceType:(unsigned int)arg2 highPriority:(_Bool)arg3;
- (void)downloadCloudPhotoLibraryAsset:(id)arg1 resourceType:(unsigned int)arg2 highPriority:(_Bool)arg3 trackCPLDownload:(_Bool)arg4 downloadIsTransient:(_Bool)arg5 proposedTaskIdentifier:(id)arg6 completion:(CDUnknownBlockType)arg7;
...
- (void)downloadCloudSharedAsset:(id)arg1 withCloudPlaceholderKind:(unsigned int)arg2 shouldPrioritize:(_Bool)arg3 shouldExtendTimer:(_Bool)arg4 completionHandler:(CDUnknownBlockType)arg5;
