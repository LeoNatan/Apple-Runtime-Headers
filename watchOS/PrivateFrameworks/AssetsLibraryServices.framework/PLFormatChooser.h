...
- (void)chooseFormatsForSize:(struct CGSize)arg1 specificVersionType:(int)arg2 contentMode:(int)arg3 demoteFactor:(double)arg4 srcAspectRatio:(double)arg5 degradedFormatPolicy:(int)arg6 hasAdjustmentsHandler:(CDUnknownBlockType)arg7 desiredImagePixelSize:(struct CGSize *)arg8 bestFormat:(id *)arg9 degradedFormat:(id *)arg10;
...
- (id)_bestFormatWithSize:(struct CGSize)arg1 specificVersionType:(int)arg2 contentMode:(int)arg3 demoteFactor:(double)arg4 srcAspectRatio:(double)arg5 hasAdjustmentsHandler:(CDUnknownBlockType)arg6 desiredImagePixelSize:(struct CGSize *)arg7;
- (id)derivativeFormatThatFitsSize:(struct CGSize)arg1 contentMode:(int)arg2 demoteFactor:(double)arg3 srcAspectRatio:(double)arg4 desiredImagePixelSize:(struct CGSize *)arg5;
