...
- (void)addIntegerQueryKey:(int)arg1 withValue:(int)arg2 comparator:(int)arg3;
- (void)addDoubleQueryKey:(int)arg1 withValue:(double)arg2 comparator:(int)arg3;
- (void)addHasLocationQuery:(_Bool)arg1;
- (void)addWhiteBalanceQuery:(int)arg1 comparator:(int)arg2;
- (void)addTrackFormatQuery:(int)arg1 comparator:(int)arg2;
- (void)addShutterSpeedQuery:(double)arg1 comparator:(int)arg2;
- (void)addSampleRateQuery:(int)arg1 comparator:(int)arg2;
- (void)addMeteringModeQuery:(int)arg1 comparator:(int)arg2;
- (void)addLensModelQuery:(id)arg1 comparator:(int)arg2;
- (void)addFpsQuery:(double)arg1 comparator:(int)arg2;
- (void)addIsoQuery:(int)arg1 comparator:(int)arg2;
...
- (void)addIsoRangeQueryBetweenValue:(int)arg1 andValue:(int)arg2;
...
- (void)addInTheLastSecondsQueryKey:(int)arg1 withCount:(int)arg2 exclude:(_Bool)arg3;
- (void)addInTheLastYearsQueryKey:(int)arg1 withCount:(int)arg2 exclude:(_Bool)arg3;
- (void)addInTheLastMonthsQueryKey:(int)arg1 withCount:(int)arg2 exclude:(_Bool)arg3;
- (void)addInTheLastWeeksQueryKey:(int)arg1 withCount:(int)arg2 exclude:(_Bool)arg3;
- (void)addInTheLastDaysQueryKey:(int)arg1 withCount:(int)arg2 exclude:(_Bool)arg3;
