...
- (id)maskImageForLayer:(id)arg1 size:(struct CGSize)arg2 scale:(float)arg3 resourceProvider:(id)arg4;
- (id)scaledImageFromContent:(id)arg1 size:(struct CGSize)arg2 scale:(float)arg3;
- (void)drawElement:(id)arg1 inContext:(id)arg2;
@property(readonly) _Bool canUseCoreImage; // @dynamic canUseCoreImage;
- (id)filterForLayer:(id)arg1 scale:(float)arg2 resourceProvider:(id)arg3;
