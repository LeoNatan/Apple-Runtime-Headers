...
- (id)modelWithObjectChangeType:(unsigned int)arg1;
...
@property(nonatomic) int targetProtectionMode; // @synthesize targetProtectionMode=_targetProtectionMode;
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;
@property(readonly) unsigned int hash;
- (void)configureWithHome:(id)arg1;
- (id)initWithModel:(id)arg1;
- (id)initWithUUID:(id)arg1 manufacturer:(id)arg2 category:(id)arg3 targetProtectionMode:(int)arg4;
