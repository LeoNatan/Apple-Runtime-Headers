...
@class HAPAccessoryServerBrowserBTLE, HAPAccessoryServerBrowserIP, HAPAccessoryServerBrowserRelay, HAPWACAccessoryBrowser, HMDAuthServer, HMDHomeManager, HMDMediaBrowser, HMDUnassociatedWACAccessory, HMDWACBrowser, HMFMessageDispatcher, HMFTimer, NSArray, NSData, NSHashTable, NSMapTable, NSMutableArray, NSMutableSet, NSObject, NSString, NSUUID;
...
- (void)accessoryServer:(id)arg1 requestUserPermission:(int)arg2 accessoryInfo:(id)arg3 error:(id)arg4;
- (void)accessoryServer:(id)arg1 promtDialog:(id)arg2 forNotCertifiedAccessory:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)_callProgressOrErrorOut:(id)arg1 pairingInfo:(id)arg2 accessoryInfo:(id)arg3 unpairedAccessory:(id)arg4 progress:(int)arg5 certStatus:(unsigned int)arg6;
...
- (void)_checkIfPairingWithPairedAccessoryServer:(id)arg1 errorCode:(int)arg2;
- (void)_removePairingInformation:(id)arg1 errorCode:(int)arg2;
...
- (void)_discoverAccessoryServer:(id)arg1 linkType:(int)arg2 errorHandler:(CDUnknownBlockType)arg3;
...
- (unsigned int)numPairedIPAccessories;
...
- (void)discoverAccessoryServer:(id)arg1 linkType:(int)arg2 errorHandler:(CDUnknownBlockType)arg3;
