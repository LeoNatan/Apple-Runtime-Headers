...
@property unsigned int privilege; // @synthesize privilege=_privilege;
...
- (void)dealloc;
- (id)initWithAccountHandle:(id)arg1 home:(id)arg2 pairingIdentity:(id)arg3 privilege:(unsigned int)arg4;
