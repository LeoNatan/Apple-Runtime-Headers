...
@class HMDCentralMessageDispatcher, HMDDevice, HMFTimer, NSMapTable, NSMutableArray, NSObject<OS_dispatch_queue>, NSString, NSUUID;
...
- (id)deviceForType:(int)arg1;
- (_Bool)containsDevice:(id)arg1;
- (void)_removeDeviceForType:(int)arg1;
- (void)removeDeviceForType:(int)arg1;
- (void)setDevice:(id)arg1 forType:(int)arg2;
