...
@property(nonatomic) unsigned int pairingAttempts; // @synthesize pairingAttempts=_pairingAttempts;
@property(nonatomic) unsigned int activationAttempts; // @synthesize activationAttempts=_activationAttempts;
...
- (void)setReachability:(_Bool)arg1 serverIdentifier:(id)arg2 linkType:(int)arg3;
...
- (void)_evaluateLocalOperation:(int)arg1 state:(id)arg2 logEventSession:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)_readCharacteristicValues:(id)arg1 hapAccessory:(id)arg2 source:(unsigned int)arg3 queue:(id)arg4 logEventSession:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)_readCharacteristicValues:(id)arg1 hapAccessory:(id)arg2 source:(unsigned int)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)_writeCharacteristicValues:(id)arg1 hapAccessory:(id)arg2 source:(unsigned int)arg3 queue:(id)arg4 logEventSession:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)_writeCharacteristicValues:(id)arg1 hapAccessory:(id)arg2 source:(unsigned int)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void)_readCharacteristicValues:(id)arg1 localOperationRequired:(_Bool)arg2 source:(unsigned int)arg3 queue:(id)arg4 logEventSession:(id)arg5 completionHandler:(CDUnknownBlockType)arg6 errorBlock:(CDUnknownBlockType)arg7;
- (void)_readCharacteristicValues:(id)arg1 localOperationRequired:(_Bool)arg2 source:(unsigned int)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5 errorBlock:(CDUnknownBlockType)arg6;
- (void)autoUpdateCachedCountDownCharacteristics:(id)arg1;
- (void)readCharacteristicValues:(id)arg1 source:(unsigned int)arg2 queue:(id)arg3 logEventSession:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)readCharacteristicValues:(id)arg1 source:(unsigned int)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (id)_getResponseTuple:(id)arg1 error:(id)arg2 source:(unsigned int)arg3 suspended:(_Bool)arg4;
- (id)getFullError:(id)arg1 source:(unsigned int)arg2 suspended:(_Bool)arg3;
- (void)_writeCharacteristicValues:(id)arg1 localOperationRequired:(_Bool)arg2 source:(unsigned int)arg3 queue:(id)arg4 logEventSession:(id)arg5 completionHandler:(CDUnknownBlockType)arg6 errorBlock:(CDUnknownBlockType)arg7;
- (void)_writeCharacteristicValues:(id)arg1 localOperationRequired:(_Bool)arg2 source:(unsigned int)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5 errorBlock:(CDUnknownBlockType)arg6;
- (void)writeCharacteristicValues:(id)arg1 source:(unsigned int)arg2 queue:(id)arg3 logEventSession:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)writeCharacteristicValues:(id)arg1 source:(unsigned int)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (_Bool)canWakeBasedOnCharacteristic:(id)arg1;
@property(readonly) _Bool supportsUserManagement;
- (void)_performOperation:(int)arg1 linkType:(int)arg2 logEventSession:(id)arg3 operationBlock:(CDUnknownBlockType)arg4 errorBlock:(CDUnknownBlockType)arg5;
- (void)performOperation:(int)arg1 linkType:(int)arg2 operationBlock:(CDUnknownBlockType)arg3 errorBlock:(CDUnknownBlockType)arg4;
- (_Bool)matchesHAPAccessoryWithServerIdentifier:(id)arg1 linkType:(int *)arg2;
...
- (void)unconfigureAccessoryWithServerIdentifier:(id)arg1 linkType:(int)arg2 updateReachability:(_Bool)arg3;
- (void)unconfigure;
...
- (void)_removeHAPAccessoryWithServerIdentifier:(id)arg1 linkType:(int)arg2 completion:(CDUnknownBlockType)arg3 completionQueue:(id)arg4;
- (void)removeHAPAccessoryWithServerIdentifier:(id)arg1 linkType:(int)arg2 completion:(CDUnknownBlockType)arg3 completionQueue:(id)arg4;
...
- (unsigned int)_currentRelayAccessoryState;
@property(readonly, nonatomic) unsigned int currentRelayAccessoryState; // @synthesize currentRelayAccessoryState=_currentRelayAccessoryState;
