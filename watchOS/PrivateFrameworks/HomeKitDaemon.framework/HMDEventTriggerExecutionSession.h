...
@property(nonatomic) unsigned int executionState; // @synthesize executionState=_executionState;
...
- (void)_userResponse:(unsigned int)arg1 device:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)userResponse:(unsigned int)arg1 device:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
