...
- (void)_handleAuthenticationResults:(id)arg1 error:(id)arg2 targetedAccountType:(unsigned int)arg3;
- (void)_authenticateAccount:(id)arg1 targetedAccountType:(unsigned int)arg2;
- (void)_authenticateStoreWithAuthenticationResults:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)_authenticateForAccountType:(unsigned int)arg1 usingAuthenticationResults:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
