...
{
    int _advertisementProtocol;
}

+ (id)parsedFromData:(id)arg1 error:(id *)arg2;
+ (id)protocolFromFirewallRuleAdvertisingProtocol:(unsigned char)arg1;
@property(nonatomic) int advertisementProtocol; // @synthesize advertisementProtocol=_advertisementProtocol;
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;
- (id)copyWithZone:(struct _NSZone *)arg1;
- (id)serializeWithError:(id *)arg1;
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;
- (id)initWithAdvertisementProtocol:(int)arg1;
- (id)init;
