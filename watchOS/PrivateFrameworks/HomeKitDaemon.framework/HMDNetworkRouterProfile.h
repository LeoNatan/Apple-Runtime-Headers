...
+ (id)logCategory;
@property(nonatomic) int routerStatus; // @synthesize routerStatus=_routerStatus;
...
- (void)__notifyClientsOfNetworkStatus:(unsigned int)arg1;
- (void)_notifyClientsOfNetworkStatusUpdate;
- (unsigned int)__networkStatusFromWANStatus:(id)arg1;
