...
@interface HMDNetworkRouterFirewallRuleManager : HMFObject <HMFLogging, HMDNetworkRouterFirewallRuleManager, HMDNetworkRouterFirewallRuleManagerDebug>
{
    ...
    unsigned int _operationsInProgressCount;
...
@property(nonatomic) unsigned int operationsInProgressCount; // @synthesize operationsInProgressCount=_operationsInProgressCount;
