...
- (_Bool)_shouldQueryCanDisableRecordingForAccessMode:(unsigned int)arg1 isAtHome:(_Bool)arg2 currentSettings:(id)arg3;
- (_Bool)_shouldQueryCanEnableRecordingForAccessMode:(unsigned int)arg1 currentSettings:(id)arg2;
- (void)_addRecordingAudioEnabledWriteRequestToArray:(id)arg1 recordingAudioEnabled:(_Bool)arg2;
- (void)_addAccessModeCharacteristicWriteRequestsToArray:(id)arg1 currentAccessMode:(unsigned int)arg2;
- (void)_addHomeKitCameraActiveCharacteristicWriteRequestToArray:(id)arg1 currentAccessMode:(unsigned int)arg2;
