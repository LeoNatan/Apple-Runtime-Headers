...
- (_Bool)updateTargetProtectionModeForGroupWithUUID:(id)arg1 protectionMode:(int)arg2 error:(id *)arg3 requestMessage:(id)arg4;
- (_Bool)updateTargetProtectionModeForGroupWithUUID:(id)arg1 protectionMode:(int)arg2 error:(id *)arg3;
- (int)targetProtectionModeForGroupWithUUID:(id)arg1;
