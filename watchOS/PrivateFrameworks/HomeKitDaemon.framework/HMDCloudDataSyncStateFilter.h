...
- (_Bool)_cloudSyncinProgressCheck:(id)arg1 supressPopup:(_Bool)arg2 sendCanceledError:(_Bool *)arg3 dataSyncState:(unsigned int *)arg4;
- (_Bool)dataSyncInProgressWithState:(unsigned int *)arg1 withMessage:(id)arg2;
...
- (void)_postNotificationForDataSyncInProgress:(_Bool)arg1 dataSyncState:(unsigned int)arg2 forcePost:(_Bool)arg3;
- (void)handleKeychainSyncStateChangedNotification:(id)arg1;
- (void)_updateKeychainSyncEnabled:(_Bool)arg1;
- (void)dealloc;
- (void)_registerForMessages;
- (id)initWithName:(id)arg1 homeManager:(id)arg2 messageDispatcher:(id)arg3 serverTokenAvailable:(_Bool)arg4 homeDataHasBeenDecrypted:(_Bool)arg5 homeManagerServerTokenAvailable:(_Bool)arg6 localDataDecryptionFailed:(_Bool)arg7 totalHomes:(int)arg8 currentAccount:(id)arg9;
