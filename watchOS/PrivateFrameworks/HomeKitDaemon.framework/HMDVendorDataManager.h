...
- (_Bool)_parseDatabaseFromDictionary:(id)arg1 dataVersion:(int *)arg2 collectionsByManufacturer:(struct NSDictionary **)arg3 entriesByProductData:(struct NSDictionary **)arg4;
