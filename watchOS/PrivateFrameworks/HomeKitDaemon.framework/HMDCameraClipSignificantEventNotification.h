...
- (id)initWithUUID:(id)arg1 dateOfOccurrence:(id)arg2 significantEvent:(unsigned int)arg3 heroFrameURL:(id)arg4 camera:(id)arg5 clip:(id)arg6 timeOffsetWithinClip:(double)arg7 homePresence:(id)arg8;
