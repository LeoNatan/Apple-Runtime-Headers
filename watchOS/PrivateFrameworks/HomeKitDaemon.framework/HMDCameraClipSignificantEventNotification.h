...
- (id)initWithUUID:(id)arg1 dateOfOccurrence:(id)arg2 reason:(unsigned int)arg3 confidenceLevel:(unsigned int)arg4 heroFrameURL:(id)arg5 camera:(id)arg6 clip:(id)arg7 timeOffsetWithinClip:(double)arg8 homePresence:(id)arg9;
