...
@property(nonatomic) int startupTickCount; // @synthesize startupTickCount=_startupTickCount;
...
- (id)deviceForAccessory:(id)arg1 residentOrder:(unsigned int)arg2 reachableResidents:(unsigned int *)arg3;
