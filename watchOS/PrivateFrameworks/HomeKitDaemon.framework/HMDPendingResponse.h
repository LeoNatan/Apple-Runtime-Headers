...
@interface HMDPendingResponse : HMFObject
{
    ...
    unsigned int _pendingResponseCount;
    unsigned int _totalRequestsCount;
...
+ (id)tupleForMessage:(id)arg1 originalRequestIdentifier:(id)arg2 requestCount:(unsigned int)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
- (void).cxx_destruct;
...
@property(nonatomic) unsigned int totalRequestsCount; // @synthesize totalRequestsCount=_totalRequestsCount;
@property(nonatomic) unsigned int pendingResponseCount; // @synthesize pendingResponseCount=_pendingResponseCount;
