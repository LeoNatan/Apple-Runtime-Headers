...
@property(readonly, nonatomic) int residentEnabledState; // @synthesize residentEnabledState=_residentEnabledState;
...
@property(readonly, nonatomic) unsigned int assistantGenerationCounter; // @synthesize assistantGenerationCounter=_assistantGenerationCounter;
...
@property(readonly, nonatomic) int schemaVersion; // @synthesize schemaVersion=_schemaVersion;
...
- (void).cxx_destruct;
- (id)initWithHomes:(id)arg1 accessories:(id)arg2 primaryHomeUUID:(id)arg3 lastCurrentHomeUUID:(id)arg4 dataVersion:(int)arg5 schemaVersion:(int)arg6 dataTag:(id)arg7 uuidsOfRemovedHomes:(id)arg8 cloudZones:(id)arg9 incomingInvitations:(id)arg10 assistantGenerationCounter:(unsigned int)arg11 currentDevice:(id)arg12 pendingReasonSaved:(id)arg13 pendingUserManagementOperations:(id)arg14 unprocessedOperationIdentifiers:(id)arg15 applicationData:(id)arg16 residentEnabledState:(int)arg17 account:(id)arg18 accessAllowedWhenLocked:(_Bool)arg19;
