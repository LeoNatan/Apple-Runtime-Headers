...
- (id)initWithShareGroup:(id)arg1 record:(id)arg2 data:(id)arg3 encoding:(unsigned int)arg4 resultBlock:(CDUnknownBlockType)arg5;
- (id)initWithGroup:(id)arg1 record:(id)arg2 data:(id)arg3 encoding:(unsigned int)arg4 resultBlock:(CDUnknownBlockType)arg5;
- (id)initWithGroup:(id)arg1 share:(id)arg2 name:(id)arg3 record:(id)arg4 data:(id)arg5 encoding:(unsigned int)arg6 model:(id)arg7 resultBlock:(CDUnknownBlockType)arg8;
