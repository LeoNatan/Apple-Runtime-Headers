...
- (id)initWithSentinal:(id)arg1 alreadyPushedTo:(unsigned int)arg2 fetchResult:(CDUnknownBlockType)arg3;
- (id)initWithAlreadyPushedTo:(unsigned int)arg1 result:(CDUnknownBlockType)arg2;
- (id)initWithSentinal:(id)arg1 needsPushTo:(unsigned int)arg2 fetchResult:(CDUnknownBlockType)arg3;
