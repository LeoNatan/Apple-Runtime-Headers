...
@property(nonatomic) unsigned int homeDatabaseSize; // @synthesize homeDatabaseSize=_homeDatabaseSize;
...
@property(nonatomic) unsigned int assistantGenerationCounter; // @synthesize assistantGenerationCounter=_assistantGenerationCounter;
...
@property(nonatomic) int residentEnabledState; // @synthesize residentEnabledState=_residentEnabledState;
...
- (unsigned int)statusForMessage:(id)arg1;
...
- (void)_sendUpdateRequestToAdminForInvitation:(id)arg1 homeUUID:(id)arg2 invitationState:(int)arg3 authStatus:(id)arg4;
...
- (void)processTransactionsFromHomeDataSync:(id)arg1 accessories:(id)arg2 version:(int)arg3 completion:(CDUnknownBlockType)arg4;
- (void)_processSharedHomeModel:(id)arg1 message:(id)arg2;
- (void)processSharedHomeModelUpdate:(id)arg1 message:(id)arg2;
- (id)_loadCloudTransactionForRemoteHome:(id)arg1 localHome:(id)arg2 cachedHome:(id)arg3 version:(int)arg4 cloudTransaction:(id)arg5 stagedTransaction:(id)arg6 mustReplayTransaction:(id)arg7;
...
- (id)_trackIncomingInvitationFromAccount:(id)arg1 message:(id)arg2 invitationState:(int)arg3 error:(id *)arg4;
...
- (_Bool)_preferLocalHomesOverCloudHomes:(id)arg1 migrationOptions:(unsigned int)arg2;
- (void)_transactionalizeAndApplyHomeData:(id)arg1 cachedHomeData:(id)arg2 syncCompletion:(CDUnknownBlockType)arg3;
- (void)_transactionalizeAndApplyCloudHomeData:(id)arg1 cachedHomeData:(id)arg2 version:(int)arg3 migrationOptions:(unsigned int)arg4 dataWasMerged:(_Bool *)arg5 syncCompletion:(CDUnknownBlockType)arg6;
...
- (id)checkConflictInHomeNamespaceWithName:(id)arg1 options:(unsigned int)arg2 namespaceUUID:(id)arg3;
...
- (void)_updateModelChangesAsPushed:(id)arg1 home:(id)arg2 pushMask:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)_updateHomeManagerModelChangesAsPushed:(id)arg1 pushMask:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)_processRemoveHomeModels:(id)arg1 processIndex:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)migrateModelObjectsToCloud:(int)arg1 schemaVersion:(int)arg2;
...
- (void)_sendFragmentedMessage:(id)arg1 messageIndex:(unsigned int)arg2 messageIdentity:(id)arg3 userID:(id)arg4 destination:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
