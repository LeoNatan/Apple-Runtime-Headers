...
- (void)_getRuntimeStateUpdateForHomeManager:(_Bool)arg1 includeMediaAccessoryState:(_Bool)arg2 options:(unsigned int)arg3 includeResidentDeviceState:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
- (id)_runtimeState;
