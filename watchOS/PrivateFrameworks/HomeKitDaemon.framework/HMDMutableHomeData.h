...
@property(nonatomic) int residentEnabledState; // @dynamic residentEnabledState;
...
@property(nonatomic) unsigned int assistantGenerationCounter; // @dynamic assistantGenerationCounter;
...
@property(nonatomic) int dataVersion; // @dynamic dataVersion;
