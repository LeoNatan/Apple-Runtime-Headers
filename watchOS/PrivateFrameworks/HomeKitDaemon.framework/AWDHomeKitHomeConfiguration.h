...
- (id)primaryHAPServicesListCertifiedAtIndex:(unsigned int)arg1;
- (unsigned int)primaryHAPServicesListCertifiedsCount;
- (void)addPrimaryHAPServicesListCertified:(id)arg1;
- (void)clearPrimaryHAPServicesListCertifieds;
- (id)hapServicesListCertifiedAtIndex:(unsigned int)arg1;
- (unsigned int)hapServicesListCertifiedsCount;
- (void)addHapServicesListCertified:(id)arg1;
- (void)clearHapServicesListCertifieds;
- (id)primaryHAPServicesListAtIndex:(unsigned int)arg1;
- (unsigned int)primaryHAPServicesListsCount;
- (void)addPrimaryHAPServicesList:(id)arg1;
- (void)clearPrimaryHAPServicesLists;
- (id)hapServicesListAtIndex:(unsigned int)arg1;
- (unsigned int)hapServicesListsCount;
...
- (id)homeKitMultiUserSettingsAtIndex:(unsigned int)arg1;
- (unsigned int)homeKitMultiUserSettingsCount;
...
- (id)eventTriggersAtIndex:(unsigned int)arg1;
- (unsigned int)eventTriggersCount;
