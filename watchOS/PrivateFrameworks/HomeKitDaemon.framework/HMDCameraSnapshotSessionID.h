...
@property(readonly) unsigned int snapshotReason; // @synthesize snapshotReason=_snapshotReason;
...
- (id)initWithSessionID:(id)arg1 remoteDevice:(id)arg2 cameraSessionAppID:(id)arg3 descriptionString:(id)arg4 spiClient:(_Bool)arg5 snapshotReason:(unsigned int)arg6 snapshotRequestForBulletin:(_Bool)arg7 snapshotCharacteristicEventUUID:(id)arg8 streamingTier:(id)arg9;
