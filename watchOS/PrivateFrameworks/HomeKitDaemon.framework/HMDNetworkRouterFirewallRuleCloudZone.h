...
+ (unsigned int)__maxSizeForCKRecordString;
+ (unsigned int)__maxSizeForCKRecordNetworkDeclarationsSignature;
+ (unsigned int)__maxSizeForCKRecordNetworkDeclarations;
