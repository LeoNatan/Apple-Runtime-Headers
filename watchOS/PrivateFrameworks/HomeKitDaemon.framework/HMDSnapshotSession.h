...
@property(readonly, nonatomic) unsigned int streamingTierType; // @synthesize streamingTierType=_streamingTierType;
...
- (void)dealloc;
- (id)logIdentifier;
- (id)initWithSessionID:(id)arg1 accessory:(id)arg2 snapshotGetter:(id)arg3 message:(id)arg4 waitPeriod:(double)arg5 streamingTierType:(unsigned int)arg6 cameraLocallyReachable:(_Bool)arg7 snapshotForNotification:(_Bool)arg8;
