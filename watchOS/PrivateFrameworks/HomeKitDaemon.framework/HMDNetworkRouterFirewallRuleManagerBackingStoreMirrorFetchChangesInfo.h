...
@property(nonatomic) _Bool zonesWereDeleted; // @synthesize zonesWereDeleted=_zonesWereDeleted;
@property(nonatomic) _Bool zonesHaveChanged; // @synthesize zonesHaveChanged=_zonesHaveChanged;
