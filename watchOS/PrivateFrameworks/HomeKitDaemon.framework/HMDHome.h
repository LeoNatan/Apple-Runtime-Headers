...
@interface HMDHome : HMFObject <HMDBulletinIdentifiers, HMDResidentDeviceManagerDelegate, HMFLogging, HMDAccessoryBrowserDelegate, HMDHomeMessageReceiver, HMDRelayManagerDelegate, HMFTimerDelegate, HMFDumpState, HMDUserManagementOperationDelegate, NSSecureCoding, HMDBackingStoreObjectProtocol>
{
    ...
    int _lastKnownReachableIPAndMediaAccessoryCount;
...
@property(nonatomic) int lastKnownReachableIPAndMediaAccessoryCount; // @synthesize lastKnownReachableIPAndMediaAccessoryCount=_lastKnownReachableIPAndMediaAccessoryCount;
...
- (void)_updateOutgoingInvitationForUser:(id)arg1 invitationState:(int)arg2 error:(id)arg3 responseHandler:(CDUnknownBlockType)arg4;
...
- (void)_addUser:(id)arg1 userPrivilege:(unsigned int)arg2 confirm:(_Bool)arg3 message:(id)arg4;
- (void)_cleanRemovedUsers:(id)arg1;
- (void)_handleAddUser:(id)arg1;
- (id)prepareUserManagementOperationForUser:(id)arg1 accessory:(id)arg2 type:(unsigned int)arg3 error:(id *)arg4;
...
- (void)_processAccessoriesToAddForUnpairedAccessory:(id)arg1 certificationStatus:(int)arg2 accessoryServer:(id)arg3 message:(id)arg4;
