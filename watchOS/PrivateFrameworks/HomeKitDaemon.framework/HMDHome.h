...
@interface HMDHome : HMFObject <HMDBulletinIdentifiers, HMDResidentDeviceManagerDelegate, HMFLogging, HMDAccessoryBrowserDelegate, HMDHomeMessageReceiver, HMDRelayManagerDelegate, HMFTimerDelegate, HMFDumpState, HMDUserManagementOperationDelegate, HMDMediaActionRouterDataSource, NSSecureCoding, HMDBackingStoreObjectProtocol>
{
    ...
    int _lastSyncedConfigurationVersion;
...
@property(nonatomic) int expectedConfigurationVersion; // @synthesize expectedConfigurationVersion=_expectedConfigurationVersion;
@property(nonatomic) int lastSyncedConfigurationVersion; // @synthesize lastSyncedConfigurationVersion=_lastSyncedConfigurationVersion;
...
@property(nonatomic) unsigned int homeHubState; // @synthesize homeHubState=_homeHubState;
...
- (void)_handleWriteMediaProperties:(id)arg1 source:(unsigned int)arg2 requestMessage:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)_handleReadMediaProperties:(id)arg1 source:(unsigned int)arg2 message:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (id)homeConfigurationModelObjectWithChangeType:(unsigned int)arg1;
...
- (void)_notifyRetrievalError:(id)arg1 accessoryServer:(id)arg2 linkType:(int)arg3 accessoryOperationBlock:(CDUnknownBlockType)arg4;
...
- (_Bool)_isRetrievalInProgressForLinkType:(int)arg1 accessory:(id)arg2;
...
- (void)_retrieveHAPAccessoryForHMDAccessory:(id)arg1 linkType:(int)arg2 queue:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)retrieveHAPAccessoryForHMDAccessory:(id)arg1 linkType:(int)arg2 queue:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)setMinimumMediaUserPrivilege:(int)arg1;
...
@property(readonly, nonatomic) int homeLocation; // @synthesize homeLocation=_homeLocation;
@property(nonatomic) int atHomeLevel; // @synthesize atHomeLevel=_atHomeLevel;
...
- (void)_readCharacteristicValues:(id)arg1 requestMessage:(id)arg2 source:(unsigned int)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
...
- (void)readCharacteristicValues:(id)arg1 identifier:(id)arg2 isSPIEntitled:(_Bool)arg3 source:(unsigned int)arg4 logEventSession:(id)arg5 withCompletionHandler:(CDUnknownBlockType)arg6;
...
- (void)_writeCharacteristicValues:(id)arg1 requestMessage:(id)arg2 source:(unsigned int)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
- (void)_redispatchWriteForAccessories:(id)arg1 dispatchGroup:(id)arg2 requestMap:(id)arg3 requestMessage:(id)arg4 source:(unsigned int)arg5 responseTuples:(id)arg6;
- (void)_loadBalancedRedispatchForAccessories:(id)arg1 source:(unsigned int)arg2 dispatchGroup:(id)arg3 writeRequestMap:(id)arg4 requestMessage:(id)arg5 responseTuples:(id)arg6;
...
- (void)_writeCharacteristicValuesForAccessories:(id)arg1 writeRequestMap:(id)arg2 responseTuples:(id)arg3 requestMessage:(id)arg4 viaDevice:(id)arg5 source:(unsigned int)arg6 logEventSession:(id)arg7 completionHandler:(CDUnknownBlockType)arg8;
- (id)_applyDeviceLockCheck:(id)arg1 forSource:(unsigned int)arg2;
- (void)writeCharacteristicValues:(id)arg1 source:(unsigned int)arg2 identifier:(id)arg3 logEventSession:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;
...
- (id)prepareUserManagementOperationForUser:(id)arg1 accessory:(id)arg2 type:(unsigned int)arg3 model:(id)arg4 error:(id *)arg5;
- (id)prepareUserManagementOperationForUser:(id)arg1 accessories:(id)arg2 type:(unsigned int)arg3 error:(id *)arg4;
...
- (void)_processAccessoriesToAddForUnpairedAccessory:(id)arg1 certificationStatus:(int)arg2 accessoryServer:(id)arg3 networkCredential:(id)arg4 message:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
- (void)getReachableIPAccessories:(unsigned int *)arg1 btleAccessories:(unsigned int *)arg2 mediaAccessories:(unsigned int *)arg3;
- (unsigned int)reachableIPAccessories;
- (int)reachableMediaAccessories;
...
- (unsigned int)accessoryCountForRoom:(id)arg1;
...
- (void)notifyOfRemovedAccessory:(id)arg1 source:(unsigned int)arg2;
...
- (void)_accessoryPairingDidComplete:(id)arg1 configuration:(id)arg2 pairingEvent:(id)arg3 accessoryServer:(id)arg4 certificationStatus:(int)arg5 requestMessage:(id)arg6;
...
- (unsigned int)assistantAccessCapableAccessoryCount;
...
- (id)getTransactionFromHAPAccessory:(id)arg1 hmdAccessory:(id)arg2 uuid:(id)arg3 bridgeUUID:(id)arg4 configurationAppIdentifier:(id)arg5 objectChangeType:(unsigned int)arg6;
- (id)getServiceTransaction:(id)arg1 parentUUID:(id)arg2 changeType:(unsigned int)arg3;
...
- (id)hapAccessoriesForServer:(id)arg1 linkType:(int)arg2;
- (void)_readProfileState:(id)arg1 viaDevice:(id)arg2 message:(id)arg3;
- (void)_getRunTimeStateUpdateWithOptions:(unsigned int)arg1 includeMediaAccessoryState:(_Bool)arg2 includeResidentDeviceState:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
- (id)residentDevicesIncludingRemoteGateways;
- (void)getRunTimeStateUpdateWithOptions:(unsigned int)arg1 includeMediaAccessoryState:(_Bool)arg2 includeResidentDeviceState:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
- (void)handleBackgroundTaskAgentJob:(id)arg1;
- (void)checkTimerTriggers;
- (id)migrateOwnedTriggers;
- (void)writeCharacteristicValues:(id)arg1 source:(unsigned int)arg2 transactionId:(id)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
...
- (_Bool)configure:(id)arg1 accessoriesPresent:(id)arg2 source:(unsigned int)arg3;
...
- (_Bool)checkForNetworkRouterSupport:(unsigned int)arg1 error:(id *)arg2;
...
- (unsigned int)deriveNetworkRouterSupport:(unsigned int)arg1;
