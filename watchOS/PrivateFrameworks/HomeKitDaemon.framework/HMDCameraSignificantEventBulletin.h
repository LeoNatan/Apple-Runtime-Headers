...
+ (id)localizedMessageForSignificantEvent:(unsigned int)arg1;
...
- (id)initWithNotificationUUID:(id)arg1 previewImageFilePathURL:(id)arg2 significantEvent:(unsigned int)arg3 camera:(id)arg4 home:(id)arg5 accessory:(id)arg6 recordingService:(id)arg7;
