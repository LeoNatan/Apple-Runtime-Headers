...
- (_Bool)_validFetchRetryCKErrorCode:(int)arg1;
...
- (void)_verifyZonesExist:(id)arg1 zoneIndex:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_resetHomeDataRecordState;
- (id)_changeTokenFromData:(id)arg1;
- (void)_handleAccountStatus:(int)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)updateAccountStatusChanged:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)_processFetchCompletedWithError:(id)arg1 serverToken:(id)arg2 fetchTransaction:(id)arg3 migrationOptions:(int)arg4 completionHandler:(CDUnknownBlockType)arg5 moreRecordsComing:(_Bool)arg6 emptyRecord:(_Bool)arg7;
