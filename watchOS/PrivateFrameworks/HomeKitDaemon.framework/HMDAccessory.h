...
@property(nonatomic) _Bool supportsMediaContentProfile; // @synthesize supportsMediaContentProfile=_supportsMediaContentProfile;
...
- (void)saveCurrentNetworkProtectionMode:(int)arg1 appliedFirewallWANRules:(id)arg2;
