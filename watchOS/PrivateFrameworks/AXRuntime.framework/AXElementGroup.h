...
@interface AXElementGroup : NSArray <AXGroupable>
{
    ...
    unsigned long _groupTraits;
    unsigned long _userDefinedScanningBehaviorTraits;
...
@property(nonatomic) unsigned long userDefinedScanningBehaviorTraits; // @synthesize userDefinedScanningBehaviorTraits=_userDefinedScanningBehaviorTraits;
@property(nonatomic) unsigned long groupTraits; // @synthesize groupTraits=_groupTraits;
