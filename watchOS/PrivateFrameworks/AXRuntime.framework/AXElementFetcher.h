...
- (id)_groupWithItems:(id)arg1 groupTraits:(unsigned long)arg2 scanningBehaviorTraits:(unsigned long)arg3 label:(id)arg4 identifier:(id)arg5 currentPid:(int)arg6;
