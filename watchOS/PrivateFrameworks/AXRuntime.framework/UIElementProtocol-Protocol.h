...
- (void)setAXAttribute:(long)arg1 withArray:(NSArray *)arg2;
- (void)setAXAttribute:(long)arg1 withUIElementArray:(NSArray *)arg2;
...
- (void)setAXAttribute:(long)arg1 withNumber:(NSNumber *)arg2;
- (void)setAXAttribute:(long)arg1 withFloat:(float)arg2;
- (void)setAXAttribute:(long)arg1 withLong:(long)arg2;
- (void)setAXAttribute:(long)arg1 withString:(NSString *)arg2;
...
- (NSArray *)uiElementsWithAttribute:(long)arg1 parameter:(void *)arg2 fetchAttributes:(_Bool)arg3;
- (NSArray *)uiElementsWithAttribute:(long)arg1 parameter:(void *)arg2;
- (NSArray *)uiElementsWithAttribute:(long)arg1;
- (id)objectWithAXAttribute:(long)arg1;
- (struct CGColor *)colorWithAXAttribute:(long)arg1;
...
- (NSNumber *)numberWithAXAttribute:(long)arg1;
- (_Bool)boolWithAXAttribute:(long)arg1;
- (NSString *)stringWithAXAttribute:(long)arg1;
- (NSArray *)arrayWithAXAttribute:(long)arg1;
