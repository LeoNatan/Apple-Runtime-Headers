...
- (_Bool)_deduplicateBookmarksWithRootFolder:(int)arg1 depth:(unsigned int)arg2 trackChanges:(_Bool)arg3 considerBookmarksWithSyncDataAsUnique:(_Bool)arg4 davHomeURL:(id)arg5;
- (_Bool)_deduplicateBookmarksForSyncingAndTrackChanges:(_Bool)arg1 considerBookmarksWithSyncDataAsUnique:(_Bool)arg2;
- (_Bool)deduplicateBookmarksWithRootFolder:(int)arg1 depth:(unsigned int)arg2;
...
- (_Bool)_insertTombsonesRecursivelyHelperCurrentDepth:(unsigned int)arg1 folder:(id)arg2;
...
- (void)_createSchema;
- (int)_userVersion;
- (id)_mergeCandidateBookmarkWithTitle:(id)arg1 address:(id)arg2 parent:(int)arg3 mergeMode:(int)arg4;
- (id)_mergeCandidateFolderWithTitle:(id)arg1 parent:(int)arg2 mergeMode:(int)arg3;
...
- (unsigned int)countReadingListBookmarksNeedingArchiveInMode:(int)arg1 automaticArchivingEnabled:(_Bool)arg2;
...
@property(readonly, nonatomic) int _cloudKitLocalMigrationState;
