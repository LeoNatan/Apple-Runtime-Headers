...
- (id)description;
- (id)lteNeighborsAtIndex:(unsigned int)arg1;
- (unsigned int)lteNeighborsCount;
- (void)addLteNeighbors:(id)arg1;
- (void)clearLteNeighbors;
- (id)cdmaNeighborsAtIndex:(unsigned int)arg1;
- (unsigned int)cdmaNeighborsCount;
- (void)addCdmaNeighbors:(id)arg1;
- (void)clearCdmaNeighbors;
- (id)scdmaNeighborsAtIndex:(unsigned int)arg1;
- (unsigned int)scdmaNeighborsCount;
- (void)addScdmaNeighbors:(id)arg1;
- (void)clearScdmaNeighbors;
- (id)gsmNeighborsAtIndex:(unsigned int)arg1;
- (unsigned int)gsmNeighborsCount;
