...
- (id)description;
- (id)accessoryLocationAtIndex:(unsigned int)arg1;
- (unsigned int)accessoryLocationsCount;
- (void)addAccessoryLocation:(id)arg1;
- (void)clearAccessoryLocations;
@property(readonly, nonatomic) _Bool hasAccessoryMeta;
- (id)appBundleIdsAtIndex:(unsigned int)arg1;
- (unsigned int)appBundleIdsCount;
