...
- (id)description;
- (id)locationsAtIndex:(unsigned int)arg1;
- (unsigned int)locationsCount;
- (void)addLocations:(id)arg1;
- (void)clearLocations;
- (id)wifiScanAtIndex:(unsigned int)arg1;
- (unsigned int)wifiScansCount;
- (void)addWifiScan:(id)arg1;
- (void)clearWifiScans;
- (id)pressureAtIndex:(unsigned int)arg1;
- (unsigned int)pressuresCount;
