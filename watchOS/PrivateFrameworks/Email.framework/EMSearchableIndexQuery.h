...
+ (id)queryStringForPhrase:(id)arg1 attributes:(id)arg2 modifiers:(unsigned int)arg3 languages:(id)arg4 phraseMatchFormatString:(id)arg5 comparisonOperator:(int)arg6;
+ (id)queryStringForPhrase:(id)arg1 attributes:(id)arg2 modifiers:(unsigned int)arg3 languages:(id)arg4;
+ (id)_queryStringForPhrase:(id)arg1 attributes:(id)arg2 modifiers:(unsigned int)arg3 phraseMatchFormatString:(id)arg4 comparisonOperator:(int)arg5;
+ (id)_queryStringForPhrase:(id)arg1 attributes:(id)arg2 modifiers:(unsigned int)arg3 phraseMatchFormatString:(id)arg4;
...
- (void)_logSignpostForSearchQueryDidReceiveFirstResultsWithItemCount:(unsigned int)arg1;
- (void)_logSignpostForSearchQueryStart;
- (void)_searchQueryDidChangeCount:(int)arg1;
