...
@property(nonatomic) unsigned int certificateType; // @synthesize certificateType=_certificateType;
...
- (void)evaluateTrustWithOptions:(unsigned int)arg1 signerEmailAddress:(id)arg2;
...
- (void)dealloc;
- (id)initWithTrust:(struct __SecTrust *)arg1 certificateType:(unsigned int)arg2 sender:(id)arg3 commonName:(id)arg4;
