...
- (void)performMessageChangeAction:(EMMessageChangeAction *)arg1 returnUndoAction:(_Bool)arg2 completionHandler:(void (^)(EMUndoMessageAction *))arg3;
...
- (void)performQuery:(EFQuery *)arg1 limit:(int)arg2 completionHandler:(void (^)(NSArray *, NSError *))arg3;
@end
