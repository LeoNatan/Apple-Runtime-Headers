...
- (_Bool)_canArchiveForMailboxType:(int)arg1;
...
- (id)initWithObjectID:(id)arg1 repository:(id)arg2 name:(id)arg3 accountIdentifier:(id)arg4 type:(int)arg5 builder:(CDUnknownBlockType)arg6;
