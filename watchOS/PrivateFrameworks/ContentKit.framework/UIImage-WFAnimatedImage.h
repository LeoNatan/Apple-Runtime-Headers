...
+ (id)wf_animatedImageWithData:(id)arg1 scale:(float)arg2;
+ (id)wf_animatedImageWithData:(id)arg1;
+ (id)wf_imageWithColor:(id)arg1;
+ (_Bool)imageSizeIndicatesScreenshot:(struct CGSize)arg1;
+ (id)imageWithCGImage:(struct CGImage *)arg1 scale:(float)arg2 cgImagePropertyOrientation:(unsigned int)arg3;
...
- (id)initWithCGImage:(struct CGImage *)arg1 scale:(float)arg2 cgImagePropertyOrientation:(unsigned int)arg3;
@end
