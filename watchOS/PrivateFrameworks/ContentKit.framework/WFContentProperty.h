...
@interface WFContentProperty : NSObject <NSCopying>
{
    ...
    unsigned int _tense;
    unsigned int _timeUnits;
    unsigned int _comparableUnits;
...
@property(readonly, nonatomic) unsigned int comparableUnits; // @synthesize comparableUnits=_comparableUnits;
@property(readonly, nonatomic) unsigned int timeUnits; // @synthesize timeUnits=_timeUnits;
@property(readonly, nonatomic) unsigned int tense; // @synthesize tense=_tense;
