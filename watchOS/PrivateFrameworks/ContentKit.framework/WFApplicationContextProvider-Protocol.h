...
- (NSString *)notificationNameForApplicationStateEvent:(int)arg1 applicationContext:(WFApplicationContext *)arg2;
...
- (int)currentApplicationStateForWFApplicationContext:(WFApplicationContext *)arg1;
@end
