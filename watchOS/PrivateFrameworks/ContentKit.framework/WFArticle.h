...
+ (id)articleWithTitle:(id)arg1 author:(id)arg2 publishedDate:(id)arg3 body:(id)arg4 excerpt:(id)arg5 numberOfWords:(unsigned int)arg6 mainImageURL:(id)arg7 URL:(id)arg8;
+ (id)mainImageURLFromHTML:(id)arg1;
+ (id)summaryOfParagraph:(id)arg1;
+ (unsigned int)numberOfWordsInString:(id)arg1;
...
@property(readonly, nonatomic) unsigned int numberOfWords; // @synthesize numberOfWords=_numberOfWords;
...
- (id)initWithTitle:(id)arg1 author:(id)arg2 publishedDate:(id)arg3 body:(id)arg4 excerpt:(id)arg5 numberOfWords:(unsigned int)arg6 mainImageURL:(id)arg7 URL:(id)arg8;
