...
+ (id)buttonWithTitle:(id)arg1 style:(int)arg2 preferred:(_Bool)arg3 handler:(CDUnknownBlockType)arg4;
...
- (id)initWithTitle:(id)arg1 style:(int)arg2 handler:(CDUnknownBlockType)arg3 preferred:(_Bool)arg4;
