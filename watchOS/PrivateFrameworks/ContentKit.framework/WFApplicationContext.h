...
- (void)removeApplicationStateObserver:(id)arg1 forEvent:(int)arg2;
- (void)addApplicationStateObserver:(id)arg1 forEvent:(int)arg2;
- (void)handleApplicationStateEvent:(int)arg1;
