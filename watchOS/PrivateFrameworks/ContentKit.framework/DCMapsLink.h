...
+ (CDStruct_2b0c6e0b)coordinateRegionForMapSize:(struct CGSize)arg1 centeredAtLocation:(struct CLLocationCoordinate2D)arg2 atZoomLevel:(int)arg3;
+ (CDStruct_c3b9c2ee)coordinateSpanForMapSize:(struct CGSize)arg1 centeredAtLocation:(struct CLLocationCoordinate2D)arg2 atZoomLevel:(int)arg3;
...
@property(readonly, nonatomic) unsigned int mapType;
@property(readonly, nonatomic) int zoomLevel;
@property(readonly, nonatomic) NSString *centerLocation;
@property(readonly, nonatomic) unsigned int directionsMode;
...
@property(readonly, nonatomic) unsigned int directionsTransportType;
...
@property(readonly, nonatomic) unsigned int mkMapType;
