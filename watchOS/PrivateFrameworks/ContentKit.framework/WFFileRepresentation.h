...
+ (id)fileWithURL:(id)arg1 options:(int)arg2 ofType:(id)arg3 proposedFilename:(id)arg4 originalURL:(id)arg5;
+ (id)fileWithURL:(id)arg1 options:(int)arg2 ofType:(id)arg3 proposedFilename:(id)arg4;
+ (id)fileWithURL:(id)arg1 options:(int)arg2 ofType:(id)arg3;
+ (id)fileWithURL:(id)arg1 options:(int)arg2;
...
@property(readonly, nonatomic) int representationType;
...
- (void)dealloc;
- (id)initWithFileURL:(id)arg1 options:(int)arg2 ofType:(id)arg3 proposedFilename:(id)arg4 originalURL:(id)arg5;
