...
- (id)notesForServerIntIdsInRange:(struct _NSRange)arg1 ascending:(_Bool)arg2 limit:(unsigned int)arg3;
- (id)notesForServerIntIds:(id)arg1 ascending:(_Bool)arg2 limit:(unsigned int)arg3;
