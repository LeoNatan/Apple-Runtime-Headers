...
@property(nonatomic) unsigned int presentationDefaultActionIndex; // @synthesize presentationDefaultActionIndex=_presentationDefaultActionIndex;
...
@property(nonatomic) unsigned int defaultActionIndex; // @synthesize defaultActionIndex=_defaultActionIndex;
