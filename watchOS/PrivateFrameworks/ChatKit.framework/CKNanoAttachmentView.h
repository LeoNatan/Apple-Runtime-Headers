...
@interface CKNanoAttachmentView : UIView <CKAttachmentView>
{
    ...
    PUICActivityIndicatorView *_loadingIndicator;
    UILabel *_titleLabel;
...
@property(retain, nonatomic) PUICActivityIndicatorView *loadingIndicator; // @synthesize loadingIndicator=_loadingIndicator;
