...
+ (id)conversationListAlertSuppressionContextForFilterMode:(unsigned int)arg1;
+ (id)stringForFilterMode:(unsigned int)arg1;
+ (id)numberForFilterMode:(unsigned int)arg1;
...
- (void)_setConversations:(id)arg1 forFilterMode:(unsigned int)arg2;
- (id)conversationsForFilterMode:(unsigned int)arg1;
...
- (unsigned int)filterModeForConversation:(id)arg1;
...
- (int)unreadCountForFilterMode:(unsigned int)arg1;
