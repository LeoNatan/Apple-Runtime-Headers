...
+ (id)chatItemWithNotification:(id)arg1 balloonMaxWidth:(float)arg2 otherMaxWidth:(float)arg3;
+ (id)chatItemWithIMChatItem:(id)arg1 balloonMaxWidth:(float)arg2 otherMaxWidth:(float)arg3 transcriptTraitCollection:(id)arg4;
- (void).cxx_destruct;
...
- (id)initWithNotification:(id)arg1 maxWidth:(float)arg2;
