...
+ (id)notificationRequestWithNotificationId:(id)arg1 requestDestinations:(id)arg2 lockScreenPersistence:(unsigned int)arg3;
...
@property(readonly, nonatomic) unsigned int collapsedNotificationsCount; // @synthesize collapsedNotificationsCount=_collapsedNotificationsCount;
