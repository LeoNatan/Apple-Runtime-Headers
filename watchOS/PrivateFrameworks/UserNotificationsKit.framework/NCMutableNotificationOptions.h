...
@property(nonatomic) unsigned int contentPreviewSetting; // @dynamic contentPreviewSetting;
...
@property(nonatomic) unsigned int messageNumberOfLines; // @dynamic messageNumberOfLines;
...
@property(nonatomic) unsigned int lockScreenPriority; // @dynamic lockScreenPriority;
@property(nonatomic) unsigned int lockScreenPersistence; // @dynamic lockScreenPersistence;
