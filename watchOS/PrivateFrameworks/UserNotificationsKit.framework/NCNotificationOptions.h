...
@property(readonly, nonatomic) unsigned int contentPreviewSetting; // @synthesize contentPreviewSetting=_contentPreviewSetting;
...
@property(readonly, nonatomic) unsigned int messageNumberOfLines; // @synthesize messageNumberOfLines=_messageNumberOfLines;
...
@property(readonly, nonatomic) unsigned int realertCount; // @synthesize realertCount=_realertCount;
@property(readonly, nonatomic) unsigned int lockScreenPriority; // @synthesize lockScreenPriority=_lockScreenPriority;
@property(readonly, nonatomic) unsigned int lockScreenPersistence; // @synthesize lockScreenPersistence=_lockScreenPersistence;
