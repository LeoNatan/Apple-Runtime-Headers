...
@property(readonly, nonatomic) unsigned int soundBehavior; // @synthesize soundBehavior=_soundBehavior;
@property(readonly, nonatomic) unsigned long systemSoundID; // @synthesize systemSoundID=_systemSoundID;
