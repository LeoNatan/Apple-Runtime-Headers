...
- (id).cxx_construct;
- (void).cxx_destruct;
- (Vector_23cb8338)_timesForVisits:(unsigned int)arg1 toSynthesizeBetweenStartTime:(double)arg2 endTime:(double)arg3;
- (Vector_23cb8338)_timesForSynthesizedVisitsPreceedingDailyAndWeeklyRange:(unsigned int)arg1;
