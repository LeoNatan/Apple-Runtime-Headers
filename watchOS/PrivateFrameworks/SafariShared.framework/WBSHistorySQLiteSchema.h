...
- (long long)_migrateLegacyVisitWithItemID:(long long)arg1 visitTime:(double)arg2 title:(id)arg3 score:(unsigned int)arg4 loadSuccessful:(_Bool)arg5 httpNonGet:(_Bool)arg6 synthesized:(_Bool)arg7;
