...
@class NSArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, UIColor;
...
- (CDUnknownBlockType)_responseHandlerForRequest:(id)arg1 thumbnailIndex:(unsigned int)arg2;
