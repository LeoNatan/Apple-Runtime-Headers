...
+ (_Bool)convertNumber:(id)arg1 toFormMetadataRequestType:(unsigned int *)arg2;
- (id).cxx_construct;
- (void).cxx_destruct;
...
- (unsigned int)userEditedTextControlCountInArray:(struct OpaqueJSValue *)arg1 context:(struct OpaqueJSContext *)arg2 expectTextFieldsRatherThanTextAreas:(_Bool)arg3;
...
- (id)metadataForForm:(id)arg1 inFrame:(id)arg2 requestType:(unsigned int)arg3 addUserEditedStateForUserNameAndPasswordFields:(_Bool)arg4;
