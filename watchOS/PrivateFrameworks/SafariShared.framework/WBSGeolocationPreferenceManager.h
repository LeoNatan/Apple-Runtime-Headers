...
- (id)perSitePreferenceValueForGeolocationSetting:(int)arg1;
...
- (void)setDefaultGeolocationSetting:(int)arg1;
- (void)setGeolocationSetting:(int)arg1 forDomain:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
