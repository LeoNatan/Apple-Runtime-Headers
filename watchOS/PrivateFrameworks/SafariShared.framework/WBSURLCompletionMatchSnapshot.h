...
@property(readonly, nonatomic) int visitCount; // @synthesize visitCount=_visitCount;
...
- (id)initWithURL:(id)arg1 title:(id)arg2 matchLocation:(int)arg3 isTopHit:(_Bool)arg4 isSynthesizedTopHit:(_Bool)arg5 isTopHitDueToTriggerMatch:(_Bool)arg6 visitCount:(int)arg7 lastVisitTime:(id)arg8;
- (id)init;
