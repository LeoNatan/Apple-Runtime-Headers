...
- (void)_getSortedMatchesForTypedString:(id)arg1 topHits:(Vector_3aefaf4b *)arg2 historyMatches:(Vector_3aefaf4b *)arg3 historyLimit:(unsigned int)arg4 bookmarkMatches:(Vector_3aefaf4b *)arg5 bookmarkLimit:(unsigned int)arg6 prefixMatchesOnly:(_Bool)arg7;
- (void)_removeMatchesWithTitlesThatLookLikeURLsRemovedFromMatches:(Vector_3aefaf4b *)arg1;
- (void)_getSortedPrefixMatchesForTypedString:(id)arg1 topHits:(Vector_3aefaf4b *)arg2 historyMatches:(Vector_3aefaf4b *)arg3 historyLimit:(unsigned int)arg4 bookmarkMatches:(Vector_3aefaf4b *)arg5 bookmarkLimit:(unsigned int)arg6;
- (void)_getSortedFullTextMatchesForTypedString:(id)arg1 topHits:(Vector_3aefaf4b *)arg2 historyMatches:(Vector_3aefaf4b *)arg3 historyLimit:(unsigned int)arg4 bookmarkMatches:(Vector_3aefaf4b *)arg5 bookmarkLimit:(unsigned int)arg6;
...
- (void)getBestMatchesForTypedString:(id)arg1 topHits:(id *)arg2 matches:(id *)arg3 limit:(unsigned int)arg4 forQueryID:(long long)arg5;
- (id)init;
