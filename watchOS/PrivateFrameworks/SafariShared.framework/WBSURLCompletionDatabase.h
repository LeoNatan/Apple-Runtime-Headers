...
- (void)_getSortedMatchesForTypedString:(id)arg1 topHits:(Vector_fc835981 *)arg2 historyMatches:(Vector_fc835981 *)arg3 historyLimit:(unsigned int)arg4 bookmarkMatches:(Vector_fc835981 *)arg5 bookmarkLimit:(unsigned int)arg6 prefixMatchesOnly:(_Bool)arg7;
- (void)_removeMatchesWithTitlesThatLookLikeURLsRemovedFromMatches:(Vector_fc835981 *)arg1;
- (void)_getSortedPrefixMatchesForTypedString:(id)arg1 topHits:(Vector_fc835981 *)arg2 historyMatches:(Vector_fc835981 *)arg3 historyLimit:(unsigned int)arg4 bookmarkMatches:(Vector_fc835981 *)arg5 bookmarkLimit:(unsigned int)arg6;
- (void)_getSortedFullTextMatchesForTypedString:(id)arg1 topHits:(Vector_fc835981 *)arg2 historyMatches:(Vector_fc835981 *)arg3 historyLimit:(unsigned int)arg4 bookmarkMatches:(Vector_fc835981 *)arg5 bookmarkLimit:(unsigned int)arg6;
