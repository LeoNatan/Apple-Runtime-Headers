...
- (id).cxx_construct;
- (void).cxx_destruct;
@property(nonatomic) int numPages; // @synthesize numPages=_numPages;
...
@property(nonatomic) float backingScale; // @synthesize backingScale=_backingScale;
...
@property(nonatomic) float lineWidthScale; // @synthesize lineWidthScale=_lineWidthScale;
