...
- (_Bool)registerQueriableMetricCallback:(CDUnknownBlockType)arg1 forIdentifier:(unsigned long)arg2;
- (_Bool)registerQueriableMetric:(unsigned long)arg1 callback:(CDUnknownBlockType)arg2;
- (_Bool)submitMetric:(id)arg1;
- (id)newMetricContainerWithIdentifier:(unsigned long)arg1;
- (void)dealloc;
- (id)initWithComponentId:(unsigned long)arg1 andBlockOnConfiguration:(_Bool)arg2;
