...
- (id)initWithIdentifier:(id)arg1 firstSeen:(id)arg2 lastSeen:(id)arg3 frequency:(int)arg4 lastDuration:(double)arg5 totalDuration:(double)arg6 metadata:(id)arg7;
...
@property(nonatomic) int _frequency; // @synthesize _frequency;
