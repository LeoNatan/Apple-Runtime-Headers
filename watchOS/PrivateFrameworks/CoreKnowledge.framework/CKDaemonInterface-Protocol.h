...
- (void)relativeAppUsageProbabilitiesForBundleIDs:(NSArray *)arg1 overDays:(int)arg2 completionHandler:(void (^)(NSDictionary *))arg3;
...
- (void)decreaseWeightForLinkWithLabel:(NSString *)arg1 betweenSubject:(NSString *)arg2 andObject:(NSString *)arg3 inStoreWithIdentifier:(NSString *)arg4 completionHandler:(void (^)(NSError *, int))arg5;
- (void)increaseWeightForLinkWithLabel:(NSString *)arg1 betweenSubject:(NSString *)arg2 andObject:(NSString *)arg3 inStoreWithIdentifier:(NSString *)arg4 completionHandler:(void (^)(NSError *, int))arg5;
- (void)setWeightForLinkWithLabel:(NSString *)arg1 betweenSubject:(NSString *)arg2 andObject:(NSString *)arg3 toValue:(int)arg4 inStoreWithIdentifier:(NSString *)arg5 completionHandler:(void (^)(NSError *))arg6;
