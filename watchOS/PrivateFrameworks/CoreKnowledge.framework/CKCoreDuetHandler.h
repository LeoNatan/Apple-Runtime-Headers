...
+ (void)duetEventsWithIdentifier:(id)arg1 inStreamNamed:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 limit:(unsigned int)arg5 completionHandler:(CDUnknownBlockType)arg6;
