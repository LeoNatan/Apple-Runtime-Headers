...
@property(readonly, nonatomic) unsigned int scalarType;
@property(readonly, nonatomic) unsigned int scalarCategory;
@property(readonly, nonatomic) unsigned short rawBytesLength;
@property(readonly, nonatomic) const void *rawBytes;
@property(readonly, nonatomic) unsigned int privacy;
@property(readonly, nonatomic) unsigned int availability;
- (id)initWithProxy:(id)arg1 index:(unsigned int)arg2;
