...
@property(readonly, nonatomic) unsigned int logType;
...
- (void)_setBuffer:(const void *)arg1 size:(unsigned long)arg2 privateBuffer:(const void *)arg3 privateSize:(unsigned long)arg4;
