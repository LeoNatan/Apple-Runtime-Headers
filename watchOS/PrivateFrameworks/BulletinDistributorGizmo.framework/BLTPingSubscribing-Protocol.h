...
- (NSSet *)sectionIDs;
- (void)pingWithBulletin:(BBBulletin *)arg1 ack:(void (^)(unsigned int))arg2;
- (void)pingWithBulletin:(BBBulletin *)arg1;
- (void)pingWithRecordID:(NSString *)arg1 forSectionID:(NSString *)arg2 ack:(void (^)(unsigned int))arg3;
