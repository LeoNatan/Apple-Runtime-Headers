...
#import <BulletinDistributorGizmo/BLTPingSubscriptionInfo-Protocol.h>
...
@interface BLTPingHandlerHolder : NSObject <BLTPingSubscriptionInfo>
{
    ...
    NSString *_sectionID;
    unsigned int _ackType;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned int ackType; // @synthesize ackType=_ackType;
