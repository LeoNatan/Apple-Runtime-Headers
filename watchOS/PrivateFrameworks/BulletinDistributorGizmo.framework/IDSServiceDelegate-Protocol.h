...
- (void)service:(IDSService *)arg1 account:(IDSAccount *)arg2 identifier:(NSString *)arg3 sentBytes:(int)arg4 totalBytes:(int)arg5;
...
- (void)service:(IDSService *)arg1 account:(IDSAccount *)arg2 incomingPendingMessageOfType:(int)arg3 fromID:(NSString *)arg4 context:(IDSMessageContext *)arg5;
