...
- (void)observer:(BBObserver *)arg1 prepareAttachment:(BBAttachmentMetadata *)arg2 beforeDeliveringBulletin:(BBBulletin *)arg3 withCompletionHandler:(void (^)(unsigned int))arg4;
...
- (void)observer:(BBObserver *)arg1 addBulletin:(BBBulletin *)arg2 forFeed:(unsigned int)arg3 playLightsAndSirens:(_Bool)arg4 withReply:(void (^)(_Bool))arg5;
@end
