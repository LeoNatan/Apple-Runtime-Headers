...
- (_Bool)isAlertableBulletinInNonCriticalSection:(id)arg1 ignoresQuietMode:(_Bool)arg2;
...
- (id)_queue_cacheLightsAndSirens:(unsigned int)arg1 forBulletin:(id)arg2 andPublicationDate:(id)arg3 knownSection:(id)arg4 additionalLocalSection:(id)arg5 transmissionDate:(id)arg6 receptionDate:(id)arg7 localBulletin:(_Bool)arg8 isTrafficRestricted:(_Bool)arg9 turnsOnDisplay:(_Bool)arg10 ignoresQuietMode:(_Bool)arg11;
- (id)_queue_playLightsAndSirens:(unsigned int)arg1 bulletin:(id)arg2 publicationDate:(id)arg3 knownSection:(id)arg4 additionalLocalSection:(id)arg5 subtype:(int)arg6 feed:(unsigned int)arg7 transmissionDate:(id)arg8 receptionDate:(id)arg9 isTrafficRestricted:(_Bool)arg10 turnsOnDisplay:(_Bool)arg11 ignoresQuietMode:(_Bool)arg12;
