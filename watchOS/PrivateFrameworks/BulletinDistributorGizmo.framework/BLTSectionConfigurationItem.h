...
@interface BLTSectionConfigurationItem : NSObject
{
    ...
    unsigned int _coordinationType;
...
@property unsigned int coordinationType; // @synthesize coordinationType=_coordinationType;
- (_Bool)updateCoordinationType:(unsigned int)arg1;
