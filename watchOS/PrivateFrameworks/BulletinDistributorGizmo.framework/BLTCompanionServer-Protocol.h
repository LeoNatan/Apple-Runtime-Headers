...
- (void)willSendLightsAndSirensWithPublisherBulletinID:(NSString *)arg1 recordID:(NSString *)arg2 inPhoneSection:(NSString *)arg3 systemApp:(_Bool)arg4 completion:(void (^)(_Bool, unsigned int))arg5;
