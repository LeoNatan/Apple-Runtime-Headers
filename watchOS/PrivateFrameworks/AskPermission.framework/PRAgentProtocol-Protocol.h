...
- (void)attemptLocalApprovalForStorePurchaseRequestWithItemIdentifier:(unsigned int)arg1 replyBlock:(void (^)(_Bool, _Bool, NSError *))arg2;
- (void)pendingStorePurchaseRequestForItemIdentifier:(unsigned int)arg1 withReplyBlock:(void (^)(PRRequest *, NSError *))arg2;
