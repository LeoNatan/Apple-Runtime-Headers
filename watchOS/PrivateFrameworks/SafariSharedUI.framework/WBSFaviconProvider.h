...
@property(readonly, nonatomic) float preferredIconScale; // @synthesize preferredIconScale=_preferredIconScale;
...
- (id)initWithPersistenceBaseURL:(id)arg1 persistenceName:(id)arg2 preferredIconSize:(struct CGSize)arg3 atScale:(float)arg4 allScales:(id)arg5 shouldCheckIntegrityWhenOpeningDatabaseBlock:(CDUnknownBlockType)arg6;
- (id)init;
