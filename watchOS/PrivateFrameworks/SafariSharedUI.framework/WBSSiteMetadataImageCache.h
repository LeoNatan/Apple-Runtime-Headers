...
@interface WBSSiteMetadataImageCache : NSObject
{
    ...
    unsigned int _fileProtectionOptions;
    _Bool _terminating;
...
- (id)imageForKeyString:(id)arg1 getImageState:(int *)arg2;
...
- (id)initWithImageDirectoryURL:(id)arg1 imageType:(int)arg2 fileProtectionOptions:(unsigned int)arg3;
