...
- (void)_saveTouchIconToDiskWithResult:(id)arg1 forRequest:(id)arg2 knownImageState:(int)arg3;
...
- (void)emptyCaches;
- (CDUnknownBlockType)_blockOperationForRequest:(id)arg1 knownImageState:(int)arg2;
- (void)stopWatchingUpdatesForRequest:(id)arg1;
- (void)_setUpAndReturnPreparedResponseForRequest:(id)arg1 withImage:(id)arg2 imageState:(int)arg3 didReceiveNewData:(_Bool)arg4;
...
- (_Bool)_shouldRequestTouchIconForURL:(id)arg1 inUserLoadedWebpage:(_Bool)arg2 initiatedFromBookmarkInteraction:(_Bool)arg3 knownImageState:(int)arg4;
...
- (id)_touchIconForURL:(id)arg1 getImageState:(int *)arg2;
- (void)_ensureCacheDirectory;
- (void)_setUpImageCacheSettingsSQLiteStore;
- (id)uuidStringToHost;
- (void)_openCacheSettingsDatabaseIfNeeded;
- (void)dealloc;
- (id)initWithCacheDirectoryURL:(id)arg1 isReadOnly:(_Bool)arg2 protectionType:(int)arg3 allowFetchingOverCellularNetwork:(_Bool)arg4 fileMappingStyle:(int)arg5;
