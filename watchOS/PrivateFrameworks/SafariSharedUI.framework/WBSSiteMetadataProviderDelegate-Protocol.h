...
- (id)siteMetadataProvider:(id <WBSSiteMetadataProvider>)arg1 registerOneTimeRequest:(WBSSiteMetadataRequest *)arg2 priority:(int)arg3 responseHandler:(void (^)(WBSSiteMetadataResponse *))arg4;
- (id)siteMetadataProvider:(id <WBSSiteMetadataProvider>)arg1 registerRequest:(WBSSiteMetadataRequest *)arg2 priority:(int)arg3 responseHandler:(void (^)(WBSSiteMetadataResponse *))arg4;
...
- (void)siteMetadataProvider:(id <WBSSiteMetadataProvider>)arg1 didReceiveResponse:(WBSSiteMetadataResponse *)arg2 ofType:(int)arg3 didReceiveNewData:(_Bool)arg4 forRequest:(WBSSiteMetadataRequest *)arg5;
@end
