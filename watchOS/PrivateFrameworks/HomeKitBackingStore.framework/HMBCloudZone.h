...
- (id)decodeModelFrom:(id)arg1 recordSource:(unsigned int)arg2 error:(id *)arg3;
@property(readonly, nonatomic) NAFuture *waitForPendingRebuild;
@property(readonly, nonatomic) int keyStatus;
- (void)rebuild;
...
- (id)decodeManateeCloudFrom:(id)arg1 recordSource:(unsigned int)arg2 error:(id *)arg3;
...
- (id)_triggerOutputForOutputRow:(unsigned int)arg1 options:(id)arg2;
...
- (id)cloudFieldForEncoding:(unsigned int)arg1;
- (id)cloudMetadataForModel:(id)arg1 usingEncoding:(unsigned int)arg2;
- (_Bool)populateV4CloudRecord:(id)arg1 withModel:(id)arg2 metadataFieldData:(id)arg3 startEncoding:(unsigned int)arg4 endEncoding:(unsigned int)arg5 error:(id *)arg6;
