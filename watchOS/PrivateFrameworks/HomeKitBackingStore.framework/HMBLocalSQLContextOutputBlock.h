...
- (id)abort;
- (id)commit:(id)arg1;
- (id)updateModelID:(id)arg1 modelEncoding:(unsigned int)arg2 modelData:(id)arg3;
- (id)initWithOwner:(id)arg1 zoneRow:(unsigned int)arg2 blockRow:(unsigned int)arg3;
