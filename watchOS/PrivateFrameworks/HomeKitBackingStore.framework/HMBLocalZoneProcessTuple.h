...
- (void).cxx_destruct;
- (id)initWithPrevious:(id)arg1 update:(id)arg2 recordRow:(unsigned int)arg3 itemRow:(unsigned int)arg4 modelID:(id)arg5 modelSchema:(id)arg6 externalID:(id)arg7 externalData:(id)arg8;
