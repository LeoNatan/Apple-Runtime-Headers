...
- (void).cxx_destruct;
- (id)initWithPrevious:(id)arg1 update:(id)arg2 recordRow:(unsigned int)arg3 itemRow:(unsigned int)arg4 modelSchema:(id)arg5 externalID:(id)arg6 externalData:(id)arg7;
