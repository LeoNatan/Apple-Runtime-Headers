...
@interface HMBModelQuery : HMFObject
{
    ...
    NSArray *_sqlColumns;
    unsigned int _maximumRowsPerSelect;
...
@property(readonly, nonatomic) unsigned int maximumRowsPerSelect; // @synthesize maximumRowsPerSelect=_maximumRowsPerSelect;
...
- (id)initWithSQLPredicate:(id)arg1 sqlColumns:(id)arg2 initialSequence:(id)arg3 maximumRowsPerSelect:(unsigned int)arg4 arguments:(id)arg5;
