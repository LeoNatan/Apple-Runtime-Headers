...
- (_Bool)fetchModelsOfType:(Class)arg1 withLimit:(unsigned int)arg2 error:(id *)arg3 handler:(CDUnknownBlockType)arg4;
- (id)fetchModelsOfType:(Class)arg1 withLimit:(unsigned int)arg2 error:(id *)arg3;
