...
- (id)modelFromData:(id)arg1 encoding:(unsigned int)arg2 error:(id *)arg3;
- (id)modelFromData:(id)arg1 encoding:(unsigned int)arg2 type:(id)arg3 error:(id *)arg4;
- (id)modelFromDictionary:(id)arg1 typeName:(id)arg2 error:(id *)arg3;
- (id)dataFromModel:(id)arg1 encoding:(unsigned int)arg2 destination:(unsigned int)arg3 updatedModelIDs:(id)arg4 error:(id *)arg5;
