...
- (id)waitForPreResponseItemsForMessage:(id)arg1 maximumResponses:(unsigned int)arg2 forConversationHistory:(id)arg3 forContext:(id)arg4 time:(id)arg5 withLanguage:(id)arg6 options:(unsigned int)arg7;
...
- (void)preResponseItemsForMessage:(id)arg1 maximumResponses:(unsigned int)arg2 forConversationHistory:(id)arg3 forContext:(id)arg4 time:(id)arg5 withLanguage:(id)arg6 options:(unsigned int)arg7 completionBlock:(CDUnknownBlockType)arg8;
- (void)responsesForMessage:(id)arg1 maximumResponses:(unsigned int)arg2 forConversationHistory:(id)arg3 forContext:(id)arg4 time:(id)arg5 withLanguage:(id)arg6 options:(unsigned int)arg7 completionBlock:(CDUnknownBlockType)arg8;
- (id)responsesForMessage:(id)arg1 maximumResponses:(unsigned int)arg2 forConversationHistory:(id)arg3 forContext:(id)arg4 time:(id)arg5 withLanguage:(id)arg6 options:(unsigned int)arg7;
- (id)activeExperimentName;
- (id)cacheKeyForMessage:(id)arg1 maxResponses:(unsigned int)arg2 time:(id)arg3 language:(id)arg4;
