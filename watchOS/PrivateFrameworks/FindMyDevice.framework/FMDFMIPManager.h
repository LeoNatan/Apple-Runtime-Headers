...
- (void)_disableFMIPUsingToken:(id)arg1 inContext:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)clearData:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)disableFMIPUsingToken:(id)arg1 inContext:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
