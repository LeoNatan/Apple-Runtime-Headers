...
- (oneway void)attestIdentityForSigningRequest:(FMDIdentitySigningRequest *)arg1 type:(unsigned int)arg2 completion:(void (^)(NSObject<FMDIdentityAttesting> *, NSError *))arg3;
