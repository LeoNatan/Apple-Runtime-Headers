...
+ (id)calGMT;
+ (int)daysSpannedFromStartDate:(id)arg1 toEndDate:(id)arg2 allDay:(_Bool)arg3 inCalendar:(id)arg4;
...
- (id)localizedYear;
- (id)dateRemovingComponents:(unsigned int)arg1 inCalendar:(id)arg2;
- (int)midnightOffsetMinutes:(id)arg1;
