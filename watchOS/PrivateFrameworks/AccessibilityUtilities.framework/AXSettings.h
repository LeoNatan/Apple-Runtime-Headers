...
@property(readonly, nonatomic) int touchAccommodationsHoldDurationSwipeGestureSensitivity;
@property(nonatomic) float touchAccommodationsSwipeGestureMinimumDistance;
...
@property(nonatomic) int voiceOverSpeakDiscoveredTextFeedback;
...
@property(nonatomic) int voiceOverTapticChimesSoundType;
@property(nonatomic) int voiceOverTapticChimesFrequencyEncoding;
@property(nonatomic) int voiceOverTapticChimesAvailability;
...
@property(nonatomic) int tapToSpeakTimeAvailability;
...
@property(nonatomic) int voiceOverDescribedMedia;
@property(nonatomic) int voiceOverPreferredTVInteractionMode;
...
@property(nonatomic) int voiceOverCapitalLetterFeedback;
@property(nonatomic) int voiceOverDeletionFeedback;
@property(nonatomic) int voiceOverLinkFeedback;
@property(nonatomic) int voiceOverPunctuationLevel;
...
- (void)setUserDidSelectVoiceForLanguage:(id)arg1 source:(int)arg2;
- (void)setSpeechVoiceIdentifier:(id)arg1 forLanguage:(id)arg2 source:(int)arg3;
- (_Bool)userDidSelectVoiceForLanguage:(id)arg1 source:(int)arg2;
- (id)speechVoiceIdentifierForLanguage:(id)arg1 source:(int)arg2 exists:(_Bool *)arg3;
@property(nonatomic) unsigned int quickSpeakHighlightOption;
@property(nonatomic) int quickSpeakSentenceHighlightColor;
@property(nonatomic) int quickSpeakWordHighlightColor;
...
@property(nonatomic) int speechControllerDoubleTapAction;
@property(nonatomic) int speechControllerLongPressAction;
...
@property(nonatomic) float voiceOverContinuousPathKeyboardStartTimeout;
...
@property(nonatomic) int guidedAccessAutoLockTimeInSeconds;
...
- (void)zoomUserHadLegacyZoomEnabled:(_Bool *)arg1 wasZoomedIn:(_Bool *)arg2 withScale:(float *)arg3;
...
@property(nonatomic) int zoomControllerColor;
...
@property(nonatomic) int zoomSlugTripleTapAction;
@property(nonatomic) int zoomSlugDoubleTapAction;
@property(nonatomic) int zoomSlugSingleTapAction;
...
@property(nonatomic) float dockSize;
...
@property(nonatomic) int switchControlPointPickerSelectionStyle;
...
@property(nonatomic) float assistiveTouchIdleOpacity;
...
- (void)setAssistiveTouchMotionTrackerSmoothingMaxDelta:(float)arg1;
- (float)assistiveTouchMotionTrackerSmoothingMaxDelta;
- (void)setAssistiveTouchMotionTrackerSmoothingBufferSize:(unsigned int)arg1;
- (unsigned int)assistiveTouchMotionTrackerSmoothingBufferSize;
- (_Bool)assistiveTouchMotionTrackerConfigurable;
- (_Bool)assistiveTouchMotionTrackerEnableHIDTracking;
- (void)setAssistiveTouchMouseZoomPanningStyle:(unsigned int)arg1;
- (unsigned int)assistiveTouchMouseZoomPanningStyle;
...
- (void)setAssistiveTouchMouseDwellControlMovementToleranceRadius:(float)arg1;
- (float)assistiveTouchMouseDwellControlMovementToleranceRadius;
...
- (float)assistiveTouchMousePointerSizeMultiplier;
- (void)setAssistiveTouchMousePointerSizeMultiplier:(float)arg1;
- (int)assistiveTouchMousePointerColor;
- (void)setAssistiveTouchMousePointerColor:(int)arg1;
...
- (int)assistiveTouchMouseKeysMaxSpeed;
- (void)setAssistiveTouchMouseKeysMaxSpeed:(int)arg1;
- (int)assistiveTouchMouseKeysDelay;
...
- (void)nukePrefsForDomains:(int *)arg1 numDomains:(unsigned long)arg2;
- (void)nukeAll;
- (void)dealloc;
- (id)init;
...
@property float audioLeftRightBalance;
...
@property(nonatomic) int voiceOverBrailleStatusCellPreference;
...
- (id)_switchWithAction:(int)arg1 excludedUUIDs:(id)arg2 needsToSupportLongPress:(_Bool)arg3;
