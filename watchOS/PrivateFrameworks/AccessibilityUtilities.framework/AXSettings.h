...
@property(nonatomic) int voiceOverTapticChimesStyleEncoding;
...
- (_Bool)assistiveTouchMouseUsesLargerPointer;
- (void)setAssistiveTouchMouseUsesLargerPointer:(_Bool)arg1;
