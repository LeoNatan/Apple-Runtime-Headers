...
@property(nonatomic) unsigned long midiDevice; // @synthesize midiDevice=_midiDevice;
...
- (id)_entityForMidiEntity:(unsigned long)arg1 addIfNeeded:(_Bool)arg2;
...
- (void)removeMidiEntity:(unsigned long)arg1;
- (void)addMidiEntity:(unsigned long)arg1;
...
- (id)initWithMIDIDevice:(unsigned long)arg1 delegate:(id)arg2;
