...
- (void)update;
- (void)publish:(unsigned int)arg1 numberOfUniqueThreads:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)publish:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
- (void)publishWithNumberOfUniqueThreads:(unsigned int)arg1;
- (void)publish;
