...
- (void)_queue_updateSettingsWithAuthorizationStatus:(int)arg1 options:(unsigned int)arg2 forNotificationSourceDescription:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)updateAuthorizationWithOptions:(unsigned int)arg1 forNotificationSourceDescription:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)requestAuthorizationStatus:(int)arg1 withOptions:(unsigned int)arg2 forNotificationSourceDescription:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
