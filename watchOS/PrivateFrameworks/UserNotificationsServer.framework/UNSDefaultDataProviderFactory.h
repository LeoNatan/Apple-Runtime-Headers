...
- (void)_queue_enableNotifications:(_Bool)arg1 withAuthorizationOptions:(unsigned int)arg2 forBundleIdentifier:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)updateAuthorizationWithOptions:(unsigned int)arg1 forBundleIdentifier:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
