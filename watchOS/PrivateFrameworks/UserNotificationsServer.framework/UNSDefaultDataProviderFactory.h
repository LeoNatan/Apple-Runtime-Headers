...
- (void)updateAuthorizationWithOptions:(unsigned int)arg1 topics:(id)arg2 forBundleIdentifier:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)requestAuthorizationStatus:(int)arg1 withOptions:(unsigned int)arg2 topics:(id)arg3 forBundleIdentifier:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
