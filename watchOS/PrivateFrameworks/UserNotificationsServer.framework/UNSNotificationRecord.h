...
@property(nonatomic) unsigned int triggerRepeatInterval; // @synthesize triggerRepeatInterval=_triggerRepeatInterval;
...
@property(nonatomic) int toneAlertType; // @synthesize toneAlertType=_toneAlertType;
...
@property(nonatomic) unsigned int realertCount; // @synthesize realertCount=_realertCount;
