...
@interface TKTonePickerController : NSObject <TLToneStoreDownloadObserver>
{
    ...
    int _toneStoreDownloadButtonState;
...
@property(nonatomic, setter=_setSelectedClassicAlertToneIndex:) unsigned int _selectedClassicAlertToneIndex; // @synthesize _selectedClassicAlertToneIndex=__selectedClassicAlertToneIndex;
@property(nonatomic, setter=_setSelectedClassicRingtoneIndex:) unsigned int _selectedClassicRingtoneIndex; // @synthesize _selectedClassicRingtoneIndex=__selectedClassicRingtoneIndex;
...
- (void)_uncachePickerRowItemAtIndex:(int)arg1 inSectionForItem:(id)arg2;
...
- (void)_cachePickerSectionItem:(id)arg1 forSection:(int)arg2;
