...
+ (id)queryWithDatabase:(id)arg1 predicate:(id)arg2 limit:(unsigned int)arg3 orderingTerms:(id)arg4 groupBy:(id)arg5;
...
+ (_Bool)enumerateQueryResultsFromColumns:(id)arg1 properties:(id)arg2 predicate:(id)arg3 groupBy:(id)arg4 orderingTerms:(id)arg5 limit:(int)arg6 database:(id)arg7 error:(id *)arg8 enumerationHandler:(CDUnknownBlockType)arg9;
