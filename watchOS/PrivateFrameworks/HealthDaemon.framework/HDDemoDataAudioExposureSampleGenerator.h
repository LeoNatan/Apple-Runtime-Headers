...
- (id)_makeNormallyDistributedAudioExposureLevelsWithCount:(unsigned int)arg1 headphones:(_Bool)arg2;
- (id)_makeEvenlyDistributedAudioExposureLevelsWithCount:(unsigned int)arg1 headphones:(_Bool)arg2;
