...
- (id)_queue_assertionsPerStateForActivityType:(unsigned int)arg1;
...
- (void)workoutSessionServer:(id)arg1 didTransitionFromState:(int)arg2 toState:(int)arg3 date:(id)arg4;
- (void)dealloc;
