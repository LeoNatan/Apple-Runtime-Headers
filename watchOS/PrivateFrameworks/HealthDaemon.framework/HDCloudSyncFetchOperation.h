...
- (int)_verifyAnchorRangesForSyncStore:(id)arg1 storeRecord:(id)arg2 error:(id *)arg3;
- (int)_verifyAnchorRangesForSyncStore:(id)arg1 storeRecord:(id)arg2 sequenceRecord:(id)arg3 error:(id *)arg4;
...
- (void)_queue_helpFetchHeaderRecordsInBatchesForZoneID:(id)arg1 recordIndex:(int)arg2 recordsByRecordID:(id)arg3;
...
- (void)_incrementAggdCountForResultStatus:(int)arg1;
- (void)_finishWithStatus:(int)arg1 error:(id)arg2;
