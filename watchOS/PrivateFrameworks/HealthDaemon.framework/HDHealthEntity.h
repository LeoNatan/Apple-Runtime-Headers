...
+ (unsigned int)_transactionOptionsForWriting:(_Bool)arg1;
...
+ (long long)nextSyncAnchorWithStartAnchor:(long long)arg1 predicate:(id)arg2 syncEntityClass:(Class)arg3 session:(id)arg4 orderingProperties:(id)arg5 orderingDirections:(id)arg6 limit:(unsigned int)arg7 healthDatabase:(id)arg8 error:(id *)arg9;
...
+ (_Bool)enumerateEntitiesForSyncWithProperties:(id)arg1 predicate:(id)arg2 syncEntityClass:(Class)arg3 session:(id)arg4 syncAnchorRange:(struct HDSyncAnchorRange)arg5 orderingProperties:(id)arg6 orderingDirections:(id)arg7 limit:(unsigned int)arg8 lastSyncAnchor:(long long *)arg9 healthDatabase:(id)arg10 error:(id *)arg11 block:(CDUnknownBlockType)arg12;
