...
+ (unsigned int)_transactionOptionsForWriting:(_Bool)arg1 highPriority:(_Bool)arg2;
...
+ (long long)nextSyncAnchorWithStartAnchor:(long long)arg1 predicate:(id)arg2 session:(id)arg3 orderingProperties:(id)arg4 orderingDirections:(id)arg5 limit:(unsigned int)arg6 healthDatabase:(id)arg7 error:(id *)arg8;
...
+ (_Bool)enumerateEntitiesForSyncWithProperties:(id)arg1 predicate:(id)arg2 session:(id)arg3 syncAnchorRange:(struct HDSyncAnchorRange)arg4 orderingProperties:(id)arg5 orderingDirections:(id)arg6 limit:(unsigned int)arg7 lastSyncAnchor:(long long *)arg8 healthDatabase:(id)arg9 error:(id *)arg10 block:(CDUnknownBlockType)arg11;
