...
@interface HDAchievementDetective : NSObject <_HKActivitySummaryHistoryEnvironmentDataSource, _HKAchievementPredicateWorkoutsEnvironmentDataSource, HDAchievementEngineDataProviding, HDCurrentActivitySummaryHelperObserver, HDAchievementEvaluationDelegate>
{
    ...
    unsigned int _lastTodayStandValue;
    unsigned int _previousTodayStandValue;
    unsigned int _lastTodayStandGoal;
...
@property(nonatomic) unsigned int lastTodayStandGoal; // @synthesize lastTodayStandGoal=_lastTodayStandGoal;
@property(nonatomic) unsigned int previousTodayStandValue; // @synthesize previousTodayStandValue=_previousTodayStandValue;
@property(nonatomic) unsigned int lastTodayStandValue; // @synthesize lastTodayStandValue=_lastTodayStandValue;
...
- (id)aggregateEnvironmentForMonthOffsetFromNow:(int)arg1;
...
- (unsigned int)yesterdayStandHoursForEngine:(id)arg1;
- (unsigned int)todayStandHoursForEngine:(id)arg1;
- (unsigned int)yesterdayStandGoalForEngine:(id)arg1;
- (unsigned int)todayStandGoalForEngine:(id)arg1;
...
- (id)_predicateForWorkoutsInDefaultSourcesOfActivityType:(unsigned int)arg1;
...
- (void)_detectAchievementsWithEngine:(id)arg1 triggers:(unsigned int)arg2 environment:(id)arg3;
