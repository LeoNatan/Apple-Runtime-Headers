...
+ (id)_nextModificationEpochForSourceIdentifier:(long long)arg1 type:(int)arg2 profile:(id)arg3 database:(id)arg4 error:(id *)arg5;
+ (_Bool)_insertAuthorizationWithSourceIdentifier:(long long)arg1 dataTypeCode:(int)arg2 authorizationStatus:(int)arg3 authorizationRequest:(int)arg4 authorizationMode:(int)arg5 modificationDate:(id)arg6 currentDate:(id)arg7 syncProvenance:(long long)arg8 objectAnchor:(long long)arg9 modificationEpoch:(id)arg10 options:(unsigned int)arg11 profile:(id)arg12 database:(id)arg13 error:(id *)arg14;
+ (_Bool)_insertCodableAuthorizations:(id)arg1 sourceEntity:(id)arg2 syncProvenance:(long long)arg3 objectAnchor:(long long)arg4 currentDate:(id)arg5 options:(unsigned int)arg6 profile:(id)arg7 database:(id)arg8 error:(id *)arg9;
