...
@interface HDUserNotification : NSObject
{
    ...
    int _alertLevel;
    unsigned long _userNotificationOptions;
...
@property(nonatomic) unsigned long userNotificationOptions; // @synthesize userNotificationOptions=_userNotificationOptions;
@property(nonatomic) int alertLevel; // @synthesize alertLevel=_alertLevel;
