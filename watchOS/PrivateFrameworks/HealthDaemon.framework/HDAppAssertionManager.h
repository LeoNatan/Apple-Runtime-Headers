...
- (void)_queue_invalidateAssertionWithBundleID:(id)arg1 dataCode:(int)arg2 anchor:(id)arg3;
- (void)invalidateAssertionWithBundleID:(id)arg1 dataCode:(int)arg2 anchor:(id)arg3;
- (void)_queue_extendAssertionWithBundleID:(id)arg1 dataCode:(int)arg2 anchor:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)extendAssertionWithBundleID:(id)arg1 dataCode:(int)arg2 anchor:(id)arg3 completion:(CDUnknownBlockType)arg4;
