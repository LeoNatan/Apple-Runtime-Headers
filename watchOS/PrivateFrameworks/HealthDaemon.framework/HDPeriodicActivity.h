...
- (void)_queue_activityFinishedWithResult:(int)arg1 minimumRetryInterval:(double)arg2 error:(id)arg3;
...
- (void)didPerformActivityWithResult:(int)arg1 minimumRetryInterval:(double)arg2 error:(id)arg3;
