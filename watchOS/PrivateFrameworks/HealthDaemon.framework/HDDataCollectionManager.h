...
- (void)_requestAggregationThroughDate:(id)arg1 type:(id)arg2 mode:(int)arg3 completion:(CDUnknownBlockType)arg4;
- (void)_requestAggregationThroughDate:(id)arg1 types:(id)arg2 mode:(int)arg3 completion:(CDUnknownBlockType)arg4;
- (void)requestAggregationForAllTypesThroughDate:(id)arg1 mode:(int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)requestAggregationThroughDate:(id)arg1 types:(id)arg2 mode:(int)arg3 completion:(CDUnknownBlockType)arg4;
