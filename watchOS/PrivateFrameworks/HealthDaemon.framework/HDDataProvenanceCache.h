...
- (id)sourceRevisionForPersistentID:(id)arg1 sourceVersion:(id)arg2 productType:(id)arg3 operatingSystemVersion:(CDStruct_4bb15e50)arg4 profile:(id)arg5 error:(id *)arg6;
