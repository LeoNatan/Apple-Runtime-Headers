...
- (int)validateForeignKeysForTable:(id)arg1 databaseName:(id)arg2 error:(id *)arg3;
...
- (_Bool)setUserVersion:(int)arg1 withDatabaseName:(id)arg2 error:(id *)arg3;
...
- (_Bool)performTransactionWithType:(int)arg1 error:(id *)arg2 usingBlock:(CDUnknownBlockType)arg3;
- (int)getChangesCount;
...
@property(readonly, nonatomic) int statementCacheScope;
...
- (_Bool)correlationCountForDataEntitySubclassTable:(id)arg1 count:(int *)arg2 error:(id *)arg3;
