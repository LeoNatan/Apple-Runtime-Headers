...
@interface HDDataManager : NSObject <HDDiagnosticObject>
{
    ...
    int _notifyCount;
    int _samplesAddedCount;
    int _samplesJournaledCount;
...
- (int)hasSampleWithBundleIdentifier:(id)arg1 error:(id *)arg2;
...
- (_Bool)deleteDataObjectsOfClass:(Class)arg1 predicate:(id)arg2 limit:(unsigned int)arg3 deletedSampleCount:(unsigned int *)arg4 notifyObservers:(_Bool)arg5 generateDeletedObjects:(_Bool)arg6 recursiveDeleteAuthorizationBlock:(CDUnknownBlockType)arg7 error:(id *)arg8;
...
- (id)_deleteDataObjectsByUUIDSQLStringForConfiguration:(id)arg1 entityType:(int)arg2 error:(id *)arg3;
