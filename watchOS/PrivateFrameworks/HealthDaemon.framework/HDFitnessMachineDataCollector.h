...
#import "HDMetricsCollector.h"

@class CMFitnessMachine, HDDataCollectorConfiguration, HDProfile, HKDevice, HKObserverSet, HKSource, NSDate, NSMapTable, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSSet, NSString;
