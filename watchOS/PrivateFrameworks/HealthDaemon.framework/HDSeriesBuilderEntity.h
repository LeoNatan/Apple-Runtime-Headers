...
+ (id)createPersistentEntityForBuilderIdentifier:(id)arg1 seriesType:(id)arg2 state:(int)arg3 profile:(id)arg4 error:(id *)arg5;
...
- (_Bool)setBuilderState:(int)arg1 transaction:(id)arg2 error:(id *)arg3;
- (int)stateWithTransaction:(id)arg1 error:(id *)arg2;
