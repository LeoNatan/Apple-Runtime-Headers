...
- (id)initWithSyncAnchorRangeMapData:(id)arg1 changeIndex:(unsigned long long)arg2 changesetAsset:(id)arg3 protocolVersion:(int)arg4 options:(id)arg5 sequenceRecordID:(id)arg6 record:(id)arg7 schemaVersion:(int)arg8;
