...
- (void)remote_select:(NSArray *)arg1 from:(NSString *)arg2 where:(NSPredicate *)arg3 groupBy:(NSArray *)arg4 orderBy:(NSArray *)arg5 limit:(int)arg6 completion:(void (^)(NSArray *, NSArray *, _Bool, NSError *))arg7;
...
- (void)remote_generateFakeDataForActivityType:(int)arg1 minutes:(double)arg2 completion:(void (^)(id, NSError *))arg3;
- (void)remote_stopFakingDataWithCompletion:(void (^)(_Bool, NSError *))arg1;
- (void)remote_startFakingDataWithActivityType:(int)arg1 speed:(HKQuantity *)arg2 completion:(void (^)(_Bool, NSError *))arg3;
@end
