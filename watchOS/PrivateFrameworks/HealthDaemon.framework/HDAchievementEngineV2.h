...
- (CDStruct_7dbd4349)_runForActivityDataWithInitialState:(CDStruct_7dbd4349)arg1 forGoalType:(unsigned int)arg2 goalDisplayName:(id)arg3 shouldAlertGoalComplete:(_Bool)arg4 goalMetHandler:(CDUnknownBlockType)arg5;
- (unsigned int)runForNewStandDataAlertingDailyGoals:(_Bool)arg1;
- (unsigned int)runForNewExerciseDataAlertingDailyGoals:(_Bool)arg1;
- (unsigned int)runForNewMoveDataAlertingDailyGoals:(_Bool)arg1;
