...
- (id)initWithStatus:(int)arg1 storeRecordsCacheMap:(id)arg2 syncStorePushIdentifier:(id)arg3 syncStorePullIdentifiers:(id)arg4 abandonedStoreIdentifiers:(id)arg5 reclaimedIdentifiers:(id)arg6;
