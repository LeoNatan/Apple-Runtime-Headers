...
- (void)remote_setAuthorizationStatuses:(id)arg1 authorizationModes:(id)arg2 forBundleIdentifier:(id)arg3 options:(unsigned int)arg4 completion:(CDUnknownBlockType)arg5;
