...
+ (id)statisticsBuilderWithQuantityType:(id)arg1 filter:(id)arg2 statisticsOptions:(unsigned int)arg3 mergeStrategy:(unsigned int)arg4 restrictedSourceEntities:(id)arg5 profile:(id)arg6;
...
- (id)initWithQuantityType:(id)arg1 filter:(id)arg2 statisticsOptions:(unsigned int)arg3 mergeStrategy:(unsigned int)arg4 restrictedSourceEntities:(id)arg5 profile:(id)arg6;
