...
- (id)initWithSessionUUID:(id)arg1 machineUUID:(id)arg2 machineType:(unsigned int)arg3 machineName:(id)arg4 machineBrand:(id)arg5 activityType:(unsigned int)arg6;
