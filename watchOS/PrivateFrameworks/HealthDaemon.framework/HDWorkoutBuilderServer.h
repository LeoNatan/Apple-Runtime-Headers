...
- (id)_lock_statisticsCalculatorForQuantityType:(id)arg1 mergeStrategy:(unsigned int)arg2 computationMethod:(int)arg3;
...
- (void)remote_setTargetConstructionState:(int)arg1 startDate:(id)arg2 endDate:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)_notifySourcesOfTransitionFromState:(unsigned int)arg1 toState:(unsigned int)arg2;
...
- (int)_recoveredStateForStartDate:(id)arg1 endDate:(id)arg2;
