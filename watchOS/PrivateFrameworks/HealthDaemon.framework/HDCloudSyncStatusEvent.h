...
- (id)initWithProfile:(id)arg1 build:(id)arg2 internal:(_Bool)arg3 operation:(int)arg4 reason:(int)arg5 options:(unsigned int)arg6 type:(int)arg7 syncCirclePrefix:(id)arg8 containerID:(id)arg9 syncID:(id)arg10 operationID:(id)arg11 syncState:(id)arg12 lastSuccessfulPullDate:(id)arg13 lastPushForwardProgressDate:(id)arg14;
