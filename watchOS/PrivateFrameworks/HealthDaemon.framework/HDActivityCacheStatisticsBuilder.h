...
- (id).cxx_construct;
- (void).cxx_destruct;
- (double)_sumSourceTotals:(map_55d41576 *)arg1 orderedSources:(vector_bbba3654)arg2 strictStartTime:(double)arg3 strictEndTime:(double)arg4;
- (double)_sumSourceTotals:(map_55d41576 *)arg1 orderedSources:(vector_bbba3654)arg2;
...
- (vector_bbba3654)_sourceOrderForTypeCode:(int)arg1;
- (id)init;
