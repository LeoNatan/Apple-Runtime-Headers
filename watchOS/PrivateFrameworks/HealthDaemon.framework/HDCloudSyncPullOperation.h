...
- (void)_queue_setAssetExtractionFailureCount:(int)arg1;
- (int)_queue_assetExtractionFailureCount;
...
- (void)_queue_helpFetchAssetsForOrderedChangeRecords:(id)arg1 operation:(id)arg2 recordIndex:(int)arg3;
...
- (int)_queue_requiresSyncWithError:(id *)arg1;
- (int)_queue_requiresSyncForSequence:(id)arg1 error:(id *)arg2;
