...
- (_Bool)getCondenserVersion:(out int *)arg1 date:(out id *)arg2 profile:(id)arg3 error:(id *)arg4;
- (_Bool)isCondenserVersionLessThan:(int)arg1 transaction:(id)arg2;
- (_Bool)updateCondenserVersion:(int)arg1 date:(id)arg2 transaction:(id)arg3 error:(id *)arg4;
