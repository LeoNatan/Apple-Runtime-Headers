...
- (void).cxx_destruct;
- (id)_queue_eventCollectorsForType:(unsigned int)arg1 delegate:(id)arg2;
- (void)assertionManager:(id)arg1 assertionInvalidated:(id)arg2;
- (void)requestPendingEventsThroughDate:(id)arg1 sessionIdentifier:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (id)takeSessionAssertionWithOwnerIdentifier:(id)arg1 activityType:(unsigned int)arg2 sessionIdentifier:(id)arg3 eventsDelegate:(id)arg4;
