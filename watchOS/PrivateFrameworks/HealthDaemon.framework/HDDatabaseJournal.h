...
@interface HDDatabaseJournal : NSObject
{
    ...
    unsigned int _mergeTransactionOptions;
}

@property(nonatomic) unsigned int mergeTransactionOptions; // @synthesize mergeTransactionOptions=_mergeTransactionOptions;
...
- (unsigned int)_processJournalFile:(id)arg1 profile:(id)arg2 sqlDatabase:(id)arg3 fileSize:(unsigned int *)arg4 error:(id *)arg5;
