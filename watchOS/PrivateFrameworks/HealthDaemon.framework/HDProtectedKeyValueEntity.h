...
+ (_Bool)enumerateAchievementValuesForKeys:(id)arg1 category:(int)arg2 profile:(id)arg3 error:(id *)arg4 usingBlock:(CDUnknownBlockType)arg5;
...
+ (_Bool)removeAchievementValuesForKeys:(id)arg1 category:(int)arg2 profile:(id)arg3 error:(id *)arg4;
+ (_Bool)setAchievementValuesWithDictionary:(id)arg1 category:(int)arg2 profile:(id)arg3 error:(id *)arg4;
