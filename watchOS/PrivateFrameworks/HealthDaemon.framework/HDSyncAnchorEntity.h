...
+ (_Bool)_setSyncAnchor:(long long)arg1 options:(unsigned int)arg2 updatePolicy:(int)arg3 entityIdentifier:(id)arg4 store:(id)arg5 database:(id)arg6 error:(id *)arg7;
+ (_Bool)_setSyncAnchor:(long long)arg1 options:(unsigned int)arg2 updatePolicy:(int)arg3 entityIdentifier:(id)arg4 store:(id)arg5 profile:(id)arg6 error:(id *)arg7;
