...
- (void)unitTest_fakeMachineDiscoveryForType:(unsigned int)arg1;
...
- (void)pairingManager:(id)arg1 discoveredHealthService:(id)arg2 machineType:(unsigned int)arg3;
- (void)pairingManagerReceivedActivityTypeAndPermission:(id)arg1;
- (void)pairingManager:(id)arg1 updatedConnectionStateFromState:(unsigned int)arg2 toState:(unsigned int)arg3;
...
- (void)_queue_deliverConnectionStateChangedFromState:(unsigned int)arg1 toState:(unsigned int)arg2 error:(id)arg3 notifyingPairingManager:(_Bool)arg4;
- (void)_queue_deliverMachineStateChangedFromState:(unsigned int)arg1 date:(id)arg2;
...
- (void)_queue_setConnectionState:(unsigned int)arg1 error:(id)arg2;
- (void)_queue_setMachineState:(unsigned int)arg1 date:(id)arg2;
...
- (void)_queue_handleBluetoothStatusUpdate:(int)arg1 error:(id)arg2;
...
- (void)_queue_handleOrBufferReceivedCharacteristic:(id)arg1 sessionIdentifier:(unsigned int)arg2 device:(id)arg3 error:(id)arg4;
- (void)_queue_reconnectFitnessMachineWithError:(id)arg1;
- (void)_queue_handleConnectionStatus:(int)arg1 finished:(_Bool)arg2 error:(id)arg3;
- (unsigned int)connectionOptionsForSession:(id)arg1 isReconnect:(_Bool)arg2;
...
- (unsigned int)fitnessMachineTypeForSessionUUID:(id)arg1;
