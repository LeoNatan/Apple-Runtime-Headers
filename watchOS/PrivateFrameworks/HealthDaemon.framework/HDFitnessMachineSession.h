...
@interface HDFitnessMachineSession : NSObject
{
    ...
    unsigned int _healthServiceSessionIdentifier;
...
@property(nonatomic) unsigned int healthServiceSessionIdentifier; // @synthesize healthServiceSessionIdentifier=_healthServiceSessionIdentifier;
...
- (void)setFitnessMachineName:(id)arg1 type:(unsigned int)arg2 identifier:(id)arg3;
