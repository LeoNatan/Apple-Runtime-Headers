...
- (void)pairingManager:(HDFitnessMachinePairingManager *)arg1 discoveredHealthService:(HKHealthService *)arg2 machineType:(unsigned int)arg3;
- (void)pairingManagerReceivedActivityTypeAndPermission:(HDFitnessMachinePairingManager *)arg1;
- (void)pairingManager:(HDFitnessMachinePairingManager *)arg1 updatedConnectionStateFromState:(unsigned int)arg2 toState:(unsigned int)arg3;
