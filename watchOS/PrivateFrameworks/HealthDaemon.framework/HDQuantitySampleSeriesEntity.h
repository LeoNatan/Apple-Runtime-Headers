...
+ (id)_updatedSampleForSeries:(id)arg1 originalEntity:(id)arg2 HFDKey:(long long)arg3 newCount:(int)arg4 transaction:(id)arg5 profile:(id)arg6 error:(id *)arg7;
...
+ (_Bool)primitiveInsertValues:(id)arg1 seriesVersion:(int)arg2 HFDKey:(long long)arg3 database:(id)arg4 error:(id *)arg5;
