...
@interface HDBTLEHeartRateDataCollector : NSObject <HDDataCollector>
{
    ...
    unsigned int _connectedSessionIdentifier;
}
...
- (void)_queue_service:(id)arg1 sessionDidDisconnect:(unsigned int)arg2;
- (void)_queue_service:(id)arg1 sessionDidConnect:(unsigned int)arg2;
- (void)_queue_service:(id)arg1 session:(unsigned int)arg2 statusDidChange:(int)arg3 finished:(_Bool)arg4 error:(id)arg5;
