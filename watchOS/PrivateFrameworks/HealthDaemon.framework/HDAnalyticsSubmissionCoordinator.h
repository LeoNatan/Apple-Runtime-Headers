...
- (void)cloudSync_reportMissingManateeIdentityDuringFetchInContainer:(id)arg1 zoneName:(id)arg2 databaseScope:(int)arg3;
- (void)database_reportUnprotectedDatabaseIdentifier:(id)arg1 doesNotMatchProtectedDatabaseIdentifier:(id)arg2;
- (void)database_reportHFDCorruptionWithFailureType:(int)arg1 profile:(id)arg2;
- (void)database_reportSQLiteCorruptionWithResultCode:(int)arg1 type:(int)arg2 profile:(id)arg3;
