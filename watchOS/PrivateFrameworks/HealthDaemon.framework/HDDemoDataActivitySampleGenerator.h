...
- (void)_generateSwimmingSegmentDataWithStartDate:(id)arg1 segmentTime:(double)arg2 segmentDistance:(double)arg3 numLaps:(int)arg4 strokeStyle:(int)arg5 objectCollection:(id)arg6 demoPerson:(id)arg7;
...
- (void)generateRecentWorkoutIfNeededWith:(id)arg1 demoPerson:(id)arg2;
