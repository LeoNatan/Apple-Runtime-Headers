...
- (_Bool)performWithOptions:(unsigned int)arg1 error:(id *)arg2 block:(CDUnknownBlockType)arg3 inaccessibilityHandler:(CDUnknownBlockType)arg4;
- (id)databaseForEntityClass:(Class)arg1;
- (id)databaseForEntity:(id)arg1;
- (id)databaseForEntityProtectionClass:(int)arg1;
- (id)databaseForOptions:(unsigned int)arg1;
