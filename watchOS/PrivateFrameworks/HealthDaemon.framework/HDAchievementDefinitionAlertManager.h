...
- (_Bool)_queue_markDefinitions:(id)arg1 asAlertedState:(unsigned int)arg2;
...
- (_Bool)markDefinitionIdentifiers:(id)arg1 asAlertedState:(unsigned int)arg2 error:(id *)arg3;
