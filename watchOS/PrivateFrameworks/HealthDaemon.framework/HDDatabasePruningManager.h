...
- (void)_queue_pruneExpiredSamplesWithOptions:(unsigned int)arg1 fromNowDate:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_queue_pruneDatabaseWithOptions:(unsigned int)arg1 nowDate:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)pruneDatabaseWithOptions:(unsigned int)arg1 nowDate:(id)arg2 accessibilityAssertion:(id)arg3 completion:(CDUnknownBlockType)arg4;
