...
+ (id)calculatorForQuantityType:(id)arg1 intervalCollection:(id)arg2 options:(unsigned int)arg3 mergeStrategy:(unsigned int)arg4 computationMethod:(int)arg5;
+ (id)calculatorForQuantityType:(id)arg1 intervalCollection:(id)arg2 options:(unsigned int)arg3 mergeStrategy:(unsigned int)arg4;
- (id).cxx_construct;
- (void).cxx_destruct;
...
@property(readonly, nonatomic) int computationMethod; // @synthesize computationMethod=_computationMethod;
...
@property(readonly, nonatomic) unsigned int mergeStrategy;
...
- (id)initForQuantityType:(id)arg1 intervalCollection:(id)arg2 options:(unsigned int)arg3 mergeStrategy:(unsigned int)arg4 computationMethod:(int)arg5;
