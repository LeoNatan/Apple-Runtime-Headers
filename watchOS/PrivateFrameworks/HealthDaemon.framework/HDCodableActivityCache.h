...
- (id)dailyBriskMinutesStatisticsAtIndex:(unsigned int)arg1;
- (unsigned int)dailyBriskMinutesStatisticsCount;
- (void)addDailyBriskMinutesStatistics:(id)arg1;
- (void)clearDailyBriskMinutesStatistics;
- (id)dailyEnergyBurnedStatisticsAtIndex:(unsigned int)arg1;
- (unsigned int)dailyEnergyBurnedStatisticsCount;
