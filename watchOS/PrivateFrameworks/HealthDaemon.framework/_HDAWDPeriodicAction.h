...
- (void)_loadState;
- (id)taskName;
- (id)initWithTaskName:(char *)arg1 keyPrefix:(id)arg2 xpcInterval:(long long)arg3 xpcGraceInterval:(long long)arg4 requiresClassA:(_Bool)arg5 intervalMultiple:(int)arg6 maximumAttemptCount:(int)arg7 minimumDelayBetweenAttempts:(double)arg8 block:(CDUnknownBlockType)arg9;
