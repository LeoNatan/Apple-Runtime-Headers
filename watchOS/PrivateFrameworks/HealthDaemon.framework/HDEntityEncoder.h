...
- (id)createBareObject;
- (_Bool)generateCodableRepresentationsForPersistentID:(long long)arg1 row:(struct HDSQLiteRow *)arg2 maxBytesPerRepresentation:(int)arg3 error:(id *)arg4 handler:(CDUnknownBlockType)arg5;
- (id)codableRepresentationForPersistentID:(long long)arg1 row:(struct HDSQLiteRow *)arg2 error:(id *)arg3;
- (id)orderedProperties;
- (id)initWithHealthEntityClass:(Class)arg1 profile:(id)arg2 database:(id)arg3 purpose:(int)arg4 encodingOptions:(id)arg5 authorizationFilter:(CDUnknownBlockType)arg6;
