...
- (id)initWithTransaction:(id)arg1 persistentID:(long long)arg2 dataTypeCode:(int)arg3 UUID:(id)arg4 startTime:(double)arg5 count:(long long)arg6 sourceID:(long long)arg7 HFDKey:(long long)arg8 bufferSize:(unsigned long)arg9;
