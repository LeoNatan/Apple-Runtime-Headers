...
- (_Bool)_insertExternalSyncMetadata:(id)arg1 forObjectID:(id)arg2 sourceID:(id)arg3 externalSyncObjectCode:(int)arg4 objectDeleted:(_Bool)arg5 database:(id)arg6 error:(id *)arg7;
...
- (_Bool)insertMetadata:(id)arg1 forObjectID:(id)arg2 sourceID:(id)arg3 externalSyncObjectCode:(int)arg4 objectDeleted:(_Bool)arg5 database:(id)arg6 error:(id *)arg7;
- (_Bool)insertMetadata:(id)arg1 forObjectID:(id)arg2 sourceID:(id)arg3 externalSyncObjectCode:(int)arg4 objectDeleted:(_Bool)arg5 error:(id *)arg6;
