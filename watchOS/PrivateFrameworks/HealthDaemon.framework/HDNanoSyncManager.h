...
- (int)_changeResponseActionForMessage:(id)arg1 statusCode:(int)arg2 syncStore:(id)arg3 errorDescription:(id *)arg4;
...
- (int)_changeRequestActionForMessage:(id)arg1 syncStore:(id)arg2 errorDescription:(id *)arg3;
...
- (int)_actionForRestoreRequest:(id)arg1 syncStore:(id)arg2 error:(id *)arg3;
