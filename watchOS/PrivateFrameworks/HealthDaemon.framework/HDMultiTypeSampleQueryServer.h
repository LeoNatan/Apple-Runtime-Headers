...
{
    unsigned int _deliveredResultCount;
...
- (void)_queue_handleBatchedQueryResult:(int)arg1 error:(id)arg2;
- (int)batchObjectsWithError:(id *)arg1 batchHandler:(CDUnknownBlockType)arg2;
- (void)_queue_start;
