...
@property(readonly, nonatomic) unsigned int currentBucket; // @synthesize currentBucket=_currentBucket;
...
- (void).cxx_destruct;
- (double)endDateForBucket:(unsigned int)arg1;
- (double)startDateForBucket:(unsigned int)arg1;
