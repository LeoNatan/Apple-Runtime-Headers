...
@property(readonly, nonatomic) int authorizationMode;
@property(readonly, nonatomic) int authorizationRequest;
@property(readonly, nonatomic) int authorizationStatus;
- (id)initWithReadAuthorizationStatus:(int)arg1 authorizationRequest:(int)arg2 authorizationMode:(int)arg3 restrictedBundleIdentifier:(id)arg4 restrictedSourceEntities:(id)arg5 deletedObjectBaselineAnchor:(id)arg6 objectLimitAnchor:(id)arg7 objectLimitModifiedDate:(id)arg8;
