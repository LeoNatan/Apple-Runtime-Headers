...
- (_Bool)setVersion:(int)arg1 schema:(id)arg2 protectionClass:(int)arg3 error:(id *)arg4;
- (int)currentVersionForSchema:(id)arg1 protectionClass:(int)arg2 error:(id *)arg3;
