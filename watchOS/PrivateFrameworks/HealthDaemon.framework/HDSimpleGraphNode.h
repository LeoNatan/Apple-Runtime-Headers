...
- (_Bool)work_loadAllRelationshipsWithMaxDepth:(int)arg1 error:(id *)arg2;
- (_Bool)work_loadRelationships:(id)arg1 maxDepth:(int)arg2 fetchType:(long long)arg3 error:(id *)arg4;
- (_Bool)_work_loadRelatedNodesRecursiveForRelationships:(id)arg1 maxDepth:(int)arg2 currentDepth:(int)arg3 fetchType:(long long)arg4 error:(id *)arg5;
