...
- (_Bool)_enumerateSamplesOfType:(int)arg1 interval:(id)arg2 database:(id)arg3 handler:(CDUnknownBlockType)arg4;
- (id)_dateIntervalForType:(int)arg1;
- (unsigned int)mergeStrategyForType:(id)arg1;
...
- (_Bool)addQuantitySamplesForType:(int)arg1 value:(double)arg2 bucketStartTime:(double)arg3 bucketEndTime:(double)arg4 startTime:(double)arg5 endTime:(double)arg6 sourceId:(long long)arg7 enforceLatest:(_Bool)arg8;
- (_Bool)_updateWithQuantitySamples:(id)arg1 typeCode:(int)arg2;
- (_Bool)addCategorySamplesForType:(int)arg1 value:(double)arg2 startTime:(double)arg3 endTime:(double)arg4 sourceId:(long long)arg5 enforceLatest:(_Bool)arg6;
- (_Bool)addBinarySamplesForType:(int)arg1 startTime:(double)arg2 endTime:(double)arg3 sourceId:(long long)arg4;
- (_Bool)_addSleepSample:(id)arg1;
- (_Bool)_addWorkoutSample:(id)arg1;
- (_Bool)wasUpdated;
- (_Bool)_updateNonQuantityValuesWithAddedSamples:(id)arg1 typeCode:(int)arg2;
- (void)updateValuesWithAddedSamples:(id)arg1 typeCode:(int)arg2 anchor:(id)arg3;
