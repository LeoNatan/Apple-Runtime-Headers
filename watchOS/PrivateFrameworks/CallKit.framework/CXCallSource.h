...
- (void)reportCallWithUUID:(id)arg1 crossDeviceIdentifier:(id)arg2 changedBytesOfDataUsed:(int)arg3 reply:(CDUnknownBlockType)arg4;
- (oneway void)reportCallWithUUID:(id)arg1 crossDeviceIdentifier:(id)arg2 changedBytesOfDataUsed:(int)arg3;
- (void)reportCallWithUUID:(id)arg1 changedMeterLevel:(float)arg2 forDirection:(int)arg3 reply:(CDUnknownBlockType)arg4;
- (oneway void)reportCallWithUUID:(id)arg1 changedMeterLevel:(float)arg2 forDirection:(int)arg3;
- (void)reportCallWithUUID:(id)arg1 changedFrequencyData:(id)arg2 forDirection:(int)arg3 reply:(CDUnknownBlockType)arg4;
...
- (void)reportCallWithUUID:(id)arg1 endedAtDate:(id)arg2 privateReason:(int)arg3 failureContext:(id)arg4 reply:(CDUnknownBlockType)arg5;
