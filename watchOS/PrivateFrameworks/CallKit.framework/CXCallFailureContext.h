...
@property(nonatomic) int providerEndedReason; // @synthesize providerEndedReason=_providerEndedReason;
@property(nonatomic) int providerErrorCode; // @synthesize providerErrorCode=_providerErrorCode;
