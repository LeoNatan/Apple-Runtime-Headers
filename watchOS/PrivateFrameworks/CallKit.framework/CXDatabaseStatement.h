...
- (_Bool)processResultsWithExpectedColumnCount:(int)arg1 resultRowHandler:(CDUnknownBlockType)arg2 error:(id *)arg3;
...
- (_Bool)executeWithExpectedColumnCount:(int)arg1 resultRowHandler:(CDUnknownBlockType)arg2 error:(id *)arg3;
