...
@interface CXCallDirectoryStore : NSObject
{
    ...
    int _lastRemoveBlockingEntriesCount;
    ...
    int _lastRemoveIdentificationEntriesCount;
...
@property(nonatomic) int lastAddPhoneNumbersCount; // @synthesize lastAddPhoneNumbersCount=_lastAddPhoneNumbersCount;
...
@property(nonatomic) int lastAddIdentificationEntriesCount; // @synthesize lastAddIdentificationEntriesCount=_lastAddIdentificationEntriesCount;
@property(copy, nonatomic) NSString *removeBlockingEntriesSQL; // @synthesize removeBlockingEntriesSQL=_removeBlockingEntriesSQL;
@property(nonatomic) int lastRemoveBlockingEntriesCount; // @synthesize lastRemoveBlockingEntriesCount=_lastRemoveBlockingEntriesCount;
...
- (_Bool)_removeIdentificationEntriesWithData:(id)arg1 startIndex:(unsigned int)arg2 count:(unsigned int)arg3 extensionID:(long long)arg4 error:(id *)arg5;
- (_Bool)removeIdentificationEntriesWithData:(id)arg1 extensionID:(long long)arg2 error:(id *)arg3;
- (_Bool)_addPhoneNumbersWithEntryData:(id)arg1 startIndex:(unsigned int)arg2 count:(unsigned int)arg3 error:(id *)arg4;
- (_Bool)_addIdentificationEntriesWithData:(id)arg1 startIndex:(unsigned int)arg2 count:(unsigned int)arg3 extensionID:(long long)arg4 error:(id *)arg5;
...
- (_Bool)_removeBlockingEntriesWithData:(id)arg1 startIndex:(unsigned int)arg2 count:(unsigned int)arg3 extensionID:(long long)arg4 error:(id *)arg5;
- (_Bool)removeBlockingEntriesWithData:(id)arg1 extensionID:(long long)arg2 error:(id *)arg3;
- (_Bool)_addBlockingEntriesWithData:(id)arg1 startIndex:(unsigned int)arg2 count:(unsigned int)arg3 extensionID:(long long)arg4 error:(id *)arg5;
...
- (_Bool)setStateForAllExtensions:(int)arg1 error:(id *)arg2;
- (_Bool)setStateLastModifiedDate:(id)arg1 forExtensionWithID:(long long)arg2 error:(id *)arg3;
- (_Bool)setState:(int)arg1 forExtensionWithID:(long long)arg2 error:(id *)arg3;
- (_Bool)setState:(int)arg1 forExtensionWithIdentifier:(id)arg2 error:(id *)arg3;
