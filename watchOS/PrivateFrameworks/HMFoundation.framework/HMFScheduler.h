...
+ (id)defaultScheduler;
- (void).cxx_destruct;
- (id)performSelector:(SEL)arg1 target:(id)arg2 argument:(id)arg3 qualityOfService:(int)arg4;
- (id)performSelector:(SEL)arg1 target:(id)arg2 argument:(id)arg3;
- (id)performWithQualityOfService:(int)arg1 block:(CDUnknownBlockType)arg2;
