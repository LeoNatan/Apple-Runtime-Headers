...
+ (void)initialize;
+ (id)bundleIdentifier;
+ (void)activityWithName:(id)arg1 parent:(id)arg2 options:(unsigned int)arg3 block:(CDUnknownBlockType)arg4;
+ (void)activityWithName:(id)arg1 parent:(id)arg2 assertions:(unsigned int)arg3 block:(CDUnknownBlockType)arg4;
...
- (CDUnknownBlockType)blockWithQualityOfService:(int)arg1 block:(CDUnknownBlockType)arg2;
...
- (void)end;
- (void)begin;
@property(readonly) unsigned int assertions;
...
- (void)dealloc;
- (id)initWithName:(id)arg1 parent:(id)arg2 options:(unsigned int)arg3;
- (id)initWithName:(id)arg1 parent:(id)arg2 assertions:(unsigned int)arg3;
