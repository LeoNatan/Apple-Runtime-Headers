...
@interface MSMessageLoadingAnalyticController : NSObject
{
    ...
    unsigned int _maxLoadingTimeSeconds;
...
@property(nonatomic) unsigned int maxLoadingTimeSeconds; // @synthesize maxLoadingTimeSeconds=_maxLoadingTimeSeconds;
...
- (void)_commonInitWithDiagnosticManager:(id)arg1 maxLoadingTimeSeconds:(unsigned int)arg2;
- (void)endAllRecording;
- (void)endRecordingForMessage:(id)arg1;
- (void)startRecordingForMessage:(id)arg1;
- (id)initWithDiagnosticManager:(id)arg1 maxLoadingTimeSeconds:(unsigned int)arg2;
