...
- (id)initWithEngagmentType:(int)arg1 message:(id)arg2 isTopHit:(_Bool)arg3 messageListIndex:(int)arg4 spotlightListIndex:(int)arg5;
- (id)initWithEngagmentType:(int)arg1 receivedDate:(id)arg2 mailboxType:(int)arg3 isTopHit:(_Bool)arg4 messageListIndex:(int)arg5 spotlightListIndex:(int)arg6;
