...
@interface MTLSimDevice : _MTLDevice <MTLDeviceSPI>
{
    ...
    CDStruct_778afa1c _maxThreadsPerThreadgroup;
    unsigned int _maxThreadgroupMemoryLength;
    _Bool headless;
    _Bool lowPower;
    ...
    unsigned int currentAllocatedSize;
...
@property(readonly) unsigned int doubleFPConfig; // @synthesize doubleFPConfig;
@property(readonly) unsigned int halfFPConfig; // @synthesize halfFPConfig;
...
@property(readonly) unsigned int singleFPConfig; // @synthesize singleFPConfig;
...
@property(readonly) unsigned int currentAllocatedSize; // @synthesize currentAllocatedSize;
...
@property(readonly) CDStruct_778afa1c maxThreadsPerThreadgroup;
- (id)newSharedEvent;
- (id)newEvent;
...
- (id)productName;
- (id)newTiledTextureWithBytesNoCopy:(void *)arg1 length:(unsigned long)arg2 descriptor:(id)arg3 offset:(unsigned int)arg4 bytesPerRow:(unsigned int)arg5;
- (id)newTiledTextureWithBytesNoCopy:(void *)arg1 length:(unsigned long)arg2 deallocator:(CDUnknownBlockType)arg3 descriptor:(id)arg4 offset:(unsigned int)arg5 bytesPerRow:(unsigned int)arg6;
...
- (id)newFunctionVariantWithCompilerOutput:(id)arg1 functionType:(unsigned int)arg2;
- (id)reportLeaks;
...
- (id)newBufferWithLength:(unsigned int)arg1 options:(unsigned int)arg2 pointer:(void *)arg3 copyBytes:(_Bool)arg4 deallocator:(CDUnknownBlockType)arg5;
