...
- (unsigned int)monthlyChallengeTypeForMonth:(id)arg1;
- (id)existingMonthlyChallengeTemplates;
- (int)numberOfEarnedInstancesOfTemplateWithUniqueName:(id)arg1 inDateComponentInterval:(id)arg2 withCalendar:(id)arg3;
