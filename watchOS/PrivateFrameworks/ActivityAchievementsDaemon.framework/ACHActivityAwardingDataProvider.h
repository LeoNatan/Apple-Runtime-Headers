...
- (void)setNewStandState:(CDStruct_9a304c14)arg1;
- (void)setNewExerciseState:(CDStruct_9a304c14)arg1;
- (void)_setBaseMoveState:(CDStruct_9a304c14)arg1;
- (void)setNewMoveState:(CDStruct_9a304c14)arg1;
- (CDStruct_9a304c14)currentStandState;
- (CDStruct_9a304c14)currentExerciseState;
- (CDStruct_9a304c14)_baseMoveState;
- (CDStruct_9a304c14)currentMoveState;
- (void)setNewState:(CDStruct_9a304c14)arg1 forGoalType:(int)arg2;
- (CDStruct_9a304c14)currentStateForGoalType:(int)arg1;
