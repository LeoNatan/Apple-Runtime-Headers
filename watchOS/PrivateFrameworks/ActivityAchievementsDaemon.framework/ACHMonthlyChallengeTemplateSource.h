...
- (id)_suffixForCurrentMonthForType:(unsigned int)arg1 template:(id)arg2;
...
- (unsigned int)_getRandomMonthlyChallengeType;
- (id)_availableMonthlyChallengeTypes;
- (_Bool)isMonthlyChallengeOfTypeAvailable:(unsigned int)arg1;
- (_Bool)isGoalValueForMonthlyChallengeTypeValid:(unsigned int)arg1;
