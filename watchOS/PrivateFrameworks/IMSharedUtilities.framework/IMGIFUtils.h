...
+ (_Bool)writeLoopCount:(int)arg1 withFileAtPath:(id)arg2 error:(id *)arg3;
+ (_Bool)copyGifFromPath:(id)arg1 toDestinationPath:(id)arg2 error:(id *)arg3;
+ (_Bool)writeLoopCount:(int)arg1 destinationFilePath:(id)arg2 fromImageSource:(struct CGImageSource *)arg3 error:(id *)arg4;
+ (_Bool)writeNewFileAtPath:(id)arg1 withProperties:(id)arg2 fromImageSource:(struct CGImageSource *)arg3 error:(id *)arg4;
+ (_Bool)readFileProperties:(id *)arg1 fromImageSource:(struct CGImageSource *)arg2 withUpdatedLoopCount:(int)arg3 error:(id *)arg4;
...
+ (id)randomFileName;
+ (_Bool)readLoopCount:(int *)arg1 fromImageSource:(struct CGImageSource *)arg2 error:(id *)arg3;
+ (int)loopCountFromGifProperties:(id)arg1;
...
+ (_Bool)setOutgoingError:(id *)arg1 errorCode:(int)arg2 comment:(id)arg3;
