...
- (void)_emitSignpostTranscodeRange:(int)arg1 begin:(_Bool)arg2;
- (void)_emitSignpostPreviewGenerationRange:(int)arg1 begin:(_Bool)arg2;
...
- (int)_telemetryImageTypeForUTI:(id)arg1;
- (id)init;
