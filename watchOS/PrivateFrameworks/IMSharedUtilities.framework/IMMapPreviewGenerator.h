...
+ (id)titleBarMaskImageForWidth:(float)arg1 constraints:(struct IMPreviewConstraints)arg2;
...
+ (struct CGImage *)newPreviewFromSourceURL:(id)arg1 withPreviewConstraints:(struct IMPreviewConstraints)arg2 interfaceStyle:(int)arg3 error:(id *)arg4;
