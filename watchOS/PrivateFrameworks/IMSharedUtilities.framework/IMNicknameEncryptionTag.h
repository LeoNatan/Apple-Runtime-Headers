...
+ (id)_tagWithStringRepresentation:(id)arg1 length:(unsigned int)arg2 error:(id *)arg3;
+ (id)_tagWithDataRepresentation:(id)arg1 length:(unsigned int)arg2 error:(id *)arg3;
