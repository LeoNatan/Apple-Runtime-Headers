...
- (id)pcsDataFromFetchedShare:(id)arg1 withPublicSharingKey:(id)arg2 withServiceType:(unsigned int)arg3 error:(id *)arg4;
...
- (struct _OpaquePCSShareProtection *)createSharePCSFromData:(id)arg1 withService:(unsigned int)arg2 logFailure:(_Bool)arg3 error:(id *)arg4;
...
- (void)preflightIdentitiesForService:(unsigned int)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)_createZonePCSFromData:(id)arg1 usingServiceIdentityWithType:(unsigned int)arg2 withSyncKeyRegistryRetry:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)_locked_createZonePCSFromData:(id)arg1 usingServiceIdentityWithType:(unsigned int)arg2 withSyncKeyRegistryRetry:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (struct _PCSIdentitySetData *)_copyServiceIdentityWithType:(unsigned int)arg1 useCache:(_Bool)arg2 withError:(id *)arg3;
