...
- (void)synchronizeUserKeyRegistryForServiceType:(unsigned int)arg1 shouldThrottle:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (id)newAssetKeyWithType:(unsigned int)arg1 withError:(id *)arg2;
...
- (void)_locked_pcsDataFromFetchedShare:(id)arg1 withPublicSharingKey:(id)arg2 withServiceType:(unsigned int)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)pcsDataFromFetchedShare:(id)arg1 withPublicSharingKey:(id)arg2 withServiceType:(unsigned int)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)pcsDataFromFetchedShare:(id)arg1 withServiceType:(unsigned int)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (struct _OpaquePCSShareProtection *)createSharePCSFromData:(id)arg1 ofType:(unsigned int)arg2 withService:(unsigned int)arg3 error:(id *)arg4;
- (struct _OpaquePCSShareProtection *)createSharePCSFromData:(id)arg1 ofType:(unsigned int)arg2 withService:(unsigned int)arg3 logFailure:(_Bool)arg4 error:(id *)arg5;
...
- (struct _OpaquePCSShareProtection *)createSharePCSOfType:(unsigned int)arg1 forPCSServiceType:(unsigned int)arg2 error:(id *)arg3;
...
- (struct _OpaquePCSShareProtection *)createEmptySharePCSOfType:(unsigned int)arg1 error:(id *)arg2;
- (struct _OpaquePCSShareProtection *)createEmptySignedSharePCSOfType:(unsigned int)arg1 forPCSServiceType:(unsigned int)arg2 withError:(id *)arg3;
...
- (_Bool)addSharePCS:(struct _OpaquePCSShareProtection *)arg1 toRecordPCS:(struct _OpaquePCSShareProtection *)arg2 permission:(unsigned int)arg3 error:(id *)arg4;
- (struct _OpaquePCSShareProtection *)createPCSObjectFromData:(id)arg1 ofType:(unsigned int)arg2 sharedToPCS:(struct _OpaquePCSShareProtection *)arg3 error:(id *)arg4;
- (struct _OpaquePCSShareProtection *)createPCSObjectFromData:(id)arg1 ofType:(unsigned int)arg2 sharedToPCS:(struct _OpaquePCSShareProtection *)arg3 logFailure:(_Bool)arg4 error:(id *)arg5;
...
- (id)updateIdentityAndRollKeyForZonePCS:(struct _OpaquePCSShareProtection *)arg1 usingServiceIdentityWithType:(unsigned int)arg2;
...
- (struct _OpaquePCSShareProtection *)createZonePCSFromData:(id)arg1 usingServiceIdentityWithType:(unsigned int)arg2 error:(id *)arg3;
- (void)preflightIdentitiesForService:(unsigned int)arg1 withSyncKeyRegistryRetry:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)_locked_preflightIdentitiesForService:(unsigned int)arg1 withSyncKeyRegistryRetry:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (_Bool)availableIdentityForService:(unsigned int)arg1 error:(id *)arg2;
- (void)createIngestedPPPCSDataFromInvitationData:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)createZonePCSFromData:(id)arg1 usingServiceIdentityWithType:(unsigned int)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)_createPCSFromData:(id)arg1 ofType:(unsigned int)arg2 usingPCSServiceType:(unsigned int)arg3 withSyncKeyRegistryRetry:(_Bool)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)_triggerAutobugCaptureForLostManateeIdentityError;
- (void)_locked_createPCSFromData:(id)arg1 ofType:(unsigned int)arg2 usingPCSServiceType:(unsigned int)arg3 withSyncKeyRegistryRetry:(_Bool)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (_Bool)canDecryptInvitedProtectionData:(id)arg1 participantProtectionInfo:(id)arg2 serviceType:(unsigned int)arg3 error:(id *)arg4;
...
- (id)participantPublicKeyForServiceType:(unsigned int)arg1 error:(id *)arg2;
...
- (unsigned int)publicKeyVersionForServiceType:(unsigned int)arg1;
- (struct _PCSIdentityData *)debugSharingIdentity;
- (id)_pcsObjectKindForCKDPCSBlobType:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int serviceTypeForSharing;
