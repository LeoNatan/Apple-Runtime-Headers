...
@property unsigned int highestReturnedOrder; // @synthesize highestReturnedOrder=_highestReturnedOrder;
@property unsigned int curFetchOrder; // @synthesize curFetchOrder=_curFetchOrder;
