...
- (void)updateFlowControl:(id)arg1 withRetryAfter:(unsigned int)arg2 reportableError:(id)arg3;
- (void)updateFlowControl:(id)arg1 withCost:(unsigned int)arg2 reportableError:(id)arg3;
