...
@interface CKDAccountManateeObserver : NSObject
{
    ...
    int _manateeAvailableForLoggedInAccount;
...
@property(nonatomic, setter=_lockedSetManateeAvailableForLoggedInAccount:) int manateeAvailableForLoggedInAccount; // @synthesize manateeAvailableForLoggedInAccount=_manateeAvailableForLoggedInAccount;
...
- (int)_fetchManateeAvailability:(id *)arg1;
- (void)dealloc;
- (id)init;
