...
@property(nonatomic) int checkoutCount; // @synthesize checkoutCount=_checkoutCount;
...
- (id)registerItemGroupSet:(id)arg1 operation:(id)arg2 options:(unsigned int)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (id)_contextToRegisterItemGroup:(id)arg1 operation:(id)arg2 options:(unsigned int)arg3 completionHandler:(CDUnknownBlockType)arg4;
