...
@property(nonatomic) unsigned int numRequestsSent; // @synthesize numRequestsSent=_numRequestsSent;
...
@property(readonly, nonatomic) unsigned int resultsLimit; // @synthesize resultsLimit=_resultsLimit;
