...
@property(nonatomic) int bodyStreamResetCount; // @synthesize bodyStreamResetCount=_bodyStreamResetCount;
...
- (id)description;
- (id)_initWithUUID:(id)arg1 requestMetadata:(id)arg2 requestObjects:(id)arg3 bodyStreamResetCount:(int)arg4 responseMetadata:(id)arg5 responseObjects:(id)arg6;
