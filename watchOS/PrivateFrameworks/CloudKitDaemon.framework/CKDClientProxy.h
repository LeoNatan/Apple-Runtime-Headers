...
@property(nonatomic) int hasTCCAuthorizationTernary; // @synthesize hasTCCAuthorizationTernary=_hasTCCAuthorizationTernary;
...
- (void)clearCachesForZoneWithSetupInfo:(id)arg1 zoneID:(id)arg2 databaseScope:(int)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)clearCachesForRecordWithSetupInfo:(id)arg1 recordID:(id)arg2 databaseScope:(int)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)clearCachesWithSetupInfo:(id)arg1 options:(unsigned int)arg2 databaseScope:(int)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)clearAssetCacheWithSetupInfo:(id)arg1 databaseScope:(int)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)showAssetCacheWithSetupInfo:(id)arg1 databaseScope:(int)arg2;
- (void)countAssetCacheItemsWithSetupInfo:(id)arg1 databaseScope:(int)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)setApplicationPermission:(unsigned int)arg1 enabled:(_Bool)arg2 setupInfo:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)accountWithID:(id)arg1 changedWithChangeType:(int)arg2;
...
- (void)_setApplicationPermission:(unsigned int)arg1 enabled:(_Bool)arg2 setupInfo:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
@property(readonly, nonatomic) unsigned int _outstandingOperationCount;
...
- (_Bool)canRunGivenAvailabilityState:(unsigned int)arg1;
- (void)dealloc;
