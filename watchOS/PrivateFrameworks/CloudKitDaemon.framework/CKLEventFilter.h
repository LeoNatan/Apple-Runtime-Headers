...
@property(nonatomic) unsigned int logTypes; // @synthesize logTypes=_logTypes;
- (_Bool)matchesEvent:(id)arg1;
- (id)initWithLogTypes:(unsigned int)arg1;
- (void)_initFilterDict;
- (_Bool)hasOnlyLogType:(unsigned int)arg1;
- (_Bool)hasLogType:(unsigned int)arg1;
