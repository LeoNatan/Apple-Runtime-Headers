...
- (id)description;
- (id)packagePutReceiptsAtIndex:(unsigned int)arg1;
- (unsigned int)packagePutReceiptsCount;
- (void)addPackagePutReceipts:(id)arg1;
- (void)clearPackagePutReceipts;
- (void)setPackageAssetSizes:(long long *)arg1 count:(unsigned int)arg2;
- (long long)packageAssetSizeAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int packageAssetSizesCount;
