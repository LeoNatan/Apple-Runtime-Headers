...
+ (id)translatorIgnoringUserIDsWithPackageStagingDirectory:(id)arg1 databaseScope:(int)arg2;
- (void).cxx_destruct;
...
- (unsigned int)capabilitiesFromPZoneCapabilities:(id)arg1;
...
- (id)initWithPackageStagingDirectory:(id)arg1 databaseScope:(int)arg2;
- (id)initWithContainerScopedUserID:(id)arg1 orgAdminUserID:(id)arg2 packageStagingDirectory:(id)arg3 databaseScope:(int)arg4;
- (id)_initWithContainerScopedUserID:(id)arg1 orgAdminUserID:(id)arg2 packageStagingDirectory:(id)arg3 databaseScope:(int)arg4;
