...
- (_Bool)startTrackingGetAssetHandles:(id)arg1 operationType:(int)arg2 error:(id *)arg3;
- (_Bool)startTrackingRegisterOrPutAssetHandles:(id)arg1 operationType:(int)arg2 error:(id *)arg3;
