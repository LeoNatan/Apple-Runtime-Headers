...
#import "NLSedentaryTimerStateEngineDelegate.h"

@class CMSedentaryTimer, HDProfile, HKActivitySummary, NLActivityAlarmMonitor, NLBridgeSettings, NLDataLogger, NLExperimentInstance, NLExperimentalCondition, NLGizmoWristEventsManager, NLSedentaryTimerStateEngine, NSObject<OS_dispatch_queue>, NSString;
