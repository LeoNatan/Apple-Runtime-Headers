...
@class NLAWDHealthKitAchievement, NLAWDHealthKitActivityCache, NLAWDHealthKitConcurrentCalendarItem, NLAWDHealthKitExperimentalCondition, NLAWDHealthKitNotificationResponseFlags, NLAWDHealthKitWeeklySummaryDetail, NSMutableArray;
...
@interface NLAWDHealthKitNotificationEvent : PBCodable <NSCopying>
{
    ...
    NLAWDHealthKitAchievement *_achievement;
    NLAWDHealthKitActivityCache *_activityCache;
    int _alertType;
    NLAWDHealthKitConcurrentCalendarItem *_calendarItem;
    NLAWDHealthKitExperimentalCondition *_experimentalCondition;
    NLAWDHealthKitNotificationResponseFlags *_responseFlags;
    int _testAction;
    NSMutableArray *_views;
    NLAWDHealthKitWeeklySummaryDetail *_weeklySummaryDetail;
    _Bool _dndEnabled;
...
+ (Class)viewsType;
- (void).cxx_destruct;
@property(retain, nonatomic) NLAWDHealthKitNotificationResponseFlags *responseFlags; // @synthesize responseFlags=_responseFlags;
@property(retain, nonatomic) NLAWDHealthKitWeeklySummaryDetail *weeklySummaryDetail; // @synthesize weeklySummaryDetail=_weeklySummaryDetail;
@property(retain, nonatomic) NLAWDHealthKitAchievement *achievement; // @synthesize achievement=_achievement;
@property(retain, nonatomic) NLAWDHealthKitActivityCache *activityCache; // @synthesize activityCache=_activityCache;
@property(retain, nonatomic) NSMutableArray *views; // @synthesize views=_views;
@property(retain, nonatomic) NLAWDHealthKitConcurrentCalendarItem *calendarItem; // @synthesize calendarItem=_calendarItem;
