...
- (void)remoteGeneratePosterFrameForVideoAtURL:(NSURL *)arg1 maximumPixelCount:(int)arg2 destinationURL:(NSURL *)arg3 reply:(void (^)(NSURL *, NSError *))arg4;
- (void)remoteResizeImageAtURL:(NSURL *)arg1 destinationURL:(NSURL *)arg2 options:(NSDictionary *)arg3 reply:(void (^)(NSURL *, NSError *))arg4;
- (void)remoteTerminateWithReply:(void (^)(int))arg1;
- (void)remoteStatusWithReply:(void (^)(int))arg1;
@end
