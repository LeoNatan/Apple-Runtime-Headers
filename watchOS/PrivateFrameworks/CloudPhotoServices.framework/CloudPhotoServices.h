...
+ (void)_createVideoResourcesFromInputURL:(id)arg1 withItemScopedIdentifier:(id)arg2 videoAdjustments:(id)arg3 resourceType:(unsigned int)arg4 forIris:(_Bool)arg5 destinationDirectory:(id)arg6 outputResources:(id)arg7;
+ (unsigned long)videoCodecFourCharCodeNumberForAVAsset:(id)arg1;
+ (_Bool)_shouldGenerateLargeVideoDerivativeForAVAsset:(id)arg1;
+ (_Bool)shouldGenerateVideoDerivativeForAVAsset:(id)arg1 forResourceType:(unsigned int)arg2 adjusted:(_Bool)arg3;
...
+ (id)_createCPLResourceFromURL:(id)arg1 withResourceType:(unsigned int)arg2 uniformTypeIdentifier:(id)arg3 itemScopedIdentifier:(id)arg4;
...
+ (id)_filenameForResourceWithItemScopedIdentifier:(id)arg1 resourceType:(unsigned int)arg2 extension:(id)arg3;
...
+ (void)generatePosterFrameForVideoAtURL:(id)arg1 maximumPixelCount:(int)arg2 destinationURL:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
+ (void)resizeImageAtURL:(id)arg1 destinationURL:(id)arg2 maximumPixelCount:(int)arg3 bakeInOrientation:(_Bool)arg4 colorOutput:(int)arg5 completionHandler:(CDUnknownBlockType)arg6;
+ (int)status;
