...
+ (void)_createVideoResourcesFromInputURL:(id)arg1 withItemIdentifier:(id)arg2 videoAdjustments:(id)arg3 resourceType:(unsigned int)arg4 forIris:(_Bool)arg5 destinationDirectory:(id)arg6 outputResources:(id)arg7;
