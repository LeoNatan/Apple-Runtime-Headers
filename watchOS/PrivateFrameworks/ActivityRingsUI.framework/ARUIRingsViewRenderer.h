...
@interface ARUIRingsViewRenderer : NSObject <ARUIRingsRendering>
{
    ...
    unsigned int _maximumRingCount;
}
...
@property(readonly, nonatomic) unsigned int maximumRingCount; // @synthesize maximumRingCount=_maximumRingCount;
- (void).cxx_destruct;
- (void)prewarmRendererForCelebrationOfType:(unsigned int)arg1;
...
- (void)dealloc;
- (id)initWithMaximumRingCount:(unsigned int)arg1 commandQueue:(id)arg2;
- (id)initWithMaximumRingCount:(unsigned int)arg1;
