...
- (unsigned int)waveFragmentOffsetForWaveAtIndex:(unsigned int)arg1;
- (unsigned int)wavePointsOffsetForWaveAtIndex:(unsigned int)arg1;
- (void)_setupWavePoints;
- (unsigned int)waveComputeUniformsOffsetForType:(unsigned int)arg1;
