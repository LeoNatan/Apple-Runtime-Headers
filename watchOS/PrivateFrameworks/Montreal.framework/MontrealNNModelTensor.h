...
+ (id)createOutputs:(CDStruct_5cdcd9df *)arg1 outputChunks:(id)arg2 nodeName:(id)arg3;
+ (id)createInputs:(CDStruct_5cdcd9df *)arg1 inputChunks:(id)arg2 nodeName:(id)arg3;
- (void).cxx_destruct;
