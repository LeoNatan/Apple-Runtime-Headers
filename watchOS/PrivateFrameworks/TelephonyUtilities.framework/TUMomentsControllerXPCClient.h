...
- (void)startRequestWithMediaType:(int)arg1 forStreamToken:(int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)unregisterStreamToken:(int)arg1 completion:(CDUnknownBlockType)arg2;
- (void)registerStreamToken:(int)arg1 remoteIDSDestination:(id)arg2 remoteMomentsAvailable:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
- (void)dealloc;
- (id)init;
