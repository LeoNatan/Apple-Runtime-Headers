...
- (oneway void)didUpdateCapabilities:(id)arg1 forVideoStreamToken:(int)arg2;
...
- (void)startRequestWithMediaType:(int)arg1 forStreamToken:(int)arg2 requesteeID:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)unregisterStreamToken:(int)arg1 completion:(CDUnknownBlockType)arg2;
- (void)registerStreamToken:(int)arg1 requesterID:(id)arg2 remoteIDSDestinations:(id)arg3 remoteMomentsAvailable:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
- (void)dealloc;
- (id)init;
