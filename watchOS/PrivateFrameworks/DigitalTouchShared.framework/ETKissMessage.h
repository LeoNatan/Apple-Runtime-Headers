...
- (void)_displayKissAtPoint:(struct CGPoint)arg1 angle:(float)arg2 leavesMark:(_Bool)arg3 inScene:(id)arg4;
- (void)_setKissLeavesMark:(id)arg1;
- (void)displayInScene:(id)arg1;
- (_Bool)_hasKissesThatLeaveMark;
- (void)addKissAtNormalizedPoint:(struct CGPoint)arg1 angle:(float)arg2 time:(double)arg3 toScene:(id)arg4;
- (void)_initAtlas;
