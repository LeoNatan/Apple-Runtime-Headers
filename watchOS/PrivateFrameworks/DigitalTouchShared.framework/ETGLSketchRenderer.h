...
@property(nonatomic) float cometScaleFactor; // @synthesize cometScaleFactor=_cometScaleFactor;
...
@property(nonatomic) float lineWidthScaleFactor; // @synthesize lineWidthScaleFactor=_lineWidthScaleFactor;
