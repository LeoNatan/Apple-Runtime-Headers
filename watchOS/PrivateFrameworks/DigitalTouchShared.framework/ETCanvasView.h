...
- (void)_hideHeartbeat;
- (void)_showHeartbeatAtNormalizedPoint:(struct CGPoint)arg1 rotation:(float)arg2;
...
- (void)handlePanAtX:(float)arg1 Y:(float)arg2 color:(id)arg3 time:(double)arg4 state:(int)arg5 isRemote:(_Bool)arg6;
