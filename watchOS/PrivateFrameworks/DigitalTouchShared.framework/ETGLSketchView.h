...
@interface ETGLSketchView : UIView <ETGLSketchRendererDelegate>
{
    ...
    vector_8b7b626a _vertexBatchCount;
    vector_8b7b626a _secondaryVertexBatchCount;
}
...
@property(nonatomic) vector_8b7b626a secondaryVertexBatchCount; // @synthesize secondaryVertexBatchCount=_secondaryVertexBatchCount;
@property(nonatomic) vector_8b7b626a vertexBatchCount; // @synthesize vertexBatchCount=_vertexBatchCount;
...
-     // Error parsing type: v24@0:4^8L12^16B20, name: updateRendererWithSecondaryPoints:count:controlPoint:flush:
-     // Error parsing type: v24@0:4^8L12^16B20, name: updateRendererWithPoints:count:controlPoint:flush:
