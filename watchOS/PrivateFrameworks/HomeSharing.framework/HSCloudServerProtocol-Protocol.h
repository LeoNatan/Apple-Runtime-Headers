...
- (void)setCollectionProperties:(NSDictionary *)arg1 forCollectionWithPersistentID:(long long)arg2 groupingType:(int)arg3 completion:(void (^)(NSError *))arg4;
...
- (void)setCloudAddToPlaylistBehavior:(int)arg1 completion:(void (^)(NSError *))arg2;
