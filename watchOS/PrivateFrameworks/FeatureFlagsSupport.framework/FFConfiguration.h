...
- (void)unsetFeature:(id)arg1 domain:(id)arg2 level:(int)arg3;
- (void)disableFeature:(id)arg1 domain:(id)arg2 level:(int)arg3;
- (void)enableFeature:(id)arg1 domain:(id)arg2 level:(int)arg3;
- (id)defaultStateForFeature:(id)arg1 domain:(id)arg2;
- (id)stateForFeature:(id)arg1 domain:(id)arg2 level:(int)arg3;
...
- (id)effectiveStateForFeature:(id)arg1 domain:(id)arg2 level:(int)arg3;
- (void)loadAllData;
