...
- (_Bool)getNSError:(id *)arg1 code:(int)arg2 description:(id)arg3 reason:(id)arg4;
- (_Bool)getNSError:(id *)arg1 code:(int)arg2 description:(id)arg3 hResult:(long)arg4;
- (int)startICEConnectionCheck:(id)arg1 isCaller:(_Bool)arg2 withCallID:(unsigned long)arg3;
...
- (_Bool)acceptCallID:(unsigned long)arg1 error:(id *)arg2;
