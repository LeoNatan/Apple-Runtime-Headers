...
- (id)dictionaryForCallID:(unsigned long)arg1 isIncomingDictonary:(_Bool)arg2;
- (id)dictionaryForParticipantID:(id)arg1 isIncomingDictonary:(_Bool)arg2;
- (id)dictionaryForNonce:(int)arg1 participantID:(id)arg2 isIncomingDictonary:(_Bool)arg3;
