...
#import "NCEBulletinsLiaisonTriggerDelegate.h"

@class CSLSBacklightAssertion, NCEFireVector, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSObject<OS_os_log>, NSString;
