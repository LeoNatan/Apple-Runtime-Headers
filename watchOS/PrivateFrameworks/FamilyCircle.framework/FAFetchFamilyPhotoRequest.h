...
@property int backgroundType; // @synthesize backgroundType=_backgroundType;
...
- (id)init;
- (id)initWithFamilyMemberHashedDSID:(id)arg1 size:(unsigned int)arg2 localFallback:(_Bool)arg3 connectionProvider:(id)arg4;
- (id)initWithFamilyMemberHashedDSID:(id)arg1 size:(unsigned int)arg2 localFallback:(_Bool)arg3;
- (id)initWithFamilyMemberDSID:(id)arg1 size:(unsigned int)arg2 localFallback:(_Bool)arg3 connectionProvider:(id)arg4;
- (id)initWithFamilyMemberDSID:(id)arg1 size:(unsigned int)arg2 localFallback:(_Bool)arg3;
