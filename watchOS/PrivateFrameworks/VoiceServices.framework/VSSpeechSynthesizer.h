...
+ (void)getVoiceInfoForLanguageCode:(id)arg1 footprint:(long)arg2 gender:(long)arg3 custom:(_Bool)arg4 reply:(CDUnknownBlockType)arg5;
...
- (void)connection:(id)arg1 speechRequest:(id)arg2 willSpeakMark:(long)arg3 inRange:(struct _NSRange)arg4;
