...
+ (_Bool)_isCommerceUIURL:(id)arg1 actionType:(int)arg2 URLType:(int)arg3 bag:(id)arg4;
+ (id)_createRequestFromDialogDictionary:(id)arg1 kind:(int)arg2 account:(id)arg3 bag:(id)arg4;
+ (id)_createRequestButtonsFromDialogDictionary:(id)arg1 kind:(int)arg2 account:(id)arg3 bag:(id)arg4;
+ (id)_createActionFromButtonDictionary:(id)arg1 kind:(int)arg2 title:(id)arg3 account:(id)arg4 bag:(id)arg5;
+ (int)_actionTypeFromButtonDictionary:(id)arg1;
+ (id)_URLForCommerceUIFromURL:(id)arg1 account:(id)arg2;
+ (int)dialogKindFromPayload:(id)arg1;
- (void).cxx_destruct;
...
- (id)initWithDialogDictionary:(id)arg1 kind:(int)arg2 account:(id)arg3 clientInfo:(id)arg4 bag:(id)arg5;
