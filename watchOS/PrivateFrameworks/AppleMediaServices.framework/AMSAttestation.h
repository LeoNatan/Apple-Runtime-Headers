...
+ (id)_attestationPListWithStyle:(unsigned int)arg1 primaryAttestation:(id)arg2 extendedAttestation:(id)arg3 error:(id *)arg4;
+ (_Bool)clearAttestationWithAccount:(id)arg1 options:(id)arg2 error:(id *)arg3;
+ (id)attestationHTTPBodyDataWithStyle:(unsigned int)arg1 regenerateKeys:(_Bool)arg2 error:(id *)arg3;
