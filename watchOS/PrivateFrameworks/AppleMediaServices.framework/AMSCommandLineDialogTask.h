...
- (int)_gatherButtonInput;
- (id)_createTextfieldWithTextfield:(id)arg1 width:(int)arg2;
- (id)_createText:(id)arg1 width:(int)arg2 centered:(_Bool)arg3 omitLeftPipe:(_Bool)arg4;
- (id)_createLinesFromText:(id)arg1 width:(int)arg2;
- (id)_createHorizontolLineWithWidth:(int)arg1;
- (id)present;
