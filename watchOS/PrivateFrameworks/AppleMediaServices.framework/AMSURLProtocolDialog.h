...
@property(readonly, nonatomic) int dialogOptions; // @synthesize dialogOptions=_dialogOptions;
...
- (id)runDialog;
- (id)initWithDialogDictionary:(id)arg1 dialogOptions:(int)arg2 account:(id)arg3 bagContract:(id)arg4;
