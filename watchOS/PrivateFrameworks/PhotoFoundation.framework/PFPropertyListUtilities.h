...
+ (id)encodedDataWithPropertyListObject:(id)arg1 format:(unsigned int)arg2 error:(id *)arg3;
...
+ (id)propertyListObjectFromEncodedData:(id)arg1 expectedClass:(Class)arg2 options:(unsigned int)arg3;
+ (id)propertyListObjectFromEncodedData:(id)arg1 expectedClass:(Class)arg2 options:(unsigned int)arg3 error:(id *)arg4;
