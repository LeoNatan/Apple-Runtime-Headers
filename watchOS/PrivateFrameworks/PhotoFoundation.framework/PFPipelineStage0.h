...
- (void).cxx_destruct;
- (void)runQueuedJobs;
- (void)addJobs:(unsigned int)arg1 withQOS:(unsigned int)arg2 generator:(CDUnknownBlockType)arg3 pipeline:(id)arg4;
- (void)generateNextJob:(unsigned int)arg1;
- (unsigned long long)indexOfMaxQOSAvailableGenerator;
- (void)setConcurrentJobLimit:(unsigned int)arg1;
- (id)description;
- (id)init;
