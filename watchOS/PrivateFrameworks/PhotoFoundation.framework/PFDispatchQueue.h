...
+ (void)dispatchApply:(unsigned long)arg1 withConcurrencyLimit:(unsigned long)arg2 canceler:(id)arg3 ofBlock:(CDUnknownBlockType)arg4;
+ (void)dispatchApply:(unsigned long)arg1 ofBlock:(CDUnknownBlockType)arg2;
