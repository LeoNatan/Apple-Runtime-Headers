...
- (void)_setPayload:(id)arg1 inBucket:(unsigned int)arg2;
- (unsigned int)capacity;
- (unsigned int)countByVerifyingWeakObjects;
...
- (unsigned int)_addObject:(id)arg1;
...
- (_Bool)_shouldShrink;
- (_Bool)_shouldGrow;
- (unsigned int)_bucketForObject:(id)arg1 foundInHash:(_Bool *)arg2;
- (void)_rehashWithNewCapacity:(unsigned int)arg1;
