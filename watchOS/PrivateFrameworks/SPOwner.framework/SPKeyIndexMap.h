...
{
    CDStruct_e2e1023a *_mapHandle;
    unsigned char _sequence;
    NSUUID *_beaconIdentifier;
}

- (void).cxx_destruct;
@property(readonly) CDStruct_e2e1023a *mapHandle; // @synthesize mapHandle=_mapHandle;
...
- (id)headerString;
- (id)initWithBeaconIdentifier:(id)arg1 keySequence:(unsigned char)arg2 mapHandle:(CDStruct_e2e1023a *)arg3;
- (void)dealloc;
- (id)init;
