...
- (id)fetchMessageZoneChangesCKOperationUsingToken:(id)arg1 zoneID:(id)arg2 resultsLimit:(unsigned int)arg3 operationGroupName:(id)arg4;
- (id)_operationGroupWithName:(id)arg1;
- (id)_messageFetchRecordZoneChangesOptionsDictionaryUsingToken:(id)arg1 zoneID:(id)arg2 resultsLimit:(unsigned int)arg3;
