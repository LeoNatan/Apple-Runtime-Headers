...
- (void)_fetchTransfersFromCloudKit:(id)arg1 indexOfTransfers:(unsigned long)arg2 numberOfBatchesToFetch:(unsigned long)arg3 withCompletion:(CDUnknownBlockType)arg4;
- (_Bool)_shouldFetchNextBatch:(unsigned long)arg1 totalTransfers:(id)arg2;
- (unsigned long)_indexOfNextBatch:(id)arg1 totalTransfers:(id)arg2 indexOfTransfers:(unsigned long)arg3;
- (id)_getIndexSetForBatch:(id)arg1 indexOfTransfers:(unsigned long)arg2;
...
- (_Bool)shouldDownloadAssetsOfSize:(unsigned long)arg1 refreshCachedValue:(_Bool)arg2;
- (_Bool)canWriteFileOfEstimatedSize:(unsigned long)arg1 refreshCachedValue:(_Bool)arg2;
- (id)_cacheDeleteRequestCacheableSpaceGuidanceWithID:(id)arg1 diskVolume:(id)arg2 urgency:(int)arg3 requestedSize:(unsigned long)arg4;
