...
@interface IMDServiceSession : NSObject <IMSystemMonitorListener, IMConnectionMonitorDelegate, IMServiceSessionProtocol>
{
    ...
    unsigned int _messagesProcessedComingBackFromStorage;
...
- (void)_didReceiveMessageSavedForMessageID:(id)arg1 ofType:(long long)arg2 forChat:(id)arg3 fromHandle:(id)arg4 fromMe:(_Bool)arg5 date:(id)arg6 attempts:(int)arg7 useMessageSuppression:(_Bool)arg8 account:(id)arg9 completionBlock:(CDUnknownBlockType)arg10;
...
- (void)_didReceiveMessagePlayedForMessageID:(id)arg1 date:(id)arg2 attempts:(int)arg3 useMessageSuppression:(_Bool)arg4 completionBlock:(CDUnknownBlockType)arg5;
...
- (void)_didReceiveMessageReadForMessageID:(id)arg1 date:(id)arg2 attempts:(int)arg3 useMessageSuppression:(_Bool)arg4 completionBlock:(CDUnknownBlockType)arg5;
...
- (_Bool)_didReceiveMessageDeliveryReceiptForMessageID:(id)arg1 attempts:(int)arg2 date:(id)arg3 account:(id)arg4;
