...
- (id)copyMessagesThatNeedToBeDeletedInCloudKitWithLimit:(unsigned int)arg1;
- (void)markAllMessagesAsNeedingCloudKitSync;
- (id)messagesThatNeedSyncWithCloudKitWithLimit:(int)arg1;
- (id)_messagesThatNeedSyncWithCloudKitWithLimit:(int)arg1 attemptCount:(unsigned int)arg2;
...
- (void)_deleteMessagesWithGUIDs:(id)arg1 chatIdentifiers:(id)arg2 style:(unsigned char)arg3 onServices:(id)arg4 batchNumber:(unsigned int)arg5 completion:(CDUnknownBlockType)arg6;
...
- (id)messagesWithHandlesBeforeAndAfterGUID:(id)arg1 handles:(id)arg2 onServices:(id)arg3 numberOfMessagesBefore:(unsigned int)arg4 numberOfMessagesAfter:(unsigned int)arg5;
...
- (id)_messagesWithHandlesBeforeAndAfterGUID:(id)arg1 handles:(id)arg2 onServices:(id)arg3 numberOfMessagesBefore:(unsigned int)arg4 numberOfMessagesAfter:(unsigned int)arg5;
- (id)_messagesWithRoomNames:(id)arg1 onServices:(id)arg2 messageGUID:(id)arg3 limit:(unsigned int)arg4 onlyMessages:(_Bool)arg5;
- (id)_messagesWithHandles:(id)arg1 onServices:(id)arg2 messageGUID:(id)arg3 limit:(unsigned int)arg4 onlyMessages:(_Bool)arg5;
