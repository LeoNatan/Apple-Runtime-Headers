...
@interface IMDChat : NSObject <INSpeakable>
{
    ...
    unsigned int _numMessagesSent;
}

+ (id)_recordType;
@property _Bool meCardUpdated; // @synthesize meCardUpdated=_meCardUpdated;
@property unsigned int numMessagesSent; // @synthesize numMessagesSent=_numMessagesSent;
...
@property int srCloudKitSyncState; // @synthesize srCloudKitSyncState=_srCloudKitSyncState;
...
- (void)updateSRCloudKitSyncState:(int)arg1;
- (void)updateCloudKitSyncState:(int)arg1;
...
- (void)updateEngroupCreationDate:(int)arg1;
...
@property int cloudKitSyncState;
