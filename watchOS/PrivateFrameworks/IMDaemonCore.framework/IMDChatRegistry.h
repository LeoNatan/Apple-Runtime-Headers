...
- (void)_updateSyncStatisticsForMessage:(id)arg1 incrementTotalCount:(unsigned int)arg2;
- (void)_updateSyncStatisticsForChat:(id)arg1 incrementTotalCount:(unsigned int)arg2;
- (_Bool)_shouldUpdateSyncStatsForMessage:(id)arg1 originalSyncState:(long long)arg2;
- (_Bool)_shouldUpdateSyncStatsForChat:(id)arg1 originalSyncState:(int)arg2;
- (id)_statsCollector;
...
- (id)_blackholedChatInfoForNumberOfChats:(int)arg1;
