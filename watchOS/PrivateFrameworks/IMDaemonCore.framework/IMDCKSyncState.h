...
- (void)setSyncControllerSyncState:(unsigned int)arg1 withRecordType:(int)arg2;
- (void)setStartingInitialSyncWithRecordType:(int)arg1;
- (void)setStartingPeriodicSyncWithRecordType:(int)arg1;
- (void)_setStartingSync;
- (void)clearLocalCloudKitSyncState;
- (void)setSyncingFinished;
@property(readonly, copy) NSString *description;
- (id)syncReportDictionaryForAttempt:(unsigned int)arg1 withSuccess:(_Bool)arg2;
...
@property(nonatomic) int accountStatus; // @dynamic accountStatus;
@property(nonatomic) int syncControllerRecordType; // @dynamic syncControllerRecordType;
@property(nonatomic) int syncControllerSyncType; // @dynamic syncControllerSyncType;
@property(nonatomic) unsigned int syncControllerSyncState; // @dynamic syncControllerSyncState;
