...
@property(nonatomic) int carrierBundlingErrorCode; // @synthesize carrierBundlingErrorCode=_carrierBundlingErrorCode;
@property(nonatomic) int carrierBundlingStatus; // @synthesize carrierBundlingStatus=_carrierBundlingStatus;
