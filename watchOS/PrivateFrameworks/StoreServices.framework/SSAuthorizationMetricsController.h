...
+ (id)_dialogEventForBiometricAuthorizationWithDialogId:(id)arg1 buyParams:(id)arg2 matchState:(int)arg3 topicName:(id)arg4 userAgent:(id)arg5;
+ (id)userActionDictionaryForUserAction:(int)arg1 didBiometricsLockout:(_Bool)arg2;
+ (id)userActionDictionaryForBiometricMatchState:(unsigned int)arg1 didBiometricsLockout:(_Bool)arg2;
