...
- (void)x509CertChainDataForAccountIdentifier:(id)arg1 purpose:(int)arg2 regenerateCerts:(_Bool)arg3 completionBlock:(CDUnknownBlockType)arg4;
...
- (void)getPublicKeyDataForAccountIdentifier:(id)arg1 purpose:(int)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (void)createX509CertChainDataForAccountIdentifier:(id)arg1 purpose:(int)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (void)createAttestationDataForAccountIdentifier:(id)arg1 purpose:(int)arg2 completionBlock:(CDUnknownBlockType)arg3;
