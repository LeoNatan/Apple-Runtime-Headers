...
@interface SSURLSessionManager : NSObject <NSCacheDelegate, NSURLSessionDataDelegate>
{
    ...
    unsigned int _memoryPressureCachedMaxSize;
...
+ (id)bagValueForKey:(id)arg1 delegate:(id)arg2 type:(unsigned int)arg3;
...
+ (unsigned int)_messageSizeFromTask:(id)arg1 isRequest:(_Bool)arg2 delegate:(id)arg3;
