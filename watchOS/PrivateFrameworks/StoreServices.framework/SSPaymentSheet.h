...
- (void).cxx_destruct;
@property int titleType; // @synthesize titleType=_titleType;
...
@property int salableIconType; // @synthesize salableIconType=_salableIconType;
...
@property int payeeType; // @synthesize payeeType=_payeeType;
...
@property int confirmationTitleType; // @synthesize confirmationTitleType=_confirmationTitleType;
...
- (int)_salableIconTypeForString:(id)arg1;
- (id)_replaceMarkupForMutableAttributedString:(id)arg1 markupType:(int)arg2;
- (id)_replaceBreakingSpaceMarkupForMutableAttributedString:(id)arg1;
- (int)_payeeTypeInferredFromEnumeratedTitle;
- (int)_payeeTypeForRequestorValue:(id)arg1;
- (void)_parseResponse:(id)arg1;
- (void)_lock;
- (int)_inferSalableIconTypeWithBuyParams:(id)arg1;
...
- (int)_confirmationTitleTypeForStringValue:(id)arg1;
