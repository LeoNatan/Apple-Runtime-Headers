...
+ (void)_possiblyAddToArray:(id)arg1 ifTransport:(int)arg2 existsInTransports:(int)arg3;
...
- (id)queryStartDateWithSyncType:(id)arg1 streamName:(id)arg2 lastSyncDate:(id)arg3 lastDaySyncCount:(unsigned int)arg4 previousHighWaterMark:(id)arg5;
- (id)queryStartDateWithSyncType:(id)arg1 streamName:(id)arg2 lastSyncDate:(id)arg3 lastDaySyncCount:(unsigned int)arg4;
- (_Bool)highPriorityForSyncUpWithSyncType:(id)arg1 lastSyncDate:(id)arg2;
- (_Bool)highPriorityForSyncDownWithSyncType:(id)arg1;
- (_Bool)canPerformSyncOperationWithSyncType:(id)arg1 lastSyncDate:(id)arg2 lastDaySyncCount:(unsigned int)arg3;
- (_Bool)canDeferSyncOperationWithSyncType:(id)arg1;
- (id)streamNamesToSync;
- (id)enabledFeaturesForSyncType:(id)arg1;
- (unsigned int)singleDevicePeriodicSyncCadenceInDaysMaximumValue;
- (unsigned int)singleDevicePeriodicSyncCadenceInDaysMinimumValue;
- (unsigned int)periodicSyncCadenceInMinutesMaximumValue;
- (unsigned int)periodicSyncCadenceInMinutesMinimumValue;
- (unsigned int)minimumTimeBetweenSyncsInSecondsMaximumValue;
- (unsigned int)minimumTimeBetweenSyncsInSecondsMinimumValue;
- (unsigned int)maximumSyncsPerDayMaximumValue;
- (unsigned int)maximumSyncsPerDayMinimumValue;
- (_Bool)canPushTriggerSync;
- (_Bool)_anyFeaturePropertyValueWithKey:(id)arg1 getterBlock:(CDUnknownBlockType)arg2;
- (unsigned int)_maximumPropertyValueWithKey:(id)arg1 policies:(id)arg2 skipZeroValues:(_Bool)arg3;
- (unsigned int)_minimumPropertyValueWithKey:(id)arg1 policies:(id)arg2 skipZeroValues:(_Bool)arg3;
- (id)initWithProperties:(id)arg1 transports:(int)arg2 sourceDevices:(id)arg3 destinationDevices:(id)arg4 isSingleDevice:(_Bool)arg5 isOnPower:(_Bool)arg6 transportPolicies:(id)arg7 featurePolicies:(id)arg8;
- (id)initWithTransports:(int)arg1 features:(id)arg2 sourceDevices:(id)arg3 destinationDevices:(id)arg4 isSingleDevice:(_Bool)arg5 isOnPower:(_Bool)arg6;
- (id)init;
