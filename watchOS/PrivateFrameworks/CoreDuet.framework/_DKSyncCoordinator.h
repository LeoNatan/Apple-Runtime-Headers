...
- (void)_databaseDidHaveInsertsAndDeletesWithInsertsAndDeletesCount:(unsigned int)arg1;
...
- (void)_sendNotificationsForAppliedRemoteDeletionChangeSet:(id)arg1 deleted:(unsigned int)arg2;
...
- (void)_setIfHigherSequenceNumber:(unsigned int)arg1 ofLastDeletionChangeSetProcessedFromDevice:(id)arg2;
- (unsigned int)_sequenceNumberOfLastDeletionChangeSetProcessedFromDevice:(id)arg1;
- (void)_setLastChangeCount:(unsigned int)arg1;
- (unsigned int)_lastChangeCount;
