...
- (void)setLastSuccessfulActivityDate:(id)arg1 onTransport:(int)arg2 forPeer:(id)arg3;
- (id)lastSuccessfulActivityDateOnTransport:(int)arg1 forPeer:(id)arg2;
- (void)setLastSeenDate:(id)arg1 onPeer:(id)arg2;
- (void)removeActiveTransports:(int)arg1 fromPeer:(id)arg2;
- (void)addActiveTransports:(int)arg1 toPeer:(id)arg2;
