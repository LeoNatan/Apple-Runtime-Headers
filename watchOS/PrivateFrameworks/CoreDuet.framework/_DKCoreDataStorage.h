...
+ (unsigned int)anonymizeObjectStringsInContext:(id)arg1 entityName:(id)arg2 predicate:(id)arg3 sortDescriptors:(id)arg4 batchFetchLimit:(unsigned int)arg5 totalFetchLimit:(unsigned int)arg6 includeSubentities:(_Bool)arg7 salt:(id)arg8;
...
+ (unsigned int)updateObjectsInContext:(id)arg1 entityName:(id)arg2 predicate:(id)arg3 sortDescriptors:(id)arg4 batchFetchLimit:(unsigned int)arg5 totalFetchLimit:(unsigned int)arg6 includeSubentities:(_Bool)arg7 updateBlock:(CDUnknownBlockType)arg8;
+ (_Bool)forceCopyItemAtPath:(id)arg1 toPath:(id)arg2 error:(id *)arg3;
+ (unsigned int)deleteOrphanedEntitiesInContext:(id)arg1;
+ (unsigned int)deleteObjectsIfNeededToLimitTotal:(unsigned int)arg1 context:(id)arg2 entityName:(id)arg3 predicate:(id)arg4 sortDescriptors:(id)arg5 fetchLimit:(unsigned int)arg6 includeSubentities:(_Bool)arg7 includePendingChanges:(_Bool)arg8;
+ (unsigned int)countObjectsInContext:(id)arg1 entityName:(id)arg2 predicate:(id)arg3 includeSubentities:(_Bool)arg4 includePendingChanges:(_Bool)arg5;
+ (unsigned int)deleteObjectsInContext:(id)arg1 entityName:(id)arg2 predicate:(id)arg3 sortDescriptors:(id)arg4 fetchOffset:(unsigned int)arg5 fetchLimit:(unsigned int)arg6 includeSubentities:(_Bool)arg7 includePendingChanges:(_Bool)arg8;
+ (unsigned int)deleteObjectsInContext:(id)arg1 entityName:(id)arg2 predicate:(id)arg3 sortDescriptors:(id)arg4 fetchLimit:(unsigned int)arg5 includeSubentities:(_Bool)arg6 includePendingChanges:(_Bool)arg7;
- (void).cxx_destruct;
...
- (int)modelVersionForStoreAtURL:(id)arg1 error:(id *)arg2;
- (id)managedObjectModelForVersion:(unsigned int)arg1;
- (id)managedObjectModelURLForVersion:(unsigned int)arg1;
- (unsigned int)managedObjectModelVersionCompatibleWithPersistentStoreAtURL:(id)arg1 error:(id *)arg2;
