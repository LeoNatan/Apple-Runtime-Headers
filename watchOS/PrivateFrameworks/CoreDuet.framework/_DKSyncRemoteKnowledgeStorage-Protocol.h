...
- (void)fetchEventsFromPeer:(_DKSyncPeer *)arg1 windows:(NSArray *)arg2 streamNames:(NSArray *)arg3 limit:(unsigned int)arg4 fetchOrder:(int)arg5 highPriority:(_Bool)arg6 completion:(void (^)(NSArray *, NSArray *, NSError *))arg7;
