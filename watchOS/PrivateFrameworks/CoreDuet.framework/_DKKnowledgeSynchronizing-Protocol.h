...
- (void)synchronizeWithUrgency:(unsigned int)arg1 client:(NSString *)arg2 responseQueue:(NSObject<OS_dispatch_queue> *)arg3 completion:(void (^)(NSError *))arg4;
- (_Bool)synchronizeWithUrgency:(unsigned int)arg1 client:(NSString *)arg2 error:(id *)arg3;
