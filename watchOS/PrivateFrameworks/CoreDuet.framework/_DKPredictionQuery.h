...
@property(nonatomic) unsigned int partitionType; // @synthesize partitionType=_partitionType;
...
- (_Bool)shouldIncludeEventWithStartDate:(id)arg1 eventSlot:(int)arg2 withPredictionStartDate:(id)arg3 withPartitionType:(unsigned int)arg4 andCalendar:(id)arg5;
