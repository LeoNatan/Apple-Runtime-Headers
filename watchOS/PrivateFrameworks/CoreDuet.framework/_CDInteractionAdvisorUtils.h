...
+ (_Bool)adjustRanker:(id)arg1 forModel:(unsigned int)arg2;
...
+ (id)adviceBasedOnInteractions:(id)arg1 forContacts:(id)arg2 andRanker:(id)arg3 ignoringContacts:(id)arg4 withLimit:(unsigned int)arg5 aggregateByIdentifier:(_Bool)arg6 requireOneOutgoingInteraction:(_Bool)arg7;
