...
- (void)deleteInteractionsWithBundleId:(NSString *)arg1 domainIdentifier:(NSString *)arg2 reply:(void (^)(unsigned int, NSError *))arg3;
- (void)deleteInteractionsWithBundleId:(NSString *)arg1 account:(NSString *)arg2 reply:(void (^)(unsigned int, NSError *))arg3;
- (void)deleteInteractionsWithBundleId:(NSString *)arg1 reply:(void (^)(unsigned int, NSError *))arg2;
- (void)deleteInteractionsMatchingPredicate:(NSPredicate *)arg1 sortDescriptors:(NSArray *)arg2 limit:(unsigned int)arg3 reply:(void (^)(unsigned int, NSError *))arg4;
- (void)countContactsUsingPredicate:(NSPredicate *)arg1 reply:(void (^)(unsigned int, NSError *))arg2;
- (void)countInteractionsUsingPredicate:(NSPredicate *)arg1 reply:(void (^)(unsigned int, NSError *))arg2;
- (void)queryContactsUsingPredicate:(NSPredicate *)arg1 sortDescriptors:(NSArray *)arg2 limit:(unsigned int)arg3 reply:(void (^)(NSArray *, NSError *))arg4;
- (void)queryInteractionsUsingPredicate:(NSPredicate *)arg1 sortDescriptors:(NSArray *)arg2 limit:(unsigned int)arg3 reply:(void (^)(NSArray *, NSError *))arg4;
