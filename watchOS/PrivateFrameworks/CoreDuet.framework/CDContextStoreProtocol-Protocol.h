...
- (void)integerValueForKey:(NSString *)arg1 reply:(void (^)(int))arg2;
- (void)stringValueForKey:(NSString *)arg1 reply:(void (^)(NSString *))arg2;
- (void)setIntegerValue:(int)arg1 forKey:(NSString *)arg2 withMetaData:(NSDictionary *)arg3 reply:(void (^)(_Bool))arg4;
