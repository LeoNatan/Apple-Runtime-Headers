...
@property unsigned int constrainMaxRecipientCount; // @synthesize constrainMaxRecipientCount=_constrainMaxRecipientCount;
...
@property unsigned int maxNumberOfPeopleSuggested; // @synthesize maxNumberOfPeopleSuggested=_maxNumberOfPeopleSuggested;
- (id)description;
