...
@interface _DKSync3FeaturePolicy : NSObject <_DKSync3PolicyCommonMethods>
{
    ...
    NSString *_transport;
    unsigned int _periodicSyncCadenceInMinutes;
    unsigned int _oldestEventToSyncInDays;
...
@property(nonatomic) unsigned int oldestEventToSyncInDays; // @synthesize oldestEventToSyncInDays=_oldestEventToSyncInDays;
@property(nonatomic) unsigned int periodicSyncCadenceInMinutes; // @synthesize periodicSyncCadenceInMinutes=_periodicSyncCadenceInMinutes;
