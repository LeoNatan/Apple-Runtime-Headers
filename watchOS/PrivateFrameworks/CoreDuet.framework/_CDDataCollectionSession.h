...
- (void).cxx_destruct;
@property(readonly, nonatomic) unsigned int batchNumber; // @synthesize batchNumber=_batchNumber;
...
- (id)initWithIdentifier:(id)arg1 salt:(id)arg2 latestStartDate:(id)arg3 lastCollectionDate:(id)arg4 batchNumber:(unsigned int)arg5;
