...
@property unsigned int incomingRecipientCount; // @synthesize incomingRecipientCount=_incomingRecipientCount;
@property unsigned int incomingSenderCount; // @synthesize incomingSenderCount=_incomingSenderCount;
@property unsigned int outgoingRecipientCount; // @synthesize outgoingRecipientCount=_outgoingRecipientCount;
