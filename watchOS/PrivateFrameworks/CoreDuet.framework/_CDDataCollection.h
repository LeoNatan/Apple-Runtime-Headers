...
@interface _CDDataCollection : NSObject
{
    ...
    unsigned int _daysPerBatch;
    unsigned int _maxBatches;
...
@property(readonly, nonatomic) unsigned int maxBatches; // @synthesize maxBatches=_maxBatches;
@property(readonly, nonatomic) unsigned int daysPerBatch; // @synthesize daysPerBatch=_daysPerBatch;
...
- (void)_execute;
- (void)execute;
- (id)initWithStorage:(id)arg1 activity:(id)arg2 sessionPath:(id)arg3 dataDirectory:(id)arg4 collectionDate:(id)arg5 samplingRate:(double)arg6 daysPerBatch:(unsigned int)arg7 eventStreams:(id)arg8 maxBatches:(unsigned int)arg9;
