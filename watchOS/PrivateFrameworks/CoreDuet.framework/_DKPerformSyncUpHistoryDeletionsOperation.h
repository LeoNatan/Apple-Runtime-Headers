...
+ (void)_updateEventStatsWithTotal:(unsigned int)arg1 transportType:(int)arg2;
+ (void)_updateEventStatsWithPreviousSyncDate:(id)arg1 transportType:(int)arg2;
- (void).cxx_destruct;
- (void)endPerfMetrics;
- (void)startPerfMetrics;
- (void)endOperation;
- (void)handleUpdateStorageWithStartDate:(id)arg1 endDate:(id)arg2 deletedEventIDsCount:(unsigned int)arg3 orError:(id)arg4;
