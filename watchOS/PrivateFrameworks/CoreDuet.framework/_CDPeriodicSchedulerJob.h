...
+ (id)jobWithPeriod:(int)arg1 schedulerJobName:(id)arg2 handler:(CDUnknownBlockType)arg3;
- (void).cxx_destruct;
...
@property(readonly) int period; // @synthesize period=_period;
- (void)setExecutionCriteria:(id)arg1;
- (id)initWithPeriod:(int)arg1 interval:(double)arg2 schedulerJobName:(id)arg3 queue:(id)arg4 asynchronousHandler:(_Bool)arg5 handler:(CDUnknownBlockType)arg6;
- (id)init;
