...
+ (id)completedWindowsFromWindows:(id)arg1 firstEvent:(id)arg2 lastEvent:(id)arg3 fetchOrder:(int)arg4 fillOrder:(unsigned int)arg5 hitLimit:(_Bool)arg6;
+ (id)completedWindowsWithSortedEvents:(id)arg1 windows:(id)arg2 fetchOrder:(int)arg3 fillOrder:(unsigned int)arg4 hitLimit:(_Bool)arg5;
