...
- (void)syncCoordinator:(id)arg1 didDeleteRemoteEventsWithCount:(unsigned int)arg2;
- (void)syncCoordinator:(id)arg1 didAddRemoteEventsWithStreamNameCounts:(id)arg2 events:(id)arg3;
- (void)syncCoordinator:(id)arg1 didInsertLocalDeletionEventsWithCount:(unsigned int)arg2;
