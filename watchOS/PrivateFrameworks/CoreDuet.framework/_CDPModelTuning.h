...
+ (void)_cumulativeSumOfArray:(float *)arg1 size:(unsigned long)arg2 reverse:(_Bool)arg3;
...
+ (void)_enumerateSubsetsOfSet:(unsigned int *)arg1 setLength:(unsigned long)arg2 withSize:(unsigned long)arg3 callback:(CDUnknownBlockType)arg4;
+ (void)_enumerateSubsetsOfSet:(unsigned int *)arg1 setLength:(unsigned long)arg2 index:(unsigned long)arg3 subset:(unsigned int *)arg4 subsetLength:(unsigned long)arg5 index:(unsigned long)arg6 callback:(CDUnknownBlockType)arg7;
