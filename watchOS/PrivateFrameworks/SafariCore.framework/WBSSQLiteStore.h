...
- (void)_handleOpenFailureWithStatus:(int)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)_openDatabase:(id)arg1 createIfNeeded:(_Bool)arg2 checkIntegrity:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)openAndCheckIntegrity:(_Bool)arg1 createIfNeeded:(_Bool)arg2 fallBackToMemoryStoreIfError:(_Bool)arg3 lockingPolicy:(int)arg4 completionHandler:(CDUnknownBlockType)arg5;
@property(readonly, nonatomic) _Bool isOpen;
- (void)dealloc;
- (id)initWithURL:(id)arg1 protectionType:(int)arg2;
