...
- (void)_didSelectFavoritesGridItemOfSection:(int)arg1 type:(int)arg2 atIndex:(unsigned int)arg3 itemsPerRow:(unsigned int)arg4 isNewTabPage:(_Bool)arg5;
- (void)didSelectFavoritesGridFrequentlyVisitedItemAtIndex:(unsigned int)arg1 itemsPerRow:(unsigned int)arg2 isNewTabPage:(_Bool)arg3;
- (void)didSelectFavoritesGridItemOfType:(int)arg1 atIndex:(unsigned int)arg2 itemsPerRow:(unsigned int)arg3 isNewTabPage:(_Bool)arg4;
