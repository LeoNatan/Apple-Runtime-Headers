...
@interface SubCalValidationTask : SubCalDATask <SubCalURLRequestDelegate>
{
    ...
    unsigned int _searchIndex;
}

- (void).cxx_destruct;
@property(nonatomic) unsigned int searchIndex; // @synthesize searchIndex=_searchIndex;
...
- (id)_stringBeforeNewline:(const char *)arg1 length:(unsigned int)arg2;
