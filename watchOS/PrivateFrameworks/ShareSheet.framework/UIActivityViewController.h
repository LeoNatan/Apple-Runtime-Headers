...
@property(nonatomic) int sharingStyle; // @synthesize sharingStyle=_sharingStyle;
...
- (void)userDefaultsViewController:(id)arg1 didSelectActivityAtIndex:(int)arg2 activityCategory:(int)arg3;
- (void)userDefaultsViewController:(id)arg1 didFavoriteActivity:(_Bool)arg2 atIndex:(int)arg3;
- (void)userDefaultsViewController:(id)arg1 didToggleActivityAtIndex:(int)arg2 activityCategory:(int)arg3;
- (void)userDefaultsViewController:(id)arg1 didMoveActivityAtIndex:(int)arg2 toIndex:(int)arg3 activityCategory:(int)arg4;
- (void)performUserDefaultsWithFavoritesProxies:(id)arg1 suggestionProxies:(id)arg2 activityCategory:(int)arg3;
...
- (void)selectedPersonAtIndex:(unsigned int)arg1;
