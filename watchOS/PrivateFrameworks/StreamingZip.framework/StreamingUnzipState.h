...
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long)arg3 onlyFinishCurrentChunk:(_Bool)arg4;
...
@property(readonly, nonatomic) CDStruct_7a7d509e *cmpState;
- (void)dealloc;
- (id)init;
