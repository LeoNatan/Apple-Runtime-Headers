...
- (id)_analysisWithAlgorithmsAnalysis:(id)arg1 algorithmsCycles:(id)arg2 recentSymptoms:(unsigned int)arg3 recentBasalBodyTemperature:(id)arg4 lastLoggedDayIndex:(int)arg5;
