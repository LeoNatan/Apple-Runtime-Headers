...
- (_Bool)_shouldUpdateStoredNotificationDataGivenTransition:(unsigned int)arg1;
...
- (void)_addNotificationDataForSourceClientIdentifier:(id)arg1 sourceNotificationInfo:(id)arg2 existingNotificationData:(id)arg3 transition:(unsigned int)arg4 now:(id)arg5;
- (void)_updateStoredNotificationDataForSourceClientIdentifier:(id)arg1 sourceNotificationInfo:(id)arg2 existingNotificationData:(id)arg3 transition:(unsigned int)arg4 now:(id)arg5;
- (void)_removeStoredNotificationDataForEventWithEventID:(id)arg1;
- (id)_notificationDataForSourceNotificationInfo:(id)arg1 existingNotificationData:(id)arg2 transition:(unsigned int)arg3 now:(id)arg4;
...
- (void)_notificationAddedWithSourceClientIdentifier:(id)arg1 sourceNotificationInfo:(id)arg2 trigger:(unsigned int)arg3;
- (void)_addRecord:(id)arg1 sourceNotificationInfo:(id)arg2 existingNotificationData:(id)arg3 trigger:(unsigned int)arg4 transition:(unsigned int)arg5 now:(id)arg6;
...
- (unsigned int)_calnTravelAdvisoryTimelinessPeriodFromEKTravelAvisoryTimelinessPeriod:(unsigned int)arg1;
- (unsigned int)_travelAdvisoryTimelinessPeriodForHypothesis:(id)arg1;
