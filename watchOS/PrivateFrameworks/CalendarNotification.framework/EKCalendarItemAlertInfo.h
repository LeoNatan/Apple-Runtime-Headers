...
@interface EKCalendarItemAlertInfo : NSObject <NSCopying>
{
    ...
    unsigned int _currentRouteHypothesizerNotificationType;
    NSDate *_fireDate;
...
@property(nonatomic) unsigned int currentRouteHypothesizerNotificationType; // @synthesize currentRouteHypothesizerNotificationType=_currentRouteHypothesizerNotificationType;
...
- (id)description;
- (id)initWithTitle:(id)arg1 location:(id)arg2 date:(id)arg3 endDate:(id)arg4 timeZone:(id)arg5 allDay:(_Bool)arg6 tentative:(_Bool)arg7 publisherBulletinID:(id)arg8 entityID:(id)arg9 appLink:(id)arg10 action:(id)arg11 proximity:(int)arg12 externalID:(id)arg13 acknowledged:(_Bool)arg14 dismissalID:(id)arg15 alarmID:(id)arg16 isOffsetFromTravelTimeStart:(_Bool)arg17 refiring:(_Bool)arg18 pseudoEvent:(_Bool)arg19;
