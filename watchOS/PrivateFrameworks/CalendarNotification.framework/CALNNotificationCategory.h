...
+ (id)categoryWithIdentifier:(id)arg1 actions:(id)arg2 hiddenPreviewsBodyPlaceholder:(id)arg3 options:(unsigned int)arg4 categorySummaryFormat:(id)arg5;
+ (id)categoryWithIdentifier:(id)arg1 actions:(id)arg2 hiddenPreviewsBodyPlaceholder:(id)arg3 options:(unsigned int)arg4;
- (void).cxx_destruct;
...
- (unsigned int)hash;
- (id)initWithIdentifier:(id)arg1 actions:(id)arg2 hiddenPreviewsBodyPlaceholder:(id)arg3 options:(unsigned int)arg4 categorySummaryFormat:(id)arg5;
