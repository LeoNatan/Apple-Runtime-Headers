...
- (unsigned int)_ttsVocalizerSetParameters:(struct _VE_HSAFE *)arg1 rate:(float)arg2 pitch:(float)arg3 volume:(float)arg4 footprintID:(long)arg5;
...
- (unsigned int)_ttsVocalizerCreateInstance:(struct _VE_HSAFE *)arg1 desiredVoiceName:(char **)arg2 desiredFootprint:(long)arg3 languageCode:(struct __CFString *)arg4 voiceType:(long)arg5;
