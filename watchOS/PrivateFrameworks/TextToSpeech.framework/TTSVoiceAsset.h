...
- (id)description;
- (id)initWithName:(id)arg1 languages:(id)arg2 gender:(int)arg3 footprint:(int)arg4 isInstalled:(_Bool)arg5 isBuiltIn:(_Bool)arg6 masteredVersion:(id)arg7 compatibilityVersion:(id)arg8;
