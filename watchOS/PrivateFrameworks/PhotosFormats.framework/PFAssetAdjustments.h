...
+ (_Bool)adjustmentsPropertyListFileRequiresOverflowDataReassemblyAtURL:(id)arg1 predictedSize:(int *)arg2;
- (void).cxx_destruct;
...
- (id)initWithFormatIdentifier:(id)arg1 formatVersion:(id)arg2 data:(id)arg3 baseVersion:(int)arg4 editorBundleID:(id)arg5 renderTypes:(unsigned int)arg6;
