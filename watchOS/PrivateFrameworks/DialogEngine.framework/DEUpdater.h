...
+ (_Bool)prepareDistribution:(id)arg1 withManifestDir:(id)arg2 disabled:(_Bool)arg3 in:(id)arg4 keyId:(unsigned int)arg5 multipart:(_Bool)arg6;
+ (_Bool)package:(id)arg1 to:(id)arg2 includePrefixes:(id)arg3 excludePrefixes:(id)arg4 includeSuffixes:(id)arg5 excludeSuffixes:(id)arg6 overrides:(id)arg7 keyId:(unsigned int)arg8 multipart:(_Bool)arg9 updating:(id)arg10;
...
- (id)find:(id)arg1 downloadType:(unsigned int)arg2 status:(id *)arg3;
- (void)find:(id)arg1 downloadType:(unsigned int)arg2 block:(CDUnknownBlockType)arg3;
