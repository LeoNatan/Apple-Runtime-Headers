...
-     // Error parsing type: B16@0:4^{AccessibilityObject=^^?{atomic<unsigned int>={__cxx_atomic_impl<unsigned int, std::__1::__cxx_atomic_base_impl<unsigned int> >=AI}}I{Vector<WTF::RefPtr<WebCore::AXCoreObject, WTF::DumbPtrTraits<WebCore::AXCoreObject> >, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>=^{RefPtr<WebCore::AXCoreObject, WTF::DumbPtrTraits<WebCore::AXCoreObject> >}II}Bii{AccessibilityIsIgnoredFromParentData=^{AXCoreObject}BBB}BB{RetainPtr<WebAccessibilityObjectWrapper>=^v}}8@12, name: _addAccessibilityObject:toTextMarkerArray:
...
-     // Error parsing type: ^{AXCoreObject=^^?{atomic<unsigned int>={__cxx_atomic_impl<unsigned int, std::__1::__cxx_atomic_base_impl<unsigned int> >=AI}}}12@0:4^{AXCoreObject=^^?{atomic<unsigned int>={__cxx_atomic_impl<unsigned int, std::__1::__cxx_atomic_base_impl<unsigned int> >=AI}}}8, name: treeItemParentForObject:
-     // Error parsing type: ^{AXCoreObject=^^?{atomic<unsigned int>={__cxx_atomic_impl<unsigned int, std::__1::__cxx_atomic_base_impl<unsigned int> >=AI}}}12@0:4^{AccessibilityObject=^^?{atomic<unsigned int>={__cxx_atomic_impl<unsigned int, std::__1::__cxx_atomic_base_impl<unsigned int> >=AI}}I{Vector<WTF::RefPtr<WebCore::AXCoreObject, WTF::DumbPtrTraits<WebCore::AXCoreObject> >, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>=^{RefPtr<WebCore::AXCoreObject, WTF::DumbPtrTraits<WebCore::AXCoreObject> >}II}Bii{AccessibilityIsIgnoredFromParentData=^{AXCoreObject}BBB}BB{RetainPtr<WebAccessibilityObjectWrapper>=^v}}8, name: detailParentForObject:
-     // Error parsing type: ^{AXCoreObject=^^?{atomic<unsigned int>={__cxx_atomic_impl<unsigned int, std::__1::__cxx_atomic_base_impl<unsigned int> >=AI}}}12@0:4^{AXCoreObject=^^?{atomic<unsigned int>={__cxx_atomic_impl<unsigned int, std::__1::__cxx_atomic_base_impl<unsigned int> >=AI}}}8, name: detailParentForSummaryObject:
...
- (void)dealloc;
- (void)detach;
-     // Error parsing type: @12@0:4^{AXCoreObject=^^?{atomic<unsigned int>={__cxx_atomic_impl<unsigned int, std::__1::__cxx_atomic_base_impl<unsigned int> >=AI}}}8, name: initWithAccessibilityObject:
