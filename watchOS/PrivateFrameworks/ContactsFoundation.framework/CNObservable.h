...
+ (id)binderTypeForResultType:(unsigned int)arg1;
+ (id)observableWithScannerResultsOfType:(unsigned int)arg1 inString:(id)arg2;
...
- (id)throttle:(double)arg1 options:(unsigned int)arg2 schedulerProvider:(id)arg3;
