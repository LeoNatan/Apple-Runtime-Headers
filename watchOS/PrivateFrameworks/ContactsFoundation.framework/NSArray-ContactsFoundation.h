...
+ (id)_cn_arrayWithObject:(id)arg1 count:(unsigned int)arg2;
- (id)_cn_arrayByRotatingRange:(struct _NSRange)arg1 by:(int)arg2;
...
- (id)_cn_takeLast:(unsigned int)arg1;
...
- (id)_cn_tail;
- (unsigned int)_cn_indexOfFirstObjectPassingTest:(CDUnknownBlockType)arg1;
- (id)_cn_firstObjectPassingTest:(CDUnknownBlockType)arg1;
- (id)_cn_balancedSlicesWithMaximumCount:(unsigned int)arg1;
- (id)_cn_slicesWithMaximumCount:(unsigned int)arg1;
