...
@property(nonatomic) int callDestinationIDType; // @synthesize callDestinationIDType=_callDestinationIDType;
...
@property(nonatomic) int callerIDType; // @synthesize callerIDType=_callerIDType;
