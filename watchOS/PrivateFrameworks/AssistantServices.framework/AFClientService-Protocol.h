...
- (oneway void)reportIssueForError:(NSError *)arg1 type:(int)arg2 context:(NSDictionary *)arg3;
...
- (oneway void)startAudioPlaybackRequest:(AFAudioPlaybackRequest *)arg1 options:(unsigned int)arg2 reply:(void (^)(NSError *))arg3;
...
- (oneway void)startRecordingForPendingSpeechRequestWithOptions:(AFSpeechRequestOptions *)arg1 requestId:(unsigned int)arg2 completion:(void (^)(NSError *))arg3;
...
- (oneway void)forceAudioSessionActiveWithOptions:(unsigned int)arg1 completion:(void (^)(unsigned int, NSError *))arg2;
