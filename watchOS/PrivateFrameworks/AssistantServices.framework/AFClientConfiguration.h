...
- (id)description;
- (id)initWithAccessibilityState:(id)arg1 deviceRingerSwitchState:(int)arg2 isDeviceInSetupFlow:(_Bool)arg3 isDeviceInCarDNDMode:(_Bool)arg4 isDeviceInStarkMode:(_Bool)arg5 outputVolume:(float)arg6 tapToSiriAudioPlaybackRequest:(id)arg7 twoShotAudioPlaybackRequest:(id)arg8;
