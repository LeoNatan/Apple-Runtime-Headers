...
@class AFAudioPowerUpdater, AFSpeechRequestOptions, NSMutableData, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, NSXPCConnection;
