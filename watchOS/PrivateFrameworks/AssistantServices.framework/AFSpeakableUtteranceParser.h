...
- (id)_handleControlCodeAtIndex:(unsigned int)arg1 withBuffer:(CDStruct_64adce64)arg2 totalLength:(unsigned int)arg3 consumedLength:(unsigned int *)arg4 hadEmpties:(_Bool *)arg5;
