...
- (oneway void)reportIssueForError:(NSError *)arg1 eventType:(int)arg2 context:(NSDictionary *)arg3;
...
- (oneway void)_sendEngagementFeedback:(int)arg1 voiceQueryIdentifier:(NSString *)arg2;
