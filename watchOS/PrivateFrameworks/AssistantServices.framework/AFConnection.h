...
@interface AFConnection : NSObject <NSXPCListenerDelegate, AFAudioPowerUpdaterDelegate, AFAccessibilityListening, AFDeviceRingerSwitchListening, AFInterstitialProviderDelegate>
{
    ...
    int _activeRequestActivationEvent;
    ...
    unsigned int _activeRequestNumberOfPresentedInterstitials;
    ...
    unsigned int _pendingSpeechRequestCounter;
...
- (void)startAudioPlaybackRequest:(id)arg1 options:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)startRequestWithInfo:(id)arg1 activationEvent:(int)arg2;
...
- (void)boostedPreheatWithStyle:(int)arg1 completion:(CDUnknownBlockType)arg2;
- (void)preheatWithStyle:(int)arg1 forOptions:(id)arg2;
- (void)preheatWithStyle:(int)arg1;
- (void)invalidate;
- (void)endSession;
- (void)_endInterstitialsForReason:(id)arg1;
- (void)_handleInterstitialPhase:(int)arg1 fromProvider:(id)arg2 displayText:(id)arg3 speakableText:(id)arg4 context:(id)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)interstitialProvider:(id)arg1 handlePhase:(int)arg2 displayText:(id)arg3 speakableText:(id)arg4 context:(id)arg5 completion:(CDUnknownBlockType)arg6;
- (void)deviceRingerObserver:(id)arg1 didChangeState:(int)arg2;
...
- (void)_tellSpeechDelegateToPerformTwoShotPromptWithType:(int)arg1 reply:(CDUnknownBlockType)arg2;
...
- (void)_tellDelegateStartPlaybackDidFail:(int)arg1;
- (void)_tellDelegateWillProcessStartPlayback:(int)arg1 intent:(id)arg2 completion:(CDUnknownBlockType)arg3;
