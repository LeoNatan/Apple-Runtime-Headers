...
@optional
- (_Bool)configureWithASBD:(struct AudioStreamBasicDescription *)arg1 andFrameRate:(unsigned long)arg2;
- (_Bool)configureWithSampleRate:(double)arg1 andFrameRate:(unsigned long)arg2;
@end
