...
@interface AFPreferences : NSObject
{
    ...
    int _navToken;
    int _tlsSessionTicketFlushRequestPending;
}
...
- (void)setNanoUseDeviceSpeakerForTTS:(int)arg1;
- (int)nanoUseDeviceSpeakerForTTS;
...
- (unsigned int)internalUserClassification;
- (void)setInternalUserClassification:(unsigned int)arg1;
