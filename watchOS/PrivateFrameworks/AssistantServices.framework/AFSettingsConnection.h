...
- (void)setNanoSiriDataSharingOptInStatus:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;
...
- (void)dismissUI;
- (void)startMultiUserUIRequestWithText:(id)arg1 expectedSpeakerSharedUserID:(id)arg2 expectedSpeakerConfidenceScore:(unsigned int)arg3 nonspeakerConfidenceScores:(id)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)setOpportuneSpeakingEdgeDetectorSignalOverride:(int)arg1;
