...
- (void)siriActivationListener:(id)arg1 deactivateForReason:(int)arg2 options:(unsigned int)arg3 analyticsContext:(id)arg4 completion:(CDUnknownBlockType)arg5;
