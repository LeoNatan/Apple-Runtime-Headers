...
- (void)addBlurFilterWithRadius:(float)arg1;
- (void)addBlurFilterWithRadius:(float)arg1 opaque:(_Bool)arg2;
- (void)addProjectionStyleWithArray:(float [9])arg1;
- (void)addShadowStyleWithRadius:(float)arg1 offset:(struct CGSize)arg2 color:(CDStruct_0b1c536a)arg3 mode:(int)arg4;
...
- (void)translateByX:(float)arg1 Y:(float)arg2;
- (void)scaleByX:(float)arg1 Y:(float)arg2;
