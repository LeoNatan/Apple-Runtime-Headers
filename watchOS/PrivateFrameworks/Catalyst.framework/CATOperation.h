...
- (void).cxx_destruct;
@property int totalUnitCount; // @synthesize totalUnitCount=_totalUnitCount;
@property int completedUnitCount; // @synthesize completedUnitCount=_completedUnitCount;
...
@property unsigned int phase; // @synthesize phase=_phase;
