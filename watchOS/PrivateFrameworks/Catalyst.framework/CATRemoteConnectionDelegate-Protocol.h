...
- (void)connection:(CATRemoteConnection *)arg1 didWriteDataFromStream:(NSInputStream *)arg2 totalBytesWritten:(unsigned int)arg3 totalBytesExpectedToWrite:(unsigned int)arg4 userInfo:(id)arg5;
