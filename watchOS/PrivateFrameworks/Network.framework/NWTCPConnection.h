...
@property(readonly, nonatomic) unsigned long multipathConnectedSubflowCount;
@property(readonly, nonatomic) unsigned long multipathSubflowCount;
...
- (void)readMinimumLength:(unsigned int)arg1 maximumLength:(unsigned int)arg2 timeout:(unsigned int)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)readToPattern:(id)arg1 maximumLength:(unsigned int)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)readMinimumLength:(unsigned int)arg1 maximumLength:(unsigned int)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)readLength:(unsigned int)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)cancel;
