...
+ (id)groupWithHighPriority:(int)arg1 lowPriority:(int)arg2 cellularItemClass:(Class)arg3 wifiItemClass:(Class)arg4 cellularTypeClass:(Class)arg5 includeCellularName:(_Bool)arg6;
