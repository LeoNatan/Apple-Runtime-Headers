...
+ (id)_roundedRectBezierPathInRect:(struct CGRect)arg1 withSectionLocation:(int)arg2 sectionCornerRadius:(float)arg3 cornerRadiusAdjustment:(float)arg4 sectionBorderWidth:(float)arg5 forBorder:(_Bool)arg6;
+ (void)initialize;
