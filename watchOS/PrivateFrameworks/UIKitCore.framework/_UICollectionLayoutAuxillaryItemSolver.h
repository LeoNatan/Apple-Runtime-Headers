...
{
    int _memoizedSupplementaryKind;
...
- (id)_effectiveBoundarySupplementrayItem:(id)arg1 forLayoutAxis:(unsigned int)arg2;
@property(readonly, nonatomic) NSArray *memoizedSupplementaryItems;
@property(readonly, nonatomic) int memoizedSupplementaryKind;
- (id)_normalizedFramesAlongLayoutAxisForFrames:(id)arg1 layoutAxis:(unsigned int)arg2;
- (struct CGPoint)_offsetForContentSizeInsets:(struct NSDirectionalEdgeInsets)arg1;
- (struct CGSize)_requiredContentSizeForSupplementaryFrames:(id)arg1 forLayoutAxis:(unsigned int)arg2 containerSize:(struct CGSize)arg3;
- (struct CGSize)_largestPossibleHostContentSizeForContainerSize:(struct CGSize)arg1 layoutAxis:(unsigned int)arg2;
- (struct CGSize)_computeContentSizeForEmptyHostContentSizeForContainer:(id)arg1 hostContentSize:(struct CGSize)arg2 layoutAxis:(unsigned int)arg3 supplementaryFrames:(id)arg4 preferredSizes:(id)arg5 layoutRTL:(_Bool)arg6 supplementaryKind:(int)arg7;
- (struct CGRect)_frameForSupplementaryItem:(id)arg1 container:(id)arg2 contentSize:(struct CGSize)arg3 frameOffset:(struct CGPoint)arg4 applyPinning:(_Bool)arg5 visibleBounds:(struct CGRect)arg6 preferredSizes:(id)arg7 preferredIndex:(int)arg8 layoutRTL:(_Bool)arg9;
- (id)_queryFramesIntersectingRect:(struct CGRect)arg1 frameOffset:(struct CGPoint)arg2;
- (void)_updateGeometricIndexer;
- (id)_rearrangedFramesForFrames:(id)arg1 container:(id)arg2 contentSize:(struct CGSize)arg3 applyPinning:(_Bool)arg4 frameOffset:(struct CGPoint)arg5 visibleBounds:(struct CGRect)arg6 preferredSizes:(id)arg7 layoutRTL:(_Bool)arg8 supplementaryKind:(int)arg9;
