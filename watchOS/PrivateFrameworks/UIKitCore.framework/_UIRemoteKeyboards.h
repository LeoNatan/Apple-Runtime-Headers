...
- (void)queue_keyboardTransition:(id)arg1 event:(unsigned int)arg2 withInfo:(id)arg3 onComplete:(CDUnknownBlockType)arg4;
...
- (void)setWindowLevel:(float)arg1 sceneLevel:(float)arg2 forResponder:(id)arg3;
