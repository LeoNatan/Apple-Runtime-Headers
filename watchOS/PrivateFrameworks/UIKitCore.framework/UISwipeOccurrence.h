...
@property(nonatomic) unsigned int currentDirection; // @synthesize currentDirection=_currentDirection;
...
- (void)resetItemWithSwipeInfo:(CDStruct_5516dc31)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)moveItemWithSwipeInfo:(CDStruct_5516dc31)arg1 completion:(CDUnknownBlockType)arg2;
- (void)endSwipe;
- (void)beginSwipe;
