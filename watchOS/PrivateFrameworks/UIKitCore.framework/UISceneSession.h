...
@interface UISceneSession : NSObject <NSCopying, NSMutableCopying, NSSecureCoding>
{
    ...
    struct {
        unsigned int _stateRestorationActivityHasLoaded:1;
...
+ (id)canvasRepresentationForSystemType:(int)arg1;
...
- (void)_loadStateRestorationActivity;
...
@property(readonly, nonatomic) int systemType;
