...
@interface _UITextTiledLayer : CALayer <CALayerDelegate>
{
    ...
    float _maxPrefetchedTiles;
}

- (void).cxx_destruct;
@property(nonatomic) float maxPrefetchedTiles; // @synthesize maxPrefetchedTiles=_maxPrefetchedTiles;
@property(nonatomic) float maxTileHeight; // @synthesize maxTileHeight=_maxTileHeight;
- (void)resumeTiling;
- (void)suspendTiling;
- (void)dealloc;
...
- (id)_preparedTileForFrame:(struct CGRect)arg1 mask:(id)arg2 opacity:(float)arg3 deferred:(_Bool)arg4;
