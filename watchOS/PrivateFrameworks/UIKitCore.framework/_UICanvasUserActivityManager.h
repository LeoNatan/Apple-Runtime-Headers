...
- (void)_canvas:(id)arg1 didTransitionFromActivationState:(int)arg2 withReasonsMask:(unsigned int)arg3;
- (void)_canvas:(id)arg1 willTransitionToActivationState:(int)arg2 withReasonsMask:(unsigned int)arg3;
