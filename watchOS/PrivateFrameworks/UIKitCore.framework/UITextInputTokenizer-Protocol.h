...
- (_Bool)isPosition:(UITextPosition *)arg1 withinTextUnit:(int)arg2 inDirection:(int)arg3;
- (UITextPosition *)positionFromPosition:(UITextPosition *)arg1 toBoundary:(int)arg2 inDirection:(int)arg3;
- (_Bool)isPosition:(UITextPosition *)arg1 atBoundary:(int)arg2 inDirection:(int)arg3;
