...
- (id)description;
- (id)initWithView:(id)arg1 indexPath:(id)arg2 viewType:(int)arg3 endRect:(struct CGRect)arg4 endAlpha:(float)arg5 startFraction:(float)arg6 endFraction:(float)arg7 curve:(int)arg8 animateFromCurrentPosition:(_Bool)arg9 shouldDeleteAfterAnimation:(_Bool)arg10 editing:(_Bool)arg11;
