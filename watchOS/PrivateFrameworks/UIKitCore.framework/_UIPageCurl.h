...
- (void)_endManualCurlAtLocation:(struct CGPoint)arg1 withSuggestedVelocity:(float)arg2 shouldComplete:(_Bool)arg3;
- (float)_durationForManualCurlEndAnimationWithSuggestedVelocity:(float)arg1 shouldComplete:(_Bool)arg2;
...
- (_Bool)_isPreviousCurlCompatibleWithCurlOfType:(int)arg1 inDirection:(int)arg2;
...
- (_Bool)_populateFromValue:(float *)arg1 toValue:(float *)arg2 fromState:(id)arg3 forAnimationWithKeyPath:(id)arg4;
