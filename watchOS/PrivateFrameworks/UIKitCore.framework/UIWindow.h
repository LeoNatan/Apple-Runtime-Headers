...
+ (void)_noteStatusBarHeightChanged:(float)arg1 oldHeight:(float)arg2 forAutolayoutRootViewsOnly:(_Bool)arg3;
...
- (_Bool)_legacyShouldAutorotateToInterfaceOrientation:(int)arg1;
