...
@interface _UIDisplayInfoProvider : NSObject <_UIDisplayInfoProviding>
{
    ...
    float homeAffordanceOverlayAllowance;
    float systemMinimumMargin;
...
@property(readonly, nonatomic) float systemMinimumMargin; // @synthesize systemMinimumMargin;
@property(readonly, nonatomic) float homeAffordanceOverlayAllowance; // @synthesize homeAffordanceOverlayAllowance;
@property(nonatomic) unsigned int artworkSubtype; // @synthesize artworkSubtype;
