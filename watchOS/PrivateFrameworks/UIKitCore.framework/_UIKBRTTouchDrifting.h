...
@property(nonatomic) CDStruct_818bb265 touchError; // @synthesize touchError=_touchError;
...
- (void)moveTouchWithIdentifier:(id)arg1 toLocation:(struct CGPoint)arg2 withRadius:(float)arg3 atTouchTime:(double)arg4;
- (void)ignoreTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2;
- (void)updateTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2 resultingError:(struct CGPoint)arg3 rowOffsetFromHomeRow:(int)arg4;
- (void)addTouchLocation:(struct CGPoint)arg1 withRadius:(float)arg2 withTouchTime:(double)arg3 withIdentifier:(id)arg4;
