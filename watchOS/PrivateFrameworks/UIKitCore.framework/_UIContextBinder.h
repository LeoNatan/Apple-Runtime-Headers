...
#import "_UIAnimationFenceCoordinating.h"
...
@interface _UIContextBinder : NSObject <_UIAnimationFenceCoordinating>
{
    ...
    int _contextManagementPolicy;
}

+ (id)createContextForBindable:(id)arg1 withSubstrate:(id)arg2;
@property(nonatomic) int contextManagementPolicy; // @synthesize contextManagementPolicy=_contextManagementPolicy;
