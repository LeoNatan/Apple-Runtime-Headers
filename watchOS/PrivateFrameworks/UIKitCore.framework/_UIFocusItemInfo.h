...
@property(readonly, nonatomic) int focusTouchSensitivityStyle; // @synthesize focusTouchSensitivityStyle=_focusTouchSensitivityStyle;
@property(readonly, nonatomic) float focusSoundPan; // @synthesize focusSoundPan=_focusSoundPan;
@property(readonly, nonatomic) int focusSound; // @synthesize focusSound=_focusSound;
@property(readonly, nonatomic) int inheritedFocusMovementStyle; // @synthesize inheritedFocusMovementStyle=_inheritedFocusMovementStyle;
