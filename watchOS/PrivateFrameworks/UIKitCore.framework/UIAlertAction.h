...
@class NSString, UIAlertController, UIColor, UIImage, UIInterfaceAction<UIAlertActionMutablePropertyObservering>, UIViewController;
...
+ (id)_actionWithContentViewController:(id)arg1 style:(int)arg2 handler:(CDUnknownBlockType)arg3;
...
@property(nonatomic, getter=_keyCommandModifierFlags, setter=_setKeyCommandModifierFlags:) int keyCommandModifierFlags; // @synthesize keyCommandModifierFlags=_keyCommandModifierFlags;
