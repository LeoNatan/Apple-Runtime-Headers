...
- (void)_performActivityOfType:(id)arg1 executionEnvironment:(int)arg2;
...
- (void)_retryRemoteViewServiceConnectionIfPossibleWithPriming:(_Bool)arg1 previousAttempts:(int)arg2;
- (void)_connectToRemoteViewServiceOnceWithPriming:(_Bool)arg1 previousAttempts:(int)arg2;
