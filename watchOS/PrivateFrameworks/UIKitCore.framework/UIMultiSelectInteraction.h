...
@interface UIMultiSelectInteraction : NSObject <UIGestureRecognizerDelegate>
{
    _Bool _isScrollView;
...
- (unsigned int)_currentExtensionTypeForOneFingerTap;
...
@property(nonatomic) float singleTouchPanGestureHysteresis; // @dynamic singleTouchPanGestureHysteresis;
