...
+ (void)animateWithParameters:(id)arg1 fromCurrentState:(_Bool)arg2 frameInterval:(float)arg3 animations:(CDUnknownBlockType)arg4 completion:(CDUnknownBlockType)arg5;
