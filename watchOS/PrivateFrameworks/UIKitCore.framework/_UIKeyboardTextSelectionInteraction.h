...
+ (void)attachToExistingRecogniser:(id)arg1 owner:(id)arg2 forType:(int)arg3;
...
- (void)indirectPanGestureWithState:(int)arg1 withTranslation:(struct CGPoint)arg2 withFlickDirection:(unsigned int)arg3;
...
- (void)beginLongPressWithTranslation:(struct CGPoint)arg1 touchCount:(unsigned int)arg2 executionContext:(id)arg3;
- (void)longPressGestureWithState:(int)arg1 withTranslation:(struct CGPoint)arg2 touchCount:(unsigned int)arg3;
...
- (void)indirectBlockPanGestureWithState:(int)arg1 withTranslation:(struct CGPoint)arg2;
- (void)indirectCursorPanGestureWithState:(int)arg1 withTranslation:(struct CGPoint)arg2 withFlickDirection:(unsigned int)arg3;
...
- (id)initWithView:(id)arg1 owner:(id)arg2 forTypes:(int)arg3;
- (id)gestures;
