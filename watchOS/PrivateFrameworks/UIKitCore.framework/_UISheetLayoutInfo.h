...
@interface _UISheetLayoutInfo : NSObject
{
    ...
    float __stackTopAlignmentOffset;
...
@property(readonly, nonatomic) float _stackTopAlignmentOffset; // @synthesize _stackTopAlignmentOffset=__stackTopAlignmentOffset;
