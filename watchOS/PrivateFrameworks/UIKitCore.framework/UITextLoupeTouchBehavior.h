...
- (void).cxx_destruct;
- (void)textLoupeInteraction:(id)arg1 gestureChangedWithState:(int)arg2 location:(CDUnknownBlockType)arg3 translation:(CDUnknownBlockType)arg4 velocity:(CDUnknownBlockType)arg5 modifierFlags:(int)arg6 shouldCancel:(_Bool *)arg7;
