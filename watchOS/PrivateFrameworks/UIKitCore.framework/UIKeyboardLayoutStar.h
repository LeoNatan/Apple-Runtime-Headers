...
- (void)typingStyleEstimator:(id)arg1 didChangeTypingStyleEstimate:(unsigned int)arg2;
...
- (void)didDetectPinchWithSeparation:(float)arg1;
- (_Bool)pinchCanBeginWithTouches:(id)arg1 andScale:(float)arg2;
...
- (int)currentHandBiasWithCoordinator:(id)arg1;
- (void)finishHandBiasTransitionWithFinalBias:(int)arg1;
- (id)hostViewForHandBiasTransition:(id)arg1;
- (id)prepareTransition:(id)arg1 forTargetHandBias:(int)arg2 coordinator:(id)arg3;
...
- (void)setKeyboardDim:(_Bool)arg1 amount:(float)arg2 withDuration:(float)arg3;
...
- (void)_transitionToContinuousPathState:(int)arg1 forTouchInfo:(id)arg2;
- (id)_pathEffectView;
