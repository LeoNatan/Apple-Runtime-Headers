...
@interface _UINavigationBarLayout : NSObject <NSCopying, _UINavigationBarTransitionContextParticipant>
{
    ...
    int _representedSearchLayoutState;
    _UINavigationBarPalette *_bottomPalette;
    float _largeTitleExposure;
    float _chromelessTransitionProgress;
    float _computedBackgroundViewAlpha;
    int _apiVersion;
...
@property(readonly, nonatomic) float computedBackgroundViewAlpha; // @synthesize computedBackgroundViewAlpha=_computedBackgroundViewAlpha;
@property(readonly, nonatomic) float chromelessTransitionProgress; // @synthesize chromelessTransitionProgress=_chromelessTransitionProgress;
@property(readonly, nonatomic) float largeTitleExposure; // @synthesize largeTitleExposure=_largeTitleExposure;
@property(retain, nonatomic) _UINavigationBarPalette *bottomPalette; // @synthesize bottomPalette=_bottomPalette;
@property(nonatomic) int representedSearchLayoutState; // @synthesize representedSearchLayoutState=_representedSearchLayoutState;
...
@property(nonatomic) float requestedBackgroundViewAlpha; // @synthesize requestedBackgroundViewAlpha=_requestedBackgroundViewAlpha;
...
@property(readonly, nonatomic) CDStruct_869f9c67 layoutHeights;
@property(readonly, copy, nonatomic) NSArray *restingHeights;
- (id)layoutForMeasuringWidth:(float)arg1;
...
- (struct CGRect)_backgroundViewLayoutFrameWithRelevantMaxY:(float)arg1;
@property(readonly, nonatomic) struct CGRect bottomPaletteLayoutFrame;
- (struct CGRect)_bottomPaletteLayoutFrameWithSearchBarMaxY:(float)arg1;
...
- (struct CGRect)_contentViewLayoutFrameWithPromptMaxY:(float)arg1;
