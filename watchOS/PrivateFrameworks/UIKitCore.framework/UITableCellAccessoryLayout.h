...
@interface UITableCellAccessoryLayout : NSObject <UICellAccessoryLayout>
{
    ...
    unsigned int _edge;
    float _safeAreaInset;
    float _minimumCompressionLayoutWidth;
...
- (struct CGRect)_frameForAccessoryAtIndex:(unsigned int)arg1 inAccessories:(id)arg2 containerSize:(struct CGSize)arg3 withXOrigin:(float *)arg4;
- (float)_totalWidthForAccessories:(id)arg1 withContainerSize:(struct CGSize)arg2;
- (id)init;
