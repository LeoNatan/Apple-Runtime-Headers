...
- (float)_imageCenterToTopForHUD:(id)arg1 preferredSizeForLabel:(struct CGSize)arg2;
- (unsigned int)_actualNumberOfLinesForLabelInHUD:(id)arg1 preferredSize:(struct CGSize)arg2;
- (void)layoutSubviewsOfHUD:(id)arg1;
- (struct CGSize)preferredSizeForLabelInHUD:(id)arg1 maximumWidth:(float)arg2;
