...
- (void)showCorners:(_Bool)arg1 withDuration:(float)arg2;
...
- (void)updateInputAccessoryViewVisibility:(_Bool)arg1 withDuration:(float)arg2;
...
- (struct CGRect)displayRectForViewSet:(id)arg1 orientation:(int)arg2 position:(int)arg3 fromRotation:(_Bool)arg4;
