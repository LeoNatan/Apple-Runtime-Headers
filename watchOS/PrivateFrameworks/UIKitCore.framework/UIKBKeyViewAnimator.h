...
- (void)transitionStartedForKeyView:(id)arg1 alternateCount:(unsigned int)arg2 toLeft:(_Bool)arg3;
...
- (void)_fadeInKeyView:(id)arg1 duration:(float)arg2 completion:(CDUnknownBlockType)arg3;
- (void)_fadeOutKeyView:(id)arg1 duration:(float)arg2 completion:(CDUnknownBlockType)arg3;
