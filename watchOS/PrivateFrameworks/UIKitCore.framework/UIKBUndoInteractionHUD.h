...
@interface UIKBUndoInteractionHUD : UIView
{
    ...
    int _currentUndoElementIndex;
    UIKBUndoStyling *_style;
    float _grabberStartXLocation;
...
@property(nonatomic) int currentUndoElementIndex; // @synthesize currentUndoElementIndex=_currentUndoElementIndex;
...
@property(nonatomic) float optimizedHUDWidth; // @synthesize optimizedHUDWidth=_optimizedHUDWidth;
