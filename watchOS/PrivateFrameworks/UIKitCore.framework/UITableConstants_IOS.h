...
- (id)_defaultImageForEditingStyle:(int)arg1 cell:(id)arg2 tableView:(id)arg3;
...
- (id)_symbolImageNamed:(id)arg1 font:(id)arg2 scale:(int)arg3 cell:(id)arg4 tableView:(id)arg5;
...
- (float)_defaultMarginWidthForTableView:(id)arg1 canUseLayoutMargins:(_Bool)arg2;
