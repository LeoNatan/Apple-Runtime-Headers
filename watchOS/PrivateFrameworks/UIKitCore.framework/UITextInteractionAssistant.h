...
@interface UITextInteractionAssistant : NSObject <UITextInteraction_AssistantDelegate, UIResponderStandardEditActions>
{
    ...
    unsigned int _activeSelectionInteractions;
...
+ (int)_nextGranularityInCycle:(int)arg1 forTouchType:(int)arg2;
- (void).cxx_destruct;
...
- (void)_updateSelectionWithPoint:(struct CGPoint)arg1 granularity:(int)arg2 forceGranularity:(_Bool)arg3;
...
- (void)dealloc;
- (id)initWithView:(id)arg1 textInteractionMode:(int)arg2;
