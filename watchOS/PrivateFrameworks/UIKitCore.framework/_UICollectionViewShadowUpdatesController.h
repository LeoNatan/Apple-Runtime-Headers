...
- (int)sectionIndexAfterShadowUpdates:(int)arg1 allowingAppendingInserts:(_Bool)arg2;
- (int)sectionIndexAfterShadowUpdates:(int)arg1;
- (int)sectionIndexBeforeShadowUpdates:(int)arg1;
...
- (id)_collectionView:(id)arg1 indexPathForSectionIndexTitle:(id)arg2 atIndex:(int)arg3;
- (id)_collectionView:(id)arg1 sectionIndexTitlesTrimmedToCount:(unsigned int)arg2;
