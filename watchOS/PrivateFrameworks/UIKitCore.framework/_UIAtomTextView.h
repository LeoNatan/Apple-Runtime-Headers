...
@property(nonatomic) int trailingViewMode; // @synthesize trailingViewMode=_trailingViewMode;
...
@property(nonatomic) int leadingViewMode; // @synthesize leadingViewMode=_leadingViewMode;
...
- (_Bool)layoutManager:(id)arg1 shouldSetLineFragmentRect:(inout struct CGRect *)arg2 lineFragmentUsedRect:(inout struct CGRect *)arg3 baselineOffset:(inout float *)arg4 inTextContainer:(id)arg5 forGlyphRange:(struct _NSRange)arg6;
...
- (id)_attachmentAtCharacterIndex:(unsigned int)arg1;
...
- (_Bool)_showViewWithMode:(int)arg1 alwaysDefinition:(_Bool)arg2;
...
- (void)removeRepresentedObjectAtIndex:(unsigned int)arg1;
...
- (void)insertRepresentedObject:(id)arg1 atIndex:(unsigned int)arg2;
