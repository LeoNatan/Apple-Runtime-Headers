...
- (void).cxx_destruct;
@property(nonatomic) unsigned int webClipStatusBarStyle; // @synthesize webClipStatusBarStyle=_webClipStatusBarStyle;
...
@property(readonly, nonatomic) unsigned int bundleVersion; // @synthesize bundleVersion;
