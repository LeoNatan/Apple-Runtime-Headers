...
@interface UIUndoGestureInteraction : NSObject <UIInteractiveUndoHUDActionDelegate, UIGestureRecognizerDelegate, UIEditingOverlayInteractionWithView>
{
    ...
    int _currentAppearance;
    UILayoutGuide *_layoutGuide;
    int _previousRecognizedPanDirection;
    UIDelayedAction *_multiPansTimer;
    float _remainingDistanceToTravel;
    int _beginPanDirection;
    unsigned int _panDownStateChangedCounter;
...
@property(nonatomic) unsigned int panDownStateChangedCounter; // @synthesize panDownStateChangedCounter=_panDownStateChangedCounter;
@property(nonatomic) int beginPanDirection; // @synthesize beginPanDirection=_beginPanDirection;
...
@property(nonatomic) float remainingDistanceToTravel; // @synthesize remainingDistanceToTravel=_remainingDistanceToTravel;
@property(retain, nonatomic) UIDelayedAction *multiPansTimer; // @synthesize multiPansTimer=_multiPansTimer;
@property(nonatomic) int previousRecognizedPanDirection; // @synthesize previousRecognizedPanDirection=_previousRecognizedPanDirection;
...
@property(nonatomic) int currentAppearance; // @synthesize currentAppearance=_currentAppearance;
...
- (_Bool)canRedo;
- (_Bool)canUndo;
- (void)animateSpringCoverWithSuccess:(_Bool)arg1 direction:(int)arg2 remainingDistanceToTravel:(float)arg3;
- (void)fullyCloseCoverWithBeginDirection:(int)arg1 complete:(CDUnknownBlockType)arg2;
- (void)fullyOpenAndCloseCoverWithBeginDirection:(int)arg1;
- (_Bool)performActionWithDirection:(int)arg1;
- (int)undoControlTypeWithDirection:(int)arg1;
...
- (unsigned int)privateEditingInteractionOptions;
- (id)_undoManager;
...
- (void)setUndoStateHUDVisibility:(_Bool)arg1 withType:(int)arg2 available:(_Bool)arg3;
- (void)setUndoInteractiveHUDVisibility:(_Bool)arg1;
- (void)setUndoHUDType:(int)arg1 visibility:(_Bool)arg2;
