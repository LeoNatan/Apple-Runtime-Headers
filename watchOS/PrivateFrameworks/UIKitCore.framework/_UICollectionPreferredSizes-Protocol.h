...
- (id <_UICollectionPreferredSizes>)preferredSizesApplyingFrameOffset:(int)arg1 supplementaryBaseOffsets:(id <_UICollectionLayoutAuxillaryOffsets>)arg2;
...
- (_UICollectionPreferredSize *)objectAtIndexedSubscript:(int)arg1;
- (_Bool)hasSizes;
@end
