...
@property(nonatomic) unsigned int concaveCorner; // @synthesize concaveCorner=m_concaveCorner;
...
- (void)dealloc;
- (id)initWithGeometry:(id)arg1 frame:(struct CGRect)arg2 paddedFrame:(struct CGRect)arg3 concaveCorner:(unsigned int)arg4 concaveCornerOffset:(struct CGSize)arg5;
