...
- (void)registerFileRepresentationForTypeIdentifier:(id)arg1 fileOptions:(int)arg2 loadHandler:(CDUnknownBlockType)arg3;
- (void)registerDataRepresentationForTypeIdentifier:(id)arg1 loadHandler:(CDUnknownBlockType)arg2;
- (void)registerFileRepresentationForTypeIdentifier:(id)arg1 fileOptions:(int)arg2 options:(id)arg3 loadHandler:(CDUnknownBlockType)arg4;
- (void)registerDataRepresentationForTypeIdentifier:(id)arg1 options:(id)arg2 loadHandler:(CDUnknownBlockType)arg3;
- (void)registerFileProviderItemForTypeIdentifier:(id)arg1 visibility:(int)arg2 loadHandler:(CDUnknownBlockType)arg3;
