...
+ (id)groupWithLayoutAxis:(unsigned int)arg1 size:(id)arg2 subitems:(id)arg3 count:(int)arg4;
...
+ (id)verticalGroupWithSize:(id)arg1 subitem:(id)arg2 count:(int)arg3;
+ (id)horizontalGroupWithSize:(id)arg1 subitems:(id)arg2;
+ (id)horizontalGroupWithSize:(id)arg1 subitem:(id)arg2 count:(int)arg3;
- (void).cxx_destruct;
...
- (id)initWithlayoutSize:(id)arg1 contentInsets:(struct NSDirectionalEdgeInsets)arg2 layoutAxis:(unsigned int)arg3 isCustomGroup:(_Bool)arg4 subitems:(id)arg5 count:(int)arg6 supplementaryItems:(id)arg7 interItemSpacing:(id)arg8 groupOptions:(int)arg9 subitemsProvider:(CDUnknownBlockType)arg10 frameProvider:(CDUnknownBlockType)arg11 customGroupItemProvider:(CDUnknownBlockType)arg12 visualFormats:(id)arg13 visualFormatProvider:(CDUnknownBlockType)arg14;
