...
@interface _UIFocusFastScrollingController : NSObject
{
    ...
    CDStruct_12aaad36 _previousPanVelocity;
    unsigned int _accelerationSwipeCount;
    float _accelerationMultiplier;
    float _accelerationStartMultiplier;
...
+ (int)indexOfEntryNearestToScrollViewBounds:(struct CGRect)arg1 inDisplayedEntries:(id)arg2;
...
- (void)_updateSoftFocusForVelocity:(CDStruct_b2fbf00d)arg1;
- (void)_stopScrollingAnimation;
- (void)_setContentOffset:(struct CGPoint)arg1 withVelocity:(CDStruct_b2fbf00d)arg2;
- (CDStruct_b2fbf00d)_currentScrollViewDecelerationVelocity;
- (void)_startScrollingAnimationWithVelocity:(CDStruct_b2fbf00d)arg1 friction:(struct CGPoint)arg2;
...
- (void)_startPressTrackingWithVelocity:(CDStruct_b2fbf00d)arg1;
- (void)_handlePressGesture:(id)arg1;
- (void)_resetSwipeAcceleration;
- (void)_endDraggingWithFinalVelocity:(CDStruct_b2fbf00d)arg1;
...
- (void)_interpretDigitzerLocation:(struct CGPoint)arg1 toFindEntryIndex:(int *)arg2 deflection:(float *)arg3;
...
@property(readonly, nonatomic) int scrollingStyle;
