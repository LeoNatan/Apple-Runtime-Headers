...
@interface UIKeyboardTouchInfo : NSObject
{
    ...
    unsigned int _processedTouchCount;
    UIKBTree *_key;
    UIKBTree *_keyplane;
    ...
    int _continuousPathState;
}

@property(nonatomic) unsigned int processedTouchCount; // @synthesize processedTouchCount=_processedTouchCount;
@property(nonatomic) int continuousPathState; // @synthesize continuousPathState=_continuousPathState;
