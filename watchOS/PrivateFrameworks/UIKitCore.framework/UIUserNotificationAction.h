...
- (id)init;
- (id)initWithIdentifier:(id)arg1 title:(id)arg2 behavior:(unsigned int)arg3 parameters:(id)arg4 activationMode:(unsigned int)arg5 isAuthenticationRequired:(_Bool)arg6 isDestructive:(_Bool)arg7;
