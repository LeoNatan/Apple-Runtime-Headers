...
- (void).cxx_destruct;
@property(readonly, nonatomic) int activeFocusAnimation; // @synthesize activeFocusAnimation=_activeFocusAnimation;
...
- (void)addCoordinatedAnimationsForAnimation:(int)arg1 animations:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;
...
@property(readonly, nonatomic, getter=_animationOptions) unsigned int animationOptions;
