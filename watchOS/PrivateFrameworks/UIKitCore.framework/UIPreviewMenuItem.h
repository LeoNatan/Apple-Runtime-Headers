...
+ (id)_itemWithTitle:(id)arg1 style:(int)arg2 image:(id)arg3 handler:(CDUnknownBlockType)arg4;
+ (id)itemWithTitle:(id)arg1 style:(int)arg2 items:(id)arg3;
+ (id)itemWithTitle:(id)arg1 style:(int)arg2 handler:(CDUnknownBlockType)arg3;
- (void).cxx_destruct;
