...
@property(nonatomic) int frameOffset; // @synthesize frameOffset=_frameOffset;
- (id)preferredSizesApplyingFrameOffset:(int)arg1 supplementaryBaseOffsets:(id)arg2;
- (_Bool)containsSupplementaryOffsets:(id)arg1;
- (void)addPreferredSize:(id)arg1 forSupplementaryWithElementKind:(id)arg2 atIndex:(int)arg3;
...
- (_Bool)hasSizes;
- (id)init;
- (id)initWithSizes:(id)arg1 indexes:(id)arg2 supplementarySizesDict:(id)arg3 frameOffset:(int)arg4 supplementaryBaseOffsets:(id)arg5;
