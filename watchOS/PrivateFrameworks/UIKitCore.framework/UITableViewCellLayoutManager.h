...
- (float)requiredIndentationForFirstLineOfCell:(id)arg1 rowWidth:(float)arg2 forSizing:(_Bool)arg3;
- (float)requiredIndentationForFirstLineOfCell:(id)arg1 rowWidth:(float)arg2;
...
- (void)_legacy_cell:(id)arg1 didTransitionToState:(unsigned int)arg2;
- (void)_modern_cell:(id)arg1 didTransitionToState:(unsigned int)arg2;
- (void)cell:(id)arg1 didTransitionToState:(unsigned int)arg2;
- (void)_legacy_cell:(id)arg1 willTransitionToState:(unsigned int)arg2;
...
- (struct CGRect)_legacy_contentRectForCell:(id)arg1 forEditingState:(_Bool)arg2 showingDeleteConfirmation:(_Bool)arg3 rowWidth:(float)arg4;
- (struct CGRect)_contentRectForCell:(id)arg1 forEditingState:(_Bool)arg2 showingDeleteConfirmation:(_Bool)arg3 rowWidth:(float)arg4;
- (struct CGRect)_contentRectForCell:(id)arg1 forEditingState:(_Bool)arg2 showingDeleteConfirmation:(_Bool)arg3;
- (float)_contentRectLeadingOffsetForCell:(id)arg1 editingState:(_Bool)arg2 rowWidth:(float)arg3;
...
- (struct CGRect)_accessoryRectForCell:(id)arg1 offscreen:(_Bool)arg2 rowWidth:(float)arg3;
...
- (struct CGRect)_adjustedBackgroundContentRectForCell:(id)arg1 forIndentedState:(_Bool)arg2 rowWidth:(float)arg3;
- (struct CGRect)_adjustedBackgroundContentRectForCell:(id)arg1 forIndentedState:(_Bool)arg2;
- (struct CGRect)_adjustedBackgroundRectForCell:(id)arg1 forIndentedState:(_Bool)arg2 rowWidth:(float)arg3;
- (struct CGRect)_adjustedBackgroundRectForCell:(id)arg1 forIndentedState:(_Bool)arg2;
- (struct CGRect)_backgroundRectForCell:(id)arg1 forIndentedState:(_Bool)arg2 rowWidth:(float)arg3;
