...
+ (int)UIDictationStartStopReasonToInstrumentationDictationEndPointType:(unsigned int)arg1;
+ (int)UIDictationStartStopReasonToInstrumentationInvocationSourceType:(unsigned int)arg1;
...
+ (id)interpretation:(id)arg1 forPhraseIndex:(unsigned int)arg2 isShiftLocked:(_Bool)arg3 autocapitalizationType:(int)arg4 useServerCapitalization:(_Bool)arg5;
...
+ (id)serializedInterpretationFromTokens:(id)arg1 transform:(struct __CFString *)arg2 autocapitalization:(int)arg3 capitalization:(unsigned int)arg4;
+ (id)serializedInterpretationFromTokens:(id)arg1 transform:(struct __CFString *)arg2 capitalization:(unsigned int)arg3;
+ (_Bool)isRunning;
+ (id)sharedInstance;
+ (id)activeInstance;
...
- (void)_presentPrivacySheetForType:(int)arg1 completion:(CDUnknownBlockType)arg2;
- (void)_presentAlertForDictationInputModeOfType:(int)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)presentAlertOfType:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;
