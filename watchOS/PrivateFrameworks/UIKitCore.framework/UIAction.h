...
- (id)initWithTitle:(id)arg1 image:(id)arg2 identifier:(id)arg3 discoverabilityTitle:(id)arg4 attributes:(unsigned int)arg5 state:(int)arg6 handler:(CDUnknownBlockType)arg7;
