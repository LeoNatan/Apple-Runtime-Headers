...
- (void)animateAccessoryViewVisibility:(_Bool)arg1 withDuration:(float)arg2;
- (_Bool)isSplitting;
- (_Bool)isTranslating;
...
@property(readonly, nonatomic) int keyboardOrientation;
