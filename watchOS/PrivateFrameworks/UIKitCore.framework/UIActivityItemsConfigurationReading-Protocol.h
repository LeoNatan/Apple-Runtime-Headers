...
- (NSItemProvider *)activityItemsConfigurationPreviewForItemAtIndex:(int)arg1 intent:(NSString *)arg2 suggestedSize:(struct CGSize)arg3;
- (id)activityItemsConfigurationMetadataForItemAtIndex:(int)arg1 key:(NSString *)arg2;
