...
- (float)titleViewLargeTitleHeight:(UIView<_UINavigationBarAugmentedTitleView> *)arg1;
- (float)titleViewContentBaseHeight:(UIView<_UINavigationBarAugmentedTitleView> *)arg1;
- (CDStruct_b2fbf00d)titleViewLargeTitleHeightRange:(UIView<_UINavigationBarAugmentedTitleView> *)arg1;
- (float)titleViewContentBaselineOffsetFromTop:(UIView<_UINavigationBarAugmentedTitleView> *)arg1;
