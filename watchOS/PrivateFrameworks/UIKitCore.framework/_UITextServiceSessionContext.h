...
+ (id)sessionContextForType:(int)arg1 withTextInput:(id)arg2;
...
- (_Bool)_typeRequiresContext:(int)arg1;
- (id)initForType:(int)arg1 withText:(id)arg2 withTextInput:(id)arg3 withView:(id)arg4;
