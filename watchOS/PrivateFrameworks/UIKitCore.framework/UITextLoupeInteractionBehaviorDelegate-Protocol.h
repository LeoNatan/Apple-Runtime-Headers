...
- (void)textLoupeInteraction:(UITextLoupeInteraction *)arg1 gestureChangedWithState:(int)arg2 location:(struct CGPoint (^)(void))arg3 translation:(struct CGPoint (^)(void))arg4 velocity:(struct CGPoint (^)(void))arg5 modifierFlags:(int)arg6 shouldCancel:(_Bool *)arg7;
