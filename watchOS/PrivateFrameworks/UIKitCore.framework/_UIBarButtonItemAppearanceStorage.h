...
- (id)backButtonBackgroundImageForState:(unsigned int)arg1 isMini:(_Bool)arg2;
- (void)setBackButtonBackgroundImage:(id)arg1 forState:(unsigned int)arg2 isMini:(_Bool)arg3;
...
- (id)backgroundImageForState:(unsigned int)arg1 style:(int)arg2 isMini:(_Bool)arg3;
- (void)setBackgroundImage:(id)arg1 forState:(unsigned int)arg2 style:(int)arg3 isMini:(_Bool)arg4;
