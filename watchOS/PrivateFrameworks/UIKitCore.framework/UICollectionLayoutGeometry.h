...
@property(nonatomic) int preparedFrameCount; // @synthesize preparedFrameCount=_preparedFrameCount;
...
- (void).cxx_destruct;
- (struct CGRect)frameForItemAtIndex:(int)arg1 applyingOffset:(struct CGPoint)arg2;
