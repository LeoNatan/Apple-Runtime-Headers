...
@interface UICollectionLayoutGeometryGroup : NSObject <NSCopying>
{
    ...
    float _height;
    float _heightAsFractionOfContainerHeight;
    float _width;
    float _widthAsFractionOfContainerWidth;
    int _itemCountComputedToFit;
...
@property(nonatomic) int gridRowCount; // @synthesize gridRowCount=_gridRowCount;
...
@property(nonatomic) float bottomSpace; // @synthesize bottomSpace=_bottomSpace;
@property(nonatomic) float topSpace; // @synthesize topSpace=_topSpace;
@property(nonatomic) float trailingSpace; // @synthesize trailingSpace=_trailingSpace;
@property(nonatomic) float leadingSpace; // @synthesize leadingSpace=_leadingSpace;
@property(nonatomic) int maximumNumberOfItems; // @synthesize maximumNumberOfItems=_maximumNumberOfItems;
@property(nonatomic) int itemCountComputedToFit; // @synthesize itemCountComputedToFit=_itemCountComputedToFit;
@property(nonatomic) float widthAsFractionOfContainerWidth; // @synthesize widthAsFractionOfContainerWidth=_widthAsFractionOfContainerWidth;
...
@property(nonatomic) float heightAsFractionOfContainerHeight; // @synthesize heightAsFractionOfContainerHeight=_heightAsFractionOfContainerHeight;
...
- (float)_dimensionAlongLayoutAxisForContainerDimensions:(struct CGSize)arg1;
...
- (int)_orthogonalAlignmentOption;
- (int)_alignmentOption;
- (_Bool)_hasItemAlignmentSpecified;
- (void)_parseAttributes:(id)arg1;
- (id)_effectiveGroupItemForIndex:(int)arg1;
