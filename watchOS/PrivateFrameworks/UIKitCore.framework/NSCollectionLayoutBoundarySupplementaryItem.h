...
+ (id)boundarySupplementaryItemWithLayoutSize:(id)arg1 elementKind:(id)arg2 alignment:(int)arg3 absoluteOffset:(struct CGPoint)arg4;
+ (id)boundarySupplementaryItemWithLayoutSize:(id)arg1 elementKind:(id)arg2 alignment:(int)arg3;
...
- (id)initWithSize:(id)arg1 contentInsets:(struct NSDirectionalEdgeInsets)arg2 elementKind:(id)arg3 containerAnchor:(id)arg4 itemAnchor:(id)arg5 zIndex:(int)arg6 alignment:(int)arg7 offset:(struct CGPoint)arg8 extendsBoundary:(_Bool)arg9 pinToVisibleBounds:(_Bool)arg10;
