...
@class CADisplayLink, NSHashTable, UIView, _UIPreviewInteractionStateRecognizer;
...
- (void)_updateHighlighter:(float)arg1;
- (void)_prepareHighlighterIfNeeded;
- (_Bool)_shouldCancelTransitionToState:(int)arg1;
...
- (void)_updateInteractionStateRecognizerForTouchForce:(float)arg1 atTimestamp:(double)arg2 withCentroidAtLocation:(struct CGPoint)arg3;
