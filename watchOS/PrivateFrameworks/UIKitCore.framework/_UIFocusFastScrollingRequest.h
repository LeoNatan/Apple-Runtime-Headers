...
@property(nonatomic) unsigned int allowedHeadings; // @synthesize allowedHeadings=_allowedHeadings;
@property(nonatomic) unsigned int heading; // @synthesize heading=_heading;
