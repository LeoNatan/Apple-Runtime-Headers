...
@class NSString, UILongPressGestureRecognizer, UITapGestureRecognizer, UIView, UIView<UIActionSheetPresentationControllerDismissActionView>, _UIAnimationCoordinator, _UIDimmingKnockoutBackdropView;
...
- (CDStruct_8662c974)_currentLayoutGeometry;
...
- (void)_updateForKeyboardStartFrame:(struct CGRect)arg1 endFrame:(struct CGRect)arg2 duration:(double)arg3 curve:(int)arg4;
