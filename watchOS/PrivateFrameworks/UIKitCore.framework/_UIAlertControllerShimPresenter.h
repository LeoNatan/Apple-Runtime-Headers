...
- (void)_presentAlertControllerFromRect:(struct CGRect)arg1 inView:(id)arg2 direction:(unsigned int)arg3 animated:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
