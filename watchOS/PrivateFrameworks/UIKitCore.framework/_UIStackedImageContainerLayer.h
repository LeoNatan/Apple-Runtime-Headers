...
@interface _UIStackedImageContainerLayer : CALayer <CALayerDelegate>
{
    ...
    unsigned int _layerStackInflationSeed;
...
- (struct CATransform3D)_fixedFrameTransformForDepth:(float)arg1 fudgeFactor:(float)arg2;
...
- (id)_contentLayers;
- (void)_setLayerStackInflated:(_Bool)arg1 seed:(unsigned int)arg2;
...
- (void)_setControlState:(unsigned int)arg1 animated:(_Bool)arg2 focusAnimationCoordinator:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (void)setControlState:(unsigned int)arg1 animated:(_Bool)arg2 focusAnimationCoordinator:(id)arg3;
