...
- (int)_defaultPresentationPriority;
...
- (id)snapshotContext;
- (id)createPresenterForLayerTarget:(id)arg1 identifier:(id)arg2 priority:(int)arg3;
- (id)createPresenterForLayerTarget:(id)arg1 identifier:(id)arg2;
- (id)createPresenterWithIdentifier:(id)arg1 priority:(int)arg2;
