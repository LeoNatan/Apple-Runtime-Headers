...
- (void)setGroupNeighbor:(unsigned int)arg1;
- (unsigned int)groupNeighbor;
...
- (void)shiftRowAndResizeLeadingControlKey:(id)arg1 toSize:(struct CGSize)arg2 scale:(float)arg3;
- (void)replaceKey:(id)arg1 withKey:(id)arg2;
- (void)removeKey:(id)arg1 andShiftKeys:(id)arg2 scale:(float)arg3;
...
- (void)_mutateKeys:(id)arg1 scale:(float)arg2 withShapeOperation:(CDUnknownBlockType)arg3;
...
- (id)shapeFromFrame:(struct CGRect)arg1 leftPadding:(float)arg2 rightPadding:(float)arg3;
...
- (_Bool)isLeafType;
- (void)elaborateLayoutWithSize:(struct CGSize)arg1 scale:(float)arg2 origin:(struct CGPoint)arg3;
