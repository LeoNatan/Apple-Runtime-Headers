...
@property(nonatomic) float spacePanDistance; // @synthesize spacePanDistance=_spacePanDistance;
...
@property(nonatomic) int panGestureState; // @synthesize panGestureState=_panGestureState;
@property(nonatomic) int previousRepeatedGranularity; // @synthesize previousRepeatedGranularity=_previousRepeatedGranularity;
