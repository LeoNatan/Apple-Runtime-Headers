...
#import "_UINavigationBarGestureHandlerDelegate.h"
...
- (int)_shim_backdropStyle;
- (float)_shim_backgroundHeight;
...
- (void)_wrapView:(id)arg1 inClippingViewWithLeftBoundary:(float)arg2 rightBoundary:(float)arg3 leftMaskImage:(id)arg4 leftMaskIsChevron:(_Bool)arg5 rightMaskImage:(id)arg6;
...
- (void)_getTitleViewFrame:(struct CGRect *)arg1 leftViewFrames:(id)arg2 rightViewFrames:(id)arg3 forPreviousItem:(id)arg4 item:(id)arg5 returnedIdealWidthOfTextContent:(float *)arg6 availableLayoutWidthForTextContent:(float *)arg7 idealBackButtonWidth:(float *)arg8;
- (void)_getLeftMargin:(float *)arg1 rightMargin:(float *)arg2 forNavigationItem:(id)arg3 showingBackButton:(_Bool)arg4 visualStyle:(id)arg5;
- (id)_defaultTitleFontForItem:(id)arg1 fittingHeight:(float)arg2 withScaleAdjustment:(float)arg3;
