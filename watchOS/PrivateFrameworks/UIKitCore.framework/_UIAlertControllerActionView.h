...
- (void)_updateTextAlignmentForHavingDescriptiveText:(_Bool)arg1 titleTextAlignment:(int)arg2;
- (void)_updateImageMargins;
- (void)_updateMinimumHeight;
- (void)updateHeightUsingAXEnforcedWidth:(float)arg1;
