...
- (struct UIEdgeInsets)_baseInsetsForBottomEdgeAccessoryWithBoundingPathEdgesToUse:(unsigned int)arg1 safeAreaInsets:(struct UIEdgeInsets)arg2 bounds:(struct CGRect)arg3 scale:(float)arg4 accessoryHeight:(float)arg5 additionalInsetFromEdge:(float)arg6;
- (struct UIEdgeInsets)_baseInsetsForTrailingEdgeAccessoryWithBoundingPathEdgesToUse:(unsigned int)arg1 safeAreaInsets:(struct UIEdgeInsets)arg2 bounds:(struct CGRect)arg3 scale:(float)arg4 accessoryWidth:(float)arg5 additionalInsetFromEdge:(float)arg6;
