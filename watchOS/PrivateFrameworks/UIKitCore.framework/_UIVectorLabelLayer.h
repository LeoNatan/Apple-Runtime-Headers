...
@interface _UIVectorLabelLayer : CALayer <CALayerDelegate, CAAnimationDelegate>
{
    ...
    unsigned int _maxRenderedMoveDistance;
}

+ (void)initialize;
- (void).cxx_destruct;
@property(nonatomic) unsigned int maxRenderedMoveDistance; // @synthesize maxRenderedMoveDistance=_maxRenderedMoveDistance;
