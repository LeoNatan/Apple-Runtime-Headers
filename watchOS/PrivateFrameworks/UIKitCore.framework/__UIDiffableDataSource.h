...
@interface __UIDiffableDataSource : NSObject <UICollectionViewDataSource, UITableViewDataSource>
{
    ...
    unsigned int _mutationQueueSource;
...
@property unsigned int mutationQueueSource; // @synthesize mutationQueueSource=_mutationQueueSource;
...
- (int)_numberOfRowsInSection:(int)arg1 tableView:(id)arg2;
- (int)_numberOfSectionsForTableView:(id)arg1;
...
- (int)_numberOfItemsInSectionDeprecatedSPI:(int)arg1 collectionView:(id)arg2;
- (int)_numberOfSectionsForCollectionViewDeprecatedSPI:(id)arg1;
...
- (int)_numberOfItemsInSection:(int)arg1 collectionView:(id)arg2;
- (int)_numberOfSectionsForCollectionView:(id)arg1;
...
- (int)indexOfSectionIdentifier:(id)arg1;
...
- (int)numberOfItemsInSection:(id)arg1;
