...
- (_Bool)webView:(WebView *)arg1 shouldChangeSelectedDOMRange:(DOMRange *)arg2 toDOMRange:(DOMRange *)arg3 affinity:(unsigned int)arg4 stillSelecting:(_Bool)arg5;
- (_Bool)webView:(WebView *)arg1 shouldDeleteDOMRange:(DOMRange *)arg2;
- (_Bool)webView:(WebView *)arg1 shouldInsertText:(NSString *)arg2 replacingDOMRange:(DOMRange *)arg3 givenAction:(int)arg4;
- (_Bool)webView:(WebView *)arg1 shouldInsertNode:(DOMNode *)arg2 replacingDOMRange:(DOMRange *)arg3 givenAction:(int)arg4;
