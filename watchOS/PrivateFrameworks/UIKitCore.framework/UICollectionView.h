...
@interface UICollectionView : UIScrollView <_UIHorizontalIndexTitleBarDelegate, _UIKeyboardAutoRespondingScrollView, _UIDataSourceBackedView, UIDataSourceTranslating>
{
    ...
    int _performUsingPresentationValuesRefCount;
...
@property(nonatomic) int reorderingCadence; // @synthesize reorderingCadence=_reorderingCadence;
...
- (void)_completeInteractiveMovementWithDisposition:(int)arg1 completion:(CDUnknownBlockType)arg2;
...
- (id)_layoutAttributesForFailedMovementWithHeading:(unsigned int)arg1;
...
- (void)_updateWithUpdates:(id)arg1 updateAction:(int)arg2;
- (void)_updateRowsAtIndexPaths:(id)arg1 updateAction:(int)arg2;
- (void)_moveSection:(int)arg1 toSection:(int)arg2;
...
- (id)_reusableViewWithoutAttributesForElementCategory:(unsigned int)arg1 kind:(id)arg2 indexPath:(id)arg3;
...
- (void)_prepareViewForUse:(id)arg1 withElementCategory:(unsigned int)arg2 elementKind:(id)arg3 reuseIdentifier:(id)arg4 indexPath:(id)arg5 applyDefaultAttributes:(_Bool)arg6;
...
- (id)_indexPathForEntryWithTitle:(id)arg1 atIndex:(int)arg2;
...
- (void)scrollToItemAtIndexPath:(id)arg1 atScrollPosition:(unsigned int)arg2 animated:(_Bool)arg3;
- (struct CGPoint)_contentOffsetForScrollingToItemAtIndexPath:(id)arg1 atScrollPosition:(unsigned int)arg2 itemFrame:(struct CGRect)arg3 containingScrollView:(id)arg4;
- (struct CGPoint)_contentOffsetForScrollingToItemAtIndexPath:(id)arg1 atScrollPosition:(unsigned int)arg2;
...
- (id)_indexPathForView:(id)arg1 ofType:(unsigned int)arg2 includePrefetchedCells:(_Bool)arg3;
...
- (id)_doubleSidedAnimationsForView:(id)arg1 withStartingLayoutAttributes:(id)arg2 startingLayout:(id)arg3 endingLayoutAttributes:(id)arg4 endingLayout:(id)arg5 withAnimationSetup:(CDUnknownBlockType)arg6 animationCompletion:(CDUnknownBlockType)arg7 enableCustomAnimations:(_Bool)arg8 customAnimationsType:(unsigned int)arg9;
...
- (unsigned int)_updateVisibleCellsNow:(_Bool)arg1;
...
- (unsigned int)_prefetchItemsForPrefetchingContext:(id)arg1 maxItemsToPrefetch:(unsigned int)arg2;
...
- (void)_setPrefetchingContext:(id)arg1 forOrthogonalScrollingSection:(int)arg2;
- (id)_prefetchingContextForOrthogonalScrollingSection:(int)arg1;
...
- (void)_addControlledSubview:(id)arg1 atZIndex:(int)arg2 forced:(_Bool)arg3 initialAttributes:(id)arg4;
- (void)_addControlledSubview:(id)arg1 atZIndex:(int)arg2 forced:(_Bool)arg3;
...
- (_Bool)_highlightItemAtIndexPath:(id)arg1 animated:(_Bool)arg2 scrollPosition:(unsigned int)arg3;
- (_Bool)_highlightItemAtIndexPath:(id)arg1 animated:(_Bool)arg2 scrollPosition:(int)arg3 notifyDelegate:(_Bool)arg4;
...
- (void)_selectItemAtIndexPath:(id)arg1 animated:(_Bool)arg2 scrollPosition:(unsigned int)arg3 notifyDelegate:(_Bool)arg4 deselectPrevious:(_Bool)arg5;
- (void)_selectItemAtIndexPath:(id)arg1 animated:(_Bool)arg2 scrollPosition:(unsigned int)arg3 notifyDelegate:(_Bool)arg4;
