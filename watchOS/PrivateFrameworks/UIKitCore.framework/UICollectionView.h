...
- (unsigned int)_prefetchItemsForVelocity:(struct CGVector)arg1 maxItemsToPrefetch:(unsigned int)arg2 invalidateCandidatesOnDirectionChanges:(_Bool)arg3;
- (unsigned int)_prefetchItemsForVelocity:(struct CGVector)arg1 maxItemsToPrefetch:(unsigned int)arg2;
