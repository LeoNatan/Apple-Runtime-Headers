...
@property(nonatomic, setter=_setPopoverBackgroundStyle:) int _popoverBackgroundStyle;
...
@property(nonatomic, getter=_arrowOffset, setter=_setArrowOffset:) float _arrowOffset;
