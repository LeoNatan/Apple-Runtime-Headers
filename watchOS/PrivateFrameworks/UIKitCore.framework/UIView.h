...
@interface UIView : UIResponder <NSISVariableDelegate, _UILayoutItem, _UIMultilineTextContentSizing, NSISEngineDelegate, UITextEffectsOrdering, UILayoutItem_Internal, _UIScrollViewScrollObserver_Internal, _UITraitEnvironmentInternal, _UIFocusItemInternal, _UIFocusItemDebuggable, _UIFocusRegionContainerInternal, _UILegacyFocusRegion, _UIGeometryChangeObserver, _UIFocusEnvironmentPrivate, _UIFocusRegionContainer, NSCoding, UIAppearance, UIAppearanceContainer, UIDynamicItem, UITraitEnvironment, UICoordinateSpace, UIFocusItem, UIFocusItemContainer, CALayerDelegate>
{
    ...
    int _imminentLayoutSubviewsCount;
    int _retainCount;
...
+ (void)setAnimationTransition:(int)arg1 forView:(id)arg2 cache:(_Bool)arg3;
...
+ (void)_completeAnimationWithUUID:(id)arg1 duration:(double)arg2 curve:(int)arg3 reverse:(_Bool)arg4;
...
+ (void)animateWithInteractionProgress:(id)arg1 options:(unsigned int)arg2 animations:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;
...
+ (void)_animateUsingSpringWithDampingRatio:(float)arg1 response:(float)arg2 tracking:(_Bool)arg3 initialDampingRatio:(float)arg4 initialResponse:(float)arg5 dampingRatioSmoothing:(float)arg6 responseSmoothing:(float)arg7 targetSmoothing:(float)arg8 projectionDeceleration:(float)arg9 animations:(CDUnknownBlockType)arg10 completion:(CDUnknownBlockType)arg11;
+ (void)_animateUsingSpringWithDampingRatio:(float)arg1 response:(float)arg2 tracking:(_Bool)arg3 dampingRatioSmoothing:(float)arg4 responseSmoothing:(float)arg5 targetSmoothing:(float)arg6 projectionDeceleration:(float)arg7 retargetImpulse:(float)arg8 animations:(CDUnknownBlockType)arg9 completion:(CDUnknownBlockType)arg10;
+ (void)_animateUsingSpringWithDampingRatio:(float)arg1 response:(float)arg2 tracking:(_Bool)arg3 dampingRatioSmoothing:(float)arg4 responseSmoothing:(float)arg5 targetSmoothing:(float)arg6 projectionDeceleration:(float)arg7 animations:(CDUnknownBlockType)arg8 completion:(CDUnknownBlockType)arg9;
+ (void)__animateUsingSpringWithDampingRatio:(float)arg1 response:(float)arg2 interactive:(_Bool)arg3 initialDampingRatio:(id)arg4 initialResponse:(id)arg5 dampingRatioSmoothing:(float)arg6 responseSmoothing:(float)arg7 targetSmoothing:(float)arg8 projectionDeceleration:(float)arg9 retargetImpulse:(float)arg10 animations:(CDUnknownBlockType)arg11 completion:(CDUnknownBlockType)arg12;
...
+ (void)_animateUsingSpringWithTension:(float)arg1 friction:(float)arg2 interactive:(_Bool)arg3 animations:(CDUnknownBlockType)arg4 completion:(CDUnknownBlockType)arg5;
...
@property(nonatomic) int semanticContentAttribute; // @synthesize semanticContentAttribute=_semanticContentAttribute;
@property(nonatomic) unsigned int _countOfFocusedAncestorTrackingViewsInSubtree; // @synthesize _countOfFocusedAncestorTrackingViewsInSubtree;
...
@property(readonly, nonatomic) int effectiveUserInterfaceLayoutDirection;
...
@property(readonly, nonatomic, getter=_focusTouchSensitivityStyle) int focusTouchSensitivityStyle;
...
@property(nonatomic, setter=_setContinuousCornerRadius:) float _continuousCornerRadius;
- (id)maskView;
...
- (void)_accessibilitySetResolvedInterfaceStyle:(unsigned int)arg1;
- (unsigned int)_accessibilityResolvedInterfaceStyle;
- (unsigned int)_accessibilityResolvedInterfaceStyleForCurrentPreference;
- (void)_accessibilitySetInterfaceStyleIntent:(unsigned int)arg1;
- (unsigned int)_accessibilityInterfaceStyleIntent;
...
- (unsigned int)edgesInsettingLayoutMarginsFromSafeArea;
- (void)setEdgesInsettingLayoutMarginsFromSafeArea:(unsigned int)arg1;
- (_Bool)preservesSuperviewLayoutMargins;
- (void)setPreservesSuperviewLayoutMargins:(_Bool)arg1;
- (unsigned int)edgesPreservingSuperviewLayoutMargins;
- (void)setEdgesPreservingSuperviewLayoutMargins:(unsigned int)arg1;
...
- (unsigned int)_edgesPreservingSuperviewLayoutMarginsOfAncestor:(id)arg1;
...
@property(readonly, nonatomic) int _pendingHiddenCount;
- (void)_decrementHiddenManagedByLayoutArrangementCount;
- (void)_incrementHiddenManagedByLayoutArrangementCount;
@property(readonly, nonatomic) int _hiddenManagedByLayoutArrangementCount;
- (_Bool)_bitFlagValueAfterIncrementingHiddenManagementCountForKey:(const char *)arg1 withIncrement:(int)arg2 bitFlagValue:(_Bool)arg3;
- (int)_hiddenManagementCountForKey:(const char *)arg1 bitFlagValue:(_Bool)arg2;
...
- (float)_findAutolayoutHeightConstraint;
...
- (id)_edgeExpressionInContainer:(id)arg1 vertical:(_Bool)arg2 max:(_Bool)arg3 contentInsetScale:(float)arg4 engine:(id)arg5;
...
- (_Bool)_old_nsli_lowerAttribute:(int)arg1 intoExpression:(id)arg2 withCoefficient:(float)arg3 forConstraint:(id)arg4;
...
- (void)_recursiveCollectTemporaryInternalConstraintsWithEngine:(id)arg1 ignoreAutoresizingMaskConstraints:(_Bool)arg2 returningConstraintsForViewsNeedingSecondPass:(id *)arg3 currentTargetWidth:(float)arg4;
- (void)_makeTemporaryInternalConstraintsWithEngine:(id)arg1 ignoreAutoresizingMaskConstraints:(_Bool)arg2 returningConstraintsForViewsNeedingSecondPass:(id *)arg3 currentTargetWidth:(float)arg4;
...
@property(nonatomic, setter=_setDisableLayoutFlushingCount:) int _disableLayoutFlushingCount;
...
- (void)_resetLayoutEngineHostConstraintsForAxis:(int)arg1 collectingViews:(id)arg2;
...
- (_Bool)_uiib_tryToAddConstraint:(id)arg1 roundingAdjustment:(float)arg2 mutuallyExclusiveConstraints:(id *)arg3;
- (_Bool)_tryToAddConstraint:(id)arg1 roundingAdjustment:(float)arg2 mutuallyExclusiveConstraints:(id *)arg3;
- (_Bool)_tryToAddConstraintWithoutUpdatingConstraintsArray:(id)arg1 roundingAdjustment:(float)arg2 mutuallyExclusiveConstraints:(id *)arg3;
- (id)constraints;
- (void)_layoutEngine_willRemoveLayoutConstraint:(id)arg1;
- (_Bool)_layoutEngine_didAddLayoutConstraint:(id)arg1 roundingAdjustment:(float)arg2 mutuallyExclusiveConstraints:(id *)arg3;
...
- (_Bool)nsli_lowerAttribute:(int)arg1 intoExpression:(id)arg2 withCoefficient:(float)arg3 forConstraint:(id)arg4 onBehalfOfLayoutGuide:(id)arg5;
...
@property(nonatomic, setter=_setMultilineContextWidth:) float _multilineContextWidth; // @dynamic _multilineContextWidth;
...
- (id)_baselineViewForConstraint:(id)arg1 forFirstItem:(_Bool)arg2 withOffset:(float *)arg3;
- (void)_setBaselineView:(id)arg1 offset:(float)arg2 forConstraint:(id)arg3 forFirstItem:(_Bool)arg4;
...
- (float)_paddingForBaselineSpacingFromEdge:(int)arg1 toNeighborEdge:(int)arg2;
...
- (float)_uiatom_currentScreenScale;
...
@property(readonly, nonatomic) int _keyboardOrientation;
...
- (void)_ensureViewsAreInstalledInRelativeOrder:(id *)arg1 viewCount:(int)arg2 insertionStartIndex:(int)arg3;
...
- (float)_preferredContentScaleFactorForScreenScale:(float)arg1;
...
- (id)_projectedTargetForKey:(id)arg1 decelerationFactor:(float)arg2;
...
- (void)_performUpdatesForPossibleChangesOfIdiom:(int)arg1 orScreen:(id)arg2 traverseHierarchy:(_Bool)arg3;
...
- (void)_willChangeToIdiom:(int)arg1 onScreen:(id)arg2 traverseHierarchy:(_Bool)arg3;
...
- (struct CGRect)_largestInscribedRectInBoundingPathWithCenter:(struct CGPoint)arg1 aspectRatio:(float)arg2;
- (struct CGRect)_inscribedRectInBoundingPathByInsettingRect:(struct CGRect)arg1 onEdges:(unsigned int)arg2 withOptions:(unsigned int)arg3;
...
@property(readonly, nonatomic) int _lfld_count;
