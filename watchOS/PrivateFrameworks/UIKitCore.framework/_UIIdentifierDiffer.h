...
- (void).cxx_destruct;
- (void)_performFoundationDiffWithOptions:(int)arg1;
- (void)_performHeckelDiffWithOptions:(int)arg1;
- (void)_performDiffWithOptions:(int)arg1;
...
- (void)performDiffWithOptions:(int)arg1;
- (void)performDiff;
