...
@class NSArray, NSDictionary, NSHashTable, NSLayoutManager, NSSet, NSString, UIResponder<UITextInput>, UITextChecker, UITextInputPasswordRules, UITextInputTraits, UITextPosition, UITextRange, UIView, UIView<UITextInput>, UIView<UITextInputPrivate>, _UIDictationAttachment, _UITextInputControllerTokenizer, _UITextKitTextRange, _UITextServiceSession, _UITextUndoManager, _UITextUndoOperationTyping;
...
- (unsigned int)_validCaretPositionFromCharacterIndex:(unsigned int)arg1 downstream:(_Bool)arg2;
