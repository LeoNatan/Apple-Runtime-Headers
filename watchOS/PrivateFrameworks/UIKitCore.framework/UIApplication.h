...
- (int)_preferredUserInterfaceStyle;
- (void)_setPreferredUserInterfaceStyle:(int)arg1 updateWallpaper:(_Bool)arg2;
- (void)_setPreferredUserInterfaceStyle:(int)arg1;
- (int)_systemUserInterfaceStyle;
- (void)_setSystemUserInterfaceStyle:(int)arg1;
...
- (_Bool)_prepareButtonEvent:(id)arg1 type:(int)arg2 phase:(int)arg3 timestamp:(double)arg4 force:(float)arg5 clickCount:(unsigned int)arg6 longClick:(_Bool)arg7;
- (_Bool)_prepareButtonEvent:(id)arg1 type:(int)arg2 phase:(int)arg3 timestamp:(double)arg4 force:(float)arg5;
- (_Bool)_prepareButtonEvent:(id)arg1 type:(int)arg2 phase:(int)arg3 timestamp:(double)arg4;
...
- (void)setStatusBarOrientation:(int)arg1 animationParameters:(id)arg2 notifySpringBoardAndFence:(_Bool)arg3 updateBlock:(CDUnknownBlockType)arg4;
- (void)setStatusBarOrientation:(int)arg1 animationParameters:(id)arg2 notifySpringBoardAndFence:(_Bool)arg3;
