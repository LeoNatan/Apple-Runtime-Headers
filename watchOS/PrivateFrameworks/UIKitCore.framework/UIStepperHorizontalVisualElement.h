...
- (void)_updateButton:(id)arg1 lowerBackgroundView:(id)arg2 upperBackgroundView:(id)arg3 highlightView:(id)arg4 lowerBackgroundImage:(id)arg5 upperBackgroundImage:(id)arg6 highlightImage:(id)arg7 onRight:(_Bool)arg8;
