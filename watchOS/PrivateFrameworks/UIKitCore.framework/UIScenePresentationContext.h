...
@property(readonly, nonatomic) unsigned int renderingMode;
...
@property(readonly, nonatomic) unsigned int presentedLayerTypes;
@property(readonly, nonatomic) unsigned int appearanceStyle;
