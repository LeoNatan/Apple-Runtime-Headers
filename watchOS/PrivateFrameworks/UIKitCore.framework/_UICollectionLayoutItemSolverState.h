...
@property(readonly, nonatomic) int supplementaryFrameCount; // @synthesize supplementaryFrameCount=_supplementaryFrameCount;
@property(readonly, nonatomic) int itemFrameCount; // @synthesize itemFrameCount=_itemFrameCount;
...
- (id)initWithSolutionFrames:(id)arg1 itemFrameCount:(int)arg2 supplementaryFrameCount:(int)arg3 availableLayoutSpaces:(id)arg4 solvedFittingFrame:(struct CGRect)arg5;
