...
+ (id)boundarySupplementaryItemWithSize:(id)arg1 elementKind:(id)arg2 alignment:(int)arg3 offset:(struct CGPoint)arg4;
+ (id)boundarySupplementaryItemWithSize:(id)arg1 elementKind:(id)arg2 alignment:(int)arg3;
- (void).cxx_destruct;
...
- (id)initWithSize:(id)arg1 elementKind:(id)arg2 alignment:(int)arg3 offset:(struct CGPoint)arg4 zIndex:(int)arg5 contentInsets:(struct NSDirectionalEdgeInsets)arg6 extendsBoundary:(_Bool)arg7 pinToVisibleBounds:(_Bool)arg8;
