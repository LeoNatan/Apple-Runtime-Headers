...
@class NSArray, NSIndexPath, NSMutableDictionary, NSString, NSTimer, UICellAccessoryManager, UIColor, UIControl, UIFocusGuide, UIFont, UIImage, UIImageView, UILabel, UILongPressGestureRecognizer, UIStoryboardPreviewingSegueTemplateStorage, UITextField, UIVisualEffect, _UIFloatingContentView, _UITableViewCellSeparatorView;
...
@interface UITableViewCell : UIView <UIScrollViewDelegate, _UILayoutEngineSuspending, UITableConstantsCellProviding, NSCoding, UIGestureRecognizerDelegate>
{
    ...
    float _previousImageAlignmentBaselineOffsetFromBottom;
    UIFont *_previousFontForImageAlignmentBaselineOffsetFromBottom;
    float _previousHeightForImageAlignmentBaselineOffsetFromBottom;
    ...
    float _defaultLeadingMarginWidth;
...
- (float)_verticalPaddingForSeparator;
...
- (void)_setIndexBarExtentFromEdge:(float)arg1;
- (float)_indexBarExtentFromEdge;
...
- (void)_setDefaultTrailingCellMarginWidth:(float)arg1;
- (float)_defaultLeadingMarginWidth;
- (void)_setDefaultLeadingMarginWidth:(float)arg1;
- (void)_setRightMarginWidth:(float)arg1;
- (float)_rightMarginWidth;
- (void)_setMarginWidth:(float)arg1;
- (float)_marginWidth;
- (float)_imageViewExtentFromCellLeadingEdge;
...
- (void)_animateInnerShadowForInsertion:(_Bool)arg1 withRowAnimation:(int)arg2;
- (void)_removeFloatingSeparator;
- (void)_animateFloatingSeparatorForInsertion:(_Bool)arg1 withRowAnimation:(int)arg2;
...
- (void)_setEditingControlTintColor:(id)arg1 forStyle:(int)arg2;
...
@property(readonly, nonatomic, getter=_cellStyle) int cellStyle;
- (int)style;
...
- (void)_setContentClipCorners:(unsigned int)arg1;
