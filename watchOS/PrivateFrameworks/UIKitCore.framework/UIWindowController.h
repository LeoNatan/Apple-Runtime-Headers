...
- (struct CGRect)_boundsForViewController:(id)arg1 transition:(int)arg2 orientation:(int)arg3 fullScreenLayout:(_Bool)arg4 inWindow:(id)arg5;
- (struct CGSize)_flipSize:(struct CGSize)arg1;
- (struct CGPoint)_originForViewController:(id)arg1 orientation:(int)arg2 actualStatusBarHeight:(float)arg3 fullScreenLayout:(_Bool)arg4 inWindow:(id)arg5;
- (void)dealloc;
