...
@property(nonatomic) unsigned int presentedLayerTypes; // @dynamic presentedLayerTypes;
@property(nonatomic) unsigned int appearanceStyle; // @dynamic appearanceStyle;
