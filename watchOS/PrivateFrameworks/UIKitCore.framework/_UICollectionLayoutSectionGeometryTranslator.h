...
- (id)initWithContentSize:(struct CGSize)arg1 layoutAxis:(unsigned int)arg2 layoutRTL:(_Bool)arg3 sectionInsets:(struct NSDirectionalEdgeInsets)arg4 supplementaryInsets:(struct NSDirectionalEdgeInsets)arg5;
