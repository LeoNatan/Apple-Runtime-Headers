...
- (id)_visibleFooterViewForSection:(int)arg1 includeTentativeViews:(_Bool)arg2;
- (id)_templateLayoutCellForCellsWithReuseIdentifier:(id)arg1;
- (id)_visibleFooterViewForSection:(int)arg1;
- (id)_visibleHeaderViewForSection:(int)arg1 includeTentativeViews:(_Bool)arg2;
...
- (_Bool)_shouldDrawSeparatorAtTopOfSection:(int)arg1;
...
- (float)_contentOffsetYForRestoringScrollPositionOfFirstVisibleRowWithContentInsetTop:(float)arg1;
