...
@interface UITableView : UIScrollView <UIGestureRecognizerDelegatePrivate, UIScrollViewDelegate, _UITableViewSubviewManagerDelegate, UISwipeActionHost, UITable_ForMailOnly, _UIKeyboardAutoRespondingScrollView, UITable_RowDataSource, UITable_UITableViewCellDelegate, _UIDataSourceBackedView, NSCoding, UIDataSourceTranslating>
{
    ...
    float _preReloadAnimationTargetOffsetDelta;
...
- (int)_dataSourceSectionIndexForPresentationSectionIndex:(int)arg1;
- (int)_presentationSectionIndexForDataSourceSectionIndex:(int)arg1;
...
- (void)swipeActionController:(id)arg1 swipeOccurrence:(id)arg2 didChangeStateFrom:(int)arg3 to:(int)arg4;
...
@property(readonly, nonatomic, getter=_defaultTrailingCellMarginWidth) float defaultTrailingCellMarginWidth;
@property(readonly, nonatomic, getter=_defaultLeadingCellMarginWidth) float defaultLeadingCellMarginWidth;
...
@property(nonatomic) int separatorInsetReference;
...
- (void)_setupCell:(id)arg1 forEditing:(_Bool)arg2 atIndexPath:(id)arg3 canEdit:(_Bool)arg4 editingStyle:(int)arg5 shouldIndentWhileEditing:(_Bool)arg6 showsReorderControl:(_Bool)arg7 accessoryType:(int)arg8 animated:(_Bool)arg9 updateSeparators:(_Bool)arg10;
- (id)_sectionFooterViewWithFrame:(struct CGRect)arg1 forSection:(int)arg2 floating:(_Bool)arg3 reuseViewIfPossible:(_Bool)arg4 willDisplay:(_Bool)arg5;
- (id)_sectionHeaderViewWithFrame:(struct CGRect)arg1 forSection:(int)arg2 floating:(_Bool)arg3 reuseViewIfPossible:(_Bool)arg4 willDisplay:(_Bool)arg5;
- (id)_sectionHeaderView:(_Bool)arg1 withFrame:(struct CGRect)arg2 forSection:(int)arg3 floating:(_Bool)arg4 reuseViewIfPossible:(_Bool)arg5 willDisplay:(_Bool)arg6;
...
- (_Bool)_delegateWantsCustomFooterForSection:(int)arg1;
- (_Bool)_delegateWantsFooterTitleForSection:(int)arg1;
- (_Bool)_delegateWantsFooterForSection:(int)arg1;
- (_Bool)_delegateImplementsMarginForTableView;
- (_Bool)_delegateWantsHeaderTitleForSection:(int)arg1;
- (_Bool)_delegateWantsHeaderForSection:(int)arg1;
...
- (void)_moveSectionIndexTitleIndexToIndex:(int)arg1 highlight:(_Bool)arg2;
...
- (void)_selectRowsAtIndexPaths:(id)arg1 animated:(_Bool)arg2 scrollPosition:(int)arg3 notifyDelegate:(_Bool)arg4;
...
- (_Bool)_shouldDrawSeparatorAtBottomOfSection:(int)arg1;
...
- (_Bool)_highlightRowAtIndexPath:(id)arg1 animated:(_Bool)arg2 scrollPosition:(int)arg3 usingPresentationValues:(_Bool)arg4;
- (_Bool)highlightRowAtIndexPath:(id)arg1 animated:(_Bool)arg2 scrollPosition:(int)arg3;
...
- (id)_updateRowsAtIndexPaths:(id)arg1 withUpdateAction:(int)arg2 rowAnimation:(int)arg3 usingPresentationValues:(_Bool)arg4;
- (void)moveSection:(int)arg1 toSection:(int)arg2;
- (id)_moveSection:(int)arg1 toSection:(int)arg2 usingPresentationValues:(_Bool)arg3;
...
- (id)_updateSections:(id)arg1 withUpdateAction:(int)arg2 rowAnimation:(int)arg3 headerFooterOnly:(_Bool)arg4 usingPresentationValues:(_Bool)arg5;
...
- (void)_scrollToRowAtIndexPath:(id)arg1 atScrollPosition:(int)arg2 animated:(_Bool)arg3 usingPresentationValues:(_Bool)arg4;
- (void)scrollToRowAtIndexPath:(id)arg1 atScrollPosition:(int)arg2 animated:(_Bool)arg3;
- (struct CGPoint)_contentOffsetForScrollingToRowAtIndexPath:(id)arg1 atScrollPosition:(int)arg2 usingPresentationValues:(_Bool)arg3;
...
- (id)_footerViewForSection:(int)arg1 usingPresentationValues:(_Bool)arg2;
- (id)footerViewForSection:(int)arg1;
- (id)_headerViewForSection:(int)arg1 usingPresentationValues:(_Bool)arg2;
- (id)headerViewForSection:(int)arg1;
- (int)_visibleSectionForSectionAdjustedForCurrentUpdate:(int)arg1;
- (int)_visibleGlobalRowForRowAtIndexPathAdjustedForCurrentUpdate:(id)arg1;
...
- (struct CGRect)_rectForFooterInSection:(int)arg1 usingPresentationValues:(_Bool)arg2;
- (struct CGRect)rectForFooterInSection:(int)arg1;
- (struct CGRect)_rectForHeaderInSection:(int)arg1 usingPresentationValues:(_Bool)arg2;
- (struct CGRect)rectForHeaderInSection:(int)arg1;
- (struct CGRect)_rectForSection:(int)arg1 usingPresentationValues:(_Bool)arg2;
- (struct CGRect)rectForSection:(int)arg1;
- (int)_numberOfRowsInSection:(int)arg1 usingPresentationValues:(_Bool)arg2;
- (int)numberOfRowsInSection:(int)arg1;
- (int)_numberOfSectionsUsingPresentationValues:(_Bool)arg1;
...
- (void)_restoreOrAdjustContentOffsetWithRowCount:(int)arg1 initialContentInsetTop:(float)arg2;
- (_Bool)_retargetScrollAnimation;
- (float)_contentOffsetYForRestoringScrollPositionOfFirstVisibleRowWithContentInsetTop:(float)arg1 canGuessHeights:(_Bool)arg2;
...
- (void)_applyAppearanceDefaultsForStyle:(int)arg1;
...
- (id)_newSectionViewWithFrame:(struct CGRect)arg1 forSection:(int)arg2 isHeader:(_Bool)arg3;
- (void)_setupSectionView:(id)arg1 isHeader:(_Bool)arg2 forSection:(int)arg3;
...
- (void)_removeIndex;
- (float)_cellIndexBarExtentFromEdge;
...
- (unsigned int)_edgesApplyingBaseInsetsToIndexBarInsets;
