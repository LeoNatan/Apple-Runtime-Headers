...
@property(nonatomic) float initialDistance; // @synthesize initialDistance=_initialDistance;
...
- (void)manuallyUpdateInteractionWithGestureState:(int)arg1 location:(struct CGPoint)arg2 locationOfFirstTouch:(struct CGPoint)arg3 forTouchType:(int)arg4;
- (void)_adjustmentInteractionCancelled;
- (void)_adjustmentInteractionEndedAtLocation:(struct CGPoint)arg1 forTouchType:(int)arg2;
- (void)_adjustmentInteractionChangedWithLocation:(struct CGPoint)arg1 forTouchType:(int)arg2;
- (void)_adjustmentInteractionBeganWithLocation:(struct CGPoint)arg1 startPoint:(struct CGPoint)arg2 forTouchType:(int)arg3;
- (void)_updateAdjustmentInteractionWithState:(int)arg1 location:(struct CGPoint)arg2 locationOfFirstTouch:(struct CGPoint)arg3 forTouchType:(int)arg4;
- (_Bool)_shouldApplyOffsetForTouchType:(int)arg1;
