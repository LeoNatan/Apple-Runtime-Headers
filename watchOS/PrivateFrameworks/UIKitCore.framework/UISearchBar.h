...
- (void)_getTopInset:(float *)arg1 bottomInset:(float *)arg2 forBarMetrics:(int)arg3 barPosition:(int)arg4;
...
- (id)_imageForSearchBarIcon:(int)arg1 state:(unsigned int)arg2 customImage:(_Bool *)arg3;
...
- (void)layoutSubviews;
- (void)_getScopeBarHeight:(float *)arg1 containerHeight:(float *)arg2;
...
- (float)_barHeightForBarMetrics:(int)arg1 withEffectiveInsets:(struct UIEdgeInsets)arg2;
