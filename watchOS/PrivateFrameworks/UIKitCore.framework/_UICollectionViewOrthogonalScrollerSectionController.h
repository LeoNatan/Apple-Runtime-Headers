...
- (void)_configureScrollView:(id)arg1 forSection:(int)arg2 baseContentInsets:(struct UIEdgeInsets)arg3;
...
- (void)_deleteSectionScrollView:(id)arg1 forSection:(int)arg2;
- (id)_addSectionScrollViewForSection:(int)arg1;
- (id)_addSectionScrollViewForIndexPath:(id)arg1;
- (id)_sectionScrollViewForSection:(int)arg1;
