...
@property(readonly, nonatomic) float offsetFromMagnificationPoint;
...
- (void)remove;
- (void)beginZoomDownAnimation:(CDUnknownBlockType)arg1 withDuration:(float)arg2 postponeHandler:(CDUnknownBlockType)arg3;
- (void)beginZoomUpAnimation:(CDUnknownBlockType)arg1 withDuration:(float)arg2;
