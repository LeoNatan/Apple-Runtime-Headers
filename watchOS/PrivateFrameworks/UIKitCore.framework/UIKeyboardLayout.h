...
#import "_UIViewRepresentingKeyboardLayout.h"
...
- (struct CGPoint)_uikbrtTouchDrifting:(id)arg1 touchCenterForFingerID:(unsigned int)arg2;
...
- (void)_updateTouchState:(id)arg1 errorVector:(struct CGPoint)arg2 rowOffsetFromHomeRow:(int)arg3;
...
- (_Bool)handRestRecognizerShouldNeverIgnoreTouchState:(id)arg1 fromPoint:(struct CGPoint)arg2 toPoint:(struct CGPoint)arg3 forRestingState:(unsigned int)arg4 otherRestedTouchLocations:(id)arg5;
...
- (_Bool)_shouldAllowKeyboardHandlingIfNecessaryForTouch:(id)arg1 phase:(int)arg2 withTouchState:(id)arg3 task:(CDUnknownBlockType)arg4;
...
- (_Bool)queryShouldNeverIgnoreTouchStateWithIdentifier:(id)arg1 touchState:(id)arg2 startPoint:(struct CGPoint)arg3 forRestingState:(unsigned int)arg4;
- (void)recognizer:(id)arg1 shouldContinueTrackingTouchWithId:(id)arg2 startingAt:(double)arg3 atPoint:(struct CGPoint)arg4 currentPoint:(struct CGPoint)arg5 forContinueState:(unsigned int)arg6 whenStateReady:(CDUnknownBlockType)arg7;
...
- (void)recognizer:(id)arg1 beginTouchDownForTouchWithId:(id)arg2 atPoint:(struct CGPoint)arg3 forBeginState:(unsigned int)arg4 whenStateReady:(CDUnknownBlockType)arg5;
