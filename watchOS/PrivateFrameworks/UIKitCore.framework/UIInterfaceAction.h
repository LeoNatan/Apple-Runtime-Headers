...
+ (id)actionWithTitle:(id)arg1 type:(int)arg2 handler:(CDUnknownBlockType)arg3;
...
@property(readonly, nonatomic) int _typeForDeterminingViewRepresentation;
...
- (id)description;
- (id)initWithTitle:(id)arg1 type:(int)arg2 customContentViewController:(id)arg3 customContentView:(id)arg4 handler:(CDUnknownBlockType)arg5;
