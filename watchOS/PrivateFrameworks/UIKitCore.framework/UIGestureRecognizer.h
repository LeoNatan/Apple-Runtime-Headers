...
- (void).cxx_destruct;
@property(nonatomic, getter=_wantsGESEvents, setter=_wantsGESEvents:) _Bool wantsGESEvents; // @synthesize wantsGESEvents=_wantsGESEvents;
...
@property(readonly, nonatomic) unsigned int numberOfTouches;
...
- (_Bool)_requiredPreviewForceStateSatisfiedByForceLevel:(int)arg1;
...
- (unsigned int)_inputPrecisionForEvents:(id)arg1;
- (_Bool)_shouldBegin;
...
- (id)_activeEventOfType:(int)arg1;
- (id)_activeEvents;
...
@property(nonatomic, setter=_setRecognitionEvent:) int _recognitionEvent;
