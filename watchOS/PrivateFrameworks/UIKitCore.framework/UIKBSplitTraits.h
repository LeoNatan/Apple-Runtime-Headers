...
+ (id)traitsWithLeftFrame:(struct CGRect)arg1 rightFrame:(struct CGRect)arg2 corners:(unsigned int)arg3;
@property(readonly, nonatomic) unsigned int corners; // @synthesize corners=_corners;
