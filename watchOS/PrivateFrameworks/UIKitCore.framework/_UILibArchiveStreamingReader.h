...
@interface _UILibArchiveStreamingReader : NSObject
{
    ...
    int _nextLoadedItemEntrySequenceIndex;
    NSMutableArray *_readableLoadedItemEntryQueue;
    NSError *_readError;
    NSString *_archivePath;
    struct ui_archive *_underlyingArchive;
    int _appleDoubleIdentificationType;
}

- (void).cxx_destruct;
@property(nonatomic) int appleDoubleIdentificationType; // @synthesize appleDoubleIdentificationType=_appleDoubleIdentificationType;
