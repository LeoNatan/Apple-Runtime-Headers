...
@interface _UIFocusFastScrollingRecognizer : NSObject <_UIFocusEnginePanGestureTouchObserver>
{
    ...
    unsigned int _spatialFocusUpdateCount;
    _Bool _enabled;
...
- (_Bool)_scrollViewIsEligibleForFastScrolling:(id)arg1 alongHeading:(unsigned int)arg2;
...
- (unsigned int)_bestHeadingForAccumulator:(struct CGVector)arg1;
