...
- (void)__hostViewWillAppear:(_Bool)arg1 inInterfaceOrientation:(int)arg2 traitCollection:(UITraitCollection *)arg3 statusBarHeight:(float)arg4 underlapsStatusBar:(_Bool)arg5 sheetConfiguration:(_UISheetPresentationControllerConfiguration *)arg6 completionHandler:(void (^)(struct CGSize))arg7;
