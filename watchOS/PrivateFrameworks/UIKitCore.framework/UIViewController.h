...
+ (_Bool)_allViewControllersInArray:(id)arg1 allowAutorotationToInterfaceOrientation:(int)arg2 predicate:(CDUnknownBlockType)arg3;
...
+ (void)initialize;
+ (float)_boundsWidthWithMinimumHorizontalContentMarginForView:(id)arg1 preservingContentWidth:(float)arg2;
+ (float)_slimHorizontalContentMargin;
+ (float)_horizontalContentMarginForView:(id)arg1;
+ (float)_horizontalContentMarginForView:(id)arg1 ofWidth:(float)arg2;
...
@property(nonatomic, setter=_setRightContentMargin:) float _rightContentMargin; // @synthesize _rightContentMargin;
@property(nonatomic, setter=_setLeftContentMargin:) float _leftContentMargin; // @synthesize _leftContentMargin;
...
@property(readonly, nonatomic) int preferredTrailingStatusBarStyle;
@property(readonly, nonatomic) int preferredLeadingStatusBarStyle;
...
- (void)getRotationContentSettings:(CDStruct_3af65568 *)arg1 forWindow:(id)arg2;
...
- (_Bool)__withSupportedInterfaceOrientation:(int)arg1 apply:(CDUnknownBlockType)arg2;
...
- (_Bool)_modalPresentationStyleRequiresTemporaryPopoverPresentationController:(int)arg1;
...
- (int)_transitionForModalTransitionStyle:(int)arg1 appearing:(_Bool)arg2;
...
@property(nonatomic) int overrideUserInterfaceStyle;
- (void)setPreferredUserInterfaceStyle:(int)arg1;
@property(readonly, nonatomic) int preferredUserInterfaceStyle;
...
- (SEL)_customSelectorToCreateChildViewControllerAtIndex:(int)arg1;
