...
@property(nonatomic, setter=_setKeyCode:) long keyCode; // @synthesize keyCode=_keyCode;
@property(nonatomic, setter=_setModifierFlags:) int modifierFlags; // @synthesize modifierFlags=_modifierFlags;
- (id)description;
