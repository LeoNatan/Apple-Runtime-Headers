...
@property(readonly, nonatomic) int numberOfRanges;
- (struct _NSRange)rangeAtIndex:(int)arg1;
- (int)indexOfRangeContainingLocation:(int)arg1;
- (struct _NSRange)rangeContainingLocation:(int)arg1;
