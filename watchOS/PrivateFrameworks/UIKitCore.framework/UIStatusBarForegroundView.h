...
- (_Bool)_tryToPlaceItem:(id)arg1 inItemArray:(id)arg2 layoutManager:(id)arg3 roomRemaining:(float *)arg4 allowSwap:(_Bool)arg5 swappedItem:(id *)arg6;
