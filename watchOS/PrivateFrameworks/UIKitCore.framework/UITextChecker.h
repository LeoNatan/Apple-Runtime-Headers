...
- (struct _NSRange)checkGrammarOfString:(id)arg1 startingAt:(int)arg2 language:(id)arg3 wrap:(_Bool)arg4 details:(id *)arg5;
- (struct _NSRange)checkSpellingOfString:(id)arg1 startingAt:(int)arg2 languages:(id)arg3 wrap:(_Bool)arg4 correction:(id *)arg5;
- (struct _NSRange)checkSpellingOfString:(id)arg1 startingAt:(int)arg2 language:(id)arg3 wrap:(_Bool)arg4 correction:(id *)arg5;
- (struct _NSRange)rangeOfMisspelledWordInString:(id)arg1 range:(struct _NSRange)arg2 startingAt:(int)arg3 wrap:(_Bool)arg4 language:(id)arg5;
- (struct _NSRange)rangeOfMisspelledWordInString:(id)arg1 range:(struct _NSRange)arg2 startingAt:(int)arg3 wrap:(_Bool)arg4 languages:(id)arg5;
- (struct _NSRange)_chunkAndFindMisspelledWordInString:(id)arg1 languages:(id)arg2 learnedDictionaries:(id)arg3 wordCount:(int *)arg4 correction:(id *)arg5 usingChecker:(id)arg6;
