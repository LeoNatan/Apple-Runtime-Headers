...
@interface IMEmbeddedHardwareJPEGTranscoder : NSObject
{
    ...
    float _targetJPEGCompressionValue;
}

@property(nonatomic) _Bool stripImageMetadata; // @synthesize stripImageMetadata=_stripImageMetadata;
@property(nonatomic) float targetJPEGCompressionValue; // @synthesize targetJPEGCompressionValue=_targetJPEGCompressionValue;
