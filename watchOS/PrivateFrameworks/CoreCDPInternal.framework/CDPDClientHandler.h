...
- (void)localSecretChangedTo:(id)arg1 secretType:(unsigned int)arg2 context:(id)arg3 uiProvider:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)attemptToEscrowPreRecord:(id)arg1 context:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)attemptToEscrowPreRecord:(id)arg1 preRecordUUID:(id)arg2 secretType:(unsigned int)arg3 context:(id)arg4 completion:(CDUnknownBlockType)arg5;
