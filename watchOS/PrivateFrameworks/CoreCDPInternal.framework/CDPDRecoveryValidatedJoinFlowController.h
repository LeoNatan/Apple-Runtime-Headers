...
- (void)_showEntryLimitError:(id)arg1 withRecoveryOptionHandlers:(id)arg2 defaultIndex:(int)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)_handleLimit:(unsigned int)arg1 forDevice:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (unsigned int)_escapeOfferForDevices:(id)arg1 remoteApproval:(_Bool)arg2 forMultipleICSC:(_Bool)arg3;
