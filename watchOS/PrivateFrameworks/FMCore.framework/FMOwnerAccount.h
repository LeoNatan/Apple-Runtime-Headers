...
+ (id)ownerAccountWithType:(int)arg1;
+ (id)ownerAccount;
+ (id)personIdForAccount:(id)arg1 error:(id *)arg2;
+ (id)primaryAccountWithStore:(id)arg1 error:(id *)arg2;
+ (id)subAccountForAccount:(id)arg1 type:(int)arg2;
+ (id)hostNameForAccount:(id)arg1 type:(int)arg2;
+ (id)authTokenForSubAccount:(id)arg1 type:(int)arg2 error:(id *)arg3;
+ (id)sharedInstance;
- (void).cxx_destruct;
