...
- (id)_sendProtobuf:(id)arg1 priority:(int)arg2 responseIdentifier:(id)arg3 expectsResponse:(_Bool)arg4 bypassingDuet:(_Bool)arg5 deviceID:(id)arg6;
...
- (id)_sendMessageWithProtobuf:(id)arg1 inResponseToRequest:(id)arg2 withPriority:(int)arg3 timeout:(double)arg4 bypassingDuet:(_Bool)arg5 deviceID:(id)arg6 responseHandler:(CDUnknownBlockType)arg7;
- (void)sendMessageWithProtobuf:(id)arg1 inResponseToRequest:(id)arg2 withPriority:(int)arg3 timeout:(double)arg4 bypassingDuet:(_Bool)arg5 deviceID:(id)arg6 requestAcceptedHandler:(CDUnknownBlockType)arg7 responseHandler:(CDUnknownBlockType)arg8;
- (void)sendMessageWithProtobuf:(id)arg1 inResponseToRequest:(id)arg2 withPriority:(int)arg3 timeout:(double)arg4 bypassingDuet:(_Bool)arg5 requestAcceptedHandler:(CDUnknownBlockType)arg6 responseHandler:(CDUnknownBlockType)arg7;
