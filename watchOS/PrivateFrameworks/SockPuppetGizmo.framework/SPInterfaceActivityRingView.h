...
@class HKActivityRingView, NSBundle, NSDictionary, NSString;

@interface SPInterfaceActivityRingView : UIView <SPInterfaceItem>
{
    ...
    HKActivityRingView *_hkRingView;
    struct CGSize _interfacePlistSize;
    struct CGSize _cachedContainerSize;
    struct CGSize _cachedSize;
}

@property(retain, nonatomic) HKActivityRingView *hkRingView; // @synthesize hkRingView=_hkRingView;
