...
@class NSBundle, NSDictionary, NSString, PKPaymentButton;

@interface SPInterfacePayButton : UIControl <SPInterfaceActionItem>
{
    ...
    PKPaymentButton *_buttonControl;
    id _target;
    SEL _action;
...
@property(retain, nonatomic) PKPaymentButton *buttonControl; // @synthesize buttonControl=_buttonControl;
