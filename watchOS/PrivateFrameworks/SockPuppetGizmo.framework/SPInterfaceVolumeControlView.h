...
#import <SockPuppetGizmo/NACVolumeControllerDelegate-Protocol.h>
#import <SockPuppetGizmo/PUICSliderDelegate-Protocol.h>
#import <SockPuppetGizmo/SPInterfaceItem-Protocol.h>

@class NMUVolumeControlsView, NSBundle, NSDictionary, NSString;
@protocol NACVolumeController;

@interface SPInterfaceVolumeControlView : UIView <NACVolumeControllerDelegate, PUICSliderDelegate, SPInterfaceItem>
{
...
- (void)setupVolumeControllerForLocalVolume:(_Bool)arg1;
- (void)dealloc;
