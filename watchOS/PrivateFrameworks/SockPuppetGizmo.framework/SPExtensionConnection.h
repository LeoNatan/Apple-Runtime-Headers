...
#import <SockPuppetGizmo/NSXPCListenerDelegate-Protocol.h>
#import <SockPuppetGizmo/SPApplicationRemoteProtocol-Protocol.h>
#import <SockPuppetGizmo/SPGizmoApplicationProtocol-Protocol.h>
...
- (void)interfaceViewController:(id)arg1 setTimerSupportVC:(id)arg2;
...
- (void)interfaceViewController:(id)arg1 receivePresentTimerSupportInterfaceWithControllerClass:(Class)arg2 presentCompletion:(CDUnknownBlockType)arg3 dismissCompletion:(CDUnknownBlockType)arg4;
- (void)interfaceViewController:(id)arg1 receivePushTimerSupportInterfaceWithControllerClass:(Class)arg2 completion:(CDUnknownBlockType)arg3;
- (void)interfaceViewController:(id)arg1 receivePushTimerSupportInterfaceWithName:(id)arg2 initializationContextID:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (id)timerSupportActionItemsForInterfaceController:(id)arg1;
