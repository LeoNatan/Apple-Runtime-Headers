...
@class CSLSBacklightAssertion, LSApplicationProxy, NSArray, NSDictionary, NSMutableArray, NSObject<OS_dispatch_queue>, NSString, NSXPCConnection, NSXPCListener, SPInProcessNotificationDelegate, SPLongFormAudioServerConnection, SPRemoteInterface;
...
- (void)requestRemoteNotificationViewServiceForHost:(id)arg1 hostID:(id)arg2 bulletinUniqueID:(id)arg3 completion:(CDUnknownBlockType)arg4;
