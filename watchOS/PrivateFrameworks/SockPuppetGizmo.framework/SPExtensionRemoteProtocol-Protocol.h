...
- (void)interfaceContentSafeAreaInsets:(NSString *)arg1 withValue:(struct UIEdgeInsets)arg2;
...
- (void)requestNotificationViewServiceForHost:(id <SPRemoteNotificationViewHost>)arg1 hostID:(NSString *)arg2 clientIdentifier:(NSString *)arg3 bulletinUniqueID:(NSString *)arg4 classicMode:(_Bool)arg5 completion:(void (^)(id <SPRemoteNotificationViewService>, unsigned int))arg6;
