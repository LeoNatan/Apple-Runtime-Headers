...
#import "SPInterfaceViewControllerPreloadDelegate.h"
#import "UIScrollViewDelegate.h"

@class NSArray, NSMutableArray, NSMutableSet, NSString, PUICPageIndicatorView, PUICStatusBarCubicTitleView, UIScrollView;

@interface SPPageViewController : UIViewController <UIScrollViewDelegate, SPInterfaceViewControllerPreloadDelegate>
{
    _Bool _vertical;
    _Bool _hasAppeared;
