...
- (id)description;
- (id)settingOutputDeviceUIDAtIndex:(unsigned int)arg1;
- (unsigned int)settingOutputDeviceUIDsCount;
- (void)addSettingOutputDeviceUID:(id)arg1;
- (void)clearSettingOutputDeviceUIDs;
- (id)removingOutputDeviceUIDAtIndex:(unsigned int)arg1;
- (unsigned int)removingOutputDeviceUIDsCount;
- (void)addRemovingOutputDeviceUID:(id)arg1;
- (void)clearRemovingOutputDeviceUIDs;
- (id)addingOutputDeviceUIDAtIndex:(unsigned int)arg1;
- (unsigned int)addingOutputDeviceUIDsCount;
