...
@interface MRPlaybackSessionMigrateRequest : NSObject
{
    ...
    long _playerOptions;
    long _endpointOptions;
    NSString *_identifier;
}

@property(retain, nonatomic) NSString *identifier; // @synthesize identifier=_identifier;
@property(nonatomic) long endpointOptions; // @synthesize endpointOptions=_endpointOptions;
@property(nonatomic) long playerOptions; // @synthesize playerOptions=_playerOptions;
- (void).cxx_destruct;
