...
@interface MRDeviceInfo : NSObject
{
    ...
    unsigned int _groupLogicalDeviceCount;
...
@property(nonatomic) unsigned int groupLogicalDeviceCount; // @synthesize groupLogicalDeviceCount=_groupLogicalDeviceCount;
...
@property(readonly, nonatomic) unsigned int groupedDeviceCount; // @synthesize groupedDeviceCount=_groupedDeviceCount;
