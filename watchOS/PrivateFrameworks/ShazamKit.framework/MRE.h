...
- (id)initWithBundle:(id)arg1 cacheDir:(id)arg2 density:(int)arg3 bufferSize:(int)arg4 error:(id *)arg5;
- (id)initWithBundle:(id)arg1 cacheDir:(id)arg2 density:(int)arg3 error:(id *)arg4;
- (id)initWithSignatures:(id)arg1 density:(int)arg2 error:(id *)arg3;
