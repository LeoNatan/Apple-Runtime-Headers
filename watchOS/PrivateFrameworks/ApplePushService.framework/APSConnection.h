...
- (void)_deliverOutgoingMessageResultWithID:(unsigned int)arg1 error:(id)arg2 sendRTT:(unsigned int)arg3;
- (void)_deliverOutgoingMessageResultWithID:(unsigned int)arg1 checkpointTraceData:(id)arg2 error:(id)arg3 sendRTT:(unsigned int)arg4 ackTimestamp:(unsigned int)arg5;
