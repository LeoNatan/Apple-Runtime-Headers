...
- (void)getSupportedTimeTravelDirectionsForComplication:(CLKComplication *)arg1 withHandler:(void (^)(unsigned int))arg2;
...
- (void)getTimelineEntriesForComplication:(CLKComplication *)arg1 afterDate:(NSDate *)arg2 limit:(unsigned int)arg3 withHandler:(void (^)(NSArray *))arg4;
- (void)getTimelineEntriesForComplication:(CLKComplication *)arg1 beforeDate:(NSDate *)arg2 limit:(unsigned int)arg3 withHandler:(void (^)(NSArray *))arg4;
- (void)getAlwaysOnTemplateForComplication:(CLKComplication *)arg1 withHandler:(void (^)(CLKComplicationTemplate *))arg2;
- (void)getTimelineAnimationBehaviorForComplication:(CLKComplication *)arg1 withHandler:(void (^)(unsigned int))arg2;
- (void)getPrivacyBehaviorForComplication:(CLKComplication *)arg1 withHandler:(void (^)(unsigned int))arg2;
