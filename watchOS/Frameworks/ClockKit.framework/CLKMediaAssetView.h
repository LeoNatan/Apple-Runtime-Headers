...
@interface CLKMediaAssetView : UIView <CLKVideoPlayerViewDelegate>
{
    ...
    int _preparedForOperation;
    int _transitionOperation;
    CLKDevice *_device;
...
- (_Bool)isPlaying;
- (void)pauseWithOperation:(int)arg1;
- (void)_completePlaybackWithOperation:(int)arg1;
- (void)playWithOperation:(int)arg1;
- (void)_transitionFromPosterToVideo;
- (void)prepareToPlayWithOperation:(int)arg1;
- (CDStruct_1b6d18a9)_endTimeForOperation:(int)arg1;
- (CDStruct_1b6d18a9)_startTimeForOperation:(int)arg1;
