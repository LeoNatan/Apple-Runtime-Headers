...
- (void)registerObjectOfClass:(Class)arg1 visibility:(int)arg2 loadHandler:(CDUnknownBlockType)arg3;
- (void)registerObject:(id)arg1 visibility:(int)arg2;
...
- (void)registerFileRepresentationForTypeIdentifier:(id)arg1 fileOptions:(int)arg2 visibility:(int)arg3 loadHandler:(CDUnknownBlockType)arg4;
- (void)registerDataRepresentationForTypeIdentifier:(id)arg1 visibility:(int)arg2 loadHandler:(CDUnknownBlockType)arg3;
...
- (id)representations;
- (void)_addRepresentationType:(id)arg1 preferredRepresentation:(int)arg2 loader:(CDUnknownBlockType)arg3;
- (void)_addRepresentationType_v2:(id)arg1 preferredRepresentation:(int)arg2 loader:(CDUnknownBlockType)arg3;
- (void)_addRepresentationType:(id)arg1 preferredRepresentation:(int)arg2 visibility:(int)arg3 loader:(CDUnknownBlockType)arg4;
