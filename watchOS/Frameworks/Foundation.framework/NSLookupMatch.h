...
+ (id)matchesInString:(id)arg1 types:(unsigned int)arg2 range:(struct _NSRange)arg3;
...
@property(readonly) unsigned int matchType; // @synthesize matchType=_matchType;
- (id)description;
- (void)dealloc;
- (id)initWithType:(unsigned int)arg1 range:(struct _NSRange)arg2 score:(double)arg3;
