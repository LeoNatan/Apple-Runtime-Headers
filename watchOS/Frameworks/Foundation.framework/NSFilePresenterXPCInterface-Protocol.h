...
- (void)relinquishToWritingClaimWithID:(id)arg1 options:(unsigned int)arg2 purposeID:(id)arg3 subitemURL:(NSURLPromisePair *)arg4 completionHandler:(void (^)(NSError *))arg5;
- (oneway void)reacquireFromReadingClaimForID:(id)arg1;
- (void)relinquishToReadingClaimWithID:(id)arg1 options:(unsigned int)arg2 purposeID:(id)arg3 completionHandler:(void (^)(NSError *))arg4;
@end
