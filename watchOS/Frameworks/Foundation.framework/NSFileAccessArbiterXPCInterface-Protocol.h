...
- (void)addProvider:(id <NSFileProviderXPCInterface>)arg1 withID:(id)arg2 uniqueID:(NSUUID *)arg3 forProvidedItemsURL:(NSURL *)arg4 options:(unsigned int)arg5 withServer:(NSXPCListenerEndpoint *)arg6 reply:(void (^)(_Bool))arg7;
- (oneway void)removePresenterWithID:(id)arg1;
- (void)addPresenter:(id <NSFilePresenterXPCInterface>)arg1 withID:(id)arg2 fileURL:(NSURL *)arg3 lastPresentedItemEventIdentifier:(NSNumber *)arg4 ubiquityAttributes:(NSSet *)arg5 options:(unsigned int)arg6 responses:(unsigned long long)arg7;
