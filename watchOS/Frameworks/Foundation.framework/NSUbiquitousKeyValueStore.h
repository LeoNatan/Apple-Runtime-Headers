...
- (_Bool)_postDidChangeNotificationExternalChanges:(id)arg1 sourceChangeCount:(int)arg2;
...
- (id)initWithBundleIdentifier:(id)arg1 storeIdentifier:(id)arg2 additionalStore:(_Bool)arg3 storeType:(int)arg4;
