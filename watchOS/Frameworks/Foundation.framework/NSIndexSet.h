...
- (unsigned int)__getContainmentVector:(out _Bool *)arg1 inRange:(struct _NSRange)arg2;
...
- (unsigned int)_indexClosestToIndex:(unsigned int)arg1 equalAllowed:(_Bool)arg2 following:(_Bool)arg3;
