...
- (void)_computeMatchesForString:(id)arg1 options:(unsigned int)arg2 maxCount:(unsigned int)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)_ensureViewForPage:(CDStruct_a0bf0dc5 *)arg1;
