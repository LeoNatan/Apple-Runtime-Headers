...
@property(nonatomic, setter=_setEditableLinkBehavior:) int _editableLinkBehavior;
...
@property(nonatomic, setter=_setDefaultFixedPitchFontSize:) unsigned int _defaultFixedPitchFontSize;
@property(nonatomic, setter=_setDefaultFontSize:) unsigned int _defaultFontSize;
...
@property(nonatomic, setter=_setJavaScriptRuntimeFlags:) unsigned int _javaScriptRuntimeFlags;
...
@property(nonatomic, setter=_setVisibleDebugOverlayRegions:) unsigned int _visibleDebugOverlayRegions;
