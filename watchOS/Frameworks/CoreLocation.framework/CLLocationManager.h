...
+ (void)setEntityAuthorization:(unsigned int)arg1 withCorrectiveCompensation:(_Bool)arg2 forLocationDictionary:(id)arg3;
...
+ (_Bool)isStatusBarIconEnabledForLocationEntityClass:(unsigned int)arg1;
+ (void)setStatusBarIconEnabled:(_Bool)arg1 forLocationEntityClass:(unsigned int)arg2;
...
- (void)_fetchPlaceInferencesWithFidelityPolicy:(unsigned int)arg1 handler:(CDUnknownBlockType)arg2;
- (void)_updateLSLHeadingEstimation:(id)arg1;
- (void)_updateARSessionState:(unsigned int)arg1;
