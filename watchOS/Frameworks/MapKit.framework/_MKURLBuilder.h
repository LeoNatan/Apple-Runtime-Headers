...
+ (id)URLForDirectionsFromHereTo:(id)arg1 label:(id)arg2 muid:(unsigned long long)arg3 provider:(int)arg4 transport:(unsigned int)arg5;
...
+ (id)URLForSearch:(id)arg1 at:(struct CLLocationCoordinate2D)arg2 zoomLevel:(float)arg3;
...
- (void)setSearchLocation:(struct CLLocationCoordinate2D)arg1 zoomLevel:(float)arg2;
