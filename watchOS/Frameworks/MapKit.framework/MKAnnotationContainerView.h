...
@property(readonly, nonatomic) CDStruct_05afe423 currentComparisonContext;
...
- (void)getClusterImageTextForClusterFeatureCount:(unsigned int)arg1 text:(id *)arg2 locale:(id *)arg3;
