...
@class CLLocation, CNContact, CNContactNavigationController<CNContactViewControllerPrivateDelegate>, GEOAutomobileOptions, GEOTransitOptions, MKMapItem, NSString, _MKPlaceActionButtonController;
...
@property(nonatomic) float headerHeight; // @synthesize headerHeight;
