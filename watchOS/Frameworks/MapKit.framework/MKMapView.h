...
@interface MKMapView : UIView <MKLocationManagerObserver, MKOverlayContainerViewDelegate, MKMapGestureControllerDelegate, UIGestureRecognizerDelegate, MKVariableDelayTapRecognizerDelegate, VKMapViewDelegate, VKMapViewCameraDelegate, MKAnnotationMarkerContainer, MKAnnotationManagerDelegate, GEOLogContextDelegate, MKRotationFilterDelegate, GEOConfigChangeListenerDelegate, GEOResourceManifestTileGroupObserver, MKAnnotationContainerViewDelegate, NSCoding>
{
    ...
    struct {
        ...
        unsigned int hapticFeedbackEnabled:1;
...
+ (CDStruct_b7cb895d)regionThatFitsMapType:(unsigned int)arg1 viewSize:(struct CGSize)arg2 region:(CDStruct_b7cb895d)arg3;
+ (CDStruct_b7cb895d)regionThatFitsMapType:(unsigned int)arg1 viewSize:(struct CGSize)arg2 edgeInsets:(struct UIEdgeInsets)arg3 region:(CDStruct_b7cb895d)arg4;
...
- (void)mapLayer:(id)arg1 arSessionWasInterrupted:(unsigned int)arg2;
- (void)mapLayer:(id)arg1 arTrackingStateDidChange:(unsigned int)arg2 reason:(unsigned int)arg3;
...
- (float)zoomToFocusVenueBuilding:(id)arg1;
- (float)zoomToFocusVenue:(id)arg1;
...
- (float)_zoomLevelForRegion:(CDStruct_b7cb895d)arg1 includeAccessoryPadding:(_Bool)arg2;
- (float)_zoomLevelForMapRect:(CDStruct_02837cd9)arg1 includeAccessoryPadding:(_Bool)arg2;
...
- (void)_setZoomScale:(float)arg1 centerCoordinate:(struct CLLocationCoordinate2D)arg2 duration:(double)arg3 animated:(_Bool)arg4;
- (void)_setZoomScale:(float)arg1 centerMapPoint:(CDStruct_c3b9c2ee)arg2 duration:(double)arg3 animated:(_Bool)arg4;
...
- (CDStruct_d7416ebf)_zoomRegionForMapRect:(CDStruct_02837cd9)arg1 edgePadding:(struct UIEdgeInsets)arg2 maxZoomLevel:(int)arg3 minZoomLevel:(int)arg4;
...
@property(nonatomic, getter=_displayedSearchResultsType, setter=_setDisplayedSearchResultsType:) int displayedSearchResultsType;
@property(nonatomic, getter=_applicationState, setter=_setApplicationState:) int applicationState;
@property(nonatomic, getter=_userTrackingZoomStyle, setter=_setUserTrackingZoomStyle:) int userTrackingZoomStyle;
...
- (float)annotationContainer:(id)arg1 pinDropDistanceForCoordinate:(struct CLLocationCoordinate2D)arg2 maxDistance:(float *)arg3;
...
- (void)mapLayer:(id)arg1 willTransitionTo:(int)arg2;
...
- (void)mapLayerDidChangeSceneState:(id)arg1 withState:(unsigned int)arg2;
...
- (void)_stopEffects;
- (void)_updateScrollContainerView:(_Bool)arg1 forReason:(int)arg2;
...
- (_Bool)_canZoomOut;
- (_Bool)_canZoomIn;
@property(readonly, nonatomic, getter=_maximumZoomLevel) float maximumZoomLevel;
@property(readonly, nonatomic, getter=_minimumZoomLevel) float minimumZoomLevel;
- (float)_vectorKitTileZoomLevelForMapKitZoomLevel:(float)arg1;
- (float)_mapKitZoomLevelForVectorKitTileZoomLevel:(float)arg1;
@property(readonly, nonatomic) float _zoomLevel;
@property(readonly, nonatomic) float _zoomScale;
...
- (void)_setMapType:(unsigned int)arg1 onInit:(_Bool)arg2 animated:(_Bool)arg3 forceSetting:(_Bool)arg4;
- (void)_setMapType:(unsigned int)arg1 onInit:(_Bool)arg2 animated:(_Bool)arg3;
- (void)_setMapType:(unsigned int)arg1 animated:(_Bool)arg2;
...
@property(readonly, nonatomic) int _interfaceOrientation;
...
@property(nonatomic, getter=_isHapticFeedbackEnabled, setter=_setHapticFeedbackEnabled:) _Bool hapticFeedbackEnabled;
...
- (_Bool)_isUserLocationViewCentered:(float)arg1;
...
- (void)_setCamera:(id)arg1 duration:(double)arg2 timingCurve:(int)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (CDUnknownBlockType)_vkTimingFunctionForUIViewAnimationCurve:(int)arg1;
...
- (struct CGPoint)gestureController:(id)arg1 focusPointForPoint:(struct CGPoint)arg2 gestureKind:(int)arg3;
...
- (void)gestureControllerDidStopTilting:(id)arg1 willDecelerate:(_Bool)arg2 tiltDirection:(int)arg3;
...
- (void)_gestureControllerDidStopZoomingProvidHapticFeedbackIfNeeded:(id)arg1 direction:(int)arg2 type:(int)arg3;
- (void)gestureControllerDidStopZoomingDecelerating:(id)arg1 direction:(int)arg2 type:(int)arg3;
- (void)gestureControllerDidStopZoomingDecelerating:(id)arg1 direction:(int)arg2;
- (void)gestureControllerDidStopZooming:(id)arg1 direction:(int)arg2 type:(int)arg3 willDecelerate:(_Bool)arg4;
- (void)gestureControllerDidStopZooming:(id)arg1 direction:(int)arg2 willDecelerate:(_Bool)arg3;
