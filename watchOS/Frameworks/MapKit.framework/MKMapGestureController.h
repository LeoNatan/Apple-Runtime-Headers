...
@interface MKMapGestureController : NSObject <MKVariableDelayTapRecognizerDelegate, _MKUserInteractionGestureRecognizerTouchObserver, UIGestureRecognizerDelegate>
{
    ...
    _MKZoomingCrownSequencer *_zoomingCrownSequencer;
    struct CLLocationCoordinate2D _previousZoomingLocationCoordinate;
...
- (void)_updateZoomGestureForState:(int)arg1 focusPoint:(struct CGPoint)arg2 scale:(double)arg3 velocity:(float)arg4 gestureType:(int)arg5 configuration:(id)arg6;
- (void)_resetCrownZoomingFocusPoint;
- (void)handleZoomingCrownSequencer:(id)arg1;
- (void)handlePanZoom:(id)arg1;
- (void)handlePinch:(id)arg1;
- (void)handleTwoFingerLongPress:(id)arg1;
- (void)handleTwoFingerTap:(id)arg1;
- (void)handleDoubleTap:(id)arg1;
- (void)_updateRotationGestureForState:(int)arg1 focusPoint:(struct CGPoint)arg2 rotation:(double)arg3 velocity:(float)arg4;
