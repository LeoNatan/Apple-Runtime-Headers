...
- (void)mapLayer:(VKMapView *)arg1 willTransitionTo:(int)arg2;
...
- (void)mapLayer:(VKMapView *)arg1 arTrackingStateDidChange:(unsigned int)arg2 reason:(unsigned int)arg3;
- (void)mapLayerARSessionInterruptionEnded:(VKMapView *)arg1;
- (void)mapLayer:(VKMapView *)arg1 arSessionWasInterrupted:(unsigned int)arg2;
...
- (void)mapLayerDidChangeSceneState:(VKMapView *)arg1 withState:(unsigned int)arg2;
