...
struct __map_iterator<std::__1::__tree_iterator<std::__1::__value_type<std::__1::basic_string<char>, unsigned long>, std::__1::__tree_node<std::__1::__value_type<std::__1::basic_string<char>, unsigned long>, void *>*, int>> {
...
struct __map_iterator<std::__1::__tree_iterator<std::__1::__value_type<unsigned long, unsigned long>, std::__1::__tree_node<std::__1::__value_type<unsigned long, unsigned long>, void *>*, int>> {
    struct __tree_iterator<std::__1::__value_type<unsigned long, unsigned long>, std::__1::__tree_node<std::__1::__value_type<unsigned long, unsigned long>, void *>*, int> {
        struct __tree_end_node<std::__1::__tree_node_base<void *>*> *__ptr_;
    } __i_;
};
...
struct pair<unsigned int, float>;
...
struct vector<std::__1::pair<unsigned int, float>, std::__1::allocator<std::__1::pair<unsigned int, float>>> {
    struct pair<unsigned int, float> *_field1;
    struct pair<unsigned int, float> *_field2;
    struct __compressed_pair<std::__1::pair<unsigned int, float>*, std::__1::allocator<std::__1::pair<unsigned int, float>>> {
        struct pair<unsigned int, float> *_field1;
    } _field3;
};
...
typedef struct {
    void *_field1;
    void *_field2;
    unsigned long _field3[4];
    unsigned long _field4[4];
...
} __map_iterator_07bfca81;

typedef struct __map_iterator<std::__1::__tree_iterator<std::__1::__value_type<unsigned long, unsigned long>, std::__1::__tree_node<std::__1::__value_type<unsigned long, unsigned long>, void *>*, int>> {
    struct __tree_iterator<std::__1::__value_type<unsigned long, unsigned long>, std::__1::__tree_node<std::__1::__value_type<unsigned long, unsigned long>, void *>*, int> {
        struct __tree_end_node<std::__1::__tree_node_base<void *>*> *__ptr_;
    } __i_;
...
typedef struct vector<std::__1::pair<unsigned int, float>, std::__1::allocator<std::__1::pair<unsigned int, float>>> {
    struct pair<unsigned int, float> *_field1;
    struct pair<unsigned int, float> *_field2;
    struct __compressed_pair<std::__1::pair<unsigned int, float>*, std::__1::allocator<std::__1::pair<unsigned int, float>>> {
        struct pair<unsigned int, float> *_field1;
