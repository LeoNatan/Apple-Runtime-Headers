...
@property unsigned int inputSize; // @synthesize inputSize=_inputSize;
...
- (void)fillSVMNodeVector:(struct svm_node *)arg1 values:(double *)arg2 count:(unsigned int)arg3;
- (struct svm_node *)allocSVMNodeVector:(unsigned int)arg1;
@property(readonly, nonatomic) unsigned int numberOfClasses;
- (void)dealloc;
- (id)initWithSVMModel:(struct svm_model *)arg1 freeOnDealloc:(_Bool)arg2 isInputSizeLowerBoundOnly:(_Bool)arg3 inputSize:(unsigned int)arg4 classLabels:(id)arg5;
