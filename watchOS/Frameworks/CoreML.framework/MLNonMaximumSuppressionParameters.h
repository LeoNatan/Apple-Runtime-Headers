...
@interface MLNonMaximumSuppressionParameters : NSObject
{
    ...
    unsigned long _minBoxes;
    long _maxBoxes;
    unsigned long _numClasses;
...
@property unsigned long numClasses; // @synthesize numClasses=_numClasses;
@property long maxBoxes; // @synthesize maxBoxes=_maxBoxes;
@property unsigned long minBoxes; // @synthesize minBoxes=_minBoxes;
