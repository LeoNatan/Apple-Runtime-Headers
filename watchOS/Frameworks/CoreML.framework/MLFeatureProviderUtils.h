...
+ (_Bool)vectorizeFeaturesProvidedBy:(id)arg1 featureNames:(id)arg2 intoDoubleVector:(double *)arg3 length:(unsigned int)arg4 stride:(unsigned int)arg5 error:(id *)arg6;
+ (_Bool)_vectorizeWithoutSizeCheckFeatureValues:(id)arg1 intoDoubleVector:(double *)arg2 stride:(unsigned int)arg3 error:(id *)arg4;
+ (int)_vectorizedSizeOfFeatureValues:(id)arg1 error:(id *)arg2;
