...
+ (unsigned int)locationClosestTo:(unsigned int)arg1 inRange:(struct _NSRange)arg2;
- (void).cxx_destruct;
...
- (id)initUnspecified;
- (id)allowedImageSizeClosestToPixelsWide:(int)arg1 pixelsHigh:(int)arg2 preferDownScaling:(_Bool)arg3 preferInputAspectRatio:(_Bool)arg4;
