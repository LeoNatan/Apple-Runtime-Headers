...
@property(readonly) unsigned int inputSize; // @synthesize inputSize=_inputSize;
...
- (void)dealloc;
- (id)initWithSVMModel:(struct svm_model *)arg1 freeOnDealloc:(_Bool)arg2 isInputSizeLowerBoundOnly:(_Bool)arg3 inputSize:(unsigned int)arg4;
