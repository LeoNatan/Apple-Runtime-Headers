...
- (void)scheduledSessonInvalidatedWhileRunning:(NSString *)arg1;
- (void)showSystemAlertForBARDisabled:(NSString *)arg1 reply:(void (^)(_Bool))arg2;
- (void)playHapticDuringScheduledExtendedRuntimeSession:(NSString *)arg1 soundID:(unsigned long)arg2;
