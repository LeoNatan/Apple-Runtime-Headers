...
- (void)newTextureWithName:(id)arg1 scaleFactor:(float)arg2 displayGamut:(int)arg3 bundle:(id)arg4 options:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)newTextureWithName:(id)arg1 scaleFactor:(float)arg2 bundle:(id)arg3 options:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)newTexturesWithNames:(id)arg1 scaleFactor:(float)arg2 displayGamut:(int)arg3 bundle:(id)arg4 options:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)newTexturesWithNames:(id)arg1 scaleFactor:(float)arg2 bundle:(id)arg3 options:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void)_newAsyncTextureWithNames:(id)arg1 scaleFactor:(float)arg2 displayGamut:(int)arg3 bundle:(id)arg4 options:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (id)newUploaderForOptions:(id)arg1;
- (_Bool)validateGenerateMipmapsForPixelFormat:(unsigned int)arg1 options:(id)arg2 error:(id *)arg3;
