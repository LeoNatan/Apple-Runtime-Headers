...
@interface EKDayOccurrenceView : UIView <NSCopying, EKDayOccurrenceTravelTimeViewMetricsDelegate>
{
    ...
    unsigned int _invalidatedRequestOptions;
...
+ (float)enoughHeightForOneLineForEvent:(id)arg1 usingSmallText:(_Bool)arg2 sizeClass:(int)arg3;
...
+ (float)minimumHeightForSizeClass:(int)arg1 orientation:(int)arg2 isAllDay:(_Bool)arg3 usesSmallText:(_Bool)arg4;
+ (float)minimumHeightForSizeClass:(int)arg1 orientation:(int)arg2 isAllDay:(_Bool)arg3;
+ (float)minimumHeightForSizeClass:(int)arg1 orientation:(int)arg2;
...
- (void)requestContentIfNeeded:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
