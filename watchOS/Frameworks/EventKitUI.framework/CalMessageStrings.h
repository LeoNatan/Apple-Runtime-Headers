...
@property(readonly, nonatomic) int comments; // @synthesize comments=_comments;
...
- (id)initWithTitles:(id)arg1 bodyStrings:(id)arg2 comments:(int)arg3 timeProposals:(_Bool)arg4 importantAttendee:(id)arg5;
