...
- (_Bool)_getBottomPinRegion:(float *)arg1 dayIndex:(unsigned int *)arg2 forPoint:(struct CGPoint)arg3;
...
- (void)dealloc;
- (id)initWithFrame:(struct CGRect)arg1 sizeClass:(int)arg2 orientation:(int)arg3;
- (id)initWithFrame:(struct CGRect)arg1 sizeClass:(int)arg2 orientation:(int)arg3 backgroundColor:(id)arg4 opaque:(_Bool)arg5 numberOfDaysToDisplay:(unsigned int)arg6;
