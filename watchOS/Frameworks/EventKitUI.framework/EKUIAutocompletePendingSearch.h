...
#import "EKUIAutocompletePendingSearchProtocol.h"
...
- (id)initWithEventStore:(id)arg1 searchString:(id)arg2 maximumResultCount:(unsigned int)arg3 completionHandler:(CDUnknownBlockType)arg4;
