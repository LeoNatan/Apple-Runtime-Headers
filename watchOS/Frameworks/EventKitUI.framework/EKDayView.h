...
@property(nonatomic) float topYBoundaryForOccurrenceText; // @synthesize topYBoundaryForOccurrenceText=_topYBoundaryForOccurrenceText;
@property(nonatomic) float additionalLeftPadding; // @synthesize additionalLeftPadding=_additionalLeftPadding;
...
- (void)scrollToDate:(id)arg1 offset:(float)arg2 animated:(_Bool)arg3 whenFinished:(CDUnknownBlockType)arg4;
- (void)scrollToDate:(id)arg1 animated:(_Bool)arg2 whenFinished:(CDUnknownBlockType)arg3;
- (void)_scrollToSecond:(int)arg1 offset:(float)arg2 animated:(_Bool)arg3 whenFinished:(CDUnknownBlockType)arg4;
