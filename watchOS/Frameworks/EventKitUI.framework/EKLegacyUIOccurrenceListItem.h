...
- (void)drawText:(id)arg1 withDefaultColor:(id)arg2 atPoint:(struct CGPoint)arg3 forWidth:(float)arg4 font:(id)arg5 lineBreakMode:(int)arg6 staticColor:(_Bool)arg7;
- (void)drawDeemphasizedText:(id)arg1 atPoint:(struct CGPoint)arg2 forWidth:(float)arg3 font:(id)arg4 lineBreakMode:(int)arg5 staticColor:(_Bool)arg6;
- (void)drawBoldText:(id)arg1 atPoint:(struct CGPoint)arg2 forWidth:(float)arg3 font:(id)arg4 lineBreakMode:(int)arg5 staticColor:(_Bool)arg6;
