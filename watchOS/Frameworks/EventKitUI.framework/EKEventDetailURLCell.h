...
- (void)_layoutForWidth:(float)arg1 position:(int)arg2;
- (void)layoutSubviews;
- (void)updateLinkWithLaunchInfo;
- (void)updateLinkWithURL;
- (_Bool)updateLink;
- (_Bool)update;
- (id)initWithEvent:(id)arg1 launchInfo:(id)arg2 editable:(_Bool)arg3 style:(int)arg4;
- (id)initWithEvent:(id)arg1 url:(id)arg2 editable:(_Bool)arg3 style:(int)arg4;
