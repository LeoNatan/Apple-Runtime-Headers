...
{
    CDStruct_56d48c16 _prohibitedInterfaceSubTypes;
    CDStruct_56d48c16 _prohibitedInterfaceTypes;
    NSString *_account;
...
- (id)preferredAgentsAtIndex:(unsigned int)arg1;
- (unsigned int)preferredAgentsCount;
- (void)addPreferredAgents:(id)arg1;
- (void)clearPreferredAgents;
- (id)requiredAgentsAtIndex:(unsigned int)arg1;
- (unsigned int)requiredAgentsCount;
- (void)addRequiredAgents:(id)arg1;
- (void)clearRequiredAgents;
- (id)prohibitedAgentsAtIndex:(unsigned int)arg1;
- (unsigned int)prohibitedAgentsCount;
- (void)addProhibitedAgents:(id)arg1;
- (void)clearProhibitedAgents;
- (id)prohibitedInterfacesAtIndex:(unsigned int)arg1;
- (unsigned int)prohibitedInterfacesCount;
...
- (void)setProhibitedInterfaceSubTypes:(int *)arg1 count:(unsigned int)arg2;
- (int)prohibitedInterfaceSubTypesAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int prohibitedInterfaceSubTypesCount;
- (int)StringAsProhibitedInterfaceTypes:(id)arg1;
- (id)prohibitedInterfaceTypesAsString:(int)arg1;
- (void)setProhibitedInterfaceTypes:(int *)arg1 count:(unsigned int)arg2;
- (int)prohibitedInterfaceTypesAtIndex:(unsigned int)arg1;
...
@property(readonly, nonatomic) unsigned int prohibitedInterfaceTypesCount;
