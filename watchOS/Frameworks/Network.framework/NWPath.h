...
+ (id)createStringFromStatus:(int)arg1;
...
@property(readonly, nonatomic) unsigned int secondsSinceInterfaceChange;
@property(readonly, nonatomic) int maximumDatagramSize;
...
- (_Bool)usesInterfaceType:(int)arg1;
