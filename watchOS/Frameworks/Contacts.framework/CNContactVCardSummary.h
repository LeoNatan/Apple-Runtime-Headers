...
+ (id)localizedStringWithName:(id)arg1 andThisManyOthers:(unsigned int)arg2;
...
+ (id)readingOptionsWithContactLimit:(unsigned int)arg1;
- (void).cxx_destruct;
@property(readonly, copy, nonatomic) NSArray *avatarContacts; // @synthesize avatarContacts=_avatarContacts;
@property(readonly, nonatomic) unsigned int contactCount; // @synthesize contactCount=_contactCount;
...
- (id)description;
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 contactCount:(unsigned int)arg3 avatarContacts:(id)arg4;
