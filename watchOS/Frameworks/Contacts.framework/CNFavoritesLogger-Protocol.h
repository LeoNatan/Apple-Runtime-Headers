...
- (void)finishedWritingFavoritesToPath:(NSString *)arg1 entriesCount:(unsigned int)arg2;
- (void)finishedWritingRemoteFavorites;
- (void)finishedReadingFavoritesFromPath:(NSString *)arg1 entriesCount:(unsigned int)arg2;
