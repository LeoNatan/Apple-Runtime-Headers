...
+ (unsigned int)countOfLabelsUnifiableWithLabel:(id)arg1 valuesUnifiableWithValue:(id)arg2 inMultiValue:(id)arg3 forProperty:(id)arg4;
...
+ (unsigned int)indexOfPreferredContactForUnifying:(id)arg1 includingMainStoreContacts:(_Bool)arg2;
