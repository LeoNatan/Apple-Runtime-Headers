...
+ (void)initialize;
+ (id)numberFromIntegerABBytes:(char *)arg1 length:(unsigned int)arg2;
+ (id)dataFromABBytes:(char *)arg1 length:(unsigned int)arg2;
+ (id)dateFromABBytes:(char *)arg1 length:(unsigned int)arg2;
+ (id)stringFromABBytes:(char *)arg1 length:(unsigned int)arg2;
