...
+ (id)observableWithPredicates:(id)arg1 sortOrdering:(unsigned int)arg2 options:(unsigned int)arg3 addressBook:(void *)arg4 environment:(id)arg5;
- (void).cxx_destruct;
...
- (void)dealloc;
- (id)initWithPredicate:(id)arg1 sortOrdering:(unsigned int)arg2 options:(unsigned int)arg3 addressBook:(void *)arg4 environment:(id)arg5;
