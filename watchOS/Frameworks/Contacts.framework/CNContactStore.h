...
+ (id)standardLabelsForPropertyWithKey:(id)arg1 options:(unsigned int)arg2;
...
- (id)sectionListOffsetsForSortOrder:(int)arg1 error:(id *)arg2;
...
- (id)initWithEnvironment:(id)arg1 options:(unsigned int)arg2 managedConfiguration:(id)arg3;
