...
@class NSArray, NSMutableArray, NSMutableIndexSet, NSString, UIControl, UIScrollView, UIStackView, UIView, _SFSettingsAlertItem;
...
- (void)_addGroupSeparatorIfNeededBeforeItemAtIndex:(unsigned int)arg1;
- (void)addDivider;
