...
#import "SFBrowserViewDelegate.h"
...
- (unsigned int)availableContentTypeForMailContentProvider:(id)arg1;
...
@property(readonly, nonatomic) _Bool _privateBrowsingInitiallyEnabled;
