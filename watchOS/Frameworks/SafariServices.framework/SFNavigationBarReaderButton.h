...
- (void)layoutSubviews;
- (id)initWithFrame:(struct CGRect)arg1 useStandaloneAppearance:(_Bool)arg2 prefersResizableBackground:(_Bool)arg3 resizableBackgroundCornerRadius:(float)arg4;
