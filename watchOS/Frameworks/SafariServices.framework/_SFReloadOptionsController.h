...
- (id)customNavigatorPlatformForSetting:(int)arg1;
- (id)customSiteCompatibilityScriptForMainFrameURL:(id)arg1;
- (id)customJavaScriptUserAgentForSetting:(int)arg1 withMainFrameURL:(id)arg2;
- (id)customUserAgentForSetting:(int)arg1;
- (void)customUserAgentSettingForMainFrameURL:(id)arg1 withTimeout:(double)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)_overrideSettingIfNeeded:(int)arg1 source:(unsigned int)arg2 domain:(id)arg3 completion:(CDUnknownBlockType)arg4;
- (_Bool)_updateSettingSource:(unsigned int)arg1 domain:(id)arg2;
...
- (void)didUpdateRequestDesktopSiteDefaultValue:(int)arg1;
- (id)init;
