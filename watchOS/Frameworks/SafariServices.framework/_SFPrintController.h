...
- (void)preparePrintInteractionControllerForUsage:(int)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)getPDFDataForUsage:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;
...
- (void)_shouldPrintWhileLoadingForUsage:(int)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)_didFinishPrintingCurrentItemWithResult:(int)arg1 fromPrintInteractionControllerCompletion:(_Bool)arg2;
- (void)_printCurrentItem;
- (void)_preparePrintInteractionControllerForUsage:(int)arg1 onlyIfLoaded:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)dealloc;
- (id)init;
