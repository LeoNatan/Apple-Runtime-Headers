...
- (void)readerController:(_SFReaderController *)arg1 didDeactivateReaderWithMode:(unsigned int)arg2;
- (void)readerController:(_SFReaderController *)arg1 didDetermineReaderAvailability:(_Bool)arg2 dueTo:(int)arg3;
@end
