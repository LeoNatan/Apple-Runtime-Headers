...
+ (id)keyboardGeometryForInterfaceOrientation:(int)arg1;
+ (id)_keyboardGeometryForCurrentDeviceWithInterfaceOrientation:(int)arg1;
...
- (id)_initWithFallbackSizeForOrientation:(int)arg1;
