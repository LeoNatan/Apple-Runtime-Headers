...
@interface _SFPasswordPickerTableConfiguration : NSObject
{
    ...
    unsigned int _minimumNumberOfCredentialsToShowLikelyMatchesSection;
}
...
@property(nonatomic) unsigned int minimumNumberOfCredentialsToShowLikelyMatchesSection; // @synthesize minimumNumberOfCredentialsToShowLikelyMatchesSection=_minimumNumberOfCredentialsToShowLikelyMatchesSection;
