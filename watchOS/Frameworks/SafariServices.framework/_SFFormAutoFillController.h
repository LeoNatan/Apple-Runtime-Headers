...
@class NSMutableIndexSet, NSMutableSet, NSString, NSTimer, SFFormAutocompleteState, SFNanoDomainContainerView, UIView, UIView<WBUFormAutoFillWebView>, WKWebView<WBUFormAutoFillWebView>, _SFAuthenticationContext, _SFAutoFillAuthenticationCache, _WKRemoteObjectInterface;
...
- (void)authenticateForAutoFillOnPageLoad:(_Bool)arg1 forAuthenticationType:(int)arg2 withCompletion:(CDUnknownBlockType)arg3;
