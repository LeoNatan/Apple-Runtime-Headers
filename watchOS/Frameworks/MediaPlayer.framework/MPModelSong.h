...
@property(nonatomic) int beatsPerMinute; // @dynamic beatsPerMinute;
@property(copy, nonatomic) NSString *classicalMovement; // @dynamic classicalMovement;
@property(nonatomic) int classicalMovementCount; // @dynamic classicalMovementCount;
@property(nonatomic) int classicalMovementNumber; // @dynamic classicalMovementNumber;
...
@property(nonatomic) int discNumber; // @dynamic discNumber;
...
@property(nonatomic) int skipCount; // @dynamic skipCount;
