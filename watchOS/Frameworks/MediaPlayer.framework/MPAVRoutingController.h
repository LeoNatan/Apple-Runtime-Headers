...
@interface MPAVRoutingController : NSObject
{
    ...
    int _volumeControlStateForPickedRoute;
...
@property(nonatomic) int routeTypes; // @synthesize routeTypes=_routeTypes;
...
- (void)getActiveRouteWithTimeout:(double)arg1 completion:(CDUnknownBlockType)arg2;
- (_Bool)_deviceAvailabilityOverrideState;
- (void)_setVolumeControlStateForPickedRoute:(int)arg1;
- (int)_volumeControlStateForPickedRoute;
- (int)_externalScreenType:(_Bool *)arg1;
...
- (void)_onQueueSetExternalScreenType:(int)arg1;
...
- (_Bool)_updateGroupMembership:(int)arg1 forRoute:(id)arg2 completion:(CDUnknownBlockType)arg3;
