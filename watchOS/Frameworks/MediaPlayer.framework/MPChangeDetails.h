...
+ (id)changeDetailsWithPreviousCount:(int)arg1 finalCount:(int)arg2 isEqualBlock:(CDUnknownBlockType)arg3 isUpdatedBlock:(CDUnknownBlockType)arg4;
- (void).cxx_destruct;
...
- (void)removeSectionMoveFromIndex:(int)arg1;
- (void)appendSectionMoveFromIndex:(int)arg1 toIndex:(int)arg2 updated:(_Bool)arg3;
- (id)debugDescription;
