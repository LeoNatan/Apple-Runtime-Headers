...
- (map_b31fefcb)_propertyMapForKeyPath:(id)arg1 includePropertiesToSort:(_Bool)arg2;
- (struct ModelPropertyBase *)_propertyForKeyPath:(id)arg1;
- (id)_propertyTranslatorForKeyPath:(id)arg1;
- (map_b31fefcb)propertiesToFetchForPropertyKey:(id)arg1;
...
- (void)mapPropertyKey:(id)arg1 withPropertiesToFetch:(const map_b31fefcb *)arg2 propertiesToSort:(const map_b31fefcb *)arg3 sortTransformer:(CDUnknownBlockType)arg4 valueTransformer:(CDUnknownBlockType)arg5;
- (void)mapPropertyKey:(id)arg1 withPropertiesToFetch:(const map_b31fefcb *)arg2 valueTransformer:(CDUnknownBlockType)arg3;
- (void)mapPropertyKey:(id)arg1 toMLProperty:(struct ModelPropertyBase *)arg2;
- (void)mapIdentifierMLProperties:(const map_b31fefcb *)arg1 identifierCreationBlock:(CDUnknownBlockType)arg2;
