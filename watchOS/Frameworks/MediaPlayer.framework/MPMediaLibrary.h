...
@property(readonly, nonatomic) int libraryChangeObservers; // @synthesize libraryChangeObservers=_libraryChangeObservers;
...
- (void)populateLocationPropertiesOfItem:(id)arg1 withPath:(id)arg2 assetProtectionType:(int)arg3 completionBlock:(CDUnknownBlockType)arg4;
...
- (id)collectionWithPersistentID:(unsigned long long)arg1 groupingType:(int)arg2 verifyExistence:(_Bool)arg3;
...
- (_Bool)hasVideos;
- (_Bool)_checkHasContent:(_Bool *)arg1 determined:(_Bool *)arg2 mediaType:(unsigned int)arg3 queryHasEntitiesBlock:(CDUnknownBlockType)arg4;
