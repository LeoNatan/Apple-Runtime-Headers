...
- (void)populateLocationPropertiesOfItemWithIdentifier:(long long)arg1 withPath:(NSString *)arg2 assetProtectionType:(int)arg3 completionBlock:(void (^)(_Bool, NSError *))arg4;
...
- (void)moveItemFromIndex:(unsigned int)arg1 toIndex:(unsigned int)arg2 inPlaylistWithIdentifier:(long long)arg3 completionBlock:(void (^)(_Bool))arg4;
...
- (_Bool)removeItemsWithIdentifiers:(long long *)arg1 count:(unsigned int)arg2;
- (_Bool)deleteItemsWithIdentifiers:(long long *)arg1 count:(unsigned int)arg2;
...
- (void)setValue:(id)arg1 forProperty:(NSString *)arg2 ofCollectionWithIdentifier:(long long)arg3 groupingType:(int)arg4 completionBlock:(void (^)(_Bool, NSError *))arg5;
...
- (_Bool)collectionExistsWithPersistentID:(unsigned long long)arg1 groupingType:(int)arg2;
...
- (_Bool)hasMediaOfType:(unsigned int)arg1;
