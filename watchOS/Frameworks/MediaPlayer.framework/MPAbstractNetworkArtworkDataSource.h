...
+ (void)_applyURLCachePolicy:(unsigned int)arg1 cacheDiskPath:(id)arg2 toConfiguration:(id)arg3;
- (void).cxx_destruct;
...
- (void)updateURLSessionWithCachePolicy:(unsigned int)arg1 cachePath:(id)arg2;
