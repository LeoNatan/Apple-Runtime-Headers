...
+ (struct CGSize)_tileSizeForFittingSize:(struct CGSize)arg1 rows:(unsigned int)arg2 columns:(unsigned int)arg3 spacing:(float)arg4;
...
- (void)loadArtworkEffectResultForEffectType:(int)arg1 catalog:(id)arg2 options:(id)arg3 systemEffectHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
