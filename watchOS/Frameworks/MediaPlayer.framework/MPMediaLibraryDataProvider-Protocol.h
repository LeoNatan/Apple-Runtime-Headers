...
- (void)enumerateEntityChangesAfterSyncAnchor:(NSString *)arg1 maximumRevisionType:(int)arg2 inUsersLibrary:(_Bool)arg3 itemBlock:(void (^)(long long, NSString *, int, _Bool *))arg4 collectionBlock:(void (^)(long long, int, NSString *, int, _Bool *))arg5;
- (void)disconnect;
