...
+ (id)_assetURLForCachedLocalPlaybackAssetFilePathForPlaybackItemMetadata:(id)arg1 withMinimumAssetQuality:(unsigned int)arg2 assetOptions:(id)arg3 returningProtectionType:(unsigned int *)arg4 assetQuality:(unsigned int *)arg5 usesPurchaseBundle:(_Bool *)arg6;
...
+ (_Bool)isPlaybackItemMetadataStreamingForAssetCreation:(id)arg1 returningProtectionType:(unsigned int *)arg2;
...
- (_Bool)_getAssetURL:(id *)arg1 playWhileDownloadSession:(id *)arg2 assetQuality:(unsigned int *)arg3 error:(id *)arg4 usingStoreDownload:(id)arg5 assetOptions:(id)arg6 shouldStartDownload:(_Bool)arg7;
...
@property(readonly, nonatomic) int rtcReportingAssetType;
...
- (_Bool)isStreamable;
- (_Bool)isSupportedDefaultPlaybackSpeed:(int)arg1;
- (_Bool)isExplicitTrack;
- (_Bool)isCloudItem;
- (_Bool)isAssetURLValid;
- (_Bool)hasAlternatesForTypes:(unsigned int)arg1;
