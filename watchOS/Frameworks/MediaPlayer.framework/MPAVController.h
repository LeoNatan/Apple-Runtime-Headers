...
@class AVPlayerLayer, MPAVItem, MPAVPolicyEnforcer, MPAVRoute, MPAVRoutingController, MPQueueFeeder, MPQueuePlayer, MPVideoView, NSArray, NSMapTable, NSMutableArray, NSMutableSet, NSNotification, NSString;
...
- (void)setCurrentTime:(double)arg1 options:(int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)endSeek;
- (_Bool)changePlaybackIndexBy:(int)arg1 deltaType:(int)arg2 ignoreElapsedTime:(_Bool)arg3 force:(_Bool)arg4 error:(id *)arg5;
