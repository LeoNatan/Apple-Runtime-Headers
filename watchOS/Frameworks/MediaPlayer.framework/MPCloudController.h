...
@property(nonatomic) int activeCount; // @synthesize activeCount=_activeCount;
...
- (void)setLikedState:(int)arg1 forAlbumWithStoreID:(long long)arg2 completion:(CDUnknownBlockType)arg3;
- (void)setLikedState:(int)arg1 forAlbumWithStoreID:(long long)arg2;
- (void)setLikedState:(int)arg1 forEntityWithStoreID:(long long)arg2 withMediaType:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)setCloudAddToPlaylistBehavior:(int)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)loadArtworkInfoForEntityPersistentID:(long long)arg1 entityType:(int)arg2 artworkType:(int)arg3 artworkSourceType:(int)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)loadArtworkForEntityPersistentID:(long long)arg1 entityType:(int)arg2 artworkType:(int)arg3 artworkSourceType:(int)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void)setCollectionProperties:(id)arg1 forCollectionWithPersistentID:(long long)arg2 groupingType:(int)arg3 completionHandler:(CDUnknownBlockType)arg4;
