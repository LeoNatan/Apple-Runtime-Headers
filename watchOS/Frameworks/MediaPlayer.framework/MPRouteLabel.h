...
@property(nonatomic) int minimumEndCharacterCount; // @synthesize minimumEndCharacterCount=_minimumEndCharacterCount;
- (void).cxx_destruct;
- (int)_compareLength:(id)arg1 with:(id)arg2;
- (void)_updateTitleIfNeeded;
- (id)_truncateText:(id)arg1 by:(int)arg2;
- (void)_updateRouteLabel;
- (_Bool)_labelFitsText:(id)arg1;
...
@property(readonly, nonatomic) float _baselineOffsetFromBottom;
- (void)layoutSubviews;
