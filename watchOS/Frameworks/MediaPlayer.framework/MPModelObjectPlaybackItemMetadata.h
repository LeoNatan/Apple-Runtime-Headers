...
- (void).cxx_destruct;
- (id)_cachedLocalPlaybackAssetFilePathWithIntegrityCheck:(_Bool)arg1 returningAssetQuality:(unsigned int *)arg2 protectionType:(unsigned int *)arg3 usesPurchaseBundle:(_Bool *)arg4;
...
- (void)setCachedLocalPlaybackAssetFilePath:(id)arg1 protectionType:(unsigned int)arg2 assetQuality:(unsigned int)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;
...
- (id)cachedLocalPlaybackAssetFilePathReturningAssetQuality:(unsigned int *)arg1 protectionType:(unsigned int *)arg2 usesPurchaseBundle:(_Bool *)arg3;
- (id)buyParameters;
- (double)bookmarkTime;
