...
- (id)titleForControlStatusType:(int)arg1;
- (void)setTitle:(id)arg1 forControlStatusType:(int)arg2;
...
- (struct CGSize)maximumSizeWithPreferredHeight:(float)arg1;
- (void)layoutSubviews;
