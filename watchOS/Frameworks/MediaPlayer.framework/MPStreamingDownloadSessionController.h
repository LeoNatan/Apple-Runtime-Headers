...
- (id)_newDownloadSessionForRequest:(id)arg1 sourceURL:(id)arg2 downloadKey:(id)arg3 sinfs:(id)arg4 pathExtension:(id)arg5 assetFlavor:(id)arg6 allowAssetCaching:(_Bool)arg7 allowITunesContentConfiguration:(_Bool)arg8 protectionType:(unsigned int)arg9 returningAssetDownloadSession:(id *)arg10;
