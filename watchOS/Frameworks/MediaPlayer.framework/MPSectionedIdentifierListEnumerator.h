...
- (void).cxx_destruct;
- (id)nextObject;
- (id)_initWithSectionedIdentifierList:(id)arg1 options:(unsigned int)arg2 startingEntry:(id)arg3;
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned int)arg2 startingAtItem:(id)arg3 inSection:(id)arg4;
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned int)arg2;
