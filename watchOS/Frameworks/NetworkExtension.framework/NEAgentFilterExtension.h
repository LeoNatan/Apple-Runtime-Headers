...
- (int)sanitizeFilterReportEvent:(int)arg1;
- (id)sanitizeFilterFlow:(id)arg1;
- (_Bool)authenticateFlow:(id)arg1;
- (int)sanitizeFilterAction:(int)arg1;
...
- (void)dealloc;
- (id)initWithPluginType:(id)arg1 pluginClass:(int)arg2 pluginEndpoint:(id)arg3 pluginUUID:(id)arg4 queue:(id)arg5 factory:(id)arg6;
- (id)initWithPluginType:(id)arg1 pluginClass:(int)arg2 pluginInfo:(id)arg3 queue:(id)arg4 factory:(id)arg5;
