...
- (void)prepareAgentForURL:(id)arg1 urlRequest:(id)arg2 urlResponse:(id)arg3 parentURL:(id)arg4 direction:(int)arg5 flowUUID:(id)arg6 handler:(CDUnknownBlockType)arg7;
