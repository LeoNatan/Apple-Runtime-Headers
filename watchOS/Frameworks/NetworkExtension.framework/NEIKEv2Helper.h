...
+ (_Bool)getDPDAttributesForMode:(int)arg1 isWakeUp:(_Bool)arg2 isNAT:(_Bool)arg3 retry:(unsigned int *)arg4 timeout:(unsigned long long *)arg5 frequency:(unsigned int *)arg6;
+ (unsigned int)getIdentifierType:(id)arg1;
