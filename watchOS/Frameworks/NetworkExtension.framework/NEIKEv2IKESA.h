...
@interface NEIKEv2IKESA : NSObject
{
    ...
    unsigned int _childSAModeFromPacket;
...
@property(nonatomic) unsigned int childSAModeFromPacket; // @synthesize childSAModeFromPacket=_childSAModeFromPacket;
...
- (_Bool)supportsSignHash:(unsigned int)arg1;
