...
+ (struct NSMutableData *)createPRFPlusFromData:(id)arg1 key:(id)arg2 prfAlgorithm:(unsigned int)arg3 outputLength:(unsigned int)arg4;
+ (struct NSMutableData *)createHMACFromData:(id)arg1 key:(id)arg2 prfAlgorithm:(unsigned int)arg3;
+ (struct NSMutableData *)createHMACFromData:(id)arg1 key:(id)arg2 integrityAlgorithm:(unsigned int)arg3;
