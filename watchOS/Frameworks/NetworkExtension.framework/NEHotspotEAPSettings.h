...
@interface NEHotspotEAPSettings : NSObject <NSCopying, NSSecureCoding>
{
    ...
    int _ttlsInnerAuthenticationType;
    NSString *_password;
    NSArray *_trustedServerNames;
    int _preferredTLSVersion;
...
@property int preferredTLSVersion; // @synthesize preferredTLSVersion=_preferredTLSVersion;
...
@property int ttlsInnerAuthenticationType; // @synthesize ttlsInnerAuthenticationType=_ttlsInnerAuthenticationType;
