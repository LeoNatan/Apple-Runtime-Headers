...
@property(readonly) long interfaceType; // @synthesize interfaceType=_interfaceType;
@property unsigned long buffersSize; // @synthesize buffersSize=_buffersSize;
@property unsigned int *packetLengths; // @synthesize packetLengths=_packetLengths;
