...
- (id)initCustomWithAttributeType:(unsigned int)arg1 attributeName:(id)arg2 addressValue:(id)arg3 ipv4SubnetMask:(unsigned int)arg4;
- (id)initCustomWithAttributeType:(unsigned int)arg1 attributeName:(id)arg2 addressValue:(id)arg3 prefix:(unsigned char)arg4;
