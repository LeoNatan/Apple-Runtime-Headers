...
@interface NENexus : NSObject <NENexusAgentDelegate>
{
    ...
    unsigned int _maximumTransmissionUnit;
...
@property(nonatomic) unsigned int maximumTransmissionUnit; // @synthesize maximumTransmissionUnit=_maximumTransmissionUnit;
...
@property(nonatomic) unsigned int availability; // @synthesize availability=_availability;
...
- (id)initWithLevel:(unsigned int)arg1 name:(id)arg2 virtualInterfaceType:(long)arg3 delegate:(id)arg4 channelCount:(unsigned int)arg5 netifRingSize:(unsigned int)arg6 kernelPipeTxRingSize:(unsigned int)arg7 kernelPipeRxRingSize:(unsigned int)arg8;
- (id)initWithLevel:(unsigned int)arg1 name:(id)arg2 virtualInterfaceType:(long)arg3 delegate:(id)arg4 channelCount:(unsigned int)arg5;
