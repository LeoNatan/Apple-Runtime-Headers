...
- (void)handleNewFlowMessageComplete:(id)arg1 flow:(id)arg2 flowUUID:(const char *)arg3 direction:(int)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (id)getDataVerdictWithControlVerdict:(id)arg1 flow:(id)arg2 data:(id)arg3 startOffset:(unsigned long long)arg4 direction:(int)arg5;
