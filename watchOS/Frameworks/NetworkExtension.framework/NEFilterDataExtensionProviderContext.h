...
- (void)reportFlow:(id)arg1 forVerdict:(id)arg2 event:(int)arg3;
...
- (void)handleDataCompleteForFlow:(id)arg1 direction:(int)arg2 reply:(id)arg3 controlSocket:(int)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)handleData:(id)arg1 offset:(unsigned long long)arg2 forFlow:(id)arg3 direction:(int)arg4 reply:(id)arg5 controlSocket:(int)arg6 completionHandler:(CDUnknownBlockType)arg7;
- (void)handleNewFlow:(id)arg1 reply:(id)arg2 controlSocket:(int)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (id)adjustDataToFilter:(id)arg1 startOffset:(unsigned long long *)arg2 flow:(id)arg3 direction:(int)arg4;
...
- (void)updateFlow:(id)arg1 withVerdict:(id)arg2 forDirection:(int)arg3;
