...
@property int ingestionState; // @synthesize ingestionState=_ingestionState;
- (void).cxx_destruct;
...
- (void)ingestHealthRecordsWithFHIRDocumentHandle:(id)arg1 accountIdentifier:(struct NSUUID *)arg2 options:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
