...
@class HKHealthStore, HKObjectType, HKQueryServerProxyProvider, HKSampleType, NSObject<OS_dispatch_queue>, NSPredicate, NSString, NSUUID, _HKFilter;
...
+ (id)predicateForWorkoutsWithOperatorType:(unsigned int)arg1 totalFlightsClimbed:(id)arg2;
...
+ (id)predicateForSamplesForDayFromDate:(id)arg1 calendar:(id)arg2 options:(unsigned int)arg3;
+ (id)predicateForSamplesWithinDateInterval:(id)arg1 options:(unsigned int)arg2;
...
+ (id)predicateForSamplesWithStartDate:(id)arg1 endDate:(id)arg2 inclusiveEndDates:(_Bool)arg3 options:(unsigned int)arg4;
...
@property(readonly) int deactivateCallCount;
