...
- (id)initWithIdentifier:(id)arg1 state:(int)arg2 userEnabled:(_Bool)arg3 needsRelogin:(_Bool)arg4 lastFetchDate:(id)arg5 lastFullFetchDate:(id)arg6 gateway:(id)arg7;
- (id)init;
