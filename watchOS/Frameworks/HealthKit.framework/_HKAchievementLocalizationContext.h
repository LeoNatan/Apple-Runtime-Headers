...
+ (id)contextWithKeyPrefix:(id)arg1 timesEarned:(int)arg2 userName:(id)arg3 isWheelchairUser:(_Bool)arg4;
@property(readonly, nonatomic) _Bool isWheelchairUser; // @synthesize isWheelchairUser=_isWheelchairUser;
@property(readonly, nonatomic) NSString *userName; // @synthesize userName=_userName;
@property(readonly, nonatomic) int timesEarned; // @synthesize timesEarned=_timesEarned;
