...
- (void).cxx_destruct;
@property(readonly) CDStruct_4bb15e50 operatingSystemVersion; // @synthesize operatingSystemVersion=_operatingSystemVersion;
...
- (id)initWithSource:(id)arg1 version:(id)arg2 productType:(id)arg3 operatingSystemVersion:(CDStruct_4bb15e50)arg4;
