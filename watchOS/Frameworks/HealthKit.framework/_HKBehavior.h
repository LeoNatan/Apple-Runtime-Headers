...
+ (void)_setHasCompletedBuddyWithVersion:(int)arg1;
+ (_Bool)_hasCompletedBuddyWithVersion:(int)arg1;
+ (_Bool)_isForceBuddyEnabled;
+ (_Bool)_runningInStoreDemoModeF201;
+ (_Bool)_deviceSupportsHeartRateMotionContexts;
+ (int)_runningInStoreDemoModeFProgramNumber;
+ (_Bool)_isRunningStoreDemoMode;
+ (_Bool)_hasTelephonyCapability;
+ (_Bool)_isAppleInternalInstall;
+ (_Bool)_isDeviceSupported;
...
+ (_Bool)_healthAppHidden;
+ (CDStruct_4bb15e50)currentOSVersionStruct;
+ (id)currentOSVersion;
+ (id)currentOSBuild;
...
+ (void)setHasCompletedBuddyWithVersion:(int)arg1;
+ (_Bool)hasCompletedBuddyWithVersion:(int)arg1;
...
@property(readonly, nonatomic) CDStruct_4bb15e50 currentOSVersionStruct;
