...
#import "HKFitnessMachineConnectionInitiatorClientInterface.h"
...
- (void)_simulateTapWithFitnessMachineType:(unsigned int)arg1;
- (void)clientRemote_encounteredError:(id)arg1;
- (void)clientRemote_workoutAppReady;
- (void)clientRemote_updatedFitnessMachineState:(unsigned int)arg1 fitnessMachineSessionUUID:(id)arg2;
- (void)clientRemote_updatedFitnessMachine:(id)arg1 fitnessMachineSessionUUID:(id)arg2;
- (void)clientRemote_updatedConnectionState:(unsigned int)arg1 fitnessMachineSessionUUID:(id)arg2;
- (void)peformServerOperation:(CDUnknownBlockType)arg1;
- (void)forbidConnectionForFitnessMachineSessionUUID:(id)arg1;
- (void)permitConnectionForFitnessMachineSessionUUID:(id)arg1 activityType:(unsigned int)arg2;
- (void)registerClient;
