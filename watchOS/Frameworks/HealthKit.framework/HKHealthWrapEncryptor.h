...
- (_Bool)_appendEncryptedBytes:(const char *)arg1 length:(unsigned long)arg2 error:(id *)arg3;
- (_Bool)_writeStream:(const char *)arg1 length:(unsigned long)arg2 hash:(_Bool)arg3 error:(id *)arg4;
