...
+ (id)procedureRecordWithType:(id)arg1 note:(id)arg2 enteredInError:(_Bool)arg3 modifiedDate:(id)arg4 FHIRIdentifier:(id)arg5 locale:(id)arg6 extractionVersion:(int)arg7 device:(id)arg8 metadata:(id)arg9 country:(id)arg10 state:(unsigned int)arg11 procedureCodings:(id)arg12 performers:(id)arg13 executionStartDate:(id)arg14 executionEndDate:(id)arg15 notPerformed:(_Bool)arg16 statusCoding:(id)arg17 categoryCodings:(id)arg18 reasonCodings:(id)arg19 reasonsNotPerformedCodings:(id)arg20 outcomeCodings:(id)arg21 complicationsCodings:(id)arg22 followUpsCodings:(id)arg23 bodySitesCodings:(id)arg24;
- (void).cxx_destruct;
