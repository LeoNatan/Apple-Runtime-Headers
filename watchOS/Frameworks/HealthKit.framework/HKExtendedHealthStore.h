...
- (void)createMonthlyChallengeAchievementForMonth:(int)arg1 year:(int)arg2 predicateString:(id)arg3 progressExpressionString:(id)arg4 goalExpressionString:(id)arg5 completion:(CDUnknownBlockType)arg6;
