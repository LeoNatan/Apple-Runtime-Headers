...
+ (id)dynamicDefinitionForAchievementIdentifier:(id)arg1 typeString:(id)arg2 dateInterval:(id)arg3 progressExpression:(id)arg4 goalExpression:(id)arg5 displayOder:(int)arg6 badgeShapeName:(id)arg7;
...
@property(nonatomic) unsigned int calendarUnitForEqualityCheck; // @synthesize calendarUnitForEqualityCheck=_calendarUnitForEqualityCheck;
@property(nonatomic) _Bool equalityRequiresSameValue; // @synthesize equalityRequiresSameValue=_equalityRequiresSameValue;
@property(nonatomic) unsigned int deduplicationStrategy; // @synthesize deduplicationStrategy=_deduplicationStrategy;
