...
+ (int)_collectionStateAtDate:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 sortedEvents:(id)arg4;
...
- (void)clientRemote_stateDidChange:(int)arg1 startDate:(id)arg2 endDate:(id)arg3;
...
- (void)_resourceQueue_setStatisticsComputationMethod:(int)arg1 forType:(id)arg2;
- (void)_resourceQueue_setStatisticsMergeStrategy:(unsigned int)arg1 forType:(id)arg2;
...
- (void)_setStatisticsComputationMethod:(int)arg1 forType:(id)arg2;
- (void)_setStatisticsMergeStrategy:(unsigned int)arg1 forType:(id)arg2;
...
- (id)initWithHealthStore:(id)arg1 configuration:(id)arg2 goalType:(unsigned int)arg3 goal:(id)arg4 device:(id)arg5;
