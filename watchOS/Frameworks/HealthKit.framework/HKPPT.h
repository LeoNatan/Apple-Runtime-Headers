...
- (_Bool)performPPTTest:(id)arg1 enumerateWorkoutRouteWithDatumCount:(int)arg2;
- (_Bool)performPPTTest:(id)arg1 insertWorkoutRouteWithDatumCount:(int)arg2 batched:(_Bool)arg3;
...
- (_Bool)performPPTTest:(id)arg1 anchoredQueryForType:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 withLimit:(int)arg5 anchor:(int)arg6;
- (_Bool)performPPTTest:(id)arg1 sampleQueryForType:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 withLimit:(int)arg5;
- (_Bool)performPPTTest:(id)arg1 saveDataWithCount:(int)arg2;
