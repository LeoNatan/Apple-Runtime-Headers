...
@interface HKSleepPeriod : NSObject
{
    ...
    int _intendedBedtimeType;
    int _asleepDurationGoalSource;
    int _numberOfInterruptions;
    NSArray *_segments;
...
@property(readonly, nonatomic) int asleepDurationGoalSource; // @synthesize asleepDurationGoalSource=_asleepDurationGoalSource;
...
@property(readonly, nonatomic) int intendedBedtimeType; // @synthesize intendedBedtimeType=_intendedBedtimeType;
...
- (void)enumerateDateIntervalsForCategoryValue:(int)arg1 intersectedWithDateInterval:(id)arg2 block:(CDUnknownBlockType)arg3;
- (id)segmentDateIntervalsForCategoryValue:(int)arg1 intersectedWithDateInterval:(id)arg2;
- (void)_setIntendedBedtime:(id)arg1 type:(int)arg2;
- (void)_setType:(int)arg1;
- (id)segmentsForCategory:(int)arg1;
