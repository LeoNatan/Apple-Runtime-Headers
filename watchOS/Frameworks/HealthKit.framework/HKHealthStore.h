...
- (void)suppressActivityAlertsForIdentifier:(id)arg1 suppressionReason:(int)arg2 timeoutUntilDate:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)obliterateHealthDataWithOptions:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)_beginWorkoutWithActivityType:(unsigned int)arg1 startDate:(id)arg2 goalType:(unsigned int)arg3 goal:(id)arg4 metadata:(id)arg5 lapLength:(id)arg6 shouldUseDeviceData:(_Bool)arg7 fitnessMachineSessionConfiguration:(id)arg8 completion:(CDUnknownBlockType)arg9;
- (void)_beginWorkoutWithActivityType:(unsigned int)arg1 startDate:(id)arg2 goalType:(unsigned int)arg3 goal:(id)arg4 metadata:(id)arg5 lapLength:(id)arg6 shouldUseDeviceData:(_Bool)arg7 completion:(CDUnknownBlockType)arg8;
...
- (_Bool)_setWheelchairUse:(int)arg1 error:(id *)arg2;
- (id)wheelchairUseWithError:(id *)arg1;
- (_Bool)_setFitzpatrickSkinType:(int)arg1 error:(id *)arg2;
- (id)fitzpatrickSkinTypeWithError:(id *)arg1;
- (_Bool)_setBloodType:(int)arg1 error:(id *)arg2;
- (id)bloodTypeWithError:(id *)arg1;
- (_Bool)_setBiologicalSex:(int)arg1 error:(id *)arg2;
...
- (void)deleteObjectsOfType:(id)arg1 predicate:(id)arg2 options:(unsigned int)arg3 withCompletion:(CDUnknownBlockType)arg4;
- (void)deleteObjects:(id)arg1 options:(unsigned int)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void)deleteObject:(id)arg1 options:(unsigned int)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void)deleteObjectsOfType:(id)arg1 predicate:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void)_deleteObjects:(id)arg1 options:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)deleteObjectsWithUUIDs:(id)arg1 options:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)deleteSourceWithBundleIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)deleteAllSamplesWithTypes:(id)arg1 sourceBundleIdentifier:(id)arg2 options:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)healthPeripheralsWithFilter:(unsigned int)arg1 handler:(CDUnknownBlockType)arg2;
...
- (void)forceCloudSyncWithOptions:(unsigned int)arg1 progress:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)forceNanoSyncWithOptions:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)select:(id)arg1 from:(id)arg2 where:(id)arg3 groupBy:(id)arg4 orderBy:(id)arg5 limit:(int)arg6 completion:(CDUnknownBlockType)arg7;
...
- (void)startFakingDataWithActivityType:(int)arg1 speed:(id)arg2 completion:(CDUnknownBlockType)arg3;
