...
- (void)clientRemote_conceptIndexManagerDidBecomeQuiescentWithSamplesProcessedCount:(int)arg1;
...
- (void)runStaticSyncExportWithOptions:(unsigned int)arg1 storeIdentifier:(id)arg2 URL:(id)arg3 batchSize:(unsigned long long)arg4 progressHandler:(CDUnknownBlockType)arg5 completion:(CDUnknownBlockType)arg6;
