...
- (id)description;
@property(readonly, nonatomic) int workoutEventType;
@property(readonly, copy, nonatomic) NSUUID *sessionUUID;
- (id)initWithWorkoutEventType:(int)arg1 sessionUUID:(id)arg2 dateInterval:(id)arg3 metadata:(id)arg4 error:(id)arg5;
- (id)initWithSessionId:(id)arg1 error:(id)arg2;
- (id)initWithEventType:(int)arg1 sessionId:(id)arg2 dateInterval:(id)arg3 metadata:(id)arg4;
