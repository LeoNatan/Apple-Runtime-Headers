...
@property(readonly, nonatomic) int collectionType; // @synthesize collectionType=_collectionType;
...
- (id)description;
- (id)_initWithCollectionType:(int)arg1 collection:(id)arg2 tags:(id)arg3;
- (id)_initWithCollectionType:(int)arg1 collection:(id)arg2;
- (id)init;
