...
- (void)remote_triggerClinicalOptInDataCollectionForReason:(int)arg1 completion:(void (^)(_Bool, NSError *))arg2;
...
- (void)remote_getHealthRecordsIngestionFrequencyWithCompletion:(void (^)(_Bool, int, NSError *))arg1;
- (void)remote_resetHealthRecordsLastExtractedRowIDWithCompletion:(void (^)(_Bool, NSError *))arg1;
- (void)remote_ingestHealthRecordsWithFHIRDocumentHandle:(NSFileHandle *)arg1 accountIdentifier:(NSUUID *)arg2 options:(unsigned int)arg3 completion:(void (^)(_Bool, NSError *))arg4;
- (void)remote_ingestHealthRecordsWithOptions:(unsigned int)arg1 completion:(void (^)(_Bool, NSString *, NSError *))arg2;
- (void)remote_ingestionStateWithCompletion:(void (^)(int))arg1;
