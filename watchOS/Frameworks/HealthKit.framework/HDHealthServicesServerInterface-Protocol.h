...
- (void)remote_performHealthServiceOperation:(NSString *)arg1 onSession:(unsigned int)arg2 withParameters:(NSDictionary *)arg3 completion:(void (^)(NSString *, _Bool, NSError *))arg4;
- (void)remote_getHealthServiceProperty:(NSString *)arg1 forSession:(unsigned int)arg2 withHandler:(void (^)(id, NSError *))arg3;
...
- (void)remote_getHealthPeripheralsWithFilter:(unsigned int)arg1 handler:(void (^)(NSArray *, NSError *))arg2;
- (void)remote_endHealthServiceSession:(unsigned int)arg1;
- (void)remote_startHealthServiceSession:(HKHealthService *)arg1 client:(id <HKHealthServicesClientInterface>)arg2 withCompletion:(void (^)(unsigned int, NSError *))arg3;
- (void)remote_endHealthServiceDiscovery:(unsigned int)arg1;
- (void)remote_startHealthServiceDiscovery:(int)arg1 client:(id <HKHealthServicesClientInterface>)arg2 withCompletion:(void (^)(unsigned int, NSError *))arg3;
- (void)remote_fetchSupportedServiceIDsWithCompletion:(void (^)(NSArray *, NSError *))arg1;
- (void)remote_endBluetoothStatusUpdates;
- (void)remote_beginBluetoothStatusUpdates:(void (^)(int, NSError *))arg1 client:(id <HKHealthServicesClientInterface>)arg2;
@end
