...
+ (id)attributeWithIdentifier:(long long)arg1 name:(id)arg2 valueType:(int)arg3 value:(id)arg4;
...
- (id)initWithIdentifier:(long long)arg1 name:(id)arg2 valueType:(int)arg3 value:(id)arg4 concept:(id)arg5;
- (id)init;
