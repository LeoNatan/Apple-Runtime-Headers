...
- (id)initWithStartDate:(id)arg1 endDate:(id)arg2 contextStyle:(int)arg3 anchorDate:(id)arg4 intervalComponents:(id)arg5 histogramAnchor:(id)arg6 histogramBucketSize:(id)arg7 completionHandler:(CDUnknownBlockType)arg8;
