...
+ (_Bool)isElectrocardiogramAppInstalled;
...
- (void)_setElectrocardiogramOnboardingCompletedForVersion:(int)arg1 inCountryCode:(id)arg2;
...
- (void)_triggerFeatureAvailabilityUpdateOnPhoneAndWatchWithDelay:(int)arg1;
...
- (_Bool)_isOnboardingCompletedForKey:(id)arg1 version:(int)arg2 useCache:(_Bool)arg3;
...
- (_Bool)_meetsMinimumAgeRequirementWithMinimumRequiredAge:(int)arg1 currentDate:(id)arg2;
