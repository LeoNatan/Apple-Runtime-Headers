...
+ (id)_achievementWithUUID:(id)arg1 definitionIdentifier:(id)arg2 completedDate:(id)arg3 value:(id)arg4 workoutActivityType:(unsigned int)arg5 alerted:(_Bool)arg6;
+ (id)achievementWithDefinitionIdentifier:(id)arg1 completedDate:(id)arg2 progressValue:(id)arg3 goalValue:(id)arg4 value:(id)arg5 workoutActivityType:(unsigned int)arg6;
...
- (id)_initWithDefinitionIdentifier:(id)arg1 completedDate:(id)arg2 progressValue:(id)arg3 goalValue:(id)arg4 value:(id)arg5 workoutActivityType:(unsigned int)arg6;
...
- (id)localizedShareDescriptionWithNumberOfTimesAchieved:(int)arg1 isWheelchairUser:(_Bool)arg2;
...
- (id)localizedDescriptionWithNumberOfTimesAchieved:(int)arg1 isWheelchairUser:(_Bool)arg2;
