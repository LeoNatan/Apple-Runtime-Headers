...
+ (id)_serverInterface;
+ (id)_clientInterface;
+ (id)_workoutWithActivityType:(unsigned int)arg1 startDate:(id)arg2 endDate:(id)arg3 workoutEvents:(id)arg4 duration:(double)arg5 totalActiveEnergyBurned:(id)arg6 totalBasalEnergyBurned:(id)arg7 totalDistance:(id)arg8 goalType:(unsigned int)arg9 goal:(id)arg10 shouldUseDeviceData:(_Bool)arg11 metadata:(id)arg12;
...
- (void)_propertyQueue_handleUpdatesForPaceQty:(id)arg1 metricType:(unsigned int)arg2;
- (void)_propertyQueue_handleUpdatesForPowerQty:(id)arg1 metricType:(unsigned int)arg2;
