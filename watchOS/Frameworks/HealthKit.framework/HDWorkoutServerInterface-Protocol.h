...
- (void)remote_permitConnectionForFitnessMachineSessionUUID:(NSUUID *)arg1 activityType:(unsigned int)arg2 withConnectionUUID:(NSUUID *)arg3;
...
- (void)remote_simulateTapWithFitnessMachineType:(unsigned int)arg1;
