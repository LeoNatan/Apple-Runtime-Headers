...
- (void)clientRemote_updatedFitnessMachineState:(unsigned int)arg1 fitnessMachineSessionUUID:(NSUUID *)arg2;
- (void)clientRemote_updatedFitnessMachine:(_HKFitnessMachine *)arg1 fitnessMachineSessionUUID:(NSUUID *)arg2;
- (void)clientRemote_updatedConnectionState:(unsigned int)arg1 fitnessMachineSessionUUID:(NSUUID *)arg2;
@end
