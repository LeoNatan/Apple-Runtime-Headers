...
- (void)remote_setStatisticsComputationMethod:(int)arg1 forType:(HKQuantityType *)arg2;
- (void)remote_setStatisticsMergeStrategy:(unsigned int)arg1 forType:(HKQuantityType *)arg2;
...
- (void)remote_setTargetConstructionState:(int)arg1 startDate:(NSDate *)arg2 endDate:(NSDate *)arg3 completion:(void (^)(_Bool, NSError *))arg4;
@end
