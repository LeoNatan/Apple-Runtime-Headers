...
@class CIImage, NSArray, UIGraphicsImageRendererFormat, UIImageAsset, UITraitCollection, _UIImageVectorImageSupport;
...
- (id)_tabBarItemImageWithTintColor:(id)arg1 selected:(_Bool)arg2 metrics:(int)arg3 style:(int)arg4 forScreenScale:(float)arg5;
