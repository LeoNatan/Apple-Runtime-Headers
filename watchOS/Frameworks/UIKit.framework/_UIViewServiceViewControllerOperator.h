...
- (void)__hostViewWillTransitionToSize:(struct CGSize)arg1 withContextDescription:(id)arg2 statusBarHeight:(float)arg3 underlapsStatusBar:(_Bool)arg4 whenDone:(CDUnknownBlockType)arg5;
