...
- (void)swipeHandler:(id)arg1 didConfirmSwipeWithInfo:(CDStruct_5bc9d42c)arg2;
- (void)swipeHandler:(id)arg1 didGenerateSwipeWithInfo:(CDStruct_5bc9d42c)arg2;
...
- (void)_resetSwipedItemAnimated:(_Bool)arg1 swipeInfo:(CDStruct_5bc9d42c)arg2 completion:(CDUnknownBlockType)arg3;
