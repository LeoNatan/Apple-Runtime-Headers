...
- (void)_performSwipeAction:(id)arg1 inPullview:(id)arg2 swipeInfo:(CDStruct_5bc9d42c)arg3;
- (_Bool)shouldDismissWithTouchLocation:(struct CGPoint)arg1;
- (void)performPrimaryActionWithSwipeInfo:(CDStruct_5bc9d42c)arg1;
- (void)updateLayout;
- (void)_resetItemWithSwipeInfo:(CDStruct_5bc9d42c)arg1 animated:(_Bool)arg2 deletion:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
- (void)resetItemWithSwipeInfo:(CDStruct_5bc9d42c)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)moveItemWithSwipeInfo:(CDStruct_5bc9d42c)arg1 completion:(CDUnknownBlockType)arg2;
- (void)endSwipe;
- (void)beginSwipe;
