...
@interface _UINavigationControllerPalette : UIView
{
    ...
    float __heightWhenUnscrolled;
    int __visibilityState;
    struct CGSize __size;
    struct UIEdgeInsets _preferredContentInsets;
}

@property(nonatomic, setter=_setVisibilityState:) int _visibilityState; // @synthesize _visibilityState=__visibilityState;
@property(nonatomic, setter=_setHeightWhenUnscrolled:) float _heightWhenUnscrolled; // @synthesize _heightWhenUnscrolled=__heightWhenUnscrolled;
