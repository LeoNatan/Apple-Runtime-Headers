...
@property(nonatomic) int increasingForceState; // @synthesize increasingForceState=_increasingForceState;
@property(nonatomic) int liftOffState; // @synthesize liftOffState=_liftOffState;
