...
@interface UINavigationController : UIViewController <UIGestureRecognizerDelegatePrivate, _UINavigationBarDelegatePrivate, _UIScrollViewScrollObserver, UILayoutContainerViewDelegate>
{
    ...
    CDStruct_930042bc _interactiveScrollNavBarIntrinsicHeightRange;
    float _interactiveScrollNavBarVerticalSizingPriorityHeight;
...
- (void)_observeScrollViewDidScroll:(id)arg1 topLayoutType:(int)arg2;
...
- (float)_topBarHeight;
- (float)_heightOfTopPartsWhenHiddenAndCollapsed;
- (float)_heightOfTopPartsWhenVisibleAndExpanded;
- (struct CGSize)_navigationBarSizeForViewController:(id)arg1 proposedHeight:(float)arg2 verticalFittingPriority:(float)arg3 allowRubberBandStretch:(_Bool)arg4;
- (CDStruct_b2fbf00d)_intrinsicNavigationBarHeightRangeForViewController:(id)arg1;
- (float)_preferredHeightForHidingNavigationBarForViewController:(id)arg1;
