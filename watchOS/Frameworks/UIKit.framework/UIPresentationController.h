...
+ (struct UIEdgeInsets)_defaultBaseContentInsetsForView:(id)arg1 leftMargin:(float *)arg2 rightMargin:(float *)arg3;
...
@property(readonly, nonatomic) int adaptivePresentationStyle;
