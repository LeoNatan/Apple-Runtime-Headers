...
@interface _UINavigationBarContentViewLayout : NSObject
{
    ...
    float _preferredBackButtonWidth;
...
@property(nonatomic) float preferredBackButtonWidth; // @synthesize preferredBackButtonWidth=_preferredBackButtonWidth;
...
- (float)_baseHeightForContentSize:(int)arg1;
