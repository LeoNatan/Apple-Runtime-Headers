...
@interface _UIDataTransferMonitor : NSObject <NSItemProviderDataTransferDelegate, NSProgressReporting>
{
    ...
    unsigned int _outstandingItemsCount;
}

@property(readonly, nonatomic) unsigned int outstandingItemsCount; // @synthesize outstandingItemsCount=_outstandingItemsCount;
...
@property(readonly, nonatomic) unsigned int totalItemsCount; // @dynamic totalItemsCount;
