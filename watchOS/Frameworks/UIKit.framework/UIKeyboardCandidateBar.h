...
+ (struct UIEdgeInsets)edgeInsetsForInterfaceOrientation:(int)arg1;
...
- (void)_stepSelectedCandidateInDirection:(_Bool)arg1 candidateView:(id)arg2 section:(int)arg3;
- (void)_stepSelectedCandidateInDirection:(_Bool)arg1;
- (void)_scrollToFirstCandidateInSection:(int)arg1 withAnimation:(_Bool)arg2;
- (void)_showCandidateAtIndex:(unsigned int)arg1 inSection:(int)arg2 scrollCellToVisible:(_Bool)arg3 animated:(_Bool)arg4;
