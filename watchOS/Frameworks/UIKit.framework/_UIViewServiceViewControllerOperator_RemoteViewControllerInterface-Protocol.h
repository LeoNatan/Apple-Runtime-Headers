...
- (void)__hostViewWillTransitionToSize:(struct CGSize)arg1 withContextDescription:(_UIViewControllerTransitionCoordinatorContextDescription *)arg2 statusBarHeight:(float)arg3 underlapsStatusBar:(_Bool)arg4 whenDone:(void (^)(struct CGSize, float))arg5;
