...
- (id)description;
- (id)stringForRenderFlags:(int)arg1 lightKeyboard:(_Bool)arg2;
- (id)stringForSplitState:(_Bool)arg1 handBias:(int)arg2;
...
- (_Bool)isUsableForCacheToken:(id)arg1 withRenderFlags:(int)arg2;
