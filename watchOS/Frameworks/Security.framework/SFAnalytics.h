...
+ (id)hwModelID;
+ (int)fuzzyDaysSinceDate:(id)arg1;
...
- (id)eventDictForEventName:(id)arg1 withAttributes:(id)arg2 eventClass:(int)arg3 timestampBucket:(double)arg4;
- (void)logEventNamed:(id)arg1 class:(int)arg2 attributes:(id)arg3;
- (void)logEventNamed:(id)arg1 class:(int)arg2 attributes:(id)arg3 timestampBucket:(unsigned int)arg4;
