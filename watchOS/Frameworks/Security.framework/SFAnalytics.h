...
@class NSMutableDictionary, NSObject<OS_dispatch_queue>, SFAnalyticsSQLiteStore;
...
- (id)eventDictForEventName:(id)arg1 withAttributes:(id)arg2 eventClass:(int)arg3;
