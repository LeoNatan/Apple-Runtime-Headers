...
- (void).cxx_destruct;
- (void)performOperation:(long)arg1 algorithm:(id)arg2 parameters:(id)arg3 reply:(CDUnknownBlockType)arg4;
...
// Property attributes: T^{__SecKey={__CFRuntimeBase=IAI}^{__SecKeyDescriptor}^v},R,N
