...
- (void)performOperation:(long)arg1 algorithm:(NSString *)arg2 parameters:(NSArray *)arg3 reply:(void (^)(NSArray *, NSError *))arg4;
- (void)getPublicKey:(void (^)(NSXPCListenerEndpoint *))arg1;
- (void)getAlgorithmIDWithReply:(void (^)(int))arg1;
...
- (void)getBlockSizeWithReply:(void (^)(unsigned long))arg1;
