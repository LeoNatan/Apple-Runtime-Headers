...
-     // Error parsing type: l20@0:4^{LSDatabase={__CFRuntimeBase=IAI}^{LSDBImpl}^{__CSStore}{LSSchema=I{?={CSMap=I{CSMapCallbacks=^?^?^?^?^?^?}^{CSMapContext}{os_unfair_lock_s=I}I^{_CSMapHeader}^I^I}I}{?=II}IIII{?={CSMap=I{CSMapCallbacks=^?^?^?^?^?^?}^{CSMapContext}{os_unfair_lock_s=I}I^{_CSMapHeader}^I^I}}[12{?={CSMap=I{CSMapCallbacks=^?^?^?^?^?^?}^{CSMapContext}{os_unfair_lock_s=I}I^{_CSMapHeader}^I^I}^{?}^{?}IC}]IIIIIII^{_LSSchemaCache}}}8I12r^{LSBundleData=LQIICCCSIIQQiiQQQQQ[4I]QQQQIIIIIIIIIIIIIIIIIIIQQQQIIQQQIQIIIIIIIIIIIIIIIIIIIICCCCIIIIII}16, name: activateBindings:unitID:bundleData:
-     // Error parsing type: {LSBundleData=LQIICCCSIIQQiiQQQQQ[4I]QQQQIIIIIIIIIIIIIIIIIIIQQQQIIQQQIQIIIIIIIIIIIIIIIIIIIICCCCIIIIII}16@0:4^{LSDatabase={__CFRuntimeBase=IAI}^{LSDBImpl}^{__CSStore}{LSSchema=I{?={CSMap=I{CSMapCallbacks=^?^?^?^?^?^?}^{CSMapContext}{os_unfair_lock_s=I}I^{_CSMapHeader}^I^I}I}{?=II}IIII{?={CSMap=I{CSMapCallbacks=^?^?^?^?^?^?}^{CSMapContext}{os_unfair_lock_s=I}I^{_CSMapHeader}^I^I}}[12{?={CSMap=I{CSMapCallbacks=^?^?^?^?^?^?}^{CSMapContext}{os_unfair_lock_s=I}I^{_CSMapHeader}^I^I}^{?}^{?}IC}]IIIIIII^{_LSSchemaCache}}}8^@12, name: buildBundleData:error:
...
- (id)_LSBundleFlagMap;
-     // Error parsing type: l16@0:4^{LSDatabase={__CFRuntimeBase=IAI}^{LSDBImpl}^{__CSStore}{LSSchema=I{?={CSMap=I{CSMapCallbacks=^?^?^?^?^?^?}^{CSMapContext}{os_unfair_lock_s=I}I^{_CSMapHeader}^I^I}I}{?=II}IIII{?={CSMap=I{CSMapCallbacks=^?^?^?^?^?^?}^{CSMapContext}{os_unfair_lock_s=I}I^{_CSMapHeader}^I^I}}[12{?={CSMap=I{CSMapCallbacks=^?^?^?^?^?^?}^{CSMapContext}{os_unfair_lock_s=I}I^{_CSMapHeader}^I^I}^{?}^{?}IC}]IIIIIII^{_LSSchemaCache}}}8^{LSBundleData=LQIICCCSIIQQiiQQQQQ[4I]QQQQIIIIIIIIIIIIIIIIIIIQQQQIIQQQIQIIIIIIIIIIIIIIIIIIIICCCCIIIIII}12, name: registerSchemesWhitelist:bundleData:
