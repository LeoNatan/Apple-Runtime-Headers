...
- (void)dealloc;
- (id)init;
- (_Bool)legacy_isBundleID:(unsigned int)arg1 bundleData:(const LSBundleData_d5b0ef78 *)arg2 context:(struct LSContext *)arg3 allowedToCheckScheme:(id)arg4 error:(id *)arg5;
- (_Bool)isBundleID:(unsigned int)arg1 bundleData:(const LSBundleData_d5b0ef78 *)arg2 context:(struct LSContext *)arg3 allowedToCheckScheme:(id)arg4 error:(id *)arg5;
