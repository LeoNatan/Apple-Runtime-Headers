...
- (int)totalSkipTouchCorrections;
- (int)totalInsertKeyCorrections;
- (int)totalTranspositionCorrections;
- (int)totalRetroCorrections;
- (int)totalSpaceCorrections;
- (int)totalAutoCorrections;
- (id)totalPathLength;
