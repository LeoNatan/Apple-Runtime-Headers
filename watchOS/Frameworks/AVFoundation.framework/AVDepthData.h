...
+ (void)initialize;
- (struct __CVBuffer *)_copyPixelBufferRepresentationWithPixelFormatType:(unsigned long)arg1;
...
@property(readonly) int depthDataAccuracy;
@property(readonly, getter=isDepthDataFiltered) _Bool depthDataFiltered;
@property(readonly) int depthDataQuality;
@property(readonly) struct __CVBuffer *depthDataMap;
@property(readonly) unsigned long depthDataType;
...
- (id)depthDataByConvertingToDepthDataType:(unsigned long)arg1;
