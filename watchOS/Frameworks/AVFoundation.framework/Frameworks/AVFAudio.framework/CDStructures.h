...
struct AVAudioEngineImpl {
    ...
    int _field10;
    _Bool _field11;
    struct unique_ptr<AVAEBlock<AVAudioEngineManualRenderingStatus (^)(unsigned int, AudioBufferList *, long *)>, std::__1::default_delete<AVAEBlock<AVAudioEngineManualRenderingStatus (^)(unsigned int, AudioBufferList *, long *)>>> _field12;
};
...
struct EndpointVAD3Host {
    ...
    struct vector<std::__1::vector<unsigned long, std::__1::allocator<unsigned long>>, std::__1::allocator<std::__1::vector<unsigned long, std::__1::allocator<unsigned long>>>> _field21;
...
struct vector<std::__1::vector<unsigned long, std::__1::allocator<unsigned long>>, std::__1::allocator<std::__1::vector<unsigned long, std::__1::allocator<unsigned long>>>> {
    vector_55d7bafa *_field1;
    vector_55d7bafa *_field2;
    struct __compressed_pair<std::__1::vector<unsigned long, std::__1::allocator<unsigned long>>*, std::__1::allocator<std::__1::vector<unsigned long, std::__1::allocator<unsigned long>>>> {
        vector_55d7bafa *_field1;
    } _field3;
};
