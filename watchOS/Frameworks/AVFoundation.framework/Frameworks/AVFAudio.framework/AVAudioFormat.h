...
- (id)initWithCommonFormat:(unsigned int)arg1 sampleRate:(double)arg2 interleaved:(_Bool)arg3 channelLayout:(id)arg4;
- (id)initWithCommonFormat:(unsigned int)arg1 sampleRate:(double)arg2 channels:(unsigned int)arg3 interleaved:(_Bool)arg4;
