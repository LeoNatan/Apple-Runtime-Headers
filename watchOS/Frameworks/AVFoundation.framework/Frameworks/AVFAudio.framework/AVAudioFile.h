...
- (id)initForWriting:(id)arg1 settings:(id)arg2 commonFormat:(unsigned int)arg3 interleaved:(_Bool)arg4 error:(id *)arg5;
- (id)initForWriting:(id)arg1 settings:(id)arg2 error:(id *)arg3;
- (id)initForReadingFromExtAudioFile:(struct OpaqueExtAudioFile *)arg1 commonFormat:(unsigned int)arg2 interleaved:(_Bool)arg3 error:(id *)arg4;
- (id)initForReadingFromExtAudioFile:(struct OpaqueExtAudioFile *)arg1 error:(id *)arg2;
- (id)initForReading:(id)arg1 commonFormat:(unsigned int)arg2 interleaved:(_Bool)arg3 error:(id *)arg4;
