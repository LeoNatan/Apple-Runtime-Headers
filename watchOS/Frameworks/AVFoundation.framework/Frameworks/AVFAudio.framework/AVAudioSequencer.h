...
- (_Bool)writeToURL:(id)arg1 SMPTEResolution:(int)arg2 replaceExisting:(_Bool)arg3 error:(id *)arg4;
- (_Bool)loadFromData:(id)arg1 options:(unsigned int)arg2 error:(id *)arg3;
- (_Bool)loadFromURL:(id)arg1 options:(unsigned int)arg2 error:(id *)arg3;
