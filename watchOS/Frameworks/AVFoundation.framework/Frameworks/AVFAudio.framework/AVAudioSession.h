...
- (_Bool)decoupledIO;
- (_Bool)setAggregatedIOPreference:(unsigned int)arg1 error:(id *)arg2;
...
- (_Bool)silenceOutput:(unsigned int)arg1 error:(id *)arg2;
...
- (_Bool)overrideOutputAudioPort:(unsigned int)arg1 error:(id *)arg2;
...
- (_Bool)setPreferredOutputNumberOfChannels:(int)arg1 error:(id *)arg2;
- (_Bool)setPreferredInputNumberOfChannels:(int)arg1 error:(id *)arg2;
- (_Bool)setInterruptionPriority:(int)arg1 error:(id *)arg2;
- (_Bool)setPreferredIOBufferFrameSize:(unsigned int)arg1 error:(id *)arg2;
...
@property(readonly) unsigned int recordPermission;
- (_Bool)setActive:(_Bool)arg1 withFlags:(int)arg2 error:(id *)arg3;
- (_Bool)deactivateAndSetInterruptionPriority:(int)arg1 error:(id *)arg2;
- (void)activateWithOptions:(unsigned int)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (_Bool)setActive:(_Bool)arg1 withOptions:(unsigned int)arg2 error:(id *)arg3;
- (_Bool)setActive:(_Bool)arg1 error:(id *)arg2;
- (_Bool)setCategory:(id)arg1 mode:(id)arg2 routeSharingPolicy:(unsigned int)arg3 options:(unsigned int)arg4 error:(id *)arg5;
- (_Bool)setCategory:(id)arg1 mode:(id)arg2 options:(unsigned int)arg3 error:(id *)arg4;
- (_Bool)setCategory:(id)arg1 withOptions:(unsigned int)arg2 error:(id *)arg3;
- (_Bool)privateSetOptions:(unsigned int)arg1 forCategory:(id)arg2 error:(id *)arg3;
- (_Bool)setCategory:(id)arg1 error:(id *)arg2;
@property(readonly) NSArray *availableCategories;
@property(readonly) unsigned int routeSharingPolicy;
@property(readonly) unsigned int categoryOptions;
@property(readonly) NSString *category;
- (void)dealloc;
- (id)initAuxiliarySession;
- (id)initWithSessionID:(unsigned int)arg1;
- (id)initWithSessionType:(unsigned long)arg1;
- (id)init;
- (id)autorelease;
- (oneway void)release;
