...
@optional
- (void)depthDataOutput:(AVCaptureDepthDataOutput *)arg1 didDropDepthData:(AVDepthData *)arg2 timestamp:(CDStruct_1b6d18a9)arg3 connection:(AVCaptureConnection *)arg4 reason:(int)arg5;
