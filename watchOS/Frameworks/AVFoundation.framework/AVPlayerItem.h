...
+ (long)_createFigPlaybackItemForFigPlayer:(struct OpaqueFigPlayer *)arg1 asset:(id)arg2 URL:(id)arg3 flags:(unsigned int)arg4 options:(struct __CFDictionary *)arg5 playbackItem:(struct OpaqueFigPlaybackItem **)arg6;
