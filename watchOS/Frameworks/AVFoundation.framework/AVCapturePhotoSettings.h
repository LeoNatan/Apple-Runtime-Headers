...
+ (id)photoSettingsWithRawPixelFormatType:(unsigned long)arg1 rawFileType:(id)arg2 processedFormat:(id)arg3 processedFileType:(id)arg4;
...
@property(nonatomic) int photoQualityPrioritization; // @synthesize photoQualityPrioritization=_photoQualityPrioritization;
...
- (unsigned long)embeddedThumbnailFormatFourCC;
...
- (id)init;
- (id)_initWithFormat:(id)arg1 processedFileType:(id)arg2 rawPixelFormatType:(unsigned long)arg3 rawFileType:(id)arg4 burstQualityCaptureEnabled:(_Bool)arg5 uniqueID:(long long)arg6 exceptionReason:(id *)arg7;
