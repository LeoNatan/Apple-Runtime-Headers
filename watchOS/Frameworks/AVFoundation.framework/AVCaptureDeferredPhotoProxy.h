...
- (id)initWithTimestamp:(CDStruct_1b6d18a9)arg1 proxySurface:(struct __IOSurface *)arg2 proxySurfaceSize:(unsigned long)arg3 proxyFileType:(id)arg4 previewPhotoSurface:(struct __IOSurface *)arg5 metadata:(id)arg6 captureRequest:(id)arg7 sequenceCount:(unsigned int)arg8 photoCount:(unsigned int)arg9 captureRequestIdentifier:(id)arg10 photoIdentifier:(id)arg11 expectedPhotoProcessingFlags:(unsigned int)arg12 sourceDeviceType:(id)arg13;
