...
- (id).cxx_construct;
- (void).cxx_destruct;
-     // Error parsing type: ^{Structure=^{Structure}CCCC{StructureIDBlob=(?={?=^{Structure}CCCC}{?=ii}q)}SC{Lock={Atomic<unsigned char>={atomic<unsigned char>={__cxx_atomic_impl<unsigned char, std::__1::__cxx_atomic_base_impl<unsigned char> >=AC}}}}I{WriteBarrier<JSC::JSGlobalObject, WTF::DumbPtrTraits<JSC::JSGlobalObject> >=^{JSGlobalObject}}{WriteBarrier<JSC::Unknown, WTF::DumbValueTraits<JSC::Unknown> >=q}{WriteBarrier<JSC::StructureChain, WTF::DumbPtrTraits<JSC::StructureChain> >=^{StructureChain}}{WriteBarrier<JSC::JSCell, WTF::DumbPtrTraits<JSC::JSCell> >=^{JSCell}}{RefPtr<WTF::UniquedStringImpl, WTF::DumbPtrTraits<WTF::UniquedStringImpl> >=^{UniquedStringImpl}}^{ClassInfo}{StructureTransitionTable=i}{WriteBarrier<JSC::PropertyTable, WTF::DumbPtrTraits<JSC::PropertyTable> >=^{PropertyTable}}{InlineWatchpointSet=I}iI{TinyBloomFilter=I}}12@0:4@8, name: structureInContext:
