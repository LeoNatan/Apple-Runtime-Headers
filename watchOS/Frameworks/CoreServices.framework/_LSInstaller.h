...
- (void)_doinstallApplication:(id)arg1 atURL:(id)arg2 withOptions:(id)arg3 installType:(unsigned int)arg4 reply:(CDUnknownBlockType)arg5;
...
- (int)getNotificationTypeForOperation:(unsigned int)arg1;
