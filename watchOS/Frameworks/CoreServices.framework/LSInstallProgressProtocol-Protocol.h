...
- (void)installationEndedForApplication:(NSString *)arg1 withState:(unsigned int)arg2;
- (void)createInstallProgressForApplication:(LSApplicationProxy *)arg1 withPhase:(unsigned int)arg2 andPublishingString:(NSString *)arg3 reply:(void (^)(NSError *))arg4;
- (void)removeObserver;
- (void)addObserver;
@end
