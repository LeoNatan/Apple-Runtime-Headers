...
- (void)getIdentifierOfType:(int)arg1 vendorName:(NSString *)arg2 bundleIdentifier:(NSString *)arg3 completionHandler:(void (^)(NSUUID *))arg4;
- (void)getIdentifierOfType:(int)arg1 completionHandler:(void (^)(NSUUID *))arg2;
@end
