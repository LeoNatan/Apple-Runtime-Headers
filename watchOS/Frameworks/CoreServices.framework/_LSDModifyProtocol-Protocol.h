...
- (void)uninstallApplication:(NSString *)arg1 withOptions:(NSDictionary *)arg2 uninstallType:(unsigned int)arg3 reply:(void (^)(NSArray *, NSError *))arg4;
- (void)installApplication:(NSString *)arg1 atURL:(NSURL *)arg2 withOptions:(NSDictionary *)arg3 installType:(unsigned int)arg4 reply:(void (^)(NSArray *, NSError *))arg5;
...
- (void)removeHandlerForContentType:(NSString *)arg1 roles:(unsigned long)arg2 completionHandler:(void (^)(_Bool, NSError *))arg3;
- (void)setHandlerOptions:(unsigned long)arg1 forContentType:(NSString *)arg2 completionHandler:(void (^)(_Bool, NSError *))arg3;
- (void)setHandler:(NSString *)arg1 version:(unsigned long long)arg2 roles:(unsigned long)arg3 forContentType:(NSString *)arg4 completionHandler:(void (^)(_Bool, NSError *))arg5;
...
- (void)unregisterBundleUnit:(unsigned int)arg1 options:(unsigned long)arg2 completionHandler:(void (^)(_Bool, NSError *))arg3;
