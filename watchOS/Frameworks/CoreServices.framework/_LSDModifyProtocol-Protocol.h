...
- (void)setHandler:(NSString *)arg1 version:(struct LSVersionNumber)arg2 roles:(unsigned long)arg3 forContentType:(NSString *)arg4 completionHandler:(void (^)(_Bool, NSError *))arg5;
