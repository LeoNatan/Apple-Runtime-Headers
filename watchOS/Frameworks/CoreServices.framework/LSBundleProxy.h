...
@interface LSBundleProxy : LSResourceProxy <NSSecureCoding>
{
    ...
    NSArray *_machOUUIDs;
    unsigned int _compatibilityState;
...
@property(nonatomic, setter=_setCompatibilityState:) unsigned int compatibilityState; // @synthesize compatibilityState=_compatibilityState;
...
- (id)_initWithBundleUnit:(unsigned int)arg1 context:(struct LSContext *)arg2 bundleType:(unsigned int)arg3 bundleID:(id)arg4 localizedName:(id)arg5 bundleContainerURL:(id)arg6 dataContainerURL:(id)arg7 resourcesDirectoryURL:(id)arg8 iconsDictionary:(id)arg9 iconFileNames:(id)arg10 version:(id)arg11;
- (id)localizedName;
