...
- (id)initWithDirectory:(unsigned int)arg1 inDomain:(unsigned int)arg2 lastPathComponent:(id)arg3 createIntermediateDirectories:(_Bool)arg4 flags:(unsigned int)arg5 error:(id *)arg6;
