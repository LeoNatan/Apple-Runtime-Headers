...
+ (id)_resolvedNodeFromAliasFile:(id)arg1 flags:(unsigned long)arg2 error:(id *)arg3;
+ (id)_resolvedURLFromAliasFile:(id)arg1 flags:(unsigned long)arg2 error:(id *)arg3;
+ (id)rootVolumeNode;
...
+ (unsigned long)compareBookmarkData:(id)arg1 toBookmarkData:(id)arg2;
...
- (void)dealloc;
- (id)initWithURL:(id)arg1 flags:(unsigned long)arg2 error:(id *)arg3;
- (id)initTemporaryNodeOnVolume:(id)arg1 flags:(unsigned long)arg2 fileDescriptor:(int *)arg3 error:(id *)arg4;
- (id)initWithConfigurationString:(int)arg1 flags:(unsigned long)arg2 error:(id *)arg3;
- (id)initWithDirectory:(unsigned int)arg1 inDomain:(unsigned int)arg2 lastPathComponent:(id)arg3 createIntermediateDirectories:(_Bool)arg4 flags:(unsigned long)arg5 error:(id *)arg6;
- (id)initWithFileSystemRepresentation:(const char *)arg1 flags:(unsigned long)arg2 error:(id *)arg3;
- (void)setTemporaryResourceValue:(id)arg1 forKey:(id)arg2;
- (_Bool)getTemporaryResourceValue:(id *)arg1 forKey:(id)arg2;
- (_Bool)setResourceValue:(id)arg1 forKey:(id)arg2 options:(unsigned long)arg3 error:(id *)arg4;
- (_Bool)getResourceValue:(id *)arg1 forKey:(id)arg2 options:(unsigned long)arg3 error:(id *)arg4;
...
- (id)temporaryDirectoryNodeWithFlags:(unsigned long)arg1 error:(id *)arg2;
- (id)resolvedNodeWithFlags:(unsigned long)arg1 error:(id *)arg2;
@property(copy, nonatomic) FSNode *referringAliasNode;
- (id)diskImageURLWithFlags:(unsigned long)arg1 error:(id *)arg2;
- (id)volumeNodeWithFlags:(unsigned long)arg1 error:(id *)arg2;
- (id)childNodeWithRelativePath:(id)arg1 flags:(unsigned long)arg2 error:(id *)arg3;
...
- (id)initByResolvingBookmarkData:(id)arg1 options:(unsigned int)arg2 relativeToNode:(id)arg3 bookmarkDataIsStale:(_Bool *)arg4 error:(id *)arg5;
- (id)bookmarkDataWithOptions:(unsigned int)arg1 relativeToNode:(id)arg2 error:(id *)arg3;
