...
+ (id)displayNameConstructorWithContext:(struct LSContext *)arg1 bundle:(unsigned int)arg2 bundleClass:(const unsigned long *)arg3 node:(id)arg4 preferredLocalizations:(id)arg5 error:(id *)arg6;
...
- (void)initNodeBitsWithContext:(struct LSContext *)arg1 node:(id)arg2 bundleClass:(const unsigned long *)arg3;
- (id)initWithContext:(struct LSContext *)arg1 node:(id)arg2 bundleClass:(const unsigned long *)arg3 desiredDisplayName:(id)arg4 treatAsFSName:(_Bool)arg5;
- (_Bool)isStringNaturallyRTL:(id)arg1;
- (id)balanceBiDiControlCharacter:(unsigned short)arg1 inString:(id)arg2 imbalanceAmount:(int)arg3;
