...
- (id <MTLRenderPipelineState>)newRenderPipelineStateWithName:(NSString *)arg1 options:(unsigned int)arg2 reflection:(id *)arg3 error:(id *)arg4;
- (id <MTLComputePipelineState>)newComputePipelineStateWithName:(NSString *)arg1 options:(unsigned int)arg2 reflection:(id *)arg3 error:(id *)arg4;
@end
