...
@property(readonly) unsigned int dirtySize; // @dynamic dirtySize;
...
@property(readonly) unsigned int residentSize; // @dynamic residentSize;
@property(readonly) unsigned long long uniqueIdentifier; // @dynamic uniqueIdentifier;
@property(readonly) unsigned int virtualSize; // @dynamic virtualSize;
