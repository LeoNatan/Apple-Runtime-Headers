...
@class MTLCommandQueueDescriptor, MTLComputePipelineDescriptor, MTLStructType, MTLTextureDescriptor, NSArray, NSData, NSObject<OS_dispatch_data>, NSString, _MTLIndirectArgumentBufferLayout;
