...
- (void)setIndirectArgumentBuffer:(id <MTLBuffer>)arg1 startOffset:(unsigned int)arg2 arrayElement:(unsigned int)arg3;
- (void)setIndirectArgumentBuffer:(id <MTLBuffer>)arg1 offset:(unsigned int)arg2;
@end
