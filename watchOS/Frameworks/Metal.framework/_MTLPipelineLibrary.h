...
- (id)newRenderPipelineStateWithName:(id)arg1 options:(unsigned int)arg2 reflection:(id *)arg3 error:(id *)arg4;
- (id)newComputePipelineStateWithName:(id)arg1 options:(unsigned int)arg2 reflection:(id *)arg3 error:(id *)arg4;
