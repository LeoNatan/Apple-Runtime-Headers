...
@interface MTLRenderPipelineReflectionInternal : MTLRenderPipelineReflection
{
    ...
    unsigned int _postVertexDumpStride;
...
- (unsigned int)postVertexDumpStride;
...
- (void)dealloc;
- (id)initWithTileData:(id)arg1 functionType:(unsigned int)arg2 device:(id)arg3 options:(unsigned int)arg4 flags:(CDStruct_7ce1aa5b)arg5;
- (id)initWithTileData:(id)arg1 device:(id)arg2 options:(unsigned int)arg3 flags:(CDStruct_7ce1aa5b)arg4;
...
- (id)initWithVertexData:(id)arg1 fragmentData:(id)arg2 serializedVertexDescriptor:(id)arg3 device:(id)arg4 options:(unsigned int)arg5 flags:(CDStruct_7ce1aa5b)arg6;
