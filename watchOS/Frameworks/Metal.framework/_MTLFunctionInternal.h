...
- (id).cxx_construct;
- (id)functionInputs;
- (unsigned int)renderTargetArrayIndexType;
- (int)lineNumber;
...
- (void)dealloc;
- (id)initWithName:(id)arg1 type:(unsigned int)arg2 libraryData:(struct MTLLibraryData *)arg3 functionData:(struct MTLFunctionData *)arg4 device:(id)arg5;
