...
- (void)processResultFromPlist:(id)arg1 atIndex:(unsigned int)arg2 protectionClass:(id)arg3 oids:(long long *)arg4 oidCount:(unsigned int)arg5 items:(id)arg6 isTopHitQuery:(_Bool)arg7;
- (id)createCSSearchableItemWithOID:(long long)arg1 values:(id *)arg2 valueCount:(unsigned int)arg3 protectionClass:(id)arg4 isTopHitQuery:(_Bool)arg5;
