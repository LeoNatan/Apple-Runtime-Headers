...
- (void)processResultFromPlist:(id)arg1 atIndex:(unsigned int)arg2 protectionClass:(id)arg3 oids:(long long *)arg4 oidCount:(unsigned int)arg5 addItems:(id *)arg6 updateItems:(id *)arg7 moveItems:(id *)arg8;
...
- (void)_removeIdentifiers:(id)arg1 withBundleID:(id)arg2 andQueryID:(int)arg3;
...
- (id)init;
- (id)copyCSSearchableItemWithValues:(id *)arg1 valueCount:(unsigned int)arg2 attrKeys:(unsigned int *)arg3 protectionClass:(id)arg4 mappingStrategy:(id)arg5 attrInfo:(short *)arg6 requestedAttributeCount:(unsigned int)arg7 unpackInfo:(struct CSUnpackInfo)arg8 userFSDomain:(id)arg9;
