...
+ (id)computePartialPathWithOID:(id)arg1 pathKeyIdx:(unsigned int)arg2 pathDictionary:(id)arg3 attributeValues:(id)arg4 depth:(int)arg5;
...
- (void)bulkFetchAttributes:(id)arg1 protectionClass:(id)arg2 bundleID:(id)arg3 objects:(id)arg4 attributeKeyIndex:(int)arg5 includeParents:(_Bool)arg6 completionHandler:(CDUnknownBlockType)arg7;
