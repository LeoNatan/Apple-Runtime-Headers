...
@property unsigned int maximumBatchSize; // @synthesize maximumBatchSize=_maximumBatchSize;
...
- (void)dealloc;
- (id)initWithIdleTime:(double)arg1 idleTimeLeeway:(double)arg2 maximumBatchSize:(unsigned int)arg3 mode:(int)arg4 notifyBlock:(CDUnknownBlockType)arg5;
- (id)initWithMode:(int)arg1 notifyBlock:(CDUnknownBlockType)arg2;
