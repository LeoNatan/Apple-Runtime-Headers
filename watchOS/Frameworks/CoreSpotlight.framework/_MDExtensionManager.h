...
@interface _MDExtensionManager : NSObject <CSIndexExtensionDelegate>
{
    ...
    int _loaderCallbackCount;
}

- (void).cxx_destruct;
@property(nonatomic) int loaderCallbackCount; // @synthesize loaderCallbackCount=_loaderCallbackCount;
...
- (void)_performJob:(id)arg1 extensions:(id)arg2 count:(unsigned int)arg3 throttle:(id)arg4 perExtensionCompletionHandler:(CDUnknownBlockType)arg5;
