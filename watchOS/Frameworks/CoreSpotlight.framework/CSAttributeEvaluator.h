...
@property(nonatomic) unsigned int matcherCount; // @synthesize matcherCount=_matcherCount;
...
- (void)dealloc;
- (id)initWithQuery:(id)arg1 language:(id)arg2 fuzzyThreshold:(unsigned char)arg3 options:(unsigned int)arg4;
