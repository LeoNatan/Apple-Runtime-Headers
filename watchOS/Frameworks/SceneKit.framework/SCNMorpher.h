...
+ (id)weightIndexStringForIndex:(int)arg1;
+ (id)morpher;
...
- (id)inBetweenWeightsForTargetAtIndex:(unsigned int)arg1;
- (id)inBetweenTargetsForTargetAtIndex:(unsigned int)arg1;
...
- (int)_weightIndexForTargetNamed:(id)arg1;
