...
+ (id)geometrySourceWithData:(NSData *)arg1 semantic:(NSString *)arg2 vectorCount:(int)arg3 floatComponents:(_Bool)arg4 componentsPerVector:(int)arg5 bytesPerComponent:(int)arg6 dataOffset:(int)arg7 dataStride:(int)arg8;
