...
- (void)_updateCloneStateWithEvent:(CDStruct_795afb14)arg1;
- (id)setupClones;
- (void)validateClones;
- (void)addClonesToScene;
- (void)removeClonesFromScene;
- (id)scene;
- (_Bool)mouseUp:(CDStruct_795afb14)arg1;
- (_Bool)mouseDown:(CDStruct_795afb14)arg1;
- (_Bool)mouseDragged:(CDStruct_795afb14)arg1;
- (void)clearSnapIndexes;
- (_Bool)_applyWithEvent:(CDStruct_795afb14)arg1;
...
- (_Bool)mouseMoved:(CDStruct_795afb14)arg1;
- (void)_updateActionWithEvent:(CDStruct_795afb14)arg1;
- (id)hitTest:(CDStruct_795afb14)arg1;
- (void)unhighlightSelectedNode;
- (void)unlockLayout;
- (void)lockLayout;
@property(nonatomic) unsigned int features;
- (void)setAlternateMode:(_Bool)arg1;
- (unsigned int)_effectiveFeatures;
