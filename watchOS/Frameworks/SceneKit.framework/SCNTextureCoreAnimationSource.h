...
-     // Error parsing type: d24@0:4@8@12^{__C3DEngineContext=}16^{__C3DTextureSampler={__CFRuntimeBase=IAI}llllll{C3DColor4=(?=[4f]{?=ffff})}fClI}20, name: __updateTextureWithLayer:texture:engineContext:sampler:
