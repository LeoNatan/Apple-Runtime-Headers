...
-     // Error parsing type: v72@0:4(C3DMatrix4x4=[16f][4]{?=[4]})8, name: _updateMaterialPropertyTransform:
...
-     // Error parsing type: ^{__C3DEffectSlot={__CFRuntimeBase=IAI}{C3DColor4=(?=[4f]{?=ffff})}^v(?=^{__C3DImage}^v^{__C3DImageProxy}^{__C3DTexture})b8b1b1b1b4c^{__C3DTextureSampler}^(C3DMatrix4x4)fi^v}12@0:4B8, name: effectSlotCreateIfNeeded:
