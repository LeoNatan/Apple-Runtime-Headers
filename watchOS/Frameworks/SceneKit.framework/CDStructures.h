...
struct SCNMTLRenderCommandEncoder {
    ...
    _Bool _field12;
    _Bool _field13;
    CDStruct_1999e51d _field14[31];
    id _field15[96];
    id _field16[16];
    CDStruct_1999e51d _field17[31];
    id _field18[96];
    id _field19[16];
    id _field20;
    id _field21;
...
struct Target {
    CDStruct_827d7df1 _field1;
    unsigned int _field2;
    float _field3;
    struct __C3DMeshSource *_field4[3];
    CDStruct_827d7df1 _field5;
};
...
typedef struct {
    CDStruct_ed4b32f0 _field1;
    id _field2;
    CDStruct_797aae0e _field3;
    struct __C3DBlendStates *_field4;
    unsigned int _field5[8];
    id _field6;
    id _field7;
    id _field8;
    id _field9;
