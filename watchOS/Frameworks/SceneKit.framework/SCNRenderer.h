...
@class AVAudioEngine, AVAudioEnvironmentNode, EAGLContext, NSString, SCNAuthoringEnvironment, SCNMTLRenderContext, SCNNode, SCNRecursiveLock, SCNRendererTransitionContext, SCNScene, SCNTechnique, SKScene, UIColor, __SKSCNRenderer;
...
@interface SCNRenderer : NSObject <SCNSceneRenderer, SCNTechniqueSupport>
{
    ...
    unsigned int __preparePixelFormat;
    struct {
...
- (id)snapshotAtTime:(double)arg1 withSize:(struct CGSize)arg2 antialiasingMode:(unsigned int)arg3;
...
-     // Error parsing type: 8@0:4, name: _drawableSafeAreaInsets
...
- (void)_set_watchAppInForeground:(_Bool)arg1;
...
- (void)_projectPoints:(struct SCNVector3 *)arg1 count:(unsigned int)arg2 viewport:(struct SCNVector4)arg3;
-     // Error parsing type: 24@0:48, name: viewportWithLetterboxingIfNeeded:
- (id)pointOfCulling;
...
-     // Error parsing type: ^{__C3DRendererContext={__CFRuntimeBase=IAI}lIIIIfI^{__C3DTexture}^{__C3DStack}^vBBBBB^{__CFDictionary}I^{__CFDictionary}^{__CFDictionary}^{__CFDictionary}{C3DColor4=(?=[4f]{?=ffff})}^vi^{__C3DFXProgramObject}{__C3DEngineStats=IIIIIIIIIIIIIIIIIIIIIIIIdddddddddddddddIIIIIIIIIIIIIIIIIdIdIdddd[60d]Idd}{Cache=[8I]Ii^{__C3DBlendStates}I^{__C3DRasterizerStates}^{__C3DMesh}^{__C3DMeshElement}LIiI^vii}{?=[2I][5i][14{?=iII}][14I]^?^?^?^?^?^?^?^?^?}[2{VolatileObject=^{__C3DArray}II^{__CFArray}}]^{__C3DArray}I^{__CFDictionary}}8@0:4, name: _rendererContextGL
- (struct __C3DEngineContext *)_engineContext;
...
- (id)_initWithOptions:(id)arg1 isPrivateRenderer:(_Bool)arg2 privateRendererOwner:(id)arg3 clearsOnDraw:(_Bool)arg4 context:(void *)arg5 renderingAPI:(unsigned int)arg6;
- (void)_setupOffscreenRendererWithSize:(struct CGSize)arg1;
- (id)init;
- (_Bool)renderMovieToURL:(id)arg1 size:(struct CGSize)arg2 antialiasingMode:(unsigned int)arg3 attributes:(id)arg4 error:(id *)arg5;
