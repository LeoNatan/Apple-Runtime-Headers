...
{
    // Error parsing type: ^{__C3DNode={__C3DEntity={__CFRuntimeBase=IAI}^v^{__CFString}^{__CFString}^{__CFDictionary}^{__C3DScene}i}^{__C3DNode}^{__C3DNode}^{__C3DNode}i{?=(C3DMatrix4x4=[16f][4]{?=[4]})(?=)}^(C3DMatrix4x4)BfIib1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b3{?={?=SS}I}^{?}^{__C3DGeometry}^{__C3DSkinner}f{?=}}, name: _node
    SCNNode *_parent;
...
+     // Error parsing type: @12@0:4^{__C3DNode={__C3DEntity={__CFRuntimeBase=IAI}^v^{__CFString}^{__CFString}^{__CFDictionary}^{__C3DScene}i}^{__C3DNode}^{__C3DNode}^{__C3DNode}i{?=(C3DMatrix4x4=[16f][4]{?=[4]})(?=)}^(C3DMatrix4x4)BfIib1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b3{?={?=SS}I}^{?}^{__C3DGeometry}^{__C3DSkinner}f{?=}}8, name: nodeWithNodeRef:
...
+     // Error parsing type: 8@0:4, name: simdLocalFront
+     // Error parsing type: 8@0:4, name: simdLocalRight
+     // Error parsing type: 8@0:4, name: simdLocalUp
...
@property(nonatomic) int focusBehavior;
...
-     // Error parsing type: ^{__C3DNode={__C3DEntity={__CFRuntimeBase=IAI}^v^{__CFString}^{__CFString}^{__CFDictionary}^{__C3DScene}i}^{__C3DNode}^{__C3DNode}^{__C3DNode}i{?=(C3DMatrix4x4=[16f][4]{?=[4]})(?=)}^(C3DMatrix4x4)BfIib1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b3{?={?=SS}I}^{?}^{__C3DGeometry}^{__C3DSkinner}f{?=}}8@0:4, name: nodeRef
- (id)__morpher;
- (id)__skinner;
- (id)__geometry;
- (id)__camera;
...
-     // Error parsing type: @12@0:4^{__C3DNode={__C3DEntity={__CFRuntimeBase=IAI}^v^{__CFString}^{__CFString}^{__CFDictionary}^{__C3DScene}i}^{__C3DNode}^{__C3DNode}^{__C3DNode}i{?=(C3DMatrix4x4=[16f][4]{?=[4]})(?=)}^(C3DMatrix4x4)BfIib1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b3{?={?=SS}I}^{?}^{__C3DGeometry}^{__C3DSkinner}f{?=}}8, name: initWithNodeRef:
-     // Error parsing type: @12@0:4^{__C3DNode={__C3DEntity={__CFRuntimeBase=IAI}^v^{__CFString}^{__CFString}^{__CFDictionary}^{__C3DScene}i}^{__C3DNode}^{__C3DNode}^{__C3DNode}i{?=(C3DMatrix4x4=[16f][4]{?=[4]})(?=)}^(C3DMatrix4x4)BfIib1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b1b3{?={?=SS}I}^{?}^{__C3DGeometry}^{__C3DSkinner}f{?=}}8, name: initPresentationNodeWithNodeRef:
- (id)init;
@property(nonatomic) int authoringCameraType;
...
-     // Error parsing type: {?=[4]}76@0:4{?=[4]}8@72, name: simdConvertTransform:fromNode:
-     // Error parsing type: {?=[4]}76@0:4{?=[4]}8@72, name: simdConvertTransform:toNode:
-     // Error parsing type: 28@0:48@24, name: simdConvertVector:fromNode:
-     // Error parsing type: 28@0:48@24, name: simdConvertVector:toNode:
-     // Error parsing type: 28@0:48@24, name: simdConvertPosition:fromNode:
-     // Error parsing type: 28@0:48@24, name: simdConvertPosition:toNode:
