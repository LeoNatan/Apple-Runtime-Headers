...
@interface SCNCameraNavigationController : NSObject <SCNEventHandler, SCNCameraControllerDelegate>
{
    ...
    struct {
        ...
        unsigned int direction__pickedAxis;
        unsigned int userStickyAxis;
    } _stickyAxis;
    struct {
...
-     // Error parsing type: 12@0:4@8, name: _defaultTargetForScene:
- (void)_startBrowsingIfNeeded:(struct CGPoint)arg1;
-     // Error parsing type: 8@0:4, name: worldFront
...
- (unsigned int)_effectiveStickyAxis;
@property(nonatomic) unsigned int stickyAxis;
