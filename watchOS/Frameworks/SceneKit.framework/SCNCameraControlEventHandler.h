...
+     // Error parsing type: 12@0:4@8, name: frontVectorWithPointOfView:
...
- (void)_rotateWithDrag:(struct CGPoint)arg1 mode:(int)arg2 stickyAxis:(unsigned int)arg3;
- (void)clearRoll;
...
@property unsigned int stickyAxis;
