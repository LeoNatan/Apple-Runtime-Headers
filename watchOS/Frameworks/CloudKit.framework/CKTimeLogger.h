...
- (void)appendStatusReportToString:(id)arg1 withIndent:(unsigned int)arg2 showingPointers:(_Bool)arg3;
- (void)appendStatusReportForType:(id)arg1 toString:(id)arg2 withIndent:(unsigned int)arg3 showingPointers:(_Bool)arg4;
- (id)description;
