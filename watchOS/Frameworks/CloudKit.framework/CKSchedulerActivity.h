...
@interface CKSchedulerActivity : NSObject
{
    ...
    int _priority;
    unsigned int _expectedTransferSizeBytes;
...
@property(nonatomic) unsigned int expectedTransferSizeBytes; // @synthesize expectedTransferSizeBytes=_expectedTransferSizeBytes;
...
- (id)initWithIdentifier:(id)arg1 containerID:(id)arg2 priority:(int)arg3;
