...
+ (unsigned int)remainingCapacityAtURL:(id)arg1 error:(id *)arg2;
+ (int)canCopyFromFileURL:(id)arg1 toDirectoryURL:(id)arg2;
+ (int)estimatedSizeForAssetOrPackage:(id)arg1;
+ (id)nameForEvent:(int)arg1;
+ (int)repairRetryCount;
+ (unsigned int)diskSpaceBuffer;
+ (double)defaultSuspensionTime;
+ (int)packageSizeEstimate;
+ (int)assetSizeEstimate;
+ (int)cacheSizeLimit;
+ (int)cacheCountLimit;
+ (int)repairBatchCountLimit;
+ (int)repairBatchSizeLimit;
...
- (void)scheduleRequestsWithMaxCount:(int)arg1;
- (void)respondToEvent:(int)arg1 withObject:(id)arg2;
- (void)tickle;
