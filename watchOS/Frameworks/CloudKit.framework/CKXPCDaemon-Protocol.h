...
- (void)deviceCountWithSetupInfo:(CKContainerSetupInfo *)arg1 completionHandler:(void (^)(int, NSError *))arg2;
...
- (void)statusGroupsForApplicationPermission:(unsigned int)arg1 setupInfo:(CKContainerSetupInfo *)arg2 completionHandler:(void (^)(NSArray *, NSError *))arg3;
- (void)resetAllApplicationPermissionsWithSetupInfo:(CKContainerSetupInfo *)arg1 completionHandler:(void (^)(NSError *))arg2;
- (void)setApplicationPermission:(unsigned int)arg1 enabled:(_Bool)arg2 setupInfo:(CKContainerSetupInfo *)arg3 completionHandler:(void (^)(int, NSError *))arg4;
- (void)accountWithID:(NSString *)arg1 changedWithChangeType:(int)arg2;
...
- (void)getOutstandingOperationCountWithSetupInfo:(CKContainerSetupInfo *)arg1 completionHandler:(void (^)(unsigned int, NSError *))arg2;
- (void)wipeAllCachedLongLivedProxiesWithSetupInfo:(CKContainerSetupInfo *)arg1 completionHandler:(void (^)(NSError *))arg2;
- (void)clearCachesForZoneWithSetupInfo:(CKContainerSetupInfo *)arg1 zoneID:(CKRecordZoneID *)arg2 databaseScope:(int)arg3 completionHandler:(void (^)(NSError *))arg4;
- (void)clearCachesForRecordWithSetupInfo:(CKContainerSetupInfo *)arg1 recordID:(CKRecordID *)arg2 databaseScope:(int)arg3 completionHandler:(void (^)(NSError *))arg4;
- (void)clearCachesWithSetupInfo:(CKContainerSetupInfo *)arg1 options:(unsigned int)arg2 databaseScope:(int)arg3 completionHandler:(void (^)(NSError *))arg4;
...
- (void)showAssetCacheWithSetupInfo:(CKContainerSetupInfo *)arg1 databaseScope:(int)arg2;
- (void)clearAssetCacheWithSetupInfo:(CKContainerSetupInfo *)arg1 databaseScope:(int)arg2 completionHandler:(void (^)(NSError *))arg3;
- (void)countAssetCacheItemsWithSetupInfo:(CKContainerSetupInfo *)arg1 databaseScope:(int)arg2 completionHandler:(void (^)(unsigned int, NSError *))arg3;
...
- (void)serverEnvironmentWithSetupInfo:(CKContainerSetupInfo *)arg1 completionHandler:(void (^)(int, NSError *))arg2;
...
- (void)accountStatusWithSetupInfo:(CKContainerSetupInfo *)arg1 completionHandler:(void (^)(int, NSError *))arg2;
