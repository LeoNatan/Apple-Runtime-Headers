...
- (id)initWithRepairZoneRecordID:(id)arg1 databaseScope:(int)arg2 recordID:(id)arg3 recordType:(id)arg4 fieldName:(id)arg5 fileSignatures:(id)arg6 referenceSignatures:(id)arg7;
