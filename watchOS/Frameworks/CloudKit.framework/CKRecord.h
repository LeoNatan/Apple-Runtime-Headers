...
+ (id)keyForFetchingItems:(unsigned int)arg1 atEndOfListField:(id)arg2;
+ (id)keyForAppendingToListField:(id)arg1;
+ (id)keyForInsertingIntoListField:(id)arg1 atIndex:(int)arg2;
...
@property(readonly, nonatomic) unsigned int assetDiskSize;
