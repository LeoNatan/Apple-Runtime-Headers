...
- (void)setApplicationPermission:(unsigned int)arg1 enabled:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)_fetchImportantUserRecordIDOfType:(int)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (id)_importantUserRecordIDOfType:(int)arg1;
- (void)_setImportantUserRecordID:(id)arg1 ofType:(int)arg2;
