...
@interface CKStreamingAsset : NSObject <CKRecordValue, NSSecureCoding, NSCopying>
{
    ...
    NSString *_owner;
    unsigned int _expectedSizeBytes;
    NSURL *_uploadURL;
...
@property(nonatomic) unsigned int reservedSize; // @synthesize reservedSize=_reservedSize;
...
@property(nonatomic) unsigned int expectedSizeBytes; // @synthesize expectedSizeBytes=_expectedSizeBytes;
...
- (id)init;
- (id)_initBare;
- (id)initWithExpectedSizeBytes:(unsigned int)arg1;
