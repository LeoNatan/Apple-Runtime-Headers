...
- (void)transactionEnd:(id)arg1 reason:(unsigned int)arg2 absoluteTime:(double)arg3;
...
- (void)taskCreate:(id)arg1 pointer:(unsigned int)arg2 withRequest:(id)arg3 fromSession:(id)arg4 absoluteTime:(double)arg5;
...
- (void)sessionCreate:(id)arg1 pointer:(unsigned int)arg2 absoluteTime:(double)arg3;
