...
- (int)execSQLStatement:(const char *)arg1 onConnection:(struct sqlite3 *)arg2 toCompletionWithRetry:(int)arg3 writeLockHeld:(_Bool)arg4;
- (int)stepSQLStatement:(struct sqlite3_stmt *)arg1 toCompletionWithRetry:(int)arg2;
-     // Error parsing type: v16@0:4@8^{_CFURLCache={__CFRuntimeBase=IAI}{shared_ptr<__CFURLCache>=^{__CFURLCache}^{__shared_weak_count}}}12, name: performTimeRelativeLookupWithInitialTime:caller:
-     // Error parsing type: ^{_CFCachedURLResponse={__CFRuntimeBase=IAI}^{__CFCachedURLResponse}}24@0:4@8^@12^@16^{_CFURLCache={__CFRuntimeBase=IAI}{shared_ptr<__CFURLCache>=^{__CFURLCache}^{__shared_weak_count}}}20, name: createCachedResponseForKey:cacheDataPath:cacheDataFile:caller:
