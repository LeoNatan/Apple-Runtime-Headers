...
@class NSData, NSDate, NSDictionary, NSError, NSMutableArray, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, NSURLRequest, NSURLResponse, __NSURLSessionLocal;
...
@interface __NSCFURLLocalStreamTask : NSURLSessionStreamTask
{
    ...
    _Bool _readSignaled;
    _Bool _readEOF;
    CDStruct_8a2887be _readError;
    NSData *_writeBuffer;
    _Bool _writeSignaled;
    _Bool _writeEOF;
    _Bool _deliveredConnectionEstablished;
    CDStruct_8a2887be _writeError;
...
- (void)_onqueue_dealWithSessionTrustAuth:(int)arg1 credential:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)readDataOfMinLength:(unsigned int)arg1 maxLength:(unsigned int)arg2 timeout:(double)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)_onqueue_readDataOfMinLength:(unsigned int)arg1 maxLength:(unsigned int)arg2 timeout:(double)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (id)initWithHost:(id)arg1 port:(int)arg2 session:(id)arg3 disavow:(CDUnknownBlockType)arg4;
