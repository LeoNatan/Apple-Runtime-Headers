...
- (void)_onqueue_needConnectedSocketToHost:(id)arg1 port:(unsigned int)arg2 withCompletion:(CDUnknownBlockType)arg3;
...
- (void)_private_onqueue_didReceiveResponseDisposition:(int)arg1 completion:(CDUnknownBlockType)arg2;
