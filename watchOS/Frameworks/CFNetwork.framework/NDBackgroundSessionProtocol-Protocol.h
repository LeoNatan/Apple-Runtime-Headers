...
- (void)avAssetDownloadTaskWithDownloadToken:(unsigned long long)arg1 URL:(NSURL *)arg2 destinationURL:(NSURL *)arg3 temporaryDestinationURL:(NSURL *)arg4 assetTitle:(NSString *)arg5 assetArtworkData:(NSData *)arg6 options:(NSDictionary *)arg7 identifier:(unsigned int)arg8 uniqueIdentifier:(NSUUID *)arg9 reply:(void (^)(_Bool))arg10;
- (void)releaseWiFi;
- (void)retainWiFi;
...
- (void)downloadTaskWithResumeData:(NSData *)arg1 identifier:(unsigned int)arg2 uniqueIdentifier:(NSUUID *)arg3 reply:(void (^)(_Bool))arg4;
- (void)dataTaskWithRequest:(NSURLRequest *)arg1 originalRequest:(NSURLRequest *)arg2 identifier:(unsigned int)arg3 uniqueIdentifier:(NSUUID *)arg4 reply:(void (^)(_Bool))arg5;
- (void)uploadTaskWithRequest:(NSURLRequest *)arg1 originalRequest:(NSURLRequest *)arg2 fromFile:(NSURL *)arg3 sandboxExtensionData:(NSData *)arg4 identifier:(unsigned int)arg5 uniqueIdentifier:(NSUUID *)arg6 potentialCredentials:(NSDictionary *)arg7 reply:(void (^)(_Bool))arg8;
- (void)downloadTaskWithRequest:(NSURLRequest *)arg1 originalRequest:(NSURLRequest *)arg2 downloadFilePath:(NSString *)arg3 identifier:(unsigned int)arg4 uniqueIdentifier:(NSUUID *)arg5 reply:(void (^)(_Bool))arg6;
@end
