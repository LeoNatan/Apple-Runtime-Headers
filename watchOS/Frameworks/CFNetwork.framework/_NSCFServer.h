...
+ (_Bool)stopAll;
+ (_Bool)startSocksServerWithPort:(int)arg1;
+ (id)listeners;
- (void).cxx_destruct;
...
@property int listenerPort; // @synthesize listenerPort=_listenerPort;
...
- (_Bool)start;
- (id)init;
- (id)initWithType:(long long)arg1 port:(int)arg2;
- (id)initWithType:(long long)arg1;
- (id)initWithType:(long long)arg1 port:(int)arg2 interface:(id)arg3;
