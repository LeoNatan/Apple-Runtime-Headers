...
@property unsigned int HTTPCookieAcceptPolicy; // @dynamic HTTPCookieAcceptPolicy;
@property(retain) NSHTTPCookieStorage *HTTPCookieStorage; // @dynamic HTTPCookieStorage;
@property int HTTPMaximumConnectionsPerHost; // @dynamic HTTPMaximumConnectionsPerHost;
...
@property int _IDSMessageTimeout; // @dynamic _IDSMessageTimeout;
@property unsigned int _TCPAdaptiveReadTimeout; // @dynamic _TCPAdaptiveReadTimeout;
@property unsigned int _TCPAdaptiveWriteTimeout; // @dynamic _TCPAdaptiveWriteTimeout;
...
@property int _companionProxyPreference; // @dynamic _companionProxyPreference;
...
@property unsigned int _customReadBufferSize; // @dynamic _customReadBufferSize;
...
@property int _duetPreClearedMode; // @dynamic _duetPreClearedMode;
...
@property unsigned int _forcedNetworkServiceType; // @dynamic _forcedNetworkServiceType;
...
@property unsigned int _multipathAlternatePort; // @dynamic _multipathAlternatePort;
...
@property int minimumFastLanePriority; // @dynamic minimumFastLanePriority;
@property unsigned int networkServiceType; // @dynamic networkServiceType;
@property int numFastLanes; // @dynamic numFastLanes;
@property int numPriorityLevels; // @dynamic numPriorityLevels;
@property int pipeliningHighWatermark; // @dynamic pipeliningHighWatermark;
@property int pipeliningLowWatermark; // @dynamic pipeliningLowWatermark;
@property(copy) NSArray *protocolClasses; // @dynamic protocolClasses;
@property unsigned int requestCachePolicy; // @dynamic requestCachePolicy;
