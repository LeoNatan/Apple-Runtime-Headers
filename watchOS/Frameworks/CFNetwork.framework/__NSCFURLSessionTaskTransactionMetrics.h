...
@interface __NSCFURLSessionTaskTransactionMetrics : NSURLSessionTaskTransactionMetrics <NSSecureCoding>
{
    ...
    int __requestHeaderBytesSent;
    int __responseHeaderBytesReceived;
...
- (void)set_responseHeaderBytesReceived:(int)arg1;
- (int)_responseHeaderBytesReceived;
- (void)set_requestHeaderBytesSent:(int)arg1;
- (int)_requestHeaderBytesSent;
