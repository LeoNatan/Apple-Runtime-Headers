...
@property(nonatomic) int _discretionaryOverride; // @dynamic _discretionaryOverride;
...
@property long _requestPriority; // @dynamic _requestPriority;
...
@property unsigned int taskIdentifier; // @dynamic taskIdentifier;
