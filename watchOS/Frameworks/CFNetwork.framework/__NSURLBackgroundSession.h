...
- (void)backgroundAVAssetDownloadTask:(unsigned int)arg1 willDownloadToURL:(id)arg2;
- (void)backgroundAVAssetDownloadTask:(unsigned int)arg1 didResolveMediaSelectionProperyList:(id)arg2 reply:(CDUnknownBlockType)arg3;
...
- (void)backgroundTask:(unsigned int)arg1 didCompleteWithError:(id)arg2 info:(id)arg3 reply:(CDUnknownBlockType)arg4;
- (void)backgroundTask:(unsigned int)arg1 didFinishCollectingMetrics:(id)arg2 reply:(CDUnknownBlockType)arg3;
