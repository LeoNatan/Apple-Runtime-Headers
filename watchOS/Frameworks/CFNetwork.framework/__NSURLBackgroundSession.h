...
- (void)willRetryBackgroundDataTask:(unsigned int)arg1 withError:(id)arg2 transactionMetrics:(id)arg3;
- (void)backgroundDataTaskDidBecomeDownloadTask:(unsigned int)arg1;
- (void)backgroundTask:(unsigned int)arg1 getAuthHeadersForResponse:(id)arg2 reply:(CDUnknownBlockType)arg3;
- (void)backgroundDataTask:(unsigned int)arg1 didReceiveData:(id)arg2 withReply:(CDUnknownBlockType)arg3;
- (void)backgroundTask:(unsigned int)arg1 didCompleteWithError:(id)arg2 taskMetrics:(id)arg3 info:(id)arg4 reply:(CDUnknownBlockType)arg5;
- (void)backgroundTask:(unsigned int)arg1 needNewBodyStream:(_Bool)arg2 withReply:(CDUnknownBlockType)arg3;
...
- (void)backgroundTask:(unsigned int)arg1 didReceiveResponse:(id)arg2 transactionMetrics:(id)arg3 reply:(CDUnknownBlockType)arg4;
- (void)backgroundTask:(unsigned int)arg1 didReceiveResponse:(id)arg2 transactionMetrics:(id)arg3;
...
- (void)backgroundTask:(unsigned int)arg1 willBeginDelayedRequest:(id)arg2 reply:(CDUnknownBlockType)arg3;
