...
- (void)delegate_needConnectedSocketToHost:(id)arg1 port:(unsigned int)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
@property(readonly) unsigned int nextSeed; // @dynamic nextSeed;
