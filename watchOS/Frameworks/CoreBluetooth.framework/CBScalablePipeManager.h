...
- (void)registerEndpoint:(id)arg1 type:(int)arg2 priority:(int)arg3 options:(id)arg4;
- (void)registerEndpoint:(id)arg1 type:(int)arg2 priority:(int)arg3 transport:(int)arg4 requireEncryption:(_Bool)arg5;
