...
- (void)spritesFromGrid:(id)arg1 xDivisions:(int)arg2 zPosition:(float)arg3 spriteSize:(struct CGSize)arg4 texture:(id)arg5 physicsBody:(id)arg6;
- (void)spritesFromGrid:(id)arg1 gridSize:(struct CGSize)arg2 zPosition:(float)arg3 edgeColor:(id)arg4 interiorColor:(id)arg5 spriteSize:(struct CGSize)arg6 physicsBody:(id)arg7;
