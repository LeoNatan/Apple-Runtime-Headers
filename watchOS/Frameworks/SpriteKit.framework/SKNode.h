...
@property(nonatomic) int focusBehavior; // @synthesize focusBehavior=_focusBehavior;
...
- (_Bool)containsPoint:(struct CGPoint)arg1 withRadius:(float)arg2;
...
- (_Bool)hasChildren;
- (void)_processSearchTokens:(vector_408ca79d)arg1 visited:(set_fcfbded1 *)arg2 usingBlock:(CDUnknownBlockType)arg3 stopPointer:(_Bool *)arg4;
...
-     // Error parsing type: B16@0:4^^8^I12, name: _pathFromPhysicsBodyToPoints:outSize:
