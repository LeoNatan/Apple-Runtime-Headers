...
+ (int)_calShareeAccessLevelFromEKShareeAccessLevel:(unsigned int)arg1;
+ (unsigned int)_ekShareeAccessLevelFromCalShareeAccessLevel:(int)arg1;
+ (int)_calShareeStatusFromEKShareeStatus:(unsigned int)arg1;
+ (unsigned int)_ekShareeStatusFromCalShareeStatus:(int)arg1;
