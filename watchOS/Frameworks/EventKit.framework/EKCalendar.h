...
+ (id)_eventKitBundle;
+ (id)calendarForEntityTypes:(unsigned int)arg1 eventStore:(id)arg2;
...
@property(nonatomic) unsigned int cachedJunkStatus; // @synthesize cachedJunkStatus=_cachedJunkStatus;
- (_Bool)couldBeJunk;
...
- (void)_setFlagValue:(_Bool)arg1 withMask:(unsigned long)arg2;
- (_Bool)_flagValueWithMask:(unsigned long)arg1;
