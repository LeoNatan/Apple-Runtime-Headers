...
- (id)_importICSData:(id)arg1 intoCalendarsWithIDs:(id)arg2 options:(unsigned int)arg3;
...
- (id)initWithEKOptions:(unsigned int)arg1 path:(id)arg2 changeTrackingClientId:(id)arg3 enablePropertyModificationLogging:(_Bool)arg4;
- (id)initWithEKOptions:(unsigned int)arg1 path:(id)arg2 clientIDSuffix:(id)arg3 enablePropertyModificationLogging:(_Bool)arg4;
