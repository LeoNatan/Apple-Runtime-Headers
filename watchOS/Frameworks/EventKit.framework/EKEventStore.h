...
+ (unsigned int)ekEventStoreInitOptionsFromCalDatabaseInitOptions:(int)arg1;
+ (int)calDatabaseInitOptionsFromEKEventStoreInitOptions:(unsigned int)arg1;
...
- (unsigned int)addressValidationStatus:(id)arg1;
- (void)cacheValidationStatusForAddress:(id)arg1 status:(unsigned int)arg2;
- (void)purgeChangelog;
...
- (int)registerForDetailedChangeTracking:(id *)arg1;
...
- (id)predicateForCalendarItemsOfType:(unsigned int)arg1 withExternalID:(id)arg2 inSource:(id)arg3;
- (id)predicateForCalendarItemsOfType:(unsigned int)arg1 withExternalID:(id)arg2 inCalendar:(id)arg3;
- (id)predicateForCalendarItemsOfType:(unsigned int)arg1 withUniqueIdentifier:(id)arg2 inSource:(id)arg3;
- (id)predicateForCalendarItemsOfType:(unsigned int)arg1 withUniqueIdentifier:(id)arg2 inCalendar:(id)arg3;
- (id)predicateForMasterEventsWithExternalTrackingStatusInCalendar:(id)arg1;
- (id)predicateForCalendarItemsOfType:(unsigned int)arg1 inCalendar:(id)arg2;
...
- (unsigned int)eventNotificationCountForSource:(id)arg1 excludingDelegateSources:(_Bool)arg2 filteredByShowsNotificationsFlag:(_Bool)arg3;
...
- (id)scheduledTaskCacheFetchTasksOnDay:(id)arg1 maxResults:(unsigned int)arg2;
...
- (_Bool)accessGrantedForEntityType:(unsigned int)arg1;
- (_Bool)fetchProperties:(id)arg1 forReminders:(id)arg2;
- (id)predicateForRemindersWithTitle:(id)arg1 listTitle:(id)arg2 limitToCompletedOrIncomplete:(_Bool)arg3 completed:(_Bool)arg4 dueAfter:(id)arg5 dueBefore:(id)arg6 searchTerm:(id)arg7 sortOrder:(int)arg8 maxResults:(unsigned int)arg9;
...
- (id)predicateForPreloadedIncompleteRemindersWithDueDate:(id)arg1 calendars:(id)arg2 sortOrder:(int)arg3 preloadProperties:(id)arg4 maxResults:(unsigned int)arg5;
...
- (id)_predicateForRemindersWithDate:(id)arg1 useAsCompletionDate:(_Bool)arg2 calendars:(id)arg3 limitToCompletedOrIncomplete:(_Bool)arg4 completed:(_Bool)arg5 includeDatesBefore:(_Bool)arg6 sortOrder:(int)arg7 preloadProperties:(id)arg8 maxResults:(unsigned int)arg9;
...
- (id)_calendarItemsWithExternalIdentifier:(id)arg1 inCalendars:(id)arg2 entityTypes:(unsigned int)arg3;
...
- (id)_importEventsWithExternalIDs:(id)arg1 fromICSData:(id)arg2 intoCalendarsWithIDs:(id)arg3 options:(unsigned int)arg4 batchSize:(int)arg5;
- (id)importEventsWithExternalIDs:(id)arg1 fromICSData:(id)arg2 intoCalendars:(id)arg3 options:(unsigned int)arg4 batchSize:(int)arg5;
- (id)importICSData:(id)arg1 intoCalendars:(id)arg2 options:(unsigned int)arg3;
- (id)importICS:(id)arg1 intoCalendar:(id)arg2 options:(unsigned int)arg3;
- (_Bool)setInvitationStatus:(unsigned int)arg1 forEvents:(id)arg2 error:(id *)arg3;
- (_Bool)setInvitationStatus:(unsigned int)arg1 forEvent:(id)arg2 error:(id *)arg3;
...
- (_Bool)deleteCalendar:(id)arg1 forEntityType:(unsigned int)arg2 error:(id *)arg3;
...
- (_Bool)_calendar:(id)arg1 supportsEntityType:(unsigned int)arg2;
...
@property(readonly, nonatomic) unsigned int lastConfirmedSplashScreenVersion;
...
- (void)_postEventStoreChangedNotificationWithChangeType:(unsigned int)arg1 changedObjectIDs:(id)arg2;
- (void)_databaseChangedExternally:(unsigned int)arg1;
...
- (id)initWithEKOptions:(unsigned int)arg1;
- (id)initWithEKOptions:(unsigned int)arg1 path:(id)arg2 changeTrackingClientId:(id)arg3 enablePropertyModificationLogging:(_Bool)arg4 allowDelegateSources:(_Bool)arg5;
