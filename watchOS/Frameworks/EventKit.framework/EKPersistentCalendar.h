...
@property(nonatomic) unsigned int sharingInvitationResponse; // @dynamic sharingInvitationResponse;
...
@property(nonatomic) unsigned int sharingStatus; // @dynamic sharingStatus;
