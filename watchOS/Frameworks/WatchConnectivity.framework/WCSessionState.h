...
@property(readonly) unsigned int remainingComplicationUserInfoTransfers; // @synthesize remainingComplicationUserInfoTransfers=_remainingComplicationUserInfoTransfers;
...
- (id)description;
- (id)initWithReachable:(_Bool)arg1 paired:(_Bool)arg2 appInstalled:(_Bool)arg3 complicationEnabled:(_Bool)arg4 remainingComplicationUserInfoTransfers:(unsigned int)arg5 iOSDeviceNeedsFirstUnlock:(_Bool)arg6 pairingID:(id)arg7 pairedDevicesPairingIDs:(id)arg8 appInstallationID:(id)arg9;
- (id)initWithReachable:(_Bool)arg1 paired:(_Bool)arg2 appInstalled:(_Bool)arg3 complicationEnabled:(_Bool)arg4 remainingComplicationUserInfoTransfers:(unsigned int)arg5 activePairingID:(id)arg6 pairedDevicesPairingIDs:(id)arg7 appInstallationID:(id)arg8;
