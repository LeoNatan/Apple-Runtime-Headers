...
#import "WCXPCManagerClientProtocol.h"
#import "WCXPCManagerDaemonProtocol.h"

@class NSObject<OS_dispatch_queue>, NSObject<WCXPCManagerDelegate>, NSString, NSXPCConnection;
...
+ (id)daemonInterface;
+ (void)initialize;
@property unsigned int reconnectRetryCount; // @synthesize reconnectRetryCount=_reconnectRetryCount;
