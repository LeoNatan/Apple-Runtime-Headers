...
@property(readonly, nonatomic) unsigned int imageURLsCount;
@property(copy, nonatomic) NSArray *imageURLs;
@property(readonly, nonatomic) unsigned int iconURLsCount;
...
- (NSString *)imageURLAtIndex:(unsigned int)arg1;
- (void)addImageURL:(NSString *)arg1;
- (void)clearImageURLs;
- (NSString *)iconURLAtIndex:(unsigned int)arg1;
