...
@property(readonly, nonatomic) unsigned int waypointsCount;
...
@property(readonly, nonatomic) unsigned int additionalActionItemsCount;
@property(copy, nonatomic) NSArray *additionalActionItems;
- (_INPBLocationValue *)waypointsAtIndex:(unsigned int)arg1;
- (void)addWaypoints:(_INPBLocationValue *)arg1;
- (void)clearWaypoints;
- (int)StringAsPhase:(NSString *)arg1;
- (NSString *)phaseAsString:(int)arg1;
- (_INPBUserActivity *)additionalActionItemsAtIndex:(unsigned int)arg1;
