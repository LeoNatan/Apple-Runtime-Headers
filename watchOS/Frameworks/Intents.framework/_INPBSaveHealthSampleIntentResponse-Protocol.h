...
- (_INPBWellnessValue *)valuesUserProvidedUnitAtIndex:(unsigned int)arg1;
- (void)addValuesUserProvidedUnit:(_INPBWellnessValue *)arg1;
- (void)clearValuesUserProvidedUnits;
- (_INPBWellnessValue *)valuesDefaultUnitAtIndex:(unsigned int)arg1;
- (void)addValuesDefaultUnit:(_INPBWellnessValue *)arg1;
- (void)clearValuesDefaultUnits;
- (_INPBString *)sampleUuidsAtIndex:(unsigned int)arg1;
