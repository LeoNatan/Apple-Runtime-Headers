...
@property(readonly, nonatomic) unsigned int fareLineItemsCount;
...
@property(readonly, nonatomic) unsigned int availablePartySizeOptionsCount;
@property(copy, nonatomic) NSArray *availablePartySizeOptions;
- (_INPBRideFareLineItem *)fareLineItemsAtIndex:(unsigned int)arg1;
- (void)addFareLineItems:(_INPBRideFareLineItem *)arg1;
- (void)clearFareLineItems;
- (_INPBRidePartySizeOption *)availablePartySizeOptionsAtIndex:(unsigned int)arg1;
