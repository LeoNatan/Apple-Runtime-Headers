...
@property(readonly, nonatomic) unsigned int intentTypePhrasesCount;
@property(copy, nonatomic) NSArray *intentTypePhrases;
@property(readonly, nonatomic) unsigned int intentSlotVocabularyPoliciesCount;
@property(copy, nonatomic) NSArray *intentSlotVocabularyPolicies;
- (_INPBIntentTypePhrases *)intentTypePhrasesAtIndex:(unsigned int)arg1;
- (void)addIntentTypePhrases:(_INPBIntentTypePhrases *)arg1;
- (void)clearIntentTypePhrases;
- (_INPBIntentSlotVocabularyPolicy *)intentSlotVocabularyPoliciesAtIndex:(unsigned int)arg1;
