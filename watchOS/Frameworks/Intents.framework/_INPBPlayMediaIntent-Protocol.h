...
- (_INPBString *)hashedRouteUIDsAtIndex:(unsigned int)arg1;
- (void)addHashedRouteUIDs:(_INPBString *)arg1;
- (void)clearHashedRouteUIDs;
- (_INPBDataString *)bucketAtIndex:(unsigned int)arg1;
- (void)addBucket:(_INPBDataString *)arg1;
- (void)clearBuckets;
- (_INPBMediaItemGroup *)audioSearchResultsAtIndex:(unsigned int)arg1;
- (void)addAudioSearchResults:(_INPBMediaItemGroup *)arg1;
- (void)clearAudioSearchResults;
- (_INPBMediaItemGroup *)alternativeResultsAtIndex:(unsigned int)arg1;
