...
+ (id)_schemaWithIntentDefinitionURLs:(id)arg1 bundleIdentifier:(id)arg2 contentOptions:(unsigned int)arg3;
+ (id)_defaultSchemaForBundle:(id)arg1 contentOptions:(unsigned int)arg2;
+ (id)systemSchema;
+ (id)defaultSchema;
...
- (void)_loadIntentsFromArrayOfDictionaries:(id)arg1 intentDefinitionNamespace:(id)arg2 fromFile:(id)arg3 bundleIdentifier:(id)arg4 referencedCodableDescriptions:(id)arg5 contentOptions:(unsigned int)arg6;
...
- (id)_initWithContentsOfURLs:(id)arg1 bundleIdentifier:(id)arg2 contentOptions:(unsigned int)arg3;
