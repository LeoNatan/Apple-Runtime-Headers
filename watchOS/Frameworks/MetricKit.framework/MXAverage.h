...
@property(readonly) int sampleCount; // @synthesize sampleCount=_sampleCount;
@property(readonly) NSMeasurement *averageMeasurement; // @synthesize averageMeasurement=_averageMeasurement;
- (id)toDictionary;
- (id)initWithCoder:(id)arg1;
- (void)encodeWithCoder:(id)arg1;
- (id)initWithMeasurement:(id)arg1 sampleCount:(int)arg2 standardDeviation:(double)arg3;
- (id)initWithDoubleValue:(double)arg1 sampleCount:(int)arg2 standardDeviation:(double)arg3 unit:(id)arg4;
