...
- (_Bool)readFileCommentFromBuffer:(const void **)arg1 fileCommentLength:(unsigned short)arg2 entry:(id)arg3 dataSize:(unsigned int *)arg4 error:(id *)arg5;
- (_Bool)readZip64ExtraFieldFromBuffer:(const void *)arg1 dataLength:(unsigned short)arg2 entry:(id)arg3 error:(id *)arg4;
- (_Bool)readExtraFieldsFromBuffer:(const void **)arg1 extraFieldsLength:(unsigned short)arg2 entry:(id)arg3 dataSize:(unsigned int *)arg4 error:(id *)arg5;
- (_Bool)readFilenameFromBuffer:(const void **)arg1 nameLength:(unsigned short)arg2 entry:(id)arg3 dataSize:(unsigned int *)arg4 error:(id *)arg5;
- (_Bool)readCentralFileHeaderWithBuffer:(const void **)arg1 dataSize:(unsigned int *)arg2 error:(id *)arg3;
- (void)readCentralDirectoryData:(id)arg1 entryCount:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)readCentralDirectoryWithEntryCount:(unsigned int)arg1 offset:(long long)arg2 size:(unsigned long)arg3 channel:(id)arg4 completion:(CDUnknownBlockType)arg5;
...
@property(readonly, nonatomic) unsigned int entriesCount;
