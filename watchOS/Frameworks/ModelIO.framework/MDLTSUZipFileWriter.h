...
- (void)copyEntriesFromZipFileWriter:(id)arg1 readingFromURL:(id)arg2 options:(unsigned int)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (id)initWithZipFileArchive:(id)arg1 options:(unsigned int)arg2 error:(id *)arg3;
