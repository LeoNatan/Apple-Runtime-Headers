...
- (id)initWithTargetShapes:(id)arg1 shapeSetTargetWeights:(const float *)arg2 count:(unsigned int)arg3 shapeSetTargetCounts:(const unsigned int *)arg4 count:(unsigned int)arg5;
