...
- (void)updateTexture;
- (void)dealloc;
- (id)initWithName:(id)arg1 channelEncoding:(int)arg2 textureDimensions:(float)arg3 turbidity:(float)arg4 sunElevation:(float)arg5 upperAtmosphereScattering:(float)arg6 groundAlbedo: /* Error: Ran out of types for this method. */;
- (id)initWithName:(id)arg1 channelEncoding:(int)arg2 textureDimensions:(float)arg3 turbidity:(float)arg4 sunElevation:(float)arg5 sunAzimuth:(float)arg6 upperAtmosphereScattering:(float)arg7 groundAlbedo: /* Error: Ran out of types for this method. */;
