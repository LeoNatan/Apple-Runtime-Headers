...
- (void)resetWithDoubleQuaternionArray:(const struct *)arg1 atTimes:(const double *)arg2 count:(unsigned int)arg3;
- (void)resetWithFloatQuaternionArray:(const struct *)arg1 atTimes:(const double *)arg2 count:(unsigned int)arg3;
