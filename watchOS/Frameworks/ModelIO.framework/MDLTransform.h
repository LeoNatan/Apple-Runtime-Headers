...
-     // Error parsing type: {?=[4]}16@0:4d8, name: rotationMatrixAtTime:
...
-     // Error parsing type: @76@0:4{?=[4]}8B72, name: initWithMatrix:resetsTransform:
-     // Error parsing type: @72@0:4{?=[4]}8, name: initWithMatrix:
...
-     // Error parsing type: v80@0:4{?=[4]}8d72, name: setMatrix:forTime:
-     // Error parsing type: 16@0:4d8, name: rotationAtTime:
-     // Error parsing type: 16@0:4d8, name: translationAtTime:
-     // Error parsing type: 16@0:4d8, name: shearAtTime:
-     // Error parsing type: 16@0:4d8, name: scaleAtTime:
