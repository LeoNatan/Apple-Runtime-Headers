...
#import "MDLTSURandomWriteChannel.h"
#import "MDLTSUReadChannel.h"
#import "MDLTSUStreamWriteChannel.h"
...
- (id)initWithType:(unsigned long)arg1 URL:(id)arg2 oflag:(int)arg3 mode:(unsigned short)arg4 error:(id *)arg5 cleanupHandler:(CDUnknownBlockType)arg6;
