...
@class MDLTSUZipWriterEntry, NSArray, NSDate, NSError, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_data>, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>;
...
- (void)truncateToNumberOfEntriesImpl:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
- (void)truncateToNumberOfEntries:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
...
- (id)p_writeChannel;
- (unsigned int)entriesCountImpl;
@property(readonly) unsigned int entriesCount;
