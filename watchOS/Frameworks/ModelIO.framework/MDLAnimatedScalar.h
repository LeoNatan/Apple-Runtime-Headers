...
- (void)resetWithDoubleArray:(const double *)arg1 atTimes:(const double *)arg2 count:(unsigned int)arg3;
- (void)resetWithFloatArray:(const float *)arg1 atTimes:(const double *)arg2 count:(unsigned int)arg3;
