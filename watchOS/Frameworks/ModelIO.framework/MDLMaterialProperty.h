...
-     // Error parsing type: v72@0:4{?=[4]}8, name: setMatrix4x4Value:
...
- (id)initWithName:(id)arg1 semantic:(unsigned int)arg2 float4WithSRGBA: /* Error: Ran out of types for this method. */;
...
-     // Error parsing type: @80@0:4@8I12{?=[4]}16, name: initWithName:semantic:matrix4x4:
- (id)initWithName:(id)arg1 semantic:(unsigned int)arg2 float4: /* Error: Ran out of types for this method. */;
- (id)initWithName:(id)arg1 semantic:(unsigned int)arg2 float3: /* Error: Ran out of types for this method. */;
- (id)initWithName:(id)arg1 semantic:(unsigned int)arg2 float2: /* Error: Ran out of types for this method. */;
