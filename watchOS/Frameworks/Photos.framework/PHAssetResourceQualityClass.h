...
- (void).cxx_destruct;
@property(readonly, nonatomic) unsigned int maxNumberOfPixelsIfSquare; // @synthesize maxNumberOfPixelsIfSquare=_maxNumberOfPixelsIfSquare;
@property(readonly, nonatomic) unsigned int maxSideLengthIfSquare; // @synthesize maxSideLengthIfSquare=_maxSideLengthIfSquare;
...
@property(nonatomic) unsigned int backingCPLResourceType; // @synthesize backingCPLResourceType=_backingCPLResourceType;
