...
- (int)requestCloudResourceType:(unsigned int)arg1 forAssetWithObjectID:(id)arg2 downloadIsTransient:(_Bool)arg3 progressHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
