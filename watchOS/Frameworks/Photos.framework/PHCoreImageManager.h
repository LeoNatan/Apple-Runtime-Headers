...
+ (void)_chooseFormatsForSize:(struct CGSize)arg1 contentMode:(int)arg2 srcAspectRatio:(double)arg3 options:(id)arg4 hasAdjustmentsHandler:(CDUnknownBlockType)arg5 desiredImagePixelSize:(struct CGSize *)arg6 bestFormat:(id *)arg7 degradedFormat:(id *)arg8;
+ (id)_fastestDegradedFormatForRequest:(id)arg1 hasAdjustmentsHandler:(CDUnknownBlockType)arg2;
+ (id)_degradedFormatWithPolicy:(int)arg1 request:(id)arg2 hasAdjustmentsHandler:(CDUnknownBlockType)arg3;
...
- (void)_handleNormalImageRequest:(id)arg1 library:(id)arg2 deliveryMode:(int)arg3 degradedFormat:(id)arg4 bestFormat:(id)arg5 optimalSourcePixelSize:(struct CGSize)arg6 wantsImageDataOrURL:(_Bool)arg7 sync:(_Bool)arg8 isFinalStageOfStagedRequest:(_Bool)arg9 isResponseToSharedStreamsDownload:(_Bool)arg10;
...
- (void)_performPreheatReferenceCountingOperationForAssets:(id)arg1 CPLPrefetching:(_Bool)arg2 domain:(id)arg3 operation:(int)arg4 passingTestHandler:(CDUnknownBlockType)arg5;
