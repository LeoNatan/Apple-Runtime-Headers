...
+ (id)descriptionForMediaSubtypes:(unsigned int)arg1;
+ (id)_descriptionForMediaSubtype:(unsigned int)arg1;
+ (id)descriptionForMediaType:(int)arg1;
+ (id)descriptionForPlaybackStyle:(int)arg1;
...
+ (int)countOfAssetsWithLocationFromUUIDs:(id)arg1 photoLibrary:(id)arg2;
+ (_Bool)_isLivePhotoWithPhotoIris:(_Bool)arg1 hasAdjustments:(_Bool)arg2 videoCpDuration:(long long)arg3 videoCPVisibility:(unsigned short)arg4 sourceType:(unsigned int)arg5;
...
+ (id)_inq_imageManagerRequestMessagesByRequestIDForAssetUUID:(id)arg1 requestID:(int)arg2;
...
@property(readonly, nonatomic) int RAWPlusJPEGBadgeAttributes; // @synthesize RAWPlusJPEGBadgeAttributes=_RAWPlusJPEGBadgeAttributes;
...
- (void)getFingerPrintForAssetType:(int)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
...
- (id)_imageRequestOptionsForBaseVersion:(int)arg1 options:(id)arg2 progressEstimateForImageProgress:(CDUnknownBlockType)arg3;
- (id)_videoRequestOptionsForBaseVersion:(int)arg1 options:(id)arg2 progressEstimateForVideoProgress:(CDUnknownBlockType)arg3;
- (int)_baseVersionForAdjustmentData:(id)arg1 canHandleAdjustmentData:(_Bool)arg2;
