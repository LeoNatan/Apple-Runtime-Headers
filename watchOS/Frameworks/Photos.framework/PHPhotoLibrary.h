...
@class NSHashTable, NSMutableDictionary, NSMutableOrderedSet, NSObject<OS_dispatch_queue>, NSString, PHPersistentChangeToken, PHVariationCacheManager, PLPhotoAnalysisServiceClient, PLPhotoLibrary;
...
- (id)_fetchPersistentChangesSinceToken:(id)arg1 maximumChangeThreshold:(unsigned int)arg2 error:(id *)arg3;
...
- (id)_errorForAuthorizationStatus:(int)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (unsigned int)countOfUnprocessedFaceCrops;
...
- (id)curationDebugInformationForAssetCollectionWithLocalIdentifier:(id)arg1 precision:(unsigned int)arg2 error:(id *)arg3;
