...
@property(readonly, nonatomic) int _contentMode; // @synthesize _contentMode=__contentMode;
...
- (void)start;
- (id)initWithAsset:(id)arg1 targetSize:(struct CGSize)arg2 contentMode:(int)arg3 options:(id)arg4 imageManager:(id)arg5 resultHandler:(CDUnknownBlockType)arg6;
