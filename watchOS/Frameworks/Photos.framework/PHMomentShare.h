...
@interface PHMomentShare : PHAssetCollection
{
    ...
    unsigned int _uploadedPhotosCount;
    unsigned int _uploadedVideosCount;
    NSURL *_shareURL;
    NSDate *_expiryDate;
    NSData *_previewData;
...
+ (id)invitedMomentSharesExpiringInDays:(unsigned int)arg1;
- (void).cxx_destruct;
...
@property(readonly, nonatomic) unsigned int uploadedVideosCount; // @synthesize uploadedVideosCount=_uploadedVideosCount;
@property(readonly, nonatomic) unsigned int uploadedPhotosCount; // @synthesize uploadedPhotosCount=_uploadedPhotosCount;
@property(readonly, nonatomic) unsigned int videosCount; // @synthesize videosCount=_videosCount;
@property(readonly, nonatomic) unsigned int photosCount; // @synthesize photosCount=_photosCount;
