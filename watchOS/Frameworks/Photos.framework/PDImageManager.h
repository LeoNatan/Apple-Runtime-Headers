...
- (int)requestImageForAsset:(id)arg1 targetSize:(struct CGSize)arg2 contentMode:(int)arg3 options:(id)arg4 requestID:(int)arg5 resultHandler:(CDUnknownBlockType)arg6;
- (int)nextID;
...
- (unsigned int)requestContentEditingInputForAsset:(id)arg1 withOptions:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (id)_imageRequestOptionsForAsset:(id)arg1 baseVersion:(int)arg2 options:(id)arg3 progressEstimateForImageProgress:(CDUnknownBlockType)arg4;
...
- (id)_videoRequestOptionsForBaseVersion:(int)arg1 asset:(id)arg2 options:(id)arg3 progressEstimateForVideoProgress:(CDUnknownBlockType)arg4;
