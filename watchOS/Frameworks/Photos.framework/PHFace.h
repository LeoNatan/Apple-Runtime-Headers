...
@property(nonatomic) int expressionType3; // @synthesize expressionType3=_expressionType3;
@property(nonatomic) double expressionScore2; // @synthesize expressionScore2=_expressionScore2;
@property(nonatomic) int expressionType2; // @synthesize expressionType2=_expressionType2;
@property(nonatomic) double expressionScore1; // @synthesize expressionScore1=_expressionScore1;
@property(nonatomic) int expressionType1; // @synthesize expressionType1=_expressionType1;
...
@property(readonly, nonatomic) int nameSource; // @synthesize nameSource=_nameSource;
