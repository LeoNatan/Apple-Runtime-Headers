...
@property(nonatomic, setter=_setPixelHeight:) unsigned int pixelHeight; // @synthesize pixelHeight=_pixelHeight;
@property(nonatomic, setter=_setPixelWidth:) unsigned int pixelWidth; // @synthesize pixelWidth=_pixelWidth;
