...
+ (id)queryForCollectionListsWithType:(int)arg1 localIdentifiers:(id)arg2 options:(id)arg3;
...
+ (id)queryForAssetCollectionsWithType:(int)arg1 localIdentifiers:(id)arg2 options:(id)arg3;
...
+ (id)queryForAssetCollectionsContainingAssets:(id)arg1 withType:(int)arg2 options:(id)arg3;
+ (id)queryForAssetCollectionsContainingAsset:(id)arg1 withType:(int)arg2 options:(id)arg3;
