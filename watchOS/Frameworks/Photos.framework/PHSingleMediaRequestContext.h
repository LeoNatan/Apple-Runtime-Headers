...
+ (int)_indexOfAvProxyFromResources:(id)arg1 hasAdjustments:(_Bool)arg2 version:(int)arg3;
...
- (int)type;
- (id)_lazyProgress;
- (id)initWithRequestID:(int)arg1 managerID:(unsigned long long)arg2 asset:(id)arg3 displaySpec:(id)arg4 type:(int)arg5 networkAccessAllowed:(_Bool)arg6 progressHandler:(CDUnknownBlockType)arg7 resultHandler:(CDUnknownBlockType)arg8;
