...
+ (id)_chooseImageTableFormatForPreheatingFromFormats:(id)arg1 targetSize:(struct CGSize)arg2 contentMode:(int)arg3 returnBestTableRegardlessOfFit:(_Bool)arg4;
- (void).cxx_destruct;
