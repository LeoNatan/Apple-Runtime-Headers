...
- (void)_finish;
- (id)initWithRequestID:(int)arg1 requestIndex:(unsigned long long)arg2 contextType:(int)arg3 managerID:(unsigned long long)arg4 asset:(id)arg5 displaySpec:(id)arg6 behaviorSepc:(id)arg7 delegate:(id)arg8;
