...
- (void)controller:(id)arg1 didChangeSection:(id <NSFetchedResultsSectionInfo>)arg2 atIndex:(int)arg3 forChangeType:(unsigned int)arg4;
- (void)controller:(id)arg1 didChangeObject:(id)arg2 atIndexPath:(NSIndexPath *)arg3 forChangeType:(unsigned int)arg4 newIndexPath:(NSIndexPath *)arg5;
