...
- (void)getMaxDataRate:(CTXPCServiceSubscriptionContext *)arg1 completion:(void (^)(int, NSError *))arg2;
- (void)setMaxDataRate:(CTXPCServiceSubscriptionContext *)arg1 rate:(int)arg2 completion:(void (^)(NSError *))arg3;
