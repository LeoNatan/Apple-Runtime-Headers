...
- (_Bool)getCharacterCount:(int *)arg1 andMessageSplitThreshold:(int *)arg2 forSmsText:(id)arg3;
- (_Bool)getCharacterCountForSub:(id)arg1 count:(int *)arg2 andMessageSplitThreshold:(int *)arg3 forSmsText:(id)arg4;
...
- (CDStruct_1ef3fb1f)sendMMSFromData:(id)arg1 messageId:(unsigned int)arg2 subSlot:(int)arg3;
