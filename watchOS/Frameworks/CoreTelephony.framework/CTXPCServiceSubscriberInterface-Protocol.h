...
- (void)isEsimFor:(CTXPCServiceSubscriptionContext *)arg1 completion:(void (^)(int, NSError *))arg2;
...
- (void)context:(CTXPCServiceSubscriptionContext *)arg1 supportedIdentityProtectionFor:(NSString *)arg2 completion:(void (^)(int, NSError *))arg3;
