...
- (void)dataUsageForLastPeriodsOnActivePairedDevice:(unsigned int)arg1 completion:(CDUnknownBlockType)arg2;
...
- (int)context:(id)arg1 supportedIdentityProtectionFor:(id)arg2 error:(id *)arg3;
