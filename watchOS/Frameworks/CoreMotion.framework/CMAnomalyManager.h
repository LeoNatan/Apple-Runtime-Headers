...
- (void)resolveAnomalyEvent:(id)arg1 withResolution:(int)arg2;
- (void)respondToAnomalyEvent:(id)arg1 withResponse:(int)arg2;
- (void)_sendRegistrationForAnomalyEvent:(id)arg1;
- (void)ackAnomalyEvent:(id)arg1 withResolution:(int)arg2;
