...
{
    double fTimestamp;
    long _totalStrideCount;
    long _totalStrokeCount;
    long _totalFloorsClimbed;
    double _elapsedTime;
    double _totalEnergy;
...
@property(nonatomic) long totalFloorsClimbed; // @synthesize totalFloorsClimbed=_totalFloorsClimbed;
@property(nonatomic) long totalStrokeCount; // @synthesize totalStrokeCount=_totalStrokeCount;
@property(nonatomic) long totalStrideCount; // @synthesize totalStrideCount=_totalStrideCount;
