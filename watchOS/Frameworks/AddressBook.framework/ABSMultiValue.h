...
- (_Bool)replaceLabel:(id)arg1 atIndex:(long)arg2;
- (_Bool)replaceValue:(id)arg1 atIndex:(long)arg2;
- (_Bool)removeValueAtIndex:(long)arg1;
- (_Bool)insertValue:(id)arg1 label:(id)arg2 atIndex:(long)arg3 outIdentifier:(int *)arg4;
