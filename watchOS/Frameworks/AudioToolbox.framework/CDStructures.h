...
struct SafeHALListener<std::__1::mutex> {
    ...
    struct vector<std::__1::tuple<unsigned long, AudioObjectPropertyAddress>, std::__1::allocator<std::__1::tuple<unsigned long, AudioObjectPropertyAddress>>> _field3;
    struct mutex *_field4;
    struct function<bool (unsigned int, unsigned long, const std::__1::vector<AudioObjectPropertyAddress, std::__1::allocator<AudioObjectPropertyAddress>>&)> _field5;
};
...
struct function<bool (unsigned int, unsigned long, const std::__1::vector<AudioObjectPropertyAddress, std::__1::allocator<AudioObjectPropertyAddress>>&)> {
    struct __value_func<bool (unsigned int, unsigned long, const std::__1::vector<AudioObjectPropertyAddress, std::__1::allocator<AudioObjectPropertyAddress>>&)> {
        struct type _field1;
        struct __base<bool (unsigned int, unsigned long, const std::__1::vector<AudioObjectPropertyAddress, std::__1::allocator<AudioObjectPropertyAddress>>&)> *_field2;
    } _field1;
};
...
struct tuple<unsigned long, AudioObjectPropertyAddress>;
...
struct vector<std::__1::tuple<unsigned long, AudioObjectPropertyAddress>, std::__1::allocator<std::__1::tuple<unsigned long, AudioObjectPropertyAddress>>> {
    struct tuple<unsigned long, AudioObjectPropertyAddress> *_field1;
    struct tuple<unsigned long, AudioObjectPropertyAddress> *_field2;
    struct __compressed_pair<std::__1::tuple<unsigned long, AudioObjectPropertyAddress>*, std::__1::allocator<std::__1::tuple<unsigned long, AudioObjectPropertyAddress>>> {
        struct tuple<unsigned long, AudioObjectPropertyAddress> *_field1;
    } _field3;
};
