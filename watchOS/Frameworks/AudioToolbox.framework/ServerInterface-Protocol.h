...
- (void)loadHapticPattern:(NSDictionary *)arg1 reply:(void (^)(unsigned int, NSError *))arg2;
- (void)loadHapticSequence:(NSData *)arg1 reply:(void (^)(unsigned int, unsigned int, NSError *))arg2;
...
- (void)requestChannels:(unsigned int)arg1 reply:(void (^)(NSArray *, NSError *))arg2;
- (void)setPlayerBehavior:(unsigned int)arg1 reply:(void (^)(NSError *))arg2;
...
- (void)getClientID:(void (^)(unsigned int))arg1;
@end
