...
+ (CDStruct_c45718c8)settingsWithOptions:(id)arg1;
+ (int)faceContext:(CDStruct_ebdfc424 *)arg1 withFaceArray:(id)arg2 index:(int)arg3 settings:(CDStruct_c45718c8 *)arg4;
+ (int)bitmapRect:(CDStruct_a734b2e2 *)arg1 point:(struct CGPoint *)arg2 polygon:(struct CGPoint [8])arg3 andDistMatrix:(float [4])arg4 forEye:(int)arg5 inFaceDictionary:(id)arg6 settings:(CDStruct_c45718c8 *)arg7;
+ (float)yawAngleWithFaceDictionary:(id)arg1;
+ (CDStruct_a734b2e2)bitmapRectWithImageSubRectangle:(struct CGRect)arg1 settings:(CDStruct_c45718c8 *)arg2;
...
- (int)newShape:(CDStruct_183601bc **)arg1 byInterpolatingBetweenCheckpoints:(CDStruct_cfe5cef8 [100])arg2 nc:(int)arg3 usingVectorField:(CDStruct_c3faddef *)arg4;
