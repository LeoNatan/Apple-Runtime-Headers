...
+ (CDStruct_e2d47638)faceContextWithFaceArray:(id)arg1 index:(int)arg2;
+ (void)printProminenceSearchResultsWithTitle:(char *)arg1 hopperElement:(CDStruct_7a0e83b0 *)arg2 maxData:(CDStruct_16f4d402 *)arg3 toLine:(char *)arg4 maxLength:(int)arg5;
+ (id)imageWithREDEYEFORMATBitmap:(CDStruct_c3faddef *)arg1;
+ (void)analyzeFineGrowBitmaskData:(CDStruct_16f4d402 *)arg1 dataSize:(int)arg2 context:(CDStruct_2eaa9de4 *)arg3;
+ (void)analyzeCoarseGrowBitmaskData:(CDStruct_16f4d402 *)arg1 dataSize:(int)arg2 context:(CDStruct_2eaa9de4 *)arg3;
...
+ (CDStruct_a734b2e2)ovalBoundsWithOC:(CDStruct_973076e9 *)arg1;
+ (struct CGPoint)ovalOutlinePointWithT:(float)arg1 OC:(CDStruct_973076e9 *)arg2;
+ (float)bitmask:(CDStruct_94ca5ecd *)arg1 debugComments:(CDStruct_1c6f3adb *)arg2 toOval:(CDStruct_973076e9 *)arg3;
...
+ (void)graphBitmaskGrowData:(CDStruct_16f4d402 *)arg1 size:(int)arg2 index:(int)arg3 debugComments:(CDStruct_1c6f3adb *)arg4;
+ (void)drawBitmask:(CDStruct_94ca5ecd *)arg1 index:(int)arg2 debugComments:(CDStruct_1c6f3adb *)arg3;
+ (void)drawBitmask:(CDStruct_94ca5ecd *)arg1 withOval:(CDStruct_973076e9 *)arg2 index:(int)arg3 comparison:(_Bool)arg4 salientMode:(int)arg5 debugComments:(CDStruct_1c6f3adb *)arg6;
...
- (CDStruct_06f0479e)transformGlobalRepairRecord:(CDStruct_06f0479e *)arg1 transform:(struct CGAffineTransform)arg2;
- (struct CGPoint)leftHandedTransform:(struct CGAffineTransform)arg1 ofPoint:(struct CGPoint)arg2;
- (id)packRepairDictionary:(CDStruct_06f0479e *)arg1;
- (id)packRepairDictionary:(CDStruct_06f0479e *)arg1 print:(_Bool)arg2;
- (id)packGlobalRepairDictionary:(CDStruct_06f0479e *)arg1 print:(_Bool)arg2;
- (CDStruct_06f0479e)unpackRepairDictionary:(id)arg1;
- (CDStruct_06f0479e)unpackGlobalRepairDictionary:(id)arg1;
...
- (void)dealloc;
- (id)initWithExternalBuffer:(char *)arg1 subRectangle:(struct CGRect)arg2 rowBytes:(unsigned long)arg3 options:(id)arg4;
...
- (_Bool)analyzeIrisColors:(CDStruct_06f0479e *)arg1 side:(int)arg2;
...
- (void)extractIrisColors:(CDStruct_06f0479e *)arg1;
- (void)alignPupils;
...
- (CDStruct_06f0479e)repairWithProminence:(CDStruct_03156a88)arg1 white:(CDStruct_03156a88 *)arg2 onSide:(int)arg3 metrics:(CDStruct_265c7ca9)arg4 rect:(CDStruct_a734b2e2)arg5;
- (CDStruct_03156a88)winningProminence:(CDStruct_03156a88 [7])arg1 metrics:(CDStruct_265c7ca9)arg2;
- (void)acquireProminences:(CDStruct_03156a88 [7])arg1 onSide:(int)arg2 metrics:(CDStruct_265c7ca9)arg3;
- (void)freeChoiceRecord:(CDStruct_03156a88 *)arg1;
- (void)initChoiceRecord:(CDStruct_03156a88 *)arg1 type:(int)arg2 title:(char *)arg3 plusWhiteTitle:(char *)arg4 name:(char *)arg5 canPlusWhite:(_Bool)arg6 canSpecular:(_Bool)arg7 metrics:(CDStruct_265c7ca9)arg8;
...
- (_Bool)findProminenceWithSide:(int)arg1 record:(CDStruct_03156a88 *)arg2;
- (void)freeBitmaps;
- (void)allocateAndPopulateBitmaps;
- (CDStruct_94ca5ecd *)localComputeBitmaskWithChannel:(CDStruct_c3faddef *)arg1 x:(int)arg2 y:(int)arg3 options:(CDStruct_e5fcc3f9 *)arg4 eyeCase:(int)arg5 returningMaxData:(CDStruct_16f4d402 *)arg6 isSpecularData:(_Bool *)arg7 maxSpecularData:(CDStruct_16f4d402 *)arg8 specularBitmask:(CDStruct_183601bc **)arg9;
...
- (void)printRepair:(CDStruct_06f0479e)arg1;
