...
@interface CIBilateralGridHash : NSObject
{
    ...
    int _sigma_r_luma;
    int _sigma_r_chroma;
    unsigned long _max_hash_table_size;
...
- (long)_addHashKeyAtX:(int)arg1 Y:(int)arg2 key:(unsigned long long)arg3 isKeyExist:(_Bool *)arg4;
...
- (long)_computeBilateralSpaceYCC444:(struct __IOSurface *)arg1 region:(struct CGRect)arg2 cropRect:(struct CGRect)arg3 sigma_s:(int)arg4 sigma_r_luma:(int)arg5 sigma_r_chroma:(int)arg6;
...
- (long)createWithSurface:(struct __IOSurface *)arg1 region:(struct CGRect)arg2 cropRect:(struct CGRect)arg3 sigma_s:(int)arg4 sigma_r_luma:(int)arg5 sigma_r_chroma:(int)arg6;
- (long)_createWithSurface:(struct __IOSurface *)arg1 region:(struct CGRect)arg2 cropRect:(struct CGRect)arg3 sigma_s:(int)arg4 sigma_r_luma:(int)arg5 sigma_r_chroma:(int)arg6;
- (void)clear;
- (void)dealloc;
- (id)initWithWidth:(int)arg1 height:(int)arg2 maxHashTableSize:(unsigned long)arg3;
- (int)sigma_r_chroma;
- (int)sigma_r_luma;
- (int)sigma_s;
- (int)height;
