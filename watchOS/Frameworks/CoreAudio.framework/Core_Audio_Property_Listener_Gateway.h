...
- (void)notify_listeners_of_object:(unsigned long)arg1 about_changes_to_properties:(const vector_9f82871d *)arg2;
- (void)handle_property_changes:(id)arg1 reply:(CDUnknownBlockType)arg2;
- (void)handle_property_changes:(id)arg1;
- (void)remove_listeners_for_device_id:(unsigned long)arg1;
