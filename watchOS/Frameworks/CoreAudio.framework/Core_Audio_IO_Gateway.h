...
- (void)stop_before_io_device_change:(unsigned long)arg1 reply:(CDUnknownBlockType)arg2;
- (void)handle_io_message:(unsigned long)arg1 with:(id)arg2 reply:(CDUnknownBlockType)arg3;
