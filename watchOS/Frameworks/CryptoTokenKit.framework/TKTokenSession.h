...
- (void)objectID:(id)arg1 operation:(int)arg2 inputData:(id)arg3 algorithms:(id)arg4 parameters:(id)arg5 reply:(CDUnknownBlockType)arg6;
...
- (_Bool)checkOperation:(int)arg1 usingKey:(id)arg2 algorithm:(id)arg3 parameters:(id)arg4;
- (void)beginAuthForOperation:(int)arg1 constraint:(id)arg2 reply:(CDUnknownBlockType)arg3;
