...
- (void)updateState:(int)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)dealloc;
- (id)initWithVersion:(id)arg1 downloadSize:(unsigned long long)arg2 state:(int)arg3 documentationMetadata:(id)arg4;
- (id)initWithVersion:(id)arg1 downloadSize:(unsigned long long)arg2 state:(int)arg3;
