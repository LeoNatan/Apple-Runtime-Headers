...
- (Class)valueClass;
- (id)initWithKey:(id)arg1 properties:(unsigned int)arg2 value:(id)arg3 minimumValue:(id)arg4 maximumValue:(id)arg5 stepValue:(id)arg6;
- (id)initWithKey:(id)arg1 properties:(unsigned int)arg2 value:(id)arg3;
