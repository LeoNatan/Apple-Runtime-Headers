...
@class HMAssistantAccessControl, HMFPairingIdentity, HMFUnfairLock, HMHome, HMHomeAccessControl, HMMediaContentProfileAccessControl, HMSettings, HMSettingsController, NSString, NSUUID, _HMContext;
...
- (void)_updatePresenceAuthorizationStatus:(unsigned int)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)updatePresenceAuthorizationStatus:(unsigned int)arg1 completionHandler:(CDUnknownBlockType)arg2;
