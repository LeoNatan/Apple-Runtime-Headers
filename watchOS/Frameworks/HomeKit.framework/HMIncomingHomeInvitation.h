...
- (void)_acceptInviteWithPresenceAuthStatus:(unsigned int)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)acceptInviteWithPresenceAuthStatus:(unsigned int)arg1 completionHandler:(CDUnknownBlockType)arg2;
