...
@property int minimumMediaUserPrivilege; // @synthesize minimumMediaUserPrivilege=_minimumMediaUserPrivilege;
...
- (void)_addUser:(id)arg1 privilege:(int)arg2 confirmWithLocalUser:(_Bool)arg3 confirmWithRemoteUser:(_Bool)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void)_addUserWithoutConfirmation:(id)arg1 privilege:(int)arg2 completionHandler:(CDUnknownBlockType)arg3;
