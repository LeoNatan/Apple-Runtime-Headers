...
- (void).cxx_destruct;
@property unsigned int properties; // @synthesize properties=_properties;
...
- (id)description;
- (id)_initWithIdentifier:(id)arg1 name:(id)arg2 type:(int)arg3 value:(id)arg4 properties:(unsigned int)arg5;
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 type:(int)arg3 value:(id)arg4 properties:(unsigned int)arg5;
- (id)initWithInternal;
