...
- (void).cxx_destruct;
- (void)updateCamerasAccessLevel:(unsigned int)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (unsigned int)camerasAccessLevel;
@property(retain, nonatomic) HMUserCameraAccess *camerasAccess; // @synthesize camerasAccess=_camerasAccess;
- (unsigned int)presenceComputationStatus;
- (unsigned int)presenceAuthorizationStatus;
