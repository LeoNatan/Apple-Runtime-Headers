...
- (void)fetchClipsAfterDate:(id)arg1 withLimit:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)fetchClipsBeforeDate:(id)arg1 withLimit:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)fetchClipsWithDateInterval:(id)arg1 limit:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;
