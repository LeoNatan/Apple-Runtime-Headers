...
@property int targetProtectionMode; // @synthesize targetProtectionMode=_targetProtectionMode;
...
- (id)initWithUUID:(id)arg1 manufacturer:(id)arg2 category:(id)arg3 protectionMode:(int)arg4;
