...
-     // Error parsing type: ^AI16@0:4i8r*12, name: shmemForRole:name:
...
- (void)preloadAppValuesForIdentifiers:(const struct __CFString **)arg1 containers:(const struct __CFString **)arg2 configurationURLs:(const struct __CFURL **)arg3 count:(long)arg4;
