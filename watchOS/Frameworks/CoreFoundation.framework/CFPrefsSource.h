...
- (void)replaceAllValuesWithValues:(const void **)arg1 forKeys:(const struct __CFString **)arg2 count:(long)arg3 from:(id)arg4;
...
- (void)setValues:(const void **)arg1 forKeys:(const struct __CFString **)arg2 count:(long)arg3 from:(id)arg4;
- (void)setValues:(const void **)arg1 forKeys:(const struct __CFString **)arg2 count:(long)arg3 removeValuesForKeys:(const struct __CFString **)arg4 count:(long)arg5 from:(id)arg6;
