...
+ (id)createTokenRegistration:(int)arg1 token:(unsigned long long)arg2 connection:(id)arg3 notifyToken:(int)arg4 options:(unsigned long)arg5 queue:(id)arg6 handler:(CDUnknownBlockType)arg7;
+ (const CDStruct_459b2a3d *)keyCallbacks;
@property(readonly) unsigned long options; // @synthesize options=_options;
...
- (id)initWithToken:(unsigned long long)arg1 options:(unsigned long)arg2 queue:(id)arg3 handler:(CDUnknownBlockType)arg4;
