...
- (CDStruct_79d58866)copyFlavorsForItemIdentifier:(long)arg1;
- (CDStruct_77932685)flavorCountForItemIdentifier:(long)arg1;
- (CDStruct_77932685)itemAtIndex:(long)arg1;
- (CDStruct_77932685)itemCount;
- (CDStruct_199678ce)copyItemsAndFlavors;
...
- (void)dealloc;
- (id)init;
- (void)prepareDataForItemIdentifier:(long)arg1 flavor:(struct __CFString *)arg2;
