...
@class NSObject<OS_dispatch_queue>, _CFPasteboardCache, _CFPasteboardClientInstanceID;
...
- (id)_onqueue_cacheForGeneration:(long)arg1;
- (long)_onqueue_nextGenerationCount;
